#!/usr/bin/env python3
"""
Script to find problems with incomplete solutions in chapters 16 and 27.
"""
...
def main():
    """Find all problems with incomplete solutions."""
    contents_dir = Path('/home/user/physics-book/contents')

    problems_to_fix = []

    # Process chapters 16 and 27
    ...
    for problem in problems_to_fix:
        ...
        if 'ch16' in problem['file']:
            ch16_count += 1
        elif 'ch27' in problem['file']:
            ch27_count += 1

    print(f"\n\nChapter 16 problems needing work: {ch16_count}")
    print(f"Chapter 27 problems needing work: {ch27_count}")
    print(f"Total problems needing complete solutions: {len(problems_to_fix)}")
