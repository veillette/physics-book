# OpenStax College Physics Errata Corrections (2023-2025)

## Executive Summary

This document summarizes all errata corrections applied to the physics textbook from the OpenStax College Physics Bundle repository. All corrections have been verified for accuracy and internal consistency.

**Correction Period**: January 2023 - December 2025
**Total Corrections Applied**: 34 corrections
**Files Modified**: 23 content files
...
- **Critical angle** (26947): Completed definition with 90º
- **Thin film interference** (27042): Fixed inequality to equality (≤→=)
- **Microscope objectives** (26829, 27133): Fixed duplicate specs, added realism question
...
- **Example simplification** (22244): Wooden bench vs metal bench
- **Dental fillings** (22355): Grammar improvement
...
- ch9ApplicationsOfStaticsIncludingProblemSolvingStrategies.md
- ch10AngularMomentumAndItsConservation.md
- ch11ArchimedesPrinciple.md
- ch12MolecularTransportPhenomena.md
- ch13Temperature.md
- ch13ThermalExpansionOfSolidsAndLiquids.md
- ch14TemperatureChangeAndHeatCapacity.md
- ch16Waves.md
- ch18ConductorsAndElectricFieldsInStaticEquilibrium.md
- ch20NerveConductionElectrocardiograms.md
- ch21ElectromotiveForce.md
- ch22MoreApplicationsOfMagnetism.md
- ch23RLCSeriesACircuits.md
- ch24TheElectromagneticSpectrum.md
- ch25GeometricOptics.md
- ch25TotalInternalReflection.md
- ch26Microscopes.md
- ch27ThinFilmInterference.md
- ch31NuclearDecayAndConservationLaws.md
- ch34GeneralRelativityAndQuantumTheory.md
...
4. RLC current: 6.00→3.00 A
5. RLC frequency: 50.0→60.0 Hz
6. Rocket thrust: 2.4×10⁴→2.59×10⁴ N
7. Weight calculation: verified 37.2 pounds
8. Microscope specs: fixed duplicate values
...
4. Force directions: added ladder problem clarifications
5. Critical angle: completed "90º" definition
6. Mass vs weight: terminology correction
7. Climate change: removed speculative language
...
4. Gravitational PE: fixed 10% energy retention calculation
5. RLC circuits: verified 3.00 A at resonance
6. Nuclear decay: verified 0.005631 u → 5.25 MeV
...
4. Solutions verified for consistency
...
- Cross-reference links (different structure)
- Could not locate matching text

This is expected when converting from CNXML to Markdown format.
...
4. **errata-corrections.json** - Machine-readable data (2025 corrections)
...
- **Verification**: Cross-referenced with OpenStax errata system
...
**Branch**: claude/apply-textbook-corrections-Ic6am
