...
<div data-type="equation" id="eip-100">
 $$ \begin{array}{lll}\text{KE′}& =& \frac{1}{2}I^{\prime} {\omega \prime }^{2}=\left(0.5\right)\left(1.032\text{kg}\cdot \text{m}^{2}\right){\left(1.744\frac{\text{rad}}{\text{s}}\right)}^{2}\\ & =& 1.57 \text{J.}\end{array} $$ 
</div>
**Strategy for (c)**
