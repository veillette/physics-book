...
<div data-type="equation" id="eip-920">
 $$ I^{\prime} =m r^{2} +\frac{ {\text{Mr}}^{2}}{3}=\left(m+\frac{M}{3}\right){r}^{2}. $$ 
</div>
Entering known values in this equation yields,

<div data-type="equation" id="eip-177">
 $$ I\text{′}=\left(0.0500\text{kg}+0.667 \text{kg}\right){\left(1.20\text{m}\right)}^{2}=1.032\text{kg}\cdot \text{m}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-74">
 $$ \begin{array}{lll}\omega \prime & =& \frac{\text{mvr}}{I^{\prime} }=\frac{\left(0.0500 \text{kg}\right)\left(30.0 m/s\right)\left(1.20 \text{m}\right)}{1.032 \text{kg}\cdot \text{m}^{2}}\\ & =& 1.744 \text{rad/s}\approx 1.74 \text{rad/s}.\end{array} $$ 
</div>
**Strategy for (b)**
...
<div data-type="equation" id="eip-27">
 $$ \text{KE}=\frac{1}{2}m v^{2}=\left(0.500\right)\left(0.0500\text{kg}\right){\left(30.0\text{m/s}\right)}^{2}=22.5 \text{J} $$ 
</div>
...
<div data-type="equation" id="eip-283">
 $$ p=mv =\left(0.0500\text{kg}\right)\left(30.0\text{m/s}\right)=1.50\text{kg}\cdot \text{m/s}. $$ 
</div>
After the collision, the disk and the stick’s center of mass move in the same direction. The total linear momentum is that of the disk moving at a new velocity  $$ v^{\prime} =r \omega \prime  $$ 
...
<div data-type="equation" id="eip-953">
 $$ p^{\prime} =mv^{\prime} +{\text{Mv}}_{\text{CM}}=mv^{\prime} +\frac{\text{Mv}\prime }{2}. $$ 
</div>
...
<div data-type="equation" id="eip-1000">
 $$ p^{\prime} =\left(1.050 \text{kg}\right)\left(1.20\text{m}\right)\left(1.744 \text{rad/s}\right)=2.20 \text{kg}\cdot \text{m/s}. $$ 
</div>
**Discussion**
