...
{\left(0.0500 \text{kg}\right)\left(30.0 m/s\right)\left(1.20 \text{m}\right)}{1.032 \text{kg}\cdot \text{m}^{2}}\\
 & =& 1.744 \text{rad/s}\approx 1.74 \text{rad/s}.
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-100">
 $$ \begin{array}{lll}
\text{KE}^\prime & =& \frac{1}{2}I^{\prime} {\omega^\prime}^{2}
