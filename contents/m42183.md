...
<div data-type="equation" id="eip-177">
 $$ I\text{′}=\left(0.0500\text{kg}+0\text{.}\text{667 kg}\right){\left(1.20\text{m}\right)}^{2}=1.032\text{kg}\cdot {\text{m}}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-74">
 $$ \begin{array}{lll}\omega \prime & =& \frac{\text{mvr}}{I\prime }=\frac{\left(0\text{.}\text{0500 kg}\right)\left(30.0 m/s\right)\left(1.20 \text{m}\right)}{1\text{.}\text{032 kg}\cdot {\text{m}}^{2}}\\ & =& 1\text{.}\text{744 rad/s}\approx 1\text{.}\text{74 rad/s}.\end{array} $$ 
</div>
**Strategy for (b)**
...
<div data-type="equation" id="eip-27">
 $$ \text{KE}=\frac{1}{2}{\text{mv}}^{2}=\left(0.500\right)\left(0.0500\text{kg}\right){\left(30.0\text{m/s}\right)}^{2}=22.5 \text{J} $$ 
</div>
...
<div data-type="equation" id="eip-100">
 $$ \begin{array}{lll}\text{KE′}& =& \frac{1}{2}I\prime {\omega \prime }^{2}=\left(0.5\right)\left(1.032\text{kg}\cdot {\text{m}}^{2}\right){\left(1.744\frac{\text{rad}}{\text{s}}\right)}^{2}\\ & =& \text{1.57 J.}\end{array} $$ 
</div>
**Strategy for (c)**
...
<div data-type="equation" id="eip-283">
 $$ p=\text{mv}=\left(0.0500\text{kg}\right)\left(30.0\text{m/s}\right)=1.50\text{kg}\cdot \text{m/s}. $$ 
</div>
...
<div data-type="equation" id="eip-1000">
 $$ p\prime =\left(1\text{.}\text{050 kg}\right)\left(1.20\text{m}\right)\left(1\text{.}\text{744 rad/s}\right)=\text{2.20 kg}\cdot \text{m/s}. $$ 
</div>
**Discussion**
