...
<div data-type="equation" id="eip-758">
 $$\begin{array}{lll}{\text{ΔPE}}_{\text{cycle}}& =& \left(5000 \text{C}\right)\left(\text{12.0 V}\right)\\ & =& \left(5000 \text{C}\right)\left(\text{12.0 J/C}\right)\\ & =&  6.00 \times 10^{4}  \text{J.}\end{array} $$
</div>
Similarly, for the car battery,  $$q=\text{60},000 \text{C} $$
 and
