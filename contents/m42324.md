...
, is proportional to the test charge  $$\mathrm{q.} $$
 To have a physical quantity that is independent of test charge, we define **electric potential**  $$V $$
...
The **potential difference** between points A and B,  $${V}_{\text{B}} – {V}_{\text{A}} $$
...
**Mechanical energy** is the sum of the kinetic energy and potential energy of a system; that is,  $$\text{KE}+\text{PE = constant} $$
