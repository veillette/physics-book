...
<div class="equation" id="eip-25">
 $${\text{n}}_{\text{e}}=\frac{–2.50 C}{–1.60 \times 10^{-19} {\text{C/e}}^{-}}= 1.56 \times 10^{19}  \text{electrons} \text{.}  $$
</div>
**Discussion**
...
<div class="equation" id="eip-835">
 $$\begin{array}{lll}1 \text{eV}& =& \left(1.60 \times 10^{-19} \text{C}\right)\left(1 V\right)=\left(1.60 \times 10^{-19} \text{C}\right)\left(1 J/C\right)\\ & =& 1.60 \times 10^{-19} \text{J} \text{.} \end{array} $$
</div>
