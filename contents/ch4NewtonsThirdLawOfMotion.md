...
This law represents a certain _symmetry in nature_ : Forces always occur in
...
illustrated in [Figure 1](#Figure1). She pushes against the pool wall with her feet
and accelerates in the direction _opposite_ to that of her push. The wall has
...
The net external force on System 1 is deduced from [Figure 2](#Figure2)
...
Calculate the force the professor exerts on the cart in [Figure 2](#Figure2)
...
1. Identify the known values:
   - Force from opposing player: $$ F\_{push} = 800 \N $$ (backward)
   - Mass: $$ m_1 = 90.0 \kg $$
...
Where $$ F\_{reaction} = 800 \N $$ is the reaction force from the losing player.
