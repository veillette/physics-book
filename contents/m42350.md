...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) During surgery, a current as small as  $$\mathrm{20.0 \text{μA}} $$
...
A short circuit in a 120-V appliance cord has a  $$ 0.500\text{-}\Omega  $$
 resistance. Calculate the temperature rise of the 2.00 g of surrounding materials, assuming their specific heat capacity is  $$0.200 \text{cal/g}\cdot º\text{C} $$
