...
where  $$B $$  is the magnetic field strength over an area  $$A $$ , at an angle  $$\theta  $$
 with the perpendicular to the area as shown in [\[link\]](#Figure4). **Any change in magnetic flux  $$\Phi  $$
 induces an emf.** This process is defined to be **electromagnetic induction**. Units of magnetic flux  $$\Phi  $$  are  $$\text{T}\cdot {\text{m}}^{2} $$ .
 As seen in [\[link\]](#Figure4),  $$B \cos \theta = B_\perp $$ ,
...
![Figure shows a flat square shaped surface A. The magnetic field B is shown to act on the surface at an angle theta with the normal to the surface A. The cosine component of magnetic field B cos theta is shown to act parallel to the normal to the surface.](../resources/Figure_24_01_04.jpg "Magnetic flux \( \Phi \) is related to the magnetic field and the area over which it exists. The flux \( \Phi=BA \cos \theta \)  is related to induction; any change in \( \Phi \) induces an emf."){: #Figure4}

All induction, including the examples given so far, arises from some change in magnetic flux  $$\Phi  $$ . For example, Faraday changed  $$B $$  and hence  $$\Phi  $$  when opening and closing the switch in his apparatus (shown in [\[link\]](#Figure1)). This is also true for the bar magnet and coil shown in [\[link\]](#Figure2). When rotating the coil of a generator, the angle  $$\theta  $$
...
How do the multiple-loop coils and iron ring in the version of Faraday’s apparatus shown in [[link]](#Figure1) enhance the observation of induced emf?
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
What is the value of the magnetic flux through the coil in [[link]](#Figure6)(b) due to the wire?
