...
*, at an angle  $$\theta  $$
 ...
 induces an emf.** This process is defined to be **electromagnetic induction**. Units of magnetic flux * $$\Phi  $$
* are  $$\text{T}\cdot {\text{m}}^{2} $$
. As seen in [\[link\]](#import-auto-id1169737961842),  $$B \cos \theta = B_\perp $$
, which is the component of * $$B $$
* perpendicular to the area * $$A $$
*. Thus magnetic flux is  $$\Phi ={B}_{\perp}A $$
