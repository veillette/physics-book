...
<div data-type="equation" id="eip-634">
 $$ m_{1}=0\text{.}\text{500 kg,}m_{2}=3\text{.}\text{50 kg,}v_{1}=4\text{.}\text{00 m/s, and}v_{2}=0\text{.} $$ 
</div>
...
by the fact that object 2 is initially at rest, and thus $$ v_{2}=0 $$. Once we simplify these equations, we combine them algebraically to solve for
the unknowns.

**Solution**

For this problem, note that $$ v_{2}=0 $$
...
<div data-type="equation" id="eip-560">
 $$ v^{\prime}_{2}=\frac{ m_{1}}{ m_{2}}\left(v_{1}-v^{\prime}_{1}\right)=\frac{0.500 \text{kg}}{3.50 \text{kg}}\left[4.00-\left(-3.00\right)\right]\text{m/s} $$ 
</div>
or

<div data-type="equation" id="eip-819">
 $$ v^{\prime}_{2}=1.00 \text{m/s}. $$ 
</div>
**Discussion**
