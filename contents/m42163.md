...
one-dimensional problem. An **elastic collision**{: data-type="term" #import-auto-id1180706} is one that also conserves internal kinetic energy. **Internal kinetic energy**{: data-type="term" #import-auto-id1806312} is the sum
...
<div data-type="equation" id="eip-545">
 $$ {p}_{1}+{p}_{2}={p\prime }_{1}+{p\prime }_{2}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}\left({F}_{\text{net}}=0\right) $$ 
</div>

or

<div data-type="equation" id="eip-485">
 $$ {m}_{1}{v}_{1}+{m}_{2}{v}_{2}={m}_{1}{v\prime }_{1}+{m}_{2}{v\prime }_{2}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}\left({F}_{\text{net}}=0\right), $$ 
</div>
...
<div data-type="equation" id="eip-940">
 $$ \frac{1}{2}{m}_{1}{ {v}_{1}}^{2}+\frac{1}{2}{m}_{2}{ {v}_{2}}^{2}=\frac{1}{2}{m}_{1}{ {v\prime }_{1}}^{2}+\frac{1}{2}{m}_{2}{ {v\prime }_{2}}^{2}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}\text{(two-object elastic collision)} $$ 
</div>
...
<div data-type="equation" id="eip-634">
 $$ {m}_{1}=0\text{.}\text{500 kg,}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}{m}_{2}=3\text{.}\text{50 kg,}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}{v}_{1}=4\text{.}\text{00 m/s, and}\phantom{\rule{0.25em}{0ex}}\phantom{\rule{0.25em}{0ex}}{v}_{2}=0\text{.} $$ 
</div>
...
by the fact that object 2 is initially at rest, and thus $$ {v}_{2}=0 $$. Once we simplify these equations, we combine them algebraically to solve for
the unknowns.

**Solution**

For this problem, note that $$ {v}_{2}=0 $$
...
Substituting this expression into the second equation (internal kinetic energy equation) eliminates the variable  $$ {v\prime }_{2} $$ 

, leaving only $$ {v\prime }_{1} $$
as an unknown (the algebra is left as an exercise for the reader). There are two
solutions to any quadratic equation; in this example, they are
...
4\text{.}\text{00}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{kg} $$, and the second a mass of $$
7\text{.}\text{50}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{kg} $$. If the two satellites collide elastically rather than dock, what is their
...
elastic collision
: a collision that also conserves internal kinetic energy {: #import-auto-id1345366}

internal kinetic energy
: the sum of the kinetic energies of the objects in a system {: #import-auto-id1193287}
