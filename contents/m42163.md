...
<div data-type="equation" id="eip-485">
 $$ {m}_{1}{v}_{1}+{m}_{2}{v}_{2}={m}_{1}{v^{\prime} }_{1}+{m}_{2}{v^{\prime} }_{2}\left({F}_{\text{net}}=0\right), $$ 
</div>
...
<div data-type="equation" id="eip-940">
 $$ \frac{1}{2}{m}_{1}{ v_{1}}^{2}+\frac{1}{2}{m}_{2}{ v_{2}}^{2}=\frac{1}{2}{m}_{1}{ {v^{\prime} }_{1}}^{2}+\frac{1}{2}{m}_{2}{ {v^{\prime} }_{2}}^{2}\text{(two-object elastic collision)} $$ 
</div>
...
<div data-type="equation" id="eip-634">
 $$ {m}_{1}=0\text{.}\text{500 kg,}{m}_{2}=3\text{.}\text{50 kg,}{v}_{1}=4\text{.}\text{00 m/s, and}{v}_{2}=0\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-901">
 $$ \frac{1}{2}{m}_{1}{ v_{1}}^{2}=\frac{1}{2}{m}_{1}{v^{\prime} }_{1}{}^{2}+\frac{1}{2}{m}_{2}{v^{\prime} }_{2}{}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-436">
 $$ {v^{\prime} }_{2}=\frac{ m_{1}}{ m_{2}}\left({v}_{1}-{v^{\prime} }_{1}\right). $$ 
</div>
...
<div data-type="equation" id="eip-560">
 $$ {v^{\prime} }_{2}=\frac{ m_{1}}{ m_{2}}\left({v}_{1}-{v^{\prime} }_{1}\right)=\frac{0\text{.}\text{500 kg}}{3\text{.}\text{50 kg}}\left[4.00-\left(-3.00\right)\right]\text{m/s} $$ 
</div>
or
...
intending to dock. The first has a mass of $$ 4.00 \times  10^{3}\text{kg} $$, and the second a mass of $$ 7.50 \times  10^{3}\text{kg} $$. If the two satellites collide elastically rather than dock, what is their
