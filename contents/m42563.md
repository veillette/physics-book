...
-ray photon with  $$f{= 10}^{21} \text{Hz} $$
 has an energy  $$E= hf=6.63 \times 10^{-13} \text{J}=4.14 \text{MeV.} $$
...
<div class="equation" id="eip-989">
 $$ hf=\left( 50.0 \times 10^{3} \right)\left(1.60 \times 10^{-19} \text{C}\cdot \text{V}\right)\left(\frac{1 \text{eV}}{1.60 \times 10^{-19} \text{C}\cdot \text{V}}\right)=\left( 50.0 \times 10^{3} \right)\left(1 \text{eV}\right)=50.0 \text{keV.} $$
</div>
**Discussion**
...
In an x-ray tube, the maximum photon energy is given by  $$ hf=qV. $$
 Would it be technically more correct to say  $$ hf=qV+\text{BE,} $$
...
Do the unit conversions necessary to show that  $$hc=1240 \text{eV}\cdot \text{nm,} $$
 as stated in the text.

</div>
<div class="solution" id="eip-91">
<div class="equation" id="eip-41">
 $$\begin{array}{lll}hc& =& \left( 6.62607 \times 10^{-34}  \text{J} \cdot \text{s}\right)\left( 2.99792 \times 10^{8}  \text{m/s}\right)\left(\frac{ 10^{9} \text{nm}}{1 m}\right)\left(\frac{1.00000 \text{eV}}{ 1.60218 \times 10^{-19}  \text{J}}\right)\\ & =& 1239.84 \text{eV}\cdot \text{nm}\\ & \approx & 1240 \text{eV}\cdot \text{nm}\end{array} $$
</div>
</div>
</div>
