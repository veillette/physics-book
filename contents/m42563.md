...
<div data-type="equation" id="eip-177">
 $$E= hf=\frac{\text{hc}}{\lambda }\text{(energy of a photon),} $$
</div>
...
The maximum photon energy is  $$ hf=\text{qV} $$
, where  $$\text{q} $$
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
In an x-ray tube, the maximum photon energy is given by  $$ hf=\text{qV}. $$
 Would it be technically more correct to say  $$ hf=\text{qV}+\text{BE,} $$
...
<div data-type="equation" id="eip-41">
 $$\begin{array}{lll}\text{hc}& =& \left( 6.62607 \times 10^{-34}  J\cdot s\right)\left( 2.99792 \times 10^{8}  \text{m/s}\right)\left(\frac{ 10^{9} \text{nm}}{1 m}\right)\left(\frac{1.00000 \text{eV}}{ 1.60218 \times 10^{-19}  \text{J}}\right)\\ & =& 1239.84 \text{eV}\cdot \text{nm}\\ & \approx & 1240 \text{eV}\cdot \text{nm}\end{array} $$
</div>
</div>
</div>
