...
A photon is a quantum of EM radiation. Its energy is given by  $$E=\text{hf} $$
...
<div data-type="equation" id="eip-633">
 $$h=\text{4}\text{.}\text{14}×{\text{10}}^{\text{–15}} \text{eV}\cdot \text{s}. $$
</div>
...
All EM radiation is composed of photons. [\[link\]](#import-auto-id1317940) shows various divisions of the EM spectrum plotted against wavelength, frequency, and photon energy. Previously in this book, photon characteristics were alluded to in the discussion of some of the characteristics of UV, x rays, and  $$\gamma  $$
...
**Gamma rays**{: data-type="term" #import-auto-id2372507}, a form of nuclear and cosmic EM radiation, can have the highest frequencies and, hence, the highest photon energies in the EM spectrum. For example, a  $$\gamma  $$
-ray photon with  $$f{\text{= 10}}^{\text{21}} \text{Hz} $$
 has an energy  $$E=\text{hf}=6.63×{\text{10}}^{\text{–13}} \text{J}=4\text{.}\text{14 MeV.} $$
 ...
 rays are one type of **ionizing radiation**{: data-type="term" #import-auto-id1306466}, as are x rays and UV, because they produce ionization in materials that absorb them. Because so much ionization can be produced, a single  $$\gamma  $$
...
High photon energy also enables  $$\gamma  $$
 ...
 rays useful as a probe, and they are sometimes used in medical imaging. **x rays**{: data-type="term" #import-auto-id1519007}, as you can see in [\[link\]](#import-auto-id1317940), overlap with the low-frequency end of the  $$\gamma  $$
...
The maximum photon energy is  $$\text{hf}=\text{qV} $$
, where  $$\text{q} $$
 is the charge of the electron and  $$\text{V} $$
 is the accelerating voltage. Thus,

<div data-type="equation" id="eip-708">
 $$\text{hf}=\left(1\text{.}\text{60}×{\text{10}}^{\text{–19}} \text{C}\right)\left(\text{50.0}×{\text{10}}^{3} \text{V}\right)\text{.} $$
</div>
From the definition of the electron volt, we know  $$\text{1 eV}=\text{1}\text{.}\text{60}×{\text{10}}^{\text{–19}} \text{J} $$
, where  $$\text{1 J}=1 C\cdot V. $$
 Gathering factors and converting energy to eV yields

<div data-type="equation" id="eip-989">
 $$\text{hf}=\left(\text{50.0}×{\text{10}}^{3}\right)\left(1.60×{\text{10}}^{\text{–19}} \text{C}\cdot \text{V}\right)\left(\frac{\text{1 eV}}{1.60×{\text{10}}^{\text{–19}} \text{C}\cdot \text{V}}\right)=\left(\text{50.0}×{\text{10}}^{3}\right)\left(\text{1 eV}\right)=\text{50.0 keV.} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-533">
 $$E=\text{hf}=\frac{\text{hc}}{\lambda }. $$
</div>
Using  $$\text{hc}=\text{1240 eV}\cdot \text{nm,} $$
 we find that

<div data-type="equation" id="eip-957">
 $$E=\frac{\text{hc}}{\lambda }=\frac{\text{1240 eV}\cdot \text{nm}}{\text{100 nm}}=\text{12}\text{.}\text{4 eV}. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-252">
 $$E=\frac{\left(6\text{.}\text{63}×{\text{10}}^{\text{–34}} \text{J}\cdot \text{s}\right)\left(3.00×{\text{10}}^{8} \text{m/s}\right)}{ \text{580}×{\text{10}}^{\text{–9}} \text{m}}=\text{3.43}×{\text{10}}^{\text{–19}} \text{J}. $$
</div>
The number of visible photons per second is thus

<div data-type="equation" id="eip-690">
 $$\text{photon/s}=\frac{\text{10.0 J/s}}{3\text{.}\text{43}×{\text{10}}^{\text{–19}} \text{J/photon}}=\text{2.92}×{\text{10}}^{\text{19}} \text{photon/s}. $$
</div>
**Discussion**
...
**Microwaves**{: data-type="term" #import-auto-id2657348} are the highest frequencies that can be produced by electronic circuits, although they are also produced naturally. Thus microwaves are similar to IR but do not extend to as high frequencies. There are states in water and other molecules that have the same frequency and energy as microwaves, typically about  $${\text{10}}^{\text{–5}} \text{eV.} $$
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
In an x-ray tube, the maximum photon energy is given by  $$\text{hf}=\text{qV}. $$
 Would it be technically more correct to say  $$\text{hf}=\text{qV}+\text{BE,} $$
...
<div data-type="solution" markdown="1">
 $$6.34×{\text{10}}^{-9} \text{eV} $$
,  $$1.01×{\text{10}}^{-27} \text{J} $$
</div>
</div>
...
<div data-type="solution" markdown="1">
 $$2\text{.}\text{42}×{\text{10}}^{\text{20}} \text{Hz} $$
</div>
</div>
...
Do the unit conversions necessary to show that  $$\text{hc}=\text{1240 eV}\cdot \text{nm,} $$
 as stated in the text.

</div>
<div data-type="solution" id="eip-91">
<div data-type="equation" id="eip-41">
 $$\begin{array}{lll}\text{hc}& =& \left(\text{6.62607}×{\text{10}}^{-\text{34}} J\cdot s\right)\left(\text{2.99792}×{\text{10}}^{8} \text{m/s}\right)\left(\frac{ {\text{10}}^{9} \text{nm}}{1 m}\right)\left(\frac{\text{1.00000 eV}}{\text{1.60218}×{\text{10}}^{-\text{19}} \text{J}}\right)\\ & =& \text{1239.84 eV}\cdot \text{nm}\\ & \approx & \text{1240 eV}\cdot \text{nm}\end{array} $$
</div>
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the energy in eV of an IR photon of frequency  $$\text{2.00}×{\text{10}}^{\text{13}} \text{Hz.} $$
 (b) How many of these photons would need to be absorbed simultaneously by a tightly bound molecule to break it apart? (c) What is the energy in eV of a  $$\gamma  $$
 ray of frequency  $$3\text{.}\text{00}×{\text{10}}^{\text{20}} \text{Hz?} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Prove that, to three-digit accuracy,  $$h=4\text{.}\text{14}×{\text{10}}^{-\text{15}} \text{eV}\cdot s, $$
 as stated in the text.
...
<div data-type="solution" markdown="1">
(a)  $$\text{25.0}×{\text{10}}^{3} \text{eV} $$
(b)  $$\text{6}\text{.}\text{04}×{\text{10}}^{\text{18}} \text{Hz} $$
</div>
</div>
...
<div data-type="solution" markdown="1">
(a)  $$\text{1}\text{.}\text{25}×{\text{10}}^{\text{13}} \text{photons/s} $$
(b) 997 km
...
<div data-type="solution" markdown="1">
 $$\text{8.33}×{\text{10}}^{\text{13}} \text{photons/s} $$
</div>
</div>
