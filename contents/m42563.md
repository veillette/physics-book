...
All EM radiation is composed of photons. [[Figure 1]](#Figure1) shows various divisions of the EM spectrum plotted against wavelength, frequency, and photon energy. Previously in this book, photon characteristics were alluded to in the discussion of some of the characteristics of UV, x rays, and  $$\gamma  $$
...
High photon energy also enables  $$\gamma  $$
 ...
 rays useful as a probe, and they are sometimes used in medical imaging. **x rays**, as you can see in [[Figure 1]](#Figure1), overlap with the low-frequency end of the  $$\gamma  $$
 ...
 rays and are slightly less hazardous. X rays are ideal for medical imaging, their most common use, and a fact that was recognized immediately upon their discovery in 1895 by the German physicist W. C. Roentgen (1845–1923). (See [[Figure 2]](#Figure2).) Within one year of their discovery, x rays (for a time called Roentgen rays) were used for medical diagnostics. Roentgen received the 1901 Nobel Prize for the discovery of x rays.
