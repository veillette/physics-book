...
-ray photon with  $$f{= 10}^{\text{21}} \text{Hz} $$
 has an energy  $$E=\text{hf}=6.63 \times 10^{-13} \text{J}=4.14 \text{MeV.} $$
...
<div data-type="equation" id="eip-708">
 $$\text{hf}=\left( 1.60 \times 10^{-19} \text{C}\right)\left( 50.0 \times 10^{3}  \text{V}\right)\text{.} $$
</div>
From the definition of the electron volt, we know  $$1 \text{eV}= 1.60  \times 10^{-19} \text{J} $$
, where  $$1 \text{J}=1 C\cdot V. $$
 Gathering factors and converting energy to eV yields

<div data-type="equation" id="eip-989">
 $$\text{hf}=\left( 50.0 \times 10^{3} \right)\left(1.60 \times 10^{-19} \text{C}\cdot \text{V}\right)\left(\frac{1 \text{eV}}{1.60 \times 10^{-19} \text{C}\cdot \text{V}}\right)=\left( 50.0 \times 10^{3} \right)\left(1 \text{eV}\right)=\text{50.0 keV.} $$
</div>
**Discussion**
...
Using  $$\text{hc}=1240 \text{eV}\cdot \text{nm,} $$
 we find that

<div data-type="equation" id="eip-957">
 $$E=\frac{\text{hc}}{\lambda }=\frac{1240 \text{eV}\cdot \text{nm}}{100 \text{nm}}=12.4 \text{eV}. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-690">
 $$\text{photon/s}=\frac{\text{10.0 J/s}}{ 3.43 \times 10^{-19} \text{J/photon}}= 2.92 \times 10^{19}  \text{photon/s}. $$
</div>
**Discussion**
...
Do the unit conversions necessary to show that  $$\text{hc}=1240 \text{eV}\cdot \text{nm,} $$
 as stated in the text.

</div>
<div data-type="solution" id="eip-91">
<div data-type="equation" id="eip-41">
 $$\begin{array}{lll}\text{hc}& =& \left( 6.62607 \times 10^{-34}  J\cdot s\right)\left( 2.99792 \times 10^{8}  \text{m/s}\right)\left(\frac{ 10^{9} \text{nm}}{1 m}\right)\left(\frac{\text{1.00000 eV}}{ 1.60218 \times 10^{-19}  \text{J}}\right)\\ & =& \text{1239.84 eV}\cdot \text{nm}\\ & \approx & 1240 \text{eV}\cdot \text{nm}\end{array} $$
</div>
</div>
</div>
