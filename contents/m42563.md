...
<div data-type="equation" id="eip-989">
 $$\text{hf}=\left( 50.0 \times 10^{3} \right)\left(1.60 \times 10^{-19} \text{C}\cdot \text{V}\right)\left(\frac{1 \text{eV}}{1.60 \times 10^{-19} \text{C}\cdot \text{V}}\right)=\left( 50.0 \times 10^{3} \right)\left(1 \text{eV}\right)=50.0 \text{keV.} $$
</div>
**Discussion**
