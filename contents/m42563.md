...
<div data-type="equation" id="eip-252">
 $$E=\frac{\left(6\text{.}\text{63}×{\text{10}}^{\text{–34}} \text{J}\cdot \text{s}\right)\left( 3.00 \times 10^{8}  \text{m/s}\right)}{ \text{580}×{\text{10}}^{\text{–9}} \text{m}}=\text{3.43}×{\text{10}}^{\text{–19}} \text{J}. $$
</div>
...
(a) Calculate the energy in eV of an IR photon of frequency  $$\text{2.00}×{\text{10}}^{\text{13}} \text{Hz.} $$
 ...
 ray of frequency  $$ 3.00 \times 10^{20}  \text{Hz?} $$
