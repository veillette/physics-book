...
-ray photon with $$f{\text{= 10}}^{\text{21}}\phantom{\rule{0.25em}{0ex}}\text{Hz}$$
 has an energy $$E=\text{hf}=6.63×{\text{10}}^{\text{–13}}\phantom{\rule{0.25em}{0ex}}\text{J}=4\text{.}\text{14 MeV.}$$
...
$$\text{hf}=\left(1\text{.}\text{60}×{\text{10}}^{\text{–19}}\phantom{\rule{0.25em}{0ex}}\text{C}\right)\left(\text{50.0}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{V}\right)\text{.}$$
</div>
From the definition of the electron volt, we know $$\text{1 eV}=\text{1}\text{.}\text{60}×{\text{10}}^{\text{–19}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
, where $$\text{1 J}=1 C\cdot V.$$
 Gathering factors and converting energy to eV yields

<div data-type="equation" id="eip-989">
$$\text{hf}=\left(\text{50.0}×{\text{10}}^{3}\right)\left(1.60×{\text{10}}^{\text{–19}}\phantom{\rule{0.25em}{0ex}}\text{C}\cdot \text{V}\right)\left(\frac{\text{1 eV}}{1.60×{\text{10}}^{\text{–19}}\phantom{\rule{0.25em}{0ex}}\text{C}\cdot \text{V}}\right)=\left(\text{50.0}×{\text{10}}^{3}\right)\left(\text{1 eV}\right)=\text{50.0 keV.}$$
</div>
**Discussion**
...
**Microwaves**{: data-type="term" #import-auto-id2657348} are the highest frequencies that can be produced by electronic circuits, although they are also produced naturally. Thus microwaves are similar to IR but do not extend to as high frequencies. There are states in water and other molecules that have the same frequency and energy as microwaves, typically about $${\text{10}}^{\text{–5}}\phantom{\rule{0.25em}{0ex}}\text{eV.}$$
...
$$6.34×{\text{10}}^{-9}\phantom{\rule{0.25em}{0ex}}\text{eV}$$
, $$1.01×{\text{10}}^{-27}\phantom{\rule{0.25em}{0ex}}\text{J}$$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the energy in eV of an IR photon of frequency $$\text{2.00}×{\text{10}}^{\text{13}}\phantom{\rule{0.25em}{0ex}}\text{Hz.}$$
 ...
 ray of frequency $$3\text{.}\text{00}×{\text{10}}^{\text{20}}\phantom{\rule{0.25em}{0ex}}\text{Hz?}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Prove that, to three-digit accuracy, $$h=4\text{.}\text{14}×{\text{10}}^{-\text{15}}\phantom{\rule{0.25em}{0ex}}\text{eV}\cdot s,$$
 as stated in the text.
