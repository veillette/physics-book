...
<div data-type="equation" id="eip-708">
 $$\text{hf}=\left(1\text{.}\text{60}×{\text{10}}^{\text{–19}} \text{C}\right)\left( 50.0 \times 10^{3}  \text{V}\right)\text{.} $$
</div>
...
<div data-type="equation" id="eip-989">
 $$\text{hf}=\left( 50.0 \times 10^{3} \right)\left(1.60×{\text{10}}^{\text{–19}} \text{C}\cdot \text{V}\right)\left(\frac{\text{1 eV}}{1.60×{\text{10}}^{\text{–19}} \text{C}\cdot \text{V}}\right)=\left( 50.0 \times 10^{3} \right)\left(\text{1 eV}\right)=\text{50.0 keV.} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-690">
 $$\text{photon/s}=\frac{\text{10.0 J/s}}{3\text{.}\text{43}×{\text{10}}^{\text{–19}} \text{J/photon}}= 2.92 \times 10^{19}  \text{photon/s}. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-41">
 $$\begin{array}{lll}\text{hc}& =& \left( 6.62607 \times 10^{-34}  J\cdot s\right)\left( 2.99792 \times 10^{8}  \text{m/s}\right)\left(\frac{ {\text{10}}^{9} \text{nm}}{1 m}\right)\left(\frac{\text{1.00000 eV}}{ 1.60218 \times 10^{-19}  \text{J}}\right)\\ & =& \text{1239.84 eV}\cdot \text{nm}\\ & \approx & \text{1240 eV}\cdot \text{nm}\end{array} $$
</div>
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the energy in eV of an IR photon of frequency  $$ 2.00 \times 10^{13}  \text{Hz.} $$
