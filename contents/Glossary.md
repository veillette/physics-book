...
$$\gamma $$ | gamma rays | | $$\gamma $$ | surface tension | | $$\gamma =1/\sqrt{1-{v}^{2}/{c}^{2} } $$ | a constant used in relativity | | $$\Delta $$ |
...
$${\overline{\rho } }_{\text{obj} } $$ | average density of an object | | $$\rho /{\rho }_{\text{w} } $$ | specific gravity | | $$\tau $$ | characteristic time
...
$$a $$ | acceleration | | $${a}_{\text{B} } $$ | Bohr radius | | $${a}_{\text{c} } $$ | centripetal acceleration | | $${a}_{\text{t} } $$ | tangential acceleration
| | $$\text{AC} $$ | alternating current | | $$\text{AM} $$ | amplitude
modulation | | $$\text{atm} $$ | atmosphere | | $$B $$ | baryon number | | $$B $$ | blue quark color | | $$\overline{B} $$ | antiblue (yellow) antiquark color
...
past a point | | $$+Q $$ | positive charge | | $$-Q $$ | negative charge | | $$q $$ | electron charge | | $${q}_{p} $$ | charge of a proton | | $$q $$ | test
...
temperature—temperature below which a material becomes a superconductor | | $$T $$ | tension | | $$\text{T} $$ | tesla (magnetic field strength *B*) | | $$t $$ | quark flavor top or truth | | $$t $$ | time | | $${t}_{1/2} $$ | half-life—the
