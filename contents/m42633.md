...
If you examine the periodic table of the elements, you will find that Th has  $$Z=90 $$
, two fewer than U, which has  $$Z=92 $$
. Similarly, in the second **decay equation**{: data-type="term"}, we see that U has two fewer protons than Pu, which has  $$Z=94 $$
...
. The final mass is the sum  $$m{\left(}^{\text{235}}\text{U}\right)\text{+}m{\left(}^{4}\text{He}\right)= 235\text{.}\text{043924 u + 4.002602 u = 239.046526 u} $$
. Thus,

<div data-type="equation" id="eip-495">
 $$\begin{array}{lll}\Delta m& =& m{\left(}^{\text{239}}\text{Pu}\right)-\left[m{\left(}^{\text{235}}\text{U}\right)+m\left({}^{4}\text{He}\right)\right]\\ & =&  \text{239.052157 u}-\text{239.046526 u}\\ & =& \text{0.0005631 u.}\end{array} $$
</div>
Now we can find  $$E $$
 by entering  $$\Delta m $$
 into the equation:
...
<div data-type="equation" id="eip-101">
 $$E=\left(0.005631\right)\left(\text{931.5 MeV}/{c}^{2}\right)\left({c}^{2}\right)=\text{5.25 MeV}. $$
</div>
**Discussion**
...
. In the example of the  $${\beta }^{-} $$
 ...
 given earlier, we see that  $$Z=27 $$
 for Co and  $$Z=28 $$
...
We see that charge is conserved in  $${\beta }^{-} $$
 ...
 decay, total charge is 27 before decay, since cobalt has  $$Z=27 $$
. After decay, the daughter nucleus is Ni, which has  $$Z=28 $$
...
<div data-type="equation" id="eip-19">
 $$E=\left(0.003031\right)\left(931.5 MeV/{c}^{2}\right)\left({c}^{2}\right)=2\text{.}\text{82 MeV.} $$
</div>
...
. Since an antimatter member of the electron family (the  $${\beta }^{+} $$
  ...
  $${\beta }^{+} $$
 decays, you can write its full decay equation by first finding that  $$Z=11 $$
 for  $${}^{\text{22}}\text{Na} $$
, so that the daughter nuclide will have  $$Z=10 $$
, the atomic number for neon. Thus the  $${\beta }^{+} $$
 decay equation for  $${}^{\text{22}}\text{Na} $$
 is

<div data-type="equation" id="eip-720">
 $${}_{\text{11}}^{\text{22}}{\text{Na}}_{\text{11}}\to {}_10^{\text{22}}{\text{Ne}}_{\text{12}}+{\beta }^{+}+{\nu }_{e}. $$
</div>
