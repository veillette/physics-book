...
Some nuclides are stable, apparently living forever. Unstable nuclides decay (that is, they are radioactive), eventually producing a stable nuclide after many decays. We call the original nuclide the **parent** and its decay products the **daughters**. Some radioactive nuclides decay in a single step to a stable nucleus. For example,  $${}^{\text{60}}\text{Co} $$
 is unstable and decays directly to  $${}^{\text{60}}\text{Ni} $$
, which is stable. Others, such as  $${}^{\text{238}}\text{U} $$
, decay to another unstable nuclide, resulting in a **decay series** in which each subsequent nuclide decays until a stable nuclide is finally produced. The decay series that starts from  $${}^{\text{238}}\text{U} $$
...
Here,  $$E $$
 is the **nuclear reaction energy** (the reaction can be nuclear decay or any other reaction), and  $$\Delta m $$
...
. The neutrino in  $${\beta }^{-} $$
 decay is an **electron’s antineutrino**, given the symbol  $${\overline{\nu }}_{e} $$
, where  $$\nu  $$
...
decay. Certain nuclides decay by the emission of a *positive* electron. This is **antielectron** or **positron decay** (see [\[link\]](#import-auto-id3250027)).
...
where Y is the nuclide having one less proton than X (to conserve charge) and  $${\nu }_{e} $$
 is the symbol for the **electron’s neutrino**, which has an electron family number of  $$+1 $$
...
**Electron capture**{: data-type="term"} is the third type of beta decay. Here, a nucleus captures an inner-shell electron and undergoes a nuclear reaction that has the same effect as  $${\beta }^{+} $$
 ...
 is known to undergo electron capture, then its **electron capture equation** is
