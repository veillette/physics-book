...
, all of which are listed in [Appendix A](/m42699). The initial mass was  $$m{\left(}^{\text{239}}\text{Pu}\right)=\text{239}\text{.}052157 \text{u} $$
. The final mass is the sum  $$m{\left(}^{\text{235}}\text{U}\right)\text{+}m{\left(}^{4}\text{He}\right)= 235\text{.}043924 \text{u + 4.002602 u = 239.046526 u} $$
. Thus,

<div data-type="equation" id="eip-495">
 $$\begin{array}{lll}\Delta m& =& m{\left(}^{\text{239}}\text{Pu}\right)-\left[m{\left(}^{\text{235}}\text{U}\right)+m\left({}^{4}\text{He}\right)\right]\\ & =&  239.052157 \text{u}-239.046526 \text{u}\\ & =& 0.0005631 \text{u.}\end{array} $$
</div>
Now we can find  $$E $$
 by entering  $$\Delta m $$
 into the equation:
...
<div data-type="equation" id="eip-592">
 $$\Delta m=\text{59}\text{.}933820 \text{u}-59.930789 \text{u}=0.003031 \text{u}. $$
</div>
Thus,
...
<div data-type="equation" id="eip-19">
 $$E=\left(0.003031\right)\left(931.5 MeV/{c}^{2}\right)\left({c}^{2}\right)=2\text{.}82 \text{MeV.} $$
</div>
