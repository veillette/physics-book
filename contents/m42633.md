...
decay equation**{: class="term"}, we see that U has two fewer protons than Pu,
...
in [Atomic Physics](/m42585), the general relationship is
...
the products have less mass will be discussed in [Binding Energy](/m42640). Note
...
having a positive charge and an electron family number of $$-1 $$ . When a **
positron**{: class="term"} encounters an electron, there is a mutual
