...
, decay to another unstable nuclide, resulting in a **decay series** in which each subsequent nuclide decays until a stable nuclide is finally produced. The decay series that starts from  $${}^{238}\text{U} $$
 ...
 and  $${}^{210}\text{Po} $$
, which the Curies first discovered (see [\[link\]](#import-auto-id1930472)). Radon gas is also produced ( $${}^{222}\text{Rn} $$
...
In **alpha decay**{: class="term"}, a  $${}^{4}\text{He} $$
 ...
 decay is shown in [\[link\]](#import-auto-id1930472) for  $${}^{238}\text{U} $$
...
The decay equation was given earlier for  $${}^{239}\text{Pu} $$
 ; it is
...
. The final mass is the sum  $$m\left( {}^{235}\text{U}\right)+ m \left({}^{4}\text{He}\right)= 235.043924 \text{u + 4.002602 u = 239.046526 u} $$
. Thus,

<div class="equation" id="eip-495">
 $$\begin{array}{lll}\Delta m& =& m\left({}^{239}\text{Pu}\right)-\left[m\left({}^{235}\text{U}\right)+m\left({}^{4}\text{He}\right)\right]\\ & =&  239.052157 \text{u}-239.046526 \text{u}\\ & =& 0.0005631 \text{u.}\end{array} $$
</div>
Now we can find  $$E $$
 by entering  $$\Delta m $$
 into the equation:
...
<div class="equation" id="eip-799">
 $${}^{60}\text{Co}\to {}^{60}\text{Ni}+{\beta }^{-}+\text{neutrino.} $$
</div>
...
* {: #import-auto-id2600265}  $${\beta }^{-} $$ is an electron,
