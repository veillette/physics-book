...
, all of which are listed in [Appendix A](/m42699). The initial mass was  $$m{\left(}^{\text{239}}\text{Pu}\right)=239.052157 \text{u} $$
. The final mass is the sum  $$m{\left(}^{\text{235}}\text{U}\right)\text{+}m{\left(}^{4}\text{He}\right)= 235.043924 \text{u + 4.002602 u = 239.046526 u} $$
. Thus,
...
<div data-type="equation" id="eip-19">
 $$E=\left(0.003031\right)\left(931.5 MeV/{c}^{2}\right)\left({c}^{2}\right)=2.82 \text{MeV.} $$
</div>
