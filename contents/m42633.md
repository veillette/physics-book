...
. The final mass is the sum  $$m{\left(}^{235}\text{U}\right)\text{+}m{\left(}^{4}\text{He}\right)= 235.043924 \text{u + 4.002602 u = 239.046526 u} $$
. Thus,
...
A rare decay mode has been observed in which  $${}^{222}\text{Ra} $$
 emits a  $${}^{14}C $$
 nucleus. (a) The decay equation is  $${}^{222}\text{Ra}{\to }^{A}{\text{X+}}^{14}\text{C} $$
