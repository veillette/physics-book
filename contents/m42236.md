...
The basic components of a heat pump in its heating mode are shown in [[Figure 1]](#Figure1). A working fluid such as a non-CFC refrigerant is used. In the outdoor coils (the evaporator), heat transfer  $${Q}_{\text{c}} $$ occurs to the working fluid from the cold outdoor air, turning it into a gas.
