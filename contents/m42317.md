...
A near uniform electric field of approximately 150 N/C, directed downward, surrounds Earth, with the magnitude increasing slightly as we get closer to the surface. What causes the electric field? At around 100 km above the surface of Earth we have a layer of charged particles, called the **ionosphere**. The ionosphere is responsible for a range of phenomena including the electric field surrounding Earth. In fair weather the ionosphere is positive and the Earth largely negative, maintaining the electric field ([\[link\]](#import-auto-id3162895)(a)).
...
<div class="exercise" data-element-type="conceptual-questions">
<div class="problem" markdown="1">
Using the symmetry of the arrangement, show that the net Coulomb force on the charge  $$q $$  at the center of the square below ([[link]](#import-auto-id3009601)) is zero if the charges on the four corners are exactly equal.

</div>
</div>

 ![Four point charges, one is q a, second is q b, third is q c, and fourth is q d, lie on the corners of a square. q is located at its center.](../resources/Figure_19_07_12a.jpg "Four point charges \( q_{a} \), \( q_{b} \), \( q_{c} \), and \( q_{d} \) lie on the corners of a square and \( q \)  is located at its center."){: #import-auto-id3009601}
...
Using the symmetry of the arrangement, determine the direction of the force on  $$q $$
 in the figure below, given that  $${q}_{a}={q}_{b}\text{=+}7.50 \text{μC} $$
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
(a) Using the symmetry of the arrangement, determine the direction of the electric field at the center of the square in [[link]](#import-auto-id2617305), given that  $${q}_{a}={q}_{b}=-1.00 \text{μC} $$
 and  $${q}_{c}={q}_{d}\text{=+}1.00 \text{μC} $$ .
...
Find the electric field at the location of  $${q}_{a} $$
 in [[link]](#import-auto-id2617305) given that  $${q}_{b}={q}_{c}={q}_{d}\text{=+}2.00 \text{nC} $$ ,
  $$q=-1.00 \text{nC} $$ ,
...
Find the total Coulomb force on the charge  $$q $$
 in [[link]](#import-auto-id2617305), given that  $$q=1.00 \text{μC} $$ ,
  $${q}_{a}=2.00 \text{μC} $$ ,
  $${q}_{b}=-3.00 \text{μC} $$ ,
  $${q}_{c}=-4.00 \text{μC} $$ ,
 and  $${q}_{d}\text{=+}1.00 \text{μC} $$ .
...
(a) Find the electric field at the location of  $${q}_{a} $$
 in [[link]](#import-auto-id1427585), given that  $${q}_{\text{b}}=+10.00 \mu \text{C} $$
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
(a) Find the electric field at the center of the triangular configuration of charges in [[link]](#import-auto-id1427585), given that  $${q}_{a}\text{=+}2.50 \text{nC} $$ ,
  $${q}_{b}=-8.00 \text{nC} $$ ,
 and  $${q}_{c}\text{=+}1.50 \text{nC} $$ .
