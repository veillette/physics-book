...
Find the electric field at the location of  $${q}_{a} $$
 in [[link]](#import-auto-id2617305) given that  $${q}_{b}={q}_{c}={q}_{d}=+2.00 \text{nC} $$ ,
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
(a) Find the electric field at the center of the triangular configuration of charges in [[link]](#import-auto-id1427585), given that  $${q}_{a}=+2.50 \text{nC} $$ ,
  $${q}_{b}=-8.00 \text{nC} $$ ,
