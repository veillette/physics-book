...
, and thus  $$W={F}_{\text{app}}d=\left[\left(1/2\right)kx\right]\left(x\right)=\left(1/2\right){\mathrm{kx}}^{2} $$
...
<div data-type="equation" id="import-auto-id1562251">
 $$\begin{array}{lll}{\text{PE}}_{\text{el}}& =& \frac{1}{2}{\mathrm{kx}}^{2}=\frac{1}{2}\left( 50.0 \text{N/m}\right){\left( 0.150 \text{m}\right)}^{2}= 0.563 \text{N}\cdot \text{m}\\ & =&  0.563 \text{J}\end{array} $$
</div>
**Strategy for b**
...
1.  {: #import-auto-id2052495} Identify known quantities:
    <div data-type="equation">
     $${\text{KE}}_{\text{f}}={\text{PE}}_{\text{el}} or 1/2{\mathit{mv}}^{2}=\left(1/2\right){\mathit{kx}}^{2}={\text{PE}}_{\mathrm{el}}= 0.563 \text{J} $$
    </div>
