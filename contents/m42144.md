...
{2}^{ 2}}=\frac{ r_{1}^{ 3}}{ r_{2}^{ 3}} $$. Let us use the subscript 1 for the Moon and the subscript 2 for the satellite.
We are asked to find $$ {T}_{2} $$. The given information tells us that the orbital radius of the Moon is $$ r_
{1}=3.84 \times  10^{8}\text{m} $$, and that the period of the Moon is $$ {T}_{1}=27.3 \text{d} $$. The height of the artificial satellite above Earth’s surface is given, and so
we must add the radius of Earth (6380 km) to get $$ r_{2}=\left(
1500}+6380}\right)
\text{km}=7880}\text{km}
...
<div data-type="equation" id="eip-113">
 $$ {T}_{2}^{ 2}=T_{1}^{ 2}{\left(\frac{ r_{2}}{ r_{1}}\right)}^{3} $$ 
</div>
<div data-type="equation" id="eip-925">
 $$ {T}_{2}=T_{1}{\left(\frac{ r_{2}}{ r_{1}}\right)}^{3/2}\text{.} $$ 
</div>
Substituting known values yields

<div data-type="equation" id="eip-552">
 $$ \begin{array}{lll}{T}_{2}& =& 27.3 \text{d}×\frac{24.0 \text{h}}{\text{d}}×{\left(\frac{7880 \text{km}}{3.84\times 10^{5}\text{km}}\right)}^{3/2}\\ & =& \text{1.93 h.}\end{array} $$ 
</div>
...
$$ F_{\text{net}}={\text{ma}}_{\text{c}}=m\frac{ v^{2}}{r}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-362">
 $$ G\frac{\text{M}}{r}=\frac{ 4\pi ^{2}{r}^{2}}{ T^{2}}\text{.} $$ 
</div>
