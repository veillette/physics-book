...
We are asked to find $$ {T}_{2} $$. The given information tells us that the orbital radius of the Moon is $$ {r}_
{1}=3.84 \times  10^{8}\text{m} $$, and that the period of the Moon is $$ {T}_{1}=\text{27.3 d} $$. The height of the artificial satellite above Earth’s surface is given, and so
...
<div data-type="equation" id="eip-113">
 $$ {T}_{2}^{ 2}={T}_{1}^{ 2}{\left(\frac{ r_{2}}{ r_{1}}\right)}^{3} $$ 
</div>
<div data-type="equation" id="eip-925">
 $$ {T}_{2}={T}_{1}{\left(\frac{ r_{2}}{ r_{1}}\right)}^{3/2}\text{.} $$ 
</div>
Substituting known values yields

<div data-type="equation" id="eip-552">
 $$ \begin{array}{lll}{T}_{2}& =& \text{27.3 d}×\frac{\text{24.0 h}}{\text{d}}×{\left(\frac{\text{7880 km}}{3.84\times 10^{5}\text{km}}\right)}^{3/2}\\ & =& \text{1.93 h.}\end{array} $$ 
</div>
