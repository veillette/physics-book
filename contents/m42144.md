...
{1}=3\text{.}\text{84}×{\text{10}}^{8}\phantom{\rule{0.25em}{0ex}}\text{m} $$, and that the period of the Moon is $$ {T}_{1}=\text{27.3 d} $$. The height of the artificial satellite above Earth’s surface is given, and so
