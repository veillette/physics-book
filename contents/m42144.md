...
Kepler’s third law, given in mathematical form in $$ \frac{ T_{1}^{ 2}}{ T_{2}^{
2}}=\frac{ r_{1}^{ 3}}{ r_{2}^{ 3}} $$. Let us use the subscript 1 for the Moon
...
\times 10^{8}\text{m} $$, and that the period of the Moon is $$ T_{1}=27.3
...
10^{4} $$ light years from its center. (a) What should the orbital period of
that star be? (b) If its period is $$ 6.0\times 10^{7} $$ years instead, what is
...
b)  $$ 1.05 \times 10^{3}\text{m/s} $$ c)  $$ 2.86 \times 10^{-7}\text{s} $$ d)
$$ 1.84 \times 10^{7}\text{N} $$ e)  $$ 2.76 \times 10^{4}\text{J} $$
</div>
</div>
