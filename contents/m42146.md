...
work on it, because the force is perpendicular to the motion. That is, $$
\cos90}\text{º
=}0 $$, and so $$ W=0 $$.
...
How much work is done on the lawn mower by the person in [\[link\]](#import-auto-id2495459)(a) if he exerts a constant force of  $$ 75.0\text{N} $$ 

at an angle $$35 \text{º} $$
...
<div data-type="equation">
 $$ \begin{array}{lll}W& =& \left(75.0 \text{N}\right)\left(25.0 \text{m}\right)\cos\left(\text{35.0º}\right)\\ & =& 1536 \text{J}=1.54\times 10^{3}\text{J.}\end{array} $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Calculate the work done by an 85.0-kg man who pushes a crate 4.00 m up along a ramp that makes an angle of  $$ 20.0\text{º} $$ 

with the horizontal. (See [[link]](#fs-id2047040).) He exerts a force of 500 N
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Suppose the ski patrol lowers a rescue sled and victim, having a total mass of 90.0 kg, down a  $$ 60.0\text{º} $$ 

slope at constant speed, as shown in [[link]](#import-auto-id2504152). The
