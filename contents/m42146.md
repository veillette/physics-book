...
<div data-type="equation">
 $$ W=\text{Fd}\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta . $$ 
</div>
...
<div data-type="equation">
 $$ W=\text{Fd}\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta \text{,} $$ 
</div>
where  $$ W $$ 
...
\cos\phantom{\rule{0.25em}{0ex}}\text{90}\text{º
=}\phantom{\rule{0.25em}{0ex}}0 $$, and so $$ W=0 $$.
...
displacement downward. This makes $$ \theta =\text{180}\text{º} $$, and $$ \text{cos 180}\text{º}=–1 $$
; therefore, $$ W $$
is negative.
...
1\phantom{\rule{0.25em}{0ex}}\text{J}=1\phantom{\rule{0.25em}{0ex}}\text{N}\cdot
\text{m}=1\phantom{\rule{0.25em}{0ex}}\text{kg}\cdot
...
\text{25}\text{.}0\phantom{\rule{0.25em}{0ex}}\text{m} $$
...
\text{10},\text{000}\phantom{\rule{0.25em}{0ex}}\text{kJ} $$
...
4\text{.}\text{184}\phantom{\rule{0.25em}{0ex}}\text{J} $$, while one *food calorie* (1 kcal) is equivalent to $$
\text{4184}\phantom{\rule{0.25em}{0ex}}\text{J} $$.
...
<div data-type="equation">
 $$ \begin{array}{lll}W& =& \left(\text{75.0 N}\right)\left(\text{25.0 m}\right)\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\left(\text{35.0º}\right)\\ & =& \text{1536 J}=\text{1.54}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{J.}\end{array} $$ 
</div>
...
a 35.0 N frictional force. He pushes in a direction  $$ \text{25}\text{.}0\text{º} $$ 
