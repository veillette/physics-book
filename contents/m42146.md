...
How much work is done on the lawn mower by the person in [\[link\]](#import-auto-id2495459)(a) if he exerts a constant force of  $$ \text{75}\text{.}0\text{N} $$ 
...
\text{10},\text{000}\text{kJ} $$
(about $$ \text{2400}\text{kcal} $$
...
4\text{.}\text{184}\text{J} $$, while one *food calorie* (1 kcal) is equivalent to $$
\text{4184}\text{J} $$.
...
<div data-type="equation">
 $$ \begin{array}{lll}W& =& \left(\text{75.0 N}\right)\left(\text{25.0 m}\right)\cos\left(\text{35.0º}\right)\\ & =& \text{1536 J}=\text{1.54}×{\text{10}}^{3}\text{J.}\end{array} $$ 
</div>
Converting the work in joules to kilocalories yields  $$ W=\left(\text{1536}\text{J}\right)\left(1\text{kcal}/\text{4184}\text{J}\right)=0\text{.}\text{367}\text{kcal} $$ 

. The ratio of the work done to the daily consumption is

<div data-type="equation">
 $$ \frac{W}{\text{2400}\text{kcal}}=1\text{.}\text{53}×{\text{10}}^{-4}\text{.} $$ 
</div>
**Discussion**
...
(a)  $$ 5\text{.}\text{92}×{\text{10}}^{5}\text{J} $$ 

(b)  $$ -5\text{.}\text{88}×{\text{10}}^{5}\text{J}
$$
