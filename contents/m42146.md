...
. Why is it you get tired just holding a load? The answer is that your muscles
...
displacement downward. This makes \\( \theta =\text{180}\text{º} \\)
...
g of water by \\( 1\text{º}\text{C} \\)

, and is equivalent to \\(
4\text{.}\text{184}\phantom{\rule{0.25em}{0ex}}\text{J} \\)
