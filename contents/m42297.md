...
<table id="import-auto-id3224075" summary="This table of sound perceptions consists of two columns. The left column gives a list of different types of perception, and the right column gives the physical quantity corresponding to each type of perception."><caption><span class="title">Sound Perceptions</span></caption><thead><tr>
            <th>Perception</th>
...
Why can a hearing test show that your threshold of hearing is 0 dB at 250 Hz, when [[link]](#Figure2) implies that no one can hear such a frequency at less than 20 dB?
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
Based on the graph in [[link]](#Figure1), what is the threshold of hearing in decibels for frequencies of 60, 400, 1000, 4000, and 15 000 Hz? Note that many AC electrical appliances produce 60 Hz, music is commonly 400 Hz, a reference frequency is 1000 Hz, your maximum sensitivity is near 4000 Hz, and many older TVs produce a 15 750 Hz whine.
