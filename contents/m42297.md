...
The ear is remarkably sensitive to low-intensity sounds. The lowest audible intensity or threshold is about  $${\text{10}}^{-\text{12}} {\text{W/m}}^{2} $$
...
<div data-type="solution" markdown="1">
(a)  $$2×{\text{10}}^{-\text{10}} {\text{W/m}}^{2} $$
(b)  $$2×{\text{10}}^{-\text{13}} {\text{W/m}}^{2} $$
</div>
</div>
