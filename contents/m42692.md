...
However, this estimate of  $${\rho }_{\text{c}} $$
 ...
 to  $$2%  $$
 of the critical density, far less than that needed for closure. Taking into account the amount of dark matter we detect indirectly and all other types of indirectly observed normal matter, there is only  $$10 \text{\%}  $$
 to  $$40 \text{\%}  $$
