...
unlimited distance in any direction. A universe that is closed is called **
positively curved**{: class="term"}. This means that if you travel far enough in
...
in [General Relativity and Quantum Gravity](/m42689).
...
We have noted in [Particles, Patterns, and Conservation Laws](/m42674) that
...
matter). These are called **weakly interacting massive particles**, or **WIMPs**
, and would also be chargeless, thus interacting negligibly with normal matter,
except through gravitation. One proposed group of WIMPs would have masses
several orders of magnitude greater than nucleons and are sometimes called **
neutralinos**. Others are called **axions** and would have masses about $$
