...
less than about $$15 \text{º} $$ ), $$\sin \theta \approx \theta $$
( $$\sin \theta $$ and $$\theta $$ differ by about 1% or less at smaller angles)
. Thus, for angles less than about $$15 \text{º} $$ , the restoring force $$F $$
is
...
by $$x=s $$ . For angles less than about $$15 \text{º} $$ , the restoring force
...
than about $$15 \text{º} $$ . For the simple pendulum:
...
$$ is less than about $$15 \text{º} $$ . Even simple pendulum clocks can be
...
that the angle of deflection is less than $$15 \text{º} $$.
