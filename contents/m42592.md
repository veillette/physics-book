...
supply. An electric field $$\mathbf{E} $$ is produced between the charging
plates, and the cathode-ray tube is placed between the poles of a magnet so that
the electric field $$\mathbf{\text{E}} $$ is perpendicular to the magnetic field
$$\mathbf{B} $$ of the magnet. These fields, being perpendicular to each other,
produce opposing forces on the electrons. As discussed for mass spectrometers
in [More Applications of Magnetism](/ch22MoreApplicationsOfMagnetism), if the net force due to the fields
vanishes, then the velocity of the charged particle is $$v=E/B $$ . In this
manner, Thomson determined the velocity of the electrons and then moved the beam
up and down by adjusting the electric field.
