...
* to an accuracy of 1%, and he improved this by a factor of 10 within a few years to a value of  $$ -1.60 \times 10^{-19}  \text{C} $$
...
<div data-type="equation" id="eip-848">
 $${m}_{e}=\frac{-\text{1.60}×{\text{10}}^{-\text{19}} \text{C}}{ -1.76 \times 10^{11}  \text{C/kg}} $$
</div>
