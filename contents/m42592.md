...
<div data-type="equation" id="eip-584">
 $$\frac{ {q}_{e}}{ {m}_{e}}=-1\text{.}\text{76}×{\text{10}}^{\text{11}} \text{C/kg (electron).} $$
</div>

This is a huge number, as Thomson realized, and it implies that the electron has a very small mass. It was known from electroplating that about  $${\text{10}}^{8} \text{C/kg} $$
...
<div data-type="equation" id="eip-62">
 $$\frac{ {q}_{p}}{ {m}_{p}}=\text{9.58}×{\text{10}}^{7} \text{C/kg}\left(proton\right), $$
</div>
...
Since Faraday’s experiments with electroplating in the 1830s, it had been known that about 100,000 C per mole was needed to plate singly ionized ions. Dividing this by the number of ions per mole (that is, by Avogadro’s number), which was approximately known, the charge per ion was calculated to be about  $$1\text{.}6×{\text{10}}^{-\text{19}} \text{C} $$
...
* to an accuracy of 1%, and he improved this by a factor of 10 within a few years to a value of  $$-1\text{.}\text{60}×{\text{10}}^{-\text{19}} \text{C} $$
...
<div data-type="equation" id="eip-848">
 $${m}_{e}=\frac{-\text{1.60}×{\text{10}}^{-\text{19}} \text{C}}{-1\text{.}\text{76}×{\text{10}}^{\text{11}} \text{C/kg}} $$
</div>

or

<div data-type="equation" id="eip-618">
 $${m}_{e}=9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg} \left(electron’s mass\right), $$
</div>
...
<div data-type="equation" id="eip-375">
 $${m}_{p}=1\text{.}\text{67}×{\text{10}}^{-\text{27}} \text{kg} \left(proton’s mass\right), $$
</div>
...
* {: #import-auto-id3357018} All electrons are identical and have a charge-to-mass ratio of
  <div data-type="equation" id="eip-683">
   $$\frac{ {q}_{e}}{ {m}_{e}}=-\text{1.76}×{\text{10}}^{\text{11}} \text{C/kg.} $$
  </div>
...
* The positive charge in the nuclei is carried by particles called protons, which have a charge-to-mass ratio of
  <div data-type="equation" id="eip-115">
   $$\frac{ {q}_{p}}{ {m}_{p}}=9\text{.}\text{57}×{\text{10}}^{7} \text{C/kg}\text{.} $$
  </div>

* Mass of electron,
  <div data-type="equation" id="eip-612">
   $${m}_{e}=9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg}\text{.} $$
  </div>

* Mass of proton,
  <div data-type="equation" id="eip-602">
   $${m}_{p}=1\text{.}\text{67}×{\text{10}}^{-\text{27}} \text{kg.} $$
  </div>
...
) has a diameter of  $$4\text{.}0×{\text{10}}^{-6} \text{m} $$
