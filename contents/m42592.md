...
![A black and white image of scientist J. J. Thomson wearing a coat and oval shaped spectacles.](../resources/Figure_31_02_01b1.jpg "J. J. Thomson (credit: www.firstworldwar.com, via Wikimedia Commons)"){: #Figure2}
...
The deflection is analyzed to get  $$a $$ ,  and  $$E $$
 ...
 can be obtained by bending the beam of electrons with the magnetic field. Since  $${F}_{\text{mag}}={q}_{e}vB={m}_{e}a $$ ,
 we have  $${q}_{e}/{m}_{e}=a/vB $$ .
...
This is a huge number, as Thomson realized, and it implies that the electron has a very small mass. It was known from electroplating that about  $$10^{8} \text{C/kg} $$
...
<div class="equation" id="eip-62">
 $$\frac{ {q}_{p}}{ {m}_{p}}= 9.58 \times 10^{7}  \text{C/kg}\left(proton\right), $$
</div>

where  $${q}_{p} $$
 is the charge of the proton and  $${m}_{p} $$
 is its mass. This ratio (to four significant figures) is 1836 times less charge per kilogram than for the electron. Since the charges of electrons and protons are equal in magnitude, this implies  $${m}_{p}=1836{m}_{e} $$ .
...
An American physicist, Robert Millikan (1868–1953) (see [\[link\]](#Figure3)), decided to improve upon Thomson’s experiment for measuring  $${q}_{e} $$
...
![Black and white image of physicist Robert Millikan wearing a jacket and a bow tie.](../resources/Figure_31_02_03a1.jpg "Robert Millikan (credit: Unknown Author, via Wikimedia Commons)"){: #Figure3}
...
where  $$d $$  is the separation of the plates and  $$V $$
 is the voltage that holds the drop motionless. (The same drop can be observed for several hours to see that it really is motionless.) By 1913 Millikan had measured the charge of the electron  $${q}_{e} $$  to an accuracy of 1%, and he improved this by a factor of 10 within a few years to a value of  $$ -1.60 \times 10^{-19}  \text{C} $$ .
...
Alpha particles were known to be the doubly charged positive nuclei of helium atoms that had kinetic energies on the order of  $$5 \text{MeV} $$
...
<div class="note" data-has-label="true" id="eip-660" class="interactive" data-label="" markdown="1">
<div class="title">
...
<div class="solution" id="eip-id1151342" markdown="1">
...
<div class="problem" id="eip-414" markdown="1">
...
<div class="solution" id="eip-210" markdown="1">
(a)  $$10.0 \text{μm} $$
