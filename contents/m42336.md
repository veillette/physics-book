...
Inverting to find $${C}_{\text{S}}$$
 yields $$
$${C}_{\text{S}}=\frac{\text{µF}}{1\text{.}\text{325}}=0\text{.}\text{755 µF}$$
.
...
$$\frac{1}{ {C}_{\text{S}}}=\frac{1}{ {C}_{1}}+\frac{1}{ {C}_{2}}=\frac{1}{1\text{.}\text{000} \text{μF}}+\frac{1}{5\text{.}\text{000} \text{μF}}=\frac{1\text{.}\text{200}}{\text{μF}}.$$
</div>
Inverting gives
...
$$\begin{array}{lll}{C}_{\text{tot}}& =& {C}_{\text{S}}+{C}_{\text{S}}\\ & =& 0\text{.}\text{833} \text{μF}+8\text{.}\text{000} \text{μF}\\ & =& 8\text{.}\text{833} \text{μF}.\end{array}$$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What total capacitances can you make by connecting a $$5\text{.}\text{00 µF}$$
 and an $$8\text{.}\text{00 µF}$$
 capacitor together?
...
(a) An $$8\text{.}\text{00 µF}$$
 capacitor is connected in parallel to another capacitor, producing a total capacitance of $$5\text{.}\text{00 µF}$$
