...
<div data-type="equation" id="eip-340">
 $$\frac{1}{ {C}_{\text{S}}}=\frac{1}{1.000 \text{µF}}+\frac{1}{5\text{.}000 \text{µF}}+\frac{1}{8\text{.}000 \text{µF}}=\frac{ 1.325}{\text{µF}} $$
</div>
...
<div data-type="equation" id="eip-247">
 $$\frac{1}{ {C}_{\text{S}}}=\frac{\text{40}}{40 \text{µF}}+\frac{8}{40 \text{µF}}+\frac{5}{40 \text{µF}}=\frac{\text{53}}{40 \text{µF}}, $$
</div>
so that

<div data-type="equation" id="eip-927">
 $${C}_{\text{S}}=\frac{40 \text{µF}}{\text{53}}=0.755 \text{µF}. $$
</div>
</div>
...
<div data-type="equation" id="eip-198">
 $${C}_{\text{p}}=1.000 \text{µF}+5\text{.}000 \text{µF}+8\text{.}000 \text{µF}= 14.000 µF. $$
</div>
...
<div data-type="solution" markdown="1">
 $$3.08 \text{µF} $$
 in series combination,  $$\text{13}\text{.}0 \text{µF} $$
