...
<div data-type="solution" markdown="1">
 $$ {F}_{\text{wall}}=1.43×{\text{10}}^{3}\text{N} $$ 
...
<div data-type="solution" markdown="1">
a)  $$ \text{2.55}{×10}^{3}\text{N, 16.3º to the left of vertical (i.e., toward the wall)} $$ 
...
b)  $$ F=2\text{.}0×{\text{10}}^{4}\text{N} $$, straight up.
