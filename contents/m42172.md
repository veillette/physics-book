...
A system is said to be in **stable equilibrium**{: data-type="term" #import-auto-id2720918}**** if, when displaced from equilibrium, it experiences
...
$$ F_{\text{wall}}=1.43\times 10^{3}\text{N} $$ 
...
<div data-type="solution" markdown="1">
a)  $$ 2.55\times 10^{3}\text{N}, 16.3^\circ  \text{ to the left of vertical (i.e., toward the wall)} $$ b) 0.292
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
A person carries a plank of wood 2.00 m long with one hand pushing down on it at one end with a force  $$ {\text{F}}_{1} $$ and the other hand holding it up at .500 m from the end of the plank with force
$$ {\text{F}}_{2} $$. If the plank has a mass of 20.0 kg and its center of gravity is at the middle
...
b)  $$ F=2.0\times 10^{4}\text{N} $$, straight up.
