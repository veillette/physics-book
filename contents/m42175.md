...
interest). The magnitude of the force of the biceps is $$  F_{\text{B}} $$
; that of the elbow joint is $$  F_{\text{E}} $$
; that of the weights of the forearm is $$  w_{\text{a}} $$, and its load is $$  w_{\text{b}} $$. Two of these are unknown ( $$  F_{\text{B}} $$
and $$  F_{\text{E}} $$
...
then the torque due to $$  F_{\text{E}} $$
is zero, and the only unknown becomes $$  F_{\text{B}} $$.
...
<div data-type="equation" id="eip-311">
 $$  F_{\text{B}}=\frac{\left(0.160\text{m}\right)\left(2.50\text{kg}\right)\left(9.80\text{m/s}^{2}\right)+\left(0.380\text{m}\right)\left(4.00\text{kg}\right)\left(9.80\text{m/s}^{2}\right)}{0.0400\text{m}} $$ 
</div>
which yields
...
Now, the combined weight of the arm and its load is  $$ \left(6.50 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)=63.7 \text{N} $$ 
...
downward force $$  F_{\text{E}} $$
<sub /> exerted by the humerus at the elbow joint equals 407 N, or 6.38 times the total weight supported. (The calculation of  $$  F_{\text{E}} $$ 
...
joint equals the weight supported—that is, $$ 470 \text{N}–407 \text{N}=63 \text{N} $$, approximately equal to the weight supported.) Forces in muscles and joints are
...
Consider the person lifting a heavy box with his back, shown in [\[link\]](#import-auto-id2552526). (a) Calculate the magnitude of the force  $$  F_{\text{B}}– $$ 
...
<div data-type="equation" id="eip-780">
 $$ \left(0.350 \text{m}\right)\left(55.0 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)+\left(0.500 \text{m}\right)\left(30.0 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)=\left(0.0800 \text{m}\right) F_{\text{B}}. $$ 
</div>
Solving for  $$  F_{\text{B}} $$ 

yields

<div data-type="equation" id="eip-826">
 $$  F_{\text{B}}=4.20\times 10^{3}\text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-864">
 $$ \frac{ F_{\text{B}}}{ w_{\text{ub}}+ w_{\text{box}}}=\frac{4200 \text{N}}{833 \text{N}}=5.04. $$ 
</div>
...
<div data-type="equation" id="eip-486">
 $$  F_{\text{V}y}– w_{\text{ub}}–w_{\text{box}}– F_{\text{B}}\text{sin 29.0º}=0. $$ 
</div>
Thus,

<div data-type="equation" id="eip-325">
 $$ \begin{array}{lll} F_{\text{V}y}& =& w_{\text{ub}}+w_{\text{box}}+ F_{\text{B}}\text{sin 29.0º}\\ & =& 833 \text{N}+\left(4200 \text{N}\right)\text{sin 29.0º}\end{array} $$ 
</div>
yielding

<div data-type="equation" id="eip-600">
 $$  F_{\text{V}y}=2.87\times 10^{3}\text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-341">
 $$  F_{\text{V}x}– F_{\text{B}}\text{cos 29.0º}=0 $$ 
</div>
yielding

<div data-type="equation" id="eip-425">
 $$  F_{\text{V}x}=3.67\times 10^{3}\text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-797">
 $$  F_{\text{V}}=\sqrt{ F_{\text{V}x}^{2}+ F_{\text{V}y}^{2}}=4.66\times 10^{3}\text{N.} $$ 
</div>
...
Note that the ratio of  $$  F_{\text{V}} $$ 

to the weight supported is

<div data-type="equation" id="eip-142">
 $$ \frac{ F_{\text{V}}}{ w_{\text{ub}}+w_{\text{box}}}=\frac{4660 \text{N}}{833 \text{N}}=5.59. $$ 
</div>
**Discussion**
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
 $$ \begin{array}{lll} F_{\text{B}}& =& \text{470 N;}r_{1}=\text{4.00 cm;}w_{\text{a}}=\text{2.50 kg;}r_{2}=\text{16.0 cm;}w_{\text{b}}=\text{4.00 kg;}r_{3}=38.0 \text{cm}\\  F_{\text{E}}& =& w_{\text{a}}\left(\frac{ r_{2}}{ r_{1}}-1\right)+w_{\text{b}}\left(\frac{ r_{3}}{ r_{1}}-1\right)\\ & =& \left(2.50 \text{kg}\right)\left(9.80\text{m}/{\text{s}}^{2}\right)\left(\frac{16.0 \text{cm}}{4.0 \text{cm}}–1\right)\\ & & +\left(4.00 \text{kg}\right)\left(9.80\text{m}/{\text{s}}^{2}\right)\left(\frac{38.0 \text{cm}}{4.00 \text{cm}}–1\right)\\ & =& 407 \text{N}\end{array} $$ 
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{c}1.1\times 10^{3}\text{N}\\ \theta =190}\text{º}\text{ccw from positive}x\text{axis}\end{array} $$ 
...
<div data-type="solution" data-element-type="problem-exercises" markdown="1">
 $$  F_{\text{V}}=97}\text{N,}\theta =\text{59º} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
We analyzed the biceps muscle example with the angle between forearm and upper arm set at  $$ \text{90º} $$ . Using the same numbers as in [[link]](#fs-id1169737940047), find the force
...
<div data-type="solution" data-element-type="problem-exercises" markdown="1">
(a)  $$  F_{\text{A}}=2.21 \times 10^{3}\text{N} $$ 

upward

(b)  $$  F_
{\text{B}}=2.94\times 10^{3}\text{N} $$
downward
...
<div data-type="solution" data-element-type="problem-exercises" markdown="1">
(a)  $$  F_{\text{teeth on bullet}}=1.2\times 10^{2}\text{N} $$ 
...
force constant $$ k=600}\text{N/m} $$. (a) How much is the rope stretched (past equilibrium) to provide the same
force$$ F_{\text{B}} $$
