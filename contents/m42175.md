...
\sin{29.0^\circ }\\ & =& 833 \text{N}+\left(4200 \text{N}\right)\sin{29.0^\circ }
\end{array} $$ 
</div>
yielding
...
\left(\frac{38.0 \text{cm}}{4.00 \text{cm}}–1\right)\\ & =& 407 \text{N}
\end{array} $$ 
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{c}1.1\times 10^{3}\text{N}\\ \theta =190^\circ\text{ccw from positive}x\text{axis}
\end{array} $$ 
