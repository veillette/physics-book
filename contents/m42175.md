...
Now, the combined weight of the arm and its load is  $$ \left(\text{6.50 kg}\right)\left(9.80{\text{m/s}}^{2}\right)=63.7 \text{N} $$ 
...
470 \text{N}–407 \text{N}=63 \text{N} $$, approximately equal to the weight supported.) Forces in muscles and joints are
...
<div data-type="equation" id="eip-780">
 $$ \left(0.350 \text{m}\right)\left(\text{55.0 kg}\right)\left(9.80{\text{m/s}}^{2}\right)+\left(\text{0.500 m}\right)\left(\text{30.0 kg}\right)\left(9.80{\text{m/s}}^{2}\right)=\left(\text{0.0800 m}\right) F_{\text{B}}. $$ 
</div>
...
<div data-type="equation" id="eip-486">
 $$  F_{\text{V}y}– w_{\text{ub}}–{w}_{\text{box}}– F_{\text{B}}\text{sin 29.0º}=0. $$ 
</div>
Thus,

<div data-type="equation" id="eip-325">
 $$ \begin{array}{lll} F_{\text{V}y}& =& {w}_{\text{ub}}+{w}_{\text{box}}+ F_{\text{B}}\text{sin 29.0º}\\ & =& 833 \text{N}+\left(4200 \text{N}\right)\text{sin 29.0º}\end{array} $$ 
</div>
yielding
...
<div data-type="equation" id="eip-142">
 $$ \frac{ F_{\text{V}}}{ w_{\text{ub}}+{w}_{\text{box}}}=\frac{4660 \text{N}}{833 \text{N}}=5.59. $$ 
</div>
**Discussion**
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
 $$ \begin{array}{lll} F_{\text{B}}& =& \text{470 N;}{r}_{1}=\text{4.00 cm;}{w}_{\text{a}}=\text{2.50 kg;}{r}_{2}=\text{16.0 cm;}{w}_{\text{b}}=\text{4.00 kg;}{r}_{3}=\text{38.0 cm}\\  F_{\text{E}}& =& {w}_{\text{a}}\left(\frac{ r_{2}}{ r_{1}}-1\right)+{w}_{\text{b}}\left(\frac{ r_{3}}{ r_{1}}-1\right)\\ & =& \left(\text{2.50 kg}\right)\left(9.80\text{m}/{\text{s}}^{2}\right)\left(\frac{\text{16.0 cm}}{\text{4.0 cm}}–1\right)\\ & & +\left(\text{4.00 kg}\right)\left(9.80\text{m}/{\text{s}}^{2}\right)\left(\frac{\text{38.0 cm}}{\text{4.00 cm}}–1\right)\\ & =& 407 \text{N}\end{array} $$ 
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{c}1.1×10^{3}\text{N}\\ \theta =190}\text{º}\text{ccw from positive}x\text{axis}\end{array} $$ 
