...
for equilibrium $$ \left(\text{net}\tau
=\text{0}\right) $$
becomes
...
<div data-type="equation" id="eip-574">
 $$ {F}_{\text{B}}=\frac{ r_{2}{w}_{\text{a}}+{r}_{3}{w}_{\text{b}}}{ r_{1}}. $$ 
</div>
Entering the known values gives

<div data-type="equation" id="eip-311">
 $$ {F}_{\text{B}}=\frac{\left(0\text{.}\text{160}\text{m}\right)\left(2\text{.}\text{50}\text{kg}\right)\left(9\text{.}\text{80}{\text{m/s}}^{2}\right)+\left(0\text{.}\text{380}\text{m}\right)\left(4\text{.}\text{00}\text{kg}\right)\left(9\text{.}\text{80}{\text{m/s}}^{2}\right)}{0\text{.}\text{0400}\text{m}} $$ 
</div>
which yields
...
Now, the combined weight of the arm and its load is  $$ \left(\text{6.50 kg}\right)\left(\text{9.80}{\text{m/s}}^{2}\right)=\text{63.7 N} $$ 

, so that the ratio of the force exerted by the biceps to the total weight is

<div data-type="equation" id="eip-476">
 $$ \frac{ F_{\text{B}}}{ w_{\text{a}}+{w}_{\text{b}}}=\frac{\text{470}}{\text{63}\text{.}7}=7\text{.}\text{38}. $$ 
</div>
**Discussion**
...
equilibrium $$ \left(
\text{net}\tau =\text{0}\right) $$
becomes

<div data-type="equation" id="eip-780">
 $$ \left(0\text{.}\text{350 m}\right)\left(\text{55.0 kg}\right)\left(\text{9.80}{\text{m/s}}^{2}\right)+\left(\text{0.500 m}\right)\left(\text{30.0 kg}\right)\left(9.80{\text{m/s}}^{2}\right)=\left(\text{0.0800 m}\right){F}_{\text{B}}. $$ 
</div>
...
<div data-type="equation" id="eip-826">
 $$ {F}_{\text{B}}=\text{4.20}×{\text{10}}^{\text{3}}\text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-864">
 $$ \frac{ F_{\text{B}}}{ w_{\text{ub}}+{w}_{\text{box}}}=\frac{\text{4200 N}}{\text{833 N}}=\text{5.04}. $$ 
</div>
...
<div data-type="equation" id="eip-349">
 $$ \text{net}{F}_{y}=0\text{and}\text{net}{F}_{x}=0. $$ 
</div>
...
<div data-type="equation" id="eip-486">
 $$ {F}_{\text{V}y}–{w}_{\text{ub}}–{w}_{\text{box}}–{F}_{\text{B}}\text{sin 29.0º}=0. $$ 
</div>
Thus,

<div data-type="equation" id="eip-325">
 $$ \begin{array}{lll}{F}_{\text{V}y}& =& {w}_{\text{ub}}+{w}_{\text{box}}+{F}_{\text{B}}\text{sin 29.0º}\\ & =& \text{833 N}+\left(\text{4200 N}\right)\text{sin 29.0º}\end{array} $$ 
</div>
yielding

<div data-type="equation" id="eip-600">
 $$ {F}_{\text{V}y}=\text{2.87}×{\text{10}}^{\text{3}}\text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-341">
 $$ {F}_{\text{V}x}–{F}_{\text{B}}\text{cos 29.0º}=0 $$ 
</div>
yielding

<div data-type="equation" id="eip-425">
 $$ {F}_{\text{V}x}=\text{3.67}×{\text{10}}^{\text{3}}\text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-797">
 $$ {F}_{\text{V}}=\sqrt{ F_{\text{V}x}^{2}+{F}_{\text{V}y}^{2}}=\text{4.66}×{10}^{3}\text{N.} $$ 
</div>
...
<div data-type="equation" id="eip-29">
 $$ \theta ={\tan}^{–1}\left(\frac{ F_{\text{V}y}}{ F_{\text{V}x}}\right)=\text{38.0º}. $$ 
</div>
...
<div data-type="equation" id="eip-142">
 $$ \frac{ F_{\text{V}}}{ w_{\text{ub}}+{w}_{\text{box}}}=\frac{\text{4660 N}}{\text{833 N}}=5\text{.}\text{59}. $$ 
</div>
**Discussion**
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
 $$ \begin{array}{lll}{F}_{\text{B}}& =& \text{470 N;}{r}_{1}=\text{4.00 cm;}{w}_{\text{a}}=\text{2.50 kg;}{r}_{2}=\text{16.0 cm;}{w}_{\text{b}}=\text{4.00 kg;}{r}_{3}=\text{38.0 cm}\\ {F}_{\text{E}}& =& {w}_{\text{a}}\left(\frac{ r_{2}}{ r_{1}}-1\right)+{w}_{\text{b}}\left(\frac{ r_{3}}{ r_{1}}-1\right)\\ & =& \left(\text{2.50 kg}\right)\left(9.80\text{m}/{\text{s}}^{2}\right)\left(\frac{\text{16.0 cm}}{\text{4.0 cm}}–1\right)\\ & & +\left(\text{4.00 kg}\right)\left(9.80\text{m}/{\text{s}}^{2}\right)\left(\frac{\text{38.0 cm}}{\text{4.00 cm}}–1\right)\\ & =& \text{407 N}\end{array} $$ 
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{c}1.1×{\text{10}}^{3}\text{N}\\ \theta =\text{190}\text{º}\text{ccw from positive}x\text{axis}\end{array} $$ 
...
<div data-type="solution" data-element-type="problem-exercises" markdown="1">
(a)  $$ {F}_{\text{A}}=2\text{.}\text{21}×{\text{10}}^{3}\text{N} $$ 

upward

(b)  $$ {F}_
{\text{B}}=\text{2.94}×{\text{10}}^{3}\text{N} $$
downward
...
<div data-type="solution" data-element-type="problem-exercises" markdown="1">
(a)  $$ {F}_{\text{teeth on bullet}}=\text{1.2}×{\text{10}}^{\text{2}}\text{N} $$ 
...
force constant $$ k=\text{600}\text{N/m} $$. (a) How much is the rope stretched (past equilibrium) to provide the same
force $$ {F}_{\text{B}} $$
