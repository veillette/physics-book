...
<sub /> exerted by the humerus at the elbow joint equals 407 N, or 6.38 times
...
equals the weight supported—that is, $$ 470 \text{N}–407 \text{N}=63 \text{N}
...
created by $$ {\mathbf{\text{w}}}_{\text{ub}} $$ and $$ {\mathbf{\text{w}}}_
{\text{box}}– $$ are clockwise, while that created by $$ {\mathbf{\text{F}}}_
...
(b)  $$ F_{\text{B}}=2.94\times 10^{3}\text{N} $$ downward
...
force constant $$ k=600 \text{N/m} $$. (a) How much is the rope stretched (past
equilibrium) to provide the same force $$ F_{\text{B}} $$ as in this example?
Assume the rope is held in the hand at the same location as the book. (b) What
force is on the biceps muscle if the exercise rope is pulled straight up so that
