...
<div data-type="equation" id="eip-859">
 $$ \begin{array}{c} a_{c}=\frac{ v^{2}}{r}\\  a_{c}={\mathrm{r\omega }}^{2}\end{array}\right\}\text{.} $$ 
</div>
We choose to use the second form:

<div data-type="equation" id="eip-562">
 $$  a_{c}={\mathrm{r\omega }}^{2}\text{,} $$ 
</div>
where  $$ \omega  $$ 
...
<div data-type="equation" id="eip-959">
 $$ \begin{array}{lll} a_{c}& =& {\mathrm{r\omega }}^{2}=\left(3.84 \times  10^{8}\text{m}\right)\left(2.66 \times 10^{-6}\text{rad/s}{\right)}^{2}\\ & =& 2.72×10^{-3}{\text{m/s.}}^{2}\end{array} $$ 
</div>
