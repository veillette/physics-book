...
<div data-type="equation" id="eip-939">
 $$ G=6.674 \times  10^{ -11 }\frac{\text{N}\cdot \text{m}^{2}}{ {\text{kg}}^{2}} $$ 
</div>
...
<div data-type="equation" id="eip-216">
 $$ g=\left(6.67 \times  10^{ -11 }\frac{\text{N}\cdot \text{m}^{2}}{ {\text{kg}}^{2}}\right)×\frac{5.98 \times  10^{24}\text{kg}}{\left(6.38 \times  10^{6}\text{m}{\right)}^{2}}\text{,} $$ 
</div>
...
<div data-type="equation" id="eip-972">
 $$ \begin{array}{lll}g& =& G\frac{M}{ r^{2}}=\left(6.67 \times  10^{ -11 }\frac{\text{N}\cdot \text{m}^{2}}{ {\text{kg}}^{2}}\right)×\frac{5.98 \times  10^{24}\text{kg}}{\left(3.84 \times  10^{8}\text{m}{\right)}^{2}}\\ & =& 2.70 \times 10^{-3}{\text{m/s.}}^{2}\end{array} $$ 
</div>
**Strategy for (b)**
...
<div data-type="equation" id="eip-859">
 $$ \begin{array}{c} a_{c}=\frac{ v^{2}}{r}\\  a_{c}=r \omega^{2}\end{array}\right\}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-281">
 $$ 1 d\times 24\frac{\text{hr}}{\text{d}}\times 60\frac{min}{\text{hr}}\times 60\frac{s}{\text{min}}=\text{86 400 s} $$ 
</div>
we see that

<div data-type="equation" id="eip-54">
 $$ \omega =\frac{\Delta \theta }{\Delta t}=\frac{2\pi \text{rad}}{\left(27.3 \text{d}\right)\left(\text{86 400 s/d}\right)}=2.66 \times 10^{-6}\frac{\text{rad}}{\text{s}}. $$ 
</div>
The centripetal acceleration is

<div data-type="equation" id="eip-959">
 $$ \begin{array}{lll} a_{c}& =& r \omega^{2}=\left(3.84 \times  10^{8}\text{m}\right)\left(2.66 \times 10^{-6}\text{rad/s}{\right)}^{2}\\ & =& 2.72\times 10^{-3}{\text{m/s.}}^{2}\end{array} $$ 
</div>
...
* {: #import-auto-id3449413} Newton’s universal law of gravitation: Every
  ...
  G=6.674 \times  10^{\text{–11}}\text{N}\cdot
  \text{m}^{2}{\text{/kg}}^{2} $$
  .
...
6.418\times 10^{23}\text{kg} $$
and its radius is $$
3.38 \times  10^{6}\text{m} $$.
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
a)  $$ 3.42\times 10^{\text{–5}}\text{m}/{\text{s}}^{2} $$ 

b)  $$
3.34\times 10^{\text{–5}}\text{m}/{\text{s}}^{2}
$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Solve part (b) of [[link]](#fs-id3174863) using  $$  a_{c}={v}^{2}/r $$ 
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
a)  $$ 7.01\times 10^{\text{–7}}\text{N} $$ 

b)  $$ 1.35\times 10^{\text{–6}}\text{N} $$, $$ 0.521 $$
</div>
</div>
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
a)  $$ 1.66\times 10^{\text{–10}}\text{m}/{\text{s}}^{2} $$ 

b)  $$ 2.17\times 10^{5}\text{m/s} $$
</div>
</div>
...
a)  $$ 2.937\times 10^{17}\text{kg} $$ 

b)  $$ 4.91\times 10^{\text{–8}} $$
of the Earth’s mass.
