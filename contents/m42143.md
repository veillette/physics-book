...
<div data-type="equation" id="eip-972">
 $$ \begin{array}{lll}g& =& G\frac{M}{ r^{2}}=\left(6.67 \times 10^{ -11 }\frac{\text{N}\cdot \text{m}^{2}}{ {\text{kg}}^{2}}\right)×\frac{5.98 \times 10^{24}\text{kg}}{\left(3.84 \times 10^{8}\text{m} \right)^{2}}\\ & =& 2.70 \times 10^{-3}{\text{m/s.}}^{2}
\end{array} $$ 
</div>
**Strategy for (b)**
...
<div data-type="equation" id="eip-959">
 $$ \begin{array}{lll} a_{c}& =& r \omega^{2}=\left(3.84 \times 10^{8}\text{m}\right)\left(2.66 \times 10^{-6}\text{rad/s} \right)^{2}\\ & =& 2.72\times 10^{-3}{\text{m/s.}}^{2}
\end{array} $$ 
</div>
