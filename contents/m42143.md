...
are such that a force in newtons is obtained from $$ F=G\frac{mM}{
...
<div data-type="problem" markdown="1">
(a) Calculate Earth’s mass given the acceleration due to gravity at the North Pole is  $$ 9.830 \text{m/s}^{2} $$ 
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
a)  $$ 3.42\times 10^{-5} \text{m/s}^{2} $$ 

b)  $$
3.34\times 10^{-5} \text{m/s}^{2}
$$
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
a)  $$ 7.01\times 10^{-7}\text{N} $$ 

b)  $$ 1.35\times 10^{-6}\text{N} $$, $$ 0.521 $$
</div>
</div>
