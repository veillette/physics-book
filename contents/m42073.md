...
Since  $$ g=9.80\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$ 
...
1.67\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$. A 1.0-kg mass thus has a weight of 9.8 N on Earth and only about 1.7 N on the
Moon.
...
1.67\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$
(which is much less than the acceleration due to gravity on Earth, $$
9.80\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$
...
is $$ a=\frac{ {F}_{\text{net}}}{m} $$. Entering known values gives
...
sled’s initial acceleration is $$
\text{49}\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2}, $$
...
<div data-type="equation" id="eip-id1171442277241">
 $$ T=\frac{1.0×{\text{10}}^{5}\phantom{\rule{0.25em}{0ex}}\text{N}}{4}=2.6×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{N}. $$ 
</div>
**Discussion**
...
\'s. (Recall that $$ g $$, the acceleration due to gravity, is $$ 9\text{.}{\text{80 m/s}}^{2} $$. When we say that an acceleration is 45 $$ g $$
\'s, it is $$ \text{45}×9\text{.}{\text{80 m/s}}^{2} $$, which is approximately $$ {\text{440 m/s}}^{2} $$.) While living subjects are not used any more, land speeds of 10,000 km/h have
...
<div data-type="problem" markdown="1">
A 63.0-kg sprinter starts a race with an acceleration of  $$ 4\text{.}\text{20 m}{\text{/s}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Since astronauts in orbit are apparently weightless, a clever method of measuring their masses is needed to monitor their mass gains or losses to adjust diets. One way to do this is to exert a known force on an astronaut and measure the acceleration produced. Suppose a net external force of 50.0 N is exerted and the astronaut’s acceleration is measured to be  $$ 0\text{.}{\text{893 m/s}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The same rocket sled drawn in [[link]](#fs-id2992955) is decelerated at a rate of  $$ 1{\text{96 m/s}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) If the rocket sled shown in [[link]](#fs-id1870792) starts with only one rocket burning, what is the magnitude of its acceleration? Assume that the mass of the system is 2100 kg, the thrust T is  $$ 2.4×{10}^{4} $$ 
...
(c)  $$ a=0\text{.}\text{130}\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A powerful motorcycle can produce an acceleration of  $$ 3.50\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The rocket sled shown in [[link]](#fs-id1926895) accelerates at a rate of  $$ 49.0\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$ 
...
<div data-type="solution" markdown="1">
(a)  $$ 3.68×{10}^{3}\phantom{\rule{0.25em}{0ex}}\text{N} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Repeat the previous problem for the situation in which the rocket sled decelerates at a rate of  $$ 2{\text{01 m/s}}^{2} $$ 
