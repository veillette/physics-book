...
Since  $$ g=9.80\text{m/s}^{2} $$ on Earth, the weight of a 1.0 kg object on Earth
is 9.8 N, as we see:
...
law as stated in $$ {\mathbf{\text{F}}}_{\text{net}}=m\mathbf{\text{a}} $$.
...
Prior to manned space flights, rocket sleds were used to test aircraft, missile equipment, and physiological effects on human subjects at high speeds. They consisted of a platform that was mounted on one or two rails and propelled by several rockets. Calculate the magnitude of force exerted by each rocket, called its thrust  $$ \mathbf{\text{T}} $$ , for the four-rocket propulsion system shown in [\[link\]](#fs-id2407992). The
...
<div data-type="problem" markdown="1">
A 63.0-kg sprinter starts a race with an acceleration of  $$ 4.20 \text{m/s}^{2} $$ . What is the net external force on him?
...
(b)  $$ 3750 \text{N;}  11.3^\circ \text{above horizontal}
$$
</div>
</div>
