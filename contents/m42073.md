...
<div data-type="equation" id="eip-id2390555">
 $$ 1 \text{N}=\text{1 kg}\cdot {\text{m/s}}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-id1171443439158">
 $$ w=\text{mg}=\left(1.\text{0 kg}\right)\left(9.80{\text{m/s}}^{2}\right)=9.8\text{N}. $$ 
</div>
Recall that  $$ g $$ 
...
<div data-type="equation" id="eip-id2054706">
 $$ 4T=\text{ma}+f=\left(\text{2100 kg}\right)\left({49 \text{m/s}}^{2}\right)+650 \text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-id1171442277241">
 $$ T=\frac{1.0×10^{5}\text{N}}{4}=2.6×10^{4}\text{N}. $$ 
</div>
**Discussion**
...
\'s, it is $$ 45×9.{80 \text{m/s}}^{2} $$, which is approximately $$ {440 \text{m/s}}^{2} $$.) While living subjects are not used any more, land speeds of 10 000 km/h have
