...
later sections. For now, we will define **
friction**{: data-type="term" #import-auto-id2639388} as a force that opposes
...
free-fall**{: data-type="term" #import-auto-id1999571}. That is, the only force acting on the object is the force of gravity. In the real world, when
