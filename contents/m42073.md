...
<div data-type="equation" id="eip-id1171443439158">
 $$ w=\text{mg}=\left(1\text{.}\text{0 kg}\right)\left(9.80{\text{m/s}}^{2}\right)=9.8\text{N}. $$ 
</div>
Recall that  $$ g $$ 
...
<div data-type="solution" id="eip-id1480319" markdown="1">
 $$ 1.5×{10}^{3}\text{N},\text{150 kg},\text{150 kg} $$ 
