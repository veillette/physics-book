...
<div data-type="equation" id="eip-312">
 $$w=\left( 4.00 \times 10^{-15}  \text{kg}\right)\left(9\text{.}\text{80} {\text{m/s}}^{2}\right)= 3.92 \times 10^{-14}  \text{N}. $$
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-965">
 $$\begin{array}{lll}a& =& \frac{F-w}{m}\\ & =& \frac{ 9.60 \times 10^{-14}  \text{N}- 3.92 \times 10^{-14}  \text{N}}{ 4.00 \times 10^{-15}  \text{kg}}\\ & =& \text{14}\text{.}2 {\text{m/s}}^{2}.\end{array} $$
</div>
**Discussion for (c)**
