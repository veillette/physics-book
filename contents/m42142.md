...
in [Dynamics: Newton\'s Laws of Motion](/contents/m42129) The car is a **non-inertial frame of reference**{: data-type="
...
fictitious force, named **centrifugal force**{: data-type="term" #import-auto-id1507173}<strong> (</strong>not to be confused with centripetal
...
the apparent curve to the right by using a fictitious force, called the **Coriolis force**{: data-type="term" #import-auto-id2045471}, that causes the
