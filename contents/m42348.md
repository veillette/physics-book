...
: the root mean square of the current,
   $${I}_{\text{rms}}={I}_{0}/\sqrt{2} $$ ,  where *I*<sub>0</sub> is the peak current, in an AC system
{: #import-auto-id2828741}

rms voltage
: the root mean square of the voltage,
   $${V}_{\text{rms}}={V}_{0}/\sqrt{2} $$ ,  where *V*<sub>0</sub> is the peak voltage, in an AC system
