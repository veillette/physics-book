...
. Using the expressions for  $$I $$
 and  $$V $$
 above, we see that the time dependence of power is  $$P={I}_{0}{V}_{0} {\sin}^{2} \text{2}\pi \text{ft} $$
...
<div data-type="equation" id="eip-161">
 $${P}_{0}=\text{2}\left(60.0 \text{W}\right)=120 \text{W}. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-923">
 $$\text{\% loss=}\frac{250 \text{kW}}{100 \text{MW}}×\text{100}=0.250 \text{%}. $$
</div>
**Discussion**
