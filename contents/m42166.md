...
A Saturn V’s mass at liftoff was  $$ 2.80×10^{6}\text{kg} $$ 

, its fuel-burn rate was $$ 1.40×10^{4}\text{kg/s} $$, and the exhaust velocity was $$ 2.40×10^{3}\text{m/s} $$. Calculate its initial acceleration.
...
<div data-type="equation" id="eip-13">
 $$ \begin{array}{lll}a& =& \frac{ v_{\text{e}}}{m}\frac{\Delta m}{\Delta t}-g\\ & =& \text{}\frac{2.40×10^{3}\text{m/s}}{2.80×10^{6}\text{kg}}\left(1.40×10^{4}\text{kg/s}\right)-9.80{\text{m/s}}^{2}\\ & =& \text{}2.20{\text{m/s}}^{2}.\end{array} $$ 
</div>
**Discussion**
...
show that the thrust of the engines was $$ 3.36×10^{7}\text{N} $$.
...
$$ 11.2×10^{3}\text{m/s} $$, and assuming an exhaust velocity $$ {v}_
{\text{e}}=2.5×10^{3}\text{m/s} $$.

<div data-type="equation" id="eip-31">
 $$ \text{ln}\frac{ m_{0}}{ m_{\text{r}}}=\frac{v}{ v_{\text{e}}}=\frac{11.2×10^{3}\text{m/s}}{2.5×10^{3}\text{m/s}}=4.48 $$ 
</div>
...
{m}_
{\text{r}} $$
remaining can only be about $$ {m}_{0}/180 $$. It is difficult to build a rocket in which the fuel has a mass 180 times
...
2.00×10^{3}\text{m/s} $$. You may assume the gravitational force is negligible at the probe’s location.
...
8.00×10^{6}\text{m/s} $$. These techniques allow a much more favorable payload-to-fuel ratio. To
...
requires $$ {v}_{\text{e}}= a_{\Delta m}\Delta t $$, so $$ F={v}_{\text{e}}\frac{\Delta m}{\Delta t} $$. By Newton’s third law, this force is equal in magnitude to the thrust force
...
2.40×10^{3}\text{m/s} $$. Assume that the acceleration of gravity is the same as on Earth’s surface $$
\left(
