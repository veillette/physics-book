...
. The momentum of the entire system (rocket plus expelled gas) has actually
decreased because the force of gravity has acted for a time \\( \text{Δ}t \\)

, producing a negative impulse \\( \text{Δ}p=-\text{mg}\text{Δ}t \\)

. (Remember that impulse is the net external force on a system multiplied by the
...
1\text{.}\text{40}×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{kg/s} \\)

, and the exhaust velocity was \\(
2\text{.}\text{40}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{m/s} \\)
...
\\(
\text{11}\text{.}2×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{m/s} \\)

, and assuming an exhaust velocity \\( {v}_
...
. It is difficult to build a rocket in which the fuel has a mass 180 times
...
1\text{.}6\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} \\)
...
2\text{.}\text{00}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{m/s} \\)
...
8\text{.}\text{00}×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{m/s} \\)

. These techniques allow a much more favorable payload-to-fuel ratio. To
...
. By Newton’s third law, this force is equal in magnitude to the thrust force
acting on the rocket, so \\( {F}_
{\text{thrust}}={v}_{\text{e}}\frac{\text{Δ}m}{\text{Δ}t} \\)

, where all quantities are positive. Applying Newton’s second law to the rocket
gives \\( {F}_
...
\left(
9\text{.}\text{80}\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2}\right) \\)
