...
<div data-type="equation" id="eip-188">
 $$ a=\frac{ {v}_{\text{e}}}{m}\frac{\text{Δ}m}{\text{Δ}t}-g $$ 
</div>
...
$$
is about $$ 2\text{.}5×{\text{10}}^{3}\text{m/s}
$$
...
A Saturn V’s mass at liftoff was  $$ 2\text{.}\text{80}×{\text{10}}^{6}\text{kg} $$ 

, its fuel-burn rate was $$
1\text{.}\text{40}×{\text{10}}^{4}\text{kg/s} $$, and the exhaust velocity was $$
2\text{.}\text{40}×{\text{10}}^{3}\text{m/s} $$. Calculate its initial acceleration.
...
<div data-type="equation" id="eip-13">
 $$ \begin{array}{lll}a& =& \frac{ {v}_{\text{e}}}{m}\frac{\text{Δ}m}{\text{Δ}t}-g\\ & =& \text{}\frac{2\text{.}\text{40}×{\text{10}}^{3}\text{m/s}}{2\text{.}\text{80}×{\text{10}}^{6}\text{kg}}\left(1\text{.}\text{40}×{\text{10}}^{4}\text{kg/s}\right)-9\text{.}\text{80}{\text{m/s}}^{2}\\ & =& \text{}\text{2}\text{.}\text{20}{\text{m/s}}^{2}.\end{array} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-71">
 $$ v={v}_{\text{e}}\text{ln}\frac{ {m}_{0}}{ {m}_{\text{r}}}, $$ 
</div>
...
$$
\text{11}\text{.}2×{\text{10}}^{3}\text{m/s} $$, and assuming an exhaust velocity $$ {v}_
{\text{e}}=2\text{.}5×{\text{10}}^{3}\text{m/s} $$.

<div data-type="equation" id="eip-31">
 $$ \text{ln}\frac{ {m}_{0}}{ {m}_{\text{r}}}=\frac{v}{ {v}_{\text{e}}}=\frac{\text{11}\text{.}2×{\text{10}}^{3}\text{m/s}}{2\text{.}5×{\text{10}}^{3}\text{m/s}}=4\text{.}\text{48} $$ 
</div>
...
* {: #import-auto-id1281672} Acceleration of a rocket is $$ a=\frac{ {v}_
  {\text{e}}}{m}\frac{\text{Δ}m}{\text{Δ}t}-g $$
  .
...
2\text{.}\text{50}×{\text{10}}^{3}\text{m/s?} $$
</div>
<div data-type="solution" markdown="1">
 $$ \text{39}\text{.}2{\text{m/s}}^{2} $$ 
...
1\text{.}6{\text{m/s}}^{2} $$, if the rocket expels 8.00 kg of gas per second at an exhaust velocity of $$
2\text{.}\text{20}×{\text{10}}^{3}\text{m/s?} $$
</div>
</div>
...
2\text{.}\text{00}×{\text{10}}^{3}\text{m/s} $$. You may assume the gravitational force is negligible at the probe’s location.

</div>
<div data-type="solution" markdown="1">
 $$ 4\text{.}\text{16}×{\text{10}}^{3}\text{m/s} $$ 
...
8\text{.}\text{00}×{\text{10}}^{6}\text{m/s} $$. These techniques allow a much more favorable payload-to-fuel ratio. To
...
$$
4\text{.}\text{50}×{\text{10}}^{-6}\text{kg/s} $$
...
2\text{.}\text{40}×{\text{10}}^{3}\text{m/s} $$. Assume that the acceleration of gravity is the same as on Earth’s surface $$
\left(
9\text{.}\text{80}{\text{m/s}}^{2}\right) $$. (b) Why might it be necessary to limit the acceleration of a rocket?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
How much of a single-stage rocket that is 100,000 kg can be anything but fuel if the rocket is to have a final speed of  $$ 8\text{.}\text{00}\text{km/s} $$ 

, given that it expels gases at an exhaust velocity of $$
2\text{.}\text{20}×{\text{10}}^{3}\text{m/s?} $$
</div>
<div data-type="solution" markdown="1">
 $$ 2\text{.}\text{63}×{\text{10}}^{3}\text{kg} $$ 
{: xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" fo:font-weight="normal"}
...
ejected at $$ \text{12}\text{.}0\text{m/s} $$
