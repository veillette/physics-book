...
<div data-type="equation" id="eip-13">
 $$ \begin{array}{lll}a& =& \frac{ v_{\text{e}}}{m}\frac{\Delta m}{\Delta t}-g\\ & =& \text{}\frac{2\text{.}\text{40}×{\text{10}}^{3}\text{m/s}}{2\text{.}\text{80}×{\text{10}}^{6}\text{kg}}\left(1\text{.}\text{40}×{\text{10}}^{4}\text{kg/s}\right)-9\text{.}\text{80}{\text{m/s}}^{2}\\ & =& \text{}\text{2}\text{.}\text{20}{\text{m/s}}^{2}.\end{array} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-71">
 $$ v={v}_{\text{e}}\text{ln}\frac{ m_{0}}{ m_{\text{r}}}, $$ 
</div>
...
<div data-type="equation" id="eip-31">
 $$ \text{ln}\frac{ m_{0}}{ m_{\text{r}}}=\frac{v}{ v_{\text{e}}}=\frac{\text{11}\text{.}2×{\text{10}}^{3}\text{m/s}}{2\text{.}5×{\text{10}}^{3}\text{m/s}}=4\text{.}\text{48} $$ 
</div>
...
<div data-type="equation" id="eip-607">
 $$ \frac{ m_{0}}{ m_{\text{r}}}={e}^{4\text{.}\text{48}}=\text{88}\text{.} $$ 
</div>

Thus, the mass of the rocket is

<div data-type="equation" id="eip-263">
 $$ {m}_{\text{r}}=\frac{ m_{0}}{\text{88}}\text{.} $$ 
</div>
...
gives $$ {F}_
{\text{thrust}}-\text{mg}=\text{ma}⇒a=\frac{ v_
