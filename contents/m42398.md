...
, where  $$A $$
 is the cross-sectional area of the wire, then the force on the wire is  $$F=\left(qv_{d}B \sin \theta \right)\left(\text{nAl}\right) $$
. Gathering terms,
