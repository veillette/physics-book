...
<div data-type="equation" id="eip-346">
 $$\begin{array}{lll}\overline{P}& =& \left(\text{40.0 m}\right)\left(10^{3} \frac{\text{kg}}{ {\text{m}}^{3}}\right)\left(9.80 \frac{\text{m}}{ {\text{s}}^{2}}\right)\\ & =&  3.92 \times 10^{5}  \frac{\text{N}}{ {\text{m}}^{2}}=\text{392 kPa.}\end{array} $$
</div>
**Strategy for (b)**
...
. The area of the dam is  $$A=\text{80.0 m}×500 \text{m}= 4.00 \times 10^{4}  {\text{m}}^{2} $$
, so that
...
<div data-type="equation" id="eip-820">
 $$\text{1 atmosphere (atm)}={P}_{\text{atm}}= 1.01 \times 10^{5}  {\text{N/m}}^{2}=101 \text{kPa}. $$
</div>
