...
<div data-type="equation" id="eip-346">
 $$\begin{array}{lll}\overline{P}& =& \left(\text{40.0 m}\right)\left({\text{10}}^{3} \frac{\text{kg}}{ {\text{m}}^{3}}\right)\left(9.80 \frac{\text{m}}{ {\text{s}}^{2}}\right)\\ & =&  3.92 \times 10^{5}  \frac{\text{N}}{ {\text{m}}^{2}}=\text{392 kPa.}\end{array} $$
</div>
**Strategy for (b)**
...
. The area of the dam is  $$A=\text{80.0 m}×\text{500 m}= 4.00 \times 10^{4}  {\text{m}}^{2} $$
, so that

<div data-type="equation" id="eip-208">
 $$\begin{array}{lll}F& =& \left( 3.92 \times 10^{5}  {\text{N/m}}^{2}\right)\left( 4.00 \times 10^{4}  {\text{m}}^{2}\right)\\ & =&  1.57 \times 10^{10}  \text{N.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-820">
 $$\text{1 atmosphere (atm)}={P}_{\text{atm}}= 1.01 \times 10^{5}  {\text{N/m}}^{2}=\text{101 kPa}. $$
</div>
...
<div data-type="equation" id="eip-566">
 $$\overline{\rho }=\frac{ 1.01 \times 10^{5}  {\text{N/m}}^{2}}{\left(\text{120} \times 10^{3}  \text{m}\right)\left(9\text{.}\text{80} {\text{m/s}}^{2}\right)}= 8.59 \times 10^{-2}  {\text{kg/m}}^{3}. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-169">
 $$h=\frac{ 1.01 \times 10^{5}  {\text{N/m}}^{2}}{\left( 1.00 \times 10^{3}  {\text{kg/m}}^{3}\right)\left(9\text{.}\text{80} {\text{m/s}}^{2}\right)}=\text{10}\text{.}3 \text{m}. $$
</div>
**Discussion**
