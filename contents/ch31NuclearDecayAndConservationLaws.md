...
isotopes, such as in [Appendix B](/m42702)), its $$\alpha $$
**decay equation** is
...
decay. This is easily done using masses given in [Appendix A](/m42699).
...
Thus the pertinent masses are those of  $${}^{239}\text{Pu} $$ ,
 ...
 all of which are listed in [Appendix A](/m42699). The initial mass was  $$m \left({}^{239}\text{Pu}\right)=239.052157 \text{u} $$ .
...
given in [Appendix A](/m42699). Then the emitted energy is calculated as before,
...
since the masses given in [Appendix A](/m42699) are for neutral atoms, the
