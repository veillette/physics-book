...
<div data-type="equation" id="eip-54">
 $${X}_{L}=2\pi \text{fL}=6.28\left(60.0/\text{s}\right)\left(3.00 mH\right)=\text{1.13 Ω at 60 Hz}. $$
</div>
Similarly, at 10 kHz,

<div data-type="equation" id="eip-126">
 $${X}_{L}=2\pi \text{fL}= 6.28\left( 1.00 \times 10^{4} \text{/s}\right)\left(3.00 \text{mH}\right)=\text{188 Ω at 10 kHz}. $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-333">
 $$I=\frac{V}{ {X}_{L}}=\frac{120 \text{V}}{1.13 \Omega }=\text{106 A at 60 Hz}. $$
</div>
Similarly, at 10 kHz,

<div data-type="equation" id="eip-900">
 $$I=\frac{V}{ {X}_{L}}=\frac{120 \text{V}}{\text{188 Ω}}=0.637 A at 10 kHz. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-29">
 $$\begin{array}{lll}{X}_{C}& =& \frac{1}{2\pi \text{fC}}\\ & =& \frac{1}{ 6.28\left( 60.0/\text{s}\right)\left( 5.00\mathrm{ \mu }\text{F}\right)}=\text{531 Ω at 60 Hz}\text{.}\end{array} $$
</div>
Similarly, at 10 kHz,

<div data-type="equation" id="eip-399">
 $$\begin{array}{lll}{X}_{C}& =& \frac{1}{2\pi \text{fC}}=\frac{1}{ 6.28\left( 1.00 \times 10^{4} /\text{s}\right)\left( 5.00\mathrm{ \mu }\text{F}\right)}\\ & =& \text{3.18 Ω at 10 kHz}\end{array}\text{.} $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-356">
 $$I=\frac{V}{ {X}_{C}}=\frac{120 \text{V}}{\text{531 Ω}}=\text{0.226 A at 60 Hz}. $$
</div>
Similarly, at 10 kHz,

<div data-type="equation" id="eip-633">
 $$I=\frac{V}{ {X}_{C}}=\frac{120 \text{V}}{\text{3.18 Ω}}=37.7 A at 10 kHz. $$
</div>
**Discussion**
