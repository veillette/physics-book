...
<div data-type="equation" id="eip-54">
 $${X}_{L}=2\pi \text{fL}=6.28\left(60.0/\text{s}\right)\left(3.00 mH\right)=1.13 \text{Ω at 60 Hz}. $$
</div>
Similarly, at 10 kHz,

<div data-type="equation" id="eip-126">
 $${X}_{L}=2\pi \text{fL}= 6.28\left( 1.00 \times 10^{4} \text{/s}\right)\left(3.00 \text{mH}\right)=188 \text{ Ω at } 10 \text{kHz}. $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-29">
 $$\begin{array}{lll}{X}_{C}& =& \frac{1}{2\pi \text{fC}}\\ & =& \frac{1}{ 6.28\left( 60.0/\text{s}\right)\left( 5.00\mathrm{ \mu }\text{F}\right)}=531 \text{Ω at 60 Hz}\text{.}\end{array} $$
</div>
Similarly, at 10 kHz,

<div data-type="equation" id="eip-399">
 $$\begin{array}{lll}{X}_{C}& =& \frac{1}{2\pi \text{fC}}=\frac{1}{ 6.28\left( 1.00 \times 10^{4} /\text{s}\right)\left( 5.00\mathrm{ \mu }\text{F}\right)}\\ & =& 3.18 \text{Ω at 10 kHz}\end{array}\text{.} $$
</div>
**Solution for (b)**
