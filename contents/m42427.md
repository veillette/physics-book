...
<div data-type="equation" id="eip-399">
 $$\begin{array}{lll}{X}_{C}& =& \frac{1}{2\pi \text{fC}}=\frac{1}{6\text{.}\text{28}\left( 1.00 \times 10^{4} /\text{s}\right)\left(5\text{.}\text{00}\mathrm{ \mu }\text{F}\right)}\\ & =& \text{3.18 Ω at 10 kHz}\end{array}\text{.} $$
</div>
**Solution for (b)**
