...
L $$ are proportional, $$ F=k\Delta L $$.) (See [Exercise](#fs-id73).) For
...
In [Exercise](#fs-id73)(c) we see that this area is also $$ \frac{1}{2}k
...
energies, just as we did in [Exercise](#fs-id43). Note also that we do not
