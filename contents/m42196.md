...
<div data-type="equation" id="eip-29">
 $${V}_{\text{st}}=\frac{ {m}_{\text{st}}}{ {\rho }_{\text{st}}}=\frac{ 1.00 \times 10^{7}  \text{kg}}{7\text{.}8×{\text{10}}^{3} {\text{kg/m}}^{3}}= 1.28 \times 10^{3}  {\text{m}}^{3}. $$
</div>
...
<div data-type="equation" id="eip-383">
 $$\begin{array}{lll}{m}_{w}& =& {\rho }_{w}{V}_{w}=\left(\text{1.000}×{\text{10}}^{3} {\text{kg/m}}^{3}\right)\left( 1.28 \times 10^{3}  {m}^{3}\right)\\ & =& \text{1.28}×{\text{10}}^{6} \text{kg.}\end{array} $$
</div>
By Archimedes’ principle, the weight of water displaced is  $${m}_{\text{w}}g $$
, so the buoyant force is

<div data-type="equation" id="eip-164">
 $$\begin{array}{lll}{F}_{B}& =& {w}_{w}={m}_{w}g=\left(\text{1.28}×{\text{10}}^{6} \text{kg}\right)\left(9.80 {\text{m/s}}^{2}\right)\\ & =&  1.3 \times 10^{7}  \text{N.}\end{array} $$
</div>
