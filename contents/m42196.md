...
<div data-type="equation" id="eip-606">
 $$\begin{array}{lll}{F}_{B}& =& {w}_{w}={m}_{w}g=\left( 1.00 \times 10^{8}  \text{kg}\right)\left(9.80 {\text{m/s}}^{2}\right)\\ & =&  9.80 \times 10^{8}  \text{N.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-846">
 $${\overline{\rho }}_{\text{person}}= 0.970\cdot \left(10^{3}\frac{\text{kg}}{ {\text{m}}^{3}}\right)=\text{970}\frac{\text{kg}}{ {\text{m}}^{3}}. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-472">
 $${\rho }_{\text{c}}=\frac{ {m}_{\text{c}}}{ {V}_{c}}=\frac{8.630 \text{g}}{0\text{.830 c}{\text{m}}^{3}}= 10.4 g{\text{/cm}}^{3}. $$
</div>
**Discussion**
...
<div data-type="problem" markdown="1">
What fraction of ice is submerged when it floats in freshwater, given the density of water at 0°C is very close to  $$1000 \text{kg}{\text{/m}}^{3} $$
?
