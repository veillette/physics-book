...
(a) Calculate the buoyant force on 10 000 metric tons  $$\left(1\text{.}\text{00}×{\text{10}}^{7} \text{kg}\right) $$
 of solid steel completely submerged in water, and compare this with the steel’s weight. (b) What is the maximum buoyant force that water could exert on this same steel if it were shaped into a boat that could displace  $$1\text{.}\text{00}×{\text{10}}^{5} {\text{m}}^{3} $$
 of water?
...
<div data-type="equation" id="eip-29">
 $${V}_{\text{st}}=\frac{ {m}_{\text{st}}}{ {\rho }_{\text{st}}}=\frac{1\text{.}\text{00}×{\text{10}}^{7} \text{kg}}{7\text{.}8×{\text{10}}^{3} {\text{kg/m}}^{3}}=1\text{.}\text{28}×{\text{10}}^{3} {\text{m}}^{3}. $$
</div>
...
<div data-type="equation" id="eip-383">
 $$\begin{array}{lll}{m}_{w}& =& {\rho }_{w}{V}_{w}=\left(\text{1.000}×{\text{10}}^{3} {\text{kg/m}}^{3}\right)\left(1.28×{\text{10}}^{3} {m}^{3}\right)\\ & =& \text{1.28}×{\text{10}}^{6} \text{kg.}\end{array} $$
</div>
By Archimedes’ principle, the weight of water displaced is  $${m}_{\text{w}}g $$
, so the buoyant force is

<div data-type="equation" id="eip-164">
 $$\begin{array}{lll}{F}_{B}& =& {w}_{w}={m}_{w}g=\left(\text{1.28}×{\text{10}}^{6} \text{kg}\right)\left(9.80 {\text{m/s}}^{2}\right)\\ & =& 1.3×{\text{10}}^{7} \text{N.}\end{array} $$
</div>
The steel’s weight is  $${m}_{\text{w}}g=9\text{.}\text{80}×{\text{10}}^{7} \text{N} $$
...
<div data-type="equation" id="eip-902">
 $$\begin{array}{lll}{m}_{w}& =& {\rho }_{w}{V}_{w}=\left(\text{1.000}×{\text{10}}^{3} {\text{kg/m}}^{3}\right)\left(\text{1.00}×{\text{10}}^{5} {m}^{3}\right)\\ & =& \text{1.00}×{\text{10}}^{8} \text{kg.}\end{array} $$
</div>
The maximum buoyant force is the weight of this much water, or

<div data-type="equation" id="eip-606">
 $$\begin{array}{lll}{F}_{B}& =& {w}_{w}={m}_{w}g=\left(\text{1.00}×{\text{10}}^{8} \text{kg}\right)\left(\text{9.80} {\text{m/s}}^{2}\right)\\ & =& \text{9.80}×{\text{10}}^{8} \text{N.}\end{array} $$
</div>
**Discussion**
...
The mass of an ancient Greek coin is determined in air to be 8.630 g. When the coin is submerged in water as shown in [\[link\]](#fs-id2951234), its apparent mass is 7.800 g. Calculate its density, given that water has a density of  $$1\text{.}\text{000} {\text{g/cm}}^{3} $$
...
. Thus the volume of water is  $${V}_{\text{w}}=\frac{0\text{.}\text{830 g}}{1\text{.}\text{000 g}{\text{/cm}}^{3}}=0\text{.}\text{830} {\text{cm}}^{3} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Some fish have a density slightly less than that of water and must exert a force (swim) to stay submerged. What force must an 85.0-kg grouper exert to stay submerged in salt water if its body density is  $$\text{1015} {\text{kg/m}}^{3} $$
?
...
<div data-type="problem" markdown="1">
A certain man has a mass of 80 kg and a density of  $$\text{955} {\text{kg/m}}^{3} $$
...
(a)  $$0\text{.}\text{24} $$
(b)  $$0\text{.}\text{68} $$
(c) Yes, the cork will float because  $${\rho }_{\text{obj}}<{\rho }_{\text{ethyl alcohol}}\left(0\text{.}\text{678} {\text{g/cm}}^{3}<0\text{.}\text{79} {\text{g/cm}}^{3}\right) $$
</div>
</div>
