...
<div data-type="equation">
 $${v}_{1}=\frac{Q}{ {A}_{1}}=\frac{ 40.0 \times 10^{-3}  {\text{m}}^{3}\text{/s}}{\pi \left( 3.20 \times 10^{-2}  \text{m}{\right)}^{2}}=\text{12}\text{.}4 \text{m/s}\text{.} $$
</div>
Similarly, we find
...
<div data-type="equation">
 $$\begin{array}{lll}\text{power}& =& \text{PQ}\\ & =& \left( 0.920 \times 10^{6}  {\text{N/m}}^{2}\right)\left( 40.0 \times 10^{-3}  {\text{m}}^{3}\text{/s}\right)\text{.}\\ \text{}& =&  3.68 \times 10^{4}  \text{W}=\text{36}\text{.}8 \text{kW}\end{array} $$
</div>
**Discussion**
