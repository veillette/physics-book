...
Fire hoses used in major structure fires have inside diameters of 6.40 cm. Suppose such a hose carries a flow of 40.0 L/s starting at a gauge pressure of  $$1\text{.}\text{62}×{\text{10}}^{6} {\text{N/m}}^{2} $$
...
<div data-type="equation">
 $${v}_{1}=\frac{Q}{ {A}_{1}}=\frac{\text{40}\text{.}0×{\text{10}}^{-3} {\text{m}}^{3}\text{/s}}{\pi \left(3\text{.}\text{20}×{\text{10}}^{-2} \text{m}{\right)}^{2}}=\text{12}\text{.}4 \text{m/s}\text{.} $$
</div>
Similarly, we find
...
<div data-type="equation">
 $${P}_{2}=1\text{.}\text{62}×{\text{10}}^{6} {\text{N/m}}^{2}+\frac{1}{2}\left(\text{1000} {\text{kg/m}}^{3}\right)\left[\left(\text{12}\text{.}4 \text{m/s}{\right)}^{2}-\left(\text{56}\text{.}6 \text{m/s}{\right)}^{2}\right]-\left(\text{1000} {\text{kg/m}}^{3}\right)\left(9\text{.}80 {\text{m/s}}^{2}\right)\left(\text{10}\text{.}0 \text{m}\right)=0\text{.} $$
</div>
**Discussion**
...
<div data-type="equation">
 $$P+\frac{1}{2}{\mathrm{\rho v}}^{2}+\rho \text{gh}=\text{constant}\text{.} $$
</div>
...
<div data-type="equation">
 $$\left(P+\frac{1}{2}{\mathrm{\rho v}}^{2}+\rho \text{gh}\right)Q=\text{power}\text{.} $$
</div>
...
*. Similarly,  $$\frac{1}{2}{\mathrm{\rho v}}^{2}Q $$
...
<div data-type="equation">
 $$\begin{array}{lll}\text{power}& =& \text{PQ}\\ & =& \left(\text{0.920}×{\text{10}}^{6} {\text{N/m}}^{2}\right)\left(\text{40}\text{.}0×{\text{10}}^{-3} {\text{m}}^{3}\text{/s}\right)\text{.}\\ \text{}& =& 3\text{.}\text{68}×{\text{10}}^{4} \text{W}=\text{36}\text{.}8 \text{kW}\end{array} $$
</div>
**Discussion**
...
* {: #import-auto-id2384811} Power in fluid flow is given by the equation
   $$\left({P}_{1}+\frac{1}{2}{\mathrm{\rho v}}^{2}+\rho \text{gh}\right)Q=\text{power}\text{,} $$
...
<div data-type="problem" markdown="1">
Hoover Dam on the Colorado River is the highest dam in the United States at 221 m, with an output of 1300 MW. The dam generates electricity with water taken from a depth of 150 m and an average flow rate of  $$\text{650} {\text{m}}^{3}\text{/s} $$
. (a) Calculate the power in this flow. (b) What is the ratio of this power to the facility’s average of 680 MW?

</div>
<div data-type="solution" markdown="1">
(a)  $$\text{9.56}×{\text{10}}^{8} \text{W} $$
(b) 1.4
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The left ventricle of a resting adult’s heart pumps blood at a flow rate of  $$\text{83}\text{.}0 {\text{cm}}^{3}\text{/s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A sump pump (used to drain water from the basement of houses built below the water table) is draining a flooded basement at the rate of 0.750 L/s, with an output pressure of  $$3.00×{\text{10}}^{5} {\text{N/m}}^{2} $$
