...
[\[link\]](#Figure1) shows water gushing from a large tube through a dam. What is its speed as it emerges? Interestingly, if resistance is negligible, the speed is just what it would be if the water fell a distance  $$h $$
...
Both  $${P}_{1} $$  and  $${P}_{2} $$  equal atmospheric pressure ( $${P}_{1} $$
...
Each term has a clear physical meaning. For example,  $$\text{PQ} $$  is the power supplied to a fluid, perhaps by a pump, to give it its pressure  $$P $$ . Similarly,  $$\frac{1}{2}\rho v^{2}Q $$
