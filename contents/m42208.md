...
<div data-type="equation" id="import-auto-id2679980">
 $${P}_{1}+\frac{1}{2}{\mathrm{\rho v}}_{1}^{2}+\rho gh_{1}={P}_{2}+\frac{1}{2}{\mathrm{\rho v}}_{2}^{2}+\rho gh_{2}\text{.} $$
</div>
...
<div data-type="equation" id="import-auto-id2653363">
 $$\frac{1}{2}{\mathrm{\rho v}}_{1}^{2}+\rho gh_{1}=\frac{1}{2}{\mathrm{\rho v}}_{2}^{2}+\rho gh_{2}\text{.} $$
</div>
...
<div data-type="equation">
 $$P+\frac{1}{2}{\mathrm{\rho v}}^{2}+\rho gh=\text{constant}\text{.} $$
</div>
...
<div data-type="equation">
 $$\left(P+\frac{1}{2}{\mathrm{\rho v}}^{2}+\rho gh\right)Q=\text{power}\text{.} $$
</div>
...
* {: #import-auto-id2384811} Power in fluid flow is given by the equation
   $$\left({P}_{1}+\frac{1}{2}{\mathrm{\rho v}}^{2}+\rho gh\right)Q=\text{power}\text{,} $$
