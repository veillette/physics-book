...
<div data-type="equation">
 $${v}_{1}=\frac{Q}{ {A}_{1}}=\frac{\text{40}\text{.}0×{\text{10}}^{-3} {\text{m}}^{3}\text{/s}}{\pi \left( 3.20 \times 10^{-2}  \text{m}{\right)}^{2}}=\text{12}\text{.}4 \text{m/s}\text{.} $$
</div>
Similarly, we find
...
<div data-type="equation">
 $${P}_{2}= 1.62 \times 10^{6}  {\text{N/m}}^{2}+\frac{1}{2}\left(\text{1000} {\text{kg/m}}^{3}\right)\left[\left(\text{12}\text{.}4 \text{m/s}{\right)}^{2}-\left(\text{56}\text{.}6 \text{m/s}{\right)}^{2}\right]-\left(\text{1000} {\text{kg/m}}^{3}\right)\left(9\text{.}80 {\text{m/s}}^{2}\right)\left(\text{10}\text{.}0 \text{m}\right)=0\text{.} $$
</div>
**Discussion**
...
<div data-type="equation">
 $$\begin{array}{lll}\text{power}& =& \text{PQ}\\ & =& \left(\text{0.920}×{\text{10}}^{6} {\text{N/m}}^{2}\right)\left(\text{40}\text{.}0×{\text{10}}^{-3} {\text{m}}^{3}\text{/s}\right)\text{.}\\ \text{}& =&  3.68 \times 10^{4}  \text{W}=\text{36}\text{.}8 \text{kW}\end{array} $$
</div>
**Discussion**
