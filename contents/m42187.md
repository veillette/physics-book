...
<div data-type="equation" id="eip-289">
 $$\begin{array}{lll}V& =& \text{Ah}=\left(\text{50.0} {\text{km}}^{2}\right)\left(\text{40.0} \text{m}\right)\\ & =& \left[\left(\text{50.0 k}{\text{m}}^{2}\right){\left(\frac{ {\text{10}}^{3} \text{m}}{1 \text{km}}\right)}^{2}\right]\left(\text{40.0 m}\right)= 2.00 \times 10^{9}  {\text{m}}^{3}\end{array} $$
</div>
...
<div data-type="equation" id="eip-759">
 $$\begin{array}{lll}m& =& \left( 1.00 \times 10^{3}  {\text{kg/m}}^{3}\right)\left( 2.00 \times 10^{9}  {\text{m}}^{3}\right)\\ & =& 2.00×{\text{10}}^{\text{12}} \text{kg.}\end{array} $$
</div>
**Discussion**
