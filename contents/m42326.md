...
<div data-type="equation" id="eip-537">
 $$\begin{array}{c}{V}_{\text{AB}}=Ed\\ E=\frac{ {V}_{\text{AB}}}{d}\end{array}}\text{(uniform} E \text{- field only),}\end{array} $$
</div>
...
* {: #import-auto-id1551715} The voltage between points A and B is
  <div data-type="equation" id="eip-157">
   $$\begin{array}{c}\begin{array}{c}{V}_{\text{AB}}=Ed\\ E=\frac{ {V}_{\text{AB}}}{d}\end{array}}\text{(uniform} E \text{- field only),}\end{array} $$
  </div>
