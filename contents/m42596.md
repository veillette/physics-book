...
<div data-type="equation" id="eip-995">
 $$d=\frac{\left(1\right)\left(486 \text{nm}\right)}{\text{sin 15º}}= 1.88 \times 10^{-6}  \text{m}. $$
</div>
**Discussion for (b)**
...
<div data-type="equation" id="eip-932">
 $${a}_{\text{B}}=\frac{ {h}^{2}}{ {4\pi }^{2}{m}_{e}{\text{kq}}_{e}^{2}}= 0.529 \times 10^{-10}  \text{m}. $$
</div>
...
<div data-type="equation" id="eip-742">
 $$\text{hf}=\left(13.6 \text{eV}\right)\left(\frac{1}{ {n}_{\text{f}}^{2}}-\frac{1}{ {n}_{\text{i}}^{2}}\right). $$
</div>
...
<div data-type="equation" id="eip-49">
 $$\frac{\text{hf}}{\text{hc}}=\frac{f}{c}=\frac{1}{\lambda }=\frac{\left(13.6 \text{eV}\right)}{\text{hc}}\left(\frac{1}{ {n}_{\text{f}}^{2}}-\frac{1}{ {n}_{\text{i}}^{2}}\right). $$
</div>

It can be shown that

<div data-type="equation" id="eip-369">
 $$\left(\frac{13.6 \text{eV}}{\text{hc}}\right)=\frac{\left(13.6 \text{eV}\right)\left(1.602 \times 10^{\text{−19}} \text{J/eV}\right)}{\left(6.626 \times 10^{\text{−34}} \text{J·s}\right)\left( 2.998 \times 10^{8}  \text{m/s}\right)}= 1.097 \times 10^{7}  {\text{m}}^{-1}=R $$
</div>
...
* Bohr proposed that the allowed orbits are circular and must have quantized orbital angular momentum given by
  ...
  <div data-type="equation" id="eip-897">
   $${a}_{\text{B}}=\frac{ {h}^{2}}{ {4\pi }^{2}{m}_{e}{\text{kq}}_{e}^{2}}= 0.529 \times 10^{-10}  \text{m}\text{.} $$
  </div>
...
<div data-type="solution" markdown="1">
 ...
 $$\lambda =\left(\frac{m}{ 1.097 \times 10^{7} }\right)\left[\frac{\left(2×1{\right)}^{2}}{ {2}^{2}-{1}^{2}}\right]= 1.22 \times 10^{-7}  \text{m}=122 \text{nm} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Show that  $$\left(13.6 eV\right)/\text{hc}= 1.097 \times 10^{7}  \text{m}=R $$
...
Verify Equations  $${r}_{n}=\frac{ {n}^{2}}{Z}{a}_{\text{B}} $$
 and  $${a}_{B}=\frac{ {h}^{2}}{ {4\pi }^{2}{m}_{e}{\text{kq}}_{e}^{2}}= 0.529 \times 10^{-10}  \text{m} $$
