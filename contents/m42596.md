...
<div data-type="equation" id="eip-995">
 $$d=\frac{\left(1\right)\left(\text{486 nm}\right)}{\text{sin 15º}}= 1.88 \times 10^{-6}  \text{m}. $$
</div>
**Discussion for (b)**
...
<div data-type="equation" id="eip-369">
 $$\left(\frac{\text{13.6 eV}}{\text{hc}}\right)=\frac{\left(\text{13.6} \text{eV}\right)\left(1.602×{\text{10}}^{\text{−19}} \text{J/eV}\right)}{\left(6.626×{\text{10}}^{\text{−34}} \text{J·s}\right)\left( 2.998 \times 10^{8}  \text{m/s}\right)}= 1.097 \times 10^{7}  {\text{m}}^{–1}=R $$
</div>
...
<div data-type="solution" markdown="1">
 ...
 $$\lambda =\left(\frac{m}{ 1.097 \times 10^{7} }\right)\left[\frac{\left(2×1{\right)}^{2}}{ {2}^{2}-{1}^{2}}\right]= 1.22 \times 10^{-7}  \text{m}=\text{122 nm} $$
...
<div data-type="solution" markdown="1">
 $${a}_{\text{B}}=\frac{ {h}^{2}}{ {4\pi }^{2}{m}_{e}{\text{kZq}}_{e}^{2}}=\frac{\left(\text{6.626}×{\text{10}}^{-\text{34}} \text{J·s}{\right)}^{2}}{ {4\pi }^{2}\left( 9.109 \times 10^{-31}  \text{kg}\right)\left( 8.988 \times 10^{9}  \text{N}\text{·}{\text{m}}^{2}/{C}^{2}\right)\left(1\right)\left( 1.602 \times 10^{-19}  \text{C}{\right)}^{2}}=\text{0.529}×{\text{10}}^{-\text{10}} \text{m} $$
</div>
</div>
