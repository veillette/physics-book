...
<div class="equation" id="eip-776">
 $$\begin{array}{lll}\lambda & =& \frac{1}{ 2.057 \times 10^{6}  {\text{m}}^{-1}}=486 \times 10^{-9}  \text{m}\\ & =& 486 \text{nm.}\end{array} $$
</div>
**Discussion for (a)**
...
<div class="equation" id="eip-586">
 $${E}_{0}=\frac{ {2\pi }^{2}{q}_{e}^{4}{m}_{e}{k}^{2}}{ {h}^{2}}=13.6 \text{eV.} $$
</div>

Thus, for hydrogen,

<div class="equation" id="eip-885">
 $${E}_{n}=-\frac{13.6 \text{eV}}{ {n}^{2}}\text{(}n=1 \text{, 2, 3, ...).} $$
</div>
