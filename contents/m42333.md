...
<div class="equation" id="eip-226">
 $$\begin{array}{lll}C& =& {\epsilon }_{0}\frac{A}{d}=\left(8.85 \times 10^{-12}\frac{F}{m}\right) \frac{1.00 {\text{m}}^{2}}{1.00 \times 10^{-3} \text{m}}\\ & =& 8.85 \times 10^{-9} \text{F}=8.85 \text{nF}.\end{array} $$
</div>
**Discussion for (a)**
