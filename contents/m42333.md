...
It follows, then, that $$\mathrm{V \propto }\phantom{\rule{0.25em}{0ex}}Q$$
...
Different capacitors will store different amounts of charge for the same applied voltage, depending on their physical characteristics. We define their **capacitance**{: data-type="term" #import-auto-id1271385} $$C$$
...
$$\text{1 F}=\frac{\text{1 C}}{\text{1 V}}.$$
</div>

A 1-farad capacitor would be able to store 1 coulomb (a very large amount of charge) with the application of only 1 volt. One farad is, thus, a very large capacitance. Typical capacitors range from fractions of a picofarad $$\left(1 pF={\text{10}}^{\text{–12}}\phantom{\rule{0.25em}{0ex}}\text{F}\right)$$

 to millifarads $$\left(1 mF={\text{10}}^{–3}\phantom{\rule{0.25em}{0ex}}\text{F}\right)$$
...
$$A$$
 ...
 is the permittivity of free space; its numerical value in SI units is $${\epsilon }_{0}=8.85×{\text{10}}^{–\text{12}}\phantom{\rule{0.25em}{0ex}}\text{F/m}$$
...
(a) What is the capacitance of a parallel plate capacitor with metal plates, each of area $$\text{1.00}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}$$

, separated by 1.00 mm? (b) What charge is stored in this capacitor if a voltage of $$3.00×{\text{10}}^{\text{3}}\phantom{\rule{0.25em}{0ex}}\text{V}$$
...
. Once $$C$$
 ...
 is found, the charge stored can be found using the equation $$Q=\text{CV}$$
...
$$\begin{array}{lll}C& =& {\epsilon }_{0}\frac{A}{d}=\left(8.85×{\text{10}}^{\text{–12}}\frac{F}{m}\right)\phantom{\rule{0.10em}{0ex}}\frac{1.00\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}}{1.00×{\text{10}}^{–3}\phantom{\rule{0.25em}{0ex}}\text{m}}\\ & =& 8.85×{\text{10}}^{–9}\phantom{\rule{0.25em}{0ex}}\text{F}=8.85 nF.\end{array}$$
</div>
**Discussion for (a)** **
...
The charge stored in any capacitor is given by the equation $$Q=\text{CV}$$

. Entering the known values into this equation gives

<div data-type="equation" id="eip-754">
$$\begin{array}{lll}Q& =& \text{CV}=\left(8.85×{\text{10}}^{–9}\phantom{\rule{0.25em}{0ex}}\text{F}\right)\left(3.00×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{V}\right)\\ & =& \text{26.6 μC.}\end{array}$$
</div>
**Discussion for (b)** **

This charge is only slightly greater than those found in typical static electricity. Since air breaks down at about $$3\text{.}\text{00}×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{V/m}$$

, more charge cannot be stored on this capacitor by increasing the voltage.

</div>

Another interesting biological example dealing with electric potential is found in the cell’s plasma membrane. The membrane sets a cell off from its surroundings and also allows ions to selectively pass in and out of the cell. There is a potential difference across the membrane of about $$\text{–70 mV}$$
...
$$E=\frac{V}{d}=\frac{\text{–70}×{\text{10}}^{–3}\phantom{\rule{0.25em}{0ex}}V}{8×{\text{10}}^{–9}\phantom{\rule{0.25em}{0ex}}m}=–9×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{V/m}.$$
</div>
...
$$C={\text{κε}}_{0}\phantom{\rule{0.10em}{0ex}}\frac{A}{d}\phantom{\rule{0.25em}{0ex}}\text{(parallel plate capacitor with dielectric)}.$$
</div>
...
$$\begin{array}{lll}V& =& E\cdot d\\ & =& \left(3×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{V/m}\right)\left(1\text{.}\text{00}×{\text{10}}^{-3}\phantom{\rule{0.25em}{0ex}}\text{m}\right)\\ & =& \text{3000 V.}\end{array}$$
</div>

However, the limit for a 1.00 mm separation filled with Teflon is 60,000 V, since the dielectric strength of Teflon is $$\text{60}×{\text{10}}^{6}$$
...
$$\begin{array}{lll}Q& =& \mathit{\text{CV}}\\ & =& {\mathit{\kappa C}}_{\text{air}}V\\ & =& \left(2.1\right)\left(8.85 nF\right)\left(6.0×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{V}\right)\\ & =& 1.1 mC.\end{array}$$
</div>
...
* {: #import-auto-id2838015} The capacitance of a parallel plate capacitor is
  $$C={\epsilon }_{0}\phantom{\rule{0.15em}{0ex}}\frac{A}{d}$$
  
  , when the plates are separated by air or free space.
  $${\epsilon }_{\text{0}}\phantom{\rule{0.25em}{0ex}}$$
...
<div data-type="problem" markdown="1">
What charge is stored in a $$\text{180 µF}\phantom{\rule{0.25em}{0ex}}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Calculate the voltage applied to a $$2\text{.}\text{00 µF}$$

 capacitor when it holds $$3\text{.}\text{10 µC}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What capacitance is needed to store $$3\text{.}\text{00 µC}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Find the capacitance of a parallel plate capacitor having plates of area $$5\text{.}\text{00}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a)What is the capacitance of a parallel plate capacitor having plates of area $${\text{1.50 m}}^{2}$$
...
A prankster applies 450 V to an $$\text{80}\text{.}0 µF$$
...
(a) A certain parallel plate capacitor has plates of area $${\text{4.00 m}}^{2}$$
