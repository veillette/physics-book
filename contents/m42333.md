...
in [Electric Potential in a Uniform Electric Field](/m42326), we know that the
...
voltage, depending on their physical characteristics. We define their **
...
stored. Those factors are the physical characteristics of the capacitor, $$C $$
, and the voltage, $$V $$ . Rearranging the equation, we see that *capacitance
$$C $$
...
air-filled capacitors act much like those with vacuum between their plates **
