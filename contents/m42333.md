...
<div data-type="equation" id="eip-754">
 $$\begin{array}{lll}Q& =& \text{CV}=\left(8.85×{\text{10}}^{–9} \text{F}\right)\left( 3.00 \times 10^{3}  \text{V}\right)\\ & =& \text{26.6 μC.}\end{array} $$
</div>
**Discussion for (b)** **
...
<div data-type="equation" id="eip-328">
 $$E=\frac{V}{d}=\frac{\text{–70}×{\text{10}}^{–3} V}{8×{\text{10}}^{–9} m}=–9 \times 10^{6}  \text{V/m}. $$
</div>
...
<div data-type="equation" id="eip-867">
 $$\begin{array}{lll}V& =& E\cdot d\\ & =& \left(3 \times 10^{6}  \text{V/m}\right)\left( 1.00 \times 10^{-3}  \text{m}\right)\\ & =& \text{3000 V.}\end{array} $$
</div>

However, the limit for a 1.00 mm separation filled with Teflon is 60 000 V, since the dielectric strength of Teflon is  $$\text{60} \times 10^{6}  $$
...
<div data-type="equation" id="eip-794">
 $$\begin{array}{lll}Q& =& \mathit{\text{CV}}\\ & =& {\mathit{\kappa C}}_{\text{air}}V\\ & =& \left(2.1\right)\left(8.85 nF\right)\left( 6.0 \times 10^{4}  \text{V}\right)\\ & =& 1.1 mC.\end{array} $$
</div>
