...
<div data-type="equation" id="eip-754">
 $$\begin{array}{lll}Q& =& \text{CV}=\left(8.85 \times 10^{-9} \text{F}\right)\left( 3.00 \times 10^{3}  \text{V}\right)\\ & =& \text{26.6 μC.}\end{array} $$
</div>
**Discussion for (b)** **
...
<div data-type="equation" id="eip-328">
 $$E=\frac{V}{d}=\frac{\text{–70} \times 10^{-3} V}{8 \times 10^{-9} m}=–9 \times 10^{6}  \text{V/m}. $$
</div>
