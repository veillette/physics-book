...
<div data-type="equation" id="eip-520">
 $$\text{Δ}L=\mathrm{\alpha L}\text{Δ}T=\left(\frac{12 \times 10^{-6} }{\text{º}\text{C}}\right)\left(1275 \text{m}\right)\left(\text{55}\text{º}\text{C}\right)=0.84 \text{m.} $$
</div>
**Discussion**
...
Suppose your 60.0-L (15.9-gal) steel gasoline tank is full of gas, so both the tank and the gasoline have a temperature of  $$ 15.0\text{º}\text{C} $$
. How much gasoline has spilled by the time they warm to  $$ 35.0\text{º}\text{C} $$
?
...
<div data-type="equation" id="eip-400">
 $$\begin{array}{lll}{V}_{\text{spill}}& =& \left({\beta }_{\text{gas}}-{\beta }_{\text{s}}\right)V\text{Δ}T\\ & =& \left[\left(\text{950}-\text{35}\right) \times 10^{-6} /\text{º}\text{C}\right]\left( 60.0 \text{L}\right)\left( 20.0\text{º}\text{C}\right)\\ & =&  1.10 \text{L}.\end{array} $$
</div>
**Discussion**
...
What pressure would be created in the gasoline tank considered in [\[link\]](#fs-id2168201), if the gasoline increases in temperature from  $$ 15.0\text{º}\text{C} $$
 to  $$ 35.0\text{º}\text{C} $$
...
. In the previous example, the change in volume  $$\text{Δ}V= 1.10 \text{L} $$
...
<div data-type="problem" markdown="1">
The height of the Washington Monument is measured to be 170 m on a day when the temperature is  $$ 35.0\text{º}\text{C} $$
. What will its height be on a day when the temperature falls to  $$ - 10.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the change in length of a 3.00-cm-long column of mercury if its temperature changes from  $$ 37.0\text{º}\text{C} $$
 to  $$ 40.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
How large an expansion gap should be left between steel railroad rails if they may reach a maximum temperature  $$ 35.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Global warming will produce rising sea levels partly due to melting ice caps but also due to the expansion of water as average ocean temperatures rise. To get some idea of the size of this effect, calculate the change in length of a column of water 1.00 km high for a temperature increase of  $$ 1.00\text{º}\text{C}\text{.} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Show that 60.0 L of gasoline originally at  $$ 15.0\text{º}\text{C} $$
 will expand to 61.1 L when it warms to  $$ 35.0\text{º}\text{C,} $$
 as claimed in [[link]](#fs-id2168201).

</div>
<div data-type="solution">
<div data-type="equation" id="import-auto-id1319680">
 $$\begin{array}{lll}V& =& {V}_{0}+\text{Δ}V={V}_{0}\left(1+\beta \text{Δ}T\right)\\ & =& \left(60.00 \text{L}\right)\left[1+\left(950 \times 10^{-6} /\text{º}\text{C}\right)\left( 35.0\text{º}\text{C}- 15.0\text{º}\text{C}\right)\right]\\ & =&  61.1 \text{L}\end{array} $$
</div>
</div>
</div>
...
. What is their difference in length at  $$ 22.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) If a 500-mL glass beaker is filled to the brim with ethyl alcohol at a temperature of  $$ 5.00\text{º}\text{C,} $$
 how much will overflow when its temperature reaches  $$ 22.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Most automobiles have a coolant reservoir to catch radiator fluid that may overflow when the engine is hot. A radiator is made of copper and is filled to its 16.0-L capacity when at  $$ 10.0º\text{C}\text{.} $$
 What volume of radiator fluid will overflow when the radiator and fluid reach their  $$ 95.0º\text{C} $$
 operating temperature, given that the fluid’s volume coefficient of expansion is  $$\beta =400 \times 10^{-6}/\text{º}\text{C} $$
? Note that this coefficient is approximate, because most car radiators have operating temperatures of greater than  $$ 95.0\text{º}\text{C}\text{.} $$
</div>
</div>
...
A physicist makes a cup of instant coffee and notices that, as the coffee cools, its level drops 3.00 mm in the glass cup. Show that this decrease cannot be due to thermal contraction by calculating the decrease in level if the  $$350 {\text{cm}}^{3} $$
 of coffee is in a 7.00-cm-diameter cup and decreases in temperature from  $$ 95.0\text{º}\text{C}  $$
to $$  45.0\text{º}\text{C}\text{.} $$
...
(a) The density of water at  $$0\text{º}\text{C} $$
 ...
 (it is actually  $$999\text{.}{84 \text{kg/m}}^{3} $$
