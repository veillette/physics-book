...
<table id="import-auto-id1814176" summary="Three-column table gives the thermal expansion coefficients of various solids, liquids, and gases at twenty degrees Celsius. The left column gives the names of the materials; the middle column gives the coefficient of linear expansion of various solids; and the right column gives the coefficient of volume expansion of solids, liquids, and gases."><caption><span data-type="title">Thermal Expansion Coefficients at  $$20\text{º}\text{C} $$<strong><sup data-type="footnote-number" id="footnote-ref1"><a data-type="footnote-link" href="#footnote1">1</a></sup></strong></span></caption><thead>  
          <tr>
            <th>Material</th>
...
The main span of San Francisco’s Golden Gate Bridge is 1275 m long at its coldest. The bridge is exposed to temperatures ranging from  $$–15\text{º}\text{C} $$
 to  $$40\text{º}\text{C} $$
...
<div data-type="equation" id="eip-520">
 $$\text{Δ}L=\mathrm{\alpha L}\text{Δ}T=\left(\frac{12 \times 10^{-6} }{\text{º}\text{C}}\right)\left(1275 \text{m}\right)\left(55\text{º}\text{C}\right)=0.84 \text{m.} $$
</div>
**Discussion**
...
In general, objects will expand with increasing temperature. Water is the most important exception to this rule. Water expands with increasing temperature (its density *decreases*) when it is at temperatures greater than  $$4\text{º}\text{C}\left(40\text{º}\text{F}\right) $$
. However, it expands with *decreasing* temperature when it is between  $$+4\text{º}\text{C} $$
 and  $$0\text{º}\text{C} $$
 $$\left(40\text{º}\text{F} $$
 to  $$32\text{º}\text{F}\right) $$
...
<div data-type="equation" id="eip-400">
 $$\begin{array}{lll}{V}_{\text{spill}}& =& \left({\beta }_{\text{gas}}-{\beta }_{\text{s}}\right)V\text{Δ}T\\ & =& \left[\left(950-35\right) \times 10^{-6} /\text{º}\text{C}\right]\left( 60.0 \text{L}\right)\left( 20.0\text{º}\text{C}\right)\\ & =&  1.10 \text{L}.\end{array} $$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
How much taller does the Eiffel Tower become at the end of a day when the temperature has increased by  $$15\text{º}\text{C} $$
...
You are looking to purchase a small piece of land in Hong Kong. The price is “only”  $$60 000 per square meter! The land title says the dimensions are  $$20 \text{m} × 30 \text{m}\text{.} $$
 By how much would the total price change if you measured the parcel with a steel tape measure on a day when the temperature was  $$20\text{º}\text{C} $$
 above normal?
