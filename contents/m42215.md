...
[\[link\]](#Table1) lists representative values of the coefficient of linear expansion, which may have units of  $$1/\text{ºC} $$
...
Use the equation for linear thermal expansion  $$\Delta L=\alpha L\Delta T $$
 ...
 for steel from [\[link\]](#Table1), and note that the change in temperature,  $$\Delta T $$ ,
 is  $$55\text{ºC} $$.
...
where  $$\beta  $$  is the **coefficient of volume expansion** and  $$\beta \approx 3\alpha  $$ .
 Note that the values of  $$\beta  $$  in [\[link\]](#Table1) are almost exactly equal to  $$3\alpha  $$.
