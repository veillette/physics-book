...
[[Table 1]](#Table1) lists representative values of the coefficient of linear expansion, which may have units of  $$1/\text{ºC} $$
...
Use the equation for linear thermal expansion  $$\Delta L=\alpha L\Delta T $$
 ...
 for steel from [[Table 1]](#Table1), and note that the change in temperature,  $$\Delta T $$ ,
 is  $$55\text{ºC} $$.
