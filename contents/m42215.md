...
Show that 60.0 L of gasoline originally at  $$ 15.0\text{ºC} $$
 will expand to 61.1 L when it warms to  $$ 35.0\text{º}\text{C} \text{,}  $$
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
(a) If a 500-mL glass beaker is filled to the brim with ethyl alcohol at a temperature of  $$ 5.00\text{º}\text{C} \text{,}  $$
