...
<div data-type="problem" markdown="1">
(a)What is the maximum velocity of an 85.0-kg person bouncing on a bathroom scale having a force constant of  $$1\text{.}\text{50}×{\text{10}}^{6} \text{N/m} $$
