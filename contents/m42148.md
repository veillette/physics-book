...
<div data-type="equation">
 $$ \begin{array}{lll}\text{mgh}& =& \left(\text{0.500 kg}\right)\left({9.80\text{m/s}}^{2}\right)\left(\text{1.00 m}\right)\\ & =& \text{4.90 kg}\cdot {m}^{2}{\text{/s}}^{2}\text{= 4.90 J.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-118">
 $$ F=-\frac{\text{mgh}}{d}=-\frac{\left(\text{60.0 kg}\right)\left(\text{9.80 m}{\text{/s}}^{2}\right)\left(-3.00 \text{m}\right)}{5.00×10^{-3}\text{m}}=3.53×10^{5}N. $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-230">
 $$ \begin{array}{lll}v& =& \sqrt{2\left(9.80 \text{m}{\text{/s}}^{2}\right)\left(\text{20.0 m}\right)}\\ & =& 19}\text{.8 m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-388">
 $$ \begin{array}{lll}v& =& \sqrt{2\left(9.80{\text{m/s}}^{2}\right)\left(20}\text{.0 m}\right)+\left(5\text{.00 m/s}{\right)}^{2}}\\ & =& \text{20.4 m/s.}\end{array} $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) How much gravitational potential energy (relative to the ground on which it is built) is stored in the Great Pyramid of Cheops, given that its mass is about  $$ 7\mathrm{ × }10^{9}\text{ kg} $$ 
