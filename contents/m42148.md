...
<div data-type="equation">
 $$ \begin{array}{lll}
mgh & =& \left(0.500 \text{kg}\right)\left( 9.80\text{m/s}^{2}\right)\left(1.00 \text{m}\right)\\
 & =& 4.90 \text{kg}\cdot {m}^{2}{\text{/s}}^{2}\text{= 4.90 J.}
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-230">
 $$ \begin{array}{lll}
v& =& \sqrt{2\left(9.80 \text{m/s}^{2}\right)\left(20.0 \text{m}\right)}\\
 & =&19 \text{.8 m/s.}
\end{array} $$ 
</div>
