...
with a minus sign because the displacement while stopping and the force from floor are in opposite directions  $$ \left(\cos{\theta} =\cos\text{180º}=-1\right) $$ . The floor removes energy from the system, so it does negative work.
