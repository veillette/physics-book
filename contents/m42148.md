...
at height $$ h $$ on Earth is given by $$ {\text{PE}}_{\text{g}}=mgh $$.
...
to its weight $$ mg $$. The work done on the mass is then $$ \text{W = Fd = mgh}
$$. We define this to be the **gravitational potential energy**{: data-type="
term"
} $$ \left({\text{PE}}_{\text{g}}\right) $$ put into (or gained by) the
...
convenience, we refer to this as the $$ {\text{PE}}_{\text{g}} $$ gained by the
...
consider just the conversion of $$ {\text{PE}}_{\text{g}} $$ to $$ \text{KE} $$
...
The equation $$ \Delta {\text{PE}}_{\text{g}}=mgh $$ applies for any path that
...
him by the floor as he stops. The initial $$ {\text{PE}}_{\text{g}} $$ is
transformed into $$ \text{KE} $$ as he falls. The work done by the floor reduces
...
that the person’s knees bend is much smaller than the height $$ h $$ of the
...
written in equation form as $$ -\Delta {\text{PE}}_{\text{g}}=\Delta \text{KE}
$$. Using the equations for $$ {\text{PE}}_{\text{g}} $$ and $$ \text{KE} $$, we
can solve for the final speed $$ v $$, which is the desired quantity.

**Solution for (a)**

Here the initial kinetic energy is zero, so that $$ \text{ΔKE}=\frac{1}{2}m
v^{2} $$. The equation for change in potential energy states that $$
{\text{ΔPE}}_{\text{g}}=mgh $$. Since $$ h $$ is negative in this case, we will
rewrite this as $$ {\text{ΔPE}}_{\text{g}}=-mg \mid h\mid $$ to show the minus
sign clearly. Thus,
...
Again $$ -{\text{ΔPE}}_{\text{g}}=\text{ΔKE} $$. In this case there is initial
kinetic energy, so $$ \text{ΔKE}=\frac{1}{2}m{v}^{2}-\frac{1}{2}m{ v_{0}}^{2}
$$. Thus,
...
* {: #import-auto-id2449367} The change in gravitational potential energy, $$
  \Delta {\text{PE}}_{\text{g}} $$ , is $$ {\text{ΔPE}}_{g}=mgh $$ , with $$ h
...
* {: #import-auto-id2746176} The gravitational potential energy of an object
  ...
  differences in gravitational potential energy, $$ {\text{ΔPE}}_{g} $$ , have
