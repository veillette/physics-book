...
<div data-type="equation" id="eip-955">
 $$ W=\text{Fd}\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta =-\text{Fd}, $$ 
</div>
with a minus sign because the displacement while stopping and the force from floor are in opposite directions  $$ \left(\cos\phantom{\rule{0.25em}{0ex}}\theta =\cos\phantom{\rule{0.25em}{0ex}}\text{180º}=-1\right) $$ 
