...
\text{ΔKE}=\frac{1}{2}m v^{2} $$. The equation for change in potential energy states that $$ {\text{ΔPE}}_
{\text{g}}=mgh  $$. Since $$ h $$
...
<div data-type="equation" id="eip-579">
 $$ \text{mg}\mid h\mid =\frac{1}{2}m v^{2}\text{.} $$ 
</div>
Solving for  $$ v $$ 
...
<div data-type="equation" id="eip-230">
 $$ \begin{array}{lll}v& =& \sqrt{2\left(9.80 \text{m}{\text{/s}}^{2}\right)\left(20.0 \text{m}\right)}\\ & =&19 \text{.8 m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-90">
 $$ \text{mg}\mid h\mid =\frac{1}{2}m v^{2}-\frac{1}{2}m{ v_{0}}^{2}\text{.} $$ 
</div>
Rearranging gives

<div data-type="equation" id="eip-484">
 $$ \frac{1}{2}m v^{2}=\text{mg}\mid h\mid +\frac{1}{2}m{ v_{0}}^{2}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-id2183293">
 $$ v_{f}=\sqrt{2\text{gh}+{ v_{0}}^{2}}=\sqrt{2\left(9.80 \text{ m}{\text{/s}}^{2}\right)\left(-0.180 \text{m}\right)+\left(2.00 \text{m/s}{\right)}^{2}}=0.687 \text{m/s} $$ 
</div>
</div>
</div>
