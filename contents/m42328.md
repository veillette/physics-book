...
<div data-type="equation" id="eip-174">
 $$\begin{array}{lll}V& =& k\frac{Q}{r}\\ & =& \left( 8.99 \times 10^{9}  \text{N}·{\text{m}}^{2}/{\text{C}}^{2}\right)\left(\frac{\text{–3.00} \times 10^{-9} \text{C}}{5.00 \times 10^{-2} \text{m}}\right)\\ & =& \text{–539 V.}\end{array} $$
</div>
**Discussion** **
...
<div data-type="equation" id="eip-939">
 $$\begin{array}{lll}Q& =& \frac{\text{rV}}{k}\\ & =& \frac{\left( 0.125 \text{m}\right)\left(100 \times 10^{3}  \text{V}\right)}{ 8.99 \times 10^{9}  \text{N}·{\text{m}}^{2}/{\text{C}}^{2}}\\ & =& 1.39 \times 10^{-6} \text{C}=\text{1.39 µC.}\end{array} $$
</div>
**Discussion** **
