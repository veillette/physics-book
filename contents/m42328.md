...
where *k* is a constant equal to  $$ 9.0 \times 10^{9}  \text{N} \text{·} {\text{m}}^{\text{2}}\text{/}{\text{C}}^{\text{2}} $$
.
...
<div data-type="equation" id="eip-939">
 $$\begin{array}{lll}Q& =& \frac{\text{rV}}{k}\\ & =& \frac{\left(0\text{.}\text{125} \text{m}\right)\left(\text{100}×{\text{10}}^{3} \text{V}\right)}{ 8.99 \times 10^{9}  \text{N}·{\text{m}}^{2}/{\text{C}}^{2}}\\ & =& \text{1.39}×{\text{10}}^{–6} \text{C}=\text{1.39 µC.}\end{array} $$
</div>
**Discussion** **
