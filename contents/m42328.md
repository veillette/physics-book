...
<div class="equation" id="eip-174">
 $$\begin{array}{lll}V& =& k\frac{Q}{r}\\ & =& \left( 8.99 \times 10^{9}  \text{N}·{\text{m}}^{2}/{\text{C}}^{2}\right)\left(\frac{-3.00 \times 10^{-9} \text{C}}{5.00 \times 10^{-2} \text{m}}\right)\\ & =& -539 \text{V.}\end{array} $$
</div>
**Discussion** **
