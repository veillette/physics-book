...
<div data-type="equation" id="eip-939">
 $$\begin{array}{lll}Q& =& \frac{\text{rV}}{k}\\ & =& \frac{\left( 0.125 \text{m}\right)\left(100 \times 10^{3}  \text{V}\right)}{ 8.99 \times 10^{9}  \text{N}·{\text{m}}^{2}/{\text{C}}^{2}}\\ & =& 1.39 \times 10^{-6} \text{C}=1.39 \text{µC.}\end{array} $$
</div>
**Discussion** **
