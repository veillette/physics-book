...
*, and noting the connection between work and potential $$\left(W= –q\Delta V\right)$$
, it can be shown that the *electric potential $$V$$
 of a point charge* is

<div data-type="equation" id="eip-436">
$$V=\frac{\text{kQ}}{r} \left(\text{Point Charge}\right),$$
</div>

where *k* is a constant equal to $$9.0×{\text{10}}^{\text{9}} \text{N} \text{·} {\text{m}}^{\text{2}}\text{/}{\text{C}}^{\text{2}}$$
.
...
$$\begin{array}{lll}V& =& k\frac{Q}{r}\\ & =& \left(\text{8.99}×{\text{10}}^{9} \text{N}·{\text{m}}^{2}/{\text{C}}^{2}\right)\left(\frac{\text{–3.00}×{\text{10}}^{–9} \text{C}}{\text{5.00}×{\text{10}}^{\text{–2}} \text{m}}\right)\\ & =& \text{–539 V.}\end{array}$$
</div>
**Discussion** **
...
$$\begin{array}{lll}Q& =& \frac{\text{rV}}{k}\\ & =& \frac{\left(0\text{.}\text{125} \text{m}\right)\left(\text{100}×{\text{10}}^{3} \text{V}\right)}{8.99×{\text{10}}^{9} \text{N}·{\text{m}}^{2}/{\text{C}}^{2}}\\ & =& \text{1.39}×{\text{10}}^{–6} \text{C}=\text{1.39 µC.}\end{array}$$
</div>
**Discussion** **
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the potential $$0\text{.}\text{530}×{\text{10}}^{–10} \text{m}$$
...
How far from a $$1\text{.}\text{00 µC}$$
 point charge will the potential be 100 V? At what distance will it be $$\text{2.00}×{\text{10}}^{2} \text{V}?$$
</div>
</div>
...
$$–2\text{.}\text{22}×{\text{10}}^{–13} \text{C}$$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
If the potential due to a point charge is $$5\text{.}\text{00}×{\text{10}}^{2} \text{V}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In nuclear fission, a nucleus splits roughly in half. (a) What is the potential $$2\text{.}\text{00}×{\text{10}}^{–14} \text{m}$$
...
(a) $$2\text{.}\text{78}×{\text{10}}^{-7} \text{C}$$
(b) $$2\text{.}\text{00}×{\text{10}}^{-10} \text{C}$$
</div>
</div>
