...
$$Q=\left(1.00 kg\right)\left(334 kJ/kg\right)=3\text{.}\text{34}×{\text{10}}^{5} \text{J.}$$
</div>
...
$$\Delta S=\frac{Q}{T}=\frac{3\text{.}\text{34}×{\text{10}}^{5} \text{J}}{T}\text{.}$$
</div>
$$T$$
...
$$\begin{array}{lll}\Delta S& =& \frac{3\text{.}\text{34}×{\text{10}}^{5} \text{J}}{\text{273 K}}\\ & =& \text{1.22}×{\text{10}}^{3} \text{J/K.}\end{array}$$
</div>
**Discussion**
...
<div data-type="problem" markdown="1">
(a) On a winter day, a certain house loses $$5\text{.}\text{00}×{\text{10}}^{8} \text{J}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
On a hot summer day, $$4\text{.}\text{00}×{\text{10}}^{6} \text{J}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
When $$1\text{.}\text{60}×{\text{10}}^{5} \text{J}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The Sun radiates energy at the rate of $$3\text{.}\text{80}×{\text{10}}^{\text{26}} \text{W}$$
...
<div data-type="solution" markdown="1">
(a) $$1\text{.}\text{04}×{\text{10}}^{\text{31}} \text{J/K}$$
(b) $$3\text{.}\text{28}×{\text{10}}^{\text{31}} \text{J}$$
</div>
</div>
...
<div data-type="solution" markdown="1">
(a) $$2\text{.}\text{47}×{\text{10}}^{\text{14}} \text{J}$$
(b) $$1\text{.}\text{60}×{\text{10}}^{\text{14}} \text{J}$$
(c) $$2.85×{\text{10}}^{\text{10}} \text{J/K}$$
(d) $$8.29×{\text{10}}^{\text{12}} \text{J}$$
</div>
</div>
