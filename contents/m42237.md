...
<div data-type="equation" id="eip-462">
 $$\begin{array}{ccc}\Delta {S}_{\text{tot}}& =& \Delta {S}_{\text{h}}+\Delta {S}_{\text{c}}\\ & =& \left(–6.67 \text{+16}\text{.}0\right) \text{J/K}\\ & =& \text{9.33 J/K.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-112">
 $$\begin{array}{lll}W& =& {\text{Eff}}_{\text{C}}{Q}_{\text{h}}\\ & =& \left(0.833\right)\left(4000 \text{J}\right)=\text{3333 J.}\end{array} $$
</div>
**Solution (b)**
...
<div data-type="equation" id="eip-251">
 $$\begin{array}{lll}W& =& {\text{Eff}\prime }_{\text{C}}{Q}_{h}\\ & =& \left(0.600\right)\left(4000 \text{J}\right)=\text{2400 J.}\end{array} $$
</div>
**Discussion**
