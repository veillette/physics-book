...
Spontaneous heat transfer from hot to cold is an irreversible process. Calculate the total change in entropy if 4000 J of heat transfer occurs from a hot reservoir at  $${T}_{\text{h}}=600 \text{K}\left(\text{327º C}\right) $$
 to a cold reservoir at  $${T}_{\text{c}}=250 \text{K}\left(-\text{23º C}\right) $$
...
<div data-type="equation" id="eip-697">
 $${\text{Eff}\prime }_{\text{C}}=1-\frac{ {T}_{\text{c}}}{ {\text{T′}}_{\text{c}}}=\text{1}-\frac{100 \text{K}}{250 \text{K}}=0.600, $$
</div>
so that
