...
The definition of  $$\Delta S $$
 ...
 for that process. That will be the change in entropy for any process going from state 1 to state 2. (See [[Figure 1]](#Figure1).)
