...
<div data-type="equation" id="eip-637">
 $$ v=\frac{r\Delta\theta }{\Delta t }=r \omega \text{.} $$ 
</div>
...
<div data-type="equation" id="eip-639">
 $$ v=r \omega \text{ or }\omega =\frac{v}{r}\text{.} $$ 
</div>
...
means a large $$ \omega $$, because $$ v=r \omega  $$. Similarly, a larger-radius tire rotating at the same angular velocity ( $$
\omega $$
...
have $$ v=15.0 \text{m/s}. $$
The radius of the tire is given to be $$ r=0.300 \text{m}. $$
Knowing $$ v $$
and $$ r $$, we can use the second relationship in $$ v=r \omega \mathrm{, }\omega
=\frac{v}{r} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the period of rotation of Earth in seconds? (b) What is the angular velocity of Earth? (c) Given that Earth has a radius of  $$ 6.4\times 10^{6}\text{m} $$ 
