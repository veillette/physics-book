...
Consider a line from the center of the CD to its edge. Each **pit**{: data-type="term" #import-auto-id2654027}
 used to record sound along this line
...
back at its original position. Because there are $$ 360^\circ $$
...
<div data-type="equation" id="eip-873">
 $$ 1\text{rad}=\frac{360^\circ}{2\pi }\approx 57.3^\circ \text{.} $$ 
</div>
