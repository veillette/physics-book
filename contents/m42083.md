...
<div data-type="equation" id="eip-873">
 $$ 1\text{rad}=\frac{\text{360º}}{2\pi }\approx 57.3º\text{.} $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the period of rotation of Earth in seconds? (b) What is the angular velocity of Earth? (c) Given that Earth has a radius of  $$ 6.4×10^{6}\text{m} $$ 
