...
\phantom{\rule{0.25em}{0ex}}\text{Δ}s $$
...
Calculate the angular velocity of a 0.300 m radius car tire when the car travels at  $$ \text{15}\text{.}0\phantom{\rule{0.25em}{0ex}}\text{m/s} $$ 

(about $$ \text{54}\phantom{\rule{0.25em}{0ex}}\text{km/h} $$
...
* {: #import-auto-id2384053} The conversion between radians and degrees is $$
  1\phantom{\rule{0.25em}{0ex}}\text{rad}=\text{57}\text{.}3\text{º} $$
  .
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the period of rotation of Earth in seconds? (b) What is the angular velocity of Earth? (c) Given that Earth has a radius of  $$ 6\text{.}4×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{m} $$ 
