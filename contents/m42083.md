...
The **arc length**{: data-type="term" #import-auto-id2679165} \\( \phantom{\rule{0.25em}{0ex}}\text{Δ}s \\) 

 is the distance traveled along a circular path as shown in [\[link\]](#import-auto-id3418263) Note that  \\( r \\) 
...
This result is the basis for defining the units used to measure rotation angles,  \\( \text{Δ}\theta  \\) 
...
If  \\( \text{Δ}\theta =2\pi  \\) 
 ...
 rad, then the CD has made one complete revolution, and every point on the CD is back at its original position. Because there are  \\( \text{360º} \\) 
...
How fast is an object rotating? We define **angular velocity**{: data-type="term" #import-auto-id2962847}  \\( \omega  \\) 
...
. To get the precise relationship between angular and linear velocity, we again consider a pit on the rotating CD. This pit moves an arc length  \\( \text{Δ}s \\) 
...
The first relationship in  \\( v=\mathrm{r\omega }\text{ or }\omega =\frac{v}{r} \\) 
 ...
 is proportional to the distance from the center of rotation, thus, it is largest for a point on the rim (largest  \\( r \\) 

), as you might expect. We can also call this linear speed  \\( v \\) 

 of a point on the rim the *tangential speed*. The second relationship in  \\( v=\mathrm{r\omega }\text{ or }\omega =\frac{v}{r} \\) 

 can be illustrated by considering the tire of a moving car. Note that the speed of a point on the rim of the tire is the same as the speed  \\( v \\) 

 of the car. See [\[link\]](#import-auto-id2931190). So the faster the car moves, the faster the tire spins—large  \\( v \\) 

 means a large  \\( \omega  \\) 

, because  \\( v=\mathrm{r\omega } \\) 

. Similarly, a larger-radius tire rotating at the same angular velocity ( \\( \omega  \\) 
...
Because the linear speed of the tire rim is the same as the speed of the car, we have  \\( v=\text{15.0 m/s}. \\) 
...
, we can use the second relationship in  \\( v=\mathrm{r\omega }\mathrm{, }\omega =\frac{v}{r} \\) 
...
* {: #import-auto-id2603294} Uniform circular motion is motion in a circle at constant speed. The rotation angle
  ...
  where arc length  \\( \text{Δ}s \\) 
   ...
   is the radius of curvature of the circular path. The quantity  \\( \text{Δ}\theta  \\) 
...
* {: #import-auto-id2442213} Angular velocity
  ...
  . The units of angular velocity are radians per second (rad/s). Linear velocity  \\( v \\) 
