...
in [\[link\]](#import-auto-id3418263) Note that $$ r $$ is the **radius of
curvature**{: data-type="term" #import-auto-id2920709} of the circular path.
...
$$ \Delta\theta $$ to be **radians**{: data-type="term"
#import-auto-id2625941} (rad), defined so that
...
$$ \Delta \theta =\frac{\Delta s}{r} $$ {: #import-auto-id2010216}
...
circular path {: #import-auto-id1019372}
