...
We know that wavelength and frequency are related by $${v}_{w}=\mathrm{f\lambda }$$
...
(1) Enter known values into $${f}_{\text{obs}}={f}_{s}\left(\frac{ {v}_{w}}{ {v}_{w}\phantom{\rule{0.25em}{0ex}}–\phantom{\rule{0.25em}{0ex}}{v}_{s}}\right).$$

<div data-type="equation" id="eip-915">
$${f}_{\text{obs}}={f}_{s}\left(\frac{ {v}_{w}}{ {v}_{w}-{v}_{s}}\right)=\left(\text{150 Hz}\right)\left(\frac{\text{340 m/s}}{\text{340 m/s – 35.0 m/s}}\right)$$
</div>
(2) Calculate the frequency observed by a stationary person as the train approaches.

<div data-type="equation" id="eip-359">
$${f}_{obs}=\left(\text{150 Hz}\right)\left(\text{1.11}\right)=\text{167 Hz}$$
</div>
...
$${f}_{\text{obs}}={f}_{s}\left(\frac{ {v}_{w}}{ {v}_{w}+{v}_{s}}\right)=\left(\text{150 Hz}\right)\left(\frac{\text{340 m/s}}{\text{340 m/s}+\text{35.0 m/s}}\right)$$
</div>
(4) Calculate the second frequency.

<div data-type="equation" id="eip-386">
$${f}_{obs}=\left(\text{150 Hz}\right)\left(0.907\right)=\text{136 Hz}$$
</div>
**Discussion on (a)**
...
. Now, as $${v}_{s}$$
 ...
 approaches infinity, because the denominator in $${f}_{\text{obs}}={f}_{s}\left(\frac{ {v}_{w}}{ {v}_{w}\phantom{\rule{0.25em}{0ex}}±\phantom{\rule{0.25em}{0ex}}{v}_{s}}\right)$$
...
$$3.79×{10}^{3}\phantom{\rule{0.25em}{0ex}}\text{Hz}$$
</div>
</div>
</div>
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
First eagle hears $$4.23×{10}^{3}\phantom{\rule{0.25em}{0ex}}\text{Hz}$$

Second eagle hears $$3.56×{10}^{3}\phantom{\rule{0.25em}{0ex}}\text{Hz}$$
