...
<div data-type="equation" id="eip-947">
 $$\begin{array}{}=\left(8.99×{\text{10}}^{9} \text{N}\cdot {\text{m}}^{2}/{\text{C}}^{2}\right)×\frac{\left(\text{1.60}×{\text{10}}^{\text{–19}} \text{C}\right)\left(1.60×{\text{10}}^{\text{–19}} \text{C}\right)}{\left(0.530×{\text{10}}^{\text{–10}} \text{m}{\right)}^{2}}\\ \end{array} $$
</div>
Thus the Coulomb force is

<div data-type="equation" id="eip-589">
 $$F=\text{8.19}×{\text{10}}^{\text{–8}} \text{N}. $$
</div>
The charges are opposite in sign, so this is an attractive force. This is a very large force for an electron—it would cause an acceleration of  $$8.99×{\text{10}}^{\text{22}} \text{m}/{\text{s}}^{2} $$
...
where  $$G=6.67×{\text{10}}^{-\text{11}} \text{N}\cdot {\text{m}}^{2}/{\text{kg}}^{2} $$
. Here  $$m $$
 and  $$M $$
...
<div data-type="equation" id="eip-142">
 $${F}_{G}=\left(6.67×{\text{10}}^{–\text{11}} \text{N}\cdot {\text{m}}^{2}/{\text{kg}}^{2}\right)×\frac{\left(9.11×{\text{10}}^{\text{–31}} \text{kg}\right)\left(1.67×{\text{10}}^{\text{–27}} \text{kg}\right)}{\left(0.530×{\text{10}}^{\text{–10}} \text{m}{\right)}^{2}}=3.61×{\text{10}}^{\text{–47}} \text{N} $$
</div>
...
* {: #import-auto-id3081048} Coulomb’s law gives the magnitude of the force between point charges. It is
  ...
  where  $${q}_{1} $$
    ...
    , and  $$k\approx 8.99×{10}^{9} \text{N}·{\text{m}}^{2}/{\text{C}}^{2} $$
...
<div data-type="solution" markdown="1">
 $$\begin{array}{lll}F& =& k\frac{\|{q}_{1}{q}_{2}\|}{ {r}^{2}}=\mathrm{ma}⇒a=\frac{k{q}^{2}}{m{r}^{2}}\\ & =& \frac{\left(9.00×{10}^{9} \text{N}\cdot {\text{m}}^{2}/{\text{C}}^{2}\right){\left(1.60×{10}^{–19} \text{m}\right)}^{2}}{\left(1.67×{10}^{–27} \text{kg}\right){\left(2.00×{10}^{–9} \text{m}\right)}^{2}}\\ & =& 3.45×{10}^{16} \text{m/}{\text{s}}^{2}\end{array} $$
</div>
</div>
