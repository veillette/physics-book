...
<div data-type="equation" id="eip-947">
 $$\begin{array}{}=\left( 8.99 \times 10^{9}  \text{N}\cdot {\text{m}}^{2}/{\text{C}}^{2}\right)×\frac{\left(\text{1.60}×{\text{10}}^{\text{–19}} \text{C}\right)\left(1.60×{\text{10}}^{\text{–19}} \text{C}\right)}{\left(0.530×{\text{10}}^{\text{–10}} \text{m}{\right)}^{2}}\\ \end{array} $$
</div>
