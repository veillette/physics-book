...
The electrostatic force is a vector quantity and is expressed in units of newtons. The force is understood to be along the line joining the two charges. (See [\[link\]](#Figure1).)
...
*  Coulomb’s law gives the magnitude of the force between point charges. It is
  ...
  where  $${q}_{1} $$      and  $${q}_{2} $$
     are two point charges separated by a distance  $$r $$ ,  and  $$k\approx 8.99 \times 10^{9}  \text{N}·{\text{m}}^{2}/{\text{C}}^{2} $$
