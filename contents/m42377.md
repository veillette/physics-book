...
<div data-type="equation" id="eip-219">
 $$\begin{array}{lll}\epsilon & =& \text{Blv}=\left(0.100 \text{T}\right)\left( 4.00 \times 10^{-3}  m\right)\left(0\text{.200 m/s}\right)\\ & =& 80.0 \text{μV}\end{array} $$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A Hall probe calibrated to read  $$1\text{.}00 \text{μV} $$
