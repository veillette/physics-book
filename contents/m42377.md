...
,  $$v $$
, and  $$l $$
 are mutually perpendicular, such as shown in [\[link\]](#import-auto-id1648625). Although the magnetic force moves negative charges to one side, they cannot build up without limit. The electric field caused by their separation opposes the magnetic force,  $$F=\text{qvB} $$
, and the electric force,  $${F}_{e}=\text{qE} $$
...
<div data-type="equation" id="eip-219">
 $$\begin{array}{lll}\epsilon & =& \text{Blv}=\left(\text{0.100 T}\right)\left(4\text{.}\text{00}×{\text{10}}^{-3} m\right)\left(0\text{.200 m/s}\right)\\ & =& \text{80.0 μV}\end{array} $$
</div>
**Discussion**
...
<div data-type="problem" markdown="1">
A large water main is 2.50 m in diameter and the average water velocity is 6.00 m/s. Find the Hall voltage produced if the pipe runs perpendicular to the Earth’s  $$5\text{.}\text{00}×{\text{10}}^{-5}\text{-T} $$
 field.

</div>
<div data-type="solution" markdown="1">
 $$7\text{.}\text{50}×{\text{10}}^{-4} V $$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the speed of a supersonic aircraft with a 17.0-m wingspan, if it experiences a 1.60-V Hall voltage between its wing tips when in level flight over the north magnetic pole, where the Earth’s field strength is  $$8\text{.}\text{00}×{\text{10}}^{-5} \text{T?} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A Hall probe calibrated to read  $$1\text{.}\text{00 μV} $$
