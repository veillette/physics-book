...
<div data-type="equation" id="eip-817">
 $$\begin{array}{}E=\left( 1.20 \times 10^{26}  \text{reactions}\right)\left(\text{17.59 MeV/reaction}\right)\left( 1.602 \times 10^{-13}  \text{J/MeV}\right)\\ \text{}= 3.37 \times 10^{14}  \text{J}\text{.}\end{array} $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-674">
 $$\begin{array}{lll}P& =& \frac{E}{t}=\frac{ 3.37 \times 10^{14}  \text{J}}{ 3.16 \times 10^{7}  \text{s}}\\ & =& \text{} 1.07 \times 10^{7}  \text{W}=\text{10}\text{.}7 \text{MW}\text{.}\end{array} $$
</div>
**Discussion**
