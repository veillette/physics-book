...
<div class="equation" id="import-auto-id1429049">
 $$\begin{array}{lll}{}^{12}\text{C}+{}^{1}\text{H}& \to & {}^{13}\text{N}+\gamma ,\\ {}^{13}\text{N}& \to & {}^{13}\text{C}+{e}^{+}+{v}_{e},\\ {}^{13}\text{C}+{}^{1}\text{H}& \to & {}^{14}\text{N}+\gamma ,\\ {}^{14}\text{N}+{}^{1}\text{H}& \to & {}^{15}\text{O}+\gamma ,\\  {}^{15}\text{O}& \to & {}^{15}\text{N}+{e}^{+}+{v}_{e},\\ {}^{15}\text{N}+{}^{1}\text{H}& \to & {}^{12}\text{C}+{}^{4}\text{He.}\end{array} $$
</div>
