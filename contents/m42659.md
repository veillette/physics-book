...
Power is energy per unit time. One year has $$3\text{.}\text{16}×{\text{10}}^{7}\phantom{\rule{0.25em}{0ex}}\text{s}$$
, so
...
By now we expect nuclear processes to yield large amounts of energy, and we are not disappointed here. The energy output of $$3\text{.}\text{37}×{\text{10}}^{\text{14}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
$$3.12×{\text{10}}^{5}\phantom{\rule{0.25em}{0ex}}\text{kg}$$
 (about 200 tons)
