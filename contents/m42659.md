...
<div data-type="equation" id="eip-789">
 $${}^{1}\text{H}+{}^{1}\text{H}\to {}^{2}\text{H}+{e}^{+}+{v}_{\text{e}}                \left(0.42 MeV\right) $$
</div>

<div data-type="equation" id="eip-495">
 $${}^{1}\text{H}+{}^{2}\text{H}\to {}^{3}\text{He}+\gamma                          \left(5.49 MeV\right) $$
</div>

<div data-type="equation" id="eip-866">
 $${}^{3}\text{He}+{}^{3}\text{He}\to {}^{4}\text{He}+{}^{1}\text{H}+{}^{1}\text{H}       \left(12.86 MeV\right) $$
</div>
...
<div data-type="equation" id="eip-983">
 $$2{e}^{-}+4{}^{1}\text{H}\to {}^{4}\text{He}+{2v}_{\text{e}}+6\gamma         \left(26.7 MeV\right) $$
</div>
...
<div data-type="equation" id="eip-494">
 $${}^{2}\text{H}+{}^{2}\text{H}\to {}^{3}\text{H}+{}^{1}\text{H}       \left(4.03 MeV\right) $$
</div>

<div data-type="equation" id="eip-522">
 $${}^{2}\text{H}+{}^{2}\text{H}\to {}^{3}\text{He}+n        \left(3.27 MeV\right) $$
</div>

<div data-type="equation" id="eip-540">
 $${}^{2}\text{H}+{}^{3}\text{H}\to {}^{4}\text{He}+n      \left(17.59 MeV\right) $$
</div>

<div data-type="equation" id="eip-816">
 $${}^{2}\text{H}+{}^{2}\text{H}\to {}^{4}\text{He}+\gamma         \left(23.85 MeV\right). $$
</div>
...
<div data-type="equation" id="eip-573">
 $$n+{}^{1}\text{H}\to {}^{2}\text{H}+\gamma       \left(20.68 MeV\right) $$
</div>

and

<div data-type="equation" id="eip-291">
 $$n+{}^{1}\text{H}\to {}^{2}\text{H}+\gamma      \left(2.22 MeV\right). $$
</div>
...
) is 3.016049 u, for a total of 5.032151 u per reaction. So a mole of reactants has a mass of 5.03 g, and in 1.00 kg there are  $$\left(1000 \text{g}\right)/\left(\text{5.03 g/mol}\right)\text{=198}\text{.}8 mol of reactants $$
. The number of reactions that take place is therefore

<div data-type="equation" id="eip-812">
 $$\left(\text{198.8 mol}\right)\left( 6.02 \times 10^{23}  {\text{mol}}^{-1}\right)= 1.20 \times 10^{26}  \text{reactions}. $$
</div>
The total energy output is the number of reactions times the energy per reaction:

<div data-type="equation" id="eip-817">
 $$\begin{array}{}E=\left( 1.20 \times 10^{26}  \text{reactions}\right)\left(\text{17.59 MeV/reaction}\right)\left( 1.602 \times 10^{-13}  \text{J/MeV}\right)\\  = 3.37 \times 10^{14}  \text{J}\text{.}\end{array} $$
</div>
**Solution for (b)**
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
 $$\begin{array}{lll}E& =& \left({m}_{\text{i}}-{m}_{\text{f}}\right){c}^{2}\\ & =& \left[4m\left({}^{1}\text{H}\right)-m\left({}^{4}\text{He}\right)\right]{c}^{2}\\ & =& \left[4\left(1.007825\right) -4.002603\right]\left(\text{931.5 MeV}\right)\\ & =& \text{26.73 MeV}\end{array} $$
</div>
</div>
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
 $$\begin{array}{lll}E& =& \left({m}_{\text{i}}-{m}_{\text{f}}\right){c}^{2}\\ {E}_{1}& =& \left(1.008665+3.016030-4.002603\right)\left(\text{931.5 MeV}\right)\\ & =& \text{20.58 MeV}\\ {E}_{2}& =& \left( 1.008665+ 1.007825 -2.014102\right)\left(\text{931.5 MeV}\right)\\ & =& \text{2.224 MeV}\end{array} $$
...
<div data-type="equation" id="import-auto-id1429049">
 $$\begin{array}{lll}{}^{\text{12}}\text{C}+{}^{1}\text{H}& \to & {}^{\text{13}}\text{N}+\gamma ,\\ {}^{\text{13}}\text{N}& \to & {}^{\text{13}}\text{C}+{e}^{+}+{v}_{e},\\ {}^{\text{13}}\text{C}+{}^{1}\text{H}& \to & {}^{\text{14}}\text{N}+\gamma ,\\ {}^{\text{14}}\text{N}+{}^{1}\text{H}& \to & {}^{\text{15}}\text{O}+\gamma ,\\  {}^{\text{15}}\text{O}& \to & {}^{\text{15}}\text{N}+{e}^{+}+{v}_{e},\\ {}^{\text{15}}\text{N}+{}^{1}\text{H}& \to & {}^{\text{12}}\text{C}+{}^{4}\text{He.}\end{array} $$
</div>
...
) annihilate electrons to form more  $$\gamma  $$
 rays.
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
 ...
 $${E}_{ {}^{4}\text{He}}=5.68 \times 10^{-2}\mathrm{MeV} $$
</div>
</div>
