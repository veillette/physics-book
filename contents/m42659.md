...
) is 3.016049 u, for a total of 5.032151 u per reaction. So a mole of reactants has a mass of 5.03 g, and in 1.00 kg there are  $$\left(1000 \text{g}\right)/\left(5.03 \text{g/mol}\right)\text{=198}\text{.}8 mol of reactants $$
...
<div class="equation" id="import-auto-id1429049">
 $$\begin{array}{lll}{}^{12}\text{C}+{}^{1}\text{H}& \to & {}^{13}\text{N}+\gamma ,\\ {}^{13}\text{N}& \to & {}^{13}\text{C}+{e}^{+}+{v}_{e},\\ {}^{13}\text{C}+{}^{1}\text{H}& \to & {}^{14}\text{N}+\gamma ,\\ {}^{14}\text{N}+{}^{1}\text{H}& \to & {}^{15}\text{O}+\gamma ,\\  {}^{15}\text{O}& \to & {}^{15}\text{N}+{e}^{+}+{v}_{e},\\ {}^{15}\text{N}+{}^{1}\text{H}& \to & {}^{12}\text{C}+{}^{4}\text{He} \text{.} \end{array} $$
</div>
