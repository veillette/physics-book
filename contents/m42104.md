...
Recall that **vectors**{: data-type="term" #import-auto-id1165298541000}
...
* {: #import-auto-id1165296313373} The shortest path between any two points is a straight
  line. In two dimensions, this path can be represented by a vector with
  horizontal and vertical components.
* {: #import-auto-id1165296414067} The horizontal and vertical components of a vector are
