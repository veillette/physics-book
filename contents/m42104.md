...
\sqrt{\left(\text{9 blocks}{\right)}^{2}\text{+ }\left(\text{5 blocks}{\right)
}^{2}}\text{= 10}\text{.}\text{3 blocks} $$, considerably shorter than the 14 blocks you walked. (Note that we are using
