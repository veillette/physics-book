...
The relatively scarce naturally occurring calcium isotope $${}^{48}\text{Ca}$$
 ...
 has a half-life of about $$2×{10}^{16}\phantom{\rule{0.25em}{0ex}}\text{y}$$
...
A physicist scatters $$\gamma $$
 ...
 rays from a substance and sees evidence of a nucleus $$7.5×{10}^{–13}\phantom{\rule{0.25em}{0ex}}\text{m}$$
