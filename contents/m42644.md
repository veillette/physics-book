...
<table id="eip-439" summary="Table lists five nuclides in column 1. Their energies in M e V are listed in column 2, and their half-lives are listed in column 3."><caption><span data-type="title">Energy and Half-Life for  $$\alpha  $$       Decay   </span></caption><thead>
<tr>
<th>Nuclide</th>

<th> 
 $${E}_{\text{α}}\phantom{\rule{0.25em}{0ex}}\text{(MeV)} $$
</th>
...
<th> $${t}_{\text{1/2}} $$
 ...
 $$\text{4.1} $$
    ...
    <td>
 $$1.4×{\text{10}}^{\text{10}}\phantom{\rule{0.25em}{0ex}}\text{y} $$
</td>
  </tr>
</tbody></table>
</div>
...
The relatively scarce naturally occurring calcium isotope  $${}^{48}\text{Ca} $$
 has a half-life of about  $$2×{10}^{16} \text{y} $$
...
A physicist scatters  $$\gamma  $$
 rays from a substance and sees evidence of a nucleus  $$7.5×{10}^{–13} \text{m} $$
