...
<div class="equation" id="import-auto-id2669968">
 $$ PV= NkT \left(\text{ideal gas}\right)\text{.} $$
</div>
...
Similarly, the curve between the solid and liquid regions in [\[link\]](#import-auto-id2045521) gives the melting temperature at various pressures. For example, the melting point is  $$0\text{ºC} $$
...
<div class="exercise" data-element-type="conceptual-questions">
<div class="problem" markdown="1">
Can carbon dioxide be liquefied at room temperature ( $$20\text{ºC} $$)? If so, how? If not, why not? (See [[link]](#import-auto-id2298789).)
