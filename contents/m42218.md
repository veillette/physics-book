...
All three curves on the phase diagram meet at a single point, the **triple point**, where all three phases exist in equilibrium. For water, the triple point occurs at 273.16 K  $$\left(0\text{.}\text{01}\text{º}\text{C}\right) $$
