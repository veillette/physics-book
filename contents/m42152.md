...
<div data-type="equation">
 $$ \begin{array}{lll}
P& =& \frac{0.5\left(60.0 \text{kg}\right){\left(2.00 \text{m/s}\right)}^{2}+\left(60.0 \text{kg}\right)\left( 9.80 \text{ m/s}^{2}\right)\left(3.00 \text{m}\right)}{3.50 \text{s}}\\ 
...
$$ 5.00 \text{kW}\cdot h $$ of energy per day? (b) How many joules of energy 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the average useful power output of a person who does  $$ 6.00\times 10^{6}\text{J} $$ of useful work in 8.00 h? 
...
operates a 2.00-W electric clock for 18 months? (b) How long can a battery 
that can supply  $$ 8.00\times 10^{4}\text{J} $$ run a pocket calculator that consumes energy at the rate of $$ 1.00\times 10^{-3}\text{W} $$ ?
...
<div data-type="solution" markdown="1">
Identify knowns:  $$ m=950 \text{kg} $$, $$ \text{slope angle}\theta =2.00^\circ $$, $$ v=3.00 m/s $$, $$ f=600
...
P& =& \left( f+mg \sin{\theta} \right)v \\ 
 & =&  \left[600 \text{N}+\left(950 \text{kg}\right)\left(9.80 \text{m/s}^{2}
...
United States’ energy needs $$ \left( 1.05\times 10^{20}\text{J}\right) $$ ?
Australia’s energy needs $$ \left(5.4\times 10^{18}\text{J} \right) $$? China’s 
energy needs $$ \left(6.3\times 10^{19}\text{J} \right) $$ ?
