...
<div data-type="equation">
 $$ \begin{array}{lll}E& =& \text{Pt}=\left(0\text{.}\text{200}\text{kW}\right)\left(6\text{.}\text{00}\text{h/d}\right)\left(\text{30}\text{.}0\text{d}\right)\\ & =& \text{}\text{36}\text{.}\text{0 kW}\cdot \text{h,}\end{array} $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the average useful power output of a person who does  $$ 6\text{.}\text{00}×{\text{10}}^{6}\text{J} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the available energy content, in joules, of a battery that operates a 2.00-W electric clock for 18 months? (b) How long can a battery that can supply  $$ 8\text{.}\text{00}×{\text{10}}^{4}\text{J} $$ 

run a pocket calculator that consumes energy at the rate of $$
1\text{.}\text{00}×{\text{10}}^{-3}\text{W} $$
?

</div>
<div data-type="solution" markdown="1">
(a)  $$ 9\text{.}\text{46}×{\text{10}}^{7}\text{J} $$ 
...
, $$ \text{slope angle}\theta =2.00º $$, $$ v=3.00 m/s $$, $$ f=\text{600 N} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the power per square meter reaching Earth’s upper atmosphere from the Sun. (Take the power output of the Sun to be  $$ 4\text{.}\text{00}×{\text{10}}^{\text{26}}\text{W}\text{.}\right) $$ 
...
energy needs $$ \left(
1\text{.}\text{05}×{\text{10}}^{\text{20}}\text{J}\right)
? $$
Australia’s energy needs $$ \left(
5\text{.}4×{\text{10}}^{\text{18}}\text{J)?} $$
China’s energy needs $$ \left(
6\text{.}3×{\text{10}}^{\text{19}}\text{J)?} $$
