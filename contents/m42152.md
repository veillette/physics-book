...
<div data-type="equation">
 $$ \begin{array}{lll}P& =& \frac{0.5\left(60.0 \text{kg}\right){\left(2.00 \text{m/s}\right)}^{2}+\left(60.0 \text{kg}\right)\left( 9.80 \text{ m/s}^{2}\right)\left(3.00 \text{m}\right)}{3.50 \text{s}}\\ & =& \frac{120 \text{J}+1764 \text{J}}{3.50 \text{s}}\\ & =& 538 \text{W.}
\end{array} $$ 
</div>
**Discussion**
