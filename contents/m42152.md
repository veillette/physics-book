...
<div data-type="equation">
 $$ \begin{array}{lll}E& =& \text{Pt}=\left(0.200\text{kW}\right)\left(6.00\text{h/d}\right)\left(30.0\text{d}\right)\\ & =& \text{}36.0 \text{kW}\cdot \text{h,}\end{array} $$ 
</div>
...
f+mg \sin{\theta}
\right)v\\ & =&
\left[600 \text{N}+\left(950 \text{kg}\right)\left(9.80 \text{ m/s}^{2}\right)\text{sin 2º}\right]
