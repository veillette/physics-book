...
given in terms of the **perpendicular lever arm**{: data-type="term" #import-auto-id2704160} $$ r_{\perp } $$
...
The perpendicular lever arm $$ r_{\perp } $$
...
the distance $$ r_{\perp } $$
is perpendicular to $$ \mathbf{\text{F}} $$, as its name implies. It is sometimes easier to find or visualize $$ r_
{\perp } $$
than to find both $$ r $$
and $$ \theta $$. In such cases, it may be more convenient to use ** $$ \tau =r_{\perp }F $$
** rather than $$ \tau
=\text{rF}\sin{\theta}
$$
...
, so that $$ \sin{\theta} =1 $$
for all three forces. That means $$ r_{\perp }=r $$
...
<div data-type="equation" id="eip-280">
 $$ \begin{array}{lll}{\tau }_{\text{p}}& =& r_{\text{p}}{F}_{\text{p}}\\ & =& 0\cdot {F}_{\text{p}}\\ & =& 0.\end{array} $$ 
</div>
...
acts directly on the pivot point, the distance $$ r_{\text{p}} $$
...
The quantities on the right side of the equation are known; thus,  $$ r_{2} $$ 
...
<div data-type="equation" id="eip-830">
 $$ \begin{array}{lll}{F}_{\text{p}}& =& \left(26.0 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)+\left(32.0 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)\\ & =& 568 \text{N.}\end{array} $$ 
</div>
**Discussion**
...
not an approximation—the distances $$ r_{1}} $$
and $$ r_{2}} $$
...
* {: #import-auto-id3580915} The second condition assures those torques are also
  ...
  point. The perpendicular lever arm $$ r_
  {\perp } $$
  is defined to be
...
* {: #import-auto-id2658945} The perpendicular lever arm $$ r_{\perp } $$
...
<div data-type="equation" id="eip-id2115028">
 $$ \begin{array}{ccc}m_{1}& =& \text{26.0 kg,}m_{2}=\text{32.0 kg,}m_{\text{s}}=\text{12.0 kg,}\\ r_{1}& =& \text{1.60 m,}r_{\text{s}}=\text{0.160 m, find (a)}r_{2,}\text{(b)}{F}_{\text{p}}\end{array} $$ 
</div>
a) Since children are balancing:

<div data-type="equation" id="import-auto-id581634">
 $$ \begin{array}{}\text{net}{\tau }_{\text{cw}}=–\text{net}{\tau }_{\text{ccw}}\\ ⇒w_{1}r_{1}+m_{\text{s}}{\mathit{gr}}_{\text{s}}=w_{2}r_{2}\\ \end{array} $$ 
</div>
So, solving for  $$ r_{2} $$ 
...
<div data-type="equation" id="import-auto-id1402886">
 $$ \begin{array}{lll}r_{2}& =& \frac{ w_{1}r_{1}+m_{\text{s}}{\mathit{gr}}_{\text{s}}}{ w_{2}}=\frac{ m_{1}{\mathit{gr}}_{1}+m_{\text{s}}{\mathit{gr}}_{\text{s}}}{ m_{2}g}=\frac{ m_{1}r_{1}+m_{\text{s}}r_{\text{s}}}{ m_{2}}\\ & =& \frac{\left(26.0 \text{kg}\right)\left(1.60 \text{m}\right)+\left(12.0 \text{kg}\right)\left(0.160 \text{m}\right)}{32.0 \text{kg}}\\ & =& 1.36 \text{m}\end{array} $$ 
</div>
b) Since the children are not moving:

<div data-type="equation" id="import-auto-id1428249">
 $$ \begin{array}{}\text{net}F=0=F_{\text{p}}–w_{1}–w_{2}–w_{\text{s}}\\ ⇒{F}_{\text{p}}=w_{1}+w_{2}+w_{s}\end{array} $$ 
</div>
So that

<div data-type="equation" id="import-auto-id1404316">
 $$ \begin{array}{lll}{F}_{\text{p}}& =& \left(26.0 \text{kg}+32.0 \text{kg}+12.0 \text{kg}\right)\left(9.80\text{m}/{\text{s}}^{2}\right)\\ & =& 686 \text{N}\end{array} $$ 
</div>
</div>
</div>
