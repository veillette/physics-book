...
into the definition of the physical quantity called torque. **Torque**{: data-type="term" #import-auto-id2603151}
 is the rotational equivalent of a
...
is perpendicular to $$ \mathbf{\text{F}} $$, as its name implies. It is sometimes easier to find or visualize $$ r_{\perp } $$
than to find both $$ r $$
...
by the supporting force $$ F_{\text{p}} $$
...
and $$ r_{2}} $$
are the distances to points directly below the **center of gravity**{: data-type="term" #import-auto-id2628264}
 of each child. As we shall see in the
...
* {: #import-auto-id3580915} The second condition assures those torques are also
  ...
  point. The perpendicular lever arm $$ r_  {\perp } $$
  is defined to be
...
r_{1}& =& 1.60  \text{m,}
r_{\text{s}}=0.160 \text{m}, \text{find (a)}r_{2,}\text{(b)}{F}_{\text{p}}\end{array} $$ 
</div>
...
<div data-type="equation" id="import-auto-id1402886">
 $$ \begin{array}{lll}r_{2}& =& \frac{ w_{1}r_{1}+m_{\text{s}}{gr}_{\text{s}}}{ w_{2}}=\frac{ m_{1}{gr}_{1}+m_{\text{s}}{gr}_{\text{s}}}{ m_{2}g}=\frac{ m_{1}r_{1}+m_{\text{s}}r_{\text{s}}}{ m_{2}}\\ & =& \frac{\left(26.0 \text{kg}\right)\left(1.60 \text{m}\right)+\left(12.0 \text{kg}\right)\left(0.160 \text{m}\right)}{32.0 \text{kg}}\\ & =& 1.36 \text{m}\end{array} $$ 
</div>
...
<div data-type="equation" id="import-auto-id1404316">
 $$ \begin{array}{lll}{F}_{\text{p}}& =& \left(26.0 \text{kg}+32.0 \text{kg}+12.0 \text{kg}\right)\left(9.80 \text{m/s}^{2}\right)\\ & =& 686 \text{N}\end{array} $$ 
</div>
</div>
</div>
