...
#import-auto-id2704160} \\( {r}_{\perp } \\)
...
, as its name implies. It is sometimes easier to find or visualize \\( {r}_
{\perp } \\)
...
. The easiest way to find it is to use the first condition for equilibrium,
which is
