...
<div data-type="equation" id="eip-830">
 $$ \begin{array}{lll}{F}_{\text{p}}& =& \left(26.0 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)+\left(32.0 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)\\
 & =& 568 \text{N} .
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id2115028">
 $$ \begin{array}{ccc}
m_{1}& =& 26.0 \text{kg},m_{2}=32.0 \text{kg}, m_{\text{s}}=12.0 \text{kg},\\ 
r_{1}& =& 1.60  \text{m}, r_{\text{s}}=0.160 \text{m}, \text{find (a)}r_{2,}\text{(b)}{F}_{\text{p}}
\end{array} $$ 
</div>
...
<div data-type="equation" id="import-auto-id1402886">
 $$ \begin{array}{lll}
r_{2}& =& \frac{ w_{1}r_{1}+m_{\text{s}}{gr}_{\text{s}}}{ w_{2}}=\frac{ m_{1}{gr}_{1}+m_{\text{s}}{gr}_{\text{s}}}{ m_{2}g}=\frac{ m_{1}r_{1}+m_{\text{s}}r_{\text{s}}}{ m_{2}}\\
 & =& \frac{\left(26.0 \text{kg}\right)\left(1.60 \text{m}\right)+\left(12.0 \text{kg}\right)\left(0.160 \text{m}\right)}{32.0 \text{kg}}\\
 & =& 1.36 \text{m}
\end{array} $$ 
</div>
