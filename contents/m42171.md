...
(b) A smaller counterclockwise torque is produced by a smaller force F&#x2032; size 12{F} {} acting at the same distance from the hinges (the pivot point).
...
<div data-type="equation" id="import-auto-id1402886">
 $$ \begin{array}{lll}
r_{2}& =& \frac{ w_{1}r_{1}+m_{\text{s}}{gr}_{\text{s}}}{ w_{2}}=\frac{ m_{1}{gr}_{1}+m_{\text{s}}{gr}_{\text{s}}}{ m_{2}g}=\frac{ m_{1}r_{1}+m_{\text{s}}r_{\text{s}}}{ m_{2}}\\ & =& \frac{\left(26.0 \text{kg}\right)\left(1.60 \text{m}\right)+\left(12.0 \text{kg}\right)\left(0.160 \text{m}\right)}{32.0 \text{kg}}\\ & =& 1.36 \text{m}
\end{array} $$ 
</div>
...
<div data-type="equation" id="import-auto-id1404316">
 $$ \begin{array}{lll}
F_{\text{p}}& =& \left(26.0 \text{kg}+32.0 \text{kg}+12.0 \text{kg}\right)\left(9.80 \text{m/s}^{2}\right)\\ 
& =& 686 \text{N}
\end{array} $$ 
</div>
</div>
