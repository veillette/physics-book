...
An array of such pipes in the California desert can provide a thermal output of 250 MW on a sunny day, with fluids reaching temperatures as high as  $$400 \text{º}\text{C} $$
...
<div data-type="equation" id="eip-372">
 $${d}_{\text{i}}=–\left( 0.0320\right)\left(12.0 \text{cm}\right)=\text{–0.384 cm.} $$
</div>
