...
<div data-type="equation" id="eip-677">
 $$\begin{array}{lll}m& =& \rho \text{V}=\mathrm{\rho \pi }{\left(\frac{d}{2}\right)}^{2}\left(1.00 m\right)\\ & =& \left(8.00 \times 10^{2}  {\text{kg/m}}^{3}\right)\text{(3.14)}{\text{(0.0100 m)}}^{2}\left(1.00 m\right)\\ & =& 0.251 kg.\end{array} $$
</div>
...
<div data-type="equation" id="eip-372">
 $${d}_{\text{i}}=–\left( 0.0320\right)\left(\text{12.0 cm}\right)=\text{–0.384 cm.} $$
</div>
...
<div data-type="equation" id="eip-70">
 $$\frac{1}{f}=\frac{1}{\text{12.0 cm}}+\frac{1}{-0.384 \text{cm}}=\frac{ -2.52}{\text{cm}}\text{.} $$
</div>
