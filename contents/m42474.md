...
2.  {: #import-auto-id2635573} Per meter of pipe, what will be the amount of sunlight concentrated onto the pipe, assuming the insolation (incident solar radiation) is $$0.900 \text{k}{\text{W/m}}^{2} $$  ?
