...
where $$ \theta $$ is the angle of rotation as seen in [Figure 1](#fig1). The
...
where $$ r $$ is the radius of curvature, also seen in [Figure 1](#fig1).
...
to the circle at the point of interest, as seen in [Figure 2](#fig2). Thus,
...
in [Figure 3](#fig3). Thus, $$ a_{\text{t}} $$ and $$ a_{\text{c}} $$ are
