...
An indicator called the **Reynolds number**{: data-type="term" #import-auto-id2891021} $${N}_{\text{R}}$$
...
$${N}_{\text{R}}=\frac{2\rho \text{vr}}{\eta }\text{(flow in tube),}$$
</div>
...
Entering the known values into $${N}_{\text{R}}=\frac{2\rho \text{vr}}{\eta }$$
 gives

<div data-type="equation" id="import-auto-id2447591">
$$\begin{array}{lll}{N}_{\text{R}}& =& \frac{2\rho \text{vr}}{\eta }\\ & =& \frac{2\left({\text{1025 kg/m}}^{3}\right)\left(\text{1.70 m/s}\right)\left(0.150×{\text{10}}^{-3} \text{m}\right)}{1\text{.}\text{00}×{\text{10}}^{-3} \text{N}\cdot {\text{s/m}}^{2}}\\ & =& \text{523}\text{.}\end{array}$$
</div>
**Discussion**
...
<div data-type="problem" markdown="1">
Verify that the flow of oil is laminar (barely) for an oil gusher that shoots crude oil 25.0 m into the air through a pipe with a 0.100-m diameter. The vertical pipe is 50 m long. Take the density of the oil to be $$\text{900 kg}{\text{/m}}^{3}$$
 and its viscosity to be $$1.00 \left({\text{N/m}}^{2}\right)\cdot \text{s}$$
 (or $$1.00 Pa\cdot \text{s}$$
).
...
<div data-type="solution" markdown="1">
(a) nozzle: $$1\text{.}\text{27}×{\text{10}}^{5}$$
 , not laminar

(b) hose: $$3\text{.}\text{51}×{\text{10}}^{4}$$
, not laminar.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A fire hose has an inside diameter of 6.40 cm. Suppose such a hose carries a flow of 40.0 L/s starting at a gauge pressure of $$1\text{.}\text{62}×{\text{10}}^{6} {\text{N/m}}^{2}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
At what flow rate might turbulence begin to develop in a water main with a 0.200-m diameter? Assume a $$\text{20º C}$$
 temperature.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the greatest average speed of blood flow at $$\text{37º C}$$
...
$$1.28×{\text{10}}^{–2} \text{L/s}$$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In [Take-Home Experiment: Inhalation](#fs-id1861353), we measured the average flow rate *$$Q$$
* of air traveling through the trachea during each inhalation. Now calculate the average air speed in meters per second through your trachea during each inhalation. The radius of the trachea in adult humans is approximately $${\text{10}}^{-2} \text{m}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Gasoline is piped underground from refineries to major users. The flow rate is $$3\text{.}\text{00}×{\text{10}}^{–2} {\text{m}}^{3}\text{/s}$$
 (about 500 gal/min), the viscosity of gasoline is $$1.00×{\text{10}}^{–3} \left({\text{N/m}}^{2}\right)\cdot \text{s}$$
, and its density is $$\text{680} {\text{kg/m}}^{3}$$
...
<div data-type="solution" markdown="1">
(a)$$\text{≥ 13.0 m}$$
(b) $$2\text{.}\text{68}×{\text{10}}^{-6} {\text{N/m}}^{2}$$
</div>
</div>
