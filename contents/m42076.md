...
4\text{.}\text{50}×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{N} \\)

. What is the rocket’s acceleration? Explicitly show how you follow the steps in
...
so that \\( F=\text{ma}+w=\text{ma}+\text{mg}=m\left(a+g\right) \\)

. \\( F=\left(\text{70.0 kg}\right)
\left[\left(\text{39}\text{.}{\text{2 m/s}}^{2}\right)+\left(9\text{.}{\text{80 m/s}}^{2}\right)\right]
\\)

\\( =3.\text{43}×{\text{10}}^{3}\text{N} \\)

. The force exerted by the high-jumper is actually down on the ground, but \\( F
\\)
...
5.50×{10}^{4}\phantom{\rule{0.25em}{0ex}}\text{kg} \\)
...
7\text{.}\text{50}×{\text{10}}^{5}\phantom{\rule{0.25em}{0ex}}\text{N} \\)
...
that total 2400 N. If the acceleration is \\( 0\text{.}{\text{150 m/s}}^{2} \\)
...
. (c) Find the direction and magnitude of some other pair of vectors that add to
give \\( {\mathbf{\text{F}}}_
{\text{tot}} \\)
