...
<div class="equation">
 $$\Delta {U}_{1}={Q}_{1}-{W}_{1}= 40.00 J- 10.00 J=30.00 \text{J.} $$
</div>
Now consider 25.00 J of heat transfer out and 4.00 J of work in, or

<div class="equation">
 $$\Delta {U}_{2}={Q}_{2}-{W}_{2}=- 25.00 J-\left( -4.00J\right)=-21.00 \text{J.} $$
</div>
The total change is the sum of these two steps, or

<div class="equation">
 $$\Delta U=\Delta {U}_{1}+\Delta {U}_{2}= 30.00 J+\left(- 21.00 J\right)=9.00 \text{J.} $$
</div>
**Discussion on (a)**
...
<div class="equation" id="eip-625">
 $$\Delta U=Q–W= -150.00 \text{J}–\left(-159.00 \text{J}\right)=9.00 \text{J.} $$
</div>
**Discussion on (b)**
...
(c) Work done by the motor is  $$ 1.61 \times 10^{7}  \text{J} $$
