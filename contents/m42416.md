...
A short circuit to the grounded metal case of an appliance occurs as shown in [[link]](#Figure9). The person touching the case is wet and only has a  $$3.00 \text{kΩ} $$
