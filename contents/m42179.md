...
<div data-type="equation" id="eip-946">
 $$ \mathrm{\tau }=\mathrm{rF}\text{sin θ}=\left(1.50 \text{m}\right)\left(250 \text{N}\right)=375 \text{N}\cdot \text{m.} $$ 
</div>
**Solution for (a)**
...
and $$ R=1.50 \text{m} $$, so that

<div data-type="equation" id="eip-768">
 $$ I=\left(0.500\right)\left(50.0 \text{kg}\right)\left(1.50 \text{m}{\right)}^{2}=56.25 \text{kg}\cdot \text{m}^{2}\text{.} $$ 
</div>
Now, after we substitute the known values, we find the angular acceleration to be

<div data-type="equation" id="eip-861">
 $$ \alpha =\frac{\tau }{I}=\frac{375 \text{N}\text{⋅}\text{m}}{56.25 \text{kg}\cdot \text{m}^{2}}=6.67\frac{\text{rad}}{ {\text{s}}^{2}}\text{.} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-266">
 $$  I_{\text{c}}=MR^{2}=\left(18.0 \text{kg}\right)\left(1.25 \text{m}{\right)}^{2}=28.13 \text{kg}\cdot \text{m}^{2}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-50">
 $$ \alpha =\frac{\text{τ}}{I}=\frac{375 \text{N}\cdot \text{m}}{84.38 \text{kg}\cdot \text{m}^{2}}=4.44\frac{\text{rad}}{ {\text{s}}^{2}}\text{.} $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The triceps muscle in the back of the upper arm extends the forearm. This muscle in a professional boxer exerts a force of  $$ 2.00\times 10^{3}\text{N} $$ 
...
and her lower leg has a moment of inertia of $$ 0.750 \text{kg}\cdot
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Zorch, an archenemy of Superman, decides to slow Earth’s rotation to once per 28.0 h by exerting an opposing force at and parallel to the equator. Superman is not immediately concerned, because he knows Zorch can only exert a force of  $$ 4.00\times 10^{7}\text{N} $$ 
