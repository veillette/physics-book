...
\text{120}\phantom{\rule{0.25em}{0ex}}{\text{rad/s}}^{2} $$. What is the moment of inertia of the boxer’s forearm?
...
0.050\phantom{\rule{0.25em}{0ex}}\text{kg}\cdot {\text{m}}^{2} $$. (a) What time is required for her to exactly reverse her spin? (b) What is
