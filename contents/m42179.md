...
, the moment of inertia for any object depends on the chosen axis. Actually,
calculating \\( I \\)
...
inertia around its axis is therefore \\( {\text{MR}}^{2} \\)
...
merry-go-round. To find the total moment of inertia \\( I \\)
...
\text{120}\phantom{\rule{0.25em}{0ex}}{\text{rad/s}}^{2} \\)
...
. What is the force exerted by the muscle if its effective perpendicular lever
arm is 1.90 cm?
...
0.050\phantom{\rule{0.25em}{0ex}}\text{kg}\cdot {\text{m}}^{2} \\)

. (a) What time is required for her to exactly reverse her spin? (b) What is
...
relationship is the basis for all other moments of inertia {:
