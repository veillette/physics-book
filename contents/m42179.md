...
<div data-type="equation" id="eip-946">
 $$ \mathrm{\tau }=\mathrm{rF}\text{sin θ}=\left(\text{1.50 m}\right)\left(250 \text{N}\right)=375 \text{N}\cdot \text{m.} $$ 
</div>
**Solution for (a)**
...
<div data-type="equation" id="eip-768">
 $$ I=\left(0.500\right)\left(\text{50.0 kg}\right)\left(\text{1.50 m}{\right)}^{2}=\text{56.25 kg}\cdot {\text{m}}^{2}\text{.} $$ 
</div>
Now, after we substitute the known values, we find the angular acceleration to be

<div data-type="equation" id="eip-861">
 $$ \alpha =\frac{\tau }{I}=\frac{375 \text{N}\text{⋅}\text{m}}{\text{56.25 kg}\cdot {\text{m}}^{2}}=6.67\frac{\text{rad}}{ {\text{s}}^{2}}\text{.} $$ 
</div>
**Solution for (b)**
...
merry-go-round. To find the total moment of inertia $$ I $$, we first find the child’s moment of inertia $$  I_{\text{c}} $$
...
<div data-type="equation" id="eip-266">
 $$  I_{\text{c}}={\mathrm{MR}}^{2}=\left(\text{18.0 kg}\right)\left(\text{1.25 m}{\right)}^{2}=\text{28.13 kg}\cdot {\text{m}}^{2}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-50">
 $$ \alpha =\frac{\text{τ}}{I}=\frac{375 \text{N}\cdot \text{m}}{\text{84.38 kg}\cdot {\text{m}}^{2}}=4.44\frac{\text{rad}}{ {\text{s}}^{2}}\text{.} $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The triceps muscle in the back of the upper arm extends the forearm. This muscle in a professional boxer exerts a force of  $$ 2.00×10^{3}\text{N} $$ 

with an effective perpendicular lever arm of 3.00 cm, producing an angular
acceleration of the forearm of $$ 120{\text{rad/s}}^{2} $$. What is the moment of inertia of the boxer’s forearm?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Zorch, an archenemy of Superman, decides to slow Earth’s rotation to once per 28.0 h by exerting an opposing force at and parallel to the equator. Superman is not immediately concerned, because he knows Zorch can only exert a force of  $$ 4.00×10^{7}\text{N} $$ 
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{c} I_{\text{end}}= I_{\text{center}}+m{\left(\frac{l}{2}\right)}^{2}\\ \text{Thus,} I_{\text{center}}= I_{\text{end}}-\frac{1}{4}{\text{ml}}^{2}=\frac{1}{3}{\text{ml}}^{2}-\frac{1}{4}{\text{ml}}^{2}=\frac{1}{12}}{\text{ml}}^{2}\end{array} $$ 
...
rad/s, and her moment of inertia is $$ 0.050\text{kg}\cdot {\text{m}}^{2} $$. (a) What time is required for her to exactly reverse her spin? (b) What is
...
A torque of $$ 500 \text{N}\cdot \text{m} $$
is reasonable.
