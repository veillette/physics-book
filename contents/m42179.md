...
is obtained in the direction of $$ F $$. We can rearrange this equation such that $$ F=ma  $$
and then look for ways to relate this expression to expressions for rotational
quantities. We note that $$
a=\mathrm{r\alpha } $$, and we substitute this expression into $$ F=ma  $$, yielding
...
m r^{2}  $$
is analogous to mass (or inertia). The quantity $$ m r^{2}  $$
...
I $$
of an object to be the sum of $$ m r^{2}  $$
...
<div data-type="problem" markdown="1">
The moment of inertia of a long rod spun around an axis through one end perpendicular to its length is  $$ {\mathit{ML}}^{2}\text{/3} $$ . Why is this moment of inertia greater than it would be if you spun a point
mass $$ M $$
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{c} I_{\text{end}}= I_{\text{center}}+m{\left(\frac{l}{2}\right)}^{2}\\ \text{Thus,} I_{\text{center}}= I_{\text{end}}-\frac{1}{4}m l^{2} =\frac{1}{3}m l^{2} -\frac{1}{4}m l^{2} =\frac{1}{12}}m l^{2} \end{array} $$ 
