...
effectiveness of a force. In this case, because $$ \mathbf{\text{F}} $$ is
...
units of mass multiplied by distance squared ( $$ \text{kg}\cdot \text{m}^{2} $$
...
ordinary numbers. The relationship in $$ \tau =I\alpha \mathrm{, }\alpha
...
* {: #import-auto-id2684041} If we exert a force $$ F $$ on a point mass $$ m $$
  ...
  perpendicular to $$ r $$ , an acceleration $$ \text{a = F/m} $$ is obtained in
...
acceleration of the forearm of $$ 120 \text{rad/s}^{2} $$. What is the moment of
...
\text{m}^{2} $$. What is the force exerted by the muscle if its effective
...
rad/s, and her moment of inertia is $$ 0.050\text{kg}\cdot \text{m}^{2} $$. (a)
...
A torque of $$ 500 \text{N}\cdot \text{m} $$ is reasonable.
...
of inertia {: #import-auto-id2384482}
