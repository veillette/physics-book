...
=56.25 \text{kg}\cdot \text{m}^{2}. $$ 
</div>
Now, after we substitute the known values, we find the angular acceleration to be

<div data-type="equation" id="eip-861">
 $$ \alpha =\frac{\tau }{I}=\frac{375 \text{N}\text{⋅}\text{m}}{56.25 \text{kg}\cdot \text{m}^{2}}=6.67\frac{\text{rad}}{ {\text{s}}^{2}}. $$ 
</div>
**Solution for (b)**
...
\left(1.25 \text{m}\right)^{2}=28.13 \text{kg}\cdot \text{m}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-50">
 $$ \alpha =\frac{\text{τ}}{I}=\frac{375 \text{N}\cdot \text{m}}{84.38 \text{kg}\cdot \text{m}^{2}}=4.44\frac{\text{rad}}{ {\text{s}}^{2}}. $$ 
</div>
**Discussion**
