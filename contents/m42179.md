...
is perpendicular to $$ r $$, torque is simply $$ \tau =F r $$. So, if we multiply both sides of the equation above by $$ r $$, we get torque on the left-hand side. That is,
...
inertia around its axis is therefore $$ MR^{2} $$, where $$ M $$
...
relationship in $$ \tau =I\alpha \mathrm{, }\alpha =\frac{\text{net
τ}}{I} $$
...
4.  {: #import-auto-id2067161} *Apply  $$ \text{net} \tau= I\alpha \mathrm{,} \alpha =\frac{\text{net τ}}{I} $$ 
...
<div data-type="equation" id="eip-946">
 $$ \tau =rF \sin{\theta}=\left(1.50 \text{m}\right)\left(250 \text{N}\right)=375 \text{N}\cdot \text{m.} $$ 
</div>
**Solution for (a)**
...
* {: #import-auto-id2684041} If we exert a force $$ F $$
  ...
  and then look for ways to relate this expression to expressions for rotational
  quantities. We note that $$ a = r\alpha $$
  , and we substitute this expression into $$ F=ma $$
  , yielding
  <div data-type="equation">
   $$ F=mr\alpha  $$ 
  </div>
...
* {: #import-auto-id3175767} The moment of inertia $$ I $$
  of an object is the sum of $$ MR^{2} $$
...
<div data-type="problem" markdown="1">
The moment of inertia of a long rod spun around an axis through one end perpendicular to its length is  $$ ML^{2}\text{/3} $$ . Why is this moment of inertia greater than it would be if you spun a point
mass $$ M $$
at the location of the center of mass of the rod (at $$ L/2 $$
)? (That would be $$ ML^{2}\text{/4} $$.)
