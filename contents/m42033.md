...
Displacement is the *change in position* of an object: <div data-type="equation" id="eip-458">  $$ \Delta x=x_{\text{f}}-x_{0},$ </div> where $\Delta x$ is displacement, $x_{\text{f}}$ is the final position, and **$x_{0} $$ is the initial position.
</div>
...
* In symbols, displacement $$ \Delta x $$
  ...
  where $$ x_{0} $$
  is the initial position and $$ x_{f} $$
