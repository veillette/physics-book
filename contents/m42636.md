...
<div data-type="equation" id="eip-732">
 $$\lambda =\frac{ln\left(2\right)}{ {t}_{1/2}}\approx \frac{ 0.693}{ {t}_{1/2}}\text{.} $$
</div>
...
<div data-type="equation" id="eip-434">
 $$ 0.92={e}^{-\mathrm{\lambda t}}\text{.} $$
</div>
Taking the natural logarithm of both sides of the equation yields

<div data-type="equation" id="eip-963">
 $$\text{ln}  0.92=\mathrm{–\lambda t} $$
</div>
so that

<div data-type="equation" id="eip-940">
 $$ -0.0834=-\mathrm{\lambda t}\text{.} $$
</div>
...
<div data-type="equation" id="eip-995">
 $$t=\frac{ 0.0834}{\frac{ 0.693}{5730 \text{y}}}=\text{690 y.} $$
</div>
**Discussion**

This dates the material in the shroud to 1988–690 = a.d. 1300. Our calculation is only accurate to two digits, so that the year is rounded to 1300. The values obtained at the three independent laboratories gave a weighted average date of a.d.  $$\text{1320}±60 $$
...
<div data-type="equation" id="eip-367">
 $$N\left({}^{\text{14}}\text{C}\right)=\left( 5.02 \times 10^{25} \right)\left(1.3 \times 10^{\text{−12}}\right)= 6.52 \times 10^{13} \text{.} $$
</div>
Now the activity  $$R $$
...
<div data-type="equation" id="eip-857">
 $$\begin{array}{lll}N& =& \frac{\left( 6.0 \times 10^{6}  \text{Ci}\right)\left( 3.7 \times 10^{10}  \text{Bq/Ci}\right)\left(\text{30.2 y}\right)\left( 3.16 \times 10^{7}  \text{s/y}\right)}{0.693}\\ & =&   3.1 \times 10^{26} \text{.}\end{array} $$
</div>
...
. Estimate the minimum age of the charcoal, noting that  $${2}^{\text{10}}=1024 $$
.
