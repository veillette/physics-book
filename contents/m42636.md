...
<div data-type="equation" id="eip-999">
 $$N\left({}^{12}\text{C}\right)=\frac{ 6.02 \times 10^{23}  {\text{mol}}^{–1}}{12.0 g/mol}×\text{(1000 g)}= 5.02 \times 10^{25} \text{.} $$
</div>
...
<div data-type="equation" id="eip-403">
 $$R=\left( 7.89 \times 10^{9}  {\text{y}}^{–1}\right)\frac{1.00 y}{ 3.16 \times 10^{7}  \text{s}}=\text{250 Bq,} $$
</div>
...
<div data-type="equation" id="eip-857">
 $$\begin{array}{lll}N& =& \frac{\left( 6.0 \times 10^{6}  \text{Ci}\right)\left( 3.7 \times 10^{10}  \text{Bq/Ci}\right)\left(\text{30.2 y}\right)\left( 3.16 \times 10^{7}  \text{s/y}\right)}{\text{0.693}}\\ & =& \text{} 3.1 \times 10^{26} \text{.}\end{array} $$
</div>
...
<div data-type="equation" id="eip-187">
 $$\begin{array}{lll}m& =& \left(\frac{\text{137 g}}{ 6.02 \times 10^{23} }\right)\left( 3.1 \times 10^{26} \right)=\text{70} \times 10^{3}  \text{g}\\ & =& \text{}\text{70 kg}\text{.}\end{array} $$
</div>
**Discussion**
