...
<div data-type="equation" id="eip-90">
 $$\text{1 Ci}= 3.70 \times 10^{10}  \text{Bq,} $$
</div>
...
<div data-type="equation" id="eip-999">
 $$N\left({}^{12}\text{C}\right)=\frac{ 6.02 \times 10^{23}  {\text{mol}}^{–1}}{12.0 g/mol}×\text{(1000 g)}=\text{5.02}×{\text{10}}^{\text{25}}\text{.} $$
</div>
So the number of  $${}^{\text{14}}\text{C} $$
 nuclei in 1 kg of carbon is

<div data-type="equation" id="eip-367">
 $$N\left({}^{\text{14}}\text{C}\right)=\left( 5.02 \times 10^{25} \right)\left(1.3×{\text{10}}^{\text{−12}}\right)= 6.52 \times 10^{13} \text{.} $$
</div>
Now the activity  $$R $$
...
<div data-type="equation" id="eip-515">
 $$R=\frac{0\text{.}\text{693}\left( 6.52 \times 10^{13} \right)}{\text{5730 y}}= 7.89 \times 10^{9}  {\text{y}}^{–1}, $$
</div>
or  $$ 7.89 \times 10^{9}  $$
...
<div data-type="equation" id="eip-172">
 $$R=\frac{\text{250 Bq}}{ 3.7 \times 10^{10}  \text{Bq/Ci}}= 6.76 \times 10^{-9}  \text{Ci.} $$
</div>
Thus,
...
<div data-type="equation" id="eip-857">
 $$\begin{array}{lll}N& =& \frac{\left(6\text{.}0×{\text{10}}^{6} \text{Ci}\right)\left( 3.7 \times 10^{10}  \text{Bq/Ci}\right)\left(\text{30.2 y}\right)\left( 3.16 \times 10^{7}  \text{s/y}\right)}{\text{0.693}}\\ & =& \text{} 3.1 \times 10^{26} \text{.}\end{array} $$
</div>
...
<div data-type="equation" id="eip-187">
 $$\begin{array}{lll}m& =& \left(\frac{\text{137 g}}{\text{6.02}×{\text{10}}^{\text{23}}}\right)\left( 3.1 \times 10^{26} \right)=\text{70}×{\text{10}}^{3} \text{g}\\ & =& \text{}\text{70 kg}\text{.}\end{array} $$
</div>
**Discussion**
