...
Why use a term like half-life rather than lifetime? The answer can be found by examining [[Figure 1]](#Figure1), which shows how the number of radioactive nuclei in a sample decreases with time. The *time in which half of the original number of nuclei decay* is defined as the **half-life**,  $${t}_{1/2} $$ .
