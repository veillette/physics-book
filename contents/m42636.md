...
<div class="equation" id="eip-403">
 $$R=\left( 7.89 \times 10^{9}  {\text{y}}^{-1}\right)\frac{1.00 y}{ 3.16 \times 10^{7}  \text{s}}=250 \text{Bq} \text{,}  $$
</div>
...
* {: #import-auto-id2421861}  $$R $$ is also expressed in terms of curies (Ci), where
  <div class="equation">
   $$1 \text{Ci}= 3.70 \times 10^{10}  \text{Bq} \text{.}  $$
  </div>
