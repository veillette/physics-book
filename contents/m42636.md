...
time equal to one half-life $${t}_{1/2} $$
*. Thus, if $$N $$ is reasonably large, half of the original nuclei decay in a
...
The SI unit for activity is one decay per second and is given the name **
becquerel** (Bq) in honor of the discoverer of radioactivity. That is,
