...
nuclear force cannot change the flavor of a quark.**
...
1. Baryons are composed of three quarks, and antibaryons are composed of three
   antiquarks.
2. Mesons are combinations of a quark and an antiquark.

One of the clever things about this scheme is that only integral charges result,
even though the quarks have fractional charge.

### All Combinations are Possible

All quark combinations are possible. [[Table 2]](#Table2) lists some of these
...
(see [[link]](/ch33ParticlesPatternsAndConservationLaws#import-auto-id1169736657305)) and other predictable
...
characteristics as seen in [[Figure 2]](#Figure2). The discovery of the
$${\Omega }^{-} $$ was convincing indirect evidence for the existence of the
...
listed in [[link]](/ch33ParticlesPatternsAndConservationLaws#import-auto-id1169736657305). Its strangeness is
$$S=0-1-1=-2 $$ , also as expected
from [[link]](/ch33ParticlesPatternsAndConservationLaws#import-auto-id1169736657305). Its charm, bottomness, and
...
in [[link]](/ch33ParticlesPatternsAndConservationLaws#import-auto-id1169736657305)). Theorists quickly proposed
...
discussed in [GUTs: The Unification of Forces](/ch33GUTS)..
...
* Hadrons are thought to be composed of quarks, with baryons having three quarks
