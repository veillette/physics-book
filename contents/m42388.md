...
The velocity selector has both an electric field and a magnetic field, perpendicular to one another, producing forces in opposite directions on the ions. Only those ions for which the forces balance travel in a straight line into the next region. If the forces balance, then the electric force  $$F=\text{qE} $$
 equals the magnetic force  $$F=\text{qvB} $$
, so that  $$\text{qE}=\text{qvB} $$
. Noting that  $$q $$
 cancels, we see that
...
What current is needed in the solenoid described in [[link]](#fs-id2626487) to produce a magnetic field  $$10^{4} $$
 times the Earth’s magnetic field of  $$ 5.00 \times 10^{-5}  T $$
?
...
How far from the starter cable of a car, carrying 150 A, must you be to experience a field less than the Earth’s  $$\left( 5.00 \times 10^{-5}  T\right)? $$
...
(a) Show that the period of the circular orbit of a charged particle moving perpendicularly to a uniform magnetic field is  $$T=2\mathrm{\pi m}/\left(qB\right) $$
...
(a) A 0.140-kg baseball, pitched at 40.0 m/s horizontally and perpendicular to the Earth’s horizontal  $$ 5.00 \times 10^{-5}  T $$
...
(a) What is the direction of the force on a wire carrying a current due east in a location where the Earth’s field is due north? Both are parallel to the ground. (b) Calculate the force per meter if the wire carries 20.0 A and the field strength is  $$ 3.00 \times 10^{-5}  T $$
...
(a) Find the charge on a baseball, thrown at 35.0 m/s perpendicular to the Earth’s  $$ 5.00 \times 10^{-5}  T $$
...
An inventor wants to generate 120-V power by moving a 1.00-m-long wire perpendicular to the Earth’s  $$ 5.00 \times 10^{-5}  T $$
...
A surveyor 100 m from a long straight 200-kV DC power line suspects that its magnetic field may equal that of the Earth and affect compass readings. (a) Calculate the current in the wire needed to create a  $$ 5.00 \times 10^{-5}  T $$
