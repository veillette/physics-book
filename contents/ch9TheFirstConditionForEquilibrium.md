...
[Figure](#fig1)
and [Figure](#fig2) illustrate situations where $$
...
in [Figure](#fig3)
and [Figure](#fig4) where forces are applied to an ice
...
whereas in the other, it is not. In [Figure](#fig3),
the ice hockey stick remains motionless. But
in [Figure](#fig4), with the same forces applied in
