...
[Figure 1](#fig1)
and [Figure 2](#fig2) illustrate situations where $$
...
in [Figure 3](#fig3)
and [Figure 4](#fig4) where forces are applied to an ice
...
whereas in the other, it is not. In [Figure 3](#fig3),
the ice hockey stick remains motionless. But
in [Figure 4](#fig4), with the same forces applied in
