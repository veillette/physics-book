...
where $$ \Delta t $$
is the change in time or elapsed time, $$ t_{f} $$
is the time at the end of the motion, and $$ t_{0} $$
...
Life is simpler if the beginning time $$ t_{0} $$
...
* {: #import-auto-id2571110} motion starts at time equal to zero $$ \left(t_  {0}=0\right) $$
* {: #import-auto-id4047929} the symbol $$ t $$
  is used for elapsed time unless otherwise specified $$ \left(\Delta t=t_  {f}\equiv t\right) $$
### Velocity
...
is the change in position (or displacement), and $$ x_{f} $$
and $$ x_{0} $$
are the final and beginning positions at times $$ t_{f} $$
and $$ t_{0} $$, respectively. If the starting time $$ t_{0} $$
is taken to be zero, then the average velocity is simply

<div data-type="equation" id="import-auto-id2027122">
 $$ \overline{v}=\frac{\Delta x}{t}\text{.} $$ 
</div>
</div>
...
<div data-type="equation" id="import-auto-id4051374">
 $$ \overline{v}=\frac{\Delta x}{t}=\frac{-4\text{m}}{5\text{s}}=-\text{0.8 m/s.} $$ 
</div>
...
<div data-type="equation" id="import-auto-id1750086">
 $$ \frac{80 \text{miles}}{105 \text{minutes}}×\frac{5280 \text{feet}}{1 \text{mile}}×\frac{1 \text{meter}}{3.28 \text{feet}}×\frac{1 \text{minute}}{60 \text{seconds}}=20 \text{m/s} $$ 
</div>
</div>
</div>
...
* {: #import-auto-id4070541} Time is measured in terms of change, and its SI
  ...
  where $$ t_{f} $$ is the final time and $$ t_{0} $$
...
<div data-type="solution" markdown="1">
 $$ 34.689 \text{m/s}=124.88 \text{km/h} $$ 
{: xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" fo:font-weight="normal"}
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A student drove to the university from her home and noted that the odometer reading of her car increased by 12.0 km. The trip took 18.0 min. (a) What was her average speed? (b) If the straight-line distance from her home to the university is 10.3 km in a direction  $$ 25.0^\circ $$ 
