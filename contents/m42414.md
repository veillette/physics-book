...
<div data-type="equation" id="eip-757">
 $$\begin{array}{lll}{N}_{\text{s}}& =& {N}_{\text{p}}\frac{ {V}_{\text{s}}}{ {V}_{\text{p}}}\\ & =& \left(\text{50}\right)\frac{\text{100 000 V}}{120 \text{V}}= 4.17 \times 10^{4} \text{.}\end{array} $$
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-361">
 $$\begin{array}{lll}{I}_{\text{s}}& =& {I}_{\text{p}}\frac{ {N}_{\text{p}}}{ {N}_{\text{s}}}\\ & =& \left(10.00 \text{A}\right) \frac{\text{50}}{ 4.17 \times 10^{4} } = \text{12.0 mA}\text{.}\end{array} $$
</div>
**Discussion for (b)**
