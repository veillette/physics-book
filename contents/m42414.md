...
<div data-type="equation" id="eip-361">
 $$\begin{array}{lll}{I}_{\text{s}}& =& {I}_{\text{p}}\frac{ {N}_{\text{p}}}{ {N}_{\text{s}}}\\ & =& \left(\text{10}\text{.}\text{00 A}\right) \frac{\text{50}}{4\text{.}\text{17}×{\text{10}}^{4}} = \text{12.0 mA}\text{.}\end{array} $$
</div>
**Discussion for (b)**
