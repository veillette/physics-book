...
** has the unit diopters (D), provided that the focal length is given in meters. That is,  $$\text{1 D}=1/\text{m} $$
, or  $${\text{1 m}}^{-1} $$
...
<div data-type="equation" id="eip-213">
 $$P=\frac{1}{f}=\frac{1}{0\text{.}\text{0800 m}}=\text{12}\text{.}5 D. $$
</div>
**Discussion**
...
, defined to be the focal point of a diverging lens. The distance from the center of the lens to the focal point is again called the focal length  $$f $$
 ...
 in [\[link\]](#import-auto-id1625442) is 5.00 cm, then the focal length is  $$f=–5.00 cm $$
 and the power of the lens is  $$P=\text{–20 D} $$
...
Several important distances appear in [\[link\]](#import-auto-id2631957). We define  $${d}_{\text{o}} $$
 to be the object distance, the distance of an object from the center of a lens. <strong data-type="term" id="import-auto-id952304">Image distance </strong> $${d}_{\text{i}} $$
 ...
 and  $${h}_{\text{i}} $$
, respectively. Images that appear upright relative to the object have heights that are positive and those that are inverted have negative heights. Using the rules of ray tracing and making a scale drawing with paper and pencil, like that in [\[link\]](#import-auto-id2631957), we can accurately describe the location and size of an image. But the real benefit of ray tracing is in visualizing how images are formed in a variety of situations. To obtain numerical information, we use a pair of equations that can be derived from a geometric analysis of ray tracing for thin lenses. The **thin lens equations****** are
...
Since the object is placed farther away from a converging lens than the focal length of the lens, this situation is analogous to those illustrated in [\[link\]](#import-auto-id2631957) and [\[link\]](#import-auto-id2657760). Ray tracing to scale should produce similar results for  $${d}_{\text{i}} $$
. Numerical solutions for  $${d}_{\text{i}} $$
 and  $$m $$
 can be obtained using the thin lens equations, noting that  $${d}_{\text{o}}=0.750 m and f=0.500 m $$
.

**Solutions (Ray tracing)**

The ray tracing to scale in [\[link\]](#import-auto-id2555289) shows two rays from a point on the bulb’s filament crossing about 1.50 m on the far side of the lens. Thus the image distance  $${d}_{\text{i}} $$
...
Rearranging to isolate  $${d}_{\text{i}} $$
 gives
...
<div data-type="equation" id="eip-79">
 $$\frac{1}{ {d}_{\text{i}}}=\frac{1}{0\text{.}\text{500 m}}-\frac{1}{0\text{.}\text{750 m}}=\frac{\text{0.667}}{\text{m}}\text{.} $$
</div>
This must be inverted to find  $${d}_{\text{i}} $$
\:

<div data-type="equation" id="eip-410">
 $${d}_{\text{i}}=\frac{\text{m}}{0.667}=1\text{.}\text{50 m}\text{.} $$
</div>
...
<div data-type="equation" id="eip-790">
 $$m=–\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}=–\frac{1.50 m}{0.750 m}=–2.00. $$
</div>
**Discussion**
...
We are given that  $${d}_{\text{o}}=7\text{.}\text{50 cm} $$
 and  $$f=\text{10}\text{.}\text{0 cm} $$
...
, we try to use magnification equation,  $$m={\mathrm{–d}}_{\text{i}}/{d}_{\text{o}} $$
...
<div data-type="equation" id="eip-694">
 $$\frac{1}{ {d}_{\text{i}}}=\frac{1}{\text{10.0 cm}}-\frac{1}{7\text{.}\text{50 cm}}=\frac{-0\text{.}\text{0333}}{\text{cm}}\text{.} $$
</div>
This must be inverted to find  $${d}_{\text{i}} $$
\:

<div data-type="equation" id="eip-22">
 $${d}_{\text{i}}=-\frac{\text{cm}}{0\text{.}\text{0333}}=-\text{30.0 cm}. $$
</div>
...
<div data-type="equation" id="eip-302">
 $$m=-\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}=-\frac{-\text{30}\text{.}0 cm}{\text{7}\text{.}50 cm}=4\text{.}\text{00.} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-95">
 $${d}_{i}=\frac{ {\mathrm{fd}}_{\text{o}}}{ {d}_{\text{o}}-f}\text{.} $$
</div>
We are given that  $$f=\text{–10.0 cm} $$
 and  $${d}_{\text{o}}=7\text{.}\text{50 cm} $$
. Entering these yields a value for  $$1/{d}_{\text{i}} $$
\:

<div data-type="equation" id="eip-145">
 $$\frac{1}{ {d}_{\text{i}}}=\frac{1}{\text{−10.0 cm}}-\frac{1}{7\text{.}\text{50 cm}}=\frac{-0\text{.}\text{2333}}{\text{cm}}\text{.} $$
</div>
This must be inverted to find  $${d}_{\text{i}} $$
\:

<div data-type="equation" id="eip-850">
 $${d}_{\text{i}}=-\frac{\text{cm}}{0\text{.}\text{2333}}=-4\text{.}\text{29 cm}\text{.} $$
</div>
Or

<div data-type="equation" id="eip-950">
 $${d}_{\text{i}}=\frac{\left(7\text{.}5\right)\left(-\text{10}\right)}{\left(7\text{.}5-\left(-\text{10}\right)\right)}=-\text{75}/\text{17}\text{.}5=-4\text{.}\text{29 cm}\text{.} $$
</div>
...
<div data-type="equation" id="eip-869">
 $$m=-\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}=-\frac{-4\text{.}\text{29 cm}}{7\text{.}\text{50 cm}}=0\text{.}\text{571}\text{.} $$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A camera with a 100 mm focal length lens is used to photograph the sun and moon. What is the height of the image of the sun on the film, given the sun is  $$1\text{.}\text{40}×{\text{10}}^{6} \text{km} $$
 in diameter and is  $$1\text{.}\text{50}×{\text{10}}^{8} \text{km} $$
 away?
