...
) to be the **magnification**{: data-type="term" #import-auto-id1442661} $$m$$
...
. Numerical solutions for $${d}_{\text{i}}$$
 ...
 can be obtained using the thin lens equations, noting that $${d}_{\text{o}}=0.750 m and\phantom{\rule{0.25em}{0ex}}f=0.500 m$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A camera with a 100 mm focal length lens is used to photograph the sun and moon. What is the height of the image of the sun on the film, given the sun is $$1\text{.}\text{40}×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{km}$$

 in diameter and is $$1\text{.}\text{50}×{\text{10}}^{8}\phantom{\rule{0.25em}{0ex}}\text{km}$$
