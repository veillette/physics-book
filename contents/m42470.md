...
<div data-type="equation" id="eip-694">
 $$\frac{1}{ {d}_{\text{i}}}=\frac{1}{\text{10.0 cm}}-\frac{1}{7.50 \text{cm}}=\frac{ -0.0333}{\text{cm}}\text{.} $$
</div>
This must be inverted to find  $${d}_{\text{i}} $$
\:

<div data-type="equation" id="eip-22">
 $${d}_{\text{i}}=-\frac{\text{cm}}{ 0.0333}=-\text{30.0 cm}. $$
</div>
...
<div data-type="equation" id="eip-950">
 $${d}_{\text{i}}=\frac{\left( 7.5\right)\left(-\text{10}\right)}{\left( 7.5-\left(-\text{10}\right)\right)}=-\text{75}/ 17.5=-4.29 \text{cm}\text{.} $$
</div>
