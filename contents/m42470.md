...
<div class="equation" id="eip-302">
 $$m=-\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}=-\frac{- 30.0 cm}{ 7.50 cm}=4.00 . $$
</div>
**Discussion**
...
<div class="equation" id="eip-145">
 $$\frac{1}{ {d}_{\text{i}}}=\frac{1}{\text{−10.0 cm}}-\frac{1}{7.50 \text{cm}}=\frac{ -0.2333}{\text{cm}}\text{.} $$
</div>
This must be inverted to find  $${d}_{\text{i}} $$
\:
...
* {: #import-auto-id1636863} The distance from the center of the lens to its focal point is called the focal length  $$f $$ . 

* {: #import-auto-id2822659} Power $$P $$ of a lens is defined to be the inverse of its focal length,  $$P=\frac{1}{f} $$ . 
