...
the system of interest, as in the figure, then $$ {\mathbf{\text{F}}}_{\text{wall on feet}} $$
...
force $$ {\mathbf{\text{F}}}_{\text{floor}} $$
...
<div data-type="equation" id="eip-id1741589">
 $$ \begin{array}{}a=\frac{ F_{\text{net}}}{m},\\ a=\frac{126 \text{N}}{84 \text{kg}}=1.5 \text{m/s}^2\text{.}\end{array} $$ 
</div>
**Discussion**
