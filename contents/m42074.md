...
<div data-type="equation" id="eip-id1515829">
 $$ {F}_{\text{net}}={F}_{\text{floor}}-f=150 \text{N}-24.0 \text{N}=126 \text{N}. $$ 
</div>
...
** is given, so we must calculate net $$ {F}_{\text{net}} $$. That can be done since both the acceleration and mass of System 2 are known.
...
<div data-type="equation" id="eip-id1454423">
 $$ {F}_{\text{net}}=\left(19.\text{0 kg}\right)\left(1.5{\text{m/s}}^{2}\right)=29 \text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-id1197329">
 $$ {F}_{\text{prof}}=29 \text{N}+24.0 \text{N}=53 \text{N}. $$ 
</div>
**Discussion**
