...
<div data-type="equation" id="eip-id1213154">
 $$ m=\left(\text{65}\text{.}\text{0}+\text{12}\text{.}\text{0}+\text{7}\text{.}0\right)\text{kg}=\text{84 kg}. $$ 
</div>
...
<div data-type="equation" id="eip-id1741589">
 $$ \begin{array}{}a=\frac{ {F}_{\text{net}}}{m},\\ a=\frac{1\text{26 N}}{\text{84 kg}}=\text{1}\text{.}{\text{5 m/s}}^{2}\text{.}\end{array} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-id1454423">
 $$ {F}_{\text{net}}=\left(\text{19}\text{.}\text{0 kg}\right)\left(1.5{\text{m/s}}^{2}\right)=\text{29 N}. $$ 
</div>
...
<div data-type="problem" markdown="1">
What net external force is exerted on a 1100-kg artillery shell fired from a battleship if the shell is accelerated at  $$ 2\text{.}\text{40}×{\text{10}}^{4}{\text{m/s}}^{2} $$ 

? What is the magnitude of the force exerted on the ship by the artillery shell?

</div>
<div data-type="solution" markdown="1">
Force on shell:  $$ 2\text{.}\text{64}×{\text{10}}^{7}\text{N} $$ 

Force exerted on ship = $$
-2\text{.}\text{64}×{\text{10}}^{7}\text{N} $$, by Newton’s third law
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A brave but inadequate rugby player is being pushed backward by an opposing player who is exerting a force of 800 N on him. The mass of the losing player plus equipment is 90.0 kg, and he is accelerating at  $$ 1\text{.}\text{20}{\text{m/s}}^{2} $$ 
