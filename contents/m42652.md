...
<div class="equation" id="eip-891">
 $$\left(1.00 J\right)/\left(50.0 kg\right)=0.0200 \text{J/kg}=2.00 \text{rad.} $$
</div>
...
<div class="equation" id="eip-338">
 $$\left(1.00 J\right)/\left(2.00 kg\right)=0.500 \text{J/kg}=50.0 \text{rad,} $$
</div>
...
<div class="equation" id="eip-159">
 $$E=\left( 1.17 \times 10^{12} \text{decays}\right)\left( 5.23 \text{MeV/decay}\right)×\left(\frac{1.60 \times 10^{-13} \text{J}}{\text{MeV}}\right)= 0.978 \text{J.} $$
</div>
...
<div class="equation" id="eip-895">
 $$=\left(0.489 Gy\right)\left(20\right)=9.8 \text{Sv.} $$
</div>
**Discussion**
...
* {: #import-auto-id1922622} Particles that have short ranges or create large ionization densities have RBEs greater than unity. The SI equivalent of the rem is the sievert (Sv), defined to be
  <div class="equation" id="eip-409">
   $$\text{Sv}=\text{Gy}×\text{RBE}\text{and 1 Sv}=100 \text{rem.} $$
  </div>
