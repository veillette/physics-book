...
The activity  $$R=1\text{.}\text{00} \text{μCi}=\text{3}\text{.}\text{70}×{\text{10}}^{4} \text{Bq}= 3.70 \times 10^{4}  $$
...
<div data-type="equation" id="eip-494">
 $$\left( 3.70 \times 10^{4}  \text{decays/s}\right)\left( 3.16 \times 10^{7}  \text{s}\right)=1\text{.}\text{17}×{\text{10}}^{\text{12}} \text{decays.} $$
</div>
