...
L $$ are proportional, $$ F=k\Delta L $$.) (See [\[link\]](#fs-id1593673).) For
...
In [\[link\]](#fs-id1593673)(c) we see that this area is also $$ \frac{1}{2}k
...
in [\[link\]](#import-auto-id1089734) for a guitar string.
