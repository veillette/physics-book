...
. The given information tells us that  $$\lambda =\text{10}\text{.}0 \text{m} $$
 and  $$T=5\text{.}\text{00} \text{s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Radio waves transmitted through space at  $$3\text{.}\text{00}×{\text{10}}^{8} \text{m/s} $$
