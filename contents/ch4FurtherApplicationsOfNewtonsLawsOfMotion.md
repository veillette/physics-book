...
Suppose two tugboats push on a barge at different angles, as shown in [Figure 1](#fig1).
...
shown in the free-body diagram in [Figure 1](#fig1)(b). The
...
one-dimensional. From [Figure 1](#fig1)**(b)**, we can see that
...
Consider the traffic light (mass 15.0 kg) suspended from two wires as shown in [Figure 2](#fig2). Find the tension in each wire, neglecting the masses of the wires.
...
[Figure 3](#fig3) shows a 75.0-kg man (weight of about 165 lb) standing on a bathroom scale in an elevator. Calculate the scale reading:
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
A 76.0-kg person is being pulled away from a burning building as shown in [Figure 6](#fig6). Calculate the tension in the two ropes if the person is momentarily motionless. Include a free-body diagram in your solution.
