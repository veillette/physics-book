...
use the notation that a boldface symbol, such as $$ \mathbf{\vec{D}} $$,
stands for a vector. Its magnitude is represented by the symbol in italics, $$ D $$, and its
direction by $$ \theta $$.
...
Show this property by choosing any three vectors  $$ \mathbf{A} $$, $$ \mathbf{B} $$, 
and $$ \mathbf{C} $$, all having different lengths and
