...
(This is true for the addition of ordinary numbers as well—you get the same result whether you add  $$ \mathbf{2}}+\mathbf{3}} $$ 
...
27}.5 \text{m} $$, or 82.5 m, in a direction $$ 66.0\text{º} $$
...
city is 10.3 blocks in a direction $$ 29}\text{.0º} $$
