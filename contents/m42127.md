...
use the notation that a boldface symbol, such as $$ \text{D} $$, stands for a
vector. Its magnitude is represented by the symbol in italics, $$ D $$, and its
direction by $$ \theta $$.
...
(4) Use a ruler to measure the magnitude of $$ \mathbf{\text{R}} $$, and a
...
In this case, the total displacement $$ \mathbf{\text{R}} $$ is seen to have a
...
subtraction (say we want to subtract $$ \mathbf{\text{B}} $$ from $$
\mathbf{\text{A}} $$, written $$ \mathbf{\text{A}}–\mathbf{\text{B}} $$, we must
first define what we mean by subtraction. The *negative* of a vector $$
\mathbf{\text{B}} $$ is defined to be $$ \mathbf{\text{–B}} $$ ; that is,
...
words, $$ \mathbf{\text{B}} $$ has the same length as $$ \mathbf{\text{–B}} $$,
...
The **subtraction** of vector $$ \mathbf{\text{B}} $$ from vector $$
\mathbf{\text{A}} $$ is then simply defined to be the addition of $$
\mathbf{\text{–B}} $$ to $$ \mathbf{\text{A}} $$. Note that vector subtraction
...
$$, and the second leg of the trip with a vector $$ \mathbf{\text{B}} $$. The
dock is located at a location $$ \mathbf{\text{A}}+\mathbf{\text{B}} $$. If the
...
\mathbf{\text{–B}} $$ has the same magnitude as $$ \mathbf{\text{B}} $$ but is
...
vectors $$ \mathbf{\text{A}} $$ and $$ \mathbf{\text{–B}} $$.
...
$$ \mathbf{\text{A}} $$ and $$ \mathbf{\text{B}} $$. We obtain the resultant
vector $$ \mathbf{\text{R}}\text{'} $$ \:
...
multiplying a vector by a positive **scalar**{: data-type="term"
#import-auto-id1165296219603}. Notice that the magnitude changes, but the
...
summarize these rules in the following way: When vector $$ \mathbf{A} $$ is
...
* {: #import-auto-id1165296253334} The **graphical method of adding vectors**
  $$ \mathbf{A} $$ and $$ \mathbf{B} $$ involves drawing vectors on a graph and
  adding them using the head-to-tail method. The resultant vector $$ \mathbf{R}
  $$ is defined such that $$
  \mathbf{\text{A}}+\mathbf{\text{B}}=\mathbf{\text{R}} $$ . The magnitude and
  direction of $$ \mathbf{R} $$ are then determined with a ruler and protractor,
  respectively.
* {: #import-auto-id1165298573640} The <strong>graphical method of subtracting
  vector </strong>
  $$ \mathbf{B} $$ from $$ \mathbf{A} $$ involves adding the opposite of vector
  $$ \mathbf{B} $$ , which is defined as $$ -\mathbf{B} $$ . In this case, $$
  \text{A}–\mathbf{\text{B}}=\mathbf{\text{A}}+\left(
  \text{–B}\right)=\text{R} $$ . Then, the head-to-tail method of addition is
  followed in the usual way to obtain the resultant vector $$ \mathbf{R} $$ .
...
* {: #import-auto-id1165298819524} If a vector $$ \mathbf{A} $$ is multiplied by
  a scalar quantity $$ c $$ , the magnitude of the product is given by $$
  \text{cA} $$ . If $$ c $$ is positive, the direction of the product points in
  the same direction as $$ \mathbf{A} $$ ; if $$ c $$ is negative, the direction
...
the two legs of the walk as vector displacements $$ \mathbf{A} $$ and $$
\mathbf{B} $$, as in [[link]](#import-auto-id1165296430663), then this problem
...
leg $$ \mathbf{A} $$, which is 12.0 m in a direction exactly $$ 20^\circ $$ west
...
north of east (which is equivalent to subtracting $$ \mathbf{\text{B}} $$ from
$$ \mathbf{A} $$ —that is, to finding $$ \mathbf{\text{R}}^{\prime}
...
, $$ \mathbf{B} $$, and $$ \mathbf{C} $$, all having different lengths and
directions. Find the sum $$ \text{A + B + C} $$ then find their sum when added
in a different order and show the result is the same. (There are five other
orders in which $$ \mathbf{A} $$, $$ \mathbf{B} $$, and $$ \mathbf{C} $$ can be
...
, $$ 90.1^\circ $$ with respect to the *x*-axis.
