...
$$ \text{A} + \mathbf{B} $$, with the location at which the woman mistakenly arrives, $$
...
* {: #import-auto-id1165296253334} The **graphical method of adding vectors**
  ...
  $$ \mathbf{R} $$ are then determined with a ruler and protractor,
  respectively.
...
$$ \mathbf{\text{A}} $$ 
and $$ \mathbf{\text{B}} $$, as in [[link]](#import-auto-id1165296241785),
