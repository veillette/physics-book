...
Heat is used to raise the temperature of air so that  $$Q=\text{mc}\Delta T $$
...
2.  Calculate the heat transferred from the change in air temperature:
    ...
    <div class="equation" id="import-auto-id3423422">
     $$Q=\left(836 \text{kg}\right)\left(1000 \text{J/kg}\cdot \text{ºC}\right)\left(10.0 \text{ºC}\right)=  8.36 \times 10^{6}  \text{J.} $$
    </div>
