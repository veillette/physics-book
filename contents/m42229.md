...
2.  Calculate the heat transferred from the change in air temperature:
    ...
    <div data-type="equation" id="import-auto-id3423422">
     $$Q=\left(836 \text{kg}\right)\left(1000 \text{J/kg}\cdot º\text{C}\right)\left(\text{10.0º}\text{C}\right)=  8.36 \times 10^{6}  \text{J.} $$
    </div>
...
3.  Calculate the heat transfer from the heat
    ...
    <div data-type="equation" id="import-auto-id3085478">
     $$\frac{Q}{t}=\frac{ 8.36 \times 10^{6 }\text{J}}{\text{1800 }\text{s}}= 4.64 \text{kW.} $$
    </div>
{: type="1"}
...
<div data-type="equation" id="import-auto-id3033754">
 $$\frac{m}{t}=\frac{\text{120}\text{ J/s}}{\text{2430}\text{ J/g}}= 0.0494\text{ g/s}= 2.96\text{ g/min.} $$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The Kilauea volcano in Hawaii is the world’s most active, disgorging about  $$\text{5} \times 10^{5}  {\text{m}}^{3} $$
 of  $$\text{1200ºC} $$
