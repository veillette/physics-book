...
While convection is usually more complicated than conduction, we can describe convection and do some straightforward, realistic calculations of its effects. Natural convection is driven by buoyant forces: hot air rises because density decreases as temperature increases. The house in [[Figure 1]](#Figure1) is kept warm in this manner, as is the pot of water on the stove in [[Figure 2]](#Figure2). Ocean currents and large-scale atmospheric circulation transfer energy from one part of the globe to another. Both are examples of natural convection.
...
Heat is used to raise the temperature of air so that  $$Q=mc\Delta T $$ .
 ...
 from [[Table 1]](#Table1) (note that the specific heat at constant pressure must be used for this process).
