...
* displacement depends on the square of the elapsed
  time when acceleration is not zero. In [Figure](#fs-id02), the
...
Calculate the final velocity of the dragster in [Figure](#fs-id02) without using information about time.
...
(this was the answer in [Figure](#fs-id02)). Finally, the average
...
less time than given in [Figure](#fs-id02) and
[Figure](#fs-id76).
