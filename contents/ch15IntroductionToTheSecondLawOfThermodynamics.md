...
schematically in [[Figure 2]](#Figure2)(b). Gasoline and diesel engines, jet
...
just as shown schematically in [[Figure 2]](#Figure2)(b). The problem is that in
...
engine will give us greater insight. [[Figure 3]](#Figure3) illustrates the
...
The **Otto cycle** shown in [[Figure 4]](#Figure4)(a) is used in four-stroke
...
$$PV $$ diagram, such as that inside path ABCDA in [[Figure 4]](#Figure4). Note
...
path CD, the more work output there is. (See [[Figure 5]](#Figure5).) So
