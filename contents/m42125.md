...
<div data-type="equation" id="import-auto-id4167672">
 $$ v={v}_{0}+\text{at}=0+\left(0\text{.}\text{40}{\text{m/s}}^{2}\right)\left(\text{100}\text{s}\right)=\text{40}\text{m/s}. $$ 
</div>
...
If someone accelerates at $$ 0\text{.}{\text{40 m/s}}^{2} $$, their velocity is increasing by 0.4 m/s each second. Does this seem
reasonable? If so, the time must be too long. It is not possible for someone to
accelerate at a constant rate of $$ 0\text{.}{\text{40 m/s}}^{2} $$
