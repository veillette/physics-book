...
<div data-type="equation" id="import-auto-id4167672">
 $$ v={v}_{0}+\text{at}=0+\left(0.40{\text{m/s}}^{2}\right)\left(100}\text{s}\right)=40}\text{m/s}. $$ 
</div>
...
<div data-type="equation" id="import-auto-id1437508">
 $$ \left(\frac{40 \text{m}}{s}\right)\left(\frac{\text{3.28 ft}}{m}\right)\left(\frac{\text{1 mi}}{\text{5280 ft}}\right)\left(\frac{60 \text{s}}{\text{min}}\right)\left(\frac{\text{60 min}}{1 \text{h}}\right)=89 mph $$ 
</div>
