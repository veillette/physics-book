...
5.  {: #import-auto-id1310375} Plug the knowns into the equation.
    <div data-type="equation" id="eip-951">
     $$\begin{array}{lll}\Delta m& =& \frac{ {\text{PE}}_{\text{elec}}}{ {c}^{2}}\\ & =& \frac{\text{qV}}{ {c}^{2}}\\ & =& \frac{\left(It\right)V}{ {c}^{2}}\\ & =& \frac{\left(600 \text{A}\cdot \text{h}\right)\left(12.0 \text{V}\right)}{\left( 3.00 \times 10^{8} {\right)}^{2}}\text{.}\end{array} $$
    </div>
    
    Write amperes A as coulombs per second (C/s), and convert hours to seconds.
    
    <div data-type="equation" id="eip-835">
     $$\begin{array}{lll}\Delta m& =& \frac{\left(600 \text{C/s}\cdot \text{h}\left(\frac{3600 \text{s}}{1 \text{h}}\right)\left(12.0 \text{J/C}\right)}{\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}}\\ & =& \frac{\left( 2.16 \times 10^{6}  \text{C}\right)\left(12.0 \text{J/C}\right)}{\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}}\end{array} $$
    </div>
...
4.  {: #import-auto-id2637141} Plug the knowns into the equation.
    <div data-type="equation" id="eip-961">
     $$\begin{array}{lll}\text{\% increase}& =& \frac{\Delta m}{m}×\text{100%}\\ & =& \frac{ 2.88 \times 10^{-10}  \text{kg}}{20.0 \text{kg}}×\text{100%}\\ & =&  1.44 \times 10^{-9} \text{\%}\text{.}\end{array} $$
    </div>
{: type="1"}
