...
5.  {: #import-auto-id1310375} Plug the knowns into the equation.
    <div data-type="equation" id="eip-951">
     $$\begin{array}{lll}\Delta m& =& \frac{ {\text{PE}}_{\text{elec}}}{ {c}^{2}}\\ & =& \frac{\text{qV}}{ {c}^{2}}\\ & =& \frac{\left(It\right)V}{ {c}^{2}}\\ & =& \frac{\left(600 \text{A}\cdot \text{h}\right)\left(\text{12.0 V}\right)}{\left( 3.00 \times 10^{8} {\right)}^{2}}\text{.}\end{array} $$
    </div>
    
    Write amperes A as coulombs per second (C/s), and convert hours to seconds.
    
    <div data-type="equation" id="eip-835">
     $$\begin{array}{lll}\Delta m& =& \frac{\left(600 \text{C/s}\cdot \text{h}\left(\frac{3600 \text{s}}{1 \text{h}}\right)\left(\text{12.0 J/C}\right)}{\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}}\\ & =& \frac{\left( 2.16 \times 10^{6}  \text{C}\right)\left(\text{12.0 J/C}\right)}{\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}}\end{array} $$
    </div>
...
3.  {: #import-auto-id2604060} Choose the appropriate equation.
     $$ \text{\% increase}=\frac{\Delta m}{m}×\text{100\%}  $$
...
4.  {: #import-auto-id2595330} Plug the knowns into the equation.
    ...
    <div data-type="equation" id="eip-971">
     $$\begin{array}{lll}{\text{KE}}_{\text{rel}}& =& \left(\gamma -1\right){\mathrm{mc}}^{2}\\ & =& \left(7.0888-1\right)\left(9.11 \times 10^{-31} \text{kg}\right)\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}\\ & =& 4.99 \times 10^{-13} \text{J}\end{array} $$
    </div>

5.  {: #import-auto-id2003431} Convert units.
    <div data-type="equation" id="eip-80">
     $$\begin{array}{lll}{\text{KE}}_{\text{rel}}& =& \left(4.99 \times 10^{-13} \text{J}\right)\left(\frac{1 \text{MeV}}{1.60 \times 10^{-13} \text{J}}\right)\\ & =& \text{3.12 MeV}\end{array} $$
    </div>
{: type="1"}
...
4.  {: #import-auto-id3143593} Plug the knowns into the equation.
    <div data-type="equation" id="eip-95">
     $$\begin{array}{lll}{\text{KE}}_{\text{class}}& =& \frac{1}{2}{\mathrm{mv}}^{2}\\ & =& \frac{1}{2}\left(9.00 \times 10^{-31} \text{kg}\right)\left(0.990{\right)}^{2}\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}\\ & =& 4.02 \times 10^{-14} \text{J}\end{array} $$
    </div>

5.  {: #import-auto-id1505723} Convert units.
    <div data-type="equation" id="eip-719">
     $$\begin{array}{lll}{\text{KE}}_{\text{class}}& =& 4.02 \times 10^{-14} \text{J}\left(\frac{1 \text{MeV}}{1.60 \times 10^{-13} \text{J}}\right)\\ & =& \text{0.251 MeV}\end{array} $$
    </div>
{: type="1"}
...
<div data-type="equation" id="eip-id1537888">
 $$\begin{array}{lll}{\text{KE}}_{\text{rel}}& =& \left(\gamma -1\right){\mathrm{mc}}^{2}=\left(\frac{1}{\sqrt{1-\frac{ {v}^{2}}{ {c}^{2}}}}-1\right){\mathrm{mc}}^{2}\\ & =& \left(\frac{1}{\sqrt{1-\frac{\left(0.992c{\right)}^{2}}{ {c}^{2}}}}-1\right)\left( 9.11 \times 10^{-31}  \text{kg}\right)\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}= 5.67 \times 10^{-13}  \text{J}\end{array} $$
</div>
</div>
</div>
