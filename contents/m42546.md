...
4.  {: #import-auto-id890041} Plug the knowns into the equation.
    <div data-type="equation" id="eip-16">
     $$\begin{array}{lll}{E}_{0}& =& {\mathrm{mc}}^{2}=\left( 1.00 \times 10^{-3}  \text{kg}\right)\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}\\ & =&  9.00 \times 10^{13}  \text{kg}\cdot {\text{m}}^{2}{\text{/s}}^{2}\end{array} $$
    </div>
...
This is an enormous amount of energy for a 1.00-g mass. We do not notice this energy, because it is generally not available. Rest energy is large because the speed of light  $$c $$
 ...
 is huge for any macroscopic mass. The  $$ 9.00 \times 10^{13}  \text{J} $$
...
5.  {: #import-auto-id1310375} Plug the knowns into the equation.
    <div data-type="equation" id="eip-951">
     $$\begin{array}{lll}\Delta m& =& \frac{ {\text{PE}}_{\text{elec}}}{ {c}^{2}}\\ & =& \frac{\text{qV}}{ {c}^{2}}\\ & =& \frac{\left(It\right)V}{ {c}^{2}}\\ & =& \frac{\left(\text{600 A}\cdot \text{h}\right)\left(\text{12.0 V}\right)}{\left( 3.00 \times 10^{8} {\right)}^{2}}\text{.}\end{array} $$
    </div>
    
    Write amperes A as coulombs per second (C/s), and convert hours to seconds.
    
    <div data-type="equation" id="eip-835">
     $$\begin{array}{lll}\Delta m& =& \frac{\left(\text{600 C/s}\cdot \text{h}\left(\frac{\text{3600 s}}{\text{1 h}}\right)\left(\text{12.0 J/C}\right)}{\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}}\\ & =& \frac{\left( 2.16 \times 10^{6}  \text{C}\right)\left(\text{12.0 J/C}\right)}{\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}}\end{array} $$
    </div>
...
4.  {: #import-auto-id2637141} Plug the knowns into the equation.
    <div data-type="equation" id="eip-961">
     $$\begin{array}{lll}\text{\% increase}& =& \frac{\Delta m}{m}×\text{100%}\\ & =& \frac{ 2.88 \times 10^{-10}  \text{kg}}{\text{20.0 kg}}×\text{100%}\\ & =&  1.44 \times 10^{-9} \text{\%}\text{.}\end{array} $$
    </div>
{: type="1"}
...
4.  {: #import-auto-id2595330} Plug the knowns into the equation.
    ...
    <div data-type="equation" id="eip-971">
     $$\begin{array}{lll}{\text{KE}}_{\text{rel}}& =& \left(\gamma -1\right){\mathrm{mc}}^{2}\\ & =& \left(\text{7.0888}-1\right)\left(9.11×{\text{10}}^{–\text{31}} \text{kg}\right)\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}\\ & =& 4.99×{\text{10}}^{\text{–13}} \text{J}\end{array} $$
    </div>
...
4.  {: #import-auto-id3143593} Plug the knowns into the equation.
    <div data-type="equation" id="eip-95">
     $$\begin{array}{lll}{\text{KE}}_{\text{class}}& =& \frac{1}{2}{\mathrm{mv}}^{2}\\ & =& \frac{1}{2}\left(9.00×{\text{10}}^{–\text{31}} \text{kg}\right)\left(0.990{\right)}^{2}\left( 3.00 \times 10^{8}  \text{m/s}{\right)}^{2}\\ & =& 4.02×{\text{10}}^{–\text{14}} \text{J}\end{array} $$
    </div>
...
A proton has a mass of  $$ 1.67 \times 10^{-27}  \text{kg} $$
