...
1.  {: #import-auto-id2720059} Identify the knowns.
    $$m=1\text{.00}×{\text{10}}^{-3} \text{kg}$$
    
    ;
    $$c=3\text{.}\text{00}×{\text{10}}^{8} \text{m/s}$$
...
4.  {: #import-auto-id890041} Plug the knowns into the equation.
    ...
    $$\begin{array}{lll}{E}_{0}& =& {\mathrm{mc}}^{2}=\left(1.00×{\text{10}}^{-3} \text{kg}\right)\left(3.00×{\text{10}}^{8} \text{m/s}{\right)}^{2}\\ & =& 9.00×{\text{10}}^{\text{13}} \text{kg}\cdot {\text{m}}^{2}{\text{/s}}^{2}\end{array}$$
    </div>

5.  {: #import-auto-id2656565} Convert units.
    Noting that $$1 \text{kg}\cdot {\text{m}}^{2}{\text{/s}}^{2}=1 J$$
    
    , we see the rest mass energy is
    
    <div data-type="equation" id="eip-694">
    $${E}_{0}=9\text{.}\text{00}×{\text{10}}^{\text{13}} \text{J}.$$
    </div>
{: type="1"}
...
This is an enormous amount of energy for a 1.00-g mass. We do not notice this energy, because it is generally not available. Rest energy is large because the speed of light $$c$$
 ...
 is huge for any macroscopic mass. The $$9\text{.}\text{00}×{\text{10}}^{\text{13}} \text{J}$$
...
5.  {: #import-auto-id1310375} Plug the knowns into the equation.
    ...
    $$\begin{array}{lll}\Delta m& =& \frac{\left(\text{600 C/s}\cdot \text{h}\left(\frac{\text{3600 s}}{\text{1 h}}\right)\left(\text{12.0 J/C}\right)}{\left(3.00×{\text{10}}^{8} \text{m/s}{\right)}^{2}}\\ & =& \frac{\left(2.16×{\text{10}}^{6} \text{C}\right)\left(\text{12.0 J/C}\right)}{\left(3.00×{\text{10}}^{8} \text{m/s}{\right)}^{2}}\end{array}$$
    </div>
    
    Using the conversion $$1 \text{kg}\cdot {\text{m}}^{2}{\text{/s}}^{2}=1 \text{J}$$
    
    , we can write the mass as
    
    $$\Delta m=2.88×{\text{10}}^{-\text{10}} \text{kg}\text{.}$$
{: type="1"}

<strong>Solution for (b) </strong>

1.  {: #import-auto-id2990812} Identify the knowns.
    $$\Delta m=2.88×{\text{10}}^{-\text{10}} \text{kg}$$
...
4.  {: #import-auto-id2637141} Plug the knowns into the equation.
    ...
    $$\begin{array}{lll}\text{\% increase}& =& \frac{\Delta m}{m}×\text{100%}\\ & =& \frac{2.88×{\text{10}}^{-\text{10}} \text{kg}}{\text{20.0 kg}}×\text{100%}\\ & =& 1.44×{\text{10}}^{-9}\text{\%}\text{.}\end{array}$$
    </div>
{: type="1"}
...
. (a) Calculate the kinetic energy in MeV of the electron. (b) Compare this with the classical value for kinetic energy at this velocity. (The mass of an electron is $$9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg}$$
.)
...
1.  {: #import-auto-id2546385} Identify the knowns.
    ...
    ;
    $$m=9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg}$$
...
4.  {: #import-auto-id2595330} Plug the knowns into the equation.
    ...
    $$\begin{array}{lll}{\text{KE}}_{\text{rel}}& =& \left(\gamma -1\right){\mathrm{mc}}^{2}\\ & =& \left(\text{7.0888}-1\right)\left(9.11×{\text{10}}^{–\text{31}} \text{kg}\right)\left(3.00×{\text{10}}^{8} \text{m/s}{\right)}^{2}\\ & =& 4.99×{\text{10}}^{\text{–13}} \text{J}\end{array}$$
    </div>

5.  {: #import-auto-id2003431} Convert units.
    <div data-type="equation" id="eip-80">
    $$\begin{array}{lll}{\text{KE}}_{\text{rel}}& =& \left(4.99×{\text{10}}^{\text{–13}} \text{J}\right)\left(\frac{\text{1 MeV}}{1.60×{\text{10}}^{–\text{13}} \text{J}}\right)\\ & =& \text{3.12 MeV}\end{array}$$
    </div>
{: type="1"}
...
4.  {: #import-auto-id3143593} Plug the knowns into the equation.
    ...
    $$\begin{array}{lll}{\text{KE}}_{\text{class}}& =& \frac{1}{2}{\mathrm{mv}}^{2}\\ & =& \frac{1}{2}\left(9.00×{\text{10}}^{–\text{31}} \text{kg}\right)\left(0.990{\right)}^{2}\left(3.00×{\text{10}}^{8} \text{m/s}{\right)}^{2}\\ & =& 4.02×{\text{10}}^{–\text{14}} \text{J}\end{array}$$
    </div>

5.  {: #import-auto-id1505723} Convert units.
    <div data-type="equation" id="eip-719">
    $$\begin{array}{lll}{\text{KE}}_{\text{class}}& =& 4.02×{\text{10}}^{–\text{14}} \text{J}\left(\frac{\text{1 MeV}}{1.60×{\text{10}}^{–\text{13}} \text{J}}\right)\\ & =& \text{0.251 MeV}\end{array}$$
    </div>
{: type="1"}
...
$$\begin{array}{lll}{\text{KE}}_{\text{rel}}& =& \left(\gamma -1\right){\mathrm{mc}}^{2}=\left(\frac{1}{\sqrt{1-\frac{ {v}^{2}}{ {c}^{2}}}}-1\right){\mathrm{mc}}^{2}\\ & =& \left(\frac{1}{\sqrt{1-\frac{\left(\text{0.992}c{\right)}^{2}}{ {c}^{2}}}}-1\right)\left(\text{9.11}×{\text{10}}^{-\text{31}} \text{kg}\right)\left(\text{3.00}×{\text{10}}^{8} \text{m/s}{\right)}^{2}=\text{5.67}×{\text{10}}^{-\text{13}} \text{J}\end{array}$$
</div>
</div>
</div>
...
<div data-type="problem" markdown="1">
What is the rest energy of an electron, given its mass is $$9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg}$$
? Give your answer in joules and MeV.

</div>
<div data-type="solution" markdown="1">
$$8.20×{\text{10}}^{-\text{14}} \text{J}$$
0\.512 MeV
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
Find the rest energy in joules and MeV of a proton, given its mass is $$1\text{.}\text{67}×{\text{10}}^{-\text{27}} \text{kg}$$
.
...
<div data-type="solution" markdown="1">
$$2\text{.}3×{\text{10}}^{-\text{30}} \text{kg}$$
</div>
</div>

<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
The Big Bang that began the universe is estimated to have released $${10}^{\text{68}} \text{J}$$
 of energy. How many stars could half this energy create, assuming the average star’s mass is $$4\text{.}\text{00}×{\text{10}}^{\text{30}} \text{kg}$$
?
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
A supernova explosion of a $$2\text{.}\text{00}×{\text{10}}^{\text{31}} \text{kg}$$
 star produces $$1\text{.}\text{00}×{\text{10}}^{\text{44}} \text{J}$$
...
<div data-type="solution" markdown="1">
(a) $$1\text{.}\text{11}×{\text{10}}^{\text{27}} \text{kg}$$
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
There is approximately $${10}^{\text{34}} \text{J}$$
 of energy available from fusion of hydrogen in the world’s oceans. (a) If $${10}^{\text{33}} \text{J}$$
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
Alpha decay is nuclear decay in which a helium nucleus is emitted. If the helium nucleus has a mass of $$6\text{.}\text{80}×{\text{10}}^{-\text{27}} \text{kg}$$
...
-meson that lives $$1\text{.}\text{40}×{10}^{-\text{16}} \text{s}$$
 as measured in the laboratory, and $$0\text{.}\text{840}×{10}^{-\text{16}} \text{s}$$
...
<div data-type="solution" markdown="1">
(a) $$6\text{.}3×{\text{10}}^{\text{11}} \text{kg/s}$$
(b) $$4\text{.}5×{\text{10}}^{\text{10}} \text{y}$$
(c) $$4\text{.}\text{44}×{\text{10}}^{9} \text{kg}$$
(d) 0.32%
...
A proton has a mass of $$1\text{.}\text{67}×{\text{10}}^{-\text{27}} \text{kg}$$
