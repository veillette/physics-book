...
3.  {: #import-auto-id2604060} Choose the appropriate equation.
     $$ \text{\% increase}=\frac{\Delta m}{m}×100 \text{\%}  $$
4.  {: #import-auto-id2637141} Plug the knowns into the equation.
    <div data-type="equation" id="eip-961">
     $$\begin{array}{lll}\text{\% increase}& =& \frac{\Delta m}{m}×100 \text{\%}\\ & =& \frac{ 2.88 \times 10^{-10}  \text{kg}}{20.0 \text{kg}}×100 \text{\%}\\ & =&  1.44 \times 10^{-9} \text{\%}\text{.}\end{array} $$
    </div>
{: type="1"}
