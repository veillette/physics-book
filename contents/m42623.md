 ...
 **beta** $$\left(\beta \right) $$ ,
 ...
 because, like x-rays, their identities were initially unknown. [\[link\]](#Figure2) shows what happens if the rays are passed through a magnetic field. The  $$\gamma  $$
...
<table id="import-auto-id1888293" summary="Types of radiation are listed in column 1. The range for each type is in column 2."><caption><span class="title">Properties of Nuclear Radiation</span></caption><thead><tr>
            <th>
              Type of Radiation
            </th>
            <th>
...
s is that they can be used as radioactive tracers (see [\[link\]](#Figure5)).
...
<div class="note" data-has-label="true" id="eip-749" class="interactive" data-label="" markdown="1">
<div class="title">
...
<div class="exercise" data-element-type="conceptual-questions">
<div class="problem" markdown="1">
Consider [[link]](#Figure2). If an electric field is substituted for the magnetic field with positive charge instead of the north pole and negative charge instead of the south pole, in which directions will the  $$\alpha  $$ ,
  $$\beta  $$ , and  $$\gamma  $$
 rays bend?
