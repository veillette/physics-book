...
Research begun by people such as New Zealander Ernest Rutherford soon after the discovery of nuclear radiation indicated that different types of rays are emitted. Eventually, three types were distinguished and named **alpha**{: data-type="term" #import-auto-id1427002}$\left(\alpha \right)$

, **beta**{: data-type="term" #import-auto-id1517480}$\left(\beta \right)$

, and **gamma**{: data-type="term" #import-auto-id1472534}$\left(\gamma \right)$
...
The **speed** at which they travel is the other major factor affecting the range of $\alpha $
 ...
 s are particles with mass (helium nuclei and electrons, respectively), their energy is kinetic, given classically by $\frac{1}{2}{\text{mv}}^{2}$
