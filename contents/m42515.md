...
{2}=45.0 \text{º} $$ . Solving the equation $$D \sin \theta =\text{mλ} $$ for
...
see that the central maximum extends $$20.7 \text{º} $$ on either side of the
original beam, for a width of about $$41 \text{º} $$ . The angle between the
first and second minima is only about $$24 \text{º} \left(45.0
...
(d)  $${2\theta }_{1}=\left(2\right)\left(14.5 \text{º}\right)=29 \text{º},
