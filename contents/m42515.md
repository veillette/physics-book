...
<div data-type="equation" id="eip-6">
 $$\begin{array}{lll}D& =& \frac{\mathrm{m\lambda }}{ \text{sin} {\theta }_{2}}=\frac{2\left(\text{550 nm}\right)}{\text{sin 45.0º}}\\ & =& \frac{\text{1100} \times 10^{-9} }{0.707}\\ & =&  1.56 \times 10^{-6} .\end{array} $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-125">
 $$\text{sin} {\theta }_{1}=\frac{\mathrm{m\lambda }}{D}=\frac{1\left(\text{550} \times 10^{-9}  \text{m}\right)}{ 1.56 \times 10^{-6}  \text{m}}\text{.} $$
</div>
