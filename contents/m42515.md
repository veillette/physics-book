...
<div data-type="equation" id="eip-6">
 $$\begin{array}{lll}D& =& \frac{\mathrm{m\lambda }}{ \text{sin} {\theta }_{2}}=\frac{2\left(550 \text{nm}\right)}{\text{sin 45.0º}}\\ & =& \frac{1100 \times 10^{-9} }{0.707}\\ & =&  1.56 \times 10^{-6} .\end{array} $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-125">
 $$\text{sin} {\theta }_{1}=\frac{\mathrm{m\lambda }}{D}=\frac{1\left(550 \times 10^{-9}  \text{m}\right)}{ 1.56 \times 10^{-6}  \text{m}}\text{.} $$
</div>
Thus the angle  $${\theta }_{1} $$
 is

<div data-type="equation" id="eip-677">
 $${\theta }_{1}={\text{sin}}^{-1} 0.354=\text{20.7º.} $$
</div>
**Discussion**
...
(d)  $${2\theta }_{1}=\left(2\right)\left(\text{14.5º}\right)=\text{29º}, {\theta }_{2}-{\theta }_{1}=\text{30}\text{.}\text{05º}- 14.5º=\text{15}\text{.}\text{56º} $$
. Thus,  $$\text{29º}\approx \left(2\right)\left(\text{15}\text{.}\text{56º}\right)= 31.1º $$
.
