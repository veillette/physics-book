...
<div data-type="equation" id="eip-635">
 $$D\sin \theta =\mathrm{m\lambda }, \text{for} m=\text{1,} \text{–1,} \text{2,} \text{–2,} \text{3,} \dots  \text{(destructive),} $$
</div>
...
<div data-type="equation" id="eip-677">
 $${\theta }_{1}={\sin}^{-1} 0.354=\text{20.7º.} $$
</div>
**Discussion**
...
* {: #import-auto-id1169738249784} There is destructive interference for a single slit when
   $$D \sin \theta =\text{mλ}, \text{(for} m=\text{1,} \text{–1,} \text{2,} \text{–2,} \text{3,} \dots \right) $$
    , where
   $$D $$
    is the slit width,
   $$\lambda  $$
