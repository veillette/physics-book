...
(d)  $${2\theta }_{1}=\left(2\right)\left(\text{14.5º}\right)=\text{29º}, {\theta }_{2}-{\theta }_{1}=30.05\text{º}- 14.5º=15.56\text{º} $$
. Thus,  $$\text{29º}\approx \left(2\right)\left(15.56\text{º}\right)= 31.1º $$
.
