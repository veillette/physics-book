...
**Step 4** Determine whether the number of molecules or the number of moles is known, in order to decide which form of the ideal gas law to use. The first form is  $$PV=Nk_{B}T $$
 ...
 and involves  $$n $$ ,  the number of moles.
...
Avogadro’s number
:  $${N}_{\text{A}} $$ ,  the number of molecules or atoms in one mole of a substance;
