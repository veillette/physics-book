...
<div data-type="equation" id="import-auto-id2402631">
 $$\begin{array}{lll}n& =& \frac{\text{PV}}{\text{RT}}=\frac{\left( 7.00 \times 10^{5}  \text{Pa}\right)\left( 2.00 \times 10^{-3}  {\text{m}}^{3}\right)}{\left(8\text{.}\text{31} \text{J/mol}\cdot \text{K}\right)\left(\text{291} \text{K}\right)}\\ \text{}& =& \text{0}\text{.}\text{579} \text{mol}\end{array} $$
</div>
**Discussion**
