...
<div data-type="equation" id="import-auto-id2677638">
 $${P}_{\text{f}}={P}_{0}\frac{ {T}_{\text{f}}}{ {T}_{0}}= 7.00 \times 10^{5}  \text{Pa}\left(\frac{\text{308 K}}{\text{291 K}}\right)= 7.41 \times 10^{5}  \text{Pa} $$
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2409094">
 $$\begin{array}{lll}T& =& 0\text{º}\text{C}=\text{273 K}\\ P& =&  1.01 \times 10^{5}  \text{Pa}\\ V& =& 1\text{.}\text{00} {\text{m}}^{3}\\ k& =& 1\text{.}\text{38}×{\text{10}}^{-\text{23}} \text{J/K}\end{array} $$
</div>
...
<div data-type="equation" id="import-auto-id2887530">
 $$N=\frac{\text{PV}}{\text{kT}}=\frac{\left( 1.01 \times 10^{5}  \text{Pa}\right)\left(1\text{.}{\text{00 m}}^{3}\right)}{\left(1\text{.}\text{38}×{\text{10}}^{-\text{23}} \text{J/K}\right)\left(\text{273 K}\right)}=2\text{.}\text{68}×{\text{10}}^{\text{25}} \text{molecules} $$
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2124330">
 $$\begin{array}{lll}P& =&  7.00 \times 10^{5}  \text{Pa}\\ V& =&  2.00 \times 10^{-3}  {\text{m}}^{3}\\ T& =& \text{18}\text{.}0\text{º}\text{C}=\text{291 K}\\ R& =& 8\text{.}\text{31} \text{J/mol}\cdot \text{K}\end{array} $$
</div>
2\. Rearrange the equation to solve for  $$n $$
 and substitute known values.

<div data-type="equation" id="import-auto-id2402631">
 $$\begin{array}{lll}n& =& \frac{\text{PV}}{\text{RT}}=\frac{\left( 7.00 \times 10^{5}  \text{Pa}\right)\left(2\text{.}00×{\text{10}}^{-3} {\text{m}}^{3}\right)}{\left(8\text{.}\text{31} \text{J/mol}\cdot \text{K}\right)\left(\text{291} \text{K}\right)}\\ \text{}& =& \text{0}\text{.}\text{579} \text{mol}\end{array} $$
</div>
**Discussion**
