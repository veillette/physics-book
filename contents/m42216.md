...
where $$P$$
 ...
 is its absolute temperature. The constant $$k$$
...
$$k=1\text{.}\text{38}×{\text{10}}^{-\text{23}} \text{J}/\text{K}.$$
</div>
</div>

The ideal gas law can be derived from basic principles, but was originally deduced from experimental measurements of Charles’ law (that volume occupied by a gas is proportional to temperature at a fixed pressure) and from Boyle’s law (that for a fixed temperature, the product $$\text{PV}$$
...
Let us see how the ideal gas law is consistent with the behavior of filling the tire when it is pumped slowly and the temperature is constant. At first, the pressure $$P$$
 ...
 put into the tire. Once the volume of the tire is constant, the equation $$\text{PV}=\text{NkT}$$
...
Suppose your bicycle tire is fully inflated, with an absolute pressure of $$7\text{.}\text{00}×{\text{10}}^{5} \text{Pa}$$
 (a gauge pressure of just under $$\text{90}\text{.}0 {\text{lb/in}}^{2}$$
) at a temperature of $$\text{18}\text{.}0\text{º}\text{C}$$
. What is the pressure after its temperature has risen to $$\text{35}\text{.}0\text{º}\text{C}$$
...
We know the initial pressure $${P}_{0}=7\text{.00}×{\text{10}}^{5} \text{Pa}$$
, the initial temperature $${T}_{0}=\text{18}\text{.}0ºC$$
, and the final temperature $${T}_{\text{f}}=35\text{.}0ºC$$
. We must find the final pressure $${P}_{\text{f}}$$
. How can we use the equation $$\text{PV}=\text{NkT}$$
? At first, it may seem that not enough information is given, because the volume $$V$$
 and number of atoms $$N$$
 are not specified. What we can do is use the equation twice: $${P}_{0}{V}_{0}={\text{NkT}}_{0}$$
 and $${P}_{\text{f}}{V}_{\text{f}}={\text{NkT}}_{\text{f}}$$
...
$${P}_{\text{f}}={P}_{0}\frac{ {T}_{\text{f}}}{ {T}_{0}}=7\text{.}\text{00}×{\text{10}}^{5} \text{Pa}\left(\frac{\text{308 K}}{\text{291 K}}\right)=7\text{.}\text{41}×{\text{10}}^{5} \text{Pa}$$
</div>
**Discussion**
...
Calculate the number of molecules in a cubic meter of gas at standard temperature and pressure (STP), which is defined to be $$0\text{º}\text{C}$$
 and atmospheric pressure.

**Strategy**

Because pressure, volume, and temperature are all specified, we can use the ideal gas law $$\text{PV}=\text{NkT}$$
, to find $$N$$
.
...
$$\begin{array}{lll}T& =& 0\text{º}\text{C}=\text{273 K}\\ P& =& 1\text{.}\text{01}×{\text{10}}^{5} \text{Pa}\\ V& =& 1\text{.}\text{00} {\text{m}}^{3}\\ k& =& 1\text{.}\text{38}×{\text{10}}^{-\text{23}} \text{J/K}\end{array}$$
</div>
...
$$N=\frac{\text{PV}}{\text{kT}}=\frac{\left(1\text{.}\text{01}×{\text{10}}^{5} \text{Pa}\right)\left(1\text{.}{\text{00 m}}^{3}\right)}{\left(1\text{.}\text{38}×{\text{10}}^{-\text{23}} \text{J/K}\right)\left(\text{273 K}\right)}=2\text{.}\text{68}×{\text{10}}^{\text{25}} \text{molecules}$$
</div>
**Discussion**
...
This number is undeniably large, considering that a gas is mostly empty space. $$N$$
 ...
 of a gas at STP has $$2\text{.}\text{68}×{\text{10}}^{\text{19}}$$
...
$${N}_{\text{A}}=6\text{.}\text{02}×{\text{10}}^{\text{23}} {\text{mol}}^{-1}\text{.}$$
</div>
...
One mole always contains $$6\text{.}\text{02}×{\text{10}}^{\text{23}}$$
...
$${N}_{\text{A}}=6\text{.}\text{02}×{\text{10}}^{\text{23}} {\text{mol}}^{-1}$$
</div>
</div>
...
$$\left(\frac{\text{325 mg}}{\text{151 grams/mole}}\right)\left(\frac{1 gram}{\text{1000 mg}}\right)=2.15×{\text{10}}^{-3} \text{moles}$$
</div>
Then use Avogadro’s number to calculate the number of molecules.

<div data-type="equation" id="import-auto-id2627386">
$$N=\left(\text{2.15}×{\text{10}}^{-3} \text{moles}\right)\left(\text{6.02}×{\text{10}}^{\text{23}} \text{molecules/mole}\right)=\text{1.30}×{\text{10}}^{\text{21}} \text{molecules}$$
</div>
</div>
</div>
...
Calculate: (a) the number of moles in $$1\text{.}\text{00} {\text{m}}^{3}$$
 of gas at STP, and (b) the number of liters of gas per mole.

**Strategy and Solution**

(a) We are asked to find the number of moles per cubic meter, and we know from [\[link\]](#fs-id1843505) that the number of molecules per cubic meter at STP is $$2\text{.}\text{68}×{\text{10}}^{\text{25}}$$
...
$$n {\text{mol/m}}^{3}=\frac{N {\text{molecules/m}}^{3}}{6\text{.}\text{02}×{\text{10}}^{\text{23}} \text{molecules/mol}}=\frac{2\text{.}\text{68}×{\text{10}}^{\text{25}} {\text{molecules/m}}^{3}}{6\text{.}\text{02}×{\text{10}}^{\text{23}} \text{molecules/mol}}=\text{44}\text{.}5 {\text{mol/m}}^{3}\text{.}$$
</div>
...
$$\frac{\left({\text{10}}^{3} {\text{L/m}}^{3}\right)}{44\text{.}5 {\text{mol/m}}^{3}}=\text{22}\text{.}5 \text{L/mol}\text{.}$$
</div>
**Discussion**
...
The (average) molar weight of air (approximately 80% $${\text{N}}_{2}$$
 and 20% $${\text{O}}_{2}$$
 is $$M=\text{28}\text{.}8 \text{g}\text{.}$$
 Thus the mass of one cubic meter of air is 1.28 kg. If a living room has dimensions $$5 \text{m}×\text{5 m}×\text{3 m,}$$
...
The density of air at standard conditions $$\left(P=1 \text{atm}$$
 and $$T=\text{20}\text{º}\text{C}\right)$$
...
, we see that when the temperature is constant, the pressure is inversely proportional to volume. Therefore, if the volume doubles, the pressure must drop to half its original value, and $${P}_{\text{f}}=0\text{.}\text{50} \text{atm}\text{.}$$
</div>
</div>
...
$$R={N}_{\text{A}}k=\left(6\text{.}\text{02}×{\text{10}}^{\text{23}} {\text{mol}}^{-1}\right)\left(1\text{.}\text{38}×{\text{10}}^{-\text{23}} \text{J/K}\right)=8\text{.}\text{31} \text{J}/\text{mol}\cdot \text{K}.$$
</div>
In other units,

<div data-type="equation" id="import-auto-id2919790">
$$\begin{array}{lll}R& =& 1\text{.}\text{99} \text{cal/mol}\cdot \text{K}\\ R& =& \text{0}\text{.}\text{0821 L}\cdot \text{atm/mol}\cdot \text{K}\text{.}\end{array}$$
</div>
...
How many moles of gas are in a bike tire with a volume of $$2\text{.}\text{00}×{\text{10}}^{–3} {\text{m}}^{3}\left(2\text{.}\text{00 L}\right),$$
 a pressure of $$7\text{.}\text{00}×{\text{10}}^{5} \text{Pa}$$
 (a gauge pressure of just under $$\text{90}\text{.}0 {\text{lb/in}}^{2}$$
), and at a temperature of $$\text{18}\text{.}0\text{º}\text{C}$$
?

**Strategy**

Identify the knowns and unknowns, and choose an equation to solve for the unknown. In this case, we solve the ideal gas law, $$\text{PV}=\text{nRT}$$
...
$$\begin{array}{lll}P& =& 7\text{.}\text{00}×{\text{10}}^{5} \text{Pa}\\ V& =& 2\text{.}\text{00}×{\text{10}}^{-3} {\text{m}}^{3}\\ T& =& \text{18}\text{.}0\text{º}\text{C}=\text{291 K}\\ R& =& 8\text{.}\text{31} \text{J/mol}\cdot \text{K}\end{array}$$
</div>
2\. Rearrange the equation to solve for $$n$$
 and substitute known values.

<div data-type="equation" id="import-auto-id2402631">
$$\begin{array}{lll}n& =& \frac{\text{PV}}{\text{RT}}=\frac{\left(7\text{.}\text{00}×{\text{10}}^{5} \text{Pa}\right)\left(2\text{.}00×{\text{10}}^{-3} {\text{m}}^{3}\right)}{\left(8\text{.}\text{31} \text{J/mol}\cdot \text{K}\right)\left(\text{291} \text{K}\right)}\\ \text{}& =& \text{0}\text{.}\text{579} \text{mol}\end{array}$$
</div>
**Discussion**

The most convenient choice for $$R$$
 in this case is $$8\text{.}\text{31} \text{J/mol}\cdot \text{K,}$$
...
The ideal gas law is closely related to energy: the units on both sides are joules. The right-hand side of the ideal gas law in $$\text{PV}=\text{NkT}$$
 is $$\text{NkT}$$
. This term is roughly the amount of translational kinetic energy of $$N$$
 atoms or molecules at an absolute temperature $$T$$
, as we shall see formally in [Kinetic Theory: Atomic and Molecular Explanation of Pressure and Temperature](/m42147). The left-hand side of the ideal gas law is $$\text{PV}$$
...
**Step 4** Determine whether the number of molecules or the number of moles is known, in order to decide which form of the ideal gas law to use. The first form is $$\text{PV}=\text{NkT}$$
 and involves $$N$$
, the number of atoms or molecules. The second form is $$\text{PV}=\text{nRT}$$
 and involves $$n$$
, the number of moles.
...
* {: #import-auto-id739594} The ideal gas law can be written in terms of the number of molecules of gas:
  ...
  $$k=1\text{.}\text{38}×{\text{10}}^{–\text{23}} \text{J/K}.$$
  </div>
...
* {: #import-auto-id2599036} The ideal gas law can also be written and solved in terms of the number of moles of gas:
  ...
  $$R=8\text{.}\text{31} \text{J/mol}\cdot \text{K}.$$
  </div>
...
<div data-type="problem" markdown="1">
The gauge pressure in your car tires is $$2\text{.}\text{50}×{\text{10}}^{5} {\text{N/m}}^{2}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Convert an absolute pressure of $$7\text{.}\text{00}×{\text{10}}^{5} {\text{N/m}}^{2}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In the text, it was shown that $$N/V=2\text{.}\text{68}×{\text{10}}^{\text{25}} {\text{m}}^{-3}$$
 for gas at STP. (a) Show that this quantity is equivalent to $$N/V=2\text{.}\text{68}×{\text{10}}^{\text{19}} {\text{cm}}^{-3},$$
...
An airplane passenger has $$\text{100} {\text{cm}}^{3}$$
 of air in his stomach just before the plane takes off from a sea-level airport. What volume will the air have at cruising altitude if cabin pressure drops to $$7\text{.}\text{50}×{\text{10}}^{4} {\text{N/m}}^{2}?$$
</div>
</div>
...
<div data-type="solution" markdown="1">
(a) $$6\text{.}\text{02}×{\text{10}}^{5} {\text{km}}^{3}$$
(b) $$6\text{.}\text{02}×{\text{10}}^{8} \text{km}$$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
An expensive vacuum system can achieve a pressure as low as $$1\text{.}\text{00}×{\text{10}}^{–7} {\text{N/m}}^{2}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The number density of gas atoms at a certain location in the space above our planet is about $$1\text{.}\text{00}×{\text{10}}^{\text{11}} {\text{m}}^{-3},$$
 and the pressure is $$2\text{.}\text{75}×{\text{10}}^{–\text{10}} {\text{N/m}}^{2}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A bicycle tire has a pressure of $$7\text{.}\text{00}×{\text{10}}^{5} {\text{N/m}}^{2}$$
 at a temperature of $$\text{18}\text{.}0\text{º}\text{C}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A high-pressure gas cylinder contains 50.0 L of toxic gas at a pressure of $$1\text{.}\text{40}×{\text{10}}^{7} {\text{N/m}}^{2}$$
 and a temperature of $$\text{25}\text{.}0\text{º}\text{C}$$
. Its valve leaks after the cylinder is dropped. The cylinder is cooled to dry ice temperature $$\left(–\text{78}\text{.}5\text{º}\text{C}\right)$$
...
<div data-type="solution" markdown="1">
(a) $$9\text{.}\text{14}×{\text{10}}^{6} {\text{N/m}}^{2}$$
(b) $$8\text{.}\text{23}×{\text{10}}^{6} {\text{N/m}}^{2}$$
(c) 2.16 K
...
Find the number of moles in 2.00 L of gas at $$\text{35}\text{.}0\text{º}\text{C}$$
 and under $$7\text{.}\text{41}×{\text{10}}^{7} {\text{N/m}}^{2}$$
 of pressure.
...
<div data-type="solution" markdown="1">
(a) $$3\text{.}7×{\text{10}}^{-\text{17}} \text{Pa}$$
(b) $$6\text{.}0×{\text{10}}^{\text{17}} {\text{m}}^{3}$$
(c) $$8\text{.}4×{\text{10}}^{2} \text{km}$$
</div>
</div>
