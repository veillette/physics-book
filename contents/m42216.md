...
) at a temperature of  $$ 18.0\text{º}\text{C} $$
. What is the pressure after its temperature has risen to  $$ 35.0\text{º}\text{C} $$
...
<div data-type="equation" id="import-auto-id2409094">
 $$\begin{array}{lll}T& =& 0\text{º}\text{C}=273 \text{K}\\ P& =&  1.01 \times 10^{5}  \text{Pa}\\ V& =&  1.00 {\text{m}}^{3}\\ k& =&  1.38 \times 10^{-23}  \text{J/K}\end{array} $$
</div>
...
<div data-type="equation" id="import-auto-id2887530">
 $$N=\frac{\text{PV}}{\text{kT}}=\frac{\left( 1.01 \times 10^{5}  \text{Pa}\right)\left(1\text{.}{00 \text{m}}^{3}\right)}{\left( 1.38 \times 10^{-23}  \text{J/K}\right)\left(273 \text{K}\right)}= 2.68 \times 10^{25}  \text{molecules} $$
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2919489">
 $$\begin{array}{}\left(\text{8 moles of carbon}\right)\left(12 \text{grams/mole}\right)+\left(\text{9 moles hydrogen}\right)\left(1 \text{gram/mole}\right)\\ +\left(\text{1 mole nitrogen}\right)\left(14 \text{grams/mole}\right)+\left(\text{2 moles oxygen}\right)\left(16 \text{grams/mole}\right)=151 \text{g}\end{array} $$
</div>
...
The (average) molar weight of air (approximately 80%  $${\text{N}}_{2} $$
 and 20%  $${\text{O}}_{2} $$
 is  $$M= 28.8 \text{g}\text{.} $$
 Thus the mass of one cubic meter of air is 1.28 kg. If a living room has dimensions  $$5 \text{m}×5 \text{m}×\text{3 m,} $$
...
The density of air at standard conditions  $$\left(P=1 \text{atm} $$
 ...
 is  $$ 1.28 {\text{kg/m}}^{3} $$
. At what pressure is the density  $$0\text{.}{64 \text{kg/m}}^{3} $$
...
How many moles of gas are in a bike tire with a volume of  $$ 2.00 \times 10^{-3} {\text{m}}^{3}\left(2.00 \text{L}\right), $$
 ...
 (a gauge pressure of just under  $$ 90.0 {\text{lb/in}}^{2} $$
), and at a temperature of  $$ 18.0\text{º}\text{C} $$
?
...
<div data-type="equation" id="import-auto-id2124330">
 $$\begin{array}{lll}P& =&  7.00 \times 10^{5}  \text{Pa}\\ V& =&  2.00 \times 10^{-3}  {\text{m}}^{3}\\ T& =&  18.0\text{º}\text{C}=291 \text{K}\\ R& =&  8.31 \text{J/mol}\cdot \text{K}\end{array} $$
</div>
2. Rearrange the equation to solve for  $$n $$
 and substitute known values.

<div data-type="equation" id="import-auto-id2402631">
 $$\begin{array}{lll}n& =& \frac{\text{PV}}{\text{RT}}=\frac{\left( 7.00 \times 10^{5}  \text{Pa}\right)\left( 2.00 \times 10^{-3}  {\text{m}}^{3}\right)}{\left( 8.31 \text{J/mol}\cdot \text{K}\right)\left(291 \text{K}\right)}\\  & =&  0.579  \text{mol}\end{array} $$
</div>
**Discussion**

The most convenient choice for  $$R $$
 in this case is  $$ 8.31 \text{J/mol}\cdot \text{K,} $$
...
The gauge pressure in your car tires is  $$ 2.50 \times 10^{5}  {\text{N/m}}^{2} $$
 at a temperature of  $$ 35.0\text{º}\text{C} $$
 when you drive it onto a ferry boat to Alaska. What is their gauge pressure later, when their temperature has dropped to  $$ - 40.0\text{º}\text{C} $$
?
...
Convert an absolute pressure of  $$ 7.00 \times 10^{5}  {\text{N/m}}^{2} $$
 ...
 (This value was stated to be just less than  $$\text{90}\text{.}{0 \text{lb/in}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Suppose a gas-filled incandescent light bulb is manufactured so that the gas inside the bulb is at atmospheric pressure when the bulb has a temperature of  $$ 20.0\text{º}\text{C} $$
. (a) Find the gauge pressure inside such a bulb when it is hot, assuming its average temperature is  $$ 60.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Large helium-filled balloons are used to lift scientific equipment to high altitudes. (a) What is the pressure inside such a balloon if it starts out at sea level with a temperature of  $$ 10.0\text{º}\text{C} $$
 and rises to an altitude where its volume is twenty times the original volume and its temperature is  $$ - 50.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Calculate the number of moles in the 2.00-L volume of air in the lungs of the average person. Note that the air is at  $$ 37.0\text{º}\text{C} $$
 (body temperature).
...
A high-pressure gas cylinder contains 50.0 L of toxic gas at a pressure of  $$ 1.40 \times 10^{7}  {\text{N/m}}^{2} $$
 and a temperature of  $$ 25.0\text{º}\text{C} $$
. Its valve leaks after the cylinder is dropped. The cylinder is cooled to dry ice temperature  $$\left( - 78.5\text{º}\text{C}\right) $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Find the number of moles in 2.00 L of gas at  $$ 35.0\text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the gauge pressure in a  $$ 25.0\text{º}\text{C} $$
 car tire containing 3.60 mol of gas in a 30.0 L volume? (b) What will its gauge pressure be if you add 1.00 L of gas originally at atmospheric pressure and  $$ 25.0\text{º}\text{C} $$
? Assume the temperature returns to  $$ 25.0\text{º}\text{C} $$
