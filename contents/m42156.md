...
<div data-type="equation" id="eip-211">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& \frac{\Delta p}{\Delta t}=\frac{\text{3.306 kg}\cdot \text{m/s}}{5.0×10^{-3}s}\\ & =& 661 \text{N}\approx \text{660 N,}\end{array} $$ 
</div>
...
\text{600 m/s} $$. (c) What is the momentum of the 90.0-kg hunter running at $$ 7\text{.}\text{40 m/s} $$
