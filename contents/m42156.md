...
<div data-type="equation" id="eip-926">
 $$ p_{\text{player}}=\left(110 \text{kg}\right)\left(8.00 \text{m/s}\right)=880 \text{kg}·\text{m/s} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-722">
 $$ p_{\text{ball}}=\left(0.410 \text{kg}\right)\left(25.0 \text{m/s}\right)=10.3 \text{kg}·\text{m/s} $$ 
</div>
...
is calculated,$$ F_{\text{net}}=\frac{\Delta p}{\Delta t} $$
...
<div data-type="equation" id="eip-107">
 $$ \begin{array}{lll}\Delta p& =& m\left(v_{f}–v_{i}\right)\\ & =& \left(0.057 \text{kg}\right)\left(58 \text{m/s}–0 m/s\right)\\ & =& 3.306 \text{kg}·\text{m/s}\approx 3.3 \text{kg}·\text{m/s}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-211">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& \frac{\Delta p}{\Delta t}=\frac{3.306 \text{kg}\cdot \text{m/s}}{5.0\times 10^{-3}s}\\ & =& 661 \text{N}\approx \text{660 N,}\end{array} $$ 
</div>
...
<div data-type="problem" markdown="1">
(a) Calculate the momentum of a 2000-kg elephant charging a hunter at a speed of  $$ 7.50 \text{m/s} $$ . (b) Compare the elephant’s momentum with the momentum of a 0.0400-kg
tranquilizer dart fired at a speed of $$
600 \text{m/s} $$. (c) What is the momentum of the 90.0-kg hunter running at $$ 7.40 \text{m/s} $$
after missing the elephant?

</div>
<div data-type="solution" markdown="1">
(a)  $$ 1.50\times 10^{4}\text{kg}\cdot \text{m/s} $$ 

(b) 625 to 1

(c)  $$ 6.66 \times 10^{2}\text{kg}\cdot
\text{m/s} $$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the mass of a large ship that has a momentum of  $$ 1.60 \times 10^{9}\text{kg}·\text{m/s} $$ 
...
fired at a speed of $$ 1200 \text{m/s} $$.
...
airplane have to fly to have a momentum of $$ 1.60 \times 10^{9}\text{kg}·\text{m/s}
$$
(the same as the ship’s momentum in the problem above)? (b) What is the plane’s
momentum when it is taking off at a speed of $$ 60.0 \text{m/s} $$
...
<div data-type="solution" markdown="1">
(a)  $$ 8.00 \times 10^{4}\text{m/s} $$ 

(b)  $$ 1.20 \times 10^{6}\text{kg}·\text{m/s}
$$
...
-0.0100 \text{m/s} $$, which is probably not noticeable.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the momentum of a garbage truck that is  $$ 1.20 \times 10^{4}\text{kg} $$ 

and is moving at $$ 10.0 \text{m/s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A runaway train car that has a mass of 15 000 kg travels at a speed of  $$ 5.4 \text{m/s} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The mass of Earth is  $$ 5.972 \times {10}^{24}\text{kg} $$ 

and its orbital radius is an average of $$ 1.496 \times {10}^{11}\text{m} $$. Calculate its linear momentum.
