...
# import-auto-id1343909} is defined as the product of a system’s mass multiplied by its velocity. In symbols, linear
...
is a vector having the same direction as the velocity \\( \mathbf{\text{v}} \\)
...
. (As usual, a symbol that is in italics is a magnitude, whereas one that is
...
1\text{.}\text{496}×{10}^{\text{11}}\phantom{\rule{0.25em}{0ex}}\text{m} \\)
