...
<div data-type="equation" id="eip-107">
 $$ \begin{array}{lll}
\Delta p& =& m\left(v_{f}–v_{i}\right)\\ & =& \left(0.057 \text{kg}\right)\left(58 \text{m/s}–0 m/s\right)\\ & =& 3.306 \text{kg}·\text{m/s}\approx 3.3 \text{kg}·\text{m/s}
\end{array} $$ 
</div>
