...
<div data-type="equation" id="eip-211">
 $$ \begin{array}{lll}
F_{\text{net}}& =& \frac{\Delta p}{\Delta t}=\frac{3.306 \text{kg}\cdot \text{m/s}}{5.0\times 10^{-3}s}\\ 
...
tranquilizer dart fired at a speed of $$ 600 \text{m/s} $$.
(c) What is the momentum of the 90.0-kg hunter running at $$ 7.40 \text{m/s} $$
...
$$ 1.60 \times 10^{9}\text{kg}·\text{m/s} $$, when the ship is moving at a speed 
of $$ 48.0 \text{ km/h?} $$
...
10^{9}\text{kg}·\text{m/s} $$
(the same as the ship’s momentum in the problem above)?
(b) What is the plane’s
...
(b) At what speed would an 8.00-kg
