...
<div data-type="equation" id="eip-17">
 $$ {\mathbf{F}}_{\text{net}}\text{=}m\mathbf{a} $$ 
</div>
...
<div data-type="equation" id="eip-211">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& \frac{\Delta p}{\Delta t}=\frac{\text{3.306 kg}\cdot \text{m/s}}{5\text{.}0×{\text{10}}^{-3}\phantom{\rule{0.25em}{0ex}}s}\\ & =& \text{661 N}\approx \text{660 N,}\end{array} $$ 
</div>
...
$$ {F}_
{\text{net}}\phantom{\rule{0.15em}{0ex}}\text{=}\phantom{\rule{0.15em}{0ex}}\text{ma}
...
(c)  $$
6\text{.}\text{66}×{\text{10}}^{2}\phantom{\rule{0.25em}{0ex}}\text{kg}\cdot
\text{m/s} $$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the mass of a large ship that has a momentum of  $$ 1\text{.}\text{60}×{\text{10}}^{9}\phantom{\rule{0.25em}{0ex}}\text{kg}·\text{m/s} $$ 
...
1\text{.}\text{60}×{\text{10}}^{9}\phantom{\rule{0.25em}{0ex}}\text{kg}·\text{m/s}
$$
...
(b)  $$
1\text{.}\text{20}×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{kg}·\text{m/s}
$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the momentum of a garbage truck that is  $$ 1\text{.}\text{20}×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{kg} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The mass of Earth is  $$ 5\text{.}\text{972}×{10}^{\text{24}}\phantom{\rule{0.25em}{0ex}}\text{kg} $$ 

and its orbital radius is an average of $$
1\text{.}\text{496}×{10}^{\text{11}}\phantom{\rule{0.25em}{0ex}}\text{m} $$. Calculate its linear momentum.
