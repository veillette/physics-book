...
energy, so that $$  W_{\text{c}}=-\Delta \text{PE} $$. Substituting this equation into the previous one and solving for $$  W_
{\text{nc}} $$
gives
...
mechanical energy of a system. If $$  W_
{\text{nc}} $$
is positive, then mechanical energy is increased, such as when the person pushes
the crate up the ramp in [\[link\]](#import-auto-id2124288). If $$  W_
{\text{nc}} $$
...
When no change in potential energy occurs, applying $$ {\text{KE}}_
{\text{i}}+{\text{PE}}_{\text{i}}+ W_
{\text{nc}}={\text{KE}}_{\text{f}}+{\text{PE}}_{\text{f}} $$
...
{\text{KE}}_{\text{i}}+{\text{PE}}_{\text{i}}+ W_{\text{nc}}={\text{KE}}_
{\text{f}}+{\text{PE}}_{\text{f}} $$
...
$$
is in the opposite direction of the motion (that is, $$ \theta =\text{180º} $$, and so $$ \cos{\theta} =-1 $$
...
Suppose that the player from [\[link\]](#fs-id1900640) is running up a hill having a  $$ 5.\text{00º} $$ 
...
to reach height $$ h $$
along the hill, with $$
h=d\sin5.00º $$. This is expressed by the equation

<div data-type="equation">
 $$ \text{KE}{}_{\text{i}}\text{}+{\text{PE}}_{\text{i}}+ W_{\text{nc}}={\text{KE}}_{\text{f}}+{\text{PE}}_{\text{f}}\text{.} $$ 
</div>
**Solution**
...
for the kinetic energy and $$ {\text{PE}}_
{f}=mgh =\text{mgd}\sin{\theta}
$$
...
<div data-type="equation" id="eip-652">
 $$ \frac{1}{2} m v_{i}^{2}+0+\left(-\text{fd}\right)=0+\text{mgd}\sin\mathrm{\theta .} $$ 
</div>
Solve this for  $$ d $$ 
...
on the cup is $$ {\mu }_{k}N $$, where the normal force $$ N $$
...
* {: #import-auto-id1455144} Work $$ W_{\text{nc}} $$
  ...
  equation form, $$ W_
  {\text{nc}}=\Delta \text{KE}+\Delta \text{PE} $$
  or, equivalently, $$ {\text{KE}}_{\text{i}}+{\text{PE}}_{\text{i}}+W_
  {\text{nc}}={\text{KE}}_
  {\text{f}}+{\text{PE}}_{\text{f}} $$
  .
