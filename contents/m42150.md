...
its kinetic energy, or $$ W_{\text{net}}=\text{ΔKE} $$. The net work is the sum
...
energy, so that $$ W_{\text{c}}=-\Delta \text{PE} $$. Substituting this equation
...
PE}\right) $$ changes by exactly the amount of work done by nonconservative
...
We rearrange $$ W_{\text{nc}}=\Delta \text{KE}+\Delta \text{PE} $$ to obtain
...
{\text{i}}+{\text{PE}}_{\text{i}}+ W_{\text{nc}}={\text{KE}}_
{\text{f}}+{\text{PE}}_{\text{f}} $$ amounts to applying the work-energy theorem
...
kinetic energy, the previous equation $$ {\text{KE}}_{\text{i}}+{\text{PE}}_
{\text{i}}+ W_{\text{nc}}={\text{KE}}_{\text{f}}+{\text{PE}}_{\text{f}} $$ says
...
potential energy is $$ {\text{PE}}_{i}=mg \cdot 0=0 $$ and the kinetic energy is
$$ {\text{KE}}_{i}=\frac{1}{2} m v_{i}^{2} $$ ; the final energy contributions
are $$ {\text{KE}}_{f}=0 $$ for the kinetic energy and $$ {\text{PE}}_{f}=mgh
...
* {: #import-auto-id1455144} Work $$ W_{\text{nc}} $$ done by a nonconservative
  ...
  {\text{nc}}=\Delta \text{KE}+\Delta \text{PE} $$ or, equivalently, $$
