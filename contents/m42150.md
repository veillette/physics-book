...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{  m v_{i}^{2}}{2f}\\ & =& \frac{\left(65.0 \text{kg}\right)\left(6.00 \text{m/s}{\right)}^{2}}{\left(2\right)\left(450 \text{N}\right)}\\ & =&
2.60 \text{ m.}\end{array} $$ 
</div>
**Discussion**
...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{\left(\frac{1}{2}\right){ {mv }_{\text{i}}}^{2}}{f+mg \sin{\theta} }\\ & =& \frac{\text{(0.5)}\left(65.0 \text{kg}\right)\left(6.00 \text{m/s}{\right)}^{2}}{450 \text{N}+\left(65.0 \text{kg}\right)
\left( 9.80 \text{ m/s}^{2}\right){\sin{(5.00^\circ )}}}\\ & =& 
2.31 \text{ m.}\end{array} $$ 
</div>
**Discussion**
