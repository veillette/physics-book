...
$$
is in the opposite direction of the motion (that is, $$ \theta =\text{180º} $$, and so $$ \text{cos}\phantom{\rule{0.25em}{0ex}}\theta =-1 $$
...
to reach height $$ h $$
along the hill, with $$
h=d\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}5.00º $$. This is expressed by the equation
...
{f}=\text{mgh}=\text{mgd}\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\theta
$$
