...
energy, so that $$ {W}_{\text{c}}=-\Delta \text{PE} $$. Substituting this equation into the previous one and solving for $$ {W}_
{\text{nc}} $$
gives

<div data-type="equation">
 $$ {W}_{\text{nc}}=\Delta \text{KE}+\Delta \text{PE.} $$ 
</div>
...
We rearrange $$ {W}_{\text{nc}}=\Delta \text{KE}+\Delta \text{PE} $$
to obtain
...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{\left(\frac{1}{2}\right){ {\text{mv}}_{\text{i}}}^{2}}{f+\text{mg}\sin{\theta} }\\ & =& \frac{\text{(0.5)}\left(\text{65.0 kg}\right)\left(\text{6.00 m/s}{\right)}^{2}}{\text{450 N}+\left(\text{65.0 kg}\right)\left({\text{9.80 m/s}}^{2}\right){\text{sin (5.00º)}}^{}}\\ & =& \text{2.31 m.}\end{array} $$ 
</div>
**Discussion**
