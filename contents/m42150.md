...
<div data-type="equation">
 $$ \begin{array}{lll}
d& =& \frac{m v_{i}^{2}}{2f}\\ 
 & =& \frac{\left(65.0 \text{kg}\right)\left(6.00 \text{m/s} \right)^{2}}
{\left(2\right)\left(450 \text{N}\right)}\\ & =&
...
=\text{KE}_{\text{f}}+\text{PE}_{\text{f}}\text{.} $$ 
</div>
**Solution**
...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{\frac{1}{2} mv_\text{i}^{2} }
{f+mg \sin{\theta} }\\ & =& \frac{\text{(0.5)}\left(65.0 \text{kg}\right)
\left(6.00 \text{m/s} \right)^{2}}
{450 \text{N}+\left(65.0 \text{kg}\right)
...
final configurations {:# import-auto-id1730340}
