...
its kinetic energy, or $$ {W}_{\text{net}}=\text{ΔKE} $$. The net work is the sum of the work by nonconservative forces plus the work by
...
energy, so that $$ {W}_{\text{c}}=-\text{Δ}\text{PE} $$. Substituting this equation into the previous one and solving for $$ {W}_
{\text{nc}} $$
gives
...
{\text{KE}}_{\text{i}}+{\text{PE}}_{\text{i}}+{W}_{\text{nc}}={\text{KE}}_
...
). Thus $$ {W}_{\text{nc}}=-\text{fd} $$. The equation simplifies to
...
to reach height $$ h $$
along the hill, with $$
h=d\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}5.00º $$. This is expressed by the equation
...
{f}=\text{mgh}=\text{mgd}\phantom{\rule{0.25em}{0ex}}\sin{\theta}
$$
...
<div data-type="equation" id="eip-652">
 $$ \frac{1}{2}{ {\text{mv}}_{i}}^{2}+0+\left(-\text{fd}\right)=0+\text{mgd}\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}\mathrm{\theta .} $$ 
</div>
Solve this for  $$ d $$ 
...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{\left(\frac{1}{2}\right){ {\text{mv}}_{\text{i}}}^{2}}{f+\text{mg}\phantom{\rule{0.25em}{0ex}}\sin{\theta} }\\ & =& \frac{\text{(0.5)}\left(\text{65.0 kg}\right)\left(\text{6.00 m/s}{\right)}^{2}}{\text{450 N}+\left(\text{65.0 kg}\right)\left({\text{9.80 m/s}}^{2}\right)\phantom{\rule{0.25em}{0ex}}{\text{sin (5.00º)}}^{}}\\ & =& \text{2.31 m.}\end{array} $$ 
</div>
**Discussion**
...
* {: #import-auto-id1455144} Work $$ {W}_{\text{nc}} $$
  ...
  equation form, $$ {W}_
  {\text{nc}}=\text{Δ}\text{KE}+\text{Δ}\text{PE} $$
