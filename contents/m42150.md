...
The work done by friction is again $$ W_{\text{nc}}=-f d  $$
...
<div data-type="equation" id="eip-652">
 $$ \frac{1}{2} m v_{i}^{2}+0+\left(-f d \right)=0+\text{mgd}\sin{\theta} .} $$ 
</div>
Solve this for  $$ d $$ 
...
cup, which moves horizontally. The work done by friction is $$ f d  $$. You will need the mass of the marble as well to calculate its initial kinetic
energy.
