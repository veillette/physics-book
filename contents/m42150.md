...
$$
is in the opposite direction of the motion (that is, $$ \theta =\text{180º} $$, and so $$ \cos\phantom{\rule{0.25em}{0ex}}\theta =-1 $$
...
{f}=\text{mgh}=\text{mgd}\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}\theta
$$
...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{\left(\frac{1}{2}\right){ {\text{mv}}_{\text{i}}}^{2}}{f+\text{mg}\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}\theta }\\ & =& \frac{\text{(0.5)}\left(\text{65.0 kg}\right)\left(\text{6.00 m/s}{\right)}^{2}}{\text{450 N}+\left(\text{65.0 kg}\right)\left({\text{9.80 m/s}}^{2}\right)\phantom{\rule{0.25em}{0ex}}{\text{sin (5.00º)}}^{}}\\ & =& \text{2.31 m.}\end{array} $$ 
</div>
**Discussion**
