...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{ { {\text{mv}}_{i}}^{2}}{2f}\\ & =& \frac{\left(\text{65.0 kg}\right)\left(6.00 \text{m/s}{\right)}^{2}}{\left(2\right)\left(450 \text{N}\right)}\\ & =& \text{2.60 m.}\end{array} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-652">
 $$ \frac{1}{2}{ {\text{mv}}_{i}}^{2}+0+\left(-\text{fd}\right)=0+\text{mgd}\sin\mathrm{\theta .} $$ 
</div>
Solve this for  $$ d $$ 
...
<div data-type="equation">
 $$ \begin{array}{lll}d& =& \frac{\left(\frac{1}{2}\right){ {\text{mv}}_{\text{i}}}^{2}}{f+\text{mg}\sin{\theta} }\\ & =& \frac{\text{(0.5)}\left(\text{65.0 kg}\right)\left(\text{6.00 m/s}{\right)}^{2}}{450 \text{N}+\left(\text{65.0 kg}\right)\left({\text{9.80 m/s}}^{2}\right){\text{sin (5.00º)}}}\\ & =& \text{2.31 m.}\end{array} $$ 
</div>
**Discussion**
...
potential energy $$ \text{mgh} $$, without combining and resolving force vectors. This simplifies the solution
considerably.
