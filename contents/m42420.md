...
The cross-sectional area in this example is  $$A={\mathrm{\pi r}}^{2}=\left(3\text{.}\text{14}\text{.}\text{.}\text{.}\right)\left(0\text{.0200 m}{\right)}^{2}= 1.26 \times 10^{-3}  {\text{m}}^{2} $$
,  $$N $$
...
<div data-type="equation" id="eip-334">
 $$\begin{array}{lll}L& =& \frac{\left(4\pi  \times 10^{-7}  \text{T}\cdot \text{m/A}\right)\left(\text{200}{\right)}^{2}\left( 1.26 \times 10^{-3}  {\text{m}}^{2}\right)}{0.100 m}\\ & =& 0\text{.}\text{632 mH}\text{.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-257">
 $$\begin{array}{lll}{E}_{\text{ind}}& =& \frac{1}{2}{\text{LI}}^{2}\\ & =& 0.5\left( 0.632 \times 10^{-3}  \text{H}\right)\left(\text{30.0 A}{\right)}^{2}=\text{0.284 J}\text{.}\end{array} $$
</div>
**Discussion**
