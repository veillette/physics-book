...
<div data-type="equation" id="eip-334">
 $$\begin{array}{lll}L& =& \frac{\left(4\pi ×{\text{10}}^{-7} \text{T}\cdot \text{m/A}\right)\left(\text{200}{\right)}^{2}\left( 1.26 \times 10^{-3}  {\text{m}}^{2}\right)}{0.100 m}\\ & =& 0\text{.}\text{632 mH}\text{.}\end{array} $$
</div>
**Discussion**
