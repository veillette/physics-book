...
, which is named a **henry**{: data-type="term" #import-auto-id1169738083318} (H), after Joseph Henry. That is, $1 H=1\phantom{\rule{0.25em}{0ex}}\Omega \cdot \text{s}$
...
The cross-sectional area in this example is $A={\mathrm{\pi r}}^{2}=\left(3\text{.}\text{14}\text{.}\text{.}\text{.}\right)\left(0\text{.0200 m}{\right)}^{2}=1\text{.}\text{26}×{\text{10}}^{-3}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}$

, $N$

 is given to be 200, and the length $\ell $

 is 0.100 m. We know the permeability of free space is ${\mu }_{0}=4\pi ×{\text{10}}^{\text{−7}}\phantom{\rule{0.25em}{0ex}}\text{T}\cdot \text{m/A}$
...
$\begin{array}{lll}L& =& \frac{\left(4\pi ×{\text{10}}^{-7}\phantom{\rule{0.25em}{0ex}}\text{T}\cdot \text{m/A}\right)\left(\text{200}{\right)}^{2}\left(1.26×{\text{10}}^{-3}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}\right)}{0.100 m}\\ & =& 0\text{.}\text{632 mH}\text{.}\end{array}$
</div>
**Discussion**
...
$\begin{array}{lll}{E}_{\text{ind}}& =& \frac{1}{2}{\text{LI}}^{2}\\ & =& 0.5\left(0.632×{\text{10}}^{-3}\phantom{\rule{0.25em}{0ex}}\text{H}\right)\left(\text{30.0 A}{\right)}^{2}=\text{0.284 J}\text{.}\end{array}$
</div>
**Discussion**
...
* {: #import-auto-id1169738244239} The self-inductance of a solenoid is
  ...
  is its length, and
  ${\text{μ}}_{0}=4\pi ×{\text{10}}^{\text{−7}}\phantom{\rule{0.25em}{0ex}}\text{T}\cdot \text{m/A}\phantom{\rule{0.10em}{0ex}}$
...
: the unit of inductance;
  $1\phantom{\rule{0.25em}{0ex}}\text{H}=1\phantom{\rule{0.25em}{0ex}}\Omega \cdot \text{s}$
