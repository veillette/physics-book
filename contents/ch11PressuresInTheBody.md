...
![The tonometer being used by an eye care professional to determine the fluid pressure inside the eye.](../resources/Figure_12_09_02a.jpg "The intraocular eye pressure can be read with a tonometer. (credit: DevelopAll at the Wikipedia Project.)")
{: #Figure2}
...
See [Forces and Torques in Muscles and Joints](/m42175).)
...
![When the piston is raised the liquid separates and results in negative pressure.](../resources/Figure_12_08_11a.jpg "(a) When the piston is raised, it stretches the liquid slightly, putting it under tension and creating a negative absolute pressure \( P= -F/A \).  (b) The liquid eventually separates, giving an experimental limit to negative pressure in this liquid.")
{: #Figure5}
