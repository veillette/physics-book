...
where  $$L $$
 ...
 the flow is entirely turbulent, even at the surface of the object. (See [\[link\]](#Figure1).) Laminar flow occurs mostly when the objects in the fluid are small, such as raindrops, pollen, and blood cells in plasma.
...
*  For
   $$N^{\prime}_{\text{R}} $$ less than about one, flow is laminar.
* {: #eip-869} For
   $$N^{\prime}_{\text{R}} $$ greater than
