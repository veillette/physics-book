...
<div data-type="equation" id="import-auto-id694467">
 $$\begin{array}{lll}N^{\prime}_{R}^{}& =& \frac{\rho \text{vL}}{\eta }=\frac{\left(1.29 {\text{kg/m}}^{3}\right)\left(40.0 \text{m/s}\right)\left(0.0740 \text{m}\right)}{ 1.81 \times 10^{-5}  1.00 Pa\cdot \text{s}}\\ & =&  2.11 \times 10^{5} \text{.}\end{array} $$
</div>
**Discussion**
