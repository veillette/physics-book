...
where  $$L $$
 ...
 the fluid density,  $$\eta  $$  its viscosity, and  $$v $$
 ...
 greater than about  $$10^{6} $$ ,
 the flow is entirely turbulent, even at the surface of the object. (See [[Figure 1]](#Figure1).) Laminar flow occurs mostly when the objects in the fluid are small, such as raindrops, pollen, and blood cells in plasma.
...
We can use  $$N^{\prime}_{\text{R}}=\frac{\rho vL}{\eta } $$
...
One of the consequences of viscosity is a resistance force called **viscous drag**  $${F}_{\text{V}} $$
