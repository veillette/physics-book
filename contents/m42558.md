...
To solve part (a), note that the energy of a photon is given by  $$E=\text{hf} $$
. For part (b), once the energy of the photon is calculated, it is a straightforward application of  $${\text{KE}}_{e}=\text{hf}\text{–BE} $$
...
<div data-type="equation" id="eip-861">
 $$E=\frac{\left(6\text{.}\text{63}×{\text{10}}^{\text{–34}} \text{J}\cdot \text{s}\right)\left(3.00×{\text{10}}^{8} \text{m/s}\right)}{\text{420}×{\text{10}}^{\text{–9}} \text{m}}=\text{4.74}×{\text{10}}^{\text{–19}} \text{J}. $$
</div>
Converting to eV, the energy of the photon is

<div data-type="equation" id="eip-432">
 $$E=\left(4\text{.}\text{74}×{\text{10}}^{\text{–19}} \text{J}\right)\frac{1 eV}{1.6×{\text{10}}^{\text{–19}} J}=\text{2.96 eV}. $$
</div>
**Solution for (b)**

Finding the kinetic energy of the ejected electron is now a simple application of the equation  $${\text{KE}}_{e}=\text{hf}\text{–BE} $$
. Substituting the photon energy and binding energy yields

<div data-type="equation" id="eip-428">
 $${\text{KE}}_{e}=\text{hf}\text{– BE}=\text{2}\text{.}\text{96 eV – 2}\text{.}\text{71 eV}=\text{0}\text{.}\text{246 eV}. $$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the number of photoelectrons per second ejected from a 1.00-mm <sup>2</sup> area of sodium metal by 500-nm EM radiation having an intensity of  $$1\text{.}{\text{30 kW/m}}^{2} $$
...
Red light having a wavelength of 700 nm is projected onto magnesium metal to which electrons are bound by 3.68 eV. (a) Use  $${\text{KE}}_{e}=\text{hf}–\text{BE} $$
