...
<div data-type="equation" id="eip-861">
 $$E=\frac{\left(6\text{.}\text{63}×{\text{10}}^{\text{–34}} \text{J}\cdot \text{s}\right)\left( 3.00 \times 10^{8}  \text{m/s}\right)}{\text{420}×{\text{10}}^{\text{–9}} \text{m}}=\text{4.74}×{\text{10}}^{\text{–19}} \text{J}. $$
</div>
