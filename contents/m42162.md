...
in the same direction when the lead car (labeled $$ {m}_{2}\right) $$
...
$$ \Delta t $$
is the same for both cars. We know from Newton’s third law that $$ {F}_
{2}=–{F}_{1} $$, and so
...
kg and a velocity of $$ -0\text{.}\text{120 m/s} $$. (The minus indicates direction of motion.) What is their final velocity?
