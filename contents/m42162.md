...
{2}=\phantom{\rule{0.25em}{0ex}}–{F}_{1} \\)
...
{\text{net}}=\frac{ {\Delta \mathbf{p}}_{\text{tot}}}{\Delta t} \\)
...
# import-auto-id1667063} make up protons (one type of particle that makes up nuclei) scattered high-energy electrons off
...
kg and a velocity of \\( -0\text{.}\text{120 m/s} \\)
