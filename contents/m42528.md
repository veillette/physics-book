...
As with many fundamental statements, there is more to this postulate than meets the eye. The laws of physics include only those that satisfy this postulate. We shall find that the definitions of relativistic momentum and energy must be altered to fit. Another outcome of this postulate is the famous equation $$E={\mathrm{mc}}^{2}$$
.
...
The speed of light is a constant $$c=3.00×{\text{10}}^{8}\phantom{\rule{0.25em}{0ex}}\text{m/s}$$
