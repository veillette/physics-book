...
{\mathbf{F}}_{\text{app}} $$ and the horizontal friction force $$ \mathbf{f} $$.
...
The effect of the net force $$ {\mathbf{F}}_{\text{net}} $$ is to accelerate the
...
<div data-type="equation">
 $$ W{}_{\text{net}}\text{}=\frac{1}{2}m v^{2}-\frac{1}{2}{mv }_{0}^{ 2}. $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}W_{\text{app}}& =& F_{\text{app}}d\cos\left(0^\circ \right)=F_{\text{app}}d\\ & =& \left(120 \text{N}\right)\left(0.800 \text{m}\right)\\ & =& 96.0 \text{J}
\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}W_{\text{fr}}& =& F_{\text{fr}}d\cos\left(180^\circ\right)=-F_{\text{fr}}d\\ & =& -\left(5.00 \text{N}\right)\left(0.800 \text{m}\right)\\ & =& -4.00 \text{ J.}
\end{array} $$ 
</div>
...
due to the pushing. Thus $$ W_{\text{fr}}=-95.75 \text{J} $$. Furthermore, $$ W_
{\text{fr}}=fd^{\prime} \cos{\theta} \text{= –}fd^{\prime} $$, where $$
...
carrier in [[link]](/contents/m42151#import-auto-id2866785). 
