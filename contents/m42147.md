...
<div data-type="equation">
 $$ \begin{array}{lll}{W}_{\text{app}}& =& {F}_{\text{app}}d\cos\left(0º\right)={F}_{\text{app}}d\\ & =& \left(\text{120 N}\right)\left(\text{0.800 m}\right)\\ & =& \text{96.0 J}\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}{W}_{\text{fr}}& =& {F}_{\text{fr}}d\cos\left(\text{180º}\right)=-{F}_{\text{fr}}d\\ & =& -\left(\text{5.00 N}\right)\left(\text{0.800 m}\right)\\ & =& -\text{4.00 J.}\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ d\prime =-\frac{ W_{\text{fr}}}{f}=-\frac{-\text{95.75 J}}{\text{5.00 N}}, $$ 
</div>
and so
