...
(b) Solve the same problem as in
...
<div data-type="equation">
 $$ \begin{array}{lll}
W_{\text{net}}& =& F_{\text{net}}d=\left(115 \text{N}\right)\left(0.800 \text{m}\right)\\ & =&
...
<div data-type="equation">
 $$ \begin{array}{lll}
W_{\text{app}}& =& F_{\text{app}}d\cos\left(0^\circ \right)=F_{\text{app}}d\\ & =& \left(120 \text{N}\right)\left(0.800 \text{m}\right)\\ & =& 96.0 \text{J}
\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}
W_{\text{fr}}& =& F_{\text{fr}}d\cos\left(180^\circ\right)=-F_{\text{fr}}d\\ & =& -\left(5.00 \text{N}\right)\left(0.800 \text{m}\right)\\ & =& -4.00 \text{ J.}
\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}
W_{\text{gr}}& =& 0,\\ W_{N}& =& 0,\\ W_{\text{app}}& =& 96.0 \text{ J,}\\ W_{\text{fr}}& =&
-4.00 \text{ J.}
\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}
v& =& \sqrt{\frac{2\text{(95.75 J)}}{m}}=\sqrt{\frac{191.5 \text{kg}\cdot {m}^{2}{\text{/s}}^{2}}{30.0 \text{kg}}}\\ & =& 
2.53 \text{ m/s} .
\end{array} $$ 
</div>
