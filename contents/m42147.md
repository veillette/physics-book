...
{\mathbf{F}}_{\text{net}} $$. In equation form, this is $$ {W}_{\text{net}}={F}_
{\text{net}}d\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta
$$
where $$ \theta $$
...
$$ F\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta
$$
vs. $$ d $$
graph. In this case, $$
F\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta $$
is constant. You can see that the area under the graph is $$
Fd\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta $$, or the work done. [\[link\]](#import-auto-id1046634)(b) shows a more general
...
F\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta
{\right)}_
{i\left(\text{ave}\right)}{d}_{i} $$
for each strip, and the total work done is the sum of the $$ {W}_{i} $$. Thus the total work done is the total area under the curve, a useful property
...
\theta =0º $$
and $$ \phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta
...
is to accelerate the package from $$ {v}_{0} $$
...
algebra, we can reach an interesting conclusion. Substituting $$ {F}_
{\text{net}}=\text{ma} $$
...
; namely, $$ {v}^{2}={ {v}_{0}}^{2}+2\text{ad} $$
(note that $$ a $$
appears in the expression for the net work). Solving for acceleration gives $$
a=\frac{ {v}^{2}-{ {v}_{0}}^{2}}{2d} $$. When $$ a $$
is substituted into the preceding expression for $$ {W}_{\text{net}} $$, we obtain
...
<div data-type="equation">
 $$ W{}_{\text{net}}\text{}=\frac{1}{2}{\text{mv}}^{2}-\frac{1}{2}{\text{mv}}_{0}^{ 2}\text{.} $$ 
</div>
...
\frac{1}{2}{\text{mv}}^{2} $$. This quantity is our first example of a form of energy.
...
<div data-type="equation">
 $$ {W}_{\text{net}}=\frac{1}{2}{\text{mv}}^{2}-\frac{1}{2}{\text{mv}}_{0}^{ 2} $$ 
</div>
</div>

The quantity $$ \frac{1}{2}{\text{mv}}^{2} $$
...
The net force is the push force minus friction, or $$ {F}_{\text{net}}\text{=
120 N – 5}\text{.}\text{00 N = 115 N} $$. Thus the net work is
...
<div data-type="equation">
 $$ \begin{array}{lll}{W}_{\text{app}}& =& {F}_{\text{app}}d\phantom{\rule{0.25em}{0ex}}\cos\left(0º\right)={F}_{\text{app}}d\\ & =& \left(\text{120 N}\right)\left(\text{0.800 m}\right)\\ & =& \text{96.0 J}\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}{W}_{\text{fr}}& =& {F}_{\text{fr}}d\phantom{\rule{0.25em}{0ex}}\cos\left(\text{180º}\right)=-{F}_{\text{fr}}d\\ & =& -\left(\text{5.00 N}\right)\left(\text{0.800 m}\right)\\ & =& -\text{4.00 J.}\end{array} $$ 
</div>
...
The calculated total work $$ {W}_{\text{total}} $$
as the sum of the work by each force agrees, as expected, with the work $$ {W}_
{\text{net}} $$
...
net work, $$ {W}_{\text{net}} $$, and the initial kinetic energy, $$ \frac{1}{2}{m{v}_{0}}^{2} $$. These calculations allow us to find the final kinetic energy, $$
\frac{1}{2}{\text{mv}}^{2} $$, and thus the final speed $$ v $$.
...
displacement, so $$ \theta =\text{180º} $$. To reduce the kinetic energy of the package to zero, the work $$ {W}_
{\text{fr}} $$
by friction must be minus the kinetic energy that the package started with plus
what the package accumulated due to the pushing. Thus $$ {W}_
{\text{fr}}=-\text{95}\text{.}\text{75 J} $$. Furthermore, $$ {W}_{\text{fr}}=fd\prime
\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta
\phantom{\rule{0.25em}{0ex}}\text{= –}fd\prime $$, where $$ d\prime $$
is the distance it takes to stop. Thus,

<div data-type="equation">
 $$ d\prime =-\frac{ {W}_{\text{fr}}}{f}=-\frac{-\text{95.75 J}}{\text{5.00 N}}, $$ 
</div>
and so

<div data-type="equation">
 $$ d\prime =\text{19}\text{.2 m}. $$ 
</div>
**Discussion**
...
* The translational kinetic energy of an object of mass $$ m $$
  moving at speed $$ v $$
  is $$ \text{KE}=\frac{1}{2}{\text{mv}}^{2} $$
  .
* The work-energy theorem states that the net work $$ {W}_{\text{net}} $$
  on a system changes its kinetic energy, $$ {W}_
  {\text{net}}=\frac{1}{2}{\text{mv}}^{2}-\frac{1}{2}{m{v}_{0}}^{2} $$
  .
...
<div data-type="solution" markdown="1">
 $$ 1\text{.}1×{\text{10}}^{\text{10}}\phantom{\rule{0.20em}{0ex}}\text{J} $$ 
