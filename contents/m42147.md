...
<div data-type="equation">
 $$ {W}_{\text{net}}=m\left(\frac{ v^{2}-{ v_{0}}^{2}}{2d}\right)d. $$ 
</div>
...
<div data-type="equation">
 $$ \text{KE}=0.5\left(\text{30.0 kg}\right)\left(\text{0.500 m/s}{\right)}^{2}, $$ 
</div>
which yields
...
<div data-type="equation">
 $$ \begin{array}{lll}{W}_{\text{net}}& =& {F}_{\text{net}}d=\left(115 \text{N}\right)\left(\text{0.800 m}\right)\\ & =& 92.0 \text{N}\cdot m=\text{92.0 J.}\end{array} $$ 
</div>
**Discussion for (a)**
...
<div data-type="equation">
 $$ \begin{array}{lll}{W}_{\text{app}}& =& {F}_{\text{app}}d\cos\left(0º\right)={F}_{\text{app}}d\\ & =& \left(120 \text{N}\right)\left(\text{0.800 m}\right)\\ & =& 96.0 \text{J}\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}{W}_{\text{fr}}& =& {F}_{\text{fr}}d\cos\left(\text{180º}\right)=-{F}_{\text{fr}}d\\ & =& -\left(5.00 \text{N}\right)\left(\text{0.800 m}\right)\\ & =& -\text{4.00 J.}\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ {W}_{\text{total}}={W}_{\text{gr}}+{W}_{N}+{W}_{\text{app}}+{W}_{\text{fr}}=92.0 \text{J}. $$ 
</div>
**Discussion for (b)**
...
<div data-type="equation">
 $$ \frac{1}{2}{\text{mv}}^{2}={W}_{\text{net}}+\frac{1}{2}{m{v}_{0}}^{2}\text{.} $$ 
</div>
Thus,

<div data-type="equation">
 $$ \frac{1}{2}{\text{mv}}^{2}=92.0 J+3.75 \text{J}=95.\text{75 J.} $$ 
</div>
...
{\text{fr}}=-95.75 \text{J} $$. Furthermore, $$ {W}_{\text{fr}}=fd\prime
\cos{\theta}
