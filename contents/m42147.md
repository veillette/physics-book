...
{\mathbf{F}}_{\text{net}} $$. In equation form, this is $$ W_{\text{net}}=F_{\text{net}}d\cos{\theta}
$$
where $$ \theta $$
...
F\cos{\theta}
{\right)}_{i\left(\text{ave}\right)}d_{i} $$
...
<div data-type="equation" id="eip-261">
 $$ \text{KE}=3.75 \text{kg}\cdot {m}^{2}{\text{/s}}^{2}=3.75 \text{ J.} $$ 
</div>
**Discussion**
...
<div data-type="equation">
 $$ \begin{array}{lll}W_{\text{net}}& =& F_{\text{net}}d=\left(115 \text{N}\right)\left(0.800 \text{m}\right)\\ & =&
92.0 \text{N}\cdot m=92.0 \text{ J.}\end{array} $$ 
</div>
**Discussion for (a)**
...
<div data-type="equation">
 $$ \begin{array}{lll}W_{\text{app}}& =& F_{\text{app}}d\cos\left(0^\circ \right)=F_{\text{app}}d\\ & =& \left(120 \text{N}\right)\left(0.800 \text{m}\right)\\ & =& 96.0 \text{J}\end{array} $$ 
</div>
...
<div data-type="equation">
 $$ \begin{array}{lll}W_{\text{fr}}& =& F_{\text{fr}}d\cos\left(180^\circ\right)=-F_{\text{fr}}d\\ & =& -\left(5.00 \text{N}\right)\left(0.800 \text{m}\right)\\ & =& -4.00 \text{ J.}\end{array} $$ 
</div>
So the amounts of work done by gravity, by the normal force, by the applied force, and by friction are, respectively,

<div data-type="equation">
 $$ \begin{array}{lll}W_{\text{gr}}& =& 0,\\ W_{N}& =& 0,\\ W_{\text{app}}& =& 96.0 \text{ J,}\\ W_{\text{fr}}& =&
-4.00 \text{ J.}\end{array} $$ 
</div>
...
as the sum of the work by each force agrees, as expected, with the work $$ W_{\text{net}} $$
...
<div data-type="equation">
 $$ \begin{array}{lll}v& =& \sqrt{\frac{2\text{(95.75 J)}}{m}}=\sqrt{\frac{191.5 \text{kg}\cdot {m}^{2}{\text{/s}}^{2}}{30.0 \text{kg}}}\\ & =& 
2.53 \text{ m/s.}\end{array} $$ 
</div>
**Discussion**
...
displacement, so $$ \theta =180^\circ $$. To reduce the kinetic energy of the package to zero, the work $$ W_{\text{fr}} $$
by friction must be minus the kinetic energy that the package started with plus
what the package accumulated due to the pushing. Thus $$ W_{\text{fr}}=-95.75 \text{J} $$. Furthermore, $$ W_{\text{fr}}=fd^{\prime}
\cos{\theta}
...
* The work-energy theorem states that the net work $$ W_{\text{net}} $$
  on a system changes its kinetic energy, $$ W_  {\text{net}}=\frac{1}{2}m v^{2}-\frac{1}{2}{mv_{0}}^{2} $$
  .
