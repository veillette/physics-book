...
{\text{net}}d\phantom{\rule{0.25em}{0ex}}\cos{\theta}
$$
where $$ \theta $$
...
$$ F\phantom{\rule{0.25em}{0ex}}\cos{\theta}
$$
vs. $$ d $$
graph. In this case, $$
F\phantom{\rule{0.25em}{0ex}}\cos{\theta} $$
is constant. You can see that the area under the graph is $$
Fd\phantom{\rule{0.25em}{0ex}}\cos{\theta} $$, or the work done. [\[link\]](#import-auto-id1046634)(b) shows a more general
...
\theta =0º $$
and $$ \phantom{\rule{0.25em}{0ex}}\cos{\theta}
