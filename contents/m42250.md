...
*. The definition of intensity is valid for any energy in transit, including that carried by waves. The SI unit for intensity is watts per square meter ($$ {\text{W/m}}^{2}$$
). For example, infrared and visible energy from the Sun impinge on Earth at an intensity of $$\text{1300} {\text{W/m}}^{2}$$
 just above the atmosphere. There are other intensity-related units in use, too. The most common is the decibel. For example, a 90 decibel sound level corresponds to an intensity of $${\text{10}}^{-3} {\text{W/m}}^{2}$$
...
(a) Calculate the amount of energy that falls on a solar collector having an area of $$0\text{.}\text{500} {\text{m}}^{2}$$
 in $$4\text{.}\text{00} \text{h}$$
.
...
4.  Calculate to find
    ...
    $$I\prime =\text{1.40}×{\text{10}}^{5} {\text{W/m}}^{2}.$$
    </div>
{: type="1"}
...
If two identical waves, each having an intensity of $$1\text{.}\text{00} {\text{W/m}}^{2}$$
...
5.  Calculate to find
    ...
    $$I\prime =4I=4\text{.}\text{00} {\text{W/m}}^{2}.$$
    </div>
{: type="1"}

**Discussion**

The intensity goes up by a factor of 4 when the amplitude doubles. This answer is a little disquieting. The two individual waves each have intensities of $$1\text{.}\text{00} {\text{W/m}}^{2}$$
, yet their sum has an intensity of $$4\text{.}\text{00} {\text{W/m}}^{2}$$
, which may appear to violate conservation of energy. This violation, of course, cannot happen. What does happen is intriguing. The area over which the intensity is $$4\text{.}\text{00} {\text{W/m}}^{2}$$
 ...
 each, there will be places in the room where the intensity is $$4\text{.}\text{00} {\text{W/m}}^{2}$$
...
Ultrasound of intensity $$1\text{.}\text{50}×{\text{10}}^{2} {\text{W/m}}^{2}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The low-frequency speaker of a stereo set has a surface area of $$0\text{.}\text{05} {\text{m}}^{2}$$
 and produces 1W of acoustical power. What is the intensity at the speaker? If the speaker projects sound uniformly in all directions, at what distance from the speaker is the intensity $$0\text{.}1 {\text{W/m}}^{2}$$
?
...
Energy from the Sun arrives at the top of the Earth’s atmosphere with an intensity of $$1.30 {\text{kW/m}}^{2}.$$
 How long does it take for $$1.8×{10}^{9} \text{J}$$
 to arrive on an area of $$1\text{.}00 {\text{m}}^{2}$$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A microphone receiving a pure sound tone feeds an oscilloscope, producing a wave on its screen. If the sound intensity is originally $$\text{2.00}×{\text{10}}^{\text{–5}} {\text{W/m}}^{2},$$
 but is turned up until the amplitude increases by 30.0%, what is the new intensity?

</div>
<div data-type="solution" markdown="1">
$$\text{3.38}×{\text{10}}^{\text{–5}} {\text{W/m}}^{2}$$
</div>
</div>
...
(a) What is the intensity in $${\text{W/m}}^{2}$$
 of a laser beam used to burn away cancerous tissue that, when 90.0% absorbed, puts 500 J of energy into a circular spot 2.00 mm in diameter in 4.00 s? (b) Discuss how this intensity compares to the average intensity of sunlight (about $$700 {\text{W/m}}^{2}$$
