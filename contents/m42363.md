...
<div data-type="equation" id="eip-853">
 $$\begin{array}{lll}V\text{′′}& =& 0.368V^{\prime}=\left(0.368\right)\left( 1.354 \times 10^{3}  \text{V}\right)\\ & =& 498 \text{V at} t=24.0\text{ ms.}\end{array} $$
</div>
**Discussion**
