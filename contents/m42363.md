...
<div data-type="equation" id="eip-506">
 $$t=\frac{x}{v}=\frac{8.0×{10}^{–2} \text{m}}{5.0×{10}^{2} \text{m/s}}= 1.6 \times 10^{-4}  \text{s.} $$
</div>
...
<div data-type="equation" id="eip-17">
 $$C=\frac{t}{R}=\frac{ 1.6 \times 10^{-4}  s}{\text{10.0 Ω}}=\text{16} \text{μF.} $$
</div>
(Note: Capacitance  $$C $$
...
<div data-type="equation" id="eip-853">
 $$\begin{array}{lll}V\text{′′}& =& \text{0.368}V\prime =\left(\text{0.368}\right)\left( 1.354 \times 10^{3}  \text{V}\right)\\ & =& \text{498 V at} t=\text{24}\text{.0 ms.}\end{array} $$
</div>
**Discussion**
