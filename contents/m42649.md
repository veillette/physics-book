...
Note that [\[link\]](#eip-909) lists many diagnostic uses for  $${}^{99 \text{m}}\text{Tc} $$ ,
...
*  [\[link\]](#eip-909) lists certain diagnostic uses of radiopharmaceuticals including the isotope and activity typically used in diagnostics.
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
[[link]](#eip-909) indicates that 7.50 mCi of  $${}^{99 \text{m}}\text{Tc} $$
...
The activities of  $${}^{131}\text{I} $$
 and  $${}^{123}\text{I} $$
 used in thyroid scans are given in [[link]](#eip-909) to be 50 and  $$70 \text{μ}Ci $$ ,
...
(a) Neutron activation of sodium, which is 100% $${}^{23}\text{Na} $$ ,
 produces  $${}^{24}\text{Na} $$ ,
 which is used in some heart scans, as seen in [[link]](#eip-909). The equation for the reaction is  $${}^{23}\text{Na}+n\to {}^{24}\text{Na}+\gamma  $$ .
