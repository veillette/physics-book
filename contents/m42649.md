...
. What is the energy output of the reaction  $${}^{98}\text{Mo}+n\to {}^{99}\text{Mo}+\gamma  $$
 ? The mass of  $${}^{98}\text{Mo} $$
 is given in [Appendix A: Atomic Masses](/m42699), and that of  $${}^{99}\text{Mo} $$
 is 98.907711 u.
...
The purpose of producing  $${}^{99}\text{Mo} $$
 (usually by neutron activation of natural molybdenum, as in the preceding problem) is to produce  $${}^{99 \text{m}}\text{Tc.} $$
