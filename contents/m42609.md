...
which creates a magnetic field of its own, $${\mathbf{B}}_{\text{orb}} $$ as
seen in [[Figure 2]](#Figure2). Note that the **orbital magnetic field**
$${\mathbf{B}}_{\text{orb}} $$ and the **orbital angular momentum**
$${\mathbf{L}}_{\text{orb}} $$ are along the same line. The external magnetic
...
an <strong class="term" id="import-auto-id2404185">intrinsic magnetic
field </strong> ** $${\mathbf{\text{B}}}_{\text{int}} $$ , which interacts with
their orbital magnetic field $${\mathbf{\text{B}}}_{\text{orb}} $$ .
