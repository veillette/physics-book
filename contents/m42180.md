...
<div data-type="equation" id="eip-877">
 $$ \alpha =\frac{64.0 \N \cdot \m }{4.352 \kg \cdot  \mm}=14.7\frac{ \text{rad}}{ {\s  }^{2}}. $$ 
</div>
...
<div data-type="equation" id="eip-116">
 $$ \omega ={\left(2 \alpha \theta\right)}^{1/2}={\left[2\left(14.7\frac{ \text{rad}}{ {\s  }^{2}}\right)\left(1.00 \text{rad}\right)\right]}^{1/2}=5.42\frac{ \text{rad}}{\s  }. $$ 
</div>
...
Conservation of energy includes rotational motion, because rotational kinetic energy is another form of  $$ \KE $$ . [Uniform Circular Motion and Gravitation](/contents/m42140) has a detailed
...
<div data-type="equation" id="eip-191">
 $$ v={\left[\frac{4\left(9.80\mss \right)\left(2.00 \m \right)}{3}\right]}^{1/2}=5.11  \ms  . $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In softball, the pitcher throws with the arm fully extended (straight at the elbow). In a fast pitch the ball leaves the hand with a speed of 139 km/h. (a) Find the rotational kinetic energy of the pitcher’s arm given its moment of inertia is  $$ 0.720 \kg \cdot  \mm $$ 
