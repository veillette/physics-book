...
<div data-type="equation" id="eip-348">
 $$ \begin{array}{lll}
\text{net}W& =& rF\theta =\left(0.320 \text{m}\right)\left(200 \text{N}\right)\left(1.00 \text{rad}\right)\\
 & =& 64.0 \text{N}\cdot \text{m} .
\end{array} $$ 
</div>
...
4.  {: #import-auto-id2937257} *For closed systems, mechanical energy is conserved*. That is,
    ...
    Note that $$ \text{KE}_{\text{i}} $$ and $$ \text{KE}_{\text{f}} $$ may each include translational and rotational contributions.
...
<div data-type="equation" id="eip-913">
 $$ \begin{array}{lll}
\text{KE}_{\text{rot}}& =& 0.5\left(1067 \text{kg}\cdot \text{m}^{2}\right){\left(31.4 \text{rad/s}\right)}^{2}\\
 & =& 5.26\times 10^{5}\text{J}
\end{array} $$ 
</div>
...
the forearm is  $$ 0.500 \text{kg}\cdot \text{m}^{2} $$, what is the rotational kinetic energy of the forearm?
...
$$ 0.900 \text{kg}\cdot \text{m}^{2} $$, the muscle force is 1500 N, and its effective perpendicular lever arm is 3.00
cm.
