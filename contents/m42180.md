...
<div data-type="equation" id="eip-789">
 $$ \text{net}W=\frac{1}{2}I\omega^{2}-\frac{1}{2}I{ {\omega }_{0}}^{2}. $$ 
</div>
...
motion, we define the term $$ \left(\frac{1}{2}\right)I\omega ^{2}
$$
...
<div data-type="equation" id="eip-348">
 $$ \begin{array}{lll}\text{net}W& =& \text{rF}\theta =\left(0.320 \text{m}\right)\left(200 \text{N}\right)\left(1.00 \text{rad}\right)\\ & =& 64.0 \text{N}\cdot \text{m.}\end{array} $$ 
</div>
Noting that  $$ 1 N·\text{m}=1 \text{J} $$ 
...
<div data-type="equation" id="eip-643">
 $$ \text{net τ}=\text{rF}=\left(0.320 \text{m}\right)\left(200 \text{N}\right)=64.0 \text{N}\cdot \text{m}. $$ 
</div>
...
<div data-type="equation" id="eip-119">
 $$ I=\frac{1}{2}{\text{MR}}^{2}=0.5\left(85.0 \text{kg}\right){\left(0.320 \text{m}\right)}^{2}=4.352 \text{kg}\cdot \text{m}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-877">
 $$ \alpha =\frac{64.0 \text{N}\cdot \text{m}}{4.352 \text{kg}\cdot \text{m}^{2}}=14.7\frac{\text{rad}}{ {\text{s}}^{2}}. $$ 
</div>
...
<div data-type="equation" id="eip-116">
 $$ \omega ={\left(2\text{αθ}\right)}^{1/2}={\left[2\left(14.7\frac{\text{rad}}{ {\text{s}}^{2}}\right)\left(1.00 \text{rad}\right)\right]}^{1/2}=5.42\frac{\text{rad}}{\text{s}}. $$ 
</div>
**Solution for (c)**
...
<div data-type="equation" id="eip-256">
 $$ {\text{KE}}_{\text{rot}}=\left(0.5\right)\left(4.352 \text{kg}\cdot \text{m}^{2}\right){\left(5.42 \text{rad/s}\right)}^{2}=64.0 \text{J}. $$ 
</div>
**Discussion**
...
We must convert the angular velocity to radians per second and calculate the moment of inertia before we can find  $$ {\text{KE}}_{\text{rot}} $$ . The angular velocity $$ \omega $$
is

<div data-type="equation" id="eip-583">
 $$ \omega =\frac{300 \text{rev}}{1.00 \text{min}}\cdot \frac{\text{2π rad}}{1 \text{rev}}\cdot \frac{1.00 \text{min}}{60.0 \text{s}}=31.4\frac{\text{rad}}{\text{s}}. $$ 
</div>
...
<div data-type="equation" id="eip-897">
 $$ I=4\frac{ M\ell^{2}}{3}=4×\frac{\left(50.0 \text{kg}\right){\left(4.00 \text{m}\right)}^{2}}{3}=1067 \text{kg}\cdot \text{m}^{2}. $$ 
</div>
Entering  $$ \omega  $$ 
...
<div data-type="equation" id="eip-913">
 $$ \begin{array}{lll}{\text{KE}}_{\text{rot}}& =& 0.5\left(1067 \text{kg}\cdot \text{m}^{2}\right){\left(31.4 \text{rad/s}\right)}^{2}\\ & =& 5.26\times 10^{5}\text{J}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-2">
 $$ {\text{KE}}_{\text{trans}}=\frac{1}{2}{\mathit{mv}}^{2}=\left(0.5\right)\left(1000 \text{kg}\right){\left(20.0 \text{m/s}\right)}^{2}=2.00\times 10^{5}\text{J}. $$ 
</div>
...
<div data-type="equation" id="eip-232">
 $$ h=\frac{ {\frac{1}{2}\mathrm{I\omega }}^{2}}{mg }=\frac{5.26\times 10^{5}\text{J}}{\left(1000 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)}=53.7 \text{m}. $$ 
</div>
**Discussion**
...
Conservation of energy includes rotational motion, because rotational kinetic energy is another form of  $$ \text{KE} $$ . [Uniform Circular Motion and Gravitation](/contents/m42140) has a detailed
...
<div data-type="equation" id="eip-454">
 $$ mgh =\frac{1}{2}{\mathit{mv}}^{2}+\frac{1}{2}I\omega^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-97">
 $$ mgh =\frac{1}{2}{\mathit{mv}}^{2}+\frac{1}{2}\left(\frac{1}{2}{\mathit{mR}}^{2}\right)\left(\frac{ v^{2}}{ R^{2}}\right). $$ 
</div>
...
<div data-type="equation" id="eip-191">
 $$ v={\left[\frac{4\left(9.80\text{m/s}^{2}\right)\left(2.00 \text{m}\right)}{3}\right]}^{1/2}=5.11 \text{m/s}. $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
While punting a football, a kicker rotates his leg about the hip joint. The moment of inertia of the leg is  $$ 3.75 \text{kg}\cdot \text{m}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
While exercising in a fitness center, a man lies face down on a bench and lifts a weight with one lower leg by contacting the muscles in the back of the upper leg. (a) Find the angular acceleration produced given the mass lifted is 10.0 kg at a distance of 28.0 cm from the knee joint, the moment of inertia of the lower leg is  $$ 0.900 \text{kg}\cdot \text{m}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
To develop muscle tone, a woman lifts a 2.00-kg weight held in her hand. She uses her biceps muscle to flex the lower arm through an angle of  $$ \text{60.0º} $$ . (a) What is the angular acceleration if the weight is 24.0 cm from the elbow
joint, her forearm has a moment of inertia of $$ 0.250 \text{kg}\cdot
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In softball, the pitcher throws with the arm fully extended (straight at the elbow). In a fast pitch the ball leaves the hand with a speed of 139 km/h. (a) Find the rotational kinetic energy of the pitcher’s arm given its moment of inertia is  $$ 0.720 \text{kg}\cdot \text{m}^{2} $$ 
