...
<div data-type="equation" id="eip-833">
 $$\begin{array}{lll}V& =& \text{emf}-\text{Ir}=12.0 \text{V}-\left(1.188 \text{A}\right)\left(0.100 \text{Ω}\right)\\ & =& 11.9 \text{V.}\end{array} $$
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-756">
 $$\begin{array}{lll}V& =& \text{emf}-\text{Ir}=12.0 \text{V}-\left(20.0 \text{A}\right)\left(0.100 \text{Ω}\right)\\ & =& \text{10}\text{.}0 \text{V.}\end{array} $$
</div>
**Discussion for (b)**
...
<div data-type="equation" id="eip-121">
 $$\begin{array}{lll}V& =& \text{emf}-\text{Ir}=12.0 \text{V}-\left(12.0 \text{A}\right)\left(0.500 \text{Ω}\right)\\ & =& 6.00 \text{V,}\end{array} $$
</div>
...
(d)  $$ 0.1000 \Omega ; \text{80}\text{.}0 \text{A, 4}\text{.}0 \text{V, 320 W} $$
</div>
</div>
