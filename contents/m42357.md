...
<div data-type="equation" id="eip-96">
 $${P}_{\text{load}}={I}^{2}{R}_{\text{load}}={\left(20.0 \text{A}\right)}^{2}\left(0\text{.500 Ω}\right)=2.00 \times 10^{2}  \text{W}. $$
</div>
**Discussion for (c)**
...
<div data-type="equation" id="eip-882">
 $${P}_{\text{load}}={I}^{2}{R}_{\text{load}}={\left(\text{12.0 A}\right)}^{2}\left( 0.500 \Omega \right)= 72.0 \text{W}. $$
</div>
**Discussion for (d)**
...
(d)  $$ 0.1000 \Omega ; \text{80}\text{.}\text{0 A, 4}\text{.}\text{0 V, 320 W} $$
</div>
</div>
...
) will its temperature increase if its mass is 20.0 kg and it has a specific heat of  $$ 0.300 \text{kcal/kg}\cdot \text{º}\text{C} $$
