...
As we have discussed in [Electric Charge and Electric Field](/ch18ElectricChargeAndElectricField), charge on
a metal sphere spreads out uniformly and produces a field like that of a point
charge located at its center. Thus we can find the voltage using the equation
$$V=kQ/r $$.
...
in [Electric Potential Energy: Potential Difference](/ch19ElectricPotentialEnergy), this is analogous
to taking sea level as $$h=0 $$ when considering gravitational potential energy,
$${\text{PE}}_{g}= mgh $$.
