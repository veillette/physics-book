...
<div data-type="equation" id="eip-159">
 $$ \frac{2 \text{m}}{\text{1 person}}×\frac{\text{2 person}}{\text{1 story}}×\text{39 stories = 156 m}\text{.} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-446">
 $$ \begin{array}{}\text{Area}={\text{5 000 yd}}^{2}×\frac{3\text{ft}}{\text{1 yd}}×\frac{3\text{ft}}{\text{1 yd}}×\frac{12}\text{in}\text{.}}{\text{1 ft}}×\frac{12}\text{in}\text{.}}{\text{1 ft}}=6,480},000}\text{in}{\text{.}}^{2},\\ \text{Area}\approx 6\times 10^{6}\text{in}{\text{.}}^{2}\text{.}\end{array} $$ 
</div>
...
$100 $$
-bill stacks is $$
9\text{in}{\text{.}}^{3}/\text{stack}\times 10^{8}\text{
...
<div data-type="equation" id="eip-690">
 $$ \begin{array}{lll}\text{volume of bills}& =& \text{area of field}×\text{height of money:}\\ \text{Height of money}& =& \frac{\text{volume of bills}}{\text{area of field}},\\ \text{Height of money}& =& \frac{9\times 10^{8}\text{in}{\text{.}}^{3}}{6\times 10^{6}{\text{in.}}^{2}}=1.33\times 10^{2}\text{in.,}\\ \text{Height of money}& \approx & 1\times 10^{2}\text{in.}=\text{100 in.}\end{array} $$ 
</div>
