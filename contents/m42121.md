...
<div data-type="equation" id="eip-203">
 $$ $1×{\text{10}}^{\text{12}}\left(\text{a trillion dollars}\right)\text{/ $1}×{\text{10}}^{4}}\text{per stack}=1×{\text{10}}^{8}\text{stacks.} $$ 
</div>
...
<div data-type="equation" id="eip-446">
 $$ \begin{array}{}\text{Area}={\text{5,000 yd}}^{2}×\frac{3\text{ft}}{\text{1 yd}}×\frac{3\text{ft}}{\text{1 yd}}×\frac{\text{12}\text{in}\text{.}}{\text{1 ft}}×\frac{\text{12}\text{in}\text{.}}{\text{1 ft}}=6,\text{480},\text{000}\text{in}{\text{.}}^{2},\\ \text{Area}\approx 6×{\text{10}}^{6}\text{in}{\text{.}}^{2}\text{.}\end{array} $$ 
</div>
This conversion gives us  $$ 6×{\text{10}}^{6}\text{in}{\text{.}}^{2} $$ 
...
$\text{100} $$
-bill stacks is $$
9\text{in}{\text{.}}^{3}/\text{stack}×{\text{10}}^{8}\text{
stacks}=9×{\text{10}}^{8}\text{in}{\text{.}}^{3}.
$$
