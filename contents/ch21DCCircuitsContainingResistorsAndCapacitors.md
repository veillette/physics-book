...
be covered in [Magnetism](/ch22Magnetism).
...
![An electrical circuit with a capacitor has an extra resistor R sub b l, called a bleeder, installed in parallel with the capacitor.](../resources/Figure_22_06_05.jpg "A bleeder resistor \( R_\text{bl} \) discharges the capacitor in this electronic device once it is switched off.")
{: #Figure5}
