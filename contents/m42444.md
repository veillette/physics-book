...
<div class="equation" id="eip-286">
 $$\begin{array}{lll}m& =& \rho \text{V}\\ & =& {\text{(1000 kg/m}}^{3}\right)\left(\text{area}×\text{thickness}{\text{(m}}^{3}\text{))}\\ & =& \text{(1000 kg/}{\text{m}}^{3}\right)\left(\pi \left(0.80 \times 10^{-3} \text{m}{\right)}^{2}/4\right)\left( 0.30 \times 10^{-6} \text{m}\right)\\ & =& 0.151 \times 10^{-9} \text{kg} \text{.} \end{array} $$
</div>
