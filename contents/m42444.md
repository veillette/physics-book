...
<div data-type="equation" id="eip-818">
 $${\text{Q}}_{\text{tot}}=m\left(c\Delta \text{T}+{\text{L}}_{\text{v}}\right)=\left( 0.151 \times 10^{-9}  \text{kg}\right)\left(\text{276 kJ/kg}+\text{2256 kJ/kg}\right)=\text{382}×{\text{10}}^{-9} \text{kJ}. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-id1512273">
 $$\lambda =\frac{c}{f}=\frac{ 3.00 \times 10^{8}  \text{m/s}}{ 1.20 \times 10^{15}  \text{Hz}}=2\text{.}\text{50}×{\text{10}}^{–7} \text{m} $$
</div>
</div>
</div>
