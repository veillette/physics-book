...
<div data-type="equation" id="eip-290">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{1530 \times 10^{3}  \text{cycles/s}}\\ & =& \text{196 m.}\end{array} $$
</div>
...
<div data-type="equation" id="eip-802">
 $$Q=m\left(\text{4186 J/kg/K}\right)\left(\text{100º}\text{C}–\text{34º}\text{C}\right)=m\left(\text{276 276 J/kg}\right)=m\left(276 \text{kJ/kg}\right). $$
</div>
...
<div data-type="equation" id="eip-931">
 $$\text{Cl}+{\text{O}}_{3} \to \text{ClO}+{\text{O}}_{2} \text{and ClO}+{\text{O}}_{3} \to \text{Cl}+{\text{2O}}_{2}. $$
</div>
