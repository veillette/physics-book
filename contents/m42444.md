...
<div data-type="equation" id="eip-290">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{\text{1530} \times 10^{3}  \text{cycles/s}}\\ & =& \text{196 m.}\end{array} $$
</div>
(b) For the  $$f=\text{105.1 MHz} $$
 FM radio signal,

<div data-type="equation" id="eip-530">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{ 105.1 \times 10^{6}  \text{cycles/s}}\\ & =& \text{2.85 m.}\end{array} $$
</div>
(c) And for the  $$f=\text{1.90 GHz} $$
 cell phone,

<div data-type="equation" id="eip-649">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{ 1.90 \times 10^{9}  \text{cycles/s}}\\ & =& \text{0.158 m.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-818">
 $${\text{Q}}_{\text{tot}}=m\left(c\Delta \text{T}+{\text{L}}_{\text{v}}\right)=\left( 0.151 \times 10^{-9}  \text{kg}\right)\left(\text{276 kJ/kg}+\text{2256 kJ/kg}\right)=\text{382} \times 10^{-9}  \text{kJ}. $$
</div>
**Discussion**
