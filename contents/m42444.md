...
<div data-type="equation" id="eip-649">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{\text{1.90}×{\text{10}}^{9} \text{cycles/s}}\\ & =& \text{0.158 m.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-id1512273">
 $$\lambda =\frac{c}{f}=\frac{ 3.00 \times 10^{8}  \text{m/s}}{1\text{.}\text{20}×{\text{10}}^{\text{15}} \text{Hz}}=2\text{.}\text{50}×{\text{10}}^{–7} \text{m} $$
</div>
</div>
</div>
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$f=\frac{c}{\lambda }=\frac{ 3.00 \times 10^{8}  \text{m/s}}{1×{\text{10}}^{-\text{10}} \text{m}}=3×{\text{10}}^{\text{18}} \text{Hz} $$
(b) X-rays
