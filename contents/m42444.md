...
<div class="equation" id="eip-290">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{1530 \times 10^{3}  \text{cycles/s}}\\ & =& 196 \text{m.}\end{array} $$
</div>
(b) For the  $$f=105.1 \text{MHz} $$
 FM radio signal,

<div class="equation" id="eip-530">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{ 105.1 \times 10^{6}  \text{cycles/s}}\\ & =& 2.85 \text{m.}\end{array} $$
</div>
(c) And for the  $$f=1.90 \text{GHz} $$
 cell phone,

<div class="equation" id="eip-649">
 $$\begin{array}{lll}\lambda & =& \frac{ 3.00 \times 10^{8}  \text{m/s}}{ 1.90 \times 10^{9}  \text{cycles/s}}\\ & =& 0.158 \text{m.}\end{array} $$
</div>
**Discussion**
...
<div class="equation" id="eip-286">
 $$\begin{array}{lll}m& =& \rho \text{V}\\ & =& {\text{(1000 kg/m}}^{3}\right)\left(\text{area}×\text{thickness}{\text{(m}}^{3}\text{))}\\ & =& \text{(1000 kg/}{\text{m}}^{3}\right)\left(\pi \left(0.80 \times 10^{-3} \text{m}{\right)}^{2}/4\right)\left( 0.30 \times 10^{-6} \text{m}\right)\\ & =& 0.151 \times 10^{-9} \text{kg.}\end{array} $$
</div>
...
<div class="equation" id="eip-108">
 $${\text{CFCl}}_{3}+\text{h}v \to {\text{CFCl}}_{2}+\text{Cl.} $$
</div>
...
[\[link\]](#import-auto-id1169736610636) shows a medical image based on  $$\gamma  $$
 ...
 ![A skeletal image of a human body is shown. The image represents gamma rays emitted by nuclei in a compound that is concentrated in the bones and eliminated through the kidneys. Some parts of the image are darker than the others. The ribs are shown darker than the leg and hand bones.](../resources/Figure 25_03_16a.jpg "This is an image of the \( \gamma \)  rays emitted by nuclei in a compound that is concentrated in the bones and eliminated through the kidneys. Bone cancer is evidenced by nonuniform concentration in similar structures. For example, some ribs are darker than others. (credit: P. P. Urone)"){: #import-auto-id1169736610636}
...
<span class="media" id="Phet_module_25.3" data-alt=""> [![](../resources/PhET_Icon.png){: data-print="false"}](color-vision_en.jar){: class="image"} <span data-media-type="image/jpg" data-print="true" data-src="PhET_Icon.png" class="image" width="450" /> </span>
</figure>
</div>
