...
<div data-type="equation" id="eip-74">
 $$ \omega =0+\left(\text{110}{\text{rad/s}}^{2}\right)\left(2\text{.}\text{00}\text{s}\right)=\text{220}\text{rad/s}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-252">
 $$ \begin{array}{lll}\theta & =& {\omega }_{0}t+\frac{1}{2}{\mathrm{\alpha t}}^{2}\\ & =& 0+\left(\text{0.500}\right)\left(\text{110}{\text{rad/s}}^{2}\right){\left(\text{2.00 s}\right)}^{2}=\text{220 rad}.\end{array} $$ 
</div>
...
Now let us consider what happens if the fisherman applies a brake to the spinning reel, achieving an angular acceleration of  $$ –\text{300}{\text{rad/s}}^{2} $$ 
...
=-\text{300}{\text{rad/s}}^{2} $$. Examining the available equations, we see all quantities but *t* are known in
...
<div data-type="equation" id="eip-309">
 $$ t=\frac{\omega -{\omega }_{0}}{\alpha }=\frac{0-\text{220 rad/s}}{-\text{300}{\text{rad/s}}^{2}}=0\text{.}\text{733 s.} $$ 
</div>
**Discussion**
...
Large freight trains accelerate very slowly. Suppose one such train accelerates from rest, giving its 0.350-m-radius wheels an angular acceleration of  $$ 0\text{.}\text{250}{\text{rad/s}}^{2} $$ 
...
<div data-type="equation" id="eip-915">
 $$ \theta =\left(\text{200}\text{rev}\right)\frac{2\pi \text{rad}}{\text{1 rev}}=\text{1257}\text{rad}. $$ 
</div>
...
<div data-type="equation" id="eip-271">
 $$ x=\mathrm{r\theta }=\left(0.350 m\right)\left(\text{1257 rad}\right)=\text{440}\text{m}. $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-745">
 $$ \theta =\left(\text{12 rev}\right)\left(\frac{2\pi \text{rad}}{\text{1 rev}}\right)=\text{75}\text{.4 rad.} $$ 
</div>
