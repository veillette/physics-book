...
Note that in rotational motion $$ a= a_{\text{t}} $$, and we shall use the symbol $$ a $$
...
<div data-type="equation" id="eip-900">
 $$ \overline{\omega }=\frac{ {\omega }_{0}+\omega }{2}\text{ and }\overline{v}=\frac{ v_{0}+v}{2}. $$ 
</div>
...
<div data-type="equation" id="eip-74">
 $$ \omega =0+\left(110}{\text{rad/s}}^{2}\right)\left(2.00\text{s}\right)=220}\text{rad/s}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-147">
 $$ v=\left(0.0450 \text{m}\right)\left(220 \text{rad/s}\right)=9.\text{90 m/s.} $$ 
</div>
...
<div data-type="equation" id="eip-252">
 $$ \begin{array}{lll}\theta & =& {\omega }_{0}t+\frac{1}{2}{\mathrm{\alpha t}}^{2}\\ & =& 0+\left(0.500\right)\left(110}{\text{rad/s}}^{2}\right){\left(\text{2.00 s}\right)}^{2}=\text{220 rad}.\end{array} $$ 
</div>
...
Now let us consider what happens if the fisherman applies a brake to the spinning reel, achieving an angular acceleration of  $$ –300}{\text{rad/s}}^{2} $$ 
...
see that the initial angular velocity is $$ {\omega }_{0}=220 \text{rad/s} $$
and the final angular velocity $$ \omega $$
is zero. The angular acceleration is given to be $$ \alpha
=-300}{\text{rad/s}}^{2} $$. Examining the available equations, we see all quantities but *t* are known in
...
<div data-type="equation" id="eip-309">
 $$ t=\frac{\omega -{\omega }_{0}}{\alpha }=\frac{0-220 \text{rad/s}}{-300}{\text{rad/s}}^{2}}=0.\text{733 s.} $$ 
</div>
**Discussion**
...
Large freight trains accelerate very slowly. Suppose one such train accelerates from rest, giving its 0.350-m-radius wheels an angular acceleration of  $$ 0.250{\text{rad/s}}^{2} $$ 
...
<div data-type="equation" id="eip-915">
 $$ \theta =\left(200}\text{rev}\right)\frac{2\pi \text{rad}}{\text{1 rev}}=1257}\text{rad}. $$ 
</div>
...
<div data-type="equation" id="eip-271">
 $$ x=\mathrm{r\theta }=\left(0.350 m\right)\left(\text{1257 rad}\right)=440}\text{m}. $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-6">
 $$ \begin{array}{lll}\omega & =& {\left[0+2\left(0.250{\text{ rad/s}}^{2}\right)\left(1257}\text{ rad}\right)\right]}^{1/2}\\ & =& \text{25.1 rad/s.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-745">
 $$ \theta =\left(\text{12 rev}\right)\left(\frac{2\pi \text{rad}}{\text{1 rev}}\right)=75}\text{.4 rad.} $$ 
</div>
...
<div data-type="equation" id="eip-624">
 $$ x=\mathrm{r\theta }=\left(0.15\text{ m}\right)\left(75.4\text{ rad}\right)=11}\text{ m}. $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A gyroscope slows from an initial rate of 32.0 rad/s at a rate of  $$ 0.700{\text{ rad/s}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
During a very quick stop, a car decelerates at  $$ 7.00{\text{ m/s}}^{2} $$ 
...
initial angular velocity is $$ 95.0 \text{rad/s} $$
?
...
of $$ 1.50{ \text{m/s}}^{2} $$, what is the angular acceleration of the yo-yo?
