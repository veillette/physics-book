...
[\[link\]](#Table1) gives the vapor pressure of water at  $$ 20.0\text{ºC} $$
...
The density is obtained by assuming a pressure equal to the vapor pressure of water at  $$ 20.0\text{ºC} $$ .
 The density found is identical to the value in [\[link\]](#Table1), which means that a vapor density of  $$ 17.2 {\text{g/m}}^{3} $$
 at  $$ 20.0\text{ºC} $$
...
We can use this and the data in [\[link\]](#Table1) to do a variety of interesting calculations, keeping in mind that relative humidity is based on the comparison of the partial pressure of water vapor in air and ice.
...
The first is given to be  $$9.40 {\text{g/m}}^{3} $$ ,
 and the second is found in [\[link\]](#Table1) to be  $$23.0 {\text{g/m}}^{3} $$ .
 Thus,
...
(b) The air contains  $$9.40 {\text{g/m}}^{3} $$
 ...
 is the saturation density. Inspection of [\[link\]](#Table1) reveals this to be the case at  $$ 10.0\text{ºC} $$ ,
...
(c) Here, the dew point temperature is given to be  $$ - 10.0\text{ºC} $$ .
 Using [\[link\]](#Table1), we see that the vapor density is  $$2.36 {\text{g/m}}^{3} $$ ,
...
Why does water boil at  $$100\text{ºC} $$ ?
 You will note from [\[link\]](#Table1) that the vapor pressure of water at  $$100\text{ºC} $$
...
<div class="problem" markdown="1">
Because humidity depends only on water’s vapor pressure and temperature, are the saturation vapor densities listed in [[link]](#Table1) valid in an atmosphere of helium at a pressure of  $$ 1.01 \times 10^{5}  {\text{N/m}}^{2} $$ ,
