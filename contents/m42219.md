...
The density is obtained by assuming a pressure equal to the vapor pressure of water at  $$ 20.0\text{ºC} $$ .
 The density found is identical to the value in [[Table 1]](#Table1), which means that a vapor density of  $$ 17.2 {\text{g/m}}^{3} $$
 at  $$ 20.0\text{ºC} $$
...
We can use this and the data in [[Table 1]](#Table1) to do a variety of interesting calculations, keeping in mind that relative humidity is based on the comparison of the partial pressure of water vapor in air and ice.
...
(c) Here, the dew point temperature is given to be  $$ - 10.0\text{ºC} $$ .
 Using [[Table 1]](#Table1), we see that the vapor density is  $$2.36 {\text{g/m}}^{3} $$ ,
...
Why does water boil at  $$100\text{ºC} $$ ?
 You will note from [[Table 1]](#Table1) that the vapor pressure of water at  $$100\text{ºC} $$
