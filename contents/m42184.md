...
<div data-type="equation" id="eip-1000">
 $$ \text{net}\mathbf{\text{τ}}=\frac{\text{Δ}\mathbf{\text{L}}}{\text{Δ}t}. $$ 
</div>
...
(a)  $$ 5\text{.}\text{64}×{\text{10}}^{\text{33}}\text{kg}\cdot {\text{m}}^{2}\text{/s} $$ 

(b)  $$
1\text{.}\text{39}×{\text{10}}^{\text{22}}\text{N}\cdot
\text{m} $$
(c)  $$
2\text{.}\text{17}×{\text{10}}^{\text{15}}\text{N}
$$
</div>
</div>
