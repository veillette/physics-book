...
We understand that  $${d}_{\text{i}} $$
 must equal the lens-to-retina distance to obtain clear vision, and that normal vision is possible for objects at distances  $${d}_{o}=\text{25 cm} $$
 to infinity.
...
What is the size of the image on the retina of a  $$1\text{.}\text{20}×{\text{10}}^{-2} $$
...
, given the height of the object is  $${h}_{o}=1\text{.}\text{20}×{\text{10}}^{-2} $$
...
<div data-type="equation" id="eip-777">
 $$\begin{array}{lll}{h}_{\text{i}}& =& -\left(1.20×{\text{10}}^{-2} \text{cm}\right)\frac{2.00 cm}{\text{60.0 cm}}\\ & =& -4.00×{\text{10}}^{-4} \text{cm}.\end{array} $$
</div>
**Discussion**
...
, as discussed earlier. The equation  $$P=\frac{1}{ {d}_{\text{o}}}+\frac{1}{ {d}_{\text{i}}} $$
 ...
 and  $${d}_{o} $$
. Power has units of diopters, where  $$\text{1 D}=\text{1/m} $$
