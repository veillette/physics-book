...
We want to find the height of the image  $${h}_{i} $$ ,
 ...
 For clear vision, the image distance must equal the lens-to-retina distance, and so  $${d}_{\text{i}}=2.00 cm $$
 . The equation  $$\frac{ {h}_{\text{i}}}{ {h}_{\text{o}}}=-\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}=m $$
