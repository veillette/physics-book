...
We want to find the height of the image  $${h}_{i} $$ ,
 ...
 cm. We also know that the object is 60.0 cm away, so that  $${d}_{o}=60.0 cm $$ .
 For clear vision, the image distance must equal the lens-to-retina distance, and so  $${d}_{\text{i}}=2.00 cm $$  . The equation  $$\frac{ {h}_{\text{i}}}{ {h}_{\text{o}}}=-\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}=m $$
...
For clear vision, the image must be on the retina, and so  $${d}_{\text{i}}=2.00 cm $$
 here. For distant vision,  $${d}_{o}\approx \infty  $$ ,
 and for close vision,  $${d}_{o}=25.0 cm $$ ,
