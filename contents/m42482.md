...
<div data-type="equation" id="eip-777">
 $$\begin{array}{lll}{h}_{\text{i}}& =& -\left( 1.20 \times 10^{-2}  \text{cm}\right)\frac{2.00 cm}{\text{60.0 cm}}\\ & =&  -4.00 \times 10^{-4}  \text{cm}.\end{array} $$
</div>
**Discussion**
...
, as discussed earlier. The equation  $$P=\frac{1}{ {d}_{\text{o}}}+\frac{1}{ {d}_{\text{i}}} $$
 ...
 and  $${d}_{o} $$
. Power has units of diopters, where  $$1 \text{D}=\text{1/m} $$
...
<div data-type="equation" id="eip-268">
 $$P=0+ 50.0/\text{m}=\text{50.0 D (distant vision).} $$
</div>
Now, for close vision,

<div data-type="equation" id="eip-4">
 $$\begin{array}{lll}P& =& \frac{1}{ {d}_{\text{o}}}+\frac{1}{ {d}_{\text{i}}}=\frac{1}{\text{0.250 m}}+\frac{1}{\text{0.0200 m}}\\ & =& \frac{4.00}{\text{m}}+\frac{50.0}{\text{m}}=\text{4.00 D}+\text{50.0 D}\\ & =& \text{54.0 D (close vision).}\end{array} $$
</div>
**Discussion**
