...
The rock is 8.10 m above its starting point at $$ t=1.00 \text{s} $$, since $$ y_{1}>y_
...
<div data-type="equation" id="import-auto-id1688803">
 $$ v_{1}=v_{0}-gt= 13.0 \text{m/s}-\left(9.80 \text{m/s}^{2}\right)
...
\text{m/s}^{2} $$. Its acceleration is $$ -9.80 \text{m/s}^{2} $$ for the 
...
{m} $$, and $$ a=-g=-9.80 \text{m/s}^{2} $$. We can then use the equation $$ 
...
t^{2}& =& \frac{2y}{-g}\\ 
t& =&  \pm  \sqrt{\frac{2y}{-g}}= \pm  \sqrt{\frac{2\left(-30.0 \text{m}\right)}{-9.80 \text{m/s}^{2}}^{2}}}= \pm  \sqrt{6.12 \text{s}^{2}}=2.47 \text{s}\approx 2.5 \text{s}
\end{array} $$ 
</div>
...
(b) 1.00, 
(c) 1.50, and 
(d) 2.00 s for a ball thrown straight up with an initial velocity of 15.0 m/s. Take the point of release to be  $$ y_{0}=0 $$ .
</div>
<div data-type="solution" markdown="1">
(a)  $$ y_{1}=6.28 \text{m} $$; $$ v_{1}=10.1 \text{m/s} $$
(b)  $$ y_{2}=10.1 \text{m} $$; $$ v_{2}=5.20 \text{m/s} $$
(c)  $$ y_{3}=11.5 \text{m} $$; $$ v_{3}=0.300 \text{m/s} $$
...
<div data-type="solution" markdown="1">
(a)  $$ a=-9.80 \text{m/s}^{2} $$ ; $$ v_{0}=13.0 \text{m/s} $$ ; $$ y_{0}=0 
\text{m} $$
...
<div data-type="equation" id="eip-id2418613">
 $$ \begin{array}{lll}{v}^{2}-v_{0}^{2}& =& 2a\left(y-y_{0}\right)\\ \frac{ v^{2}-v_{0}^{2}}{2a}& =& y-y_{0}\\ y& =& y_{0}+\frac{ v^{2}-v_{0}^{2}}{2a}=0 m+\frac{ {\left(0 \text{m/s}\right)}^{2}-{\left(13.0 \text{m/s}\right)}^{2}}{2\left(-9.80 \text{ m}{\text{/s}}^{2}\right)}=8.62 \text{m}
\end{array} $$ 
</div>
...
(c) Calculate its acceleration during contact with the floor if that contact lasts 0.0800 ms  $$ \left(8.00\times 10^{-5}\text{s}\right) $$ .
...
(a) Calculate its velocity just before it strikes the floor. 
(b) Calculate its velocity just after it leaves the floor on its way back up. 
(c) Calculate its acceleration during contact with the floor if that contact lasts 3.50 ms  $$ \left(3.50\times 10^{-3}\text{s}\right) $$. 
(d) How much did the ball compress during its collision with the floor,
assuming the floor is absolutely rigid?
