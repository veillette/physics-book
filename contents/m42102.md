...
<div data-type="equation" id="import-auto-id1688803">
 $$ v_{1}=v_{0}-gt=
13.0 \text{m/s}-\left(9.80 \text{m/s}^{2}\right)
\left(1.00 \text{s}\right)=3.20 \text{m/s} $$ 
</div>
**Discussion**
...
velocity is zero, but its acceleration is still $$ -9.80 \text{m/s}^{2} $$. Its acceleration is 
$$ -9.80 \text{m/s}^{2} $$
...
<div data-type="equation" id="import-auto-id2025017">
 $$ {v}^{2}={\left(-13.0 \text{m/s}\right)}^{2}+
2\left(-9.80 \text{m/s}^{2}\right)
\left(-5.10 \text{m}-0 \text{m}\right)=268.96 \text{m}^{2}\text{/s}^{2}, $$ 
</div>
...
initial velocity is 13.0 m/s straight up, a result of $$  \pm  3.20 \text{m/s} $$
...
<div data-type="equation" id="import-auto-id2571438">
 $$ a=\frac{2\left(-1.0000 \text{m} – 0 \right)}
{\left(0.45173 \text{s}{\right)}^{2}}=-9.8010\text{m/s}^{2}, $$ 
</div>
so, because  $$ a=-g $$ 
...
expect the value to be somewhere around the average value of $$ 9.80 \text{m/s}^{2} $$, so
$$ 9.8010 \text{m/s}^{2} $$
makes sense. Since the data going into the calculation are relatively precise,
this value for $$ g $$
is more precise than the average value of $$ 9.80 \text{m/s}^{2} $$
...
<div data-type="equation" id="import-auto-id2358783">
 $$ \begin{array}{lll}y& =& 0+0-\frac{1}{2}g t^{2} \\ {t}^{2}& =& \frac{2y}{-g}\\ t& =&  \pm  \sqrt{\frac{2y}{-g}}= \pm  \sqrt{\frac{2\left(-30.0 \text{m}\right)}{-9.80 \text{m/s}^{2}}^{2}}}= \pm  \sqrt{6.12{s}^{2}}=2.47 \text{s}\approx 2.5 \text{s}\end{array} $$ 
</div>
