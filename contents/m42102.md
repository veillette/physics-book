...
<div data-type="equation" id="eip-id2418613">
 $$ \begin{array}{lll}{v}^{2}-v_{0}^{2}& =& 2a\left(y-y_{0}\right)\\ \frac{ v^{2}-v_{0}^{2}}{2a}& =& y-y_{0}\\ y& =& y_{0}+\frac{ v^{2}-v_{0}^{2}}{2a}=0 m+\frac{ {\left(0 \text{m/s}\right)}^{2}-{\left(13.0 \text{m/s}\right)}^{2}}{2\left(-9.80 \text{m/s}^{2}\right)}=8.62 \text{m}
\end{array} $$ 
</div>
