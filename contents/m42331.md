...
<div data-type="equation" id="eip-581">
 $$W=\text{Fd} \text{cos} \theta =\text{qEd} \text{cos} \theta =0. $$
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The naturally occurring charge on the ground on a fine day out in the open country is  $$\text{–1}\text{.}\text{00} {\text{nC/m}}^{2} $$
