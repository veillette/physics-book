...
${F}_{2}=\frac{ {A}_{2}}{ {A}_{1}}{F}_{1}=\frac{ {\mathrm{\pi r}}_{2}^{2}}{ {\mathrm{\pi r}}_{1}^{2}}{F}_{1}=\frac{ {\left(1.25 cm\right)}^{2}}{ {\left(0.250 cm\right)}^{2}}×\text{500 N}=1\text{.}\text{25}×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{N}.$
</div>
**Discussion**
...
$2.55×{10}^{7}\phantom{\rule{0.25em}{0ex}}\text{Pa}$
...
<div data-type="solution" markdown="1">
$5\text{.}\text{76}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{N}$
