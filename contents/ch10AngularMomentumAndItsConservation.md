...
to [Figure 3 of Dynamics Of Rotational Motion](../contents/ch10DynamicsOfRotationalMotion.md#fig3), the formula for
...
[Figure 1](#fig1) shows a Lazy Susan food tray being rotated by a person in quest of sustenance. Suppose the person exerts a 2.50 N force perpendicular to the lazy Susan’s 0.260-m radius for 0.150 s.
...
The person whose leg is shown in [Figure 2](#fig2) kicks his leg by exerting a 2000-N force with his upper leg muscle. The effective perpendicular lever arm is 2.20 cm.
...
Suppose an ice skater, such as the one in [Figure 3](#fig3), is spinning
...
(d) He jumps off forward, tangential to the edge? Explain your answers. (Refer to [Figure 5](#fig5)).
