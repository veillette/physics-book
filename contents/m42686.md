...
in [Dark Matter and Closure](/m42692). The first results, published in 1999, are
...
it to be $$ 2.725± 0.002\text{K} $$ . The detection of what is now called the **
cosmic microwave background** (CMBR) was so important (generally considered as
...
fluctuations. (See [[link]](#fs-id1172427649801).) These amount to temperature
fluctuations of only $$200 \mu \text{k} $$ out of 2.7 K, better than one part in
...
expansion rate may be *increasing* (see [Dark Matter and Closure](/m42692))
...
in [The Four Basic Forces](/m42671), the four basic forces in nature are
