...
<div data-type="equation" id="eip-584">
 $$ N\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}\theta =\frac{ {\mathrm{mv}}^{2}}{r}\text{.} $$ 
</div>
...
N\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta $$, and the only other vertical force is the car’s weight. These must be equal in
magnitude; thus,

<div data-type="equation" id="eip-125">
 $$ N\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta =\text{mg}\text{.} $$ 
</div>
...
\cos\phantom{\rule{0.25em}{0ex}}\theta \right)
$$, and substituting this into the first yields

<div data-type="equation" id="eip-713">
 $$ \text{mg}\frac{\sin\phantom{\rule{0.25em}{0ex}}\theta }{\cos\phantom{\rule{0.25em}{0ex}}\theta }=\frac{ {\text{mv}}^{2}}{r} $$ 
</div>
