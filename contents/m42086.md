...
$$ F_{\text{c}}=\frac{ mv^{2}}{r}=\frac{\left( 900 \text{kg}\right)\left(25.0 \text{m/s}{\right)
...
Substituting the knowns, <div data-type="equation" id="eip-971"> 
$$ \mu_{\text{s}}=\frac{\left(25.0 \text{m/s}\right)^{2}}
{\left(500 \text{m}\right)\left(9.80 \text{m/s}^{2}\right)}=0.13.
...
<div data-type="equation" id="eip-571">
 $$ \begin{array}{lll}v& =& {\left[\left(100 \text{m}\right)\left(9.80 \text{m/s}^{2}\right)\left(2.14\right)\right]}^{1/2}\\ & =& 
45.8 \text{ m/s.}\end{array} $$ 
</div>
**Discussion**
...
banked at $$15.0^\circ  $$. (b) What is the minimum coefficient of friction needed for a
