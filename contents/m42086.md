...
net $$ \text{F}=ma $. For uniform circular motion, the acceleration is
...
$$ F_{\text{c}}=f={\mu }_{\text{s}}N={\mu }_{\text{s}}mg \text{.} $$ 
</div>
...
<div data-type="equation" id="eip-18">
 $$ m\frac{ v^{2}}{r}={\mu }_{\text{s}}mg \text{.} $$  </div>
...
and get an expression for $$ \theta $$, as desired. Solving the second equation for $$ N=mg /\left(
\cos{\theta} \right)
...
<div data-type="equation" id="eip-285">
 $$ \begin{array}{rrr}mg \tan\left(\theta \right)& =& \frac{ mv^{2}}{r}\\ \tan{\theta} & =& \frac{ v^{2}}{\text{rg.}}\end{array} $$ 
</div>
