...
{c}=\frac{ v^{2}}{r};a_{c}=r  \omega^{2}$, we get two expressions for the centripetal force ${\text{F}}_{\text{c}}
...
We know that$$ F_{\text{c}}=\frac{ mv^{2}}{r} $$ .
Thus, <div data-type="equation" id="eip-211">
$$ F_{\text{c}}=\frac{ mv^{2}}{r}=\frac{\left(\text{900
kg}\right)\left(25.0 \text{m/s}{\right)
}^{2}}{\left(500 \text{m}\right)}=1125 \text{N.} $$
</div>
**Strategy for (b)**
...
{\text{s}}=\frac{\left(25.0 \text{m/s}{\right)}^{2}}{\left(500 \text{m}\right)
...
magnitude $$ m v^{2}\text{/r} $$. Because this is the crucial force and it is horizontal, we use a coordinate
...
<div data-type="equation" id="eip-713">
 $$ \text{mg}\frac{\sin{\theta} }{\cos{\theta} }=\frac{ m v^{2}}{r} $$ 
</div>

<div data-type="equation" id="eip-285">
 $$ \begin{array}{rrr}\text{mg}\tan\left(\theta \right)& =& \frac{ mv^{2}}{r}\\ \tan{\theta} & =& \frac{ v^{2}}{\text{rg.}}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-571">
 $$ \begin{array}{lll}v& =& {\left[\left(100 \text{m}\right)\left(9.80 m{\text{/s}}^{2}\right)\left(2.14\right)\right]}^{1/2}\\ & =& \text{45.8 m/s.}\end{array} $$ 
</div>
**Discussion**
