...
<div data-type="equation" id="eip-584">
 $$ N\phantom{\rule{0.25em}{0ex}}\sin{\theta} =\frac{ {\mathrm{mv}}^{2}}{r}\text{.} $$ 
</div>
...
N\phantom{\rule{0.25em}{0ex}}\cos{\theta} $$, and the only other vertical force is the car’s weight. These must be equal in
magnitude; thus,

<div data-type="equation" id="eip-125">
 $$ N\phantom{\rule{0.25em}{0ex}}\cos{\theta} =\text{mg}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-713">
 $$ \text{mg}\frac{\sin{\theta} }{\cos{\theta} }=\frac{ {\text{mv}}^{2}}{r} $$ 
</div>

<div data-type="equation" id="eip-285">
 $$ \begin{array}{rrr}\text{mg}\phantom{\rule{0.25em}{0ex}}\tan\left(\theta \right)& =& \frac{ {\mathrm{mv}}^{2}}{r}\\ \tan{\theta} & =& \frac{ {v}^{2}}{\text{rg.}}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-6">
 $$ v=\left(\text{rg}\phantom{\rule{0.25em}{0ex}}\tan{\theta} {\right)}^{1/2}\text{.} $$ 
</div>
