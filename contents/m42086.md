...
<div data-type="equation" id="eip-285">
 $$ \begin{array}{rrr}\text{mg}\phantom{\rule{0.25em}{0ex}}\tan\left(\theta \right)& =& \frac{ {\mathrm{mv}}^{2}}{r}\\ \tan\phantom{\rule{0.25em}{0ex}}\theta & =& \frac{ {v}^{2}}{\text{rg.}}\end{array} $$ 
</div>

Taking the inverse tangent gives

<div data-type="equation" id="eip-239">
 $$ \theta ={\tan}^{-1}\left(\frac{ {v}^{2}}{\text{rg}}\right)\phantom{\rule{0.25em}{0ex}}\text{(ideally banked curve, no friction).} $$ 
</div>
...
<div data-type="equation" id="eip-895">
 $$ \tan\phantom{\rule{0.25em}{0ex}}\theta =\frac{ {v}^{2}}{\text{rg}} $$ 
</div>
we get

<div data-type="equation" id="eip-6">
 $$ v=\left(\text{rg}\phantom{\rule{0.25em}{0ex}}\tan\phantom{\rule{0.25em}{0ex}}\theta {\right)}^{1/2}\text{.} $$ 
</div>
