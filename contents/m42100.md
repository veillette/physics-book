...
1\. Identify the knowns. $$ {v}_{0}=0 $$, $$ {v}_{f}=-15}\text{.0 m/s} $$
...
<div data-type="equation" id="import-auto-id2400983">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{-15}\text{.0 m/s}}{1\text{.80 s}}=-8\text{.33 m}{\text{/s}}^{2}. $$ 
</div>
**Discussion**
...
second, that is, 8.33 meters per second per second, which we write as $$ 8\text{.33 m}{\text{/s}}^{2} $$. This is truly an average acceleration, because the ride is not smooth. We
...
+3.0 m{\text{/s}}^{2} $$
and $$ \text{–2}.0 m{\text{/s}}^{2} $$, respectively.
...
(the trains starts at rest), $$ {v}_{f}=30.\text{0 km/h} $$, and $$ \Delta t=20.0 \text{s} $$.
...
<div data-type="equation" id="import-auto-id2412947">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{+\text{30.0 km/h}}{20.0 s} $$ 
</div>
...
<div data-type="equation" id="import-auto-id2297812">
 $$ \stackrel{-}{a}=\left(\frac{+\text{30 km/h}}{\text{20.0 s}}\right)\left(\frac{ 10^{3}\text{m}}{\text{1 km}}\right)\left(\frac{1 \text{h}}{3600 \text{s}}\right)=0.417 \text{m/s}^2 $$ 
</div>
**Discussion**
...
1\. Identify the knowns. $$ {v}_{0}=30}\text{.0 km/h} $$, $$ {v}_{f}=0 km/h $$
...
<div data-type="equation" id="import-auto-id2586229">
 $$ \Delta v={v}_{f}-{v}_{0}=0-30.\text{0 km/h}=-30}\text{.0 km/h} $$ 
</div>
...
<div data-type="equation" id="import-auto-id2412874">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{-30.\text{0 km/h}}{8.00 \text{s}} $$ 
</div>
4\. Convert the units to meters and seconds.

<div data-type="equation" id="import-auto-id2596926">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\left(\frac{-\text{30.0 km/h}}{\text{8.00 s}}\right)\left(\frac{ 10^{3}\text{m}}{\text{1 km}}\right)\left(\frac{1 \text{h}}{3600 \text{s}}\right)={\text{−1.04 m/s}}^{2}\text{.} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2338968">
 $$ \stackrel{-}{v}=\frac{\Delta x^{\prime} }{\Delta t}=\left(\frac{-1\text{.}\text{50 km}}{5\text{.}\text{00 min}}\right)\left(\frac{\text{60 min}}{1 h}\right)=-18}\text{.0 km/h} $$ 
</div>
**Discussion**
...
1\. Identify the knowns. $$ {v}_{0}=-\text{20 km/h} $$, $$ {v}_{f}=0 km/h $$, $$ \Delta t=10.0 s $$.
...
<div data-type="equation" id="import-auto-id2585925">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{+20}\text{.0 km/h}}{10.0 s} $$ 
</div>
4\. Convert units.

<div data-type="equation" id="import-auto-id2581171">
 $$ \stackrel{-}{a}=\left(\frac{+20.\text{0 km/h}}{10.0 \text{s}}\right)\left(\frac{ 10^{3}m}{1 km}\right)\left(\frac{1 h}{\text{3600 s}}\right)=+0\text{.556 m}{\text{/s}}^{2} $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A commuter backs her car out of her garage with an acceleration of  $$ 1.40 \text{m/s}^2 $$ 
