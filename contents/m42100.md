...
<div data-type="equation" id="import-auto-id2400875">
 $$ \Delta x={x}_{f}-{x}_{0}=6\text{.}\text{70 km}-4\text{.}\text{70 km}=+2\text{.}\text{00 km} $$ 
</div>
...
v=+\text{30.0 km/h} $$, where the plus sign means velocity to the right.
...
<div data-type="equation" id="import-auto-id2581122">
 $$ \Delta v={v}_{f}-{v}_{0}=0-\left(-\text{20 km/h}\right)= +\text{20 km/h}. $$ 
</div>
...
<div data-type="equation" id="import-auto-id2581171">
 $$ \stackrel{-}{a}=\left(\frac{+\text{20}\text{.}\text{0 km/h}}{\text{10}\text{.}\text{0 s}}\right)\left(\frac{ {\text{10}}^{3}m}{1 km}\right)\left(\frac{1 h}{\text{3600 s}}\right)=+0\text{.556 m}{\text{/s}}^{2} $$ 
</div>
**Discussion**
