...
acceleration are \\( {\text{m/s}}^{2} \\)

, meters per second squared or meters per second per second, which literally
...
, its change in velocity equals its final velocity:  \\( \Delta v={v}_
{f}=-\text{15}\text{.0 m/s} \\)
...
displacement, we use the equation \\( \Delta x={x}_{f}-{x}_{0} \\)
...
(the trains starts at rest), \\( {v}_{f}=\text{30}\text{.}\text{0 km/h} \\)

, and \\( \Delta t=\text{20}\text{.}\text{0 s} \\)

.

2\. Calculate \\( \Delta v \\)

. Since the train starts from rest, its change in velocity is \\( \Delta
v\text{=}\phantom{\rule{0.20em}{0ex}}\text{+}\text{30.0 km/h} \\)
...
1\. Identify the knowns. \\( {v}_{0}=\text{30}\text{.0 km/h} \\)
...
, \\( {x\prime }_{0}=\text{5.25 km} \\)

, \\( \Delta t=\text{5.00 min} \\)

.

2\. Determine displacement, \\( \Delta x\prime \\)

. We found \\( \Delta x\prime \\)
...
1\. Identify the knowns. \\( {v}_{0}=-\text{20 km/h} \\)

, \\( {v}_{f}=0 km/h \\)

, \\( \Delta t=\text{10}\text{.}0 s \\)
