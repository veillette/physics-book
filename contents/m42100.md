...
<div data-type="equation" id="import-auto-id2400983">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{-\text{15}\text{.0 m/s}}{1\text{.80 s}}=-8\text{.33 m}{\text{/s}}^{2}. $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2400875">
 $$ \Delta x={x}_{f}-{x}_{0}=6\text{.}\text{70 km}-4\text{.}\text{70 km}\text{=}\text{+}2\text{.}\text{00 km} $$ 
</div>
...
v\text{=}\text{+}\text{30.0 km/h} $$, where the plus sign means velocity to the right.
...
<div data-type="equation" id="import-auto-id2297812">
 $$ \stackrel{-}{a}=\left(\frac{+\text{30 km/h}}{\text{20.0 s}}\right)\left(\frac{ {\text{10}}^{3}\text{m}}{\text{1 km}}\right)\left(\frac{\text{1 h}}{\text{3600 s}}\right)=0\text{.}{\text{417 m/s}}^{2} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2596926">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\left(\frac{-\text{30.0 km/h}}{\text{8.00 s}}\right)\left(\frac{ {\text{10}}^{3}\text{m}}{\text{1 km}}\right)\left(\frac{\text{1 h}}{\text{3600 s}}\right)={\text{−1.04 m/s}}^{2}\text{.} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2581171">
 $$ \stackrel{-}{a}=\left(\frac{+\text{20}\text{.}\text{0 km/h}}{\text{10}\text{.}\text{0 s}}\right)\left(\frac{ {\text{10}}^{3}m}{1 km}\right)\left(\frac{1 h}{\text{3600 s}}\right)\text{=}\text{+}0\text{.556 m}{\text{/s}}^{2} $$ 
</div>
**Discussion**
