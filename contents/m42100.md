...
<div data-type="equation" id="import-auto-id4040806">
 $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{ v_{f}-{v}_{0}}{ t_{f}-{t}_{0}}, $$ 
</div>
where * $$ \stackrel{-}{a} $$ 
...
\stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{ v_{f}-{v}_{0}}{ t_{f}-{t}_
{0}} $$.
...
* {: #import-auto-id2412645} Acceleration is the rate at which velocity changes.
  ...
  <div data-type="equation" id="import-auto-id2412659">
   $$ \stackrel{-}{a}=\frac{\Delta v}{\Delta t}=\frac{ v_{f}-{v}_{0}}{ t_{f}-{t}_{0}}\text{.} $$ 
  </div>
