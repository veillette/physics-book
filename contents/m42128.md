...
<div data-type="equation" id="eip-377">
 $$ {A}_{x}=A\phantom{\rule{0.25em}{0ex}}\cos{\theta}  $$ 
</div>

and

<div data-type="equation" id="eip-69">
 $$ {A}_{y}=A\phantom{\rule{0.25em}{0ex}}\sin{\theta} \text{.} $$ 
</div>
...
<div data-type="equation" id="eip-id1646569">
 $$ {A}_{x}=A\phantom{\rule{0.25em}{0ex}}\cos{\theta} =\left(\text{10.3 blocks}\right)\left(\cos\phantom{\rule{0.25em}{0ex}}29.1º\right)=\text{9.0 blocks} $$ 
</div>

<div data-type="equation" id="eip-id2495034">
 $$ {A}_{y}=A\phantom{\rule{0.25em}{0ex}}\sin{\theta} =\left(\text{10.3 blocks}\right)\left(\sin\phantom{\rule{0.25em}{0ex}}29.1º\right)=\text{5.0 blocks}\text{.} $$ 
</div>
...
Equations  $$ {A}_{x}=A\phantom{\rule{0.25em}{0ex}}\cos{\theta}  $$ 
...
* {: #import-auto-id1165296238492} The steps to add vectors $$ \mathbf{A} $$
  ...
  <div data-type="equation" id="import-auto-id1165298699812">
   $$ \begin{array}{lll}{A}_{x}& =& A\phantom{\rule{0.25em}{0ex}}\cos{\theta} \\ {B}_{x}& =& B\phantom{\rule{0.25em}{0ex}}\cos{\theta} \end{array} $$ 
  </div>

  and

  <div data-type="equation" id="import-auto-id1165298717989">
   $$ \begin{array}{lll}{A}_{y}& =& A\phantom{\rule{0.25em}{0ex}}\sin{\theta} \\ {B}_{y}& =& B\phantom{\rule{0.25em}{0ex}}\sin{\theta} \text{.}\end{array} $$ 
  </div>
