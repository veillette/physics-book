...
\mathbf{\text{A}}_{x}=3 \text{m} $$
east, $$ {\mathbf{\text{A}}}_{y}=4 \text{m} $$
north, and $$ \mathbf{\text{A}}=5 \text{m} $$
north-east, then it is true that the vectors 
$$ \mathbf{A}_{x} +\text{A}_{y} =\text{A} $$. However, it is **not** true that the sum of 
the magnitudes of the vectors is
also equal. That is,

<div data-type="equation" id="eip-818">
 $$ \begin{array}{}3 \text{m}+ 4 \text{m}\ne 5 \text{m}\\ \end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id1646569">
 $$ A_{x}=A\cos{\theta} =\left(10.3 \text{blocks}\right)\left(\cos{29.1^\circ }\right)=9.0 \text{blocks} $$ 
</div>

<div data-type="equation" id="eip-id2495034">
 $$ A_{y}=A\sin{\theta} =\left(10.3 \text{blocks}\right)\left(\sin{29.1^\circ }\right)=5.0 \text{blocks}\text{.} $$ 
</div>
...
and $$ A_{y} $$
are 9 and 5 blocks, respectively, then $$ A=\sqrt{ 9^{2}+5^{2}}=10.3 $$
blocks, again consistent with the example of the person walking in a city.
Finally, the direction is $$ \theta ={\tan}^{–1}\left(5/9 \right) =29.1^\circ $$, as before.
...
along the **x**- and **y**-axes. Note that $$ A=53.0 \text{m} $$, $$ \theta_{\text{A}}=20.0^\circ $$, $$ B=34.0 \text{m} $$, and $$ \theta_{\text{B}}=63.0^\circ $$. We find the **x**-components by using $$ A_{x}=A\cos{\theta}
$$, which gives

<div data-type="equation" id="eip-253">
 $$ \begin{array}{lll} A_{x}& =& A\cos{\theta_{A}}=\left(53.0 \text{m}\right)
\left(\cos{20.0^\circ}\right)\\ & =& 
\left(53.0 m\right)\left(0.940 \right)=49.8 m\end{array} $$ 
</div>
and

<div data-type="equation" id="eip-356">
 $$ \begin{array}{lll} B_{x}& =& B\cos{\theta_{B}}=\left(34.0 \text{m}\right)
\left(\cos{63.0^\circ}\right)\\ 
& =& \left(34.0 \text{m}\right)\left(0.454\right)=15.4 m\text{.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-802">
 $$ \begin{array}{lll} A_{y}& =& A\sin{\theta_{A}}=\left(53.0 \text{m}\right)
\left(\sin{20.0^\circ }\right)\\ & =&
\left(53.0 \text{m}\right)\left(0.342\right)=18.1 \text{m}\end{array} $$ 
</div>
and

<div data-type="equation" id="eip-837">
 $$ \begin{array}{lll} B_{y}& =& B\sin{\theta_{B}}=\left(34.0 \text{m}\right)\left(\sin{ 63.0^\circ}\right)\\ & =
&\left(34.0 \text{m}\right)\left(0.891\right)=30.3 \text{m}\text{.}\end{array} $$ 
</div>
The **x**- and **y**-components of the resultant are thus

<div data-type="equation" id="eip-196">
 $$  R_{x}= A_{x}+B_{x}=49.8 \text{m}+15.4 \text{m}=65.2 \text{m} $$ 
</div>
and
...
<div data-type="equation" id="eip-755">
 $$ \theta ={\tan}^{-1}\left(0.742\right)=36.6^\circ \text{.} $$ 
</div>
