...
<div data-type="equation" id="eip-id1646569">
 $$  A_{x}=A\cos{\theta} =\left(10.3 \text{blocks}\right)\left(\cos29.1º\right)=9.0 \text{blocks} $$ 
</div>

<div data-type="equation" id="eip-id2495034">
 $$  A_{y}=A\sin{\theta} =\left(10.3 \text{blocks}\right)\left(\sin29.1º\right)=5.0 \text{blocks}\text{.} $$ 
</div>
...
components are $$  A_{x} $$, $$  A_{y} $$, $$ B_{x} $$, and $$ B_{y} $$. The angles that vectors $$ \mathbf{A} $$
and $$ \mathbf{B} $$
...
<div data-type="equation" id="eip-173">
 $$ \theta ={\tan}^{-1}\left(R_{y}/R_{x}\right)\text{.} $$ 
</div>
...
represents the second leg, a displacement of $$ 34.0 \text{m} $$
...
<div data-type="equation" id="eip-196">
 $$ {R}_{x}= A_{x}+B_{x}=49.8 m\text{}+15.4 m\text{}=65.2 m\text{} $$ 
</div>
and

<div data-type="equation" id="eip-325">
 $$ {R}_{y}= A_{y}+B_{y}=18.1 m+30.3 m=48.4 m\text{.} $$ 
</div>
Now we can find the magnitude of the resultant by using the Pythagorean theorem:

<div data-type="equation" id="eip-941">
 $$ R=\sqrt{ R_{x}^{2}+R_{y}^{2}}=\sqrt{\left(65.2{\right)}^{2}+\left(48.4{\right)}^{2}\text{m}} $$ 
</div>
so that
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Do [[link]](#eip-287) again using analytical techniques and change the second leg of the walk to  $$ 25.0 \text{m} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In an attempt to escape his island, Gilligan builds a raft and sets to sea. The wind shifts a great deal during the day, and he is blown along the following straight lines:  $$ 2.50 \text{km} $$ 

$$ 45.0º $$
north of west; then $$ 4.70 \text{km} $$
$$ 60.0º $$
south of east; then $$ 1.30\text{km} $$
$$ 25.0º $$
south of west; then $$ 5.10 \text{km} $$
straight east; then $$ 1.70\text{km} $$
$$ 5.00º $$
east of north; then $$ 7.20 \text{km} $$
$$ 55.0º $$
south of west; and finally $$ 2.80 \text{km} $$
$$ 10.0º $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Suppose a pilot flies  $$ 40.0 \text{km} $$ 
