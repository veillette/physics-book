...
![\]A dotted vector A sub x whose magnitude is equal to A cosine theta is drawn from the origin along the x axis. From the head of the vector A sub x another vector A sub y whose magnitude is equal to A sine theta is drawn in the upward direction. Their resultant vector A is drawn from the tail of the vector A sub x to the head of the vector A-y at an angle theta from the x axis. Therefore vector A is the sum of the vectors A sub x and A sub y.](../resources/Figure_03_03_02a.jpg "The magnitudes of the vector components  \( A_x \)  and  \( A_y \)  can be related to the resultant vector  \( A \)  and the angle &#10; &#10; &#10; &#10; &#10; &#x3B8;&#10; &#10; &#10; &#10; &#10; size 12{&#x3B8;} {}&#10; &#10; with trigonometric identities. Here we see that Ax=Acos&#x3B8; size 12{A rSub { size 8{x} } =A&quot;cos&quot;&#x3B8;} {} and Ay=Asin&#x3B8; size 12{A rSub { size 8{y} } =A&quot;sin&quot;&#x3B8;} {}.")
...
A farmer wants to fence off his four-sided plot of flat land. He measures the first three sides, shown as  $$ \vb{A}, $$ 
$$ \vb{B}, $$ and $$ \vb{C} $$ in [[link]](#import-auto-id1165298543237)
