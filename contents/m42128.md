...
<div data-type="equation" id="eip-253">
 $$ \begin{array}{lll} A_{x}& =& A\cos{\theta_{A}}=\left(53.0 \m \right)
...
<div data-type="equation" id="eip-356">
 $$ \begin{array}{lll} B_{x}& =& B\cos{\theta_{B}}=\left(34.0 \m \right)
...
<div data-type="equation" id="eip-802">
 $$ \begin{array}{lll} 
A_{y}& =& A\sin{\theta_{A}}=\left(53.0 \m \right)
...
<div data-type="equation" id="eip-837">
 $$ \begin{array}{lll} B_{y}& =& B\sin{\theta_{B}}=\left(34.0 \m \right)\left(\sin{ 63.0^\circ}\right)\\
 & =
