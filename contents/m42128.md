...
& =& \left(34.0 \text{m}\right)\left(0.454\right)=15.4 m.\end{array} $$ 
</div>
...
&\left(34.0 \text{m}\right)\left(0.891\right)=30.3 \text{m}.\end{array} $$ 
</div>
...
* {: #import-auto-id1165296238492} The steps to add vectors $$ \mathbf{A} $$ and
  ...
  <div data-type="equation" id="import-auto-id1165298717989">
   $$ \begin{array}{lll} A_{y}& =& A\sin{\theta} \\  B_{y}& =& B\sin{\theta} .\end{array} $$ 
  </div>
