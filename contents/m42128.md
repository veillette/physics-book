...
and $$ \mathbf{B} $$
make with the **x**-axis are $$ \theta_{\text{A}} $$
and $$ \theta_{\text{B}} $$, respectively.
...
\mathbf{A} $$
and $$ \mathbf{B} $$
along the **x**- and **y**-axes. Note that $$ A=53.0 m\text{} $$, $$ \theta_{\text{A}}=20.0^\circ $$, $$ B=34.0 m\text{} $$, and $$ \theta_{\text{B}}=63.0^\circ $$. We find the **x**-components by using $$ A_{x}=A\cos{\theta}
$$, which gives

<div data-type="equation" id="eip-253">
 $$ \begin{array}{lll} A_{x}& =& A\cos{\theta_{A}}=\left(53.0 m\text{}\right)\left(\text{cos 20.0º}\right)\\ & =& \left(53.0 m\right)\left(0\text{.940}\right)=49.8 m\end{array} $$ 
</div>
and

<div data-type="equation" id="eip-356">
 $$ \begin{array}{lll} B_{x}& =& B\cos{\theta_{B}}=\left(34.0 m\text{}\right)\left(\text{cos 63.0º}\right)\\ & =& \text{}\left(34.0 m\text{}\right)\left(0.454\right)=15.4 m\text{.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-802">
 $$ \begin{array}{lll} A_{y}& =& A\sin{\theta_{A}}=\left(53.0 m\text{}\right)\left(\text{sin 20.0º}\right)\\ & =& \text{}\left(53.0 m\text{}\right)\left(0.342\right)=18.1 m\text{}\end{array} $$ 
</div>
and

<div data-type="equation" id="eip-837">
 $$ \begin{array}{lll} B_{y}& =& B\sin{\theta_{B}}=\left(34.0 m\text{}\right)\left(\text{sin 63}.0º\right)\\ & =& \text{}\left(34.0 m\text{}\right)\left(0.891\right)=30.3 m\text{}\text{.}\end{array} $$ 
</div>
The **x**- and **y**-components of the resultant are thus

<div data-type="equation" id="eip-196">
 $$  R_{x}= A_{x}+B_{x}=49.8 m\text{}+15.4 m\text{}=65.2 m\text{} $$ 
</div>
and

<div data-type="equation" id="eip-325">
 $$  R_{y}= A_{y}+B_{y}=18.1 m+30.3 m=48.4 m\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-713">
 $$ \theta ={\tan}^{-1}\left( R_{y}/ R_{x}\right)\text{=+}{\tan}^{-1}\left(48.4/65.2\right)\text{.} $$ 
</div>
Thus,
...
* {: #import-auto-id1165296238492} The steps to add vectors $$ \mathbf{A} $$
  ...
  <div data-type="equation" id="import-auto-id1165298717989">
   $$ \begin{array}{lll} A_{y}& =& A\sin{\theta} \\  B_{y}& =& B\sin{\theta} \text{.}\end{array} $$ 
  </div>
