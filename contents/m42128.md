...
<div data-type="equation" id="eip-id1646569">
 $$ {A}_{x}=A\cos{\theta} =\left(\text{10.3 blocks}\right)\left(\cos29.1º\right)=\text{9.0 blocks} $$ 
</div>

<div data-type="equation" id="eip-id2495034">
 $$ {A}_{y}=A\sin{\theta} =\left(\text{10.3 blocks}\right)\left(\sin29.1º\right)=\text{5.0 blocks}\text{.} $$ 
</div>
...
Note that the equation $$ A=\sqrt{ A_{x}^{2}+{A}_{y}^{2}} $$
...
and $$ \theta $$
to $$ {A}_{x} $$
and $$ {A}_{y} $$. Equations $$ A=\sqrt{ A_{x}^{2}+{A}_{y}^{2}} $$
...
and $$ \theta $$
using the equations $$ A=\sqrt{ { A_{x}}^{2}+{ A_{y}}^{2}} $$
...
<div data-type="equation" id="eip-253">
 $$ \begin{array}{lll}{A}_{x}& =& A\cos{\theta }_{A}=\left(\text{53.}0 m\text{}\right)\left(\text{cos 20.0º}\right)\\ & =& \left(\text{53.}0 m\right)\left(0\text{.940}\right)=\text{49.}8 m\end{array} $$ 
</div>
and

<div data-type="equation" id="eip-356">
 $$ \begin{array}{lll}{B}_{x}& =& B\cos{\theta }_{B}=\left(\text{34}\text{.}0 m\text{}\right)\left(\text{cos 63.0º}\right)\\ & =& \text{}\left(\text{34}\text{.}0 m\text{}\right)\left(0\text{.}\text{454}\right)=\text{15}\text{.}4 m\text{.}\end{array} $$ 
</div>
Similarly, the *y*-components are found using  $$ {A}_{y}=A\sin{\theta }_{A} $$ 

\:

<div data-type="equation" id="eip-802">
 $$ \begin{array}{lll}{A}_{y}& =& A\sin{\theta }_{A}=\left(\text{53}\text{.}0 m\text{}\right)\left(\text{sin 20.0º}\right)\\ & =& \text{}\left(\text{53}\text{.}0 m\text{}\right)\left(0\text{.}\text{342}\right)=\text{18}\text{.}1 m\text{}\end{array} $$ 
</div>
and

<div data-type="equation" id="eip-837">
 $$ \begin{array}{lll}{B}_{y}& =& B\sin{\theta }_{B}=\left(\text{34}\text{.}0 m\text{}\right)\left(\text{sin 63}\text{.}0º\right)\\ & =& \text{}\left(\text{34}\text{.}0 m\text{}\right)\left(0\text{.}\text{891}\right)=\text{30}\text{.}3 m\text{}\text{.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-941">
 $$ R=\sqrt{ R_{x}^{2}+{R}_{y}^{2}}=\sqrt{\left(\text{65}\text{.}2{\right)}^{2}+\left(\text{48}\text{.}4{\right)}^{2}\text{m}} $$ 
</div>
so that
...
* {: #import-auto-id1165296238492} The steps to add vectors $$ \mathbf{A} $$
  ...
  <div data-type="equation" id="import-auto-id1165298699812">
   $$ \begin{array}{lll}{A}_{x}& =& A\cos{\theta} \\ {B}_{x}& =& B\cos{\theta} \end{array} $$ 
  </div>

  and

  <div data-type="equation" id="import-auto-id1165298717989">
   $$ \begin{array}{lll}{A}_{y}& =& A\sin{\theta} \\ {B}_{y}& =& B\sin{\theta} \text{.}\end{array} $$ 
  </div>
...
$$ 60.0º $$
south of east; then $$ 1.30\text{km} $$
$$ 25.0º $$
south of west; then $$ 5\text{.}\text{10 km} $$
straight east; then $$ 1.70\text{km} $$
$$ 5.00º $$
