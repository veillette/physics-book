...
Finally, the direction is $$ \theta ={\text{tan}}^{–1}\left(\text{5/9}\right)
=29.1º $$, as before.
...
and $$ \theta ={\text{tan}}^{\text{–1}}\left({A}_{y}/{A}_{x}\right) $$
...
and $$ \theta ={\text{tan}}^{–1}\left({A}_{y}/{A}_{x}\right) $$. When you use the analytical method of vector addition, you can determine the
...
<div data-type="equation" id="eip-173">
 $$ \theta ={\text{tan}}^{-1}\left({R}_{y}/{R}_{x}\right)\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-713">
 $$ \theta ={\text{tan}}^{-1}\left({R}_{y}/{R}_{x}\right)\text{=+}{\text{tan}}^{-1}\left(\text{48}\text{.}4/\text{65}\text{.}2\right)\text{.} $$ 
</div>
Thus,

<div data-type="equation" id="eip-755">
 $$ \theta ={\text{tan}}^{-1}\left(0\text{.}\text{742}\right)=\text{36}\text{.}6º\text{.} $$ 
</div>
