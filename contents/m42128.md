...
\vb{A}_{x}=3 \text{m} $$ east, $$ {\vb{A}}_{y}=4 \text{m}
$$ north, and $$ \vb{A}=5 \text{m} $$ north-east, then it is true
...
$$. If we know $$ {\vb{R}}_{x} $$ and $$ {\mathbf{R}}_{y} $$, we can
...
from $$ \mathbf{A} $$
—that is, finding $$ \vb{R}\prime =\mathbf{\text{A – B}} $$
