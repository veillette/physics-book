...
</sub>. This implies that every 12 kg of coal puts 12 kg + 16 kg + 16 kg = 44 kg of carbon dioxide into the atmosphere. Assuming that 1 kg of coal can provide  $$ 2.5 \times 10^{6}  \text{J} $$
...
<div data-type="equation" id="eip-792">
 $$\frac{2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J}}{ 2.50 \times 10^{6}  \text{J/kg}}= 1.0 \times 10^{8}  \text{kg.} $$
</div>
...
<div data-type="equation" id="eip-975">
 $$ 1.0 \times 10^{8}  \text{kg coal}×\frac{ {\text{44 kg CO}}_{2}}{\text{12 kg coal}}= 3.7 \times 10^{8}  {\text{kg CO}}_{2}\text{.} $$
</div>
