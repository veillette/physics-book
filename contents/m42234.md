...
A coal-fired power station is a huge heat engine. It uses heat transfer from burning coal to do work to turn turbines, which are used to generate electricity. In a single day, a large coal power station has  $$2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J} $$
 of heat transfer from coal and  $$1\text{.}\text{48}×{\text{10}}^{\text{14}} \text{J} $$
...
</sub>. This implies that every 12 kg of coal puts 12 kg + 16 kg + 16 kg = 44 kg of carbon dioxide into the atmosphere. Assuming that 1 kg of coal can provide  $$2\text{.}5×{\text{10}}^{6} \text{J} $$
...
<div data-type="equation" id="eip-957">
 $$\begin{array}{lll}W& =& 2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J}–1\text{.}\text{48}×{\text{10}}^{\text{14}} \text{J}\\ & =& 1\text{.}\text{02}×{\text{10}}^{\text{14}} \text{J}\text{.}\end{array} $$
</div>
...
. The work  $$W $$
 was just found to be  $${\text{1.02 × 10}}^{\text{14}} \text{J} $$
, and  $${Q}_{\text{h}} $$
 is given, so the efficiency is

<div data-type="equation" id="eip-607">
 $$\begin{array}{lll}\text{Eff}& =& \frac{1\text{.}\text{02}×{\text{10}}^{\text{14}} \text{J}}{2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J}}\\ & =& 0\text{.}\text{408}\text{, or }\text{40}\text{.}8%\text{}\end{array} $$
</div>
**Strategy for (c)**

The daily consumption of coal is calculated using the information that each day there is  $$2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J} $$
...
<div data-type="equation" id="eip-792">
 $$\frac{2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J}}{2\text{.}\text{50}×{\text{10}}^{6} \text{J/kg}}=1\text{.}0×{\text{10}}^{8} \text{kg.} $$
</div>
...
<div data-type="equation" id="eip-975">
 $$1\text{.}0×{\text{10}}^{8} \text{kg coal}×\frac{ {\text{44 kg CO}}_{2}}{\text{12 kg coal}}=3\text{.}7×{\text{10}}^{8} {\text{kg CO}}_{2}\text{.} $$
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
With  $$2\text{.}\text{56}×{\text{10}}^{6} \text{J} $$
 of heat transfer into this engine, a given cyclical heat engine can do only  $$1\text{.}\text{50}×{\text{10}}^{5} \text{J} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the work output of a cyclical heat engine having a 22.0% efficiency and  $$6\text{.}\text{00}×{\text{10}}^{9} \text{J} $$
 of heat transfer into the engine? (b) How much heat transfer occurs to the environment?

</div>
<div data-type="solution" markdown="1">
(a)  $${\text{1.32 × 10}}^{\text{9}} \text{J} $$
(b)  $${\text{4.68 × 10}}^{\text{9}} \text{J} $$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The engine of a large ship does  $$2\text{.}\text{00}×{\text{10}}^{8} \text{J} $$
 of work with an efficiency of 5.00%. (a) How much heat transfer occurs to the environment? (b) How many barrels of fuel are consumed, if each barrel produces  $$6\text{.}\text{00}×{\text{10}}^{9} \text{J} $$
 of heat transfer when burned?

</div>
<div data-type="solution" markdown="1">
(a)  $${\text{3.80 × 10}}^{\text{9}} \text{J} $$
(b) 0.667 barrels
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) How much heat transfer occurs to the environment by an electrical power station that uses  $$1\text{.}\text{25}×{\text{10}}^{\text{14}} \text{J} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Assume that the turbines at a coal-powered power plant were upgraded, resulting in an improvement in efficiency of 3.32%. Assume that prior to the upgrade the power station had an efficiency of 36% and that the heat transfer into the engine in one day is still the same at  $$2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J} $$
...
(a)  $${\text{8.30 × 10}}^{\text{12}} \text{J} $$
, which is 3.32% of  $${\text{2.50 × 10}}^{\text{14}} \text{J} $$
 .

(b)  $${\text{–8.30 × 10}}^{\text{12}} \text{J} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
This problem compares the energy output and heat transfer to the environment by two different types of nuclear power stations—one with the normal efficiency of 34.0%, and another with an improved efficiency of 40.0%. Suppose both have the same heat transfer into the engine in one day,  $$2\text{.}\text{50}×{\text{10}}^{\text{14}} \text{J} $$
