...
and  $$W $$
 is the net work done by the system. Since  $$\Delta U=0 $$  for a complete cycle, we have
...
just as shown schematically in [[Figure 2]](#Figure2)(b). The problem is that in all processes, there is some heat transfer  $${Q}_{\text{c}} $$
...
The efficiency can be calculated with  $$\text{Eff}=\frac{W}{ {Q}_{\text{h}}} $$
 since  $${Q}_{\text{h}} $$  is given and work  $$W $$
