...
creates the current. More basic than the current that flows is the _emf_ that causes it. The current is a result of an _emf induced by a changing magnetic
field_, whether or not there is a path for current to flow.
