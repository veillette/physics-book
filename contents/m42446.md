...
<div data-type="equation" id="eip-id2426034">
 $$\begin{array}{lll}I& =& \frac{ {\mathrm{c\epsilon }}_{0}{E}_{0}^{2}}{2}\\ & =& \frac{\left( 3.00 \times 10^{8}  \text{m/s}\right)\left(8.85 \times 10^{-12}{\text{C}}^{2}\text{/N}\cdot {\text{m}}^{2}\right){\left(125 \text{V/m}\right)}^{2}}{2}\\ & =& 20.{7 \text{W/m}}^{2}\end{array} $$
</div>
</div>
</div>
