...
<div data-type="equation" id="eip-255">
 $${I}_{\text{ave}}=\frac{\text{1000 W}}{0\text{.}\text{120} {\text{m}}^{2}}= 8.33 \times 10^{3}  {\text{W/m}}^{2}. $$
</div>
...
<div data-type="equation" id="eip-261">
 $$\begin{array}{lll}{E}_{0}& =& \sqrt{\frac{2\left( 8.33 \times 10^{3}  {\text{W/m}}^{2}\right)}{\left( 3.00 \times 10^{8}  \text{m/s}\right)\left(8.85×{\text{10}}^{–12} {\text{C}}^{2}/\text{N}\cdot {\text{m}}^{2}\right)}}\\ & =& 2.51×{\text{10}}^{3} \text{V/m}\text{.}\end{array} $$
</div>
**Solution for (c)**
...
(a)  $$I=\frac{P}{A}=\frac{P}{\pi {r}^{2}}=\frac{ 0.250 \times 10^{-3}  \text{W}}{\pi {\left( 0.500 \times 10^{-3}  \text{m}\right)}^{2}}={\text{318 W/m}}^{2} $$
(b)  $$\begin{array}{lll}{I}_{\text{ave}}& =& \frac{ {\text{cB}}_{0}^{2}}{ {2\mu }_{0}}⇒{B}_{0}={\left(\frac{ {2\mu }_{0}I}{c}\right)}^{1/2}\\ & =& {\left(\frac{2\left(4\pi ×{\text{10}}^{-7} \text{T}\cdot \text{m/A}\right)\left(\text{318}\text{.}{\text{3 W/m}}^{2}\right)}{\text{3.00}×{\text{10}}^{8} \text{m/s}}\right)}^{1/2}\\ & =&  1.63 \times 10^{-6}  \text{T}\end{array} $$
(c)  $$\begin{array}{lll}{E}_{0}& =& {\text{cB}}_{0}=\left(3\text{.00}×{\text{10}}^{8} \text{m/s}\right)\left(\text{1.633}×{\text{10}}^{-6} \text{T}\right)\\ & =&  4.90 \times 10^{2}  \text{V/m}\end{array} $$
</div>
</div>
...
Police radar determines the speed of motor vehicles using the same Doppler-shift technique employed for ultrasound in medical diagnostics. Beats are produced by mixing the double Doppler-shifted echo with the original frequency. If  $$ 1.50 \times 10^{9} \text{-Hz} $$
...
, assuming no other heat transfer and given that its specific heat is  $$ 3.47 \times 10^{3}  \text{J/kg}\cdot \text{ºC} $$
?
...
On its highest power setting, a microwave oven increases the temperature of 0.400 kg of spaghetti by  $$\text{45}\text{.}0º\text{C} $$
 in 120 s. (a) What was the rate of power absorption by the spaghetti, given that its specific heat is  $$ 3.76 \times 10^{3}  \text{J/kg}\cdot \text{ºC} $$
