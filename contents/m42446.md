...
A wave’s energy is proportional to its **amplitude** squared ( $${E}^{2} $$
 or  $${B}^{2} $$
). This is true for waves on guitar strings, for water waves, and for sound waves, where amplitude is proportional to pressure. In electromagnetic waves, the amplitude is the **maximum field strength** of the electric and magnetic fields. (See [\[link\]](#import-auto-id1169737999600).)

Thus the energy carried and the **intensity**  $$I $$
...
<div data-type="equation" id="eip-585">
 $$I=\frac{P}{A}=\frac{1\text{.}\text{00 kW}}{0\text{.}\text{300 m} × 0\text{.}\text{400 m}}. $$
</div>
Here  $$I={I}_{\text{ave}} $$
, so that

<div data-type="equation" id="eip-255">
 $${I}_{\text{ave}}=\frac{\text{1000 W}}{0\text{.}\text{120} {\text{m}}^{2}}=8\text{.}\text{33}×{\text{10}}^{3} {\text{W/m}}^{2}. $$
</div>
Note that the peak intensity is twice the average:

<div data-type="equation" id="eip-213">
 $${I}_{0}=2{I}_{\text{ave}}=1\text{.}\text{67}×{\text{10}}^{4} \text{W}/{\text{m}}^{2}. $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-261">
 $$\begin{array}{lll}{E}_{0}& =& \sqrt{\frac{2\left(8\text{.}\text{33}×{\text{10}}^{3} {\text{W/m}}^{2}\right)}{\left(3\text{.}\text{00}×{\text{10}}^{8} \text{m/s}\right)\left(8.85×{\text{10}}^{–12} {\text{C}}^{2}/\text{N}\cdot {\text{m}}^{2}\right)}}\\ & =& 2.51×{\text{10}}^{3} \text{V/m}\text{.}\end{array} $$
</div>
**Solution for (c)**
...
<div data-type="equation" id="eip-16">
 $$\begin{array}{lll}{B}_{0}& =& \frac{2.51×{\text{10}}^{3} \text{V/m}}{3.0×{\text{10}}^{8} \text{m/s}}\\ & =& 8.35×{\text{10}}^{-6} \text{T}\text{.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-id2426034">
 $$\begin{array}{lll}I& =& \frac{ {\mathrm{c\epsilon }}_{0}{E}_{0}^{2}}{2}\\ & =& \frac{\left(3.00×{\text{10}}^{8} \text{m/s}\right)\left(8.85×{\text{10}}^{\text{–12}}{\text{C}}^{2}\text{/N}\cdot {\text{m}}^{2}\right){\left(1\text{25 V/m}\right)}^{2}}{2}\\ & =& 20.{\text{7 W/m}}^{2}\end{array} $$
</div>
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Find the intensity of an electromagnetic wave having a peak magnetic field strength of  $$4\text{.}\text{00}×{\text{10}}^{-9} \text{T} $$
.
...
(a)  $$I=\frac{P}{A}=\frac{P}{\pi {r}^{2}}=\frac{0\text{.}\text{250}×{\text{10}}^{-3} \text{W}}{\pi {\left(0\text{.}\text{500}×{\text{10}}^{-3} \text{m}\right)}^{2}}={\text{318 W/m}}^{2} $$
(b)  $$\begin{array}{lll}{I}_{\text{ave}}& =& \frac{ {\text{cB}}_{0}^{2}}{ {2\mu }_{0}}⇒{B}_{0}={\left(\frac{ {2\mu }_{0}I}{c}\right)}^{1/2}\\ & =& {\left(\frac{2\left(4\pi ×{\text{10}}^{-7} \text{T}\cdot \text{m/A}\right)\left(\text{318}\text{.}{\text{3 W/m}}^{2}\right)}{\text{3.00}×{\text{10}}^{8} \text{m/s}}\right)}^{1/2}\\ & =& 1\text{.}\text{63}×{\text{10}}^{-6} \text{T}\end{array} $$
(c)  $$\begin{array}{lll}{E}_{0}& =& {\text{cB}}_{0}=\left(3\text{.00}×{\text{10}}^{8} \text{m/s}\right)\left(\text{1.633}×{\text{10}}^{-6} \text{T}\right)\\ & =& 4\text{.}\text{90}×{\text{10}}^{2} \text{V/m}\end{array} $$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A 2.50-m-diameter university communications satellite dish receives TV signals that have a maximum electric field strength (for one channel) of  $$7\text{.}\text{50} \mu V/m $$
. (See [[link]](#import-auto-id1169738077918).) (a) What is the intensity of this wave? (b) What is the power received by the antenna? (c) If the orbiting satellite broadcasts uniformly over an area of  $$1\text{.}\text{50}×{\text{10}}^{\text{13}} {\text{m}}^{2} $$
...
(b)  $$1\text{.}\text{33}×{\text{10}}^{\text{19}} {\text{W/m}}^{2} $$
(c) 13.3 kJ
...
(b)  $${\mathrm{I\propto E}}_{0}^{2}\text{,} {B}_{0}^{2}⇒{E}_{0}^{2}\text{,} {B}_{0}^{2}\propto \frac{1}{ {r}^{2}}⇒{E}_{0}, {B}_{0}\propto \frac{1}{r} $$
</div>
</div>
...
, assuming no other heat transfer and given that its specific heat is  $$3\text{.}\text{47}×{\text{10}}^{3} \text{J/kg}\cdot \text{ºC} $$
?
...
On its highest power setting, a microwave oven increases the temperature of 0.400 kg of spaghetti by  $$\text{45}\text{.}0º\text{C} $$
 in 120 s. (a) What was the rate of power absorption by the spaghetti, given that its specific heat is  $$3\text{.}\text{76}×{\text{10}}^{3} \text{J/kg}\cdot \text{ºC} $$
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$5\text{.}\text{00}×{\text{10}}^{3} {\text{W/m}}^{2} $$
(b)  $$3\text{.}\text{88}×{\text{10}}^{-6} \text{N} $$
(c)  $$5\text{.}\text{18}×{\text{10}}^{-\text{12}} \text{N} $$
</div>
</div>
...
A 200-turn flat coil of wire 30.0 cm in diameter acts as an antenna for FM radio at a frequency of 100 MHz. The magnetic field of the incoming electromagnetic wave is perpendicular to the coil and has a maximum strength of  $$1\text{.}\text{00}×{\text{10}}^{-\text{12}} \text{T} $$
. (a) What power is incident on the coil? (b) What average emf is induced in the coil over one-fourth of a cycle? (c) If the radio receiver has an inductance of  $$2\text{.}\text{50} \mu H $$
...
, then  $$E={E}_{0} \text{sin} 2\pi \text{ft} $$
 and  $$B={B}_{0} \text{sin} 2\pi \text{ft} $$
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$t=0 $$
(b)  $$7\text{.}\text{50}×{\text{10}}^{-\text{10}} \text{s} $$
(c)  $$1\text{.}\text{00}×{\text{10}}^{-9} \text{s} $$
</div>
</div>
...
The peak magnetic field strength in a residential microwave oven is  $$9\text{.}\text{20}×{\text{10}}^{-5} \text{T} $$
. (a) What is the intensity of the microwave? (b) What is unreasonable about this result? (c) What is wrong about the premise?

</div>
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$1\text{.}\text{01}×{\text{10}}^{6} {\text{W/m}}^{2} $$
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$2\text{.}\text{53}×{\text{10}}^{-\text{20}} H $$
