...
A wave’s energy is proportional to its **amplitude** squared ( $${E}^{2} $$
 or  $${B}^{2} $$ ).
This is true for waves on guitar strings, for water waves, and for sound waves, where amplitude is proportional to pressure. In electromagnetic waves, the amplitude is the **maximum field strength** of the electric and magnetic fields. (See [[Figure 1]](#Figure1).)
