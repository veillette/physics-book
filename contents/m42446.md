...
(b)  $$\begin{array}{lll}{I}_{\text{ave}}& =& \frac{ {\text{cB}}_{0}^{2}}{ {2\mu }_{0}}⇒{B}_{0}={\left(\frac{ {2\mu }_{0}I}{c}\right)}^{1/2}\\ & =& {\left(\frac{2\left(4\pi  \times 10^{-7}  \text{T}\cdot \text{m/A}\right)\left(318\text{.}{3 \text{W/m}}^{2}\right)}{ 3.00 \times 10^{8}  \text{m/s}}\right)}^{1/2}\\ & =&  1.63 \times 10^{-6}  \text{T}\end{array} $$
