...
in [[link]](#Figure4). This is not really a practical alternative, and AC is in
...
<div class="problem" markdown="1">
A plug-in transformer, like that in [[link]](#Figure4), supplies 9.00 V to a video game system. (a) How many turns are in its secondary coil, if its input voltage is 120 V and the primary coil has 400 turns? (b) What is its input current when its output is 1.30 A?
