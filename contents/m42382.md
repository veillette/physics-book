...
<div data-type="equation" id="eip-525">
 $$B=\frac{ {\mu }_{0}I}{2 \pi r} \left(\text{long straight wire}\right), $$
</div>

where  $$I $$
 is the current,  $$r $$
 is the shortest distance to the wire, and the constant  $${\mu }_{0}=4\pi  \times 10^{-7} T\cdot \text{m/A} $$
...
. The equation  $$B=\frac{ {\mu }_{0}I}{2 \pi r} $$
...
* {: #import-auto-id1166991829458} The strength of the magnetic field created by current in a long straight wire is given by
  ...
  where
   ...
   $${\mu }_{0}=4\pi  \times 10^{-7} \text{T}\cdot \text{m/A} $$
