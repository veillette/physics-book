...
<div data-type="equation" id="eip-887">
 $$\begin{array}{lll}I& =& \frac{2\pi \text{rB}}{ {\mu }_{0}}=\frac{2\pi \left(5.0×{\text{10}}^{-2} m\right)\left(1.0×{\text{10}}^{-4} T\right)}{4\pi ×{\text{10}}^{-7} T\cdot \text{m/A}}\\ & =& \text{25 A.}\end{array} $$
</div>
**Discussion**
