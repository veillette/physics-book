...
<div data-type="equation" id="eip-887">
 $$\begin{array}{lll}I& =& \frac{2\pi \text{rB}}{ {\mu }_{0}}=\frac{2\pi \left( 5.0 \times 10^{-2}  m\right)\left( 1.0 \times 10^{-4}  T\right)}{4\pi  \times 10^{-7}  T\cdot \text{m/A}}\\ & =& \text{25 A.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-509">
 $$n=\frac{N}{l}=\frac{\text{2000}}{2.00 m}=1000 {\text{m}}^{-1}=10 {\text{cm}}^{-1}\text{.} $$
</div>
**Solution**
...
<div data-type="equation" id="eip-760">
 $$\begin{array}{lll}B& =& {\mu }_{0}\text{nI}=\left(4\pi  \times 10^{-7}  T\cdot \text{m/A}\right)\left(1000 {m}^{-1}\right)\left(\text{1600 A}\right)\\ & =& 2\text{.01 T.}\end{array} $$
</div>
**Discussion**
