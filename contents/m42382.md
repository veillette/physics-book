...
where  $$I $$  is the current,  $$r $$
 is the shortest distance to the wire, and the constant  $$\mu_0 =4\pi  \times 10^{-7} \text{T} \cdot \text{m/A} $$
 is the **permeability of free space**. ( $$\mu_0  $$  is one of the basic constants in nature. We will see later that  $$\mu_0  $$
...
The Earth’s field is about  $$ 5.0 \times 10^{-5} \text{T} $$ ,  and so here  $$B $$
 due to the wire is taken to be  $$ 1.0 \times 10^{-4} \text{T} $$ .
 The equation  $$B=\frac{ \mu_0 I}{2 \pi r} $$
...
<div class="equation" id="eip-34">
 $$B=\mu_0 \text{nI}  \left(\text{inside a solenoid}\right), $$
</div>

where  $$n $$
 is the number of loops per unit length of the solenoid  $$\left(n=N/l \right) $$ ,
 with  $$N $$  being the number of loops and  $$l $$
...
<div class="note" data-has-label="true" id="eip-551" data-label="" markdown="1">
<div class="title">
...
<div class="exercise" id="eip-401">
<div class="problem" id="eip-214" data-element-type="conceptual-questions" markdown="1">
...
: defined as
   ...
   $$\left(n=N/l \right) $$ ,  with
   $$N $$ being the number of loops and
   $$l $$ the length)
^
