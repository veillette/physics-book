...
<div data-type="equation" id="eip-447">
 $$\begin{array}{lll}{\tau }_{\text{max}}& =& \left(100\right)\left(15.0 \text{A}\right)\left(0.100 {\text{m}}^{2}\right)\left(2.00 \text{T}\right)\\ & =& 30.0 \text{N}\cdot m.\end{array} $$
</div>
**Discussion**
