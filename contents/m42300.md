...
[\[link\]](#import-auto-id2235769) shows a simple model of an atom with negative **electrons** orbiting its positive nucleus. The nucleus is positive due to the presence of positively charged **protons**. Nearly all charge in nature is due to electrons and protons, which are two of the three building blocks of most matter. (The third is the neutron, which is neutral, carrying no charge.) Other charge-carrying particles are observed in cosmic rays and nuclear decay, and are created in particle accelerators. All but the electron and proton survive only a short time and are quite rare by comparison.
...
<div data-type="equation" id="eip-717">
 $$\mid {q}_{e}\mid =1\text{.}\text{60}×{\text{10}}^{-\text{19}} \text{C}. $$
</div>
...
<div data-type="equation" id="eip-823">
 $$1.\text{00 C}×\frac{1 \text{proton}}{1\text{.}\text{60}×{\text{10}}^{-\text{19}} \text{C}}=6\text{.}\text{25}×{\text{10}}^{\text{18}} \text{protons}. $$
</div>

Similarly,  $$6\text{.}\text{25}×{\text{10}}^{\text{18}} $$
...
* The SI unit for charge is the coulomb (C), with protons and electrons having charges of opposite sign but equal magnitude; the magnitude of this basic charge
  ...
  <div data-type="equation" id="eip-633">
   $$\mid {q}_{e}\mid =1.60×{\text{10}}^{-\text{19}} \text{C}. $$
  </div>
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
To start a car engine, the car battery moves  $$3\text{.}\text{75}×{\text{10}}^{\text{21}} $$
