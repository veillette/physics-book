...
$$\mid {q}_{e}\mid =1\text{.}\text{60}×{\text{10}}^{-\text{19}}\phantom{\rule{0.25em}{0ex}}\text{C}.$$
</div>
...
$$1.\text{00 C}×\frac{1\phantom{\rule{0.25em}{0ex}}\text{proton}}{1\text{.}\text{60}×{\text{10}}^{-\text{19}}\phantom{\rule{0.25em}{0ex}}\text{C}}=6\text{.}\text{25}×{\text{10}}^{\text{18}}\phantom{\rule{0.25em}{0ex}}\text{protons}.$$
</div>
...
<div data-type="problem" markdown="1">
Common static electricity involves charges ranging from nanocoulombs to microcoulombs. (a) How many electrons are needed to form a charge of $$–2.00\phantom{\rule{0.25em}{0ex}}\text{nC}$$

 (b) How many electrons must be removed from a neutral object to leave a net charge of $$0.500\phantom{\rule{0.25em}{0ex}}µ\text{C}$$
