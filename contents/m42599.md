...
(a) $$\text{0.248}×{\text{10}}^{\text{−10}}\phantom{\rule{0.25em}{0ex}}m$$
...
<div data-type="solution" markdown="1">
(a) $$\text{100}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{eV}$$

, $$1\text{.}\text{60}×{\text{10}}^{-\text{14}}\phantom{\rule{0.25em}{0ex}}\text{J}$$

(b) $$\text{0.124}×{\text{10}}^{-\text{10}}\phantom{\rule{0.25em}{0ex}}\text{m}$$
