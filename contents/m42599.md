...
<div class="equation" id="eip-468">
 $${E}_{1}=-\frac{ {Z}^{2}}{ {1}^{2}}{E}_{0}=-\frac{ {73}^{2}}{1}\left(13.6 eV\right)=-72.5 \text{keV} $$
</div>
and
...
![A 3-D image showing a human skull from the front.](../resources/Figure_31_04_07aa.jpg "This three-dimensional image of a skull was produced by computed tomography, involving analysis of several x-ray slices of the head. (credit: Emailshankar, Wikimedia Commons) "){: #import-auto-id2438454}
