...
Both the $$\mathbf{E} $$ and the charge distribution vary as the current
...
value at the end of one complete cycle. The outgoing wave has an **amplitude**
proportional to the maximum separation of charge. Its **wavelength** $$\left(
\lambda \right) $$ is proportional to the period of the oscillation and, hence,
is smaller for short periods or high frequencies. (As usual, wavelength and **
frequency** $$\left(f\right) $$ are inversely proportional.)

### Electric and Magnetic Waves: Moving Together

Following Ampere’s law, current in the antenna produces a magnetic field, as
shown in [[Figure 2]](#Figure2). The relationship between $$\mathbf{E} $$ and
$$\mathbf{B} $$ is shown at one instant in [[Figure 2]](#Figure2) (a). As the
