...
<div data-type="problem" markdown="1">
What is the maximum electric field strength in an electromagnetic wave that has a maximum magnetic field strength of $$5\text{.}\text{00}×{\text{10}}^{-4}\phantom{\rule{0.25em}{0ex}}\text{T}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The maximum magnetic field strength of an electromagnetic field is $$5×{\text{10}}^{-6}\phantom{\rule{0.25em}{0ex}}\text{T}$$
