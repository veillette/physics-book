...
The direction of the electric field shown in each part of [[Figure 1]](#Figure1) is that produced by the charge distribution in the wire. Justify the direction shown in each part, using the Coulomb force law and the definition of  $$\mathbf{E}=\mathbf{F}/q $$ ,
