...
{\text{c}}=\frac{ v^{2}}{r} ; a_{\text{c}}=r \omega^{2} $$ is the most
convenient to use.
...
<div data-type="equation" id="eip-122">
 $$ a_{\text{c}}=\frac{ v^{2}}{r}=\frac{ \left(25.0 \ms \right)^{2}}{500 \m }=1.25\mss . $$ 
</div>
...
$$ a_{\text{c}}/g=\left( 1.25\mss \right)
/\left(9.80\mss \right)
...
<div data-type="equation" id="eip-576">
 $$ a_{\text{c}}=\left(0.0750 \m \right)\left(7854 \rads \right)^{2}=4.63\times 10^{6}\mss . $$ 
</div>
