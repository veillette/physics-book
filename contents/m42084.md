...
Finally, noting that $$ \Delta v/\Delta t={a}_{\text{c}} $$
and that $$ \Delta s/\Delta t=v $$, the linear or tangential speed, we see that the magnitude of the centripetal
acceleration is
...
<div data-type="equation" id="eip-740">
 $$ {a}_{\text{c}}=\frac{ {v}^{2}}{r}\mathrm{; }{a}_{\text{c}}={\mathrm{r\omega }}^{2}\text{.} $$ 
</div>
...
v=\text{25}\text{.}0\text{m/s} $$
and $$ r=\text{500 m} $$
into the first expression for $$ {a}_{\text{c}} $$
gives

<div data-type="equation" id="eip-122">
 $$ {a}_{\text{c}}=\frac{ {v}^{2}}{r}=\frac{\left(\text{25}\text{.}0\text{m/s}{\right)}^{2}}{\text{500 m}}=1\text{.}\text{25}{\text{m/s}}^{2}\text{.} $$ 
</div>
**Discussion**

To compare this with the acceleration due to gravity $$ \left(
g=9\text{.}80{\text{m/s}}^{2}\right) $$, we take the ratio of $$ {a}_{\text{c}}/g=\left(
1\text{.}\text{25}{\text{m/s}}^{2}\right)
/\left(9\text{.}\text{80}{\text{m/s}}^{2}\right)
...
Calculate the centripetal acceleration of a point 7.50 cm from the axis of an **ultracentrifuge**{: data-type="term" #import-auto-id2449410} spinning at  $$ {\text{7.5 × 10}}^{\text{4}}\text{rev/min.} $$ 
...
To convert $$
7\text{.}\text{50}×{\text{10}}^{4}\text{rev}/\text{min}
$$
...
<div data-type="equation" id="eip-458">
 $$ \omega =\text{7.50}×{\text{10}}^{\text{4}}\frac{\text{rev}}{\text{min}}×\frac{2\pi \text{rad}}{\text{1 rev}}×\frac{1\text{min}}{\text{60}\text{.}\text{0 s}}=\text{7854}\text{ rad/s.} $$ 
</div>
...
<div data-type="equation" id="eip-576">
 $$ {a}_{\text{c}}=\left(0\text{.}\text{0750 m}\right)\left(\text{7854 rad/s}{\right)}^{2}=4\text{.}\text{63}×{\text{10}}^{6}{\text{m/s}}^{2}. $$ 
</div>
...
* {: #import-auto-id1963039} Centripetal acceleration $$ {a}_{\text{c}} $$
  ...
  <div data-type="equation" id="eip-440">
   $$ {a}_{\text{c}}=\frac{ {v}^{2}}{r};{a}_{\text{c}}={\mathrm{r\omega }}^{2}. $$ 
  </div>
...
<div data-type="solution" markdown="1">
a)  $$ 3.\text{47}×{\text{10}}^{\text{4}}\text{m}/{\text{s}}^{2} $$ 

, $$ 3.\text{55}×{\text{10}}^{\text{3}}g $$
b)  $$ 51.\text{1}\text{m}/{\text{s}}^{} $$
</div>
</div>
...
1\text{.}\text{00}×{\text{10}}^{-\text{15}}\text{kg}
$$
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$ \text{1.35}×{\text{10}}^{\text{3}}\text{rpm} $$ 

(b)  $$
\text{8.47}×{\text{10}}^{\text{3}}{\text{m/s}}^{\text{2}}
$$
(c)  $$
\text{8.47}×{\text{10}}^{\text{–12}}\text{N} $$
(d)  $$ \text{865} $$
</div>
</div>
...
(d)  $$ \text{1}.\text{76}×{\text{10}}^{3}\text{N
or 3}.\text{00}w $$, that is, the normal force (upward) is three times her weight.
