...
}\right)}^{2}/r={\mathrm{r\omega }}^{2} \\)

. We can express the magnitude of centripetal acceleration using either of two
equations:
...
g=9\text{.}80\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2}\right) \\)

, we take the ratio of \\( {a}_{\text{c}}/g=\left(
...
radians per second, we obtain the angular velocity \\( \omega \\)
...
or 3}.\text{00}\phantom{\rule{0.25em}{0ex}}w \\)
