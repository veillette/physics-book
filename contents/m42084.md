...
into the above expression, we find $$ a_{\text{c}}={\left(\mathrm{r\omega
...
<div data-type="equation" id="eip-740">
 $$ a_{\text{c}}=\frac{ v^{2}}{r}\mathrm{; }a_{\text{c}}={\mathrm{r\omega }}^{2}\text{.} $$ 
</div>
...
{v}^{2}}{r}\mathrm{; }a_{\text{c}}={\mathrm{r\omega }}^{2} $$
...
To convert $$ 7.50×10^{4}\text{rev}/\text{min}
$$
...
<div data-type="equation" id="eip-458">
 $$ \omega =7.50\times 10^{4}\frac{\text{rev}}{\text{min}}×\frac{2\pi \text{rad}}{\text{1 rev}}×\frac{1\text{min}}{60.0 \text{s}}=7854\text{ rad/s.} $$ 
</div>
Now the centripetal acceleration is given by the second expression in  $$ a_{\text{c}}=\frac{ v^{2}}{r}\mathrm{; }a_{\text{c}}={\mathrm{r\omega }}^{2} $$ 

as

<div data-type="equation" id="eip-969">
 $$ a_{\text{c}}={\mathrm{r\omega }}^{2}\text{.} $$ 
</div>
Converting 7.50 cm to meters and substituting known values gives

<div data-type="equation" id="eip-576">
 $$ a_{\text{c}}=\left(0.0750 \text{m}\right)\left(7854 \text{rad/s}{\right)}^{2}=4.63×10^{6}{\text{m/s}}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-736">
 $$ \frac{ a_{\text{c}}}{g}=\frac{4.63×10^{6}}{9.80}=4.72×10^{5}. $$ 
</div>
**Discussion**
...
* {: #import-auto-id1963039} Centripetal acceleration $$ a_{\text{c}} $$
  ...
  <div data-type="equation" id="eip-440">
   $$ a_{\text{c}}=\frac{ v^{2}}{r};a_{\text{c}}={\mathrm{r\omega }}^{2}. $$ 
  </div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Taking the age of Earth to be about  $$ 4×10^{9} $$ 

years and assuming its orbital radius of $$ 1.5 ×10^{11} $$
