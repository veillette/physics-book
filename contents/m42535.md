...
<div data-type="equation" id="eip-933">
 $$L=v\Delta {t}_{0}=\left( 0.950\right)\left( 3.00 \times 10^{8}  \text{m/s}\right)\left( 2.20 \times 10^{-6}  \text{s}\right)=0\text{.627 km}. $$
</div>
...
4.  {: #import-auto-id2631462} Rearrange the equation to solve for the unknown.
    <div data-type="equation" id="eip-535">
     $$\begin{array}{lll}L& =& \frac{ {L}_{0}}{\gamma }\\ & =& \frac{4.300 ly}{30.00}\\ & =& \text{0.1433 ly}\end{array} $$
    </div>
{: type="1"}
...
(c)  $$\begin{array}{}L=\frac{ {L}_{0}}{\gamma }=\frac{1.387 \times 10^{3}  \text{m}}{3.20}\\ & =& 433.4 m=\text{0.433 km}\end{array} $$
...
(c)  $$\text{Δt}={\text{γΔt}}_{0}⇒\gamma =\frac{\text{Δt}}{ {\text{Δt}}_{0}}=\frac{4.303 \text{y}}{0.1434 \text{y}}= 30.0 $$
