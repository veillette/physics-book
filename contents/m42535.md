...
The muon discussed in [\[link\]](/m42531#fs-id3081310) illustrates this concept. To an observer on the Earth, the muon travels at $$0.950c$$
 for $$7.05\phantom{\rule{0.25em}{0ex}}\mu s$$
...
relative to the Earth. In the muon’s frame of reference, its lifetime is only $$2.20\phantom{\rule{0.25em}{0ex}}\mu s$$
...
(c) $$\begin{array}{}L=\frac{ {L}_{0}}{\gamma }=\frac{1.387×{10}^{3}\phantom{\rule{0.25em}{0ex}}\text{m}}{3.20}\\ & =& 433.4 m=\text{0.433 km}\end{array}$$
