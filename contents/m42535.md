...
<div data-type="equation" id="eip-168">
 $${L}_{0}=v\Delta t=\left(0.950\right)\left(3.00×{\text{10}}^{8} \text{m/s}\right)\left(7.05×{\text{10}}^{-6} \text{s}\right)=2.01 \text{km} $$
</div>
...
<div data-type="equation" id="eip-933">
 $$L=v\Delta {t}_{0}=\left(0\text{.}\text{950}\right)\left(3\text{.}\text{00}×{\text{10}}^{8} \text{m/s}\right)\left(2\text{.}\text{20}×{\text{10}}^{-6} \text{s}\right)=0\text{.627 km}. $$
</div>
...
<strong data-type="term" id="import-auto-id2712476">Proper length </strong> $${L}_{0} $$
...
<strong data-type="term" id="import-auto-id2546857">Length contraction </strong> $$L $$
...
Suppose an astronaut, such as the twin discussed in [Simultaneity and Time Dilation](/m42531), travels so fast that  $$\gamma =\text{30}\text{.}\text{00} $$
...
4.  {: #import-auto-id2631462} Rearrange the equation to solve for the unknown.
    <div data-type="equation" id="eip-535">
     $$\begin{array}{lll}L& =& \frac{ {L}_{0}}{\gamma }\\ & =& \frac{4.300 ly}{\text{30.00}}\\ & =& \text{0.1433 ly}\end{array} $$
    </div>
{: type="1"}
...
, we see that at low velocities ( $$v\text{<<}c $$
...
A particle is traveling through the Earth’s atmosphere at a speed of  $$0\text{.}\text{750}c $$
...
<div data-type="equation" id="eip-id2728057">
 $${\text{L=L}}_{0}\sqrt{1-\frac{ {v}^{2}}{ {c}^{2}}}=\left(2\text{.}\text{50 km}\right)\sqrt{1-\frac{\left(0\text{.}\text{750}c{\right)}^{2}}{ {c}^{2}}}=\text{1}\text{.}\text{65 km} $$
</div>
</div>
</div>
...
* {: #import-auto-id3138892} Length contraction
  ...
  <div data-type="equation" id="eip-584">
   $${\text{L=L}}_{0}\sqrt{1-\frac{ {v}^{2}}{ {c}^{2}}}=\frac{ {L}_{0}}{\gamma }. $$
  </div>
...
<div data-type="problem" markdown="1">
A spaceship, 200 m long as seen on board, moves by the Earth at  $$0\text{.}\text{970}c $$
...
(c)  $$\begin{array}{}L=\frac{ {L}_{0}}{\gamma }=\frac{1.387×{10}^{3} \text{m}}{3.20}\\ & =& 433.4 m=\text{0.433 km}\end{array} $$
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) How long would the muon in [[link]](/m42531#fs-id3081310) have lived as observed on the Earth if its velocity was  $$0\text{.}\text{0500}c $$
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) How long does it take the astronaut in [[link]](#fs-id2555827) to travel 4.30 ly at  $$0\text{.99944}c $$
 (as measured by the Earth-bound observer)? (b) How long does it take according to the astronaut? (c) Verify that these two times are related through time dilation with  $$\text{γ=}\text{30}\text{.}\text{00} $$
 as given.
...
(c)  $$\text{Δt}={\text{γΔt}}_{0}⇒\gamma =\frac{\text{Δt}}{ {\text{Δt}}_{0}}=\frac{4\text{.}\text{303 y}}{0\text{.}\text{1434 y}}=\text{30}\text{.}0 $$
...
A spaceship is heading directly toward the Earth at a velocity of  $$0\text{.}\text{800}c $$
. The astronaut on board claims that he can send a canister toward the Earth at  $$1\text{.}\text{20}c $$
