...
Refraction is responsible for dispersion in rainbows and many other situations. The angle of refraction depends on the index of refraction, as we saw in [The Law of Refraction](/m42459). We know that the index of refraction  $$n $$
 ...
 also depends on wavelength. (See [\[link\]](#Table1). Note that, for a given medium,  $$n $$
...
(a) What is the ratio of the speed of red light to violet light in diamond, based on [[link]](#Table1)? (b) What is this ratio in polystyrene? (c) Which is more dispersive?
