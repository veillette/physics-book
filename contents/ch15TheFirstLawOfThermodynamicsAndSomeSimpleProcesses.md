...
engines. [[Figure 1]](#Figure1) shows schematically how the first law of
...
See the symbols as shown in [[Figure 2]](#Figure2). Now $$F=PA $$ , and so
...
[[Figure 3]](#Figure3) shows a graph of pressure versus volume (that is, a $$PV
...
We can see where this leads by considering [[Figure 4]](#Figure4)(a), which
...
in [[Figure 4]](#Figure4)(b), then work is done on the system. The area under
...
in [[Figure 5]](#Figure5)(a), where more work is done in going from A to C by
...
the system follows the cyclical path ABCDA, as in [[Figure 5]](#Figure5)(b),
...
area inside the loop it forms on a $$PV $$ diagram, as [[Figure 5]](#Figure5)(c)
...
[[Figure 6]](#Figure6)(a) shows two other important processes on a $$PV $$
...
Also shown in [[Figure 6]](#Figure6)(a) is a curve AC for an **adiabatic**
...
Both isothermal and adiabatic processes such as shown in [[Figure 6]](#Figure6)
...
in [[Figure 2]](#Figure2)), and its environment is the piston, cylinder, and the
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
What is the net work output of a heat engine that follows path ABDA in the figure above, with a straight line from B to D? Why is the work output less than for path ABCDA? Explicitly show how you follow the steps in the [Problem-Solving Strategies for Thermodynamics](../contents/m42236#fs-id1169738116696).
