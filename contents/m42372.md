...
The *direction* of the magnetic force  $$\mathbf{\text{F}} $$
 ...
 and  $$\mathbf{\text{B}} $$ ,
 as determined by the **right hand rule 1**{: class="term"} (or RHR-1), which is illustrated in [\[link\]](#import-auto-id1473446). RHR-1 states that, to determine the direction of the magnetic force on a positive moving charge, you point the thumb of the right hand in the direction of  $$\mathbf{\text{v}} $$ ,
...
* Magnetic fields exert a force on a moving charge *q*, the magnitude of which is
  ...
  where
   $$\theta  $$ is the angle between the directions of
   $$v $$ and
   $$B $$ . 
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
(a) A physicist performing a sensitive measurement wants to limit the magnetic force on a moving charge in her equipment to less than  $$ 1.00 \times 10^{-12}  N $$ .
