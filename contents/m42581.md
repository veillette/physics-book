...
<div data-type="equation" id="eip-10">
 $$\begin{array}{lll}p& =& \frac{\text{6.63}×{\text{10}}^{-\text{34}} \text{J}\cdot s}{\text{550}×{\text{10}}^{–9} \text{m}}\\ & =& 1\text{.}\text{21}×{\text{10}}^{-\text{27}} \text{kg}\cdot \text{m/s}\text{.}\end{array} $$
</div>
**Discussion for (a)**
...
where  $$p $$
 is the photon momentum found in part (a). Entering known values (noting that a microgram is  $${\text{10}}^{-9} \text{kg} $$
) gives

<div data-type="equation" id="eip-683">
 $$\begin{array}{lll}v& =& \frac{1\text{.}\text{21}×{\text{10}}^{-\text{27}} \text{kg}\cdot \text{m/s}}{1\text{.}\text{00}×{\text{10}}^{–9} \text{kg}}\\ & =& 1\text{.}\text{21}×{\text{10}}^{\text{–18}} \text{m/s.}\end{array} $$
</div>
**Discussion**
...
<div data-type="solution" markdown="1">
(a)  $$1.3×{\text{10}}^{-\text{19}} \text{J} $$
(b)  $$2\text{.}1×{\text{10}}^{\text{23}} $$
(c)  $$1\text{.}4×{\text{10}}^{2} \text{s} $$
</div>
</div>
...
<div data-type="solution" markdown="1">
(a)  $$3\text{.}\text{35}×{\text{10}}^{5} \text{J} $$
(b)  $$1\text{.}\text{12}×{\text{10}}^{\text{–3}} \text{kg}\cdot \text{m/s} $$
(c)  $$1\text{.}\text{12}×{\text{10}}^{\text{–3}} \text{m/s} $$
(d)  $$6.23×{\text{10}}^{\text{–7}} \text{J} $$
</div>
</div>
...
(b)  $$5\text{.}\text{33}×{\text{10}}^{-\text{16}} \text{kg}\cdot \text{m/s} $$
(c)  $$1\text{.}\text{24}×{\text{10}}^{-\text{18}} \text{m} $$
</div>
</div>
...
<div data-type="solution" markdown="1">
(a)  $$1\text{.}\text{62}×{\text{10}}^{3} \text{m/s} $$
(b)  $$4\text{.}\text{42}×{\text{10}}^{-\text{19}} \text{J} $$
 for photon,  $$1\text{.}\text{19}×{\text{10}}^{-\text{24}} \text{J} $$
...
<div data-type="solution" markdown="1">
(a)  $$2\text{.}\text{30}×{\text{10}}^{-6} \text{m} $$
(b)  $$3\text{.}\text{20}×{\text{10}}^{-\text{12}} \text{m} $$
</div>
</div>
...
<div data-type="solution" markdown="1">
 $$3\text{.}\text{69}×{\text{10}}^{-4} \mathrm{ºC} $$
</div>
</div>
...
(b)  $$1\text{.}\text{33}×{\text{10}}^{-5} \text{kg}\cdot \text{m/s} $$
(c)  $$1\text{.}\text{33}×{\text{10}}^{-5} \text{N} $$
(d) yes
...
Sunlight above the Earth’s atmosphere has an intensity of  $$1\text{.}\text{30} {\text{kW/m}}^{2} $$
