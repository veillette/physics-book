...
<div data-type="equation" id="eip-10">
 $$\begin{array}{lll}p& =& \frac{\text{6.63}×{\text{10}}^{-\text{34}} \text{J}\cdot s}{\text{550}×{\text{10}}^{–9} \text{m}}\\ & =&  1.21 \times 10^{-27}  \text{kg}\cdot \text{m/s}\text{.}\end{array} $$
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-683">
 $$\begin{array}{lll}v& =& \frac{ 1.21 \times 10^{-27}  \text{kg}\cdot \text{m/s}}{1\text{.}\text{00}×{\text{10}}^{–9} \text{kg}}\\ & =& 1\text{.}\text{21}×{\text{10}}^{\text{–18}} \text{m/s.}\end{array} $$
</div>
**Discussion**
