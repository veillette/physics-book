...
<div class="equation" id="eip-683">
 $$\begin{array}{lll}v& =& \frac{ 1.21 \times 10^{-27}  \text{kg}\cdot \text{m/s}}{ 1.00 \times 10^{-9} \text{kg}}\\ & =&  1.21 \times 10^{-18} \text{m/s.}\end{array} $$
</div>
**Discussion**
...
The momentum of light is exactly reversed when reflected straight back from a mirror, assuming negligible recoil of the mirror. Thus the change in momentum is twice the photon momentum. Suppose light of intensity  $$1\text{.}{00 \text{kW/m}}^{2} $$
 reflects from a mirror of area  $$2\text{.}{00 \text{m}}^{2} $$
