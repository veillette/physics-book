...
, we get $x=X$
 ...
 again because $\text{cos}\phantom{\rule{0.25em}{0ex}}2\pi =1$
...
$v\left(t\right)=-{v}_{\text{max}}\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\left(\frac{2\pi t}{T}\right),$
</div>
