...
<div data-type="equation">
 $$ \text{KE}_{\text{i}}+\text{PE}_{\text{i}}+W_{\text{nc}}+\text{OE}_{\text{i}}=\text{KE}_{\text{f}}+\text{PE}_{\text{f}}+\text{OE}_{\text{f}}. $$ 
</div>
...
Equating  $$ \Delta \text{PE}_{g} $$ and $$ \Delta \text{KE} $$, we obtain 
