...
We examine the effects of phase change more precisely by considering adding heat into a sample of ice at  $$-20\text{ºC} $$
 ([\[link\]](#import-auto-id2928714)). The temperature of the ice rises linearly, absorbing heat at a constant rate of  $$0.50\text{cal/g}\cdot \text{ºC} $$
...
2.  {: #import-auto-id3126422} Calculate the terms in the numerator:
    ...
    <div class="equation" id="eip-291">
     $${m}_{\text{ice}}{L}_{\text{f}}=\left(0.018\text{kg}\right)\left(334 000\text{J/kg}\right)\text{=6012 }\text{J} \text{.}  $$
    </div>

3.  {: #import-auto-id2399182} Calculate the denominator:
    <div class="equation" id="eip-649">
     $$\left({m}_{\text{soda}}+{m}_{\text{ice}}\right){c}_{\text{W}}=\left(0.25\text{kg + 0}\text{.}018 \text{kg}\right)\left(4186 \text{K/}\left(\text{kg}\cdot \text{ºC}\right)\text{=1122 J/º}\text{C}\text{.} $$
    </div>

4.  {: #import-auto-id2591197} Calculate the final temperature:
    <div class="equation" id="eip-817">
     $${T}_{\text{f}}=\frac{20 930 \text{J}-6012 \text{J}}{1122 \text{J/º}\text{C}}=13 \text{º}\text{C} \text{.}  $$
    </div>
{: type="1"}
