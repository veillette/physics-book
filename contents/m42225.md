...
. Using the equation for a change in temperature and the value for water from [\[link\]](#import-auto-id3260303), we find that  $$Q={\text{mL}}_{\text{f}}=\left( 1.0 \text{kg}\right)\left(334 \text{kJ/kg}\right)=334 \text{kJ} $$
 ...
 to  $$ 79.8º\text{C} $$
. Even more energy is required to vaporize water; it would take 2256 kJ to change 1 kg of liquid water at the normal boiling point ( $$100 \text{º}\text{C} $$
...
We examine the effects of phase change more precisely by considering adding heat into a sample of ice at  $$-20 \text{º}\text{C} $$
 ([\[link\]](#import-auto-id2928714)). The temperature of the ice rises linearly, absorbing heat at a constant rate of  $$0.50\text{ cal/g}\cdot º\text{C} $$
...
. Once at this temperature, the ice begins to melt until all the ice has melted, absorbing 79.8 cal/g of heat. The temperature remains constant at  $$0º\text{C} $$
 during this phase change. Once all the ice has melted, the temperature of the liquid water rises, absorbing heat at a new constant rate of  $$1.00\text{ cal/g}\cdot º\text{C} $$
. At  $$100 \text{º}\text{C} $$
, the water begins to boil and the temperature again remains constant while the water absorbs 539 cal/g of heat during this phase change. When all the liquid has become steam vapor, the temperature rises again, absorbing heat at a rate of  $$0.482\text{ cal/g}\cdot º\text{C} $$
.
...
Water can evaporate at temperatures below the boiling point. More energy is required than at the boiling point, because the kinetic energy of water molecules at temperatures below  $$100 \text{º}\text{C} $$
 is less than that at  $$100 \text{º}\text{C} $$
, hence less energy is available from random thermal motions. Take, for example, the fact that, at body temperature, perspiration from the skin requires a heat input of 2428 kJ/kg, which is about 10 percent higher than the latent heat of vaporization at  $$100 \text{º}\text{C} $$
...
Three ice cubes are used to chill a soda at  $$20 \text{º}\text{C} $$
 with mass  $${m}_{\mathrm{soda}}=0.25 \text{ }\text{kg} $$
...
. The heat given off by the soda is  $${Q}_{\text{soda}}={m}_{\text{soda}}{c}_{\text{W}}\left({T}_{\text{f}}-20 \text{º}\text{C}\right) $$
. Since no heat is lost,  $${Q}_{\text{ice}}=-{Q}_{\text{soda}} $$
, so that

<div data-type="equation" id="eip-17">
 $${m}_{\text{ice}}{L}_{\text{f}}+{m}_{\text{ice}}{c}_{W}\left({T}_{\text{f}}-0º\text{C}\right)=-{m}_{\text{soda}}{c}_{W}\left({T}_{\text{f}}-20 \text{º}\text{C}\right)\text{.} $$
</div>
...
<div data-type="equation" id="eip-460">
 $${T}_{\text{f}}=\frac{ {m}_{\text{soda}}{c}_{W}\left(20 \text{º}\text{C}\right)-{m}_{\text{ice}}{L}_{\text{f}}}{\left({m}_{\mathrm{soda}}+{m}_{\text{ice}}\right){c}_{W}}\text{.} $$
</div>
**Solution**

1.  {: #import-auto-id3256034} Identify the known quantities. The mass of ice is
     $${m}_{\text{ice}}=3\text{×}6.0 \text{g}= 0.018\text{ kg} $$
    
    and the mass of soda is
     $${m}_{\text{soda}}=0.25\text{ }\text{kg} $$
    
    .
2.  {: #import-auto-id3126422} Calculate the terms in the numerator:
    <div data-type="equation" id="eip-96">
     $${m}_{\text{soda}}{c}_{W}\left(20 \text{º}\text{C}\right)=\left(0\text{.25 kg}\right)\left(4186 \text{ J/kg}\cdot º\text{C}\right)\left(20 \text{º}\text{C}\right)=20 930 \text{ J} $$
    </div>
    
    and
    
    <div data-type="equation" id="eip-291">
     $${m}_{\text{ice}}{L}_{\text{f}}=\left(0.018\text{ }\text{kg}\right)\left(334 000\text{ J/kg}\right)\text{=6012 }\text{J.} $$
    </div>

3.  {: #import-auto-id2399182} Calculate the denominator:
    <div data-type="equation" id="eip-649">
     $$\left({m}_{\text{soda}}+{m}_{\text{ice}}\right){c}_{\text{W}}=\left(0.25\text{ }\text{kg + 0}\text{.}018 \text{kg}\right)\left(4186 \text{K/}\left(\text{kg}\cdot º\text{C}\right)\text{=1122 J/º}\text{C}\text{.} $$
    </div>

4.  {: #import-auto-id2591197} Calculate the final temperature:
    <div data-type="equation" id="eip-817">
     $${T}_{\text{f}}=\frac{20 930 \text{ J}-6012 \text{ J}}{1122 \text{ J/º}\text{C}}=13 \text{º}\text{C.} $$
    </div>
{: type="1"}
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
In very humid climates where there are numerous bodies of water, such as in Florida, it is unusual for temperatures to rise above about  $$35 \text{º}\text{C}\left(95 \text{º}\text{F}\right) $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) How much heat transfer is required to raise the temperature of a 0.750-kg aluminum pot containing 2.50 kg of water from  $$ 30.0º\text{C} $$
 to the boiling point and then boil away 0.750 kg of water? (b) How long does this take if the rate of heat transfer is 500 W  $$1 \text{watt = 1 }\text{joule/second} \left(1 \text{ W = 1 J/s}\right) $$
?
...
On a trip, you notice that a 3.50-kg bag of ice lasts an average of one day in your cooler. What is the average power in watts entering the ice if it starts at  $$0º\text{C} $$
 ...
 water in exactly one day  $$1 \text{ watt = 1 joule/second}  \left(1 \text{ W = 1 J/s}\right) $$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
On a certain dry sunny day, a swimming pool’s temperature would rise by  $$1.50\text{º}\text{C} $$
...
(a) How much heat transfer is necessary to raise the temperature of a 0.200-kg piece of ice from  $$-20.0º\text{C} $$
 to  $$130 \text{º}\text{C} $$
...
(c) How many years would it take sunlight alone to melt ice this thick, if the ice absorbs an average of  $$100 \text{ }{\text{W/m}}^{2} $$
, 12.00 h per day?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
How many grams of coffee must evaporate from 350 g of coffee in a 100-g glass cup to cool the coffee from  $$ 95.0º\text{C} $$
 to  $$ 45.0º\text{C} $$
...
(a) It is difficult to extinguish a fire on a crude oil tanker, because each liter of crude oil releases  $$ 2.80 \times 10^{7}  \text{J} $$
 of energy when burned. To illustrate this difficulty, calculate the number of liters of water that must be expended to absorb the energy released by burning 1.00 L of crude oil, if the water has its temperature raised from  $$ 20.0º\text{C} $$
 to  $$100 \text{º}\text{C} $$
, it boils, and the resulting steam is raised to  $$300 \text{º}\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A 0.250-kg aluminum bowl holding 0.800 kg of soup at  $$ 25.0º\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A 0.0500-kg ice cube at  $$- 30.0º\text{C} $$
 is placed in 0.400 kg of  $$ 35.0º\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
If you pour 0.0100 kg of  $$ 20.0º\text{C} $$
 water onto a 1.20-kg block of ice (which is initially at  $$- 15.0º\text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Indigenous people sometimes cook in watertight baskets by placing hot rocks into water to bring it to a boil. What mass of  $$500 \text{º}\text{C} $$
 rock must be placed in 4.00 kg of  $$ 15.0º\text{C} $$
 water to bring its temperature to  $$100 \text{º}\text{C} $$
...
(a) Calculate the heat transfer necessary to evaporate this amount of liquid nitrogen and raise its temperature to  $$3.00\text{º}\text{C} $$
. (Use  $${c}_{p} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Some gun fanciers make their own bullets, which involves melting and casting the lead slugs. How much heat transfer is needed to raise the temperature and melt 0.500 kg of lead, starting from  $$ 25.0º\text{C} $$
?
...
* {: data-type="footnote-ref" #footnote2} [2](#footnote-ref2){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">At  $$ 37.0º\text{C} $$
   (body temperature), the heat of vaporization  $${L}_{v} $$
   for water is 2430 kJ/kg or 580 kcal/kg</span>
* {: data-type="footnote-ref" #footnote3} [3](#footnote-ref3){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">At  $$37.0º\text{C} $$
   (body temperature), the heat of vaporization  $${L}_{v} $$
   for water is 2430 kJ/kg or 580 kcal/kg</span>
