...
<div data-type="equation" id="eip-460">
 $${T}_{\text{f}}=\frac{ {m}_{\text{soda}}{c}_{W}\left(20\text{ºC}\right)-{m}_{\text{ice}}{L}_{\text{f}}}{\left({m}_{\mathrm{soda}}+{m}_{\text{ice}}\right){c}_{W}}\text{.} $$
</div>
**Solution**
...
3.  {: #import-auto-id2399182} Calculate the denominator:
    <div data-type="equation" id="eip-649">
     $$\left({m}_{\text{soda}}+{m}_{\text{ice}}\right){c}_{\text{W}}=\left(0.25\text{ }\text{kg + 0}\text{.}018 \text{kg}\right)\left(4186 \text{K/}\left(\text{kg}\cdot \text{ºC}\right)\text{=1122 J/º}\text{C}\text{.} $$
    </div>
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
In very humid climates where there are numerous bodies of water, such as in Florida, it is unusual for temperatures to rise above about  $$35\text{ºC}\left(95 \text{º}\text{F}\right) $$
...
* {: data-type="footnote-ref" #footnote2} [2](#footnote-ref2){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">At  $$ 37.0\text{ºC} $$
   (body temperature), the heat of vaporization  $${L}_{v} $$
   for water is 2430 kJ/kg or 580 kcal/kg</span>
* {: data-type="footnote-ref" #footnote3} [3](#footnote-ref3){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">At  $$37.0\text{ºC} $$
   (body temperature), the heat of vaporization  $${L}_{v} $$
   for water is 2430 kJ/kg or 580 kcal/kg</span>
