...
2.  {: #import-auto-id3126422} Calculate the terms in the numerator:
    <div data-type="equation" id="eip-96">
     $${m}_{\text{soda}}{c}_{W}\left(\text{20º}\text{C}\right)=\left(0\text{.25 kg}\right)\left(\text{4186 J/kg}\cdot º\text{C}\right)\left(\text{20º}\text{C}\right)=20 \text{930 J} $$
    </div>
    
    and
    
    <div data-type="equation" id="eip-291">
     $${m}_{\text{ice}}{L}_{\text{f}}=\left(0\text{.}\text{018 }\text{kg}\right)\left(334 000\text{ J/kg}\right)\text{=6012 }\text{J.} $$
    </div>
