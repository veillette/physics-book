...
3.  {: #import-auto-id2399182} Calculate the denominator:
    <div data-type="equation" id="eip-649">
     $$\left({m}_{\text{soda}}+{m}_{\text{ice}}\right){c}_{\text{W}}=\left(0\text{.}\text{25 }\text{kg + 0}\text{.}018 \text{kg}\right)\left(4186 \text{K/}\left(\text{kg}\cdot º\text{C}\right)\text{=1122 J/º}\text{C}\text{.} $$
    </div>
