...
. Using the equation for a change in temperature and the value for water from [\[link\]](#import-auto-id3260303), we find that $$Q={\text{mL}}_{\text{f}}=\left(1\text{.}0\phantom{\rule{0.25em}{0ex}}\text{kg}\right)\left(\text{334}\phantom{\rule{0.25em}{0ex}}\text{kJ/kg}\right)=\text{334}\phantom{\rule{0.25em}{0ex}}\text{kJ}$$
...
, where $${L}_{\text{s}}$$
 is the **heat of sublimation**{: data-type="term" #import-auto-id1860317}, which is the energy required to change 1.00 kg of a substance from the solid phase to the vapor phase. $${L}_{\text{s}}$$
...
(b) $$4\text{.}\text{94}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{s}$$
</div>
</div>
...
On a trip, you notice that a 3.50-kg bag of ice lasts an average of one day in your cooler. What is the average power in watts entering the ice if it starts at $$0º\text{C}$$
 ...
 water in exactly one day $$\text{1 watt = 1 joule/second}\phantom{\rule{0.25em}{0ex}} \left(\text{1 W = 1 J/s}\right)$$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) It is difficult to extinguish a fire on a crude oil tanker, because each liter of crude oil releases $$2\text{.}\text{80}×{\text{10}}^{7}\phantom{\rule{0.25em}{0ex}}\text{J}$$
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a) $$1\text{.}\text{57}×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{kcal}$$
(b) $$\text{18}\text{.3 kW}\cdot \text{h}$$
(c) $$1\text{.}\text{29}×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{kcal}$$
</div>
</div>
