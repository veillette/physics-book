...
<div data-type="equation" id="eip-705">
 $$c=2\text{.}\text{99792458}×{\text{10}}^{8} \text{m/s}\approx 3\text{.}\text{00}×{\text{10}}^{8} \text{m/s,} $$
</div>

where the approximate value of  $$3\text{.}\text{00}×{\text{10}}^{8} \text{m/s} $$
...
<div data-type="equation" id="eip-293">
 $$\begin{array}{ccc}v& =& \frac{3\text{.}\text{00}×{\text{10}}^{8} \text{m/s}}{1\text{.}\text{923}}\\ & =& \text{1.56}×{\text{10}}^{8} \text{m/s}\text{.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation">
 $$\begin{array}{ll}{n}_{2}& =& 1\text{.}\text{00}\frac{\text{sin} \text{30}\text{.}0º}{\text{sin} \text{22}\text{.}0º}=\frac{0\text{.}\text{500}}{0\text{.}\text{375}}\\ & =& 1.33.\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-1000">
 $$\text{sin} {\theta }_{2}=\frac{1\text{.}\text{00}}{2\text{.}\text{419}}\text{sin} \text{30}\text{.}0º\text{=}\left(0\text{.}\text{413}\right)\left(0\text{.}\text{500}\right)=0\text{.}\text{207}. $$
</div>
The angle is thus
...
<div data-type="solution" markdown="1">
 $$2\text{.}\text{25}×{\text{10}}^{8} \text{m/s} $$
 in water

 $$2\text{.}\text{04}×{\text{10}}^{8} \text{m/s} $$
 in glycerine
...
Calculate the index of refraction for a medium in which the speed of light is  $$2\text{.}\text{012}×{\text{10}}^{8} \text{m/s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In what substance in [[link]](#eip-69) is the speed of light <span> $$2\text{.}\text{290}×{\text{10}}^{8} \text{m/s} $$
? </span>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
There was a major collision of an asteroid with the Moon in medieval times. It was described by monks at Canterbury Cathedral in England as a red glow on and around the Moon. How long after the asteroid hit the Moon, which is  $$3\text{.}\text{84}×{\text{10}}^{5} \text{km} $$
...
Light traveling from water to a gemstone strikes the surface at an angle of  $$\text{80}\text{.}0º $$
