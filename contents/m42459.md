...
<div data-type="equation" id="import-auto-id1163675081185">
 $${n}_{1} \text{sin} {\theta }_{1}={n}_{2} \text{sin} {\theta }_{2}. $$
</div>
...
<div data-type="equation" id="eip-679">
 $${n}_{2}={n}_{1}\frac{\text{sin} {\theta }_{1}}{\text{sin} {\theta }_{2}}. $$
</div>
Entering known values,

<div data-type="equation">
 $$\begin{array}{ll}{n}_{2}& =&  1.00\frac{\text{sin}  30.0º}{\text{sin}  22.0º}=\frac{ 0.500}{ 0.375}\\ & =& 1.33.\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-826">
 $$\text{sin} {\theta }_{2}=\frac{ {n}_{1}}{ {n}_{2}}\text{sin} {\theta }_{1}. $$
</div>
Entering known values,

<div data-type="equation" id="eip-1000">
 $$\text{sin} {\theta }_{2}=\frac{ 1.00}{ 2.419}\text{sin}  30.0º=\left( 0.413\right)\left( 0.500\right)= 0.207. $$
</div>
The angle is thus

<div data-type="equation" id="import-auto-id1163675081869">
 $${\theta }_{2}={\text{sin}}^{-1} 0.207= 11.9º. $$
</div>
**Discussion**
