...
<div class="note" data-has-label="true" id="eip-88" data-label="">
<div class="title">
Value of the Speed of Light
</div>
<div class="equation" id="eip-id2221336">
 $$c= 2.99792458 \times 10^{8}  \text{m/s}\approx  3.00 \times 10^{8}  \text{m/s} $$
</div>
</div>

<div class="note" data-has-label="true" id="eip-838" data-label="">
<div class="title">
Index of Refraction
</div>
<div class="equation" id="eip-id1929258">
 $$n=\frac{c}{v} $$
</div>
</div>

That is,  $$n\ge 1 $$ .
 [\[link\]](#Table1) gives the indices of refraction for some representative substances. The values are listed for a particular wavelength of light, because they vary slightly with wavelength. (This can have important effects, such as colors produced by a prism.) Note that for gases,  $$n $$
...
<div class="example" id="eip-751" markdown="1">
<div class="title">
...
The index of refraction for zircon is given as 1.923 in [\[link\]](#Table1), and  $$c $$
...
Find the index of refraction for medium 2 in [\[link\]](#Figure3)(a), assuming medium 1 is air and given the incident angle is  $$ 30.0º $$
 and the angle of refraction is  $$ 22.0º $$.

**Strategy**

The index of refraction for air is taken to be 1 in most cases (and up to four significant figures, it is 1.000). Thus  $${n}_{1}= 1.00 $$
 here. From the given information,  $${\theta }_{1}= 30.0º $$
 and  $${\theta }_{2}= 22.0º $$ .
...
Again the index of refraction for air is taken to be  $${n}_{1}= 1.00 $$ ,
 and we are given  $${\theta }_{1}= 30.0º $$ .
 We can look up the index of refraction for diamond in [\[link\]](#Table1), finding  $${n}_{2}= 2.419 $$ .
...
*  The speed of light in vacuum
   $$c= 2.99792458 \times 10^{8}  \text{m/s}\approx  3.00 \times 10^{8}  \text{m/s}. $$
*  Index of refraction
   $$n=\frac{c}{v} $$ ,  where    $$v $$ is the speed of light in the material,
...
<div class="exercise" id="eip-332" data-element-type="problems-exercises">
<div class="problem" id="eip-194" markdown="1">
Calculate the index of refraction for a medium in which the speed of light is  $$ 2.012 \times 10^{8}  \text{m/s} $$ ,
 and identify the most likely substance based on [[link]](#Table1).

</div>
<div class="solution" id="eip-133" markdown="1">
 $$ 1.490 $$, polystyrene 
...
<div class="exercise" id="eip-955" data-element-type="problems-exercises">
<div class="problem" id="eip-70" markdown="1">
...
<div class="solution" id="eip-555" markdown="1">
 $$n= 1.46 $$ ,  fused quartz
...
<div class="problem" id="eip-277" markdown="1">
Suppose [[link]](#Figure5) represents a ray of light going from air through crown glass into water, such as going into a fish tank. Calculate the amount the ray is displaced by the glass ( $$\Delta x $$ ), 
...
<div class="solution" id="eip-572" markdown="1">
(a) 0.898
...
Consider sunlight entering the Earth’s atmosphere at sunrise and sunset—that is, at a  $$90 \text{º} $$
...
<div class="exercise" id="eip-617" data-element-type="problems-exercises">
<div class="problem" id="eip-id2150346" markdown="1">
**Unreasonable Results**

Light traveling from water to a gemstone strikes the surface at an angle of  $$ 80.0º $$
 and has an angle of refraction of  $$ 15.2º $$ .
