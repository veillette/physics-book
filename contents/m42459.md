...
Again the index of refraction for air is taken to be  $${n}_{1}= 1.00 $$ ,
 ...
 We can look up the index of refraction for diamond in [\[link\]](#eip-69), finding  $${n}_{2}= 2.419 $$ .
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
In what substance in [[link]](#eip-69) is the speed of light <span> $$ 2.290 \times 10^{8}  \text{m/s} $$ ?
 </span>
