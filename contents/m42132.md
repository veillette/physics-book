...
<div data-type="equation" id="eip-id2384618">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& ma =0=F_{\text{s}}-w\\ {F}_{\text{s}}& =& w=mg \\ {F}_{\text{s}}& =& \left(75.0 \text{kg}\right)\left(9.80 \text{m/s}^2\right)\\ {F}_{\text{s}}& =& 735 \text{N.}
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id1351504">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& \left(70.0 \text{kg}\right)\left(3.20 \text{m/s}^2\right)\\ & =& 224 \text{N}.
\end{array} $$ 
</div>
**Discussion for (b)**
