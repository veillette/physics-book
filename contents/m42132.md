...
, as shown in the free-body diagram in [\[link\]](#import-auto-id1221020)(b).
...
direction of the net applied force \\( {\mathbf{\text{F}}}_{\text{app}} \\)
...
, since it acts to slow down the acceleration. Therefore, the net external force
...
, the magnitude of the force the person exerts downward on
...
a=1.20\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} \\)
...
stationary—acceleration is zero because \\( a=\frac{\Delta v}{\Delta t} \\)
...
, then the scale reading will be zero and the person will *appear* to be
weightless.
...
the change in velocity is \\( \Delta v=8.00 m/s \\)
...
its mass is \\(
6\text{.}\text{00}×{\text{10}}^{-7}\phantom{\rule{0.25em}{0ex}}\text{kg} \\)
...
3\text{.}\text{50}×{\text{10}}^{7}\phantom{\rule{0.25em}{0ex}}\text{N} \\)
