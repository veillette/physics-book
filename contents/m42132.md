...
<div data-type="equation" id="eip-id2384618">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& \text{ma}=0=F_{\text{s}}-w\\ {F}_{\text{s}}& =& w=\text{mg}\\ {F}_{\text{s}}& =& \left(75.0 \text{kg}\right)\left(9.80 \text{m/s}^2\right)\\ {F}_{\text{s}}& =& 735 \text{N.}\end{array} $$ 
</div>
