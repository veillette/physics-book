...
<div data-type="equation" id="eip-id2122298">
 $$ {T}_{1}\cos\left(30^\circ\right)=T_{2}\cos\left(45^\circ\right). $$ 
</div>
Thus,
...
<div data-type="equation" id="eip-id1925561">
 $$ {T}_{1}\sin\{\left(30^{\circ} \right)\}+T_{2}\sin\left(45^\circ\right)=w. $$ 
</div>
...
<div data-type="equation" id="eip-id2259246">
 $$ {T}_{1}\left(0.500\right)+\left(1.225{T}_{1}\right)\left(0.707\right)=w=mg , $$ 
</div>
which yields

<div data-type="equation" id="eip-id2556360">
 $$ \left(1.366\right){T}_{1}=\left(15.0 \text{kg}\right)\left(9.80 \text{m/s}^2\right). $$ 
</div>
