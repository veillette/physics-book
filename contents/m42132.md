...
F_{\text{app}}& =& \sqrt{\left(2.7\times 10^{5}\text{N} \right)^{2}+\left(3.6\times 10^{5}\text{N} \right)^{2}}
& =& 4.5\times 10^{5}\text{N} .
\end{array} $$ 
</div>
...
\theta & =& {\tan}^{-1}\left(\frac{3.6\times 10^{5}\text{N}}{2.7\times 10^{5}\text{N}}\right)=53^\circ,
\end{array} $$ 
</div>
...
direction, so that we need to find $$ F_{\text{s}} $$ in order to find what
...
<div data-type="equation" id="eip-id2063281">
 $$ \begin{array}{lll}
a& =& \frac{8.00 \text{m/s}}{2.50 \text{s}\\
 & =& 3.20 \text{m/s}^2.
\end{array} $$ 
</div>
...
<div data-type="solution" markdown="1">
 $$ 10.2\text{m/s}^{2}, 4.67^\circ$$  from vertical
</div>
</div>
