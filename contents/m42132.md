...
Suppose two tugboats push on a barge at different angles, as shown in [\[link\]](#import-auto-id1221020). The first tugboat exerts a force of  $$ 2.7×{\text{10}}^{5}\text{N} $$ 
...
7\text{.}\text{5}×{\text{10}}^{-2}{\text{m/s}}^{2}
$$
...
<div data-type="equation" id="eip-id2112578">
 $$ \begin{array}{lll}{F}_{\text{app}}& =& \sqrt{ {\text{F}}_{x}^{2}+{\text{F}}_{y}^{2}}\\ {F}_{\text{app}}& =& \sqrt{\left(2.7×{\text{10}}^{5}\text{N}{\right)}^{2}+\left(3.6×{\text{10}}^{5}\text{N}{\right)}^{2}}& =& 4.5×{\text{10}}^{5}\text{N.}\end{array} $$ 
</div>
The angle is given by

<div data-type="equation" id="eip-id3026466">
 $$ \begin{array}{lll}\theta & =& {\tan}^{-1}\left(\frac{ {F}_{y}}{ {F}_{x}}\right)\\ \theta & =& {\tan}^{-1}\left(\frac{3.6×{\text{10}}^{5}\text{N}}{2.7×{\text{10}}^{5}\text{N}}\right)=\text{53º},\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id1715978">
 $$ {\text{F}}_{\text{D}}=\left(4\text{.}\text{5}×{\text{10}}^{5}\text{N}\right)-\left(5\text{.}\text{0}×{\text{10}}^{6}\text{kg}\right)\left(7\text{.}\text{5}×{\text{10}}^{\text{–2}}{\text{m/s}}^{2}\right)=7\text{.}\text{5}×{\text{10}}^{4}\text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-id2308230">
 $$ {F}_{\text{net}y}={T}_{\text{1}y}+{T}_{\text{2}y}-w=0. $$ 
</div>
This implies
...
<div data-type="problem" markdown="1">
A flea jumps by exerting a force of  $$ 1\text{.}\text{20}×{\text{10}}^{-5}\text{N} $$ 

straight down on the ground. A breeze blowing on the flea parallel to the ground
exerts a force of $$
0\text{.}\text{500}×{\text{10}}^{-6}\text{N} $$
on the flea. Find the direction and magnitude of the acceleration of the flea if
its mass is $$
6\text{.}\text{00}×{\text{10}}^{-7}\text{kg} $$. Do not neglect the gravitational force.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
**Integrated Concepts** A large rocket has a mass of  $$ 2\text{.}\text{00}×{\text{10}}^{6}\text{kg} $$ 

at takeoff, and its engines produce a thrust of $$
3\text{.}\text{50}×{\text{10}}^{7}\text{N} $$. (a) Find its initial acceleration if it takes off vertically. (b) How long
...
(b)  $$
2\text{.}\text{47}×{\text{10}}^{3}{\text{m/s}}^{2}
$$
(c)  $$ 6.18×{\text{10}}^{3}\text{N} $$. The average force is 252 times the shell’s weight.
