...
<div data-type="equation" id="eip-id1203757">
 $$ {\mathbf{\text{F}}}_{\text{app}}={\mathbf{\text{F}}}_{\mathit{x}}+{\mathbf{\text{F}}}_{\mathit{y}} $$ 
</div>
...
** are perpendicular, the magnitude and direction of $$ {\mathbf{\text{F}}}_
{\text{app}} $$
...
<div data-type="equation" id="eip-id3026466">
 $$ \begin{array}{lll}\theta & =& {\tan}^{-1}\left(\frac{ F_{y}}{ F_{x}}\right)\\ \theta & =& {\tan}^{-1}\left(\frac{3.6\times 10^{5}\text{N}}{2.7\times 10^{5}\text{N}}\right)=\text{53º},\end{array} $$ 
</div>
...
$$ F_{\text{net}}={F}_{\text{app}}-{F}_{\text{D}}. $$ 
</div>
...
$$ F_{\text{D}}={F}_{\text{app}}-\text{ma}. $$ 
</div>
Substituting known values gives

<div data-type="equation" id="eip-id1715978">
 $$ {\text{F}}_{\text{D}}=\left(4.5 \times  10^{5}\text{N}\right)-\left(5.0 \times  10^{6}\text{kg}\right)\left(7.5 \times  10^{\text{–2}}{\text{m/s}}^{2}\right)=7.5 \times  10^{4}\text{N}. $$ 
</div>
The direction of  $$ {\mathbf{\text{F}}}_{\text{D}} $$ 

has already been determined to be in the direction opposite to $$
{\mathbf{\text{F}}}_{\text{app}} $$, or at an angle of $$ \text{53º} $$
south of west.
...
answer to this example, where$$ F_
{\text{D}} $$
...
the figure. There are two unknowns in this problem ( $$ {T}_{1} $$
and $$ {T}_{2} $$
...
$$ F_{\text{net}x}={T}_{2}x}-{T}_{1}x}=0. $$ 
</div>
...
<div data-type="equation" id="eip-id2122298">
 $$ {T}_{1}\cos\left(\text{30º}\right)={T}_{2}\cos\left(\text{45º}\right). $$ 
</div>
Thus,

<div data-type="equation" id="eip-id2577136">
 $$ {T}_{2}=\left(1.225\right){T}_{1}. $$ 
</div>
Note that  $$ {T}_{1} $$ 

and $$ {T}_{2} $$
are not equal in this case, because the angles on either side are not equal. It
is reasonable that $$ {T}_{2} $$
ends up being greater than $$ {T}_{1} $$, because it is exerted more vertically than $$ {T}_{1} $$.

Now consider the force components along the vertical or *y*-axis:

<div data-type="equation" id="eip-id2308230">
$$ F_{\text{net}y}={T}_{1}y}+{T}_{2}y}-w=0. $$ 
</div>
This implies
...
<div data-type="equation" id="eip-id1925561">
 $$ {T}_{1}\sin\left(\text{30º}\right)+{T}_{2}\sin\left(\text{45º}\right)=w. $$ 
</div>
...
<div data-type="equation" id="eip-id2259246">
 $$ {T}_{1}\left(0.500\right)+\left(1.225{T}_{1}\right)\left(0.707\right)=w=\text{mg}, $$ 
</div>
which yields

<div data-type="equation" id="eip-id2556360">
 $$ \left(1.366\right){T}_{1}=\left(15.\text{0 kg}\right)\left(9.80 \text{m/s}^2\right). $$ 
</div>
...
= 1.225 $$ {T}_{1} $$, found above. Thus we obtain
...
From the free-body diagram we see that $$ F_{\text{net}}={F}_{\text{s}}-w $$ 
...
$$ F_{\text{s}}=\left(75.\text{0 kg}\right)\left(1.20 \text{m/s}^2\right)+\left(75.\text{0 kg}\right)\left(9.80 \text{m/s}^2\right), $$ 
</div>
yielding
...
<div data-type="equation" id="eip-id2384618">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& \text{ma}=0={F}_{\text{s}}-w\\ {F}_{\text{s}}& =& w=\text{mg}\\ {F}_{\text{s}}& =& \left(\text{75.0 kg}\right)\left(9.80 \text{m/s}^2\right)\\ {F}_{\text{s}}& =& \text{735 N.}\end{array} $$ 
</div>
...
$$ F_{\text{s}}=\left(75.\text{0 kg}\right)\left(9.80 \text{m/s}^2\right), $$ 
</div>
which gives
...
<div data-type="equation" id="eip-id1351504">
 $$ \begin{array}{lll}{F}_{\text{net}}& =& \left(\text{70.0 kg}\right)\left(3.20 \text{m/s}^2\right)\\ & =& 224 \text{N}.\end{array} $$ 
</div>
**Discussion for (b)**
...
. Why will they appear to be weightless, as measured by standing on a bathroom
...
<div data-type="solution" markdown="1">
 $$ 10.2{\text{m/s}}^{2}\text{, 4.67º from vertical} $$ 
