...
3.6×{\text{10}}^{5}\phantom{\rule{0.25em}{0ex}}\text{N} $$
in the *y*-direction.
...
5.0×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{kg} $$
and its acceleration is observed to be $$
7\text{.}\text{5}×{\text{10}}^{-2}\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2}
$$
...
<div data-type="equation" id="eip-id3026466">
 $$ \begin{array}{lll}\theta & =& {\tan}^{-1}\left(\frac{ {F}_{y}}{ {F}_{x}}\right)\\ \theta & =& {\tan}^{-1}\left(\frac{3.6×{\text{10}}^{5}\phantom{\rule{0.25em}{0ex}}\text{N}}{2.7×{\text{10}}^{5}\phantom{\rule{0.25em}{0ex}}\text{N}}\right)=\text{53º},\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id2122298">
 $$ {T}_{1}\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\left(\text{30º}\right)={T}_{2}\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\left(\text{45º}\right). $$ 
</div>
Thus,
...
<div data-type="equation" id="eip-id1925561">
 $$ {T}_{1}\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}\left(\text{30º}\right)+{T}_{2}\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}\left(\text{45º}\right)=w. $$ 
</div>
...
a=1.20\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2} $$, so that
...
exerts a force of $$
0\text{.}\text{500}×{\text{10}}^{-6}\phantom{\rule{0.25em}{0ex}}\text{N} $$
on the flea. Find the direction and magnitude of the acceleration of the flea if
its mass is $$
6\text{.}\text{00}×{\text{10}}^{-7}\phantom{\rule{0.25em}{0ex}}\text{kg} $$. Do not neglect the gravitational force.
...
3\text{.}\text{50}×{\text{10}}^{7}\phantom{\rule{0.25em}{0ex}}\text{N} $$. (a) Find its initial acceleration if it takes off vertically. (b) How long
...
(b)  $$
2\text{.}\text{47}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}{\text{m/s}}^{2}
$$
(c)  $$ 6.18×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{N} $$. The average force is 252 times the shell’s weight.
