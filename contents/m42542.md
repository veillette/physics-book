...
? The rest mass of the electron is  $$9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg} $$
.
...
<div data-type="equation" id="eip-id2442420">
 $$p=\gamma \text{mu}=\frac{\text{mu}}{\sqrt{1-\frac{ {u}^{2}}{ {c}^{2}}}}=\frac{\left(9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg}\right)\left(0\text{.}\text{985}\right)\left(3.00×{\text{10}}^{8} \text{m/s}\right)}{\sqrt{1-\frac{\left(0.985c{\right)}^{2}}{ {c}^{2}}}}=1.56×{\text{10}}^{-\text{21}} \text{kg}\cdot \text{m/s} $$
</div>
</div>
</div>
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) Find the momentum of a  $$1\text{.}\text{00}×{\text{10}}^{9} \text{kg} $$
...
<div data-type="solution" markdown="1">
(a)  $$3\text{.}\text{000000015}×{\text{10}}^{\text{13}} \text{kg}\cdot \text{m/s} $$
.
