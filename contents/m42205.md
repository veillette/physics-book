...
* are in common use. For example, the heart of a resting adult pumps blood at a rate of 5.00 liters per minute (L/min). Note that a **liter**{: data-type="term" #import-auto-id3112840} (L) is 1/1000 of a cubic meter or 1000 cubic centimeters ($${\text{10}}^{-3} {\text{m}}^{3}$$
