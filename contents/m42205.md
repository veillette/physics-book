...
<div data-type="equation">
 $$\begin{array}{lll}V& =& \left(\frac{5\text{.}\text{00} \text{L}}{\text{1 min}}\right)\left(\text{75} \text{y}\right)\left(\frac{1 {\text{m}}^{3}}{ {\text{10}}^{3} \text{L}}\right)\left( 5.26 \times 10^{5} \frac{\text{min}}{\text{y}}\right)\\ \text{}& =& 2\text{.}0×{\text{10}}^{5} {\text{m}}^{3}\text{.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation">
 $${\overline{v}}_{1}=\frac{\left(0\text{.}\text{500} \text{L/s}\right)\left({\text{10}}^{-3} {\text{m}}^{3}/\text{L}\right)}{\pi \left( 9.00 \times 10^{-3}  \text{m}{\right)}^{2}}=1\text{.}\text{96} \text{m/s}\text{.} $$
</div>
**Solution for (b)**
...
<div data-type="equation">
 $${n}_{2}=\frac{\left(1\right)\left(\pi \right){\left(\text{10}×{\text{10}}^{-3} \text{m}\right)}^{2}\left(0.27 m/s\right)}{\left(\pi \right){\left( 4.0 \times 10^{-6}  \text{m}\right)}^{2}\left( 0.33 \times 10^{-3}  \text{m/s}\right)}= 5.0 \times 10^{9}  \text{capillaries}. $$
</div>
**Discussion**
