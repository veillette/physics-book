...
<div data-type="equation">
 $$\begin{array}{lll}V& =& \left(\frac{5\text{.}\text{00} \text{L}}{\text{1 min}}\right)\left(\text{75} \text{y}\right)\left(\frac{1 {\text{m}}^{3}}{ {\text{10}}^{3} \text{L}}\right)\left(5\text{.}\text{26}×{\text{10}}^{5}\frac{\text{min}}{\text{y}}\right)\\ \text{}& =& 2\text{.}0×{\text{10}}^{5} {\text{m}}^{3}\text{.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation">
 $${\overline{v}}_{1}=\frac{\left(0\text{.}\text{500} \text{L/s}\right)\left({\text{10}}^{-3} {\text{m}}^{3}/\text{L}\right)}{\pi \left(9\text{.}\text{00}×{\text{10}}^{-3} \text{m}{\right)}^{2}}=1\text{.}\text{96} \text{m/s}\text{.} $$
</div>
**Solution for (b)**
...
<div data-type="equation">
 $${\overline{v}}_{2}=\frac{\left(0\text{.}\text{900} \text{cm}{\right)}^{2}}{\left(0\text{.}\text{250} \text{cm}{\right)}^{2}}1\text{.}\text{96} \text{m/s}=\text{25}\text{.}\text{5 m/s}\text{.} $$
</div>
**Discussion**
...
<div data-type="equation">
 $$\overline{v}=\frac{\left(5.0 \text{L/min}\right)\left({\text{10}}^{-3} {\text{m}}^{3}\text{/L}\right)\left(1 \text{min/}\text{60} \text{s}\right)}{\pi {\left(0\text{.}\text{010 m}\right)}^{2}}=0\text{.}\text{27} \text{m/s}. $$
</div>
**Solution for (b)**
...
<div data-type="equation">
 $${n}_{2}=\frac{\left(1\right)\left(\pi \right){\left(\text{10}×{\text{10}}^{-3} \text{m}\right)}^{2}\left(0.27 m/s\right)}{\left(\pi \right){\left(4.0×{\text{10}}^{-6} \text{m}\right)}^{2}\left(0.33×{\text{10}}^{-3} \text{m/s}\right)}=5.0×{\text{10}}^{9} \text{capillaries}. $$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A major artery with a cross-sectional area of  $$1\text{.}\text{00} {\text{cm}}^{2} $$
 branches into 18 smaller arteries, each with an average cross-sectional area of  $$0\text{.}\text{400} {\text{cm}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) As blood passes through the capillary bed in an organ, the capillaries join to form venules (small veins). If the blood speed increases by a factor of 4.00 and the total cross-sectional area of the venules is  $$\text{10}\text{.}0 {\text{cm}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Estimate the time it would take to fill a private swimming pool with a capacity of 80 000 L using a garden hose delivering 60 L/min. (b) How long would it take to fill if you could divert a moderate size river, flowing at  $$\text{5000} {\text{m}}^{3}\text{/s} $$
, into it?
...
The flow rate of blood through a  $$2\text{.}\text{00}×{\text{10}}^{\text{–6}}\text{-m} $$
 -radius capillary is  $$3\text{.}\text{80}×{\text{10}}^{-9} {\text{cm}}^{3}\text{/s} $$
. (a) What is the speed of the blood flow? (This small speed allows time for diffusion of materials to and from the blood.) (b) Assuming all the blood in the body passes through capillaries, how many of them must there be to carry a total flow of  $$90\text{.}0 {\text{cm}}^{3}\text{/s} $$
...
A mountain stream is 10.0 m wide and averages 2.00 m in depth. During the spring runoff, the flow in the stream reaches  $$\text{100 000} {\text{m}}^{3}\text{/s} $$
