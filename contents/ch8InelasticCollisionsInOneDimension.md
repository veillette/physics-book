...
(b) How much kinetic energy is lost during the collision? Assume friction between the ice and the puck-goalie system is negligible. (See [\[link\]](#import-auto-id1578036) )
...
In the collision pictured in [\[link\]](#import-auto-id1258204), two carts collide inelastically. Cart 1 (denoted $$ m_{1} $$ carries a spring which is initially compressed. During the collision, the spring
...
Using mass and speed data from [[link]](/contents/ch8LinearMomentumAndForce.md#fs-id1356444) and
