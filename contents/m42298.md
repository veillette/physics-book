...
(a) Using the values for density and the speed of ultrasound given in [\[link\]](#import-auto-id2672118), show that the acoustic impedance of fat tissue is indeed  $$1.34 \times 10^{6}  \text{kg/m}^{2}·\text{s} $$.
...
(1) Substitute known values from [\[link\]](#import-auto-id2672118) into  $$Z=\text{ρv} $$.
