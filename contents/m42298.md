...
<div data-type="equation" id="eip-232">
 $$a=\frac{ {\left({Z}_{2}-{Z}_{1}\right)}^{2}}{ {\left({Z}_{1}+{Z}_{2}\right)}^{2}}=\frac{ {\left( 1.34 \times 10^{6}  {\text{kg/(m}}^{\text{2}}\mathrm{· s\right)} -1.70 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}{ {\left( 1.70 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)+ 1.34 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}=0\text{.}\text{014} $$
</div>
**Discussion**
...
. Indeed, current technology cannot do quite this well. Abdominal scans may use a 7-MHz frequency, and the speed of sound in tissue is about 1540 m/s—so the wavelength limit to detail would be  $$\lambda =\frac{ {v}_{w}}{f}=\frac{\text{1540 m/s}}{7 \times 10^{6}  \text{Hz}}=0\text{.}\text{22 mm} $$
