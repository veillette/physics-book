...
Reflections at boundaries between two different media occur because of differences in a characteristic known as the <strong class="term" id="import-auto-id3007118">acoustic impedance </strong>* $$Z $$
