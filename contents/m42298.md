...
(a) Using the values for density and the speed of ultrasound given in [\[link\]](#import-auto-id2672118), show that the acoustic impedance of fat tissue is indeed  $$1.34×{10}^{6} {kg/\left(m}^{2}·s\right) $$
.
...
<div data-type="equation" id="eip-232">
 $$a=\frac{ {\left({Z}_{2}-{Z}_{1}\right)}^{2}}{ {\left({Z}_{1}+{Z}_{2}\right)}^{2}}=\frac{ {\left(1\text{.}\text{34}×{\text{10}}^{6} {\text{kg/(m}}^{\text{2}}\mathrm{· s\right)}-1.70×{\text{10}}^{6} {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}{ {\left(1\text{.}\text{70}×{\text{10}}^{6} {\text{kg/(m}}^{\text{2}}· s\right)+1\text{.}\text{34}×{\text{10}}^{6} {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}=0\text{.}\text{014} $$
</div>
**Discussion**
...
The applications of ultrasound in medical diagnostics have produced untold benefits with no known risks. Diagnostic intensities are too low (about  $${\text{10}}^{-2} {\text{W/m}}^{2} $$
...
. Indeed, current technology cannot do quite this well. Abdominal scans may use a 7-MHz frequency, and the speed of sound in tissue is about 1540 m/s—so the wavelength limit to detail would be  $$\lambda =\frac{ {v}_{w}}{f}=\frac{\text{1540 m/s}}{7×{\text{10}}^{6} \text{Hz}}=0\text{.}\text{22 mm} $$
...
<div data-type="equation" id="eip-627">
 $$\mid 2,\text{500},\text{649} \text{Hz}-2,\text{500},\text{000} \text{Hz}\mid  $$
</div>
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
Suppose you read that 210-dB ultrasound is being used to pulverize cancerous tumors. You calculate the intensity in watts per centimeter squared and find it is unreasonably high ( $${\text{10}}^{5} {\text{W/cm}}^{2} $$
...
<div data-type="problem" markdown="1">
What is the sound intensity level in decibels of ultrasound of intensity  $${\text{10}}^{5} {\text{W/m}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Find the sound intensity level in decibels of  $$2.00×{\text{10}}^{–2} {\text{W/m}}^{2}  $$
...
<div data-type="solution" markdown="1">
(a)  $${v}_{w}=1540 m/s=\mathrm{f\lambda }⇒\lambda =\frac{1540 m/s}{100×{10}^{3} \text{Hz}}=0.0154 m < 3.50 m. $$
