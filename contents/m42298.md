...
(a) Using the values for density and the speed of ultrasound given in [\[link\]](#import-auto-id2672118), show that the acoustic impedance of fat tissue is indeed  $$1.34 \times 10^{6}  {kg/\left(m}^{2}·s\right) $$
.
...
<div data-type="equation" id="eip-626">
 $$1.34 \times 10^{6}  {kg/\left(m}^{2}·s\right) $$
</div>
...
<div data-type="equation" id="eip-232">
 $$a=\frac{ {\left({Z}_{2}-{Z}_{1}\right)}^{2}}{ {\left({Z}_{1}+{Z}_{2}\right)}^{2}}=\frac{ {\left( 1.34 \times 10^{6}  {\text{kg/(m}}^{2}· s\right) -1.70 \times 10^{6}  {\text{kg/(m}}^{2}· s\right)\right)}^{2}}{ {\left( 1.70 \times 10^{6}  {\text{kg/(m}}^{2}· s\right)+ 1.34 \times 10^{6}  {\text{kg/(m}}^{2}· s\right)\right)}^{2}}= 0.014 $$
</div>
**Discussion**
