...
<div data-type="equation" id="eip-824">
 $$Z=\mathrm{\rho v}=\left(925 \text{kg}{\text{/m}}^{3}\right)\left(1450 \text{m/s}\right) $$
</div>
...
<div data-type="equation" id="eip-232">
 $$a=\frac{ {\left({Z}_{2}-{Z}_{1}\right)}^{2}}{ {\left({Z}_{1}+{Z}_{2}\right)}^{2}}=\frac{ {\left( 1.34 \times 10^{6}  {\text{kg/(m}}^{\text{2}}\mathrm{· s\right)} -1.70 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}{ {\left( 1.70 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)+ 1.34 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}= 0.014 $$
</div>
**Discussion**
...
<div data-type="solution" markdown="1">
(a)  $${v}_{w}=1540 m/s=\mathrm{f\lambda }⇒\lambda =\frac{1540 m/s}{100 \times 10^{3}  \text{Hz}}=0.0154 m < 3.50 m. $$
