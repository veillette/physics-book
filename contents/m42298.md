...
<div data-type="equation" id="eip-232">
 $$a=\frac{ {\left({Z}_{2}-{Z}_{1}\right)}^{2}}{ {\left({Z}_{1}+{Z}_{2}\right)}^{2}}=\frac{ {\left( 1.34 \times 10^{6}  {\text{kg/(m}}^{\text{2}}\mathrm{· s\right)}-1.70×{\text{10}}^{6} {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}{ {\left( 1.70 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)+ 1.34 \times 10^{6}  {\text{kg/(m}}^{\text{2}}· s\right)\right)}^{2}}=0\text{.}\text{014} $$
</div>
**Discussion**
