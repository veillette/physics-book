...
<div data-type="equation" id="eip-77">
 $$R=\frac{V}{I}=\frac{\text{12}\text{.}0 \text{V}}{2\text{.}50 \text{A}}=\text{4}\text{.}80 \text{Ω}\text{.} $$
</div>
**Discussion**
...
<div data-type="problem" markdown="1">
What current flows through the bulb of a 3.00-V flashlight when its hot resistance is  $$3\text{.}60 \text{Ω} $$
?
