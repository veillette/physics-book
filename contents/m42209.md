...
<table id="import-auto-id3073392" summary="Coefficients of Viscosity of Various Fluids"><caption><span data-type="title">Coefficients of Viscosity of Various Fluids</span></caption><thead><tr>
            ...
            <th>Viscosity 
 $$\eta \phantom{\rule{0.25em}{0ex}}\text{(mPa·s)} $$</th>
          </tr></thead><tbody><tr>
...
<div data-type="equation" id="import-auto-id2401979">
 ...
 $${P}_{1} $$
 is given as 8.00 mm Hg, which converts to  $$1\text{.}\text{066}×{\text{10}}^{3} {\text{N/m}}^{2} $$
. Substituting this and the other known values yields

<div data-type="equation" id="import-auto-id1133273">
 $$\begin{array}{lll}{P}_{2}& =& \left[\frac{8\left(1\text{.}\text{00}×{\text{10}}^{-3} \text{N}\cdot {\text{s/m}}^{2}\right)\left(2\text{.}\text{50}×{\text{10}}^{-2} \text{m}\right)}{\pi \left(0\text{.}\text{150}×{\text{10}}^{-3} \text{m}{\right)}^{4}}\right]\left(1\text{.}\text{20}×{\text{10}}^{-7} {\text{m}}^{3}\text{/s}\right)+1\text{.}\text{066}×{\text{10}}^{3} {\text{N/m}}^{2}\\ & =& 1\text{.}\text{62}×{\text{10}}^{4} {\text{N/m}}^{2}\text{.}\end{array} $$
</div>
**Discussion**
...
, with a total of  $$\text{10} {\text{cm}}^{2} $$
...
, the cart is moving at 0.400 m/s, its surface area is  $$2\text{.}\text{50}×{\text{10}}^{-2} {\text{m}}^{2} $$
, and the thickness of the air layer is  $$6.00×{\text{10}}^{-5} \text{m} $$
. (b) What is the ratio of this force to the weight of the 0.300-kg cart?

</div>
<div data-type="solution" markdown="1">
(a)  $$3\text{.}\text{02}×{\text{10}}^{-3} \text{N} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A glucose solution being administered with an IV has a flow rate of  $$4\text{.}\text{00} {\text{cm}}^{3}\text{/min} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A small artery has a length of  $$1\text{.}1×{\text{10}}^{-3} \text{m} $$
 and a radius of  $$2.5×{\text{10}}^{-5} \text{m} $$
...
<div data-type="solution" markdown="1">
 $$8.7×{\text{10}}^{-\text{11}} {\text{m}}^{3}\text{/s} $$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Fluid originally flows through a tube at a rate of  $$\text{100} {\text{cm}}^{3}\text{/s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A layer of oil 1.50 mm thick is placed between two microscope slides. Researchers find that a force of  $$5\text{.}\text{50}×{\text{10}}^{-4} \text{N} $$
 is required to glide one over the other at a speed of 1.00 cm/s when their contact area is  $$6\text{.}\text{00} {\text{cm}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
[[link]](#fs-id1969731) dealt with the flow of saline solution in an IV system. (a) Verify that a pressure of  $$1\text{.}\text{62}×{\text{10}}^{4} {\text{N/m}}^{2} $$
...
<div data-type="solution" markdown="1">
(a)  $$1\text{.}\text{62}×{\text{10}}^{\text{4}} {\text{N/m}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Water supplied to a house by a water main has a pressure of  $$3\text{.}\text{00}×{\text{10}}^{5} {\text{N/m}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Concrete is pumped from a cement mixer to the place it is being laid, instead of being carried in wheelbarrows. The flow rate is 200.0 L/min through a 50.0-m-long, 8.00-cm-diameter hose, and the pressure at the pump is  $$8\text{.}\text{00}×{\text{10}}^{6} {\text{N/m}}^{2} $$
