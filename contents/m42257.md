...
where  $$P $$
 is the power through an area  $$A $$ . The SI unit for  $$I $$  is  $${W/m}^{2} $$
...
, and  $${v}_{w} $$
 is the speed of sound in the medium, in units of m/s. The pressure variation is proportional to the amplitude of the oscillation, and so  $$I $$  varies as  $${\left( \Delta p \right)}^{2} $$
...
where  $${I}_{0}=10^{-12} {\text{W/m}}^{2} $$
 ...
 is the lowest or threshold intensity of sound a person with normal hearing can perceive at a frequency of 1000 Hz. Sound intensity level is not the same as intensity. Because  $$\beta  $$  is defined in terms of a ratio, it is a unitless quantity telling you the *level* of the sound relative to a fixed standard ( $$10^{-12} {\text{W/m}}^{2} $$
