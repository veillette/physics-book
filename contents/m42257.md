...
<div data-type="equation" id="eip-313">
 $$\beta  \left(\text{dB}\right)=\text{10} {\text{log}}_{\text{10}}\left(\frac{I}{ {I}_{0}}\right), $$
</div>

where  $${I}_{0}={\text{10}}^{\text{–12}} {\text{W/m}}^{2} $$
...
* is defined in terms of a ratio, it is a unitless quantity telling you the *level* of the sound relative to a fixed standard ( $${\text{10}}^{\text{–12}} {\text{W/m}}^{2} $$
...
The decibel level of a sound having the threshold intensity of  $${\text{10}}^{–\text{12}} {\text{W/m}}^{2} $$
 is  $$\beta =0 \text{dB} $$
...
, we can calculate  $$\beta  $$
 straight from its definition in  $$\beta  \left(\text{dB}\right)=\text{10} {\text{log}}_{\text{10}}\left(I/{I}_{0}\right) $$
.
...
<div data-type="equation" id="eip-969">
 $$I=\frac{ {\left(\Delta p\right)}^{2}}{2{\text{ρv}}_{w}}=\frac{ {\left(0.656 Pa\right)}^{2}}{2\left(1\text{.}\text{29} {\text{kg/m}}^{3}\right)\left(\text{331 m/s}\right)}=5\text{.}\text{04}×{\text{10}}^{-4} {\text{W/m}}^{2}. $$
</div>
(3) Enter the value for  $$I $$
 and the known value for  $${I}_{0} $$
 into  $$\beta  \left(\text{dB}\right)=\text{10} {\text{log}}_{\text{10}}\left(I/{I}_{0}\right) $$
. Calculate to find the sound intensity level in decibels:

<div data-type="equation" id="eip-273">
 $${10 log}_{10}\left(5.04×{10}^{8}\right)=10 \left(8.70\right) dB=87 dB. $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-123">
 $${\beta }_{2}-{\beta }_{1}={\text{10 log}}_{\text{10}}\left(\frac{ {I}_{2}}{ {I}_{1}}\right)=\text{10} {\text{log}}_{\text{10}}2.00=\text{10} \left(0\text{.}\text{301}\right) \text{dB}. $$
</div>
Thus,
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What sound intensity level in dB is produced by earphones that create an intensity of  $$4.00×{\text{10}}^{\text{−2}} {\text{W/m}}^{\text{2}} $$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the intensity of a sound that has a level 7.00 dB lower than a  $$4.00×{10}^{–9} {W/m}^{2} $$
 sound? (b) What is the intensity of a sound that is 3.00 dB higher than a  $$4.00×{10}^{–9} {W/m}^{2} $$
 sound?
