...
<div data-type="equation" id="eip-313">
 $$\beta  \left(\text{dB}\right)=10 {\text{log}}_{\text{10}}\left(\frac{I}{ {I}_{0}}\right), $$
</div>
...
, we can calculate  $$\beta  $$
 straight from its definition in  $$\beta  \left(\text{dB}\right)=10 {\text{log}}_{\text{10}}\left(I/{I}_{0}\right) $$
.
...
(3) Enter the value for  $$I $$
 ...
 into  $$\beta  \left(\text{dB}\right)=10 {\text{log}}_{\text{10}}\left(I/{I}_{0}\right) $$
...
<div data-type="equation" id="eip-123">
 $${\beta }_{2}-{\beta }_{1}={10 \text{log}}_{\text{10}}\left(\frac{ {I}_{2}}{ {I}_{1}}\right)=10 {\text{log}}_{\text{10}}2.00=10 \left( 0.301\right) \text{dB}. $$
</div>
Thus,
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What sound intensity level in dB is produced by earphones that create an intensity of  $$4.00 \times 10^{\text{−2}} {\text{W/m}}^{\text{2}} $$
?
