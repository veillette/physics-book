...
, and  $${Z}^{0} $$
 ...
 into massless carrier particles more similar to photons and gluons. These have not been observed experimentally, but there is a prediction of an associated particle called the **Higgs boson**{: data-type="term"}. The mass of this particle is not predicted with nearly the certainty with which the mass of the  $${W}^{+}, {W}^{-}, $$
 and  $${Z}^{0} $$
...
The small distances and high energies at which the electroweak force becomes identical with the strong nuclear force are not reachable with any conceivable human-built accelerator. At energies of about  $${\text{10}}^{\text{14}} \text{GeV} $$
 (16,000 J per particle), distances of about  $${\text{10}}^{-\text{30}} \text{m} $$
...
), you find the unexpected. Even more extreme are the energies and distances at which gravity is thought to unify with the other forces in a TOE. Most speculative and least constrained by experiment are TOEs, one of which is called **Superstring theory**. Superstrings are entities that are  $${\text{10}}^{-\text{35}} \text{m} $$
...
which violates both conservation of baryon number and electron family number. Although  $${\text{10}}^{\text{31}} \text{y} $$
...
The intensity of cosmic ray radiation decreases rapidly with increasing energy, but there are occasionally extremely energetic cosmic rays that create a shower of radiation from all the particles they create by striking a nucleus in the atmosphere as seen in the figure given below. Suppose a cosmic ray particle having an energy of  $${\text{10}}^{\text{10}} \text{GeV} $$
 converts its energy into particles with masses averaging  $$\text{200} \text{MeV/}{c}^{2} $$
...
(a)  $$5×{\text{10}}^{\text{10}} $$
(b)  $$5×{\text{10}}^{4} {\text{particles/m}}^{2} $$
</div>
</div>
...
Suppose you are designing a proton decay experiment and you can detect 50 percent of the proton decays in a tank of water. (a) How many kilograms of water would you need to see one decay per month, assuming a lifetime of  $${\text{10}}^{\text{31}} \text{y} $$
? (b) How many cubic meters of water is this? (c) If the actual lifetime is  $${\text{10}}^{\text{33}} \text{y} $$
, how long would you have to wait on an average to see a single proton decay?

</div>
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$7\text{.}2×{\text{10}}^{5} \text{kg} $$
(b)  $$7\text{.}2×{\text{10}}^{2} {\text{m}}^{3} $$
(c)  $$\text{100 months} $$
</div>
</div>
