...
definitions from [Reactance, Inductive and Capacitive](/m42427), we substitute
...
in [[link]](/m42427#fs-id1169736972664) to be $${X}_{L}= 1.13 \Omega $$ and
in [[link]](/m42427#fs-id1169736597928) to be $${X}_{C}=531 \Omega $$ . Entering
...
alone in [[link]](/m42427#fs-id1169736597928). The capacitor dominates at low
frequency. The current at 10.0 kHz is only slightly different from that found
for the inductor alone in [[link]](/m42427#fs-id1169736972664). The inductor
