...
which is the impedance of an *RLC* series AC circuit. For circuits without a resistor, take  $$R=0 $$
...
<div class="equation" id="eip-247">
 $$\begin{array}{lll}Z& =& \sqrt{ {\left(  40.0 \Omega  \right)}^{2}+{\left( 188 \Omega  -3.18 \Omega  \right)}^{2}}\\ & =& 190 \Omega \text{ at 10}\text{.}0 \text{kHz.}\end{array} $$
</div>
**Discussion for (a)**
...
<div class="equation" id="eip-590">
 $$\cos \varphi =\frac{ 40.0 \Omega }{531 \Omega }=0.0753 \text{at}  60.0 \text{Hz.} $$
</div>
...
* {: #import-auto-id1169736615857}  $$\varphi =0º $$ for a purely resistive circuit or an *RLC* circuit at resonance.
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
What inductance do you need to produce a resonant frequency of 60.0 Hz, when using a  $$2.00 \mu F $$
 capacitor?
