...
weight of the pole,$$ F_{R}={F}_{L}=w/2 $$. (b) The pole vaulter moves the pole to his left, and the forces that the hands
...
, the force exerted by the right hand, and (b) $$ F_{L} $$, the force exerted by the left hand. The hands are 0.900 m apart, and the cg of
...
**$$ F_{L} $$
** is seen to be exactly half of$$ F_{R} $$, as we might have guessed, since$$ F_{L} $$
is applied twice as far from the cg as$$ F_{R} $$.
