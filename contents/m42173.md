...
{L}=F_{R} $$, then the torques about the cg would not be equal since the lever arms are
...
<div data-type="equation">
 $$ \left(0.900 \text{m}\right)\left(F_{R}\right)=\left(0.600 \text{m}\right)\left(\mathit{mg}\right)\text{.} $$ 
</div>
Thus,

<div data-type="equation">
 $$ \begin{array}{lll}F_{R}& =& \left(0.667\right)\left(5.00 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)\\ & =& \text{32.7 N.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation">
 $$ \begin{array}{lll}F_{L}& =& \mathit{mg}-F_{R}\\ & =& \mathit{mg}-32.7 N\\ & =& \left(5.00 \text{kg}\right)\left(9.80\text{m/s}^{2}\right)-32.7 \text{N}\\ & =& 16.3 \text{N}\end{array} $$ 
</div>
**Discussion**
