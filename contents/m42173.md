...
3.  {: #import-auto-id1280850} Solve the problem by applying either or both of the conditions for equilibrium (represented by the equations
     $$ \text{net}\phantom{\rule{0.25em}{0ex}}F=0 $$ 
...
net}\phantom{\rule{0.25em}{0ex}}F=0\right) $$. The second condition $$ \text{(net}\phantom{\rule{0.25em}{0ex}}{\tau }_
{}=\text{0)} $$
...
equilibrium $$ \text{(net}\phantom{\rule{0.25em}{0ex}}F=0 $$
...
condition for equilibrium $$ \text{(net}\phantom{\rule{0.25em}{0ex}}\tau
=0\text{)
} $$
...
since the weight of the pole creates a counterclockwise torque and the right hand counters with a clockwise torque. Using the definition of torque,  $$ \tau =\text{rF}\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\theta  $$ 
