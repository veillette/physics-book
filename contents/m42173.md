...
<div data-type="equation">
 $$ \begin{array}{lll}{F}_{L}& =& \mathit{mg}-{F}_{R}\\ & =& \mathit{mg}-\text{32}\text{.}7 N\\ & =& \left(\text{5.00 kg}\right)\left(\text{9.80}{\text{m/s}}^{2}\right)-\text{32.7 N}\\ & =& \text{16.3 N}\end{array} $$ 
</div>
**Discussion**
