...
(4) Find the speed of sound using  $${v}_{w}=\left(\text{331 m/s}\right)\sqrt{\frac{T}{\text{273 K}}} $$
 .

<div data-type="equation" id="eip-15">
 $${v}_{w}=\left(\text{331 m/s}\right)\sqrt{\frac{\text{295 K}}{\text{273 K}}}=\text{344 m/s} $$
</div>
(5) Enter the values of the speed of sound and frequency into the expression for  $$L $$
.

<div data-type="equation" id="eip-358">
 $$L=\frac{ {v}_{w}}{ {4f}_{1}}=\frac{\text{344 m/s}}{4\left(\text{128 Hz}\right)}=0\text{.}\text{672 m} $$
</div>
**Discussion on (a)**
...
<div data-type="equation" id="eip-466">
 $${f}_{9}=9\frac{ {v}_{w}}{4L}={9f}_{1}=\text{1.15 kHz} $$
</div>
**Discussion on (b)**
