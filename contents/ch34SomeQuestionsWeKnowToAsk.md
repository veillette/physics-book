...
1. _Is the universe open or closed_? Theorists would like it to be just barely
...
2. _What is dark matter_? It is definitely there, but we really do not know what
...
3. _How do galaxies form_? They exist since very early in the evolution of the
...
4. _What is the nature of various-mass black holes_? Only recently have we
...
5. _What is the mechanism for the energy output of quasars_? These distant and
...
1. _How do phase transitions take place on the microscopic scale_? We know a lot
...
2. _Is there a way to deal with nonlinear phenomena that reveals underlying
...
4. _There are magnetic effects in materials we do not understand—how do they
   work_? Although beyond the scope of this text, there is a great deal to learn
...
1. _Are quarks and leptons fundamental, or do they have a substructure_? The
   ...
   systematics.
2. _Why do leptons have integral charge while quarks have fractional charge_? If
...
3. _Why are there three families of quarks and leptons_? First, does this imply
   some relationship? Second, why three and only three families?
4. _Are all forces truly equal (unified) under certain circumstances_? They
   ...
   they are unified.
5. _Are there other fundamental forces_? There was a flurry of activity with
...
6. _Is the proton stable_? We have discussed this in some detail, but the
   ...
   very long lived.
7. _Are there magnetic monopoles_? Many particle theories call for very massive
...
8. _Do neutrinos have mass_? Definitive evidence has emerged for neutrinos
