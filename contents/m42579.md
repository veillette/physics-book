...
<div class="equation" id="eip-669">
 $$\begin{array}{lll}{\text{KE}}_{e}& =& \frac{1}{2}mv^{2}\\ & =& \frac{1}{2}\left(9.11 \times 10^{-31} \text{kg}\right){ \left( 5.79 \times 10^{6}  \text{m/s}\right)}^{2}\\ & =& \text{(1.53} \times 10^{-17} \text{J)}\left(\frac{1 \text{eV}}{1.60 \times 10^{-19} \text{J}}\right)=95.5 \text{eV.}\end{array} $$
</div>
**Discussion**
...
<div class="equation" id="eip-453">
 $$\Delta E=\frac{h}{4\pi \Delta t}=\frac{ 6.63 \times 10^{-34} \text{J}\cdot \text{s}}{4\pi \left(1.0 \times 10^{-10} \text{s}\right)}= 5.3  \times 10^{-25} \text{J.} $$
</div>
