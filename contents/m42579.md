...
<div data-type="equation" id="eip-899">
 $$\Delta v=\frac{\Delta p}{m}=\frac{5\text{.}\text{28}×{\text{10}}^{\text{–24}} \text{kg}\cdot \text{m/s}}{9\text{.}\text{11}×{\text{10}}^{\text{–31}} \text{kg}}=5.79 \times 10^{6}  \text{m/s}\text{.} $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-669">
 $$\begin{array}{lll}{\text{KE}}_{e}& =& \frac{1}{2}{\text{mv}}^{2}\\ & =& \frac{1}{2}\left(\text{9.11}×{\text{10}}^{\text{–31}} \text{kg}\right)\left( 5.79 \times 10^{6}  \text{m/s}{\right)}^{2}\\ & =& \text{(1.53}×{\text{10}}^{\text{–17}} \text{J)}\left(\frac{\text{1 eV}}{\text{1.60}×{\text{10}}^{\text{–19}} \text{J}}\right)=\text{95.5 eV.}\end{array} $$
</div>
**Discussion**
