...
<div data-type="equation" id="eip-669">
 $$\begin{array}{lll}{\text{KE}}_{e}& =& \frac{1}{2}{\text{mv}}^{2}\\ & =& \frac{1}{2}\left(9.11 \times 10^{-31} \text{kg}\right)\left( 5.79 \times 10^{6}  \text{m/s}{\right)}^{2}\\ & =& \text{(1.53} \times 10^{-17} \text{J)}\left(\frac{1 \text{eV}}{1.60 \times 10^{-19} \text{J}}\right)=95.5 \text{eV.}\end{array} $$
</div>
**Discussion**
