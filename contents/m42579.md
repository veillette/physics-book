...
It was Werner Heisenberg who first stated this limit to knowledge in 1929 as a result of his work on quantum mechanics and the wave characteristics of all particles. (See [\[link\]](#import-auto-id1606394)). Specifically, consider simultaneously measuring the position and momentum of an electron (it could be any particle). There is an **uncertainty in position**{: data-type="term"} ****$$\Delta x$$
...
. It is not possible to tell how much momentum will be transferred to a detector, and so there is an **uncertainty in momentum**{: data-type="term" #import-auto-id1303661} $$\Delta p$$
...
This is known as the **Heisenberg uncertainty principle**{: data-type="term" #import-auto-id1487877}. It is impossible to measure position $$x$$
 and momentum $$p$$
...
The uncertainty in position is the accuracy of the measurement, or $$\Delta x=0\text{.}\text{0100} \text{nm}$$
...
$$\Delta p=\frac{h}{4\pi \Delta x}=\frac{\text{6.63}×{\text{10}}^{\text{–34}} \text{J}\cdot \text{s}}{4\pi \left(1.00×{\text{10}}^{\text{–11}} \text{m}\right)}=\text{5}\text{.}\text{28}×{\text{10}}^{\text{–24}} \text{kg}\cdot \text{m/s}\text{.}$$
</div>
Thus,

<div data-type="equation" id="eip-705">
$$\Delta p=\text{5}\text{.}\text{28}×{\text{10}}^{\text{–24}} \text{kg}\cdot \text{m/s}=m\Delta v.$$
</div>
Solving for $$\Delta v$$
 and substituting the mass of an electron gives

<div data-type="equation" id="eip-899">
$$\Delta v=\frac{\Delta p}{m}=\frac{5\text{.}\text{28}×{\text{10}}^{\text{–24}} \text{kg}\cdot \text{m/s}}{9\text{.}\text{11}×{\text{10}}^{\text{–31}} \text{kg}}=\text{5}\text{.}\text{79}×{\text{10}}^{6} \text{m/s}\text{.}$$
</div>
**Solution for (b)**
...
$$\begin{array}{lll}{\text{KE}}_{e}& =& \frac{1}{2}{\text{mv}}^{2}\\ & =& \frac{1}{2}\left(\text{9.11}×{\text{10}}^{\text{–31}} \text{kg}\right)\left(\text{5.79}×{\text{10}}^{6} \text{m/s}{\right)}^{2}\\ & =& \text{(1.53}×{\text{10}}^{\text{–17}} \text{J)}\left(\frac{\text{1 eV}}{\text{1.60}×{\text{10}}^{\text{–19}} \text{J}}\right)=\text{95.5 eV.}\end{array}$$
</div>
**Discussion**
...
where $$\Delta E$$
 is the **uncertainty in energy**{: data-type="term" #import-auto-id1359730} and $$\Delta t$$
 is the **uncertainty in time**{: data-type="term" #import-auto-id1279884}. This means that within a time interval $$\Delta t$$
...
An atom in an excited state temporarily stores energy. If the lifetime of this excited state is measured to be $${\text{1.0×10}}^{-\text{10}} s$$
...
The minimum uncertainty in energy $$\Delta E$$
 ...
 and corresponds to a reasonable choice for the uncertainty in time. The largest the uncertainty in time can be is the full lifetime of the excited state, or $$\Delta t={\text{1.0×10}}^{-\text{10}} s$$
.
...
$$\Delta E=\frac{h}{4\pi \Delta t}=\frac{6\text{.}\text{63}×{\text{10}}^{\text{–34}} \text{J}\cdot \text{s}}{4\pi \left({\text{1.0×10}}^{\text{–10}} \text{s}\right)}=\text{5}\text{.}\text{3}×{\text{10}}^{\text{–25}} \text{J.}$$
</div>
Now converting to eV yields

<div data-type="equation" id="eip-424">
$$\Delta E=\text{(5.3}×{\text{10}}^{\text{–25}} \text{J)}\left(\frac{\text{1 eV}}{1\text{.}\text{6}×{\text{10}}^{\text{–19}} \text{J}}\right)=\text{3}\text{.}\text{3}×{\text{10}}^{\text{–6}} \text{eV}\text{.}$$
</div>
**Discussion**

The lifetime of $${\text{10}}^{-\text{10}} \text{s}$$
...
The uncertainty principle for energy and time can be of great significance if the lifetime of a system is very short. Then $$\Delta t$$
 ...
 is consequently very large. Some nuclei and exotic particles have extremely short lifetimes (as small as $${\text{10}}^{-\text{25}} \text{s}$$
), causing uncertainties in energy as great as many GeV ($${\text{10}}^{9} \text{eV}$$
...
(a) If the position of an electron in a membrane is measured to an accuracy of $$1\text{.}\text{00 μm}$$
...
(b) $$9\text{.}\text{55}×{\text{10}}^{-9} \text{eV}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" data-element-type="problems-exercises" markdown="1">
(a) If the position of a chlorine ion in a membrane is measured to an accuracy of $$1\text{.}\text{00 μm}$$
, what is its minimum uncertainty in velocity, given its mass is $$5\text{.}\text{86}×{\text{10}}^{-\text{26}} \text{kg}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" data-element-type="problems-exercises" markdown="1">
Suppose the velocity of an electron in an atom is known to an accuracy of $$2\text{.}0×{\text{10}}^{3} \text{m/s}$$
...
<div data-type="solution" markdown="1">
$$1\text{.}\text{10}×{\text{10}}^{-\text{13}} \text{eV}$$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" data-element-type="problems-exercises" markdown="1">
(a) The lifetime of a highly unstable nucleus is $${\text{10}}^{-\text{20}} \text{s}$$
