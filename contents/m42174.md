...
{\mathbf{\text{F}}}_{\text{i}},}{\mathbf{\text{F}}}_
{\text{n}}, $$
...
\text{net}\tau =0\right) $$. (In order for the nail to actually move, the torque due to $$
{\mathbf{\text{F}}}_{\text{i}} $$
...
nail puller,$$ F_{\text{o}} $$, is much greater than the magnitude of the input force applied to the puller at
the other end,$$ F_{\text{i}} $$. For the nail puller,

<div data-type="equation" id="eip-394">
 $$ \text{MA}=\frac{ F_{\text{o}}}{ F_{\text{i}}}=\frac{ l_{\text{i}}}{ l_{\text{o}}}\text{.} $$ 
</div>
...
given by $$ \text{MA}=\frac{ F_
{\text{o}}}{ F_{\text{i}}} $$
and $$ \text{MA}=\frac{ d_{1}}{ d_{2}} $$, with distances being measured relative to the physical pivot. The wheelbarrow
...
(a) In this case, $$ \frac{ F_{\text{o}}}{ F_{\text{i}}}=\frac{ l_{i}}{
{l}_{o}} $$
becomes

<div data-type="equation" id="eip-501">
$$ F_{\text{i}}={F}_{\text{o}}\frac{ l_{o}}{ l_{i}}\text{.} $$ 
</div>
Adding values into this equation yields

<div data-type="equation" id="eip-453">
$$ F_{\text{i}}=\left(45.0\text{kg}\right)\left(9.80{\text{m/s}}^{2}\right)\frac{\text{0.075 m}}{\text{1.02 m}}=32.4 \text{N}\text{.} $$ 
</div>
The free-body diagram (see [\[link\]](#import-auto-id2664028)) gives the following normal force: $$ F_{i}+N=W $$ 

. Therefore, $$ N=\left(\text{45.0 kg}\right)\left(
9.80{\text{m/s}}^{2}\right)-32.4 \text{N}=\text{409
N} $$. $$ N $$
is the normal force acting on the wheel; by Newton’s third law, the force the
wheel exerts on the ground is $$ 409 \text{N} $$.

**Discussion**

An even longer handle would reduce the force needed to lift the load. The MA
here is $$
\text{MA}=1.02/0.0750=13.6 $$.
...
simplified car axle driving the wheels, as shown. If the axle’s radius is $$ 2.0 cm $$
and the wheel’s radius is $$ \text{24.0 cm} $$, then $$ \text{MA}=2.0/24.0=0.083 $$
and the axle would have to exert a force of $$ 12 000 \text{N} $$
on the wheel to enable it to exert a force of $$ 1000 \text{N} $$
on the ground.
...
on the other side? What minimum force must you exert to apply a force of $$ 1250 \text{N} $$
to the nail?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A typical car has an axle with  $$ 1.\text{10 cm} $$ 

radius driving a tire with a radius of $$ 27\text{.5 cm} $$. What is its mechanical advantage assuming the very simplified model
