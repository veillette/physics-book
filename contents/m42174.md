...
. \\( {\mathbf{\text{F}}}_{\text{n}} \\)

is the reaction force back on the system, equal and opposite to \\(
{\mathbf{\text{F}}}_{\text{o}} \\)

. (Note that \\( {\mathbf{\text{F}}}_{\text{o}} \\)
...
\text{net}\phantom{\rule{0.25em}{0ex}}\tau =0\right) \\)
...
nail puller, \\( {F}_{\text{o}} \\)

, is much greater than the magnitude of the input force applied to the puller at
the other end, \\( {F}_{\text{i}} \\)
...
MA for a crank is simply the ratio of the radii \\( {r}_{\text{i}}/{r}_{0} \\)

. Wheels and gears have this simple expression for their MAs too. The MA can be
...
and the wheel’s radius is \\( \text{24.0 cm} \\)

, then \\( \text{MA}=2.0/\text{24.0}=0\text{.}\text{083} \\)
...
radius driving a tire with a radius of \\( \text{27}\text{.5 cm} \\)

. What is its mechanical advantage assuming the very simplified model
