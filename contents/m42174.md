...
$$ F_{\text{i}}=F_{\text{o}}\frac{ l_{o}}{ l_{i}}\text{.} $$ 
</div>
Adding values into this equation yields

<div data-type="equation" id="eip-453">
$$ F_{\text{i}}=\left(45.0\text{kg}\right)\left(9.80\text{m/s}^{2}\right)\frac{0.075 \text{m}}{1.02 \text{m}}=32.4 \text{N}\text{.} $$ 
</div>
The free-body diagram (see [\[link\]](#import-auto-id2664028)) gives the following normal force: $$ F_{i}+N=W $$ . Therefore, $$ N=\left(45.0 \text{kg}\right)\left(
...
MA for a crank is simply the ratio of the radii $$ r_{\text{i}}/r_{0} $$. Wheels and gears have this simple expression for their MAs too. The MA can be
...
and the wheel’s radius is $$ 24.0 \text{cm} $$, then $$ \text{MA}=2.0/24.0=0.083 $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A typical car has an axle with  $$ 1.10 \text{cm} $$ 

radius driving a tire with a radius of $$ 27.5 \text{cm} $$. What is its mechanical advantage assuming the very simplified model
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
If you used an ideal pulley of the type shown in [[link]](#import-auto-id3492232)(a) to support a car engine of mass  $$ 115 \text{kg} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Repeat [[link]](#fs-id1448216) for the pulley shown in [[link]](#import-auto-id3492232)(c), assuming you pull straight up on the rope. The pulley system’s mass is  $$ 7.00 \text{kg} $$ .
