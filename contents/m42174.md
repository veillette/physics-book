...
{\mathbf{\text{F}}}_{\text{i}},}{\mathbf{\text{F}}}_{\text{n}}, $$
...
{\mathbf{\text{F}}}_{\text{i}} $$
must be ever-so-slightly greater than torque due to $$ {\mathbf{\text{F}}}_{\text{n}} $$.) Hence,
...
given by $$ \text{MA}=\frac{ F_{\text{o}}}{ F_{\text{i}}} $$
...
9.80\text{m/s}^{2}\right)-32.4 \text{N}= 409 \text{N} $$. $$ N $$
...
A crank is a lever that can be rotated $$ 360^\circ $$
...
<div data-type="solution" markdown="1">
a)  $$ \text{MA}=18.5 $$ b) $$ F_{\text{i}}=29.1 \text{N} $$
c) 510 N downward
