...
<div data-type="equation" id="eip-501">
 $$ {F}_{\text{i}}={F}_{\text{o}}\frac{ l_{o}}{ l_{i}}\text{.} $$ 
</div>
Adding values into this equation yields

<div data-type="equation" id="eip-453">
 $$ {F}_{\text{i}}=\left(\text{45.0}\text{kg}\right)\left(9.80{\text{m/s}}^{2}\right)\frac{\text{0.075 m}}{\text{1.02 m}}=\text{32.4 N}\text{.} $$ 
</div>
...
9.80{\text{m/s}}^{2}\right)-\text{32.4 N}=\text{409
N} $$. $$ N $$
