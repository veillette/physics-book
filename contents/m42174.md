...
{\vb{F}}_{\text{n}} $$, and $$ \vb{N} $$. $$
{\vb{F}}_{\text{n}} $$ is the reaction force back on the system,
...
{\text{i}} $$ and $$ {\vb{F}}_{\text{n}} $$ must be equal to each
...
than torque due to $$ {\vb{F}}_{\text{n}} $$.) Hence,
