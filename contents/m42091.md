...
can be written as $$ 8×10^{2} $$, and the number $$ 450 $$
can be written as $$ 4.5×10^{2}. $$
...
<div data-type="equation" id="eip-790">
 $$ \text{Average speed}=30.0\frac{\text{km}}{\text{h}}×\frac{1\text{h}}{\text{3,600 s}}×\frac{1,000}\text{m}}{\text{1 km}}\text{,} $$ 
</div>
...
<div data-type="solution" markdown="1">
 $$ \frac{\text{1.0 m}}{s}=\frac{1.0 \text{m}}{s}×\frac{3600 \text{s}}{\text{1 hr}}×\frac{1 km}{1000 \text{m}} $$ 
