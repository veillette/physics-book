...
data-type="term"} (also known as the metric system) and **English units**{:
data-type="term"} (also known as the customary or imperial system). **English
units**
...
Thus, the numbers $$ 800 $$
and $$ 450 $$
are of the same order of magnitude:  $$ 10^{2}. $$
...
<div data-type="equation" id="eip-442">
 $$ 80\overline{)\text{m}}×\frac{1 \text{km}}{1000\overline{)\text{m}}}=0\text{.080 km.} $$ 
</div>
...
<div data-type="equation" id="eip-583">
 $$ \text{average speed =}0.500\frac{\text{ km}}{\text{ min}}×\frac{60}\text{ min}}{1\text{ h}}=30.0\frac{\text{ km}}{\text{ h}}\text{.} $$ 
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-593">
 $$ \frac{\text{ km}}{\text{min}}×\frac{1\text{ hr}}{60}\text{ min}}=\frac{1}{60}}\frac{\text{ km}\cdot \text{hr}}{ {\text{ min}}^{2}}\text{,} $$ 
</div>
...
<div data-type="equation" id="eip-790">
 $$ \text{Average speed}=30.0\frac{\text{km}}{\text{h}}×\frac{1\text{h}}{\text{3 600 s}}×\frac{1 000 \text{m}}{1 \text{km}}\text{,} $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Show that  $$ 1.0 \text{m/s}=3.6 \text{km/h} $$ . Hint: Show the explicit steps involved in converting $$ 1\text{.}\text{0
m/s}=3\text{.}\text{6 km/h.} $$
</div>
<div data-type="solution" markdown="1">
 $$ \frac{1.0 \text{m}}{s}=\frac{1.0 \text{m}}{s}×\frac{3600 \text{s}}{1 \text{hr}}×\frac{1 km}{1000 \text{m}} $$ 
