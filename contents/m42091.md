...
(also known as the customary or imperial system). **English units**
...
#import-auto-id1989656} (abbreviated kg); it is defined to be the mass of a
...
an atom is on the order of $$ 10^{-9}\text{ m,} $$ while the diameter of the Sun
is on the order of $$ 10^{9}\text{ m.} $$
...
; $$ 4.53 \times 10^{3}\text{ in.} $$ width:  $$ 280 \text{ft} $$ ; $$ 3.3\times
10^{3}\text{ in.} $$.
