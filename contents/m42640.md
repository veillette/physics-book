...
The atomic masses can be found in [Appendix A](/m42699), most conveniently expressed in unified atomic mass units u ($$1\phantom{\rule{0.25em}{0ex}}\text{u}=\text{931}\text{.}5\phantom{\rule{0.25em}{0ex}}\text{MeV}/{c}^{2}$$
...
, for example. To help us look at other effects, we divide BE by $$A$$
 ...
 and consider the **binding energy per nucleon**{: data-type="term" #import-auto-id2598678}, $$\text{BE}/A$$
...
This is a large binding energy per nucleon compared with those for other low-mass nuclei, which have $$\text{BE}/A\approx \text{3 MeV/nucleon}$$
...
<div data-type="solution" markdown="1">
(a) $$1\text{.}\text{46}×{\text{10}}^{-8}\phantom{\rule{0.25em}{0ex}}u$$
