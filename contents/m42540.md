...
Suppose a galaxy is moving away from the Earth at a speed  $$\text{0.825}c $$
 . It emits radio waves with a wavelength of  $$0\text{.}\text{525} \text{m} $$
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
All galaxies farther away than about  $$\text{50}×{\text{10}}^{6} \text{ly} $$
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) All but the closest galaxies are receding from our own Milky Way Galaxy. If a galaxy  $$\text{12}\text{.}0×{\text{10}}^{9} \text{ly} $$
...
<div data-type="solution" markdown="1">
a)  $$0\text{.}\text{99947}c $$
b)  $$1\text{.}\text{2064}×{\text{10}}^{\text{11}} \text{y} $$
c)  $$1\text{.}\text{2058}×{\text{10}}^{\text{11}} \text{y} $$
