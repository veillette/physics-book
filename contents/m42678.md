...
<sup data-type="footnote-number" id="footnote-ref2"><a data-type="footnote-link" href="#footnote2">2</a></sup> 
            ...
            <th>
              Mass  $$\left(\text{GeV}/{c}^{2}\right) $$<sup data-type="footnote-number" id="footnote-ref3"><a data-type="footnote-link" href="#footnote3">3</a></sup> 
...
* {: data-type="footnote-ref" #footnote7} [7](#footnote-ref7){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">Antibaryons have the antiquarks of their counterparts. The antiproton  $$\stackrel{-}{p} $$
  ...
  , for example.</span>
* {: data-type="footnote-ref" #footnote8} [8](#footnote-ref8){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">Baryons composed of the same quarks are different states of the same particle. For example, the  $${\Delta }^{+} $$
