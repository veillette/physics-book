...
One situation where motional emf occurs is known as the Hall effect and has already been examined. Charges moving in a magnetic field experience the magnetic force $$F=\text{qvB}\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\theta $$
...
Here and below, “emf” implies the magnitude of the emf. In this equation, $$N=1$$
 and the flux $$\Phi =\text{BA}\phantom{\rule{0.25em}{0ex}}\text{cos}\phantom{\rule{0.25em}{0ex}}\theta $$
. We have $$\theta =0º$$
 and $$\text{cos}\phantom{\rule{0.25em}{0ex}}\theta =1$$
, since $$B$$
...
(b) $$2.81×{\text{10}}^{\text{8}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
(c) 0.36 m/s
