...
<div data-type="equation" id="eip-480">
 $$\begin{array}{lll}\text{emf}& =& \mathrm{B\ell v}\\ & =& \left(\text{5.00}×{\text{10}}^{-5} \text{T}\right)\left(2\text{.}0×{\text{10}}^{4} \text{m}\right)\left( 7.80 \times 10^{3}  \text{m/s}\right)\\ & =& \text{7.80}×{\text{10}}^{3} \text{V.}\end{array} $$
</div>
**Discussion**
