...
<div class="equation" id="eip-162">
 $$\begin{array}{}\theta =1.22\frac{550 \times 10^{-9}  \text{m}}{2.40 \text{m}}\\ = 2.80 \times 10^{-7}  \text{rad.}\end{array} $$
</div>
**Solution for (b)**
...
The  $$\text{NA} $$
 for a lens is  $$\text{NA}=n \sin \alpha  $$
, where  $$n $$
