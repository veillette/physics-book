...
<div data-type="equation" id="eip-649">
 $$\begin{array}{lll}\lambda & =& \frac{\left(0.0100 \text{mm}\right)\left(\text{sin 10.95º}\right)}{3}\\ & =&  6.33 \times 10^{-4}  \text{mm}=\text{633 nm.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-717">
 $$m=\frac{\left(0.0100 \text{mm}\right)\left(1\right)}{633 \text{nm}}\approx \text{15.8.} $$
</div>
