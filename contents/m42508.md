...
[\[link\]](#import-auto-id1169736768706) shows how to determine the path length difference for waves traveling from two slits to a common point on a screen. If the screen is a large distance away compared with the distance between the slits, then the angle  $$\theta  $$
 between the path and a line from the slits to the screen (see the figure) is nearly the same for each path. The difference between the paths is shown in the figure; simple trigonometry shows it to be  $$d \text{sin} \theta  $$
, where  $$d $$
...
<div data-type="equation" id="eip-39">
 $$d \text{sin} \theta =\mathrm{m\lambda }, \text{for} m=0, 1, -1, 2, -2, \dots   \text{(constructive).} $$
</div>
...
<div data-type="equation" id="eip-752">
 $$d \text{sin} \theta =\left(m+\frac{1}{2}\right)\lambda , \text{for} m=0, 1, -1, 2, -2, \dots   \text{(destructive),} $$
</div>
...
<div data-type="equation">
 $$d \text{sin} \theta =\mathrm{m\lambda }\text{,} \text{for} m=0, 1, -1, 2, -2, \dots . $$
</div>
...
, the smaller  $$d $$
 is, the larger  $$\theta  $$
 must be, since  $$\text{sin} \theta =\mathrm{m\lambda }/d $$
...
. We are given  $$d=0\text{.}\text{0100} \text{mm} $$
 and  $$\theta =\text{10}\text{.}\text{95º} $$
. The wavelength can thus be found using the equation  $$d \text{sin} \theta =\mathrm{m\lambda } $$
 for constructive interference.

**Solution**

The equation is  $$d \text{sin} \theta =\mathrm{m\lambda } $$
...
<div data-type="equation" id="eip-649">
 $$\begin{array}{lll}\lambda & =& \frac{\left(0\text{.}\text{0100 mm}\right)\left(\text{sin 10.95º}\right)}{3}\\ & =& 6\text{.}\text{33}×{\text{10}}^{-4} \text{mm}=\text{633 nm.}\end{array} $$
</div>
**Discussion**
...
The equation  $$d \text{sin} \theta =\mathrm{m\lambda } \text{(for} m=0, 1, -1, 2, -2, \dots \right) $$
 describes constructive interference. For fixed values of  $$d $$
 and  $$\lambda  $$
, the larger  $$m $$
 is, the larger  $$\text{sin} \theta  $$
 is. However, the maximum value that  $$\text{sin} \theta  $$
...
Solving the equation  $$d\text{sin} \theta =\mathrm{m\lambda } $$
 for  $$m $$
 gives

<div data-type="equation" id="eip-624">
 $$m=\frac{d \text{sin} \theta }{\lambda }. $$
</div>
Taking  $$\text{sin} \theta =1 $$
...
* {: #import-auto-id1169738043537} There is constructive interference when
   $$d\text{sin} \theta =\mathrm{m\lambda } \text{(for} m=0, 1, -1, 2, -2, \dots \right) $$
    , where
   $$d $$
...
* {: #import-auto-id1169737945882} There is destructive interference when
   $$d \text{sin} \theta =\left(m+\frac{1}{2}\right)\lambda  \text{(for} m=0, 1, -1, 2, -2, \dots \right) $$
    .
...
Calculate the wavelength of light that has its third minimum at an angle of  $$\text{30}\text{.}0º $$
 when falling on double slits separated by  $$3\text{.}\text{00} \text{μm} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the wavelength of light falling on double slits separated by  $$2\text{.}\text{00} \text{μm} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Find the largest wavelength of light falling on double slits separated by  $$1\text{.}\text{20} \text{μm} $$
...
. When the distance  $$d $$
 between the slits is relatively large, there will be numerous bright spots, called fringes. Show that, for small angles (where  $$\text{sin} \theta \approx \theta  $$
, with  $$\theta  $$
...
<div data-type="solution" markdown="1">
For small angles  $$\text{sin} \theta -\text{tan} \theta \approx \theta  \left(\text{in radians}\right) $$
.

For two adjacent fringes we have,

<div data-type="equation">
 $$d \text{sin} {\theta }_{\text{m}}=\mathrm{m\lambda } $$
</div>
and

<div data-type="equation">
 $$d \text{sin} {\theta }_{\text{m}+1}=\left(m+1\right)\lambda  $$
</div>
Subtracting these equations gives

<div data-type="equation" id="import-auto-id1169737796668">
 $$\begin{array}{}d\left(\text{sin} {\theta }_{\text{m}+1}-\text{sin} {\theta }_{\text{m}}\right)=\left[\left(m+1\right)-m\right]\lambda \\ d\left({\theta }_{\text{m}+1}-{\theta }_{\text{m}}\right)=\lambda \\ \text{tan} {\theta }_{\text{m}}=\frac{ {y}_{\text{m}}}{x}\approx {\theta }_{\text{m}}⇒d\left(\frac{ {y}_{\text{m}+1}}{x}-\frac{ {y}_{\text{m}}}{x}\right)=\lambda \\ d\frac{\Delta y}{x}=\lambda ⇒\Delta y=\frac{\mathrm{x\lambda }}{d}\end{array} $$
</div>
</div>
</div>
