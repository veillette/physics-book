...
F=3.0×10^{6}\text{N} $$. The cross-sectional area is $$ {\mathrm{\pi
...
<div data-type="equation" id="eip-657">
 $$ \begin{array}{lll}\Delta L& =& \left(\frac{1}{210 \times 10^{9}{\text{N/m}}^{2}}\right)\left(\frac{3.0×10^{6}\text{N}}{2.46\times 10^{–3}{\text{m}}^{2}}\right)\left(3020 \text{m}\right)\\ & =& 18 \text{m}.\end{array} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-843">
 $$ F=\text{mg}=\left(62.0 kg\right)\left(9.80 \text{m}{\text{/s}}^{2}\right)=607.6 N, $$ 
</div>
and the cross-sectional area is  $$ {\mathrm{\pi r}}^{2}=1.257 \times 10^{-3}{\text{m}}^{2} $$ 
...
<div data-type="equation" id="eip-24">
 $$ \begin{array}{lll}\Delta L& =& \left(\frac{1}{9×10^{9}{\text{N/m}}^{2}}\right)\left(\frac{607.6 \text{N}}{1.257×10^{-3}{\text{m}}^{2}}\right)\left(0.400 \text{m}\right)\\ & =& 2×10^{-5}\text{m.}\end{array} $$ 
</div>
**Discussion**
...
*S* is found in [\[link\]](#import-auto-id1165298671576) and is  $$ S=80 \times 10^{9}{\text{N/m}}^{2} $$ 

. The radius $$ r $$
is 0.750 mm (as seen in the figure), so the cross-sectional area is

<div data-type="equation" id="eip-365">
 $$ A={\mathrm{\pi r}}^{2}=1.77 \times 10^{-6}{\text{m}}^{2}. $$ 
</div>
The value for  $$  L_{0} $$ 
...
<div data-type="equation" id="eip-736">
 $$ F=\frac{\left(80 \times 10^{9}{\text{N/m}}^{2}\right)\left(1.77 \times 10^{-6}{\text{m}}^{2}\right)}{\left(5.00 \times 10^{-3}\text{m}\right)}\left(1.80 \times 10^{-6}\text{m}\right)=\text{51 N.} $$ 
</div>
...
<div data-type="equation" id="eip-818">
 $$ \begin{array}{lll}\frac{\Delta V}{ V_{0}}& =& \frac{5.00×10^{7}{\text{N/m}}^{2}}{2.2×10^{9}{\text{N/m}}^{2}}\\ & =& 0.023=2.3%.\end{array} $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) The “lead” in pencils is a graphite composition with a Young’s modulus of about  $$ 1×10^{9}\text{N}/{\text{m}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
A disk between vertebrae in the spine is subjected to a shearing force of 600 N. Find its shear deformation, taking it to have the shear modulus of  $$ 1×10^{9}\text{N}/{\text{m}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
A farmer making grape juice fills a glass bottle to the brim and caps it tightly. The juice expands more than the glass when it warms up, in such a way that the volume increases by 0.2% (that is,  $$ \Delta V/{V}_{0}=2×10^{-3} $$ 

) relative to the space available. Calculate the magnitude of the normal force
exerted by the juice per square centimeter if its bulk modulus is $$ 1.8×10^{9}{\text{N/m}}^{2} $$, assuming the bottle does not break. In view of your answer, do you think the
bottle will survive?
