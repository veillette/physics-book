...
deformations, Hooke’s law is obeyed. In equation form, **Hooke’s law**{: data-type="term"}
 is given by
...
Find the mass of the picture hanging from a steel nail as shown in [\[link\]](#import-auto-id1165298644588), given that the nail bends only  
$$ 1.80 \text{ µm} $$ . (Assume the shear modulus is known to two significant figures.)
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
A farmer making grape juice fills a glass bottle to the brim and caps it tightly. The juice expands more than the glass when it warms up, in such a way that the volume increases by 0.2% (that is,  $$ \Delta V/ V_{0}=2\times 10^{-3} $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) When water freezes, its volume increases by 9.05% (that is,  $$ \Delta V/ V_{0}=9.05 \times 10^{-2} $$ 
