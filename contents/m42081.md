...
where  $$ \Delta L $$ is the amount of deformation (the change in length, for example) produced by the
force $$ F $$
**, and $$ k $$
is a proportionality constant that depends on the shape and composition of the
...
F=3.0\times 10^{6}\text{N} $$. The cross-sectional area is 
$$ \pi r^{2}=2.46 \times 10^{-3}\text{m}^{2}
...
<div data-type="equation" id="eip-843">
 $$ F=mg =\left(62.0 kg\right)\left(9.80 \text{m/s}^{2}\right)=607.6 N, $$ 
</div>
...
), and the ratio of the change in length to length, $$ \frac{\Delta L}{ L_{0}} $$, is defined as **strain**{: data-type="term" #import-auto-id1165298883978} (a
...
w $$. If we can find $$ w $$, then the mass of the picture is just $$ \frac{w}{g} $$. 
The equation $$ \Delta x=\frac{1}{S}\frac{F}{A} L_{0} $$
can be solved for $$ F $$.
...
Substituting known values with the value for the bulk modulus  $$ B $$ from [\[link\]](#import-auto-id1165298671576),
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
When using a pencil eraser, you exert a vertical force of 6.00 N at a distance of 2.00 cm from the hardwood-eraser joint. The pencil is 6.00 mm in diameter and is held at an angle of  $$ 20.0^\circ $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
To consider the effect of wires hung on poles, we take data from [[link]](/contents/m42132#fs-id1348788), in which tensions in wires supporting a traffic light were calculated. The left wire made an angle  $$ 30.0^\circ $$ 
...
in a wire making an angle $$ 5.0^\circ $$
...
to the top of the pole at an angle of $$ 30.0^\circ $$
