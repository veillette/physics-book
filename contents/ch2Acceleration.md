...
consider [\[link\]](#import-auto-id3579626).
...
motion. [\[link\]](#import-auto-id2590846) shows graphs of instantaneous
acceleration versus time for two very different motions.
In [\[link\]](#import-auto-id2590846)(a), the acceleration varies slightly and
...
\mss $$).
 In [\[link\]](#import-auto-id2590846)(b), the acceleration varies drastically
...
in [\[link\]](#import-auto-id2590556). In (a)
...
in [\[link\]](#fs-id1744930). Distance traveled is the total length of the path
traveled between the two positions. (
See [Displacement](/contents/ch2Displacement.md).) In the case of the subway train shown
in [\[link\]](#import-auto-id2590556), the distance traveled is the same as the
...
in [\[link\]](#fs-id1372721)
and [\[link\]](#fs-id3600466) are displayed
in [\[link\]](#import-auto-id2596938). (We have taken the velocity to remain
...
x^{\prime} $$ to be $$ -1.5 \text{km} $$ in [\[link\]](#fs-id1744930).
...
velocity, which is positive here. As in [\[link\]](#fs-id3600466), this
...
was not the case in [\[link\]](#fs-id4015260), where a positive acceleration
...
to the left in [\[link\]](#import-auto-id2412190) is sped up by an acceleration
