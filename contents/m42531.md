...
. The muon then travels at constant velocity and lives  $$1\text{.}\text{52} \mu \text{s} $$
...
A clock moving with the system being measured observes the proper time, so the time we are given is  $$\Delta {t}_{0}=1\text{.}\text{52} \mu \text{s} $$
...
,  $$\Delta {t}_{0}=1\text{.}\text{52} \mu \text{s} $$
...
2\. A particle travels at  $$1\text{.}\text{90}×{\text{10}}^{8} \text{m/s} $$
 and lives  $$2\text{.}\text{10}×{\text{10}}^{-8} s $$
 when at rest relative to an observer. How long does the particle live as viewed in the laboratory?

</div>
<div data-type="solution" markdown="1">
 $$\Delta t=\frac{ {\Delta }_{t}}{\sqrt{1-\frac{ {v}^{2}}{ {c}^{2}}}}=\frac{2\text{.}\text{10}×{\text{10}}^{-8} \text{s}}{\sqrt{1-\frac{\left(1\text{.}\text{90}×{\text{10}}^{8} \text{m/s}{\right)}^{2}}{\left(3\text{.}\text{00}×{\text{10}}^{8} \text{m/s}{\right)}^{2}}}}=2\text{.}\text{71}×{\text{10}}^{-8} \text{s} $$
</div>
</div>
...
<div data-type="problem" markdown="1">
Particles called  $$\pi  $$
-mesons are produced by accelerator beams. If these particles travel at  $$2\text{.}\text{70}×{\text{10}}^{8} \text{m/s} $$
 and live  $$2\text{.}\text{60}×{\text{10}}^{-8} \text{s} $$
 when at rest relative to an observer, how long do they live as viewed in the laboratory?

</div>
<div data-type="solution" markdown="1">
 $$5\text{.}\text{96}×{\text{10}}^{-8} \text{s} $$
</div>
</div>
...
, and it lives  $$1\text{.}\text{24}×{\text{10}}^{-8} \text{s} $$
...
<div data-type="problem" markdown="1">
A neutral  $$\pi  $$
-meson is a particle that can be created by accelerator beams. If one such particle lives  $$1\text{.}\text{40}×{\text{10}}^{-\text{16}} \text{s} $$
 as measured in the laboratory, and  $$0\text{.}\text{840}×{\text{10}}^{-\text{16}} \text{s} $$
