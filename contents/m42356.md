...
When are resistors in **series**{: data-type="term" #import-auto-id2680205}? Resistors are in series whenever the flow of charge, called the **current**{: data-type="term" #import-auto-id2006019}, must flow through devices sequentially. For example, if current flows through a person holding a screwdriver and into the Earth, then $${R}_{1}$$
...
According to **Ohm’s law**{: data-type="term" #import-auto-id2075129}, the voltage drop, $$V$$
...
The easiest way to calculate power in watts (W) dissipated by a resistor in a DC circuit is to use **Joule’s law**{: data-type="term" #import-auto-id2017186}, $$P=\text{IV}$$
, where $$P$$
