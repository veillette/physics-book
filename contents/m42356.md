...
Suppose the voltage output of the battery in [\[link\]](#import-auto-id3043995) is $$\text{12}\text{.}0\phantom{\rule{0.25em}{0ex}}\text{V}$$
, and the resistances are $${R}_{1}=1\text{.}\text{00}\phantom{\rule{0.25em}{0ex}}\Omega $$
, $${R}_{2}=6\text{.}\text{00}\phantom{\rule{0.25em}{0ex}}\Omega $$
, and $${R}_{3}=\text{13}\text{.}0\phantom{\rule{0.25em}{0ex}}\Omega $$
...
The three $$\text{IR}$$
 drops add to $$\text{12}\text{.}0\phantom{\rule{0.25em}{0ex}}\text{V}$$
, as predicted:
...
$${P}_{1}+{P}_{2}+{P}_{3}=\left(0\text{.}\text{360}+2\text{.}\text{16}+4\text{.}\text{68}\right)\phantom{\rule{0.25em}{0ex}}\text{W}=7\text{.}\text{20}\phantom{\rule{0.25em}{0ex}}\text{W}.$$
</div>
...
Let the voltage output of the battery and resistances in the parallel connection in [\[link\]](#import-auto-id1926821) be the same as the previously considered series connection: $$V=\text{12}\text{.}0\phantom{\rule{0.25em}{0ex}}\text{V}$$
, $${R}_{1}=1\text{.}\text{00}\phantom{\rule{0.25em}{0ex}}\Omega $$
, $${R}_{2}=6\text{.}\text{00}\phantom{\rule{0.25em}{0ex}}\Omega $$
, and $${R}_{3}=\text{13}\text{.}0\phantom{\rule{0.25em}{0ex}}\Omega $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Refer to [[link]](#import-auto-id2452527) and the discussion of lights dimming when a heavy appliance comes on. (a) Given the voltage source is 120 V, the wire resistance is $$0\text{.}\text{400}\phantom{\rule{0.25em}{0ex}}\Omega $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A 240-kV power transmission line carrying $$5.00×{10}^{2}\phantom{\rule{0.25em}{0ex}}\text{A}$$
...
<div data-type="solution" markdown="1">
(a) $$\begin{array}{}{R}_{\text{s}}={R}_{1}+{R}_{2}\\ ⇒{R}_{\text{s}}\phantom{\rule{0.25em}{0ex}}\approx \phantom{\rule{0.25em}{0ex}}{R}_{1}\left({R}_{1}\text{>>}{R}_{2}\right)\end{array}$$
...
Two resistors, one having a resistance of $$1\text{45}\phantom{\rule{0.25em}{0ex}}\Omega $$
, are connected in parallel to produce a total resistance of $$150\phantom{\rule{0.25em}{0ex}}\Omega $$
