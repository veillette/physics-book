...
Suppose the voltage output of the battery in [\[link\]](#import-auto-id3043995) is  $$ 12.0 \text{V} $$
...
Let the voltage output of the battery and resistances in the parallel connection in [\[link\]](#import-auto-id1926821) be the same as the previously considered series connection:  $$V= 12.0 \text{V} $$
,  $${R}_{1}= 1.00 \Omega  $$
,  $${R}_{2}= 6.00 \Omega  $$
, and  $${R}_{3}= 13.0 \Omega  $$
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
Refer to [[link]](#import-auto-id2452527) and the discussion of lights dimming when a heavy appliance comes on. (a) Given the voltage source is 120 V, the wire resistance is  $$ 0.400 \Omega  $$
...
Show that if two resistors  $${R}_{1} $$
 and  $${R}_{2} $$
 are combined and one is much greater than the other ( $${R}_{1} \gg {R}_{2} $$
