...
<div data-type="equation" id="eip-106">
 $${V}_{1}={\mathit{IR}}_{1}=\left( 0.600 \text{A}\right)\left( 1.0 \Omega \right)= 0.600 \text{V}. $$
</div>
Similarly,

<div data-type="equation" id="eip-787">
 $${V}_{2}={\mathit{IR}}_{2}=\left( 0.600 \text{A}\right)\left( 6.0 \Omega \right)= 3.60 \text{V} $$
</div>
and

<div data-type="equation" id="eip-917">
 $${V}_{3}={\mathit{IR}}_{3}=\left( 0.600 \text{A}\right)\left( 13.0 \Omega \right)= 7.80 \text{V}. $$
</div>
**Discussion for (c)**
...
<div data-type="equation" id="eip-481">
 $$I=\frac{V}{ {R}_{\text{p}}}=\frac{\text{12.0 V}}{\text{0.8041 Ω}}=14.92 \text{A}. $$
</div>
**Discussion for (b)**
...
<div data-type="equation" id="eip-215">
 $$P=\text{IV}=\left(\text{14.92 A}\right)\left(\text{12.0 V}\right)=179 \text{W}. $$
</div>
**Discussion for (e)**
...
<div data-type="equation" id="eip-316">
 $${V}_{1}={\text{IR}}_{1}=\left( 2.35 \text{A}\right)\left( 1.00 \Omega \right)= 2.35 \text{V}. $$
</div>
**Discussion for (b)**
