...
that of the medium in which it is traveling, a $$180 \text{º} $$ phase change (
...
Angles in interference patterns cannot be greater than $$90 \text{º} $$ , for
example.
...
* When light reflects from a medium having an index of refraction greater than
  that of the medium in which it is traveling, a $$180 \text{º} $$ phase
