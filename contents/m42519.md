...
$$\begin{array}{lll}{t}_{\text{c}}& =& \frac{ {\lambda }_{n}}{4}=\frac{\lambda /n}{4}=\frac{\left(\text{650} \text{nm}\right)/1\text{.}\text{333}}{4}\\ & =& \text{122 nm.}\end{array}$$
</div>
...
$${t\prime \prime }_{\text{c}}=\text{610} \text{nm.}$$
</div>
**Solution for (b)**
...
$$\begin{array}{lll}{t\prime }_{\text{d}}& =& \frac{\lambda {}_{n}\text{}}{2}=\frac{\lambda /n}{2}=\frac{\left(\text{650} \text{nm}\right)/1\text{.}\text{333}}{2}\\ & =& \text{244 nm.}\end{array}$$
</div>
Finally, the third destructive thickness is $$2{t\prime \prime }_{\text{d}}={2\lambda }_{n}$$
, so that

<div data-type="equation" id="eip-670">
$$\begin{array}{lll}{t\prime \prime }_{\text{d}}& =& {\lambda }_{n}=\frac{\lambda }{n}=\frac{\text{650} \text{nm}}{1\text{.}\text{333}}\\ & =& \text{488 nm.}\end{array}$$
</div>
**Discussion**
