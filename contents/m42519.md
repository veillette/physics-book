...
Refer to [\[link\]](#import-auto-id1169737818442) and use  $${n}_{1}=100 $$
 for air,  $${n}_{2}=1.38 $$
, and  $${n}_{3}=1.52 $$
...
<div class="equation" id="eip-246">
 $$\begin{array}{lll}t& =& \frac{\lambda /{n}_{2}}{4}=\frac{\left(550 \text{nm}\right)/1.38}{4}\\ & =& 99.6 \text{nm.}\end{array} $$
</div>
**Discussion**
...
Use [\[link\]](#import-auto-id1169737818442) to visualize the bubble. Note that  $${n}_{1}={n}_{3}=1.00 $$
...
<div class="equation" id="eip-889">
 $$\begin{array}{lll}{t}_{\text{c}}& =& \frac{ {\lambda }_{n}}{4}=\frac{\lambda /n}{4}=\frac{\left(650 \text{nm}\right)/1.333}{4}\\ & =& 122 \text{nm.}\end{array} $$
</div>
The next thickness that gives constructive interference is  $$t^{\prime}_{\text{c}}={3\lambda }_{n}/4 $$
, so that

<div class="equation" id="eip-630">
 $$t^{\prime}_{\text{c}}=366 \text{nm.} $$
</div>
...
<div class="equation" id="eip-887">
 $${t^{\prime\prime} }_{\text{c}}=610 \text{nm.} $$
</div>
**Solution for (b)**
...
<div class="equation" id="eip-76">
 $$\begin{array}{lll}t^{\prime}_{\text{d}}& =& \frac{\lambda {}_{n} }{2}=\frac{\lambda /n}{2}=\frac{\left(650 \text{nm}\right)/1.333}{2}\\ & =& 244 \text{nm.}\end{array} $$
</div>
Finally, the third destructive thickness is  $$2{t^{\prime\prime} }_{\text{d}}={2\lambda }_{n} $$
, so that

<div class="equation" id="eip-670">
 $$\begin{array}{lll}{t^{\prime\prime} }_{\text{d}}& =& {\lambda }_{n}=\frac{\lambda }{n}=\frac{650 \text{nm}}{1.333}\\ & =& 488 \text{nm.}\end{array} $$
</div>
**Discussion**
