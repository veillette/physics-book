...
<div data-type="equation" id="eip-899">
 $$ \begin{array}{lll}\alpha & =& \frac{\Delta \omega }{\Delta t}\\ & =& \frac{\text{26.2 rad/s}}{5.00 \text{s}}\\ & =& 5.24{\text{ rad/s}}^{2}\text{.}\end{array} $$ 
</div>
**Strategy for (b)**
...
in [\[link\]](#import-auto-id1019355). Thus, linear acceleration is called **tangential acceleration**{: data-type="term" #import-auto-id1997895} $$  a_
{\text{t}} $$.
...
The radius $$ r $$
is constant for circular motion, and so $$ \Delta \left(\mathrm{r\omega
}\right)=r\left(\Delta \omega \right) $$. Thus,
...
}\omega $$, and $$ \alpha $$. These quantities are analogous to the translational quantities $$ x\mathrm{,
...
* {: #import-auto-id3035395} For circular motion, note that $$
  ...
  <div data-type="equation" id="import-auto-id1588138">
   $$  a_{\mathrm{\text{t}}}=\frac{\Delta \left(r \omega \right)}{\Delta t}. $$ 
  </div>

* {: #import-auto-id1549399} The radius r is constant for circular motion, and
  so $$ \mathrm{\Delta }\left(
