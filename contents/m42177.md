...
{a}_{\text{t}} $$. Then, the expression $$ \alpha =\frac{ a_{\text{t}}}{r} $$
...
<div data-type="equation" id="eip-155">
 $$ \begin{array}{lll}\alpha & =& \frac{ a_{\text{t}}}{r}\\ & =& \frac{\text{7.14}{\text{m/s}}^{2}}{\text{0.320 m}}\\ & =& \text{22.3}{\text{rad/s}}^{2}.\end{array} $$ 
</div>
**Discussion**
