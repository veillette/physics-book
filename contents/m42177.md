...
units of angular acceleration are $$ \left(\text{rad/s}\right)\text{/s} $$, 
or $$ \text{rad/s}^{2} $$. If $$ \omega $$
...
<div data-type="equation" id="eip-899">
 $$ \begin{array}{lll}
\alpha & =& \frac{\Delta \omega }{\Delta t}\\ 
& =&\frac{26.2 \text{rad/s}}{5.00 \text{s}}\\ 
& =& 5.24\text{rad/s}^{2}.
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-455">
 $$ \begin{array}{lll}
\Delta t& =& \frac{–26.2 \text{rad/s}}{–87.3 \text{rad/s}^{2}}\\ 
&=& 0.300 \text{ s.}
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-155">
 $$ \begin{array}{lll}
\alpha & =& \frac{ a_{\text{t}}}{r}\\ 
& =& \frac{7.14\text{m/s}^{2}}{0.320 \text{m}}\\ 
& =& 22.3 \text{rad/s}^{2}.
\end{array} $$ 
</div>
