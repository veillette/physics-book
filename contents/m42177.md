...
<div data-type="equation" id="eip-25">
 $$ \begin{array}{lll}\Delta \omega & =& 250\frac{\text{rev}}{\text{min}}\cdot \frac{\text{2π rad}}{\text{rev}}\cdot \frac{1 \text{min}}{60 \text{sec}}\\ & =& 26.2\frac{\text{rad}}{\text{s}}.\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-455">
 $$ \begin{array}{lll}\Delta t& =& \frac{–26.2 \text{rad/s}}{–87.3 \text{rad/s}^{2}}\\ & =& \text{0.300 s.}\end{array} $$ 
</div>
**Discussion**
