...
So far, we have defined three rotational quantities— $$ \theta \mathrm{,}\omega $$, and $$ \alpha $$. These quantities are analogous to the translational quantities $$ x\mathrm{,
}v $$, and $$ a $$. [\[link\]](#import-auto-id1572984) displays rotational quantities, the
