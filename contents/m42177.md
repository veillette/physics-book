...
Suppose a teenager puts her bicycle on its back and starts the rear wheel spinning from rest to a final angular velocity of 250 rpm in 5.00 s. (a) Calculate the angular acceleration in  $$ {\text{rad/s}}^{2} $$ 
...
<div data-type="equation" id="eip-272">
 $$ \begin{array}{lll}\alpha & =& \frac{\Delta \omega }{\Delta t}\\ & =& \frac{\text{250 rpm}}{\text{5.00 s}}\text{.}\end{array} $$ 
</div>
Because  $$ \Delta \omega  $$ 
...
<div data-type="equation" id="eip-25">
 $$ \begin{array}{lll}\Delta \omega & =& 250}\frac{\text{rev}}{\text{min}}\cdot \frac{\text{2π rad}}{\text{rev}}\cdot \frac{\text{1 min}}{\text{60 sec}}\\ & =& 26.2\frac{\text{rad}}{\text{s}}.\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-899">
 $$ \begin{array}{lll}\alpha & =& \frac{\Delta \omega }{\Delta t}\\ & =& \frac{\text{26.2 rad/s}}{\text{5.00 s}}\\ & =& 5.24{\text{ rad/s}}^{2}\text{.}\end{array} $$ 
</div>
**Strategy for (b)**
...
Here the angular velocity decreases from $$ \text{26.2 rad/s} $$
(250 rpm) to zero, so that $$ \Delta \omega $$
is $$ –\text{26.2 rad/s} $$, and $$ \alpha $$
is given to be $$ –87.3{\text{rad/s}}^{2}
$$. Thus,

<div data-type="equation" id="eip-455">
 $$ \begin{array}{lll}\Delta t& =& \frac{–\text{26.2 rad/s}}{–87.3{\text{rad/s}}^{2}}\\ & =& \text{0.300 s.}\end{array} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-139">
 $$  a_{\text{t}}=\frac{\Delta \left(\mathrm{r\omega }\right)}{\Delta t}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-20">
 $$ \begin{array}{lll} a_{\text{t}}& =& \frac{\Delta v}{\Delta t}\\ & =& \frac{\text{30.0 m/s}}{\text{4.20 s}}\\ & =& 7.14{\text{m/s}}^{2}.\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-155">
 $$ \begin{array}{lll}\alpha & =& \frac{ a_{\text{t}}}{r}\\ & =& \frac{7.14{\text{m/s}}^{2}}{\text{0.320 m}}\\ & =& 22.3{\text{rad/s}}^{2}.\end{array} $$ 
</div>
**Discussion**
...
* {: #import-auto-id3035395} For circular motion, note that $$
  ...
  <div data-type="equation" id="import-auto-id1588138">
   $$  a_{\mathrm{\text{t}}}=\frac{\Delta \left(\mathrm{r\omega }\right)}{\Delta t}. $$ 
  </div>

* {: #import-auto-id1549399} The radius r is constant for circular motion, and
  so $$ \mathrm{\Delta }\left(
  \mathrm{r\omega }\right)=r\Delta \omega $$
  . Thus,
