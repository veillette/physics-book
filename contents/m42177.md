...
(a) Calculate the angular acceleration in  $$  \text{rad/s}^{2} $$ . (b) If she now slams on the brakes, causing an angular acceleration of $$
...
(a) What is
its angular acceleration in $$ \text{rad/s}^{2} $$ ?
(b) What is the tangential
acceleration of a point 9.50 cm from the axis of rotation?
(c) What is the
...
acceleration of $$ 100 \text{rad/s}^{2} $$.
