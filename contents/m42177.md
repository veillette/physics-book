...
–87.3\phantom{\rule{0.25em}{0ex}}{\text{rad/s}}^{2} $$, how long does it take the wheel to stop?
...
is given to be $$ –\text{87.3}\phantom{\rule{0.25em}{0ex}}{\text{rad/s}}^{2}
$$. Thus,

<div data-type="equation" id="eip-455">
 $$ \begin{array}{lll}\Delta t& =& \frac{–\text{26.2 rad/s}}{–\text{87.3}\phantom{\rule{0.25em}{0ex}}{\text{rad/s}}^{2}}\\ & =& \text{0.300 s.}\end{array} $$ 
</div>
**Discussion**
