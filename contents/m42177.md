...
–87.3\phantom{\rule{0.25em}{0ex}}{\text{rad/s}}^{2} \\)
...
}\right)=r\left(\Delta \omega \right) \\)
...
. These quantities are analogous to the translational quantities \\( x\mathrm{,
}v \\)

, and \\( a \\)

. [\[link\]](#import-auto-id1572984) displays rotational quantities, the
...
. The direction of angular acceleration along a fixed axis is denoted by a + or
...
acceleration of \\( \text{100}{\text{ rad/s}}^{2} \\)
