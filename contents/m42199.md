...
<div data-type="equation" id="eip-459">
 $$F=\mathrm{h\rho }\text{gA}=\left(\text{85}\text{.}0×{\text{10}}^{-3} \text{m}\right)\left(\text{13}\text{.}6×{\text{10}}^{3} {\text{kg/m}}^{3}\right)\left(9\text{.}\text{80} {\text{m/s}}^{2}\right)\left( 6.0 \times 10^{-4}  {\text{m}}^{2}\right)=6.8 N. $$
</div>
</div>
...
. The pressure created is  $$P=F/A=\left(\text{5000 N}\right)/\left({\text{10}}^{-3} {\text{m}}^{2}\right)= 5.0 \times 10^{6}  {\text{N/m}}^{2} $$
