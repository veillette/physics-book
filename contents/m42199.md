...
<div data-type="equation" id="eip-652">
 $$\Delta P=\Delta \mathrm{h\rho g}=\left(1.4 m\right)\left(\text{1050 kg}{\text{/m}}^{3}\right)\left(9.80 m{\text{/s}}^{2}\right)= 1.4 \times 10^{4}  \text{Pa}=\text{108 mm Hg}. $$
</div>
...
<div data-type="equation" id="eip-239">
 $$F=\mathrm{h\rho }\text{gA}=\left( 85.0 \times 10^{-3}  \text{m}\right)\left( 13.6 \times 10^{3}  {\text{kg/m}}^{3}\right)\left(9\text{.}\text{80} {\text{m/s}}^{2}\right)\left( 6.0 \times 10^{-4}  {\text{m}}^{2}\right)=6.8 N. $$
</div>
...
<div data-type="equation" id="eip-423">
 $${P}_{\text{g}}= 3.0 \times 10^{4}  {\text{N/m}}^{2}\left(\frac{1.0 mm Hg}{\text{133} {\text{N/m}}^{2}}\right)=\text{226 mm Hg.} $$
</div>
**Strategy for (b)**
