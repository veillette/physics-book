...
2.  {: #import-auto-id2602098} Substitute known values into the new equation:
    <div data-type="equation" id="eip-95">
     $$g={4\pi }^{2}\frac{0.75000 \text{m}}{ {\left(1\text{.}\text{7357 s}\right)}^{2}}. $$
    </div>
...
(b) Since the period is related to the square root of the acceleration of gravity, when the acceleration changes by 1% the period changes by  $$\left(0.01{\right)}^{2}=0\text{.}\text{01%}  $$
