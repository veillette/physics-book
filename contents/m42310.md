...
*) acting on a <strong class="term" id="import-auto-id2383341">test charge </strong> $$q $$
 at a distance  $$r $$
...
<div class="equation" id="eip-380">
 $$\begin{array}{lll}E& =& k\frac{Q}{ {r}^{2}}\\ & =& \left( 8.99 \times 10^{9}  \text{N}\cdot {\text{m}}^{2}{\text{/C}}^{2}\right)×\frac{\left( 2.00 \times 10^{-9}  \text{C}\right)}{ { \left( 5.00 \times 10^{-3}  \text{m} \right)}^{2}}\\ & =&  7.19 \times 10^{5}  \text{N/C.}\end{array} $$
</div>
**Discussion**
...
<div class="equation" id="eip-502">
 $$\begin{array}{lll}F& =& -qE\\ & =& \left(0.250 \times 10^{-6} \text{C}\right)\left( 7.20 \times 10^{5}  \text{N/C}\right)\\ & =& 0.180 \text{N.}\end{array} $$
</div>
Because  $$q $$
