...
$$ y=-20.0 \text{m}$$. Now the initial vertical velocity is the vertical component of the initial velocity,
found from $$ v_{0y}=v_{0}\sin{\theta_{0}} = ( 25.0 \text{m/s} )(  \sin{35.0^\circ } ) = 14.3 \text{m/s} $$. Substituting known values yields
