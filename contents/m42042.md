...
<div data-type="equation" id="eip-931">
 $$ \left(4.90 \text{m/s}^{2}\right) t^{2}-\left(14.3 \text{m/s}\right)t-\left(20.0 \text{m}\right)=0. $$ 
</div>
...
<div data-type="equation" id="eip-873">
 $$ v_{x}=v_{0}\cos{\theta_{0}}=\left(25.0 \text{m/s}\right)\left(\cos{35^\circ }\right)=20.5 \text{m/s} $$ 
</div>
...
<div data-type="equation" id="eip-113">
 $$ v_{y}=14.3 \text{m/s}-\left(9.80 \text{m/s}^{2}\right)\left(3.96 \text{s}\right) $$ 
</div>
so that
