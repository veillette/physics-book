...
<div data-type="equation" id="eip-50">
 $$ \begin{array}{lll}t& =& \frac{2y}{\left(v_{0y}+v_{y}\right)}=\frac{2\left(233 \text{m}\right)}{\left(67.6 \text{m/s}\right)}\\ & =& 6.90 \text{s}.\end{array} $$ 
</div>
**Discussion for (b)**
...
to be zero, then the final position is $$ y=-20.0 \text{m}. $$ Now the
...
<div data-type="equation" id="eip-722">
 $$ -20.0 \text{m}=\left(14.3 \text{m/s}\right)t-\left(4.90 \text{m/s}^{2}\right){t}^{2}. $$ 
</div>
