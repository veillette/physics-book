...
\mathbf{\text{s}} $$
<em> and velocity </em> $$ \mathbf{\text{v}} $$ . Because the *x* - and *y* -motions are perpendicular, we determine these
...
<div data-type="equation" id="eip-895">
 $$ y=y_{0}+v_{0y}t-\frac{1}{2}g t^{2} \text{.} $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
An arrow is shot from a height of 1.5 m toward a cliff of height  $$ H $$ . It is shot with a velocity of 30 m/s at an angle of $$ \text{60º} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In the standing broad jump, one squats and then pushes off with the legs to see how far one can jump. Suppose the extension of the legs from the crouch position is 0.600 m and the acceleration achieved from this position is 1.25 times the acceleration due to gravity,  $$ g $$ . How far can they jump? State your assumptions. (Increased range can be
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Prove that the trajectory of a projectile is parabolic, having the form  $$ y=\text{ax}+b x^{2}  $$ . To obtain this expression, solve the equation $$ x=v_{0x}t $$
for $$ t $$
