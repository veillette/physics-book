...
is $$ t=3.96\text{s} $$  or $$ –1.03\text{s} $$. The negative value of time implies an event before the start of 
motion, and so
we discard it. Thus,
...
(b) When is the velocity a minimum? A
maximum? 

(c) Can the velocity ever be the same as the initial velocity at a time
other than at $$ t=0 $$? 
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{lll}
x& =& 1.30 \text{m} \times 10^{2}\\ 
y& =& 30.9 \text{m.}\end{array} $$
</div>
</div>
