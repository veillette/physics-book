...
are $$ {v}_{x}=v\cos{\theta}
$$ and $$ {v}_{y}=v\sin\mathrm{\theta
...
<div data-type="equation" id="eip-884">
 $$ {v}_{x}={v}_{0}\cos{\theta }_{0}=\left(70.0 m/s\text{}\right)\left(\text{cos 75.0º}\right)=18.1 m/s. $$ 
</div>
The time  $$ t $$ 
...
<div data-type="equation" id="eip-873">
 $$ {v}_{x}={v}_{0}\cos{\theta }_{0}=\left(25.0 m/s\text{}\right)\left(\text{cos 35º}\right)=20.5 m/s $$ 
</div>
...
<div data-type="equation" id="eip-113">
 $$ {v}_{y}=14.3 m/s\text{}-\left(9.80 \text{m/s}{\text{}}^{2}\right)\left(3.96 \text{s}\text{}\right) $$ 
</div>
so that
...
<div data-type="equation" id="eip-394">
 $$ v=\sqrt{ v_{x}^{2}+{v}_{y}^{2}}=\sqrt{\left(20.5 m/s\text{}{\right)}^{2}+\left(-24.5 m/s\text{}{\right)}^{2}}\text{,} $$ 
</div>
which gives
