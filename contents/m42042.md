...
<div data-type="equation" id="eip-677">
 $$ v_{0y}=v_{0}\sin{\theta_{0}}=\left(70.0 \text{m/s}\right)\left(\sin{75^\circ }\right)
=67.6 \text{m/s.} $$ 
</div>
and  $$ y $$ 
...
<div data-type="equation" id="eip-884">
 $$ v_{x}=v_{0}\cos{\theta_{0}}=\left(70.0 \text{m/s}\right)\left(\cos {75.0^\circ }\right)=18.1 m/s. $$ 
</div>
The time  $$ t $$ 
...
<div data-type="equation" id="eip-685">
 $$ x=\left(18.1 \text{m/s}\right)\left(6.90 \text{s}\right)=125 \text{m.} $$ 
</div>
**Discussion for (c)**
...
<div data-type="equation" id="eip-722">
 $$ -20.0 \text{m}=\left(14.3 \text{m/s}\right)t-\left(4.90 \text{m/s}^{2}\right){t}^{2}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-880">
 $$ t=\frac{-b \pm  \sqrt{ b^{2}-4\text{ac}}}{2}\text{a}}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-873">
 $$ v_{x}=v_{0}\cos{\theta_{0}}=\left(25.0 \text{m/s}\right)\left(\cos{35^\circ }\right)=20.5 m/s $$ 
</div>
...
<div data-type="equation" id="eip-113">
 $$ v_{y}=14.3 \text{m/s}-\left(9.80 \text{m/s}{\text{}}^{2}\right)\left(3.96 \text{s}\text{}\right) $$ 
</div>
so that
...
<div data-type="equation" id="eip-394">
 $$ v=\sqrt{ v_{x}^{2}+v_{y}^{2}}=\sqrt{\left(20.5 \text{m/s}{\right)}^{2}+\left(-24.5 \text{m/s}{\right)}^{2}}\text{,} $$ 
</div>
which gives
...
ramp at a speed of $$ 40.0 \text{ m/s }\left(144 \text{km/h}\right) $$. How many buses can he clear if the top of the takeoff ramp is at the same
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A basketball player is running at  $$ 5.00\text{m/s} $$ 
