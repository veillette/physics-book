...
<div data-type="equation" id="eip-240">
 $$ R=\frac{ {v}_{0}^{2}\sin{2\theta }_{0}}{g}\text{,} $$ 
</div>
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{}R=\frac{ { {v}_{0}}^{}}{\sin{2\theta }_{0}g}\\ \text{For}\theta =\text{45º},R=\frac{ { {v}_{0}}^{}}{g}\end{array} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Derive  $$ R=\frac{ {v}_{0}^{2}\sin{2\theta }_{0}}{g} $$ 
