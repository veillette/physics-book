...
<div data-type="equation" id="eip-389">
 $$ {v}^{2}=v_{0}^{2}+2a\left(x-x_{0}\right)\text{.} $$ 
</div>
</div>
...
<div data-type="equation" id="eip-243">
 $$ v_{y}^{2}= v_{0y}^{2}-2g \left( y-y_{0} \right) \text{.} $$ 
</div>
...
and $$ a_{y}=–g $$. We can then define $$ x_{0} $$
and $$ y_{0} $$
...
<div data-type="equation" id="eip-677">
 $$ v_{0y}=v_{0}\sin{\theta }_{0}=\left(70.0 \text{m/s}\right)\left(\text{sin 75º}\right)=\text{67.6 m/s.} $$ 
</div>
and  $$ y $$ 
...
<div data-type="equation" id="eip-512">
 $$ y=\frac{\left(67}.6 \text{m/s}{\right)}^{2}}{2\left(9.80 \text{m}{\text{/s}}^{2}\right)}, $$ 
</div>
so that
...
{0}+\frac{1}{2}\left(v_{0y}+v_{y}\right)t $$. Because $$ y_{0} $$
is zero, this equation reduces to simply

<div data-type="equation" id="eip-383">
 $$ y=\frac{1}{2}\left(v_{0y}+v_{y}\right)t\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-50">
 $$ \begin{array}{lll}t& =& \frac{2y}{\left(v_{0y}+v_{y}\right)}=\frac{2\left(233 \text{m}\right)}{\left(67.6 \text{m/s}\right)}\\ & =& 6.90 \text{s}\text{.}\end{array} $$ 
</div>
**Discussion for (b)**
...
displacement is horizontal velocity multiplied by time as given by $$ x=x_
{0}+v_{x}t $$, where $$ x_{0} $$
is equal to zero:
...
is the **x**-component of the velocity, which is given by $$ v_{x}=v_
{0}\cos{\theta }_
{0}\text{.} $$
Now,

<div data-type="equation" id="eip-884">
 $$ v_{x}=v_{0}\cos{\theta }_{0}=\left(70.0 m/s\text{}\right)\left(\text{cos 75.0º}\right)=18.1 m/s. $$ 
</div>
The time  $$ t $$ 
...
<div data-type="equation" id="eip-685">
 $$ x=\left(18.1 m/s\text{}\right)\left(6.90 \text{s}\text{}\right)=125 \text{m.}\text{} $$ 
</div>
**Discussion for (c)**
...
as the origin such that $$ x_{0}=0 $$
and $$ y_{0}=0 $$. It is also important to define the positive and negative directions in the $$
x $$
and $$ y $$
...
If we take the initial position  $$ y_{0} $$ 

to be zero, then the final position is $$ y=-20.0 \text{m}\text{.} $$
Now the initial vertical velocity is the vertical component of the initial
velocity, found from $$ v_{0y}=v_
{0}\sin{\theta }_
{0} $$
= ( $$ 25.0 \text{m/s} $$
)( $$ \text{sin 35.0º} $$
...
<div data-type="equation" id="eip-722">
 $$ -20.0 m\text{}=\left(14.3 m/s\text{}\right)t-\left(4.90 \text{m/s}^{2}\right){t}^{2}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-931">
 $$ \left(4.90 \text{m/s}{\text{}}^{2}\right){t}^{2}-\left(14.3 \text{m/s}\right)t-\left(20.0 \text{m}\right)=0. $$ 
</div>
...
<div data-type="equation" id="eip-873">
 $$ v_{x}=v_{0}\cos{\theta }_{0}=\left(25.0 m/s\text{}\right)\left(\text{cos 35º}\right)=20.5 m/s $$ 
</div>
...
greater the initial speed $$ v_{0} $$, the greater the range, as shown in [\[link\]](#import-auto-id1904800)(a). The
  ...
  following steps:
    ...
    2. {: #import-auto-id1830316} Analyze the motion of the projectile in the
       ...
       <div data-type="equation" id="eip-612">
        $$ v_{x}=v_{0x}={\mathbf{\text{v}}}_{\text{x}}=\text{velocity is a constant.} $$ 
       </div>
...
* {: #import-auto-id1888635} The maximum height $$ h $$
  of a projectile launched with initial vertical velocity $$ v_{0y} $$
  is given by
...
* {: #import-auto-id1823593} The maximum horizontal distance traveled by a
  ...
  above the horizontal with initial speed $$ v_{0} $$
  is given by
...
<div data-type="solution" markdown="1">
 $$ \begin{array}{lll}x& =& 1.30 \text{m}\times 10^{2}\\ y& =&30 \text{.9 m.}\end{array} $$ 
...
. To obtain this expression, solve the equation $$ x=v_{0x}t $$
for $$ t $$
and substitute it into the expression for $$ y=v_{0y}t–\left(1/2\right)
{\text{gt}}^{2} $$
...
into the expression for $$ x-x_{0} $$, noting that $$ R=x-x_{0} $$
</div>
<div data-type="solution" id="eip-id2932521" markdown="1">
 $$ y-y_{0}=0=v_{0y}t-\frac{1}{2}{\mathrm{gt}}^{2}=\left(v_{0}\sin{\theta} \right)t-\frac{1}{2}{\mathrm{gt}}^{2} $$ 

,

so that $$ t=\frac{2\left(v_
{0}\sin{\theta}
\right)}{g} $$
$$ x-x_{0}=v_{0x}t=\left(v_
{0}\cos{\theta}
\right)
t=R, $$
