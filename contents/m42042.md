...
<div data-type="equation" id="eip-293">
 $$ \text{Vertical Motion}\left(\text{assuming positive is up}{a}_{y}=-g=-9.\text{80}{\text{m/s}}^{2}\right) $$ 
</div>
...
<div data-type="equation" id="eip-884">
 $$ {v}_{x}={v}_{0}\cos{\theta }_{0}=\left(\text{70}\text{.}0 m/s\text{}\right)\left(\text{cos 75.0º}\right)=\text{18}\text{.}1 m/s. $$ 
</div>
The time  $$ t $$ 
...
<div data-type="equation" id="eip-873">
 $$ {v}_{x}={v}_{0}\cos{\theta }_{0}=\left(\text{25}\text{.}0 m/s\text{}\right)\left(\text{cos 35º}\right)=\text{20}\text{.}5 m/s.\text{} $$ 
</div>
...
<div data-type="equation" id="eip-394">
 $$ v=\sqrt{ v_{x}^{2}+{v}_{y}^{2}}=\sqrt{\left(\text{20}\text{.}5 m/s\text{}{\right)}^{2}+\left(-\text{24}\text{.}5 m/s\text{}{\right)}^{2}}\text{,} $$ 
</div>
which gives
  ...
  following steps:
    ...
    3. {: #import-auto-id1939082} Analyze the motion of the projectile in the
       ...
       <div data-type="equation" id="import-auto-id1939084">
        $$ \text{Vertical motion}\left(\text{Assuming positive direction is up;}{a}_{y}=-g=-9\text{.}\text{80 m}{\text{/s}}^{2}\right) $$ 
       </div>
