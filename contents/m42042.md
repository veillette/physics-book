...
{x}=A\phantom{\rule{0.25em}{0ex}}\cos{\theta}
$$
and $$ {A}_
{y}=A\phantom{\rule{0.25em}{0ex}}\sin{\theta}
$$
...
are $$ {v}_{x}=v\phantom{\rule{0.25em}{0ex}}\cos{\theta}
...
{v}_{0y}={v}_{
{0}^{}}\phantom{\rule{0.25em}{0ex}}\sin{\theta}
$$, where $$ {v}_{0y} $$
...
* {: #import-auto-id1786765} To solve projectile motion problems, perform the
  following steps:
    1. {: #import-auto-id1830314} Determine a coordinate system. Then, resolve
       ...
       are given by $$ {v}_
       {x}=v\phantom{\rule{0.25em}{0ex}}\cos{\theta}
       $$
       and $$ {v}_
       {y}=v\phantom{\rule{0.25em}{0ex}}\sin{\theta}
       $$
       , where $$ v $$
...
<div data-type="solution" id="eip-id2932521" markdown="1">
 $$ y-{y}_{0}=0={v}_{0y}t-\frac{1}{2}{\mathrm{gt}}^{2}=\left({v}_{0}\phantom{\rule{0.25em}{0ex}}\sin{\theta} \right)t-\frac{1}{2}{\mathrm{gt}}^{2} $$ 
...
{0}\phantom{\rule{0.25em}{0ex}}\cos{\theta}
\right)
t=R, $$
...
{0}^{2}\phantom{\rule{0.25em}{0ex}}\sin{\theta}
\phantom{\rule{0.25em}{0ex}}\cos{\theta} }{g}
$$
since $$
2\phantom{\rule{0.25em}{0ex}}\sin{\theta}
\phantom{\rule{0.25em}{0ex}}\cos{\theta}
