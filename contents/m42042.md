...
motion**{: data-type="term" #import-auto-id1846113} of an object thrown or projected into the air, subject to only the acceleration of gravity. The
...
magnitudes of these vectors are **s**, **
x**, and **y**. (Note that in the last section we used the notation $$
\mathbf{A} $$
...
motions is time $$ t $$. The problem solving procedures here are the same as for one-dimensional **
kinematics**{: data-type="term"} and are illustrated in the solved examples
below.
