...
$$  \vb{s} $$ * and velocity * $$ \vb{v} $$ . Because the *x*- and *y*-motions
...
<div data-type="equation" id="eip-50">
 $$ \begin{array}{lll}
t& =& \frac{2y}{\left(v_{0y}+v_{y}\right)}=\frac{2\left(233 \text{m}\right)}{\left(67.6 \text{m/s}\right)}\\ & =& 6.90 \text{s}.
\end{array} $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A rugby player passes the ball 7.00 m across the field, where it is caught at the same height as it left his hand. (a) At what angle was the ball thrown if its initial speed was 12.0 m/s, assuming that the smaller of the two possible angles was used?
...
arrow along its trajectory?
(c) What is the arrow’s impact speed just before
hitting the cliff?
...
(a) What vertical velocity does he need to
rise 0.750 m above the floor?
