...
, an expanding gas would be working *against* the external pressure; the work done would therefore be  $$W=-{P}_{\text{ext}}\text{Δ}\mathit{V} $$
 (isobaric process). Many texts use this definition of work, and not the definition based on internal pressure, as the basis of the First Law of Thermodynamics. This definition reverses the sign conventions for work, and results in a statement of the first law that becomes  $$\text{Δ}\mathit{U}=Q+W $$
.)

It is not surprising that  $$W=P\Delta V $$
, since we have already noted in our treatment of fluids that pressure is a type of potential energy per unit volume and that pressure in fact has units of energy divided by volume. We also noted in our discussion of the ideal gas law that  $$\text{PV} $$
 has units of energy. In this case, some of the energy associated with pressure becomes work.

[\[link\]](#import-auto-id1169737742078) shows a graph of pressure versus volume (that is, a  $$\text{PV} $$
 diagram for an isobaric process. You can see in the figure that the work done is the area under the graph. This property of  $$\text{PV} $$
 diagrams is very useful and broadly applicable: *the work done on or by a system in going from one state to another equals the area under the curve on a  $$\text{PV} $$
 diagram*.
...
Calculate the total work done in the cyclical process ABCDA shown in [\[link\]](#import-auto-id1169738251372)(b) by the following two methods to verify that work equals the area inside the closed loop on the  $$\text{PV} $$
...
To find the work along any path on a  $$\text{PV} $$
...
<div data-type="equation">
 $$\begin{array}{lll}{W}_{\text{AB}}& =& {P}_{\text{AB}}\Delta {V}_{\text{AB}}\\ & =& \left(1\text{.}\text{50}×{\text{10}}^{6} {\text{N/m}}^{2}\right)\left(5\text{.}\text{00}×{\text{10}}^{–4} {\text{m}}^{3}\right)=\text{750} \text{J.}\end{array} $$
</div>
...
<div data-type="equation">
 $$\begin{array}{lll}{W}_{\text{CD}}& =& {P}_{\text{CD}}\Delta {V}_{\text{CD}}\\ & =& \left(2\text{.}\text{00}×{\text{10}}^{5} {\text{N/m}}^{2}\right)\left(–5\text{.}\text{00}×{\text{10}}^{–4} {\text{m}}^{3}\right) \text{=} \text{–}\text{100} \text{J}\text{.}\end{array} $$
</div>
...
<div data-type="equation">
 $$\begin{array}{lll}\text{area}& =& \left({P}_{\text{AB}}-{P}_{\text{CD}}\right)\Delta V\\ & =& \left[\left(\text{1.50}×{\text{10}}^{6} {\text{N/m}}^{2}\right)-\left(2\text{.}\text{00}×{\text{10}}^{5} {\text{N/m}}^{2}\right)\right]\left(5\text{.}\text{00}×{\text{10}}^{-4} {\text{m}}^{3}\right)\\ & =& \text{650 J.}\end{array} $$
</div>
Thus,

<div data-type="equation">
 $$\text{area}=\text{650} \text{J}=W\text{.} $$
</div>
**Discussion**

The result, as anticipated, is that the area inside the closed loop equals the work done. The area is often easier to calculate than is the work done along each path. It is also convenient to visualize the area inside different curves on  $$\text{PV} $$
...
[\[link\]](#import-auto-id1169736581959)(a) shows two other important processes on a  $$\text{PV} $$
 diagram. For comparison, both are shown starting from the same point A. The upper curve ending at point B is an **isothermal** process—that is, one in which temperature is kept constant. If the gas behaves like an ideal gas, as is often the case, and if no phase change occurs, then  $$\text{PV}=\text{nRT} $$
. Since  $$T $$
 is constant,  $$\text{PV} $$
...
<div data-type="equation">
 $$\frac{1}{2}m{\overline{v}}^{2}=\frac{3}{2}\text{kT}\text{.} $$
</div>
...
<div data-type="equation">
 $$U=N\frac{1}{2}m{\overline{v}}^{2}=\frac{3}{2}\text{NkT},\text{ (monatomic ideal gas),} $$
</div>
where  $$N $$
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
Which cyclical process represented by the two closed loops, ABCFA and ABDEA, on the  $$\text{PV} $$
...
<div data-type="problem" markdown="1">
A car tire contains  $$0\text{.}\text{0380}{m}^{3} $$
 of air at a pressure of  $$2\text{.}\text{20}×{\text{10}}^{5} {\text{N/m}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Steam to drive an old-fashioned steam locomotive is supplied at a constant gauge pressure of  $$1\text{.}\text{75}×{\text{10}}^{6} {\text{N/m}}^{2} $$
 (about 250 psi) to a piston with a 0.200-m radius. (a) By calculating  $$P\text{Δ}V $$
...
<div data-type="solution" markdown="1">
(a)  $$W=P\text{Δ}V=1\text{.}\text{76}×{\text{10}}^{5} \text{J} $$
(b)  $$W=\text{Fd}=1\text{.}\text{76}×{\text{10}}^{5} \text{J} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A hand-driven tire pump has a piston with a 2.50-cm diameter and a maximum stroke of 30.0 cm. (a) How much work do you do in one stroke if the average gauge pressure is  $$2\text{.}\text{40}×{\text{10}}^{5} {\text{N/m}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) A cyclical heat engine, operating between temperatures of  $$\text{450º C} $$
 and  $$\text{150º C} $$
