...
<div data-type="equation">
 $$\begin{array}{lll}W& =& {W}_{\text{AB}}+{W}_{\text{BC}}+{W}_{\text{CD}}+{W}_{\text{DA}}\\ & =& 750 \text{J}+0+\left(-\text{100}\text{J}\right)+0=650 \text{J.}\end{array} $$
</div>
**Solution for (b)**
...
<div data-type="solution" markdown="1">
(a)  $$W=P\text{Δ}V= 1.76 \times 10^{5}  \text{J} $$
(b)  $$W=\text{Fd}= 1.76 \times 10^{5}  \text{J} $$
