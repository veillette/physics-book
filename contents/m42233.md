...
<div data-type="equation">
 $$\begin{array}{lll}W& =& {W}_{\text{AB}}+{W}_{\text{BC}}+{W}_{\text{CD}}+{W}_{\text{DA}}\\ & =& 750 \text{J}+0+\left(-\text{100}\text{J}\right)+0=\text{650 J.}\end{array} $$
</div>
**Solution for (b)**
...
<div data-type="equation">
 $$\begin{array}{lll}\text{area}& =& \left({P}_{\text{AB}}-{P}_{\text{CD}}\right)\Delta V\\ & =& \left[\left( 1.50 \times 10^{6}  {\text{N/m}}^{2}\right)-\left( 2.00 \times 10^{5}  {\text{N/m}}^{2}\right)\right]\left( 5.00 \times 10^{-4}  {\text{m}}^{3}\right)\\ & =& \text{650 J.}\end{array} $$
</div>
Thus,
