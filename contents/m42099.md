...
What else can we learn by examining the equation $$ x=x_{0}+v_{0}t+\frac{1}{2}a t^{2} ? $$
We see that:
...
2\. Plug the knowns into the equation $$ {v}^{2}=v_{0}^{2}+2a\left(x-x_{0}\right) $$
and solve for $$ v. $$
...
; $$ a=-7.00\text{m/s}^{2} $$
( $$ a $$
is negative because it is in a direction opposite to velocity). We take $$ x_{0} $$
...
<div data-type="equation" id="import-auto-id2178635">
 $$ x_{\text{wet}}=90.0 \text{ m on wet concrete}\text{.} $$ 
</div>
**Solution for (c)**
...
1\. Identify the knowns and what we want to solve for. We know that $$ v_{0}=10 \text{m/s} $$
; $$ a=2.00 \text{m/s}^2 $$
; and $$ x=200 \text{m} $$.
...
where the constants are  $$ a=1\text{.}\text{00,}b=10.0 \text{,}\text{and}c=-200 $$ .
...
A manned rocket accelerates at a rate of  $$ 20 \text{m/s}^2 $$ during launch. How long does it take the rocket to reach a velocity of 400 m/s?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A bullet in a gun is accelerated from the firing chamber to the end of the barrel at an average rate of  $$ 6\text{.20}\times 10^{5}\text{m/s}^{2} $$ for $$ 8.10 \times 10^{-4}\text{s}
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
While entering a freeway, a car accelerates from rest at a rate of  $$ 2.40 \text{m/s}^2 $$ for 12.0 s. (a) Draw a sketch of the situation. (b) List the knowns in this
