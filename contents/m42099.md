...
end of the barrel at an average rate of  
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Dragsters can actually reach a top speed of 145 m/s in only 4.45 s—considerably less time than given in [[link]](#fs-id1164906457202) and [[link]](#fs-id1164906443776). (a) Calculate the average acceleration for such a dragster.
...
The racer has an initial velocity of 11.5 m/s and accelerates at the rate of  $$ 0.500 \text{m/s}^2 $$ for 7.00 s. 
