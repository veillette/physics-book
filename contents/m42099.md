...
$$ t $$ <em> is the final time</em>, $$ x $$ *is the final position*, and
...
where the constants are  $$ a=1.00, b=10.0, \text{ and } c=-200 $$ .
...
compared with the time for a heartb`eat?
...
(a) What is the final velocity of a freight train that accelerates at a rate of  $$ 0.0500 \text{m/s}^2 $$ 
for 8.00 min, starting with an initial velocity of 4.00 m/s? 
...
its stopping distance 4.50 mm ( greater than the head and, hence, less deceleration of the brain). What is the
