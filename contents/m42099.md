...
<div data-type="equation" id="import-auto-id2168495">
 $$ v=v_{0}+\text{at}\text{}\left(\text{constant}a\right)\text{.} $$ 
</div>
</div>
...
the equation $$ v=v_{0}+\text{at} $$.

4\. Plug in the known values and solve.

<div data-type="equation" id="import-auto-id2177855">
 $$ v=v_{0}+\text{at}=70.0 \text{m/s}+\left(-1.50 \text{m/s}^2\right)\left(40.0 \text{s}\right)=10.0 \text{m/s} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id2301379">
 $$ \overline{v}=v_{0}+\frac{1}{2}\text{at}\text{.} $$ 
</div>
...
<div data-type="equation" id="import-auto-id1807031">
 $$ x=x_{0}+v_{0}t+\frac{1}{2}{\text{at}}^{2}\left(\text{constant}a\right)\text{.} $$ 
</div>
</div>
...
can use the equation $$ x=x_{0}+v_{0}t+\frac{1}{2}{\text{at}}^{2} $$
...
* {: #import-auto-id2167534} if acceleration is zero, then the initial velocity
  ...
  $$ v_{0}=\overline{v} $$
  ) and $$ x=x_{0}+v_{0}t+\frac{1}{2}{\text{at}}^{2} $$
...
2\. We need to solve for $$ t $$. Choose the best equation. $$ x=x_{0}+v_{0}t+\frac{1}{2}{\text{at}}^{2}
$$
...
We have been using SI units of meters per second squared to describe some examples of acceleration or deceleration of cars, runners, and trains. To achieve a better feel for these numbers, one can measure the braking deceleration of a car doing a slow (and safe) stop. Recall that, for average acceleration,  $$ \overline{a}=\Delta v/\Delta t $$ 
