...
<div data-type="equation" id="import-auto-id2086556">
 $$ \stackrel{-}{v}=\frac{ v_{0}+v}{2}\left(\text{constant}a\right)\text{.} $$ 
</div>
</div>

The equation $$ \stackrel{-}{v}=\frac{ v_{0}+v}{2} $$
...
<div data-type="equation" id="import-auto-id4152098">
 $$ \stackrel{-}{v}=\frac{ v_{0}+v}{2}=\frac{\text{30 km/h}+\text{60 km/h}}{2}=\text{45 km/h,} $$ 
</div>
...
1\. Identify the knowns. $$ \stackrel{-}{v}=4\text{.}\text{00 m/s} $$, $$ \Delta t=2\text{.}\text{00 min} $$, and $$ {x}_{0}=0 \text{m} $$.**

2\. Enter the known values into the equation.

<div data-type="equation" id="import-auto-id2300752">
 $$ x={x}_{0}+\stackrel{-}{v}t=0+\left(4\text{.}\text{00 m/s}\right)\left(120 \text{s}\right)=480 \text{m} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id1962571">
 $$ a=\frac{v-{v}_{0}}{t}\text{}\left(\text{constant}a\right)\text{.} $$ 
</div>
Solving for  $$ v $$ 
...
<div data-type="equation" id="import-auto-id2168495">
 $$ v={v}_{0}+\text{at}\text{}\left(\text{constant}a\right)\text{.} $$ 
</div>
</div>
...
An airplane lands with an initial velocity of 70.0 m/s and then decelerates at  $$ 1.50 \text{m/s}^2 $$ 
...
1\. Identify the knowns. $$ {v}_{0}=70.\text{0 m/s} $$, $$ a=-1.50 \text{m/s}^2 $$, $$ t=40.0\text{s} $$.
...
<div data-type="equation" id="import-auto-id2177855">
 $$ v={v}_{0}+\text{at}=70.\text{0 m/s}+\left(-1.50 \text{m/s}^2\right)\left(40.0 \text{s}\right)=10.\text{0 m/s} $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id1689620">
 $$ \frac{ v_{0}+v}{2}={v}_{0}+\frac{1}{2}\text{at}\text{.} $$ 
</div>
Since  $$ \frac{ v_{0}+v}{2}=\stackrel{-}{v} $$ 
...
<div data-type="equation" id="import-auto-id1807031">
 $$ x={x}_{0}+{v}_{0}t+\frac{1}{2}{\text{at}}^{2}\left(\text{constant}a\right)\text{.} $$ 
</div>
</div>
...
Dragsters can achieve average accelerations of  $$ 26.0 \text{m/s}^2 $$ 
...
Substituting this and  $$ \stackrel{-}{v}=\frac{ v_{0}+v}{2} $$ 

into $$ x={x}_{0}+\stackrel{-}{v}t $$, we get

<div data-type="equation" id="import-auto-id1659227">
 $$ {v}^{2}={v}_{0}^{2}+2a\left(x-{x}_{0}\right)\text{}\left(\text{constant}a\right)\text{.} $$ 
</div>
</div>
...
<div data-type="equation" id="import-auto-id2177812">
 $$ v=\sqrt{2.09 \times  10^{4}{\text{m}}^{2}{\text{/s}}^{2}}=\text{145 m/s}. $$ 
</div>
**Discussion**
...
; $$ a_{\text{reaction}}=0 $$. We take $$ {x}_{0-\text{reaction}} $$
...
<div data-type="equation" id="import-auto-id2175306">
 $$ x=0+\left(30.\text{0 m/s}\right)\left(0.500 \text{s}\right)=15.0 \text{m}. $$ 
</div>
...
Suppose a car merges into freeway traffic on a 200-m-long ramp. If its initial velocity is 10.0 m/s and it accelerates at  $$ 2.00 \text{m/s}^2 $$ 
...
<div data-type="equation" id="import-auto-id2179013">
 $$ \text{200 m}=\text{0 m}+\left(10.\text{0 m/s}\right)t+\frac{1}{2}\left(2.00 \text{m/s}^2\right){t}^{2} $$ 
</div>
4\. Simplify the equation. The units of meters (m) cancel because they are in each term. We can get the units of seconds (s) to cancel by taking  $$ t=t\text{s} $$ 
...
where the constants are  $$ a=1\text{.}\text{00,}b=10.\text{0,}\text{and}c=-200 $$ 
...
<div data-type="equation" id="import-auto-id2168930">
 $$ t=\frac{v-v{}_{0}\text{}}{a}=\frac{\text{400 m/s}-\text{0 m/s}}{ 20 \text{m/s}^2}=\text{20 s} $$ 
</div>
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A well-thrown ball is caught in a well-padded mitt. If the deceleration of the ball is  $$ 2.10 \times  10^{4}{\text{m/s}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A bullet in a gun is accelerated from the firing chamber to the end of the barrel at an average rate of  $$ 6\text{.20}\times 10^{5}{\text{m/s}}^{2} $$ 
...
rest? (b) The same train ordinarily decelerates at a rate of $$ 1.65 \text{m/s}^2 $$. How long does it take to come to a stop from its top speed? (c) In emergencies
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
While entering a freeway, a car accelerates from rest at a rate of  $$ 2.40 \text{m/s}^2 $$ 
...
decelerates at $$ 2.00 \text{m/s}^2 $$, then she will have stopped after 4.50 s. If she continues to decelerate, she
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In a slap shot, a hockey player accelerates the puck from a velocity of 8.00 m/s to 40.0 m/s in the same direction. If this shot takes  $$ 3.33 \times 10^{-2}\text{s} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Freight trains can produce only relatively small accelerations and decelerations. (a) What is the final velocity of a freight train that accelerates at a rate of  $$ 0.0500 \text{m/s}^2 $$ 

<sup /> for 8.00 min, starting with an initial velocity of 4.00 m/s? (b) If the train can slow down at a rate of  $$ 0.550 \text{m/s}^2 $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A swan on a lake gets airborne by flapping its wings and running on top of the water. (a) If the swan must reach a velocity of 6.00 m/s to take off and it accelerates from rest at an average rate of  $$ 0.350 \text{m/s}^2 $$ 
...
<sup /> and in multiples of  $$ g\left(g=9.80{\text{m/s}}^{2}\right) $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
An express train passes through a station. It enters with an initial velocity of 22.0 m/s and decelerates at a rate of  $$ 0.150 \text{m/s}^2 $$ 
...
beginning, so it would not be accelerating at $$ 32.{\text{6
m/s}}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A bicycle racer sprints at the end of a race to clinch a victory. The racer has an initial velocity of 11.5 m/s and accelerates at the rate of  $$ 0.500 \text{m/s}^2 $$ 
