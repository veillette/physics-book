...
<div data-type="equation" id="import-auto-id2177794">
 $$ {v}^{2}=2\text{.}\text{09}×{\text{10}}^{4}{\text{m}}^{2}{\text{/s}}^{2}. $$ 
</div>
To get  $$ v $$ 
...
<div data-type="equation" id="import-auto-id2177812">
 $$ v=\sqrt{2\text{.}\text{09}×{\text{10}}^{4}{\text{m}}^{2}{\text{/s}}^{2}}=\text{145 m/s}. $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A well-thrown ball is caught in a well-padded mitt. If the deceleration of the ball is  $$ 2\text{.}\text{10}×{\text{10}}^{4}{\text{m/s}}^{2} $$ 

, and 1.85 ms $$ \left(\text{1
ms}={\text{10}}^{-3}\text{s}\right) $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A bullet in a gun is accelerated from the firing chamber to the end of the barrel at an average rate of  $$ 6\text{.20}×{\text{10}}^{5}{\text{m/s}}^{2} $$ 

for $$ 8\text{.}\text{10}×{\text{10}}^{-4}\text{s}
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In a slap shot, a hockey player accelerates the puck from a velocity of 8.00 m/s to 40.0 m/s in the same direction. If this shot takes  $$ 3\text{.}\text{33}×{\text{10}}^{-2}\text{s} $$ 
...
<sup /> and in multiples of  $$ g\left(g=9\text{.}\text{80}{\text{m/s}}^{2}\right) $$ 
