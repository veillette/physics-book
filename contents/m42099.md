...
Now we substitute this expression for  $$ \overline{v} $$ into the equation for displacement, 
$$ x=x_{0}+\overline{v}t $$, yielding
...
rest? (b) The same train ordinarily decelerates at a rate of $$ 1.65 \text{m/s}^2 $$.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
In a slap shot, a hockey player accelerates the puck from a velocity of 8.00 m/s to 40.0 m/s 
in the same direction. If this shot takes  $$ 3.33 \times 10^{-2}\text{s} $$,
...
from rest at an average rate of  $$ 0.350 \text{m/s}^2 $$,
...
its stopping distance 4.50 mm ( greater than the head and, hence, 
