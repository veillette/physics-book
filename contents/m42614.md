...
<div data-type="equation" id="eip-985">
 $$\cos {\theta }_{1}=\frac{ {L}_{Z}}{L}=\frac{\frac{h}{2\pi }}{\frac{\sqrt{2}h}{2\pi }}=\frac{1}{\sqrt{2}}=0\text{.}\text{707.} $$
</div>
Thus,
...
<div data-type="equation" id="eip-607">
 $$\cos {\theta }_{3}=\frac{ {L}_{Z}}{L}=\frac{-\frac{h}{2\pi }}{\frac{\sqrt{2}h}{2\pi }}=-\frac{1}{\sqrt{2}}=-0\text{.}\text{707,} $$
</div>
so that
