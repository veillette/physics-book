...
, so that  $$l $$
 can be either 0 or 1, according to the rule in  $$L=\sqrt{l\left(l+1\right)}\frac{h}{2\pi } $$
 . Similarly, for  $$n=3 $$
,  $$l $$
...
<div data-type="equation" id="eip-935">
 $$L=\sqrt{2\left(2+1\right)}\frac{h}{2\pi }=\sqrt{6}\frac{h}{2\pi }=0\text{.}\text{390}h=2\text{.}\text{58}×{\text{10}}^{-\text{34}} \text{J}\cdot s. $$
</div>
...
<div data-type="equation" id="eip-985">
 $$\text{cos} {\theta }_{1}=\frac{ {L}_{Z}}{L}=\frac{\frac{h}{2\pi }}{\frac{\sqrt{2}h}{2\pi }}=\frac{1}{\sqrt{2}}=0\text{.}\text{707.} $$
</div>
Thus,
...
<div data-type="equation" id="eip-607">
 $$\text{cos} {\theta }_{3}=\frac{ {L}_{Z}}{L}=\frac{-\frac{h}{2\pi }}{\frac{\sqrt{2}h}{2\pi }}=-\frac{1}{\sqrt{2}}=-0\text{.}\text{707,} $$
</div>
so that
...
<div data-type="equation" id="eip-851">
 $$\text{cos} \theta =\frac{ {L}_{z}}{L}=\frac{l}{\sqrt{l\left(l+1\right)}}\text{,} $$
</div>
which approaches 1 as  $$l $$
 becomes very large. If  $$\text{cos} \theta =1 $$
, then ** $$\theta =0º $$
...
<table id="import-auto-id3013526" summary="Three-column table titled Atomic Quantum Numbers. The columns, from left to right, are titled Name, Symbol, and Allowed Values."><caption><span data-type="title">Atomic Quantum Numbers</span></caption><thead><tr>
            ...
            <td>
               $$-l,\phantom{\rule{0.25em}{0ex}}-l\phantom{\rule{0.25em}{0ex}}+1, ...,\phantom{\rule{0.25em}{0ex}}-1, 0, 1, ...,\phantom{\rule{0.25em}{0ex}}l-1,\phantom{\rule{0.25em}{0ex}}l\phantom{\rule{0.25em}{0ex}}\left(\text{or}\phantom{\rule{0.25em}{0ex}}0, ±1, ±2, ...,\phantom{\rule{0.25em}{0ex}}±l\right) $$ 
            </td>
          </tr><tr>
            ...
            <td>    $$\text{1/2}\left(\text{electrons}\right) $$</td>
          </tr><tr>
            <td>Spin projection</td>
            <td>
               $${m}_{s} $$ 
            </td>
            <td>    $$-1/2,\phantom{\rule{0.25em}{0ex}}+1/2 $$</td>
          </tr></tbody></table>
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
 $$n=4⇒l=3, 2, 1, 0⇒{m}_{l}=±3, ±\text{2,} ±\text{1, 0} $$
 are possible.
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$1\text{.}\text{49}×{\text{10}}^{-\text{34}} \text{J}\cdot s $$
(b)  $$1\text{.}\text{06}×{\text{10}}^{-\text{34}} \text{J}\cdot s $$
</div>
</div>
...
<div data-type="solution" data-element-type="problems-exercises" markdown="1">
(a)  $$3\text{.}\text{66}×{\text{10}}^{-\text{34}} \text{J}\cdot s $$
(b)  $$s=9\text{.}\text{13}×{\text{10}}^{-\text{35}} \text{J}\cdot s $$
