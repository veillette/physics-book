...
<table id="import-auto-id3013526" summary="Three-column table titled Atomic Quantum Numbers. The columns, from left to right, are titled Name, Symbol, and Allowed Values."><caption><span class="title">Atomic Quantum Numbers</span></caption><thead><tr>
            <th>Name</th>
            <th>Symbol</th>
...
*  The magnitude of angular momentum is given by
  ...
  <div class="equation" id="eip-763">
   ...
   $${m}_{s}=-1/2 $$ is called spin down. [\[link\]](#import-auto-id3013526) summarizes the atomic quantum numbers and their allowed values.
