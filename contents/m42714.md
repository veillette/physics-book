...
Electric power ( $$P $$
 ) is simply the product of current times voltage. Power has familiar units of watts. Since the SI unit for potential energy (PE) is the joule, power has units of joules per second, or watts. Thus,  $$1 \text{A}\cdot \text{V}=1 \text{W} $$
...
<div class="equation" id="eip-946">
 $$P=IV=\left(2.50 \text{A}\right)\left(12.0 \text{V}\right)=30.0 \text{W.} $$
</div>
The cold resistance was  $$ 0.350 \Omega  $$
, and so the power it uses when first switched on is

<div class="equation" id="eip-704">
 $$P=\frac{ {V}^{2}}{R}=\frac{ {\left( 12.0 \text{V} \right)}^{2}}{ 0.350 \Omega }=411 \text{W.} $$
</div>
**Discussion for (a)**
...
<div class="equation" id="eip-251">
 $$I=\sqrt{\frac{P}{R}}=\sqrt{\frac{411 \text{W}}{ 0.350 \Omega }}=34.3 \text{A.} $$
</div>
**Discussion for (b)**
...
<div class="equation" id="eip-783">
 $$E=P t=\left(60 \text{W}\right)\left(1000 \text{h}\right)=60 000 \text{W}\cdot \text{h.} $$
</div>
In kilowatt-hours, this is

<div class="equation" id="eip-379">
 $$E=60.0 \text{kW}\cdot \text{h.} $$
</div>
