...
<div data-type="equation" id="eip-946">
 $$P=\text{IV}=\left(2.50 \text{A}\right)\left(12.0 \text{V}\right)=\text{30}\text{.}\text{0 W.} $$
</div>
The cold resistance was  $$ 0.350 \Omega  $$
, and so the power it uses when first switched on is

<div data-type="equation" id="eip-704">
 $$P=\frac{ {V}^{2}}{R}=\frac{\left(12.0 \text{V}{\right)}^{2}}{ 0.350 \Omega }=\text{411 W.} $$
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-251">
 $$I=\sqrt{\frac{P}{R}}=\sqrt{\frac{411 \text{W}}{ 0.350 \Omega }}=\text{34}\text{.}\text{3 A.} $$
</div>
**Discussion for (b)**
...
<div data-type="equation" id="eip-783">
 $$E=\text{Pt}=\left(60 \text{W}\right)\left(1000 \text{h}\right)=\text{60 000 W}\cdot \text{h.} $$
</div>
