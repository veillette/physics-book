...
The cold resistance was  $$0\text{.}\text{350} \Omega  $$
, and so the power it uses when first switched on is

<div data-type="equation" id="eip-704">
 $$P=\frac{ {V}^{2}}{R}=\frac{\left(\text{12}\text{.}\text{0 V}{\right)}^{2}}{0\text{.}\text{350} \Omega }=\text{411 W.} $$
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-251">
 $$I=\sqrt{\frac{P}{R}}=\sqrt{\frac{\text{411 W}}{0\text{.}\text{350} \Omega }}=\text{34}\text{.}\text{3 A.} $$
</div>
**Discussion for (b)**
...
. It is easy to estimate the cost of operating electric appliances if you have some idea of their power consumption rate in watts or kilowatts, the time they are on in hours, and the cost per kilowatt-hour for your electric utility. Kilowatt-hours, like all other specialized energy units such as food calories, can be converted to joules. You can prove to yourself that  $$\text{1 kW}\cdot \text{h = 3}\text{.}6×{\text{10}}^{6} \text{J} $$
.
...
<div data-type="problem" markdown="1">
What is the power of a  $$1.00×{\text{10}}^{\text{2}} \text{MV} $$
 lightning bolt having a current of  $${2.00 × 10}^{\text{4}} \text{A} $$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
How many watts does a flashlight that has  $$6.00×{\text{10}}^{\text{2}} \text{C} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Verify the energy unit equivalence that  $$1 \text{kW}\cdot \text{h = 3}\text{.}\text{60}×{\text{10}}^{6} \text{J} $$
.

</div>
<div data-type="solution" markdown="1">
 $$1 \text{kW}\cdot \text{h=}\left(\frac{1×{\text{10}}^{3} \text{J}}{\text{1 s}}\right)\left(1 h\right)\left(\frac{\text{3600 s}}{\text{1 h}}\right)=3\text{.}\text{60}×{\text{10}}^{6} \text{J} $$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Electrons in an X-ray tube are accelerated through  $$1.00×{\text{10}}^{\text{2}} \text{kV} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
00-gauge copper wire has a diameter of 9.266 mm. Calculate the power loss in a kilometer of such wire when it carries  $$1.00×{\text{10}}^{\text{2}} \text{A} $$
.
...
(a) What energy is dissipated by a lightning bolt having a 20,000-A current, a voltage of  $$1.00×{\text{10}}^{\text{2}} \text{MV} $$
...
What current must be produced by a 12.0-V battery-operated bottle warmer in order to heat 75.0 g of glass, 250 g of baby formula, and  $$3.00×{\text{10}}^{\text{2}} \text{g} $$
...
Hydroelectric generators (see [[link]](#import-auto-id2953730)) at Hoover Dam produce a maximum current of  $$8.00×{\text{10}}^{\text{3}} \text{A} $$
...
-high hill in 2.00 min at a constant 25.0-m/s speed while exerting  $$5.00×{\text{10}}^{\text{2}} \text{N} $$
 of force to overcome air resistance and friction? (c) To travel at a constant 25.0-m/s speed, exerting a  $$5.00×{\text{10}}^{\text{2}} \text{N} $$
...
A light-rail commuter train draws 630 A of 650-V DC electricity when accelerating. (a) What is its power consumption rate in kilowatts? (b) How long does it take to reach 20.0 m/s starting from rest if its loaded mass is  $$5\text{.}\text{30}×{\text{10}}^{4} \text{kg} $$
...
<div data-type="solution" markdown="1">
(a)  $$1.23×{\text{10}}^{\text{3}} \text{kg} $$
(b)  $$2.64×{\text{10}}^{\text{3}} \text{kg} $$
</div>
</div>
...
(a) What current is needed to transmit  $$1.00×{\text{10}}^{\text{2}} \text{MW} $$
...
<div data-type="solution" markdown="1">
(a)  $$2.08×{\text{10}}^{\text{5}} \text{A} $$
(b)  $$4.33×{\text{10}}^{\text{4}} \text{MW} $$
