...
. For example, cars often have one or more auxiliary power outlets with which you can charge a cell phone or other electronic devices. These outlets may be rated at 20 A, so that the circuit can deliver a maximum power  $$P=\text{IV}=\left(20 \text{A}\right)\left(12 \text{V}\right)=240 \text{W} $$
...
<div data-type="equation" id="eip-946">
 $$P=\text{IV}=\left(2.50 \text{A}\right)\left(12.0 \text{V}\right)=30.0 \text{W.} $$
</div>
...
<div data-type="equation" id="eip-783">
 $$E=\text{Pt}=\left(60 \text{W}\right)\left(1000 \text{h}\right)=60 000 \text{W}\cdot \text{h.} $$
</div>
...
What is the power of a  $$ 1.00 \times 10^{2}  \text{MV} $$
 lightning bolt having a current of  $${2.00 × 10}^{4} \text{A} $$
?
...
, and a length of 1.00 ms? (b) What mass of tree sap could be raised from  $$ 18.0º\text{C} $$
...
How much time is needed for a surgical cauterizer to raise the temperature of 1.00 g of tissue from  $$ 37.0º\text{C} $$
 to  $$100 \text{º}\text{C} $$
...
(a) An immersion heater utilizing 120 V can raise the temperature of a  $$ 1.00 \times 10^{2} \text{-g} $$
 aluminum cup containing 350 g of water from  $$ 20.0º\text{C} $$
 to  $$ 95.0º\text{C} $$
...
(a) What is the cost of heating a hot tub containing 1500 kg of water from  $$ 10.0º\text{C} $$
 to  $$ 40.0º\text{C} $$
