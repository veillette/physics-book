...
. It is easy to estimate the cost of operating electric appliances if you have some idea of their power consumption rate in watts or kilowatts, the time they are on in hours, and the cost per kilowatt-hour for your electric utility. Kilowatt-hours, like all other specialized energy units such as food calories, can be converted to joules. You can prove to yourself that  $$\text{1 kW}\cdot \text{h = } 3.6 \times 10^{6}  \text{J} $$
.
...
<div data-type="solution" markdown="1">
 $$1 \text{kW}\cdot \text{h=}\left(\frac{1 \times 10^{3}  \text{J}}{\text{1 s}}\right)\left(1 h\right)\left(\frac{\text{3600 s}}{\text{1 h}}\right)= 3.60 \times 10^{6}  \text{J} $$
</div>
</div>
