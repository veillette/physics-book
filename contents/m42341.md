...
<div class="equation" id="eip-340">
 $$\begin{array}{lll}I& =& \frac{\Delta Q}{\Delta t}=\frac{720 \text{C}}{4.00 \text{s}}=180 \text{C/s}\\ & =& 180 \text{A.}\end{array} $$
</div>
**Discussion for (a)**
...
<div class="equation" id="eip-819">
 $$\begin{array}{lll}\Delta t& =& \frac{\Delta Q}{I}=\frac{1.00 \text{C}}{ 0.300 \times 10^{-3}  \text{C/s}}\\ & =&  3.33 \times 10^{3}  \text{s.}\end{array} $$
</div>
**Discussion for (b)**
...
<div class="equation" id="eip-199">
 $$\begin{array}{lll}\frac{ {e}^{\text{–}}}{\text{s}}& =& \frac{ - 0.300 \times 10^{-3} \text{C}}{\text{s}}×\frac{1 {e}^{\text{–}}}{–1.60 \times 10^{-19} \text{C}}\\ & =&  1.88 \times 10^{15}  \frac{ {e}^{\text{–}}}{\text{s}}\text{.}\end{array} $$
</div>
**Discussion**
...
<div class="equation" id="eip-724">
 $$\begin{array}{c}{v}_{\text{d}}=\frac{I}{\text{nqA}}\\ =\frac{20.0 \text{A}}{\left( 8.342 \times 10^{28} {\text{/m}}^{3}\right)\left(-1.60 \times 10^{-19} \text{C}\right)\left( 3.310 \times 10^{-6} {\text{m}}^{2}\right)}\\ =-4.53 \times 10^{-4} \text{m/s.}\end{array} $$
</div>
**Discussion**
...
<div class="solution" markdown="1">
(a)  $$7.81 \times 10^{14} {\text{He}}^{\text{++}} \text{nuclei/s} $$
