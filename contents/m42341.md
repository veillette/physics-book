...
<div data-type="equation" id="eip-199">
 $$\begin{array}{lll}\frac{ {e}^{\text{–}}}{\text{s}}& =& \frac{ - 0.300 \times 10^{-3} \text{C}}{\text{s}}×\frac{1 {e}^{\text{–}}}{–1\text{.60} \times 10^{-19} \text{C}}\\ & =&  1.88 \times 10^{15}  \frac{ {e}^{\text{–}}}{\text{s}}\text{.}\end{array} $$
</div>
**Discussion**
