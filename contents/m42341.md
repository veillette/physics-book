...
<div data-type="equation" id="eip-819">
 $$\begin{array}{lll}\Delta t& =& \frac{\Delta Q}{I}=\frac{\text{1.00 C}}{ 0.300 \times 10^{-3}  \text{C/s}}\\ & =& \text{3.33}×{\text{10}}^{3} \text{s.}\end{array} $$
</div>
**Discussion for (b)**
...
<div data-type="equation" id="eip-226">
 $$\begin{array}{lll}n& =& \frac{\text{1} {e}^{-}}{\text{atom}}×\frac{ 6.02 \times 10^{23}  \text{atoms}}{\text{mol}}×\frac{1 mol}{\text{63}\text{.}\text{54 g}}×\frac{\text{1000 g}}{\text{kg}}×\frac{\text{8.80}×{\text{10}}^{3} \text{kg}}{ {\text{1 m}}^{3}}\\ & =& \text{8}\text{.}\text{342}×{\text{10}}^{\text{28}} {e}^{-}{\text{/m}}^{3}\text{.}\end{array} $$
</div>
The cross-sectional area of the wire is

<div data-type="equation" id="eip-192">
 $$\begin{array}{lll}A& =& \pi {r}^{2}\\ & =& \pi {\left(\frac{ 2.053 \times 10^{-3}  \text{m}}{2}\right)}^{2}\\ & =& \text{3.310}×{\text{10}}^{\text{–6}} {\text{m}}^{2}\text{.}\end{array} $$
</div>
Rearranging  $$I=nqA{v}_{\text{d}} $$
 to isolate drift velocity gives

<div data-type="equation" id="eip-724">
 $$\begin{array}{c}{v}_{\text{d}}=\frac{I}{\mathit{\text{nqA}}}\\ =\frac{\text{20.0 A}}{\left( 8.342 \times 10^{28} {\text{/m}}^{3}\right)\left(\text{–1}\text{.}\text{60}×{\text{10}}^{\text{–19}} \text{C}\right)\left(3\text{.}\text{310}×{\text{10}}^{\text{–6}} {\text{m}}^{2}\right)}\\ =\text{–4}\text{.}\text{53}×{\text{10}}^{\text{–4}} \text{m/s.}\end{array} $$
</div>
**Discussion**
