...
<div data-type="equation" id="eip-819">
 $$\begin{array}{lll}\Delta t& =& \frac{\Delta Q}{I}=\frac{\text{1.00 C}}{ 0.300 \times 10^{-3}  \text{C/s}}\\ & =&  3.33 \times 10^{3}  \text{s.}\end{array} $$
</div>
**Discussion for (b)**
...
<div data-type="equation" id="eip-199">
 $$\begin{array}{lll}\frac{ {e}^{\text{–}}}{\text{s}}& =& \frac{–0\text{.}\text{300}×{\text{10}}^{–3} \text{C}}{\text{s}}×\frac{\text{1} {e}^{\text{–}}}{–1\text{.60}×{\text{10}}^{-\text{19}} \text{C}}\\ & =&  1.88 \times 10^{15}  \frac{ {e}^{\text{–}}}{\text{s}}\text{.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-226">
 $$\begin{array}{lll}n& =& \frac{\text{1} {e}^{-}}{\text{atom}}×\frac{ 6.02 \times 10^{23}  \text{atoms}}{\text{mol}}×\frac{1 mol}{\text{63}\text{.}\text{54 g}}×\frac{\text{1000 g}}{\text{kg}}×\frac{ 8.80 \times 10^{3}  \text{kg}}{ {\text{1 m}}^{3}}\\ & =& \text{8}\text{.}\text{342}×{\text{10}}^{\text{28}} {e}^{-}{\text{/m}}^{3}\text{.}\end{array} $$
</div>
