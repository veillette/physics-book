...
<div data-type="equation" id="eip-340">
 $$\begin{array}{lll}I& =& \frac{\Delta Q}{\Delta t}=\frac{720 \text{C}}{\text{4.00 s}}=180 \text{C/s}\\ & =& \text{180 A.}\end{array} $$
</div>
**Discussion for (a)**
...
The current calculated in the previous example was defined for the flow of positive charge. For electrons, the magnitude is the same, but the sign is opposite,  $${I}_{\text{electrons}}=-0.300 \times 10^{-3 }\text{C/s} $$
...
<div data-type="equation" id="eip-199">
 $$\begin{array}{lll}\frac{ {e}^{\text{–}}}{\text{s}}& =& \frac{ - 0.300 \times 10^{-3} \text{C}}{\text{s}}×\frac{\text{1} {e}^{\text{–}}}{–1\text{.60} \times 10^{-19} \text{C}}\\ & =&  1.88 \times 10^{15}  \frac{ {e}^{\text{–}}}{\text{s}}\text{.}\end{array} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-950">
 $$I=\frac{\Delta Q}{\Delta t}=\frac{\text{qnAx}}{\Delta t} . $$
</div>
...
<div data-type="equation" id="eip-226">
 $$\begin{array}{lll}n& =& \frac{\text{1} {e}^{-}}{\text{atom}}×\frac{ 6.02 \times 10^{23}  \text{atoms}}{\text{mol}}×\frac{1 mol}{63.54 \text{g}}×\frac{1000 \text{g}}{\text{kg}}×\frac{ 8.80 \times 10^{3}  \text{kg}}{ {1 \text{m}}^{3}}\\ & =&  8.342  \times 10^{28} {e}^{-}{\text{/m}}^{3}\text{.}\end{array} $$
</div>
...
<div data-type="equation" id="eip-724">
 $$\begin{array}{c}{v}_{\text{d}}=\frac{I}{\mathit{\text{nqA}}}\\ =\frac{\text{20.0 A}}{\left( 8.342 \times 10^{28} {\text{/m}}^{3}\right)\left(\text{–1}\text{.}60 \times 10^{-19} \text{C}\right)\left( 3.310 \times 10^{-6} {\text{m}}^{2}\right)}\\ =\text{–4}\text{.}53 \times 10^{-4} \text{m/s.}\end{array} $$
</div>
**Discussion**
