...
<div data-type="equation" id="eip-724">
 $$\begin{array}{c}{v}_{\text{d}}=\frac{I}{\mathit{\text{nqA}}}\\ =\frac{20.0 \text{A}}{\left( 8.342 \times 10^{28} {\text{/m}}^{3}\right)\left(\text{–1}\text{.}60 \times 10^{-19} \text{C}\right)\left( 3.310 \times 10^{-6} {\text{m}}^{2}\right)}\\ =\text{–4}\text{.}53 \times 10^{-4} \text{m/s.}\end{array} $$
</div>
**Discussion**
