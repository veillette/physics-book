...
<div data-type="equation" id="eip-672">
 $$ \begin{array}{lll}{\text{KE}}_{\text{int}}& =& \frac{1}{2}m v^{2}=\frac{1}{2}\left(0.150 \text{kg}\right){\left(35.0 \text{m/s}\right)}^{2}\\ \text{}& =& 91.9 \text{J}.
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-172">
 $$ \begin{array}{lll}{KE^{\prime} }_{\text{int}}-{\text{KE}}_{\text{int}}& =& 0.196 \text{J}-91.9 \text{J}\\ & =& -91.7 \text{J}
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-530">
 $$ \begin{array}{lll}{\text{KE}}_{\text{int}}& =& \frac{1}{2}m_{1}v_{1}^{2}+\frac{1}{2}m_{2}v_{2}^{2}\\ & =& \frac{1}{2}\left(0.350 \text{kg}\right){\left(2.00 \text{m/s}\right)}^{2}+\frac{1}{2}\left(0.500 \text{kg}\right){\left(–0.500 \text{m/s}\right)}^{2}\\ & =& 0.763 \text{J}.
\end{array} $$ 
</div>
After the collision, the internal kinetic energy is
...
6.22 \text{J}-0.763 \text{J}\\ & =& 5.46 \text{J.}
\end{array} $$ 
</div>
**Discussion**
