...
<div data-type="equation" id="eip-777">
 $$ v\prime =\left(\frac{\text{0.150 kg}}{\text{0.150 kg}+\text{70.0 kg}}\right)\left(\text{35}\text{.0 m/s}\right)=7\text{.}\text{48}×{\text{10}}^{-2}\text{m/s}\text{.} $$ 
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-440">
 $$ \begin{array}{lll}{\text{KE}\prime }_{\text{int}}& =& \frac{1}{2}\left(m+M\right){v}^{2}=\frac{1}{2}\left(\text{70}\text{.}\text{15 kg}\right){\left(7\text{.}\text{48}×{\text{10}}^{-2}\text{m/s}\right)}^{2}\\ & =& \text{0.196 J.}\end{array} $$ 
</div>
...
have an initial velocity of $$ 2\text{.}\text{00 m/s} $$. Cart 2 (denoted $$ {m}_{2} $$
in [\[link\]](#import-auto-id1258204)) has a mass of 0.500 kg and an initial
velocity of $$ -0\text{.}\text{500 m/s} $$. After the collision, cart 1 is observed to recoil with a velocity of $$
-4\text{.}\text{00 m/s} $$. (a) What is the final velocity of cart 2? (b) How much energy was released by
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A battleship that is  $$ 6\text{.}\text{00}×{\text{10}}^{7}\text{kg} $$ 
...
4\text{.}\text{00}×{\text{10}}^{3}\text{kg} $$, and the second a mass of $$
\text{7.50}×{\text{10}}^{3}\text{kg} $$. (a) Calculate the final velocity (after docking) by using the frame of
...
{}^{\text{239}}\text{Pu}\right) $$. This nucleus is radioactive and decays by splitting into a helium-4 nucleus
and a uranium-235 nucleus $$ \left(
{}^{4}{\text{He}}+{}^{\text{235}}U\right) $$, the latter of which is also radioactive and will itself decay some time later.
The energy emitted in the plutonium decay is $$
\text{8.40}×{\text{10}}^{–\text{13}}J $$
and is entirely converted to kinetic energy of the helium and uranium nuclei.
The mass of the helium nucleus is $$
\text{6.68}×{\text{10}}^{–\text{27}}\text{kg} $$, while that of the uranium is $$
3\text{.}\text{92}×{\text{10}}^{–\text{25}}\text{kg}
$$
...
(a)  $$ 1\text{.}\text{02}×{\text{10}}^{-6}\text{m/s} $$ 

(b) ** $$
5\text{.}\text{63}×{\text{10}}^{\text{20}}J $$
** (almost all KE lost)

(c) Recoil speed is $$
6\text{.}\text{79}×{\text{10}}^{-\text{17}}\text{m/s}
$$, energy lost is $$
6\text{.}\text{25}×{\text{10}}^{9}J $$. The plume will not affect the momentum result because the plume is still part
...
What is the speed of a garbage truck that is  $$ 1\text{.}\text{20}×{\text{10}}^{4}\text{kg} $$ 
