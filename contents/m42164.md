...
<div data-type="equation" id="eip-440">
 $$ \begin{array}{lll}{\text{KE}\prime }_{\text{int}}& =& \frac{1}{2}\left(m+M\right){v}^{2}=\frac{1}{2}\left(70.15 \text{kg}\right){\left(7.48 \times 10^{-2}\text{m/s}\right)}^{2}\\ & =& \text{0.196 J.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-999">
 $$ \begin{array}{lll}{v^{\prime} }_{2}& =& \frac{ m_{1}v_{1}+m_{2}v_{2}-m_{1}{v^{\prime} }_{1}}{ m_{2}}\\ & =& \frac{\left(0.350 \text{kg}\right)\left(2.00 \text{m/s}\right)+\left(0.500 \text{kg}\right)\left(-0.500 \text{m/s}\right)}{0.500 \text{kg}}-\frac{\left(0.350 \text{kg}\right)\left(-4.00 \text{m/s}\right)}{0.500 \text{kg}}\\ & =& \text{3.70 m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-626">
 $$ \begin{array}{lll}{\text{KE}\prime }_{\text{int}}& =& \frac{1}{2}m_{1}{v^{\prime} }_{1}^{2}+\frac{1}{2}m_{2}{v^{\prime} }_{2}^{2}\\ & =& \frac{1}{2}\left(0.350 \text{kg}\right){\left(-4.00 \text{m/s}\right)}^{2}+\frac{1}{2}\left(0.500 \text{kg}\right){\left(3.70 \text{m/s}\right)}^{2}\\ & =& \text{6.22 J.}\end{array} $$ 
</div>
The change in internal kinetic energy is thus

<div data-type="equation" id="eip-246">
 $$ \begin{array}{lll}{KE^{\prime} }_{\text{int}}-{\text{KE}}_{\text{int}}& =& 6.22 \text{J}-0.763 \text{J}\\ & =& \text{5.46 J.}\end{array} $$ 
</div>
**Discussion**
