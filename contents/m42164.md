...
\text{7.50}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{kg} $$. (a) Calculate the final velocity (after docking) by using the frame of
...
\text{6.68}×{\text{10}}^{–\text{27}}\phantom{\rule{0.25em}{0ex}}\text{kg} $$, while that of the uranium is $$
...
$$, energy lost is $$
6\text{.}\text{25}×{\text{10}}^{9}\phantom{\rule{0.25em}{0ex}}J $$. The plume will not affect the momentum result because the plume is still part
