...
\frac{1}{2}{\text{mv}}^{2}+\frac{1}{2}{\text{mv}}^{2}={\text{mv}}^{2} $$. The two objects come to rest after sticking together, conserving momentum. But
...
<div data-type="equation" id="eip-370">
 $$ v^{\prime} =\frac{ m_{1}}{ m_{1}+{m}_{2}}{v}_{1}. $$ 
</div>
Entering known values in this equation, we get

<div data-type="equation" id="eip-777">
 $$ v^{\prime} =\left(\frac{\text{0.150 kg}}{\text{0.150 kg}+\text{70.0 kg}}\right)\left(35}\text{.0 m/s}\right)=7.48 \times 10^{-2}\text{m/s}\text{.} $$ 
</div>
**Discussion for (a)**
...
<div data-type="equation" id="eip-672">
 $$ \begin{array}{lll}{\text{KE}}_{\text{int}}& =& \frac{1}{2}{\text{mv}}^{2}=\frac{1}{2}\left(0\text{.}\text{150 kg}\right){\left(35}\text{.0 m/s}\right)}^{2}\\ \text{}& =& 91.9 \text{J}\text{.}\end{array} $$ 
</div>
After the collision, the internal kinetic energy is

<div data-type="equation" id="eip-440">
 $$ \begin{array}{lll}{\text{KE}\prime }_{\text{int}}& =& \frac{1}{2}\left(m+M\right){v}^{2}=\frac{1}{2}\left(70.\text{15 kg}\right){\left(7.48 \times 10^{-2}\text{m/s}\right)}^{2}\\ & =& \text{0.196 J.}\end{array} $$ 
</div>
...
have an initial velocity of $$ 2.00 \text{m/s} $$. Cart 2 (denoted $$ {m}_{2} $$
...
<div data-type="equation" id="eip-999">
 $$ \begin{array}{lll}{v^{\prime} }_{2}& =& \frac{ m_{1}{v}_{1}+{m}_{2}{v}_{2}-{m}_{1}{v^{\prime} }_{1}}{ m_{2}}\\ & =& \frac{\left(\text{0.350 kg}\right)\left(\text{2.00 m/s}\right)+\left(\text{0.500 kg}\right)\left(-\text{0.500 m/s}\right)}{\text{0.500 kg}}-\frac{\left(\text{0.350 kg}\right)\left(-\text{4.00 m/s}\right)}{\text{0.500 kg}}\\ & =& \text{3.70 m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-530">
 $$ \begin{array}{lll}{\text{KE}}_{\text{int}}& =& \frac{1}{2}{m}_{1}{v}_{1}^{2}+\frac{1}{2}{m}_{2}{v}_{2}^{2}\\ & =& \frac{1}{2}\left(0\text{.}\text{350 kg}\right){\left(\text{2.00 m/s}\right)}^{2}+\frac{1}{2}\left(0\text{.}\text{500 kg}\right){\left(–0.500 \text{m/s}\right)}^{2}\\ & =& 0.763 \text{J}.\end{array} $$ 
</div>
After the collision, the internal kinetic energy is
...
7.50×10^{3}\text{kg} $$. (a) Calculate the final velocity (after docking) by using the frame of
