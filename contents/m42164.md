...
An **inelastic collision**{: data-type="term" #import-auto-id1572341}
 is one in which the internal kinetic
...
\frac{1}{2}m v^{2}+\frac{1}{2}m v^{2}=m v^{2} $$. The two objects come to rest after sticking together, conserving momentum. But
...
<div data-type="equation" id="eip-777">
 $$ v^{\prime} =\left(\frac{0.150 \text{kg}}{0.150 \text{kg}+70.0 \text{kg}}\right)\left(35.0 \text{m/s}\right)=7.48 \times 10^{-2}\text{m/s}\text{.} $$ 
</div>
**Discussion for (a)**
...
rest. Therefore, $$ {\text{KE}}_{\text{int}} $$
is initially

<div data-type="equation" id="eip-672">
 $$ \begin{array}{lll}{\text{KE}}_{\text{int}}& =& \frac{1}{2}m v^{2}=\frac{1}{2}\left(0.150 \text{kg}\right){\left(35.0 \text{m/s}\right)}^{2}\\ \text{}& =& 91.9 \text{J}\text{.}\end{array} $$ 
</div>
After the collision, the internal kinetic energy is

<div data-type="equation" id="eip-440">
 $$ \begin{array}{lll}{\text{KE}\prime }_{\text{int}}& =& \frac{1}{2}\left(m+M\right){v}^{2}=
\frac{1}{2}\left(70.15 \text{kg}\right){\left(7.48 \times 10^{-2}\text{m/s}\right)}^{2}\\ & =& 
0.196 \text{J.}\end{array} $$ 
</div>
The change in internal kinetic energy is thus

<div data-type="equation" id="eip-172">
 $$ \begin{array}{lll}{KE^{\prime} }_{\text{int}}-{\text{KE}}_{\text{int}}& =& 0.196 \text{J}-91.9 \text{J}\\ & =& -91.7 \text{J}\end{array} $$ 
</div>
...
inelastic collision. $$ {\text{KE}}_{\text{int}} $$
...
have an initial velocity of $$ 2.00 \text{m/s} $$. Cart 2 (denoted $$ m_{2} $$
in [\[link\]](#import-auto-id1258204)) has a mass of 0.500 kg and an initial
velocity of $$ -0.500 \text{m/s} $$. After the collision, cart 1 is observed to recoil with a velocity of $$
-4.00 \text{m/s} $$. (a) What is the final velocity of cart 2? (b) How much energy was released by
...
<div data-type="equation" id="eip-473">
 $$ m_{1}v_{1}+m_{2}v_{2}=m_{1}{v^{\prime} }_{1}+m_{2}{v^{\prime} }_{2}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-999">
 $$ \begin{array}{lll}{v^{\prime} }_{2}& =& 
\frac{ m_{1}v_{1}+m_{2}v_{2}-m_{1}{v^{\prime} }_{1}}{ m_{2}}\\ & =& 
\frac{\left(0.350 \text{kg}\right)\left(2.00 \text{m/s}\right)+
\left(0.500 \text{kg}\right)\left(-0.500 \text{m/s}\right)}{0.500 \text{kg}}-
\frac{\left(0.350 \text{kg}\right)\left(-4.00 \text{m/s}\right)}{0.500 \text{kg}}\\ & =& 
3.70 \text{m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-530">
 $$ \begin{array}{lll}{\text{KE}}_{\text{int}}& =& \frac{1}{2}m_{1}v_{1}^{2}+\frac{1}{2}m_{2}v_{2}^{2}\\ & =& \frac{1}{2}\left(0.350 \text{kg}\right){\left(2.00 \text{m/s}\right)}^{2}+\frac{1}{2}\left(0.500 \text{kg}\right){\left(–0.500 \text{m/s}\right)}^{2}\\ & =& 0.763 \text{J}.\end{array} $$ 
</div>
After the collision, the internal kinetic energy is

<div data-type="equation" id="eip-626">
 $$ \begin{array}{lll}{\text{KE}\prime }_{\text{int}}& =& 
\frac{1}{2}m_{1}{v^{\prime}}_{1}^{2}+\frac{1}{2}m_{2}{v^{\prime}}_{2}^{2}\\ & =& 
\frac{1}{2}\left(0.350 \text{kg}\right) \left(-4.00 \text{m/s}\right)^{2}+
\frac{1}{2}\left(0.500 \text{kg}\right) \left(3.70 \text{m/s}\right)^{2}\\ & =& 
6.22 \text{J.}\end{array} $$ 
</div>
The change in internal kinetic energy is thus

<div data-type="equation" id="eip-246">
 $$ \begin{array}{lll}KE^{\prime}_{\text{int}}-\text{KE}_{\text{int}}& =&
6.22 \text{J}-0.763 \text{J}\\ & =& 5.46 \text{J.}\end{array} $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A battleship that is  $$ 6.00 \times 10^{7}\text{kg} $$ and is originally at rest fires a 1100-kg artillery shell horizontally with a
...
4.00 \times 10^{3}\text{kg} $$, and the second a mass of $$
7.50\times 10^{3}\text{kg} $$. (a) Calculate the final velocity (after docking) by using the frame of
...
{}^{239}\text{Pu}\right) $$. This nucleus is radioactive and decays by splitting into a helium-4 nucleus
and a uranium-235 nucleus $$ \left(
{}^{4}{\text{He}}+{}^{235}U\right) $$, the latter of which is also radioactive and will itself decay some time later.
...
6.68\times 10^{–27}}\text{kg} $$, while that of the uranium is $$
3.92 \times 10^{–25}}\text{kg}
$$
...
the Moon is $$7.36 \times {10}^{22}\text{kg} $$
...
(a)  $$ 1.02 \times 10^{-6}\text{m/s} $$ 

(b) ** $$ 5.63 \times 10^{20}\text{J} $$
** (almost all KE lost)

(c) Recoil speed is $$6.79 \times 10^{-17}\text{m/s}$$, energy lost is $$6.25 \times 10^{9} \text{J} $$. The plume will not affect the momentum result 
...
What is the speed of a garbage truck that is  $$ 1.20 \times 10^{4}\text{kg} $$ and is initially moving at 25.0 m/s just after it hits and adheres to a trash
...
inelastic collision
: a collision in which internal kinetic energy is not conserved {: #import-auto-id1488639}

perfectly inelastic collision
: a collision in which the colliding objects stick together {: #import-auto-id1512865}
