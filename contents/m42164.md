...
Because the goalie is initially at rest, we know  $$ v_{2}=0 $$ 
...
In the collision pictured in [\[link\]](#import-auto-id1258204), two carts collide inelastically. Cart 1 (denoted  $$ m_{1} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A battleship that is  $$ 6.00 \times 10^{7}\text{kg} $$ 
...
What is the speed of a garbage truck that is  $$ 1.20 \times 10^{4}\text{kg} $$ 
