...
The force between two long straight and parallel conductors separated by a distance  $$r $$
 can be found by applying what we have developed in preceding sections. [[Figure 1]](#Figure1) shows the wires, their currents, the fields they create, and the subsequent forces they exert on one another. Let us consider the field produced by wire 1 and the force it exerts on wire 2 (call the force  $${F}_{2} $$ ).
