...
This field is uniform along wire 2 and perpendicular to it, and so the force  $${F}_{2} $$
 it exerts on wire 2 is given by  $$F=\text{IlB} \text{sin} \theta  $$
 with  $$\text{sin} \theta =1 $$
\:
...
<div data-type="equation" id="eip-769">
 $$\frac{F}{l}=\frac{\left(4\pi ×{\text{10}}^{-7} T\cdot \text{m/A}\right){\left(1 A\right)}^{2}}{\left(2\pi \right)\left(1 m\right)}=2×{\text{10}}^{-7} \text{N/m.} $$
</div>

Since  $${\mu }_{0} $$
 is exactly  $$4\pi ×{\text{10}}^{-7} T\cdot \text{m/A} $$
 by definition, and because  $$\text{1 T}=\text{1 N/}\left(A\cdot m\right) $$
, the force per meter is exactly  $$2×{\text{10}}^{-7} \text{N/m} $$
...
One ampere of current through each of two parallel conductors of infinite length, separated by one meter in empty space free of other magnetic fields, causes a force of exactly  $$2×{\text{10}}^{-7} \text{N/m} $$
 on each conductor.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The wire carrying 400 A to the motor of a commuter train feels an attractive force of  $$4\text{.}\text{00}×{\text{10}}^{-3} \text{N/m} $$
...
<div data-type="solution" markdown="1">
(a)  $$1\text{.}\text{67}×{\text{10}}^{-3} \text{N/m} $$
(b)  $$3\text{.}\text{33}×{\text{10}}^{-3} \text{N/m} $$
(c) Repulsive
...
<div data-type="solution" markdown="1">
(a) Top wire:  $$2\text{.}\text{65}×{\text{10}}^{-4} \text{N/m} $$
 s,  $$\text{10}\text{.}9º $$
 to left of up

(b) Lower left wire:  $$3\text{.}\text{61}×{\text{10}}^{-4} \text{N/m} $$
,  $$\text{13}\text{.}9º $$
 down from right

(c) Lower right wire:  $$3\text{.}\text{46}×{\text{10}}^{-4} \text{N/m} $$
,  $$\text{30}\text{.}0º $$
 down from left
