...
<div class="equation" id="eip-769">
 $$\frac{F}{l}=\frac{\left(4\pi  \times 10^{-7} \text{T}\cdot \text{m/A}\right){\left(1 A\right)}^{2}}{\left(2\pi \right)\left(1 m\right)}=2 \times 10^{-7}  \text{N/m.} $$
</div>
...
* The force between two parallel currents
   $${I}_{1} $$ and $${I}_{2} $$, separated by a distance $$r $$
