...
<div data-type="equation" id="eip-738">
 $$\begin{array}{lll}r=\frac{\text{mv}}{\text{qB}}& =& \frac{\left( 9.11 \times 10^{-31}  \text{kg}\right)\left( 6.00 \times 10^{7}  \text{m/s}\right)}{\left( 1.60 \times 10^{-19}  \text{C}\right)\left(0\text{.}\text{500} \text{T}\right)}\\ & =&  6.83 \times 10^{-4}  \text{m}\end{array} $$
</div>
or
