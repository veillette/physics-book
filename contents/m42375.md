...
<div data-type="equation" id="eip-738">
 $$\begin{array}{lll}r=\frac{\text{mv}}{\text{qB}}& =& \frac{\left(9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg}\right)\left( 6.00 \times 10^{7}  \text{m/s}\right)}{\left(1\text{.}\text{60}×{\text{10}}^{-\text{19}} \text{C}\right)\left(0\text{.}\text{500} \text{T}\right)}\\ & =&  6.83 \times 10^{-4}  \text{m}\end{array} $$
</div>
or
...
, in a direction perpendicular to the Earth’s field, which has a strength of  $$ 5.00 \times 10^{-5}  T $$
