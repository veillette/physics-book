...
<div data-type="equation" id="eip-738">
 $$\begin{array}{lll}r=\frac{\text{mv}}{\text{qB}}& =& \frac{\left(9\text{.}\text{11}×{\text{10}}^{-\text{31}} \text{kg}\right)\left(6\text{.}\text{00}×{\text{10}}^{7} \text{m/s}\right)}{\left(1\text{.}\text{60}×{\text{10}}^{-\text{19}} \text{C}\right)\left(0\text{.}\text{500} \text{T}\right)}\\ & =& 6\text{.}\text{83}×{\text{10}}^{-4} \text{m}\end{array} $$
</div>
or
...
* Magnetic force can supply centripetal force and cause a charged particle to move in a circular path of radius
  ...
  where
   ...
   $$B $$
    for a charged particle with mass * $$m $$
    * and charge * $$q $$
    *.
...
<div data-type="problem" markdown="1">
A cosmic ray electron moves at  $$7\text{.}\text{50}×{\text{10}}^{6} \text{m/s} $$
 perpendicular to the Earth’s magnetic field at an altitude where field strength is  $$1\text{.}\text{00}×{\text{10}}^{-5}  T $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A proton moves at  $$7\text{.}\text{50}×{\text{10}}^{7} \text{m/s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) An oxygen-16 ion with a mass of  $$2\text{.}\text{66}×{\text{10}}^{-\text{26}} \text{kg} $$
 travels at  $$5\text{.}\text{00}×{\text{10}}^{6} \text{m/s} $$
...
<div data-type="solution" markdown="1">
 $$4\text{.}\text{36}×{\text{10}}^{-4} \text{m} $$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A velocity selector in a mass spectrometer uses a 0.100-T magnetic field. (a) What electric field strength is needed to select a speed of  $$4\text{.}\text{00}×{\text{10}}^{6} \text{m/s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
An electron in a TV CRT moves with a speed of  $$6\text{.}\text{00}×{\text{10}}^{7} \text{m/s} $$
, in a direction perpendicular to the Earth’s field, which has a strength of  $$5\text{.}\text{00}×{\text{10}}^{-5} T $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A mass spectrometer is being used to separate common oxygen-16 from the much rarer oxygen-18, taken from a sample of old glacial ice. (The relative abundance of these oxygen isotopes is related to climatic temperature at the time the ice was deposited.) The ratio of the masses of these two ions is 16 to 18, the mass of oxygen-16 is  $$2\text{.}\text{66}×{\text{10}}^{-\text{26}} \text{kg}, $$
 and they are singly charged and travel at  $$5\text{.}\text{00}×{\text{10}}^{6} \text{m/s} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Triply charged uranium-235 and uranium-238 ions are being separated in a mass spectrometer. (The much rarer uranium-235 is used as reactor fuel.) The masses of the ions are  $$3\text{.}\text{90}×{\text{10}}^{-\text{25}} \text{kg} $$
 and  $$3\text{.}\text{95}×{\text{10}}^{-\text{25}} \text{kg} $$
, respectively, and they travel at  $$3\text{.}\text{00}×{\text{10}}^{5} \text{m/s} $$
