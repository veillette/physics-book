...
We know that $$N=\text{200}$$
 and $$\Delta t=\text{15}\text{.}0\phantom{\rule{0.25em}{0ex}}\text{ms}$$
...
Now, $$\Delta \left(\text{cos}\phantom{\rule{0.25em}{0ex}}\theta \right)=-1\text{.}0$$
...
The area of the loop is $$A={\mathrm{\pi r}}^{2}=\left(3\text{.}\text{14}\text{.}\text{.}\text{.}\right)\left(0\text{.}\text{0500}\phantom{\rule{0.25em}{0ex}}\text{m}{\right)}^{2}=7\text{.}\text{85}×{\text{10}}^{-3}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}$$
...
, so that its component perpendicular to $$B$$
 is $$v\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\theta $$
 (see [\[link\]](#import-auto-id1169738035840)). Thus in this case the emf induced on each side is **$$\text{emf}=\mathrm{B\ell v}\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\theta $$
...
$$\text{emf}=2\mathrm{B\ell }\frac{w}{2}\omega \phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\mathrm{\omega t}=\left(\ell w\right)\mathrm{B\omega }\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\mathrm{\omega t}\text{.}$$
</div>
...
$$\text{emf}=\text{NAB}\omega \phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\mathrm{\omega t}$$
</div>

is the **emf induced in a generator coil**{: data-type="term" #import-auto-id1169738251318} of $$N$$
 turns and area $$A$$
...
$$\text{emf}={\text{emf}}_{0}\phantom{\rule{0.25em}{0ex}}\text{sin}\phantom{\rule{0.25em}{0ex}}\mathrm{\omega t}\text{,}$$
</div>
...
is the maximum **(peak) emf**{: data-type="term" #import-auto-id1169738185659}. Note that the frequency of the oscillation is *$$f=\omega /2\pi $$
...
$$\begin{array}{lll}\omega & =& \frac{\pi /2\phantom{\rule{0.25em}{0ex}}\text{rad}}{\text{0.0150 s}}\\ & =& \text{104}.\text{7 rad/s}\text{.}\end{array}$$
</div>
...
$$\begin{array}{lll}{\text{emf}}_{0}& =& \text{NAB}\omega \\ & =& \text{200}\left(7\text{.}\text{85}×{\text{10}}^{-3}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}\right)\left(1\text{.}\text{25}\phantom{\rule{0.25em}{0ex}}\text{T}\right)\left(\text{104}\text{.}7\phantom{\rule{0.25em}{0ex}}\text{rad/s}\right)\\ & =& \text{206}\phantom{\rule{0.25em}{0ex}}\text{V}\end{array}\text{.}$$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the peak emf generated by rotating a 1000-turn, 20.0 cm diameter coil in the Earth’s $$5\text{.}\text{00}×{\text{10}}^{-5}\phantom{\rule{0.25em}{0ex}}\text{T}$$
...
, and increases to its first peak at $$t=0\text{.}\text{100}\phantom{\rule{0.25em}{0ex}}\text{ms}$$
...
A 500-turn coil with a $$0\text{.}\text{250}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2}$$
 area is spun in the Earth’s $$5\text{.}\text{00}×{\text{10}}^{-5}\phantom{\rule{0.25em}{0ex}}\text{T}$$
...
<div data-type="solution" markdown="1">
(a) $$1\text{.}\text{92}×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{rad/s}$$
