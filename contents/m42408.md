...
The area of the loop is  $$A={\mathrm{\pi r}}^{2}=\left(3\text{.}\text{14}\text{.}\text{.}\text{.}\right)\left(0\text{.}\text{0500} \text{m}{\right)}^{2}= 7.85 \times 10^{-3}  {\text{m}}^{2} $$
. Entering this value gives

<div data-type="equation" id="eip-949">
 $$\text{emf}=\text{200}\frac{\left( 7.85 \times 10^{-3}  {\text{m}}^{2}\right)\left(1\text{.}\text{25} \text{T}\right)}{\text{15}\text{.}0×{\text{10}}^{-3} \text{s}}=\text{131} \text{V.} $$
</div>
**Discussion**
...
<div data-type="equation" id="eip-910">
 $$\begin{array}{lll}{\text{emf}}_{0}& =& \text{NAB}\omega \\ & =& \text{200}\left( 7.85 \times 10^{-3}  {\text{m}}^{2}\right)\left(1\text{.}\text{25} \text{T}\right)\left(\text{104}\text{.}7 \text{rad/s}\right)\\ & =& \text{206} \text{V}\end{array}\text{.} $$
</div>
**Discussion**
