...
We know that  $$N=\text{200} $$
 and  $$\Delta t=\text{15}\text{.}0 \text{ms} $$
...
<div data-type="equation" id="eip-332">
 $$\Delta \Phi =\Delta \left(\text{BA} \text{cos} \theta \right)=\text{AB}\Delta \left(\text{cos} \theta \right)\text{.} $$
</div>
Now,  $$\Delta \left(\text{cos} \theta \right)=-1\text{.}0 $$
...
The area of the loop is  $$A={\mathrm{\pi r}}^{2}=\left(3\text{.}\text{14}\text{.}\text{.}\text{.}\right)\left(0\text{.}\text{0500} \text{m}{\right)}^{2}=7\text{.}\text{85}×{\text{10}}^{-3} {\text{m}}^{2} $$
. Entering this value gives

<div data-type="equation" id="eip-949">
 $$\text{emf}=\text{200}\frac{\left(7\text{.}\text{85}×{\text{10}}^{-3} {\text{m}}^{2}\right)\left(1\text{.}\text{25} \text{T}\right)}{\text{15}\text{.}0×{\text{10}}^{-3} \text{s}}=\text{131} \text{V.} $$
</div>
**Discussion**
...
, so that its component perpendicular to  $$B $$
 is  $$v \text{sin} \theta  $$
 (see [\[link\]](#import-auto-id1169738035840)). Thus in this case the emf induced on each side is ** $$\text{emf}=\mathrm{B\ell v} \text{sin} \theta  $$
, and they are in the same direction. The total emf around the loop is then

<div data-type="equation" id="eip-258">
 $$\text{emf}=2\mathrm{B\ell v} \text{sin} \theta \text{.} $$
</div>
...
<div data-type="equation" id="eip-892">
 $$\text{emf}=\text{2}\mathrm{B\ell v} \text{sin} \mathrm{\omega t}\text{.} $$
</div>
...
<div data-type="equation" id="eip-667">
 $$\text{emf}=2\mathrm{B\ell }\frac{w}{2}\omega  \text{sin} \mathrm{\omega t}=\left(\ell w\right)\mathrm{B\omega } \text{sin} \mathrm{\omega t}\text{.} $$
</div>
...
<div data-type="equation" id="eip-959">
 $$\text{emf}=\text{NAB}\omega  \text{sin} \mathrm{\omega t} $$
</div>
...
<div data-type="equation" id="eip-944">
 $$\text{emf}={\text{emf}}_{0} \text{sin} \mathrm{\omega t}\text{,} $$
</div>
...
<div data-type="equation" id="eip-135">
 $$\begin{array}{lll}\omega & =& \frac{\pi /2 \text{rad}}{\text{0.0150 s}}\\ & =& \text{104}.\text{7 rad/s}\text{.}\end{array} $$
</div>
...
<div data-type="equation" id="eip-910">
 $$\begin{array}{lll}{\text{emf}}_{0}& =& \text{NAB}\omega \\ & =& \text{200}\left(7\text{.}\text{85}×{\text{10}}^{-3} {\text{m}}^{2}\right)\left(1\text{.}\text{25} \text{T}\right)\left(\text{104}\text{.}7 \text{rad/s}\right)\\ & =& \text{206} \text{V}\end{array}\text{.} $$
</div>
**Discussion**
...
* {: #import-auto-id1169737786699} An electric generator rotates a coil in a magnetic field, inducing an emf**given as a function of time by
  <div data-type="equation" id="eip-841">
   $$\text{emf}=\text{NAB}\omega  \text{sin} \mathrm{\omega t}\text{,} $$
  </div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the peak emf generated by rotating a 1000-turn, 20.0 cm diameter coil in the Earth’s  $$5\text{.}\text{00}×{\text{10}}^{-5} \text{T} $$
...
, and increases to its first peak at  $$t=0\text{.}\text{100} \text{ms} $$
...
A 500-turn coil with a  $$0\text{.}\text{250} {\text{m}}^{2} $$
 area is spun in the Earth’s  $$5\text{.}\text{00}×{\text{10}}^{-5} \text{T} $$
...
<div data-type="solution" markdown="1">
(a)  $$1\text{.}\text{92}×{\text{10}}^{6} \text{rad/s} $$
