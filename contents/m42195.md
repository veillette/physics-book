...
<div data-type="equation" id="eip-321">
 $$\begin{array}{lll}h& =& \frac{\text{2400 N}{\text{/m}}^{2}}{\left( 1.0 \times 10^{3}  {\text{kg/m}}^{3}\right)\left(9\text{.}\text{80} {\text{m/s}}^{2}\right)}\\ & =& \text{0.24 m.}\end{array} $$
</div>
**Discussion**
...
<table id="eip-286" summary="Conversion Factors for Various Pressure Units"><caption><span data-type="title">Conversion Factors for Various Pressure Units</span></caption><thead>
          ...
          <tr>
            <td>
               $$1\text{.}0\phantom{\rule{0.25em}{0ex}}{\text{kg/cm}}^{2}= 9.8 \times 10^{4} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
