...
We first need to convert the pressure into SI units. Since  $$1.0 mm Hg=133 \text{Pa} $$
,

<div data-type="equation" id="eip-327">
 $$P=18 \text{mm Hg}×\frac{133 \text{Pa}}{1.0 mm Hg}=2400 \text{Pa}\text{.} $$
</div>
...
<div data-type="equation" id="eip-321">
 $$\begin{array}{lll}h& =& \frac{2400 \text{N}{\text{/m}}^{2}}{\left( 1.0 \times 10^{3}  {\text{kg/m}}^{3}\right)\left( 9.80 {\text{m/s}}^{2}\right)}\\ & =& 0.24 \text{m.}\end{array} $$
</div>
**Discussion**
...
<table id="eip-286" summary="Conversion Factors for Various Pressure Units"><caption><span data-type="title">Conversion Factors for Various Pressure Units</span></caption><thead>
          ...
          <tr>
            <td>
               $$1.0 atm= 1.013 \times 10^{5} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
               $$1.0 atm= 1.013 \times 10^{5} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
          ...
          <tr>
            <td>
               $$1.0\phantom{\rule{0.25em}{0ex}}{\text{dyne/cm}}^{2}= 0.10\phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}= 1.013 \times 10^{6} \phantom{\rule{0.25em}{0ex}}{\text{dyne/cm}}^{2} $$
            </td>
          </tr>
          <tr>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}{\text{kg/cm}}^{2}= 9.8 \times 10^{4} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}= 1.013\phantom{\rule{0.25em}{0ex}}{\text{kg/cm}}^{2} $$
            </td>
          </tr>
          <tr>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{lb/in}{\text{.}}^{2}= 6.90 \times 10^{3} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}= 14.7\phantom{\rule{0.25em}{0ex}}\text{lb/in}{\text{.}}^{2} $$
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}=760 \text{mm Hg} $$
            </td>
          </tr>
          <tr>
            <td>
               $$ 1.0 cm Hg= 1.33 \times 10^{3} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}= 76.0 cm Hg $$
            </td>
          </tr>
          <tr>
            <td>
               $$ 1.0 cm water= 98.1\phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}= 1.03 \times 10^{3} \phantom{\rule{0.25em}{0ex}}\text{cm water} $$
            </td>
          </tr>
          <tr>
            <td>
               $$1.0 bar= 1.000 \times 10^{5} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}=1.013 bar $$
            </td>
          </tr>
          <tr>
            <td>
               $$1.0 millibar= 1.000 \times 10^{2} \phantom{\rule{0.25em}{0ex}}{\text{N/m}}^{2} $$
            </td>
            <td>
...
Balloon:
 ...
 $$\begin{array}{lll}{P}_{\text{g}}& =& 5.00 cm {\text{H}}_{2}\text{O,}\\ {P}_{\text{abs}}& =&  1.035 \times 10^{3}  \text{cm} {\text{H}}_{2}\text{O.}\end{array} $$
{: xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" fo:font-weight="normal"}
...
<div data-type="solution" markdown="1">
 $$\begin{array}{}\Delta P=38.7 \text{mm Hg,}\\ \text{Leg blood pressure}=\frac{\text{159}}{\text{119}}\text{.}\end{array} $$
</div>
</div>
