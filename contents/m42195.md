...
<div data-type="equation" id="eip-327">
 $$P=\text{18 mm Hg}×\frac{133 \text{Pa}}{1.0 mm Hg}=2400 \text{Pa}\text{.} $$
</div>
...
<div data-type="equation" id="eip-321">
 $$\begin{array}{lll}h& =& \frac{2400 \text{N}{\text{/m}}^{2}}{\left( 1.0 \times 10^{3}  {\text{kg/m}}^{3}\right)\left( 9.80 {\text{m/s}}^{2}\right)}\\ & =& \text{0.24 m.}\end{array} $$
</div>
**Discussion**
...
<table id="eip-286" summary="Conversion Factors for Various Pressure Units"><caption><span data-type="title">Conversion Factors for Various Pressure Units</span></caption><thead>
          ...
          <tr>
            ...
            <td>
               $$ 1.0\phantom{\rule{0.25em}{0ex}}\text{atm}=\text{760 mm Hg} $$
            </td>
          </tr>
          <tr>
            <td>
