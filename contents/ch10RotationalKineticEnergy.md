...
in [\[link\]](/contents/ch10DynamicsOfRotationalMotion.md#fs-id1838666) :
...
found in [\[link\]](/contents/ch10DynamicsOfRotationalMotion.md#fs-id1838666). The total $$ I $$
...
from [\[link\]](/contents/ch10DynamicsOfRotationalMotion.md#fs-id1838666). Because $$ v $$ and $$ \omega $$
...
<div data-type="problem" markdown="1">
This problem considers energy and work aspects of [[link]](/contents/ch10DynamicsOfRotationalMotion.md#fs-id1468671)—use data from that example as needed.
...
([[link]](/contents/ch10DynamicsOfRotationalMotion.md#import-auto-id3370574))
