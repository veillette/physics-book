...
motion. [\[link\]](#import-auto-id3229349) shows a worker using an electric
...
in [\[link\]](#import-auto-id2009471)) and remains perpendicular as the disk
...
Work and energy in rotational motion are completely analogous to work and energy in translational motion, first presented in [Uniform Circular Motion and Gravitation](/contents/m42140.md).
...
energy in a vehicle, as seen in [\[link\]](#import-auto-id1614457).
...
revolution as shown in [\[link\]](#import-auto-id2674234). In this example,
...
in [\[link\]](/contents/m42179.md#fs-id1838666) :
...
A typical small rescue helicopter, similar to the one in [\[link\]](#import-auto-id2420248), has
...
found in [\[link\]](/contents/m42179.md#fs-id1838666). The total $$ I $$
...
kinetic energy is another form of $$ \KE $$. [Uniform Circular Motion and Gravitation](/contents/m42140.md) has a detailed
...
from [\[link\]](/contents/m42179.md#fs-id1838666). Because $$ v $$ and $$ \omega $$
...
<div data-type="problem" markdown="1">
This problem considers energy and work aspects of [[link]](/contents/m42179.md#fs-id1468671)—use data from that example as needed.
...
([[link]](/contents/m42179.md#import-auto-id3370574))
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Suppose a 200-kg motorcycle has two wheels like, [the one described in Problem 10.15](/contents/m42179.md#import-auto-id3370574) and is heading toward a hill at a speed of 30.0 m/s.
