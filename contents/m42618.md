...
<div data-type="equation" id="eip-760">
 $$\begin{array}{l}3s \text{has} l=0\text{;} \text{thus,} 2\left(2l+1\right)=2\left(0+1\right)=2\\ 3p \text{has} l=\text{1; thus, 2}\left(2l+1\right)=2\left(2+1\right)=6\\ 3d \text{has} l=\text{2; thus, 2}\left(2l+1\right)=2\left(4+1\right)=\text{10}\\ \text{Total}=\text{18}\\ \left(\text{in the} n=\text{3 shell}\right)\end{array} $$
</div>
...
(a) 32. (b)  $$2 \text{in} s, \text{6 in} p, \text{10 in} d, $$
 and 14 in  $$f $$
, for a total of 32.
...
<div data-type="solution" markdown="1">
(a)  $$6\text{.}\text{54}×{\text{10}}^{-\text{16}} \text{kg} $$
...
, a beam of electrons having a velocity of  $$ 6.00 \times 10^{7}  \text{m/s} $$
 enters a  $$\text{5.00}×{\text{10}}^{-3} \text{T} $$
...
<div data-type="solution" markdown="1">
 $$1\text{.}\text{76}×{\text{10}}^{\text{11}} \text{C/kg} $$
 , which agrees with the known value of  $$1\text{.}\text{759}×{\text{10}}^{\text{11}} \text{C/kg} $$
...
(b)  $$7.27×{\text{10}}^{-\text{20}} \text{J/molecule} $$
...
<div data-type="solution" markdown="1">
(a)  $$1\text{.}\text{24}×{\text{10}}^{\text{11}} \text{V} $$
