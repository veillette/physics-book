...
, you get  $$2\left(2l+1\right) $$
 $$=0 \text{, 1, 2, ...,}\left(n\text{–1}\right)⇒2\left\{\left[\left(2\right)\left(0\right)+1\right]+\left[\left(2\right)\left(1\right)+1\right]+\text{.}\text{.}\text{.}\text{.}+\left[\left(2\right)\left(n-1\right)+1\right]\right\}=\underset{\underset{n \text{terms}}{︸}}{2\left[1+3+\text{.}\text{.}\text{.}+\left(2n-3\right)+\left(2n-1\right)\right]} $$
