...
To denote shells and subshells, we write  $$\text{nl} $$
 ...
 This notation, called spectroscopic notation, is generalized as shown in [\[link\]](#Figure1).
...
<div class="equation" id="eip-id3039100">
...
Examining the above table, you can see that as the number of electrons in an atom increases from 1 in hydrogen to 2 in helium and so on, the lowest-energy shell gets filled first—that is, the  $$n=1 $$
 ...
 subshell. The next exception is not shown in [\[link\]](#Table2); it occurs for rubidium, where the  $$5s $$
...
<div class="note" data-has-label="true" id="eip-139" class="interactive" data-label="" markdown="1">
<div class="title">
