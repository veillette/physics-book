...
sliding on ice. But when objects are stationary, **static friction**{: data-type="term" #import-auto-id1165298806829}
**** can act between them; the
...
The symbol $$ \le $$ means *less than or equal to*, implying that static friction can have a minimum
and a maximum value of $$ \mu_{\text{s}}N $$. Static friction is a responsive force that increases to be equal and opposite
...
<div data-type="equation" id="eip-410">
 $$ f_{\text{s}\left(\text{max}\right)}=\mu_{\text{s}}N. $$ 
</div>
...
where $$ \mu_{\text{k}} $$
is the coefficient of kinetic friction. A system in which $$ f_{\text{k}}=\mu_{\text{k}}N $$
...
<table id="import-auto-id1165298658126" summary="The table shows the values of coefficients of static and kinetic friction for various materials, and it demonstrates that the coefficients of kinetic friction are less than their static counterparts."><caption><span data-type="title">Coefficients of Static and Kinetic Friction</span></caption><thead>
                  <tr>
                    <th>System</th>
                    <th>Static friction $$ \mu_{\text{s}} $$ </th>
                    <th>Kinetic friction $$ \mu_{\text{k}} $$ </th>
                  </tr>
</thead><tbody>
                  <tr>
...
$$ W=mg\left(100 \text{kg}\right)\left(
9.80\text{m/s}^{2}\right)=980 \text{ N} $$, perpendicular to the floor. 
If the coefficient of static friction is 0.45, you
would have to exert a force parallel to the floor greater than 
$$ f_{\text{s}\left(\text{max}\right)}=\mu_{\text{s}}N=\left(0.45\right)\left(
980 \text{N}\right)
=440\text{N} $$
to move the crate. Once there is motion, friction is less and the coefficient of
kinetic friction might be 0.30, so that a force of only 290 N ( $$ f_{\text
{k}}=\mu_{\text{k}}N=\left(0.30\right)\left( 980\text{N}\right)=290\text{N} 
...
<div data-type="equation" id="eip-97">
 $$ \mu_{\text{k}}=\frac{45.0 \text{N}}{\left(62 \text{kg}\right)\left(9.80 \text{m/s}^{2}\right)\left(0.906\right)}=0.082. $$ 
</div>
**Discussion**
...
with the horizontal, friction is given by $$ f_{\text{k}}=\mu_{\text{k}}mg \cos{\theta}
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) If half of the weight of a small  $$ 1.00\times 10^{3}\text{kg} $$ utility truck is supported by its two drive wheels, what is the magnitude of the
...
F_{1} $$ and $$ F_{2} $$ are 26.4 N and 18.6 N, respectively. (b) What is her initial acceleration if she
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
Show that the acceleration of any object down an incline where friction behaves simply (that is, where  $$ f_{\text{k}}=\mu_{\text{k}}N $$ 

) is $$ a=g\left( \sin{\theta} - \mu_{\text{k}}\cos{\theta} \right). $$
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
If an object is to rest on an incline without slipping, then friction must equal the component of the weight of the object parallel to the incline. This requires greater and greater friction for steeper slopes. Show that the maximum angle of an incline above the horizontal for which an object will not slide down is  $$ \theta ={\tan}^{-1}{\text{μ}}_{\text{s}} $$ . You may use the result of the previous problem. Assume that $$ a=0 $$
...
concrete. (b) On wet concrete. (c) On ice, assuming that $$ \mu_{s}=0.100 $$,
...
engines and 45 cars with average masses of $$5.50 \times 10^{5}\text{kg} $$. 
(a) What force must each engine exert backward on the track to accelerate the
train at a rate of $$5.00 \times 10^{-2} \text{m/s}^{2} $$
...
by her arms. (b) What is the minimum coefficient of friction between her shoes
and the cliff?
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
A contestant in a winter sporting event pushes a 45.0-kg block of ice across a frozen lake as shown in [[link]](#import-auto-id1165298619770)(a). (a) Calculate the minimum force  $$ F $$ he must exert to get the block moving. (b) What is the magnitude of its
...
relative to one another {: # import-auto-id1165298540973}
