...
9\text{.}\text{80}{\text{m/s}}^{2}\right)=\text{980
...
<div data-type="equation" id="eip-322">
 $$ {\mu }_{\text{k}}=\frac{ {f}_{\text{k}}}{N}=\frac{ {f}_{\text{k}}}{w\cos\text{25º}}=\frac{ {f}_{\text{k}}}{\text{mg}\cos\text{25º}.} $$ 
</div>
...
An object will slide down an inclined plane at a constant velocity if the net force on the object is zero. We can use this fact to measure the coefficient of kinetic friction between two objects. As shown in [\[link\]](#fs-id1704828), the kinetic friction on a slope  $$ {f}_{\text{k}}={\mu }_{\text{k}}\text{mg}\cos\theta  $$ 
...
<div data-type="equation" id="eip-368">
 $$ {\mu }_{\text{k}}\text{mg}\cos{\theta} =\text{mg}\sin{\theta} . $$ 
</div>
...
<div data-type="equation" id="eip-680">
 $$ {\mu }_{\text{k}}=\frac{\text{mg}\sin{\theta} }{\text{mg}\cos{\theta} }=\tan{\theta} . $$ 
</div>
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) If half of the weight of a small  $$ 1\text{.}\text{00}×{\text{10}}^{3}\text{kg} $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
If an object is to rest on an incline without slipping, then friction must equal the component of the weight of the object parallel to the incline. This requires greater and greater friction for steeper slopes. Show that the maximum angle of an incline above the horizontal for which an object will not slide down is  $$ \theta ={\tan}^{\text{–1}}{\text{μ}}_{\text{s}} $$ 
...
5\text{.}\text{50}×{\text{10}}^{5}\text{kg} $$. (a) What force must each engine exert backward on the track to accelerate the
train at a rate of $$
5\text{.}\text{00}×{\text{10}}^{-2}m/{s}^{2} $$
if the force of friction is $$
7\text{.}\text{50}×{\text{10}}^{5}N $$, assuming the engines exert identical forces? This is not a large frictional
...
<div data-type="solution" markdown="1">
(a)  $$ 1\text{.}\text{03}×{\text{10}}^{6}N $$ 

(b)  $$ 3\text{.}\text{48}×{\text{10}}^{5}N $$
</div>
</div>
...
magnitude of static friction
:  $$ {f}_{s}\le {\mu }_{s}N $$, where $$ {\mu }_{s} $$
is the coefficient of static friction and $$ N $$
