...
$$ W=\mathrm{mg}=\left(100 \text{kg}\right)\left(
...
<div data-type="equation" id="eip-97">
 $$ {\mu }_{\text{k}}=\frac{45.0 \text{N}}{\left(62 \text{kg}\right)\left(9.80 \text{m}{\text{/s}}^{2}\right)\left(0.906\right)}=0.082. $$ 
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
Show that the acceleration of any object down an incline where friction behaves simply (that is, where  $$ f_{\text{k}}={\mu }_{\text{k}}N $$ 
