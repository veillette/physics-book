...
Magnitude of static friction  $$  f_{\text{s}} $$ 

is

<div data-type="equation" id="eip-213">
 $$  f_{\text{s}}\le {\mu }_{\text{s}}N, $$ 
</div>
where  $$ {\mu }_{\text{s}} $$ 
...
exceeds $$  f_{\text{s}\left(\text{max}\right)} $$, the object will move. Thus

<div data-type="equation" id="eip-410">
 $$  f_{\text{s}\left(\text{max}\right)}={\mu }_{\text{s}}N. $$ 
</div>
...
where $$ {\mu }_{\text{k}} $$
is the coefficient of kinetic friction. A system in which $$  f_
{\text{k}}={\mu }_
{\text{k}}N $$
...
The magnitude of kinetic friction  $$  f_{\text{k}} $$ 
...
9.80{\text{m/s}}^{2}\right)=\text{980
N} $$, perpendicular to the floor. If the coefficient of static friction is 0.45, you
would have to exert a force parallel to the floor greater than $$  f_
...
kinetic friction might be 0.30, so that a force of only 290 N ( $$  f_
{\text{k}}={\mu }_{\text{k}}N=\left(0.30\right)\left(
980}\text{N}\right)
=290}\text{N} $$
...
<div data-type="equation" id="eip-97">
 $$ {\mu }_{\text{k}}=\frac{45.0 \text{N}}{\left(\text{62 kg}\right)\left(9.80 \text{m}{\text{/s}}^{2}\right)\left(0.906\right)}=0.082. $$ 
</div>
**Discussion**
...
with the horizontal, friction is given by $$  f_{\text{k}}={\mu }_
...
An object will slide down an inclined plane at a constant velocity if the net force on the object is zero. We can use this fact to measure the coefficient of kinetic friction between two objects. As shown in [\[link\]](#fs-id1704828), the kinetic friction on a slope  $$  f_{\text{k}}={\mu }_{\text{k}}\text{mg}\cos\theta  $$ 
...
(b)  $$ 1.96 \text{m}{\text{/s}}^{2} $$
</div>
</div>

<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) If half of the weight of a small  $$ 1.00\times 10^{3}\text{kg} $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the acceleration of a skier heading down a  $$ 10.0º $$ 
...
. You may use the result of the previous problem. Assume that $$ a=0 $$
...
{s}=0.100 $$, the same as for shoes on ice.
...
{\text{μ}}_{\text{s}}=0.100 $$, the same as for shoes on ice.
...
5.50 \times  10^{5}\text{kg} $$. (a) What force must each engine exert backward on the track to accelerate the
train at a rate of $$
5.00 \times 10^{-2}m/{s}^{2} $$
if the force of friction is $$
7.50 \times  10^{5}N $$, assuming the engines exert identical forces? This is not a large frictional
