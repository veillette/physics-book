...
<div data-type="equation" id="eip-368">
 $$ {\mu }_{\text{k}}\text{mg}\phantom{\rule{0.25em}{0ex}}\cos{\theta} =\text{mg}\phantom{\rule{0.25em}{0ex}}\sin{\theta} . $$ 
</div>
...
<div data-type="equation" id="eip-680">
 $$ {\mu }_{\text{k}}=\frac{\text{mg}\phantom{\rule{0.25em}{0ex}}\sin{\theta} }{\text{mg}\phantom{\rule{0.25em}{0ex}}\cos{\theta} }=\tan{\theta} . $$ 
</div>
...
a=g\phantom{\rule{0.25em}{0ex}}\sin{\theta} $$. (Note that this acceleration is independent of mass.)
...
\phantom{\rule{0.25em}{0ex}}\sin{\theta} -{\mu
}_
{\text{k}}\cos{\theta} \right). $$
