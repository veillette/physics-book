...
<div data-type="equation" id="eip-775">
 $$P=\frac{4\gamma }{r}=\frac{4\left(0.037 N/m\right)}{ 2.00 \times 10^{-4}  \text{m}}=\text{740} {\text{N/m}}^{2}=\text{740} \text{Pa}. $$
</div>
...
<div data-type="equation" id="eip-301">
 $$\begin{array}{lll}r& =& \frac{2\gamma  \text{cos} \theta }{\rho \text{gh}}=\frac{2\left(\text{0.0728 N/m}\right)\text{cos}\left(0º\right)}{\left(\text{1050} {\text{kg/m}}^{3}\right)\left(9\text{.}\text{80} {\text{m/s}}^{2}\right)\left(\text{100 m}\right)}\\ & =&  1.41 \times 10^{-7}  \text{m.}\end{array} $$
</div>
**Discussion**
