...
<div class="equation" id="eip-170">
 $$\gamma =\frac{F}{L}. $$
</div>

[\[link\]](#Table1) lists values of  $$\gamma  $$
 for some liquids. For the insect of [\[link\]](#Figure2)(a), its weight  $$w $$
 is supported by the upward components of the surface tension force:  $$w=\gamma L \sin \theta  $$ ,
 where  $$L $$
 is the circumference of the insect’s foot in contact with the water. [\[link\]](#Figure3) shows one way to measure surface tension. The liquid film exerts a force on the movable wire in an attempt to reduce its surface area. The magnitude of this force depends on the surface tension of the liquid and can be measured accurately.
...
Calculate the gauge pressure inside a soap bubble  $$ 2.00 \times 10^{-4}  \text{m} $$
 in radius using the surface tension for soapy water in [\[link\]](#Table1). Convert this pressure to mm Hg.

**Strategy**

The radius is given and the surface tension can be found in [\[link\]](#Table1), and so  $$P $$
...
Substituting  $$r $$
 and  $$\gamma  $$
 into the equation  $$P=\frac{4\gamma }{r} $$ ,  we obtain
...
Why is it that water beads up on a waxed car but does not on bare paint? The answer is that the adhesive forces between water and wax are much smaller than those between water and paint. Competition between the forces of adhesion and cohesion are important in the macroscopic behavior of liquids. An important factor in studying the roles of these two forces is the angle  $$\theta  $$
 between the tangent to the liquid surface and the surface. (See [\[link\]](#Figure7).) The **contact angle**  $$\theta  $$
 ...
 is, the smaller the relative strength, so that the adhesive force is able to flatten the drop. [\[link\]](#Table2) lists contact angles for several combinations of liquids and solids.
...
The height to which a liquid will rise as a result of capillary action is given by  $$h=\frac{2\gamma  \cos \theta }{\rho \text{gr}} $$ ,
...
-m radius is  $$ 1.40 \times 10^{3}  \text{Pa} $$ ,
 due to its fluid-lined walls. Assuming the alveolus acts like a spherical bubble, what is the surface tension of the fluid? (b) Identify the likely fluid. (You may need to extrapolate between values in [[link]](#Table1).)
...
What fluid is in the device shown in [[Figure 3]](#Figure3) if the force is  $$ 3.16 \times 10^{-3}  \text{N} $$
 ...
 and find a likely match from [[link]](#Table1).
...
* {: class="footnote-ref" #footnote1} [1](#footnote-ref1){: class="footnote-ref-link"} <span class="footnote-ref-content">At 20ºC unless otherwise stated.</span>
...
contact angle
: the angle
   $$\theta  $$ between the tangent to the liquid surface and the surface
