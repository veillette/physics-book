...
[\[link\]](#Table1) lists values of  $$\gamma  $$
 for some liquids. For the insect of [[Figure 2]](#Figure2)(a), its weight  $$w $$
 is supported by the upward components of the surface tension force:  $$w=\gamma L \sin \theta  $$ ,
 where  $$L $$
 is the circumference of the insect’s foot in contact with the water. [[Figure 3]](#Figure3) shows one way to measure surface tension. The liquid film exerts a force on the movable wire in an attempt to reduce its surface area. The magnitude of this force depends on the surface tension of the liquid and can be measured accurately.
...
Why is it that water beads up on a waxed car but does not on bare paint? The answer is that the adhesive forces between water and wax are much smaller than those between water and paint. Competition between the forces of adhesion and cohesion are important in the macroscopic behavior of liquids. An important factor in studying the roles of these two forces is the angle  $$\theta  $$
 between the tangent to the liquid surface and the surface. (See [[Figure 7]](#Figure7).) The **contact angle**  $$\theta  $$
...
If we look at the different factors in this expression, we might see how it makes good sense. The height is directly proportional to the surface tension  $$\gamma  $$ ,
 ...
 since a larger density means a greater mass in the same volume. (See [[Figure 8]](#Figure8).)
