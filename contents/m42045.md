...
$$ 5\text{m/s} $$ straight toward the goal and drives the ball in the same direction with a
...
<div data-type="equation" id="eip-311">
 $$ v_{y}=v_{\text{boat}}=0.750\text{m/s.} $$ 
</div>
Thus,
...
<div data-type="equation" id="eip-615">
 $$ v_{\text{w}x}=v_{\text{tot}x}=v_{\text{tot}}\cos{110^\circ }\text{.} $$ 
</div>
Because  $$ v_{\text{tot}}=38.0 m/\text{s} $$ and $$ \cos{110^\circ }=–0.342 $$
we have
...
Here  $$ v_{\text{tot}y}=v_{\text{tot}}\sin{110^\circ } $$ 

; thus,

<div data-type="equation" id="eip-206">
 $$ v_{\text{w}y}=\left(38.0 m/s\right)\left(0.940\right)-45.0 m/s=
-9.29\text{m/s.} $$ 
</div>
...
than $$ 3 000 \text{km/s} $$. Most things we encounter in daily life move slower than this speed.
...
<div data-type="equation" id="eip-328">
 $$ \theta ={\tan}^{-1}\left(-0.0208\right)=-1.19^\circ\text{.} $$ 
</div>
**Discussion**
...
south of west, while its direction of travel relative to the air is $$ 5.00^\circ  $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
**Unreasonable Results** A commercial airplane has an air speed of  $$ 280 \text{m/s} $$ 
...
same phenomenon {:# import-auto-id2171931}
