...
<div data-type="equation" id="eip-845">
 $$ v_{x}=v_{\text{river}}=1.20 \text{m/s} $$ 
</div>
and
...
<div data-type="equation" id="eip-869">
 $$ v_{\text{tot}}=\sqrt{\left(1.20 \text{m/s}{\right)}^{2}+\left(0.750 \text{m/s}{\right)}^{2}} $$ 
</div>
yielding
...
Because  $$ v_{\text{tot}}=38.0 m/\text{s} $$ 

and $$ \text{cos 110º}=–0.342 $$
we have

<div data-type="equation" id="eip-112">
 $$ v_{\text{w}x}=\left(38.0 \text{m/s}\right)\left(\text{–0.342}\right)=\text{–13 m/s.} $$ 
</div>
The minus sign indicates motion west which is consistent with the diagram.

Now, to find $$ v_{\text{w}\text{y}} $$
we note that

<div data-type="equation" id="eip-142">
 $$ v_{\text{tot}y}=v_{\text{w}y}+v_{\text{p}} $$ 
</div>
Here  $$ v_{\text{tot}y}=v_{\text{tot}}\text{sin 110º} $$ 

; thus,

<div data-type="equation" id="eip-206">
 $$ v_{\text{w}y}=\left(38.0 m/s\right)\left(0.940\right)-45.0 m/s=-9\text{.}\text{29 m/s.} $$ 
</div>
...
<div data-type="equation" id="eip-128">
 $$ \begin{array}{lll}v_{\text{w}}& =& \sqrt{ v_{\text{w}x}^{2}+v_{\text{w}y}^{2}}\\ & =& \sqrt{\left(-13.0 m/s{\right)}^{2}+\left(-9.29 \text{m/s}{\right)}^{2}}\end{array} $$ 
</div>
so that

<div data-type="equation" id="eip-637">
 $$ v_{\text{w}}=16.0 m/s\text{.} $$ 
</div>
The direction is:
...
for the coin relative to the ground is $$ v_
...
numbers—the final velocity v in part (b) is **not**  $$ \left(260 – 5.42\right) \text{m/s} $$
