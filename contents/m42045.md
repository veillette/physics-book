...
<div data-type="equation" id="eip-343">
 $$ {v}_{x}=v\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}\theta  $$ 
</div>

<div data-type="equation" id="eip-859">
 $$ {v}_{y}=v\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}\theta  $$ 
</div>
...
{y}=-5.42\phantom{\rule{0.25em}{0ex}}\text{m/s} $$, the same as found in part (a). In contrast to part (a), there now is a
