...
5\text{m/s} $$ straight toward the goal and drives the ball in the same
direction with a velocity of $$ 30 \text{m/s} $$ relative to her body, then the
velocity of the ball is $$ 35 \text{m/s} $$ relative to the stationary,
...
{\text{tot}} $$. The velocity of the boat, $$ {\mathbf{\text{v}}}_{\text{boat}}
$$, is 0.75 m/s in the $$ y $$ -direction relative to the river and the velocity
of the river, $$ {\mathbf{\text{v}}}_{\text{river}} $$, is 1.20 m/s to the
right.
...
swept rapidly downstream. This result is evidenced by the small angle (only $$
32.0^\circ $$
...
velocity $$ {\mathbf{\text{v}}}_{\text{tot}} $$ and that it is the sum of two
other velocities, $$ {\mathbf{\text{v}}}_{\text{w}} $$
(the wind) and $$ {\mathbf{\text{v}}}_{\text{p}} $$
(the plane relative to the air mass). The quantity $$ {\mathbf{\text{v}}}_
{\text{p}} $$ is known, and we are asked to find $$ {\mathbf{\text{v}}}_
...
the components of $$ {\mathbf{\text{v}}}_{\text{w}} $$, then we can combine them
to solve for its magnitude and direction. As shown
in [\[link\]](#import-auto-id1546060), we choose a coordinate system with its *
x*-axis due east and its *y*-axis due north (parallel to $$ {\mathbf{\text{v}}}_
{\text{p}} $$
...
Because $$ {\mathbf{\text{v}}}_{\text{tot}} $$ is the vector sum of the $$
{\mathbf{\text{v}}}_{\text{w}} $$ and $$ {\mathbf{\text{v}}}_{\text{p}} $$,
...
<div data-type="equation" id="eip-206">
 $$ v_{\text{w}y}=\left(38.0 \text{m/s} \right)
\left(0.940 \right)-45.0 \text{m/s}= -9.29\text{m/s.} $$ 
</div>
...
{\mathbf{\text{v}}}_{\text{w}} $$. First, the magnitude is
...
and final horizontal velocities are the same and $$ v_{x}=260 \text{m/s} $$.
...
\text{m/s} $$ ; rather, it is $$ 260.06 \text{m/s} $$. The velocity’s magnitude
...
(b)  $$ 5.53 \text{m/s} $$, $$ 45^\circ $$ south of east
...
speed relative to the air mass? (b) What is the airplane’s speed relative to the
Earth?
...
relative to the Earth is $$ 4.80 m/s $$ $$ 5.00^\circ $$ west of north. What is
...
5^\circ $$ south of east in 1.50 h. (a) What was the velocity of the plane
relative to the ground? (b) Calculate the magnitude and direction of the
tailwind’s velocity. (
