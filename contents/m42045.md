...
<div data-type="equation" id="eip-869">
 $$ v_{\text{tot}}=\sqrt{
\left( 1.20 \text{m/s} \right)^{2}+
\left( 0.750 \text{m/s} \right)^{2}
} $$ 
</div>
yielding

<div data-type="equation" id="eip-166">
 $$ v_{\text{tot}}=1.42\text{m/s.} $$ 
</div>
...
Because  $$ v_{\text{tot}}=38.0 \text{m/s} $$ and $$ \cos{110^\circ }=–0.342 $$
we have

<div data-type="equation" id="eip-112">
 $$ v_{\text{w}x}=\left(38.0 \text{m/s}\right)\left(\text{–0.342}\right)=-13 \text{m/s.} $$ 
</div>
...
<div data-type="equation" id="eip-206">
 $$ v_{\text{w}y}=\left(38.0 \text{m/s} \right)\left(0.940\right)-45.0 \text{m/s}=
-9.29\text{m/s.} $$ 
</div>
...
$$
and $$ v_{\text{w}y} $$
are known, we can find the magnitude and direction of $$ {\mathbf{\text{v}}}_{\text{w}} $$.
...
& =& \sqrt{
\left(-13.0 \text{m/s} \right)^{2}+
\left(-9.29 \text{m/s} \right)^{2}
}
\end{array} $$ 
</div>
so that
...
<div data-type="equation" id="eip-444">
 $$ v_{y}^{2}=0^{2}-2\left(9.80\text{m/s}^{2}\right)
\left(-1.50\text{m}-0 \text{m}\right)=29.4\text{m}^{2}{\text{/s}}^{2} $$ 
</div>
yielding
...
for the coin relative to the ground is $$ v_{y}=-5.42\text{m/s} $$, the same as 
found in part (a). In contrast to part (a), there now is a
...
v_{x}=260 \text{m/s} $$. The *x*- and *y*-components of velocity can be combined 
...
what is the velocity of the wind? (b) If the bird turns around and flies with the wind,
how long will he take to return 6.00 km? (c) Discuss how the wind affects the
