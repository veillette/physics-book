...
<div data-type="equation" id="eip-112">
 $$ v_{\text{w}x}=\left(38.0 \ms \right)\left(\text{–0.342}\right)=-13 \ms . $$ 
</div>
...
\left(-1.50\m -0 \m \right)=29.4 \mm{\text{/s}}^{2} $$ 
</div>
yielding
...
<iframe src="https://phet.colorado.edu/sims/cheerpj/motion-2d/latest/motion-2d.html?simulation=motion-2d" width="600" height="450" scrolling="no" allowfullscreen></iframe>
</figure>
</div>
