...
(a) Convert this amount of energy to kilowatt-hours, noting that  $$\text{1 kW}\cdot \text{h}=3\text{.}\text{60}×{\text{10}}^{6} \text{J} $$
.
...
<div data-type="solution" markdown="1">
(a) Blast yields  $$2.1×{\text{10}}^{\text{12}} \text{J} $$
 to  $$8.4×{\text{10}}^{\text{11}} \text{J} $$
, or 2.5 to 1, conventional to radiation enhanced.

(b) Prompt radiation yields  $$6\text{.}3×{\text{10}}^{\text{11}} \text{J} $$
 to  $$2.1×{\text{10}}^{\text{11}} \text{J} $$
...
<div data-type="solution" markdown="1">
(a)  $$1\text{.}1×{\text{10}}^{\text{25}} \text{fissions} $$
 , 4.4 kg

(b)  $$3.2×{\text{10}}^{\text{26}} \text{fusions} $$
 , 2.7 kg
