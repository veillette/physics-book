...
[\[link\]](#import-auto-id3062396) shows a simple diagram of how a thermonuclear bomb is constructed. A fission bomb is exploded next to fusion fuel in the solid form of lithium deuteride. Before the shock wave blows it apart, $\gamma $

 rays heat and compress the fuel, and neutrons create tritium through the reaction $n{+}^{6}\text{Li}{\to }^{3}\text{H}{+}^{4}\text{He}$

. Additional fusion and fission fuels are enclosed in a dense shell of ${}^{\text{238}}\text{U}$

. The shell reflects some of the neutrons back into the fuel to enhance its fusion, but at high internal temperatures fast neutrons are created that also cause the plentiful and inexpensive ${}^{\text{238}}\text{U}$
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
How does the lithium deuteride in the thermonuclear bomb shown in [[link]](#import-auto-id3062396) supply tritium $\left({}^{3}\text{H}\right)$
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
Fallout from nuclear weapons tests in the atmosphere is mainly ${}^{\text{90}}\text{Sr}$
...
(a) Convert this amount of energy to kilowatt-hours, noting that $\text{1 kW}\cdot \text{h}=3\text{.}\text{60}×{\text{10}}^{6}\phantom{\rule{0.25em}{0ex}}\text{J}$
...
<div data-type="solution" markdown="1">
(a) Blast yields $2.1×{\text{10}}^{\text{12}}\phantom{\rule{0.25em}{0ex}}\text{J}$

 to $8.4×{\text{10}}^{\text{11}}\phantom{\rule{0.25em}{0ex}}\text{J}$

, or 2.5 to 1, conventional to radiation enhanced.

(b) Prompt radiation yields $6\text{.}3×{\text{10}}^{\text{11}}\phantom{\rule{0.25em}{0ex}}\text{J}$

 to $2.1×{\text{10}}^{\text{11}}\phantom{\rule{0.25em}{0ex}}\text{J}$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) How many ${}^{\text{239}}\text{Pu}$

 nuclei must fission to produce a 20.0-kT yield, assuming 200 MeV per fission? (b) What is the mass of this much ${}^{\text{239}}\text{Pu}$
...
<div data-type="solution" markdown="1">
(a) $1\text{.}1×{\text{10}}^{\text{25}}\phantom{\rule{0.25em}{0ex}}\text{fissions}$

 , 4.4 kg

(b) $3.2×{\text{10}}^{\text{26}}\phantom{\rule{0.25em}{0ex}}\text{fusions}$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
It is estimated that weapons tests in the atmosphere have deposited approximately 9 MCi of ${}^{\text{90}}\text{Sr}$

 on the surface of the earth. Find the mass of this amount of ${}^{\text{90}}\text{Sr}$

.

</div>
<div data-type="solution" markdown="1">
$7×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{g}$
...
<div data-type="solution" markdown="1">
(a) $4\text{.}\text{86}×{\text{10}}^{9}\phantom{\rule{0.25em}{0ex}}\text{W}$
