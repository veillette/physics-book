...
1.  {: #import-auto-id3093510} Identify the knowns.
    <div data-type="equation">
     $$A= 0.950{\text{ m}}^{2}\mathrm{; }d= 2.50\text{ cm}=0\text{.0250 m;} {T}_{1}=0º\text{C;} {T}_{2}= 35.0º\text{C,} t=\text{1 day}=\text{24 hours}=86 400 \text{s.} $$
    </div>
...
5.  {: #import-auto-id1441842} Insert the known values:
    <div data-type="equation" id="import-auto-id3034432">
     $$\frac{Q}{t}=\frac{\left(\text{0.010 J/s}\cdot \text{m}\cdot º\text{C}\right)\left(0.950 {\text{ m}}^{2}\right)\left(35.0º\text{C}-0º\text{C}\right)}{\text{0.0250 m}}=\text{13.3 J/s.} $$
    </div>
...
6.  {: #import-auto-id2659945} Multiply the rate of heat transfer by the time (
    ...
    <div data-type="equation" id="import-auto-id3387697">
     $$Q=\left(Q/t\right)t=\left( 13.3\text{ J/s}\right)\left(\text{86},\text{400}\text{ s}\right)= 1.15 \times 10^{6} \text{ J.} $$
    </div>
...
7.  {: #import-auto-id3217117} Set this equal to the heat transferred to melt the ice:
    ...
    <div data-type="equation" id="import-auto-id3209170">
     $$m=\frac{Q}{ {L}_{\text{f}}}=\frac{ 1.15 \times 10^{6} \text{ J}}{\text{334 } \times 10^{3} \text{ J/kg}}= 3.44\text{kg.} $$
    </div>
{: type="1"}
...
2.  {: #import-auto-id1861248} Calculate the necessary heat of vaporization of 1 g of water:
    <div data-type="equation">
     $$Q={\text{mL}}_{\text{v}}=\left( 1.00 \times 10^{-3} \text{ kg}\right)\left(2256 \times 10^{3} \text{ J/kg}\right)=\text{2256}\mathrm{ J.} $$
    </div>
...
4.  {: #import-auto-id2421283} Insert the knowns into the equation and solve for the temperature difference:
    <div data-type="equation">
     $${T}_{2}-{T}_{1}=\frac{Q}{t}\left(\frac{d}{\text{kA}}\right)=\left(\text{2256}\text{ J/s}\right)\frac{ 8.00 × 10^{-3}\text{m}}{\left(\text{220}\text{ J/s}\cdot \text{m}\cdot º\text{C}\right)\left( 1.54 \times 10^{-2} {\text{ m}}^{2}\right)}= 5.33º\mathrm{C.} $$
    </div>
{: type="1"}
