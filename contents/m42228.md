...
where  $$Q/t $$
 ...
 and  $$d $$
 are its surface area and thickness, as shown in [[Figure 3]](#Figure3), and  $$\left({T}_{2}-{T}_{1}\right) $$
 is the temperature difference across the slab. [[Table 1]](#Table1) gives representative values of thermal conductivity.
...
Note that in [[Table 1]](#Table1), the best thermal conductors—silver, copper, gold, and aluminum—are also the best electrical conductors, again related to the density of free electrons in them. Cooking utensils are typically made from good conductors.
