...
<div class="equation">
 $$\frac{Q}{t}=\frac{kA\left({T}_{2}-{T}_{1}\right)}{d}\text{,} $$
</div>
...
1.  {: #import-auto-id3093510} Identify the knowns.
    <div class="equation">
     $$A= 0.950{\text{m}}^{2}\mathrm{; }d= 2.50\text{cm}=0.0250\text{ m;} {T}_{1}=0º\text{C;} {T}_{2}= 35.0º\text{C,} t=1 \text{day}=24 \text{ hours}=86 400 \text{s.} $$
    </div>
...
5.  {: #import-auto-id1441842} Insert the known values:
    <div class="equation" id="import-auto-id3034432">
     $$\frac{Q}{t}=\frac{\left(0.010 \text{J/s}\cdot \text{m}\cdot \text{ºC}\right)\left(0.950 {\text{m}}^{2}\right)\left(35.0\text{ºC}-0\text{ºC}\right)}{0.0250 \text{m}}=13.3 \text{J/s.} $$
    </div>
...
7.  {: #import-auto-id3217117} Set this equal to the heat transferred to melt the ice:
    ...
    <div class="equation" id="import-auto-id3209170">
     $$m=\frac{Q}{ {L}_{\text{f}}}=\frac{ 1.15 \times 10^{6} \text{J}}{334  \times 10^{3} \text{J/kg}}= 3.44\text{kg.} $$
    </div>
{: type="1"}
...
<table id="import-auto-id1245788" summary="Thermal Conductivities of Common Substances"><caption><span class="title">Thermal Conductivities of Common Substances<sup class="footnote-number" id="footnote-ref1"><a class="footnote-link" href="#footnote1">1</a></sup></span></caption><thead><tr>
...
<div class="equation">
 $${T}_{2}-{T}_{1}=\frac{Q}{t}\left(\frac{d}{kA}\right)\text{.} $$
</div>
**Solution**

1.  {: #import-auto-id2009120} Identify the knowns and convert them to the SI units.
    The thickness of the pan,  $$d=0.800\text{cm}= 8.0 \times 10^{-3}  \text{m,} $$
    
     the area of the pan,  $$A=\pi {\left(0.14/2 \right)}^{2} {\text{m}}^{2}= 1.54 \times 10^{-2}  {\text{m}}^{2} $$
    
    , and the thermal conductivity,  $$k=220 \text{J/s}\cdot \text{m}\cdot ºC. $$
...
4.  {: #import-auto-id2421283} Insert the knowns into the equation and solve for the temperature difference:
    <div class="equation">
     $${T}_{2}-{T}_{1}=\frac{Q}{t}\left(\frac{d}{kA}\right)=\left(2256\text{J/s}\right)\frac{ 8.00 × 10^{-3}\text{m}}{\left(220\text{J/s}\cdot \text{m}\cdot \text{ºC}\right)\left( 1.54 \times 10^{-2} {\text{m}}^{2}\right)}= 5.33º\mathrm{C.} $$
    </div>
{: type="1"}
...
<div class="equation">
 $${\left(\frac{Q}{t}\right)}_{\text{final}}=\frac{ {kA}_{\text{final}}\left({T}_{2}-{T}_{1}\right)}{ {d}_{\text{final}}}=\frac{k\left({4 \text{A}}_{\text{initial}}\right)\left({T}_{2}-{T}_{1}\right)}{ {2d}_{\text{initial}}}=2\frac{ {kA}_{\text{initial}}\left({T}_{2}-{T}_{1}\right)}{ {d}_{\text{initial}}}=2{\left(\frac{Q}{t}\right)}_{\text{initial}}\text{.} $$
</div>
</div>
</div>
...
<div class="exercise" id="eip-id1166654654652" data-element-type="problems-exercises">
<div class="problem" id="eip-id1166646332006" markdown="1">
