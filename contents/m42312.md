...
<div data-type="equation" id="eip-458">
 $$\begin{array}{lll}{E}_{\text{tot}}& =& \left({E}_{1}^{2}+{E}_{2}^{2}{\right)}^{\text{1/2}}\\ & =& {\left\{\left( 1.124 \times 10^{5}  \text{N/C}{\right)}^{2}+\left( 0.5619 \times 10^{5}  \text{N/C}{\right)}^{2}\right\}}^{\text{1/2}}\\ & =&  1.26 \times 10^{5}  \text{N/C.}\end{array} $$
</div>
The direction is
