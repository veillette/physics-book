...
<div data-type="equation" id="eip-269">
 $$\begin{array}{}{E}_{2}=k\frac{ {q}_{2}}{ {r}_{2}^{2}}=\left( 8.99 \times 10^{9}  \text{N}\cdot {\text{m}}^{2}{\text{/C}}^{2}\right)\frac{\left(\text{10}\text{.}0×{\text{10}}^{-9} \text{C}\right)}{ {\left( 4.00 \times 10^{-2}  \text{m}\right)}^{2}}\\ {E}_{2}= 0.5619 \times 10^{5}  \text{N/C}.\end{array} $$
</div>
...
<div data-type="equation" id="eip-842">
 $$\begin{array}{lll}\theta & =& {\text{tan}}^{-1}\left(\frac{ {E}_{1}}{ {E}_{2}}\right)\\ & =& {\text{tan}}^{-1}\left(\frac{ 1.124 \times 10^{5}  \text{N/C}}{ 0.5619 \times 10^{5}  \text{N/C}}\right)\\ & =& \text{63}\text{.}4º,\end{array} $$
</div>
or  $$63.4º $$
 above the *x*-axis.
