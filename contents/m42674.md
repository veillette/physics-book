...
Yet another quantum number emerges from decay lifetimes and patterns. Note that the particles $$\text{Λ}\text{,}\phantom{\rule{0.25em}{0ex}}\text{Σ}\text{,}\phantom{\rule{0.25em}{0ex}}\text{Ξ}$$
, and $$\Omega $$
