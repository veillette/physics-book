...
$$ F_{\text{net}}=\text{mg}-{F}_{\text{D}}=\text{ma}=0. $$ 
</div>
...
Assume the density of air is $$ \rho =1.\text{21 kg}{\text{/m}}^{3} $$. A 75-kg skydiver descending head first will have an area approximately $$
A=0.18{\text{m}}^{2} $$
and a drag coefficient of approximately $$ C=0.70 $$. We find that

<div data-type="equation" id="eip-981">
 $$ \begin{array}{lll}v& =& \sqrt{\frac{2\left(\text{75 kg}\right)\left(9\text{.80 m}{\text{/s}}^{2}\right)}{\left(1.\text{21 kg}{\text{/m}}^{3}\right)\left(0.70\right)\left(0.18{\text{m}}^{2}\right)}}\\ & =& 98 \text{m/s}\\ & =& 350 \text{km/h}\text{.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-656">
 $$ \begin{array}{lll}{v}_{\text{t}}& =& \sqrt{\frac{2\left(85}\text{kg}\right)\left(9.80{\text{m/s}}^{2}\right)}{\left(1.21{\text{kg/m}}^{3}\right)\left(1.0\right)\left(0.70{\text{m}}^{2}\right)}}\\ & =& \text{44 m/s.}\end{array} $$ 
</div>
**Discussion**
...
mathematically
  ...
  <div data-type="equation">
  $$ F_{\text{D}}=\frac{1}{2}\mathrm{C\rho }{\mathrm{Av}}^{2}, $$ 
  </div>
