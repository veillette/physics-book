...
$$ {F}_{\text{D}}\propto \phantom{\rule{0.15em}{0ex}}{v}^{2} $$
...
A=0\text{.}\text{18}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2} $$
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
A 560-g squirrel with a surface area of  $$ \text{930}\phantom{\rule{0.25em}{0ex}}{\text{cm}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
Calculate the speed a spherical rain drop would achieve falling from 5.00 km (a) in the absence of air drag (b) with air drag. Take the size across of the drop to be 4 mm, the density to be  $$ 1\text{.}\text{00}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}{\text{kg/m}}^{3} $$ 
...
1\text{.}\text{10}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}{\text{kg/m}}^{3}
$$.
