...
<div data-type="equation" id="eip-981">
 $$ \begin{array}{lll}
v& =& \sqrt{\frac{2\left(75 \text{kg}\right)\left(9.80 \text{m/s}^{2}\right)}{\left(1.21 \text{kg}{\text{/m}}^{3}\right)\left(0.70\right)\left(0.18\text{m}^{2}\right)}}\\
 & =& 98 \text{m/s}\\
 & =& 350 \text{km/h}.
\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-656">
 $$ \begin{array}{lll}
v_{\text{t}}& =& \sqrt{\frac{2\left(85\text{kg}\right)\left(9.80\text{m/s}^{2}\right)}{\left(1.21\text{kg/m}^{3}\right)
