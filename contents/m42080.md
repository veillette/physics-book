...
<div data-type="equation" id="eip-981">
 $$ \begin{array}{lll}
v& =& \sqrt{\frac{2\left(75 \kg \right)\left(9.80 \mss \right)}{\left(1.21 \kg {\text{/m}}^{3}\right)\left(0.70\right)\left(0.18 \mm\right)}}\\
 & =& 98  \ms \\
 & =& 350 \text{km/h}.
\end{array} $$ 
</div>
...
(b) What is the magnitude of drag force at 70 km/h and 100 km/h for a Hummer H2? (Drag area is $$ 2.44  \mm $$)
Assume all values are accurate to three significant digits.
