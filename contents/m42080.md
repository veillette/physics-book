...
equation can also be written in a more generalized fashion as $$ F_{\text{D}}=b v^{2}  $$,
where $$ b $$
** is a constant equivalent to $$ 0.5 C \rho A $$. We have set the exponent for these equations as 2 because, 
when an object is
