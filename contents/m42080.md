...
$$ F_{\text{D}}=\frac{1}{2}C \rho A v^{2}\text{,} $$ 
</div>
...
<table id="import-auto-id1165298535568" summary="A table lists typical values of draft coefficient C for 
different objects. Values include 0.28 for a Toyota Camry, 0.64 for a Hummer H2 SUV, 0.7 for a skydiver feet first, and 1.0 for a horizontal skydiver."><caption><span data-type="title">Drag Coefficient Values </span>Typical values of drag coefficient  $$ C $$ .</caption><thead><tr>
              <th>Object</th>
              <th>
              <em>C</em>
              </th>
...
* {: #import-auto-id1165298748357} For small objects (such as a bacterium)
  ...
  where $$ r $$ is the radius of the object, **
  $$ \eta $$ is the fluid viscosity, and $$ v $$ is the object’s velocity.
