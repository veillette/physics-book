...
<div data-type="equation" id="eip-877">
 $$ \begin{array}{lll}\text{KE}_{\text{rot}}& =& 0.5\left(1.25\text{kg}\cdot \text{m}^{2}\right)
\left(70.4{\text{rad}}^{2}/{\text{s}}^{2}\right)\\
 & =& 44.0\text{J}
\end{array}. $$ 
</div>
...
<div data-type="equation" id="eip-8">
 $$ \begin{array}{lll}
\text{KE}_{\text{rot}}& =& \left(0.5\right)\left(2.34\text{kg}\cdot \text{m}^{2}\right){\left(\left(0.800\text{rev/s}\right)\left(2\pi \text{rad/rev}\right)\right)}^{2}\\
 & =& 29.6\text{J} .
\end{array} $$ 
</div>
