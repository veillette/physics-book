...
<div data-type="equation" id="eip-466">
 $$ \begin{array}{lll}\text{net}\tau & =& {r}_{\perp }F\\ & =& \left(0.0220 \text{m}\right)\left(2000}\text{N}\right)\\ & =& 44.0 \text{N}\cdot \text{m.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-877">
 $$ \begin{array}{lll}{\text{KE}}_{\text{rot}}& =& 0.5\left(1\text{.25}\text{kg}\cdot {\text{m}}^{2}\right)\left(70.4{\text{rad}}^{2}/{\text{s}}^{2}\right)\\ & =& 44.0\text{J}\end{array}. $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-307">
 $$ \begin{array}{lll}K{E}_{\text{rot}}\prime & =& \left(0.5\right)\left(0\text{.363 kg}\cdot {m}^{2}\right){\left[\left(5\text{.}\text{16 rev/s}\right)\left(2\pi  rad/rev\right)\right]}^{2}\\ & =& \text{191 J.}\end{array} $$ 
</div>
**Discussion**
...
<div data-type="solution" markdown="1">
 $$ 22.\text{5 kg}\cdot {\text{m}}^{2}\text{/s} $$ 
