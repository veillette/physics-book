...
p=mv  $$. Units for linear momentum are $$ \text{kg}\cdot \text{m}\text{/s} $$
...
is $$ 5.979 \times  10^{24}\text{kg}
$$
and its radius $$ R $$
is $$ 6.376 \times  10^{6}\text{m}
...
<div data-type="equation" id="eip-297">
 $$ \begin{array}{lll}L& =& 0.4\left(5.979 \times  10^{24}\text{kg}\right){\left(6.376 \times  10^{6}\text{m}\right)}^{2}\left(\frac{1\text{rev}}{\text{d}}\right)\\ & =& 9.72 \times  10^{37}\text{kg}\cdot \text{m}^{2}\cdot \text{rev/d}.\end{array} $$ 
</div>
Substituting  $$ 2\pi  $$ 

rad for $$ 1 $$
rev and $$ 8.64 \times  10^{4}\text{s} $$
for 1 day gives

<div data-type="equation" id="eip-195">
 $$ \begin{array}{lll}L& =& \left(9.72 \times  10^{37}\text{kg}\cdot \text{m}^{2}\right)\left(\frac{2\pi \text{rad/rev}}{8.64 \times  10^{4}\text{s/d}}\right)\left(1\text{rev/d}\right)\\ & =& 7.07 \times  10^{33}\text{kg}\cdot \text{m}^{2}\text{/s}.\end{array} $$ 
</div>
**Discussion**
...
\text{net}\tau =\frac{\Delta L}{\Delta t} $$
for $$ \Delta L $$, and using the given information to calculate the torque. The final angular
momentum equals the change in angular momentum, because the lazy Susan starts
from rest. That is, $$ \Delta L=L $$. To find the final velocity, we must calculate $$ \omega $$
...
<div data-type="equation" id="eip-994">
 $$ \Delta L=\left(\text{net}\text{τ}\right)\mathrm{\Delta t}. $$ 
</div>
...
<div data-type="equation" id="eip-911">
 $$ \begin{array}{lll}L& =& \text{rF}\Delta t=\left(0.260 \text{m}\right)\left(2.50 N\right)\left(0.150 s\right)\\ & =& 9.75 \times 10^{-2}\text{kg}\cdot \text{m}^{2}/\text{s}.\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-466">
 $$ \begin{array}{lll}\text{net}\tau & =& r_{\perp }F\\ & =& \left(0.0220 \text{m}\right)\left(2000}\text{N}\right)\\ & =& 44.0 \text{N}\cdot \text{m.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-877">
 $$ \begin{array}{lll}{\text{KE}}_{\text{rot}}& =& 0.5\left(1.25\text{kg}\cdot \text{m}^{2}\right)\left(70.4{\text{rad}}^{2}/{\text{s}}^{2}\right)\\ & =& 44.0\text{J}\end{array}. $$ 
</div>
**Discussion**
...
\text{net}\tau \right)\Delta t $$. This equation means that, to change angular momentum, a torque must act over
...
If the change in angular momentum $$ \Delta L $$
...
with her arms extended and of $$ 0.363\text{kg}\cdot \text{m}^{2} $$
...
<div data-type="equation" id="eip-158">
 $$ \begin{array}{lll}\omega \prime & =& \frac{I}{I^{\prime} }\omega =\left(\frac{2.34 \text{kg}\cdot {m}^{2}}{0.363 \text{kg}\cdot {m}^{2}}\right)\left(0.800 \text{rev/s}\right)\\ & =& \text{}\text{5.16 rev/s.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-8">
 $$ \begin{array}{lll}{\text{KE}}_{\text{rot}}& =& \left(0.5\right)\left(2.34\text{kg}\cdot \text{m}^{2}\right){\left(\left(0.800\text{rev/s}\right)\left(2\pi \text{rad/rev}\right)\right)}^{2}\\ & =& 29.6\text{J.}\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-307">
 $$ \begin{array}{lll}K{E}_{\text{rot}}\prime & =& \left(0.5\right)\left(0.363 \text{kg}\cdot {m}^{2}\right){\left[\left(5.16 \text{rev/s}\right)\left(2\pi  rad/rev\right)\right]}^{2}\\ & =& 191 \text{J.}\end{array} $$ 
</div>
**Discussion**
...
(b)  $$ 7.07 \times  10^{33}\text{kg}\cdot
\text{m}^{2}\text{/s} $$
The angular momentum of the Earth in its orbit around the Sun is $$ 3.77 \times  10^{6} $$
