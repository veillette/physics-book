...
<div data-type="equation" id="eip-911">
 $$ \begin{array}{lll}L& =& \text{rF}\Delta t=\left(0\text{.}\text{260 m}\right)\left(2.50 N\right)\left(0.150 s\right)\\ & =& 9\text{.}\text{75}×{\text{10}}^{-2}\text{kg}\cdot {\text{m}}^{2}/\text{s}.\end{array} $$ 
</div>
**Solution for (b)**
