...
p=mv  $$. Units for linear momentum are $$ \text{kg}\cdot \text{m/s} $$
...
L=I \omega $$. First, according to [\[link\]](/contents/m42179#fs-id1838666), the formula for
...
<div data-type="equation" id="eip-911">
 $$ \begin{array}{lll}L& =& rF\Delta t=\left(0.260 \text{m}\right)\left(2.50 N\right)\left(0.150 s\right)\\ & =& 9.75 \times 10^{-2}\text{kg}\cdot \text{m}^{2}/\text{s}.\end{array} $$ 
</div>
**Solution for (b)**
...
These expressions are the **law of conservation of angular momentum**{: data-type="term" #import-auto-id1412261}
. Conservation laws are as scarce as
they are important.
...
momentum given in $$ I\omegaI^{\prime} \omega \prime $$
is applicable. Thus,
...
<div data-type="equation" id="eip-158">
 $$ \begin{array}{lll}\omega \prime & =& \frac{I}{I^{\prime}}\omega 
=\left(\frac{2.34 \text{kg}\cdot {m}^{2}}{0.363 \text{kg}\cdot {m}^{2}}\right)
\left(0.800 \text{rev/s}\right)\\ & =& 5.16 \text{rev/s.}\end{array} $$ 
</div>
...
(b)  $$ 7.07 \times 10^{33}\text{kg}\cdot \text{m}^{2}\text{/s} $$
