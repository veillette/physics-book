...
6.  {: #import-auto-id3192933} For conduction, equation
    ...
    is appropriate. [\[link\]](/m42228#import-auto-id1245788) lists thermal conductivities. For convection, determine the amount of matter moved and use equation $$Q=mc\Delta T $, to calculate the heat transfer involved in the temperature change of the fluid. If a phase change accompanies convection, equation $$Q={\text{mL}}_{\text{f}} $$ or  $$Q={\text{mL}}_{\text{v}} $$
