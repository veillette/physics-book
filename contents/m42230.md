...
<div data-type="equation" id="eip-911">
 $$=\left( 5.67 \times 10^{-8} \text{ J/s}\cdot {\text{ m}}^{2}\cdot {\text{ K}}^{4}}\right)\left( 0.97\right)\left( 1.50{\text{ m}}^{2}\right)\left[{\left(295\text{ K}\right)}^{4}-{\left(306 \text{K}\right)}^{4}\right] $$
</div>
...
(b) Any temperature increase greater than about  $$3\text{ºC} $$
 would be unreasonably large. In this case the final temperature of the person would rise to  $$73\text{ºC} \left(163 \text{º}\text{F}\right) $$
.
