...
<div data-type="equation" id="eip-911">
 $$=\left( 5.67 \times 10^{-8} \text{ J/s}\cdot {\text{ m}}^{\text{2}}\cdot {\text{ K}}^{\text{ 4}}\right)\left( 0.97\right)\left( 1.50{\text{ m}}^{2}\right)\left[{\left(\text{295}\text{ K}\right)}^{4}-{\left(306 \text{K}\right)}^{4}\right] $$
</div>
<div data-type="equation" id="eip-742">
 $$=-\text{99}\text{ J/s}=-99 \text{W.} $$
</div>
**Discussion**
...
(b) Any temperature increase greater than about  $$3º\text{C} $$
 would be unreasonably large. In this case the final temperature of the person would rise to  $$73º\text{C} \left(\text{163º}\text{F}\right) $$
.
