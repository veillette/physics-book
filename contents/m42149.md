...
to $$ \text{kx} $$
in the fully stretched position. The average force is $$ \text{kx}/2 $$. Thus the work done in stretching or compressing the spring is $$ W_{s}=F d =\left(\frac{\text{kx}}{2}\right)
