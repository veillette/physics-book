...
to $$ \text{kx} $$
in the fully stretched position. The average force is $$ \text{kx}/2 $$. Thus the work done in stretching or compressing the spring is $$ W_
...
<div data-type="equation">
 $$ \frac{1}{2}{\text{kx}}_{\text{i}}^{ 2}=\frac{1}{ 2}{\text{mv}}_{\text{f}}^{\text{ 2}}+{mgh }_{\text{f}}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-334">
 $$ \begin{array}{lll}v_{f}& =& \sqrt{\frac{ { {\text{kx}}_{i}}^{2}}{m}-2{\text{gh}}_{f}}\\ & =& \sqrt{\left(\frac{250.0 \text{N/m}}{0.100 \text{kg}}\right)\left(0.0400 \text{m}{\right)}^{2}-2\left(9.80\text{m/s}^{2}\right)\left(0.180 \text{m}\right)}\\ & =& \text{0.687 m/s.}\end{array} $$ 
</div>
**Discussion**
