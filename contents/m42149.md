...
v_{f}& =& \sqrt{\frac{k}{m}}x_{i}\\
 & =& \sqrt{\frac{250.0 \text{N/m}}{0.100 \kg }}
\left(0.0400 \m \right)\\
 & =& 2.00  \ms  .
\end{array} $$ 
</div>
...
\left(0.0400 \m  \right)^{2}-2\left(9.80\mss \right)
\left(0.180 \m \right)}\\
 & =& 0.687  \ms  .
\end{array} $$ 
</div>
