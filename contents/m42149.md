...
\frac{1}{2} m v_{f}^{2}+ mgh_{f}+ \frac{1}{2} kx_{f}^{2}, $$ 
</div>
...
\sqrt{\frac{250.0 \text{N/m}}{0.100 \text{kg}}}
\left(0.0400 \text{m}\right)\\ & =&
2.00 \text{ m/s} .
\end{array} $$ 
</div>
...
& =& \sqrt{\left(\frac{250.0 \text{N/m}}{0.100 \text{kg}}\right)
\left(0.0400 \text{m} \right)^{2}-2\left(9.80\text{m/s}^{2}\right)
\left(0.180 \text{m}\right)}\\ & =& 
0.687 \text{ m/s} .
\end{array} $$ 
</div>
