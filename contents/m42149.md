...
<div data-type="equation" id="eip-196">
 $$ \begin{array}{lll}v_{f}& =& \sqrt{\frac{k}{m}}x_{i}\\ & =& \sqrt{\frac{250.0 \text{N/m}}{0.100 \text{kg}}}\left(0.0400 \text{m}\right)\\ & =&
2.00 \text{ m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation">
 $$ \frac{1}{2}{\text{kx}}_{\text{i}}^{ 2}=\frac{1}{ 2} mv_{\text{f}}^{2}+{mgh }_{\text{f}}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-334">
 $$ \begin{array}{lll}v_{f}& =& \sqrt{\frac{ { {\text{kx}}_{i}}^{2}}{m}-2{g h }_{f}}\\ & =& \sqrt{\left(\frac{250.0 \text{N/m}}{0.100 \text{kg}}\right)\left(0.0400 \text{m}{\right)}^{2}-2\left(9.80\text{m/s}^{2}\right)\left(0.180 \text{m}\right)}\\ & =& 
0.687 \text{ m/s.}\end{array} $$ 
</div>
**Discussion**
