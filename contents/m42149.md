...
<div data-type="equation" id="eip-196">
 $$ \begin{array}{lll}{v}_{f}& =& \sqrt{\frac{k}{m}}{x}_{i}\\ & =& \sqrt{\frac{250}\text{.0 N/m}}{\text{0.100 kg}}}\left(\text{0.0400 m}\right)\\ & =& \text{2.00 m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-334">
 $$ \begin{array}{lll}{v}_{f}& =& \sqrt{\frac{ { {\text{kx}}_{i}}^{2}}{m}-2{\text{gh}}_{f}}\\ & =& \sqrt{\left(\frac{\text{250.0 N/m}}{\text{0.100 kg}}\right)\left(\text{0.0400 m}{\right)}^{2}-2\left(9.80{\text{m/s}}^{2}\right)\left(\text{0.180 m}\right)}\\ & =& \text{0.687 m/s.}\end{array} $$ 
</div>
**Discussion**
