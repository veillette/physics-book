...
to $$ \text{kx} $$
in the fully stretched position. The average force is $$ \text{kx}/2 $$. Thus the work done in stretching or compressing the spring is $$ W_{s}=\text{Fd}=\left(\frac{\text{kx}}{2}\right)
...
area is also $$
\frac{1}{2}k x^{2}  $$. We therefore define the **potential energy of a spring**{: data-type="term"},
$$ {\text{PE}}_{s} $$, to be

<div data-type="equation">
 $$ {\text{PE}}_{\text{s}}=\frac{1}{2}k x^{2} \text{,} $$ 
</div>
...
The equation $$ {\text{PE}}_{s}=\frac{1}{2}k x^{2}  $$
...
energy is $$ {\text{PE}}_{s}=\frac{1}{2}k x^{2}  $$, where $$ k $$
...
<div data-type="equation">
 $$ W_{\text{net}}=\frac{1}{2}m v^{2}-\frac{1}{2} m v_{0}^{2}=\Delta \text{KE.} $$ 
</div>

If only conservative forces act, then

<div data-type="equation">
 $$ W_{\text{net}}=W_{\text{c}}\text{,} $$ 
</div>
...
force, does work, the system loses potential energy. That is, $$ {W}_{\text{c}}=-\Delta \text{PE} $$. Therefore,
...
<div data-type="equation" id="eip-82">
 $$ \frac{1}{2} m v_{i}^{2}+{mgh }_{i}+\frac{1}{2}{ {\text{kx}}_{i}}^{2}=\frac{1}{2} m v_{f}^{2}+{mgh }_{f}+\frac{1}{2}{ {\text{kx}}_{f}}^{2}, $$ 
</div>
...
zero, so that both $$ h_{\text{i}} $$
and $$ h_{\text{f}} $$
are zero. Furthermore, the initial speed $$ v_{\text{i}} $$
is zero and the final compression of the spring $$ x_{\text{f}} $$
...
<div data-type="equation" id="eip-654">
 $$ \frac{1}{2}{ {\text{kx}}_{i}}^{2}=\frac{1}{2} m v_{f}^{2}\text{.} $$ 
</div>
...
<div data-type="equation" id="eip-196">
 $$ \begin{array}{lll}v_{f}& =& \sqrt{\frac{k}{m}}x_{i}\\ & =& \sqrt{\frac{250}.0 \text{N/m}}{0.100 \text{kg}}}\left(0.0400 \text{m}\right)\\ & =& \text{2.00 m/s.}\end{array} $$ 
</div>
**Solution for (b)**
...
<div data-type="equation">
 $$ \frac{1}{2}{\text{kx}}_{\text{i}}^{ 2}=\frac{1}{ 2}{mv }_{\text{f}}^{\text{ 2}}+{mgh }_{\text{f}}\text{.} $$ 
</div>
This form of the equation means that the spring’s initial potential energy is converted partly to gravitational potential energy and partly to kinetic energy. The final speed at the top of the slope will be less than at the bottom. Solving for  $$ v_{\text{f}} $$ 

and substituting known values gives

<div data-type="equation" id="eip-334">
 $$ \begin{array}{lll}v_{f}& =& \sqrt{\frac{ { {\text{kx}}_{i}}^{2}}{m}-2{g h }_{f}}\\ & =& \sqrt{\left(\frac{250.0 \text{N/m}}{0.100 \text{kg}}\right)\left(0.0400 \text{m}{\right)}^{2}-2\left(9.80\text{m/s}^{2}\right)\left(0.180 \text{m}\right)}\\ & =& \text{0.687 m/s.}\end{array} $$ 
</div>
**Discussion**
...
* The potential energy of a spring is $$ {\text{PE}}_  {s}=\frac{1}{2}k x^{2}  $$
  , where $$ k $$
  is the spring’s force constant and $$ x $$
...
law applies, it is given by the expression $$ \frac{1}{2}k x^{2}  $$
where $$ x $$
