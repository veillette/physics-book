...
. Thus the work done in stretching or compressing the spring is \\( {W}_
{s}=\text{Fd}=\left(\frac{\text{kx}}{2}\right)
x=\frac{1}{2}{\text{kx}}^{2} \\)

. Alternatively, we noted
...
. We therefore define the **potential energy of a spring**{: data-type="term"},
\\( {\text{PE}}_{s} \\)
...
of stretching or compressing it a distance \\( x \\)
...
. In a system that experiences only conservative forces, there is a potential
