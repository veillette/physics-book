...
<div data-type="equation" id="eip-618">
 $$\text{1 u}= 1.6605 \times 10^{-27}  \text{kg.} $$
</div>
...
<div data-type="equation" id="import-auto-id1365916">
 $$\begin{array}{lll}m=\mathrm{\rho V}={\mathrm{\rho d}}^{3}& ⇒& a={\left(\frac{m}{\rho }\right)}^{1/3}={\left(\frac{ 2.3 \times 10^{17}  \text{kg}}{\text{1000} {\text{kg/m}}^{3}}\right)}^{\frac{1}{3}}\\ & =& \text{61}×{\text{10}}^{3} \text{m}=\text{61 km}\end{array} $$
</div>
</div>
</div>
