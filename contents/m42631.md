...
<div class="equation" id="eip-940">
 $$E={\text{mc}}^{2}=\left(938.27 \text{MeV/}{c}^{2}\right){c}^{2}=938.27 \text{MeV.} $$
</div>
...
which is sufficient and is most commonly used. For example, in this simpler notation, the three isotopes of hydrogen are  $${}^{1}\text{H,} {}^{2}\text{H,} $$
 and  $${}^{3}\text{H,} $$
 while the  $$\alpha  $$
...
* A nuclide is a specific combination of protons and neutrons, denoted by
  <div class="equation" id="eip-107">
   $${}_{Z}^{A}{\text{X}}_{N} \text{or simply}{}^{A}\text{X,} $$
  </div>
