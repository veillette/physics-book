...
$$ w_{\parallel}=w \sin{\left(25^\circ\right)}=mg\sin{\left(25^\circ\right)}
$$, and the magnitude of the component of the weight perpendicular to the slope is
$$ w_{\perp}=w \cos{\left(25^\circ\right)}=mg\cos{\left(25^\circ\right)} $$.
...
where $$ F_{\text{net}\parallel }=w_{\parallel }=mg \sin\left(25^\circ\right) $$ 
...
{\mathbf{\text{w}}}_{\perp } $$
**,**{::}**** and a force acting parallel to the plane, $$ {\mathbf{\text{w}}}_{\parallel } $$. The perpendicular force of weight, $$ {\mathbf{\text{w}}}_{\perp } $$
...
, $$ {T}_{\text{R}y} $$, and $$ T $$. As we determined from the analysis in the horizontal direction, $$ {T}_{\text{L}}=T_{\text{R}}=T $$
\:
