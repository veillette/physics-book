...
$$
that the floor exerts on a chair might be $$ \mathbf{\text{N}}=100 \text{N} $$. One important difference is that normal force is a vector, while the newton is
...
where $$ F_{\text{net}\parallel }={w}_{\parallel }=\text{mg}\sin\left(\text{25º}\right) $$ 

, assuming no friction for this part, so that

<div data-type="equation" id="eip-id1172560">
 $$ a_{\parallel }=\frac{ F_{\text{net}\parallel }}{m}=\frac{\text{mg}\sin\left(\text{25º}\right)}{m}=g\sin\left(\text{25º}\right) $$ 
</div>
<div data-type="equation" id="eip-id1165294200578">
 $$ \left(9.80{\text{m/s}}^{2}\right)\left(0.4226\right)=4.14{\text{m/s}}^{2} $$ 
</div>
is the acceleration.
...
$$ F_{\text{net}\parallel }={w}_{\parallel }-f, $$ 
</div>
and substituting this into Newton’s second law,  $$ a_{\parallel }=\frac{ F_{\text{net}\parallel }}{m} $$ 

**, gives

<div data-type="equation" id="eip-id1527388">
 $$ a_{\parallel }=\frac{ F_{\text{net}\mid \mid }}{m}=\frac{ w_{\parallel }-f}{m}=\frac{\text{mg}\sin\left(\text{25º}\right)-f}{m}. $$ 
</div>
We substitute known values to obtain

<div data-type="equation" id="eip-id1967372">
 $$ a_{\parallel }=\frac{\left(60.\text{0 kg}\right)\left(9.80 \text{m/s}^2\right)\left(0.4226\right)-45.0 \text{N}}{60.\text{0 kg}}, $$ 
</div>
which yields

<div data-type="equation" id="eip-id1337555">
 $$ a_{\parallel }=3.39 \text{m/s}^2, $$ 
</div>
...
the incline is $$ a=g\sin\theta $$, *regardless of mass*. This is related to the previously discussed fact that
...
<div data-type="equation" id="eip-id2265769">
 $$ {w}_{\parallel }=w\sin\left(\theta \right)=\text{mg}\sin\left(\theta \right) $$ 
</div>
and

<div data-type="equation" id="eip-id1553388">
 $$ {w}_{\perp }=w\cos\left(\theta \right)=\text{mg}\cos\left(\theta \right). $$ 
</div>
...
<div data-type="equation" id="eip-id2503179">
 $$ \begin{array}{lll}\cos\left(\theta \right)& =& \frac{ w_{\perp }}{w}\\ {w}_{\perp }& =& w\cos\left(\theta \right)=\text{mg}\cos\left(\theta \right)\end{array} $$ 
</div>
<div data-type="equation" id="eip-id1900825">
 $$ \begin{array}{lll}\sin\left(\theta \right)& =& \frac{ w_{\parallel }}{w}\\ {w}_{\parallel }& =& w\sin\left(\theta \right)=\text{mg}\sin\left(\theta \right)\end{array} $$ 
</div>
</div>
...
<div data-type="equation" id="eip-id2489897">
 $$ T=\text{mg}=\left(\text{5.00 kg}\right)\left(9.80 \text{m/s}^2\right)=49.0 \text{N}. $$ 
</div>
...
$$ F_{\text{net}x}={T}_{\text{L}x}-{T}_{\text{R}x}. $$ 
</div>
...
<div data-type="equation" id="eip-id2130931">
 $$ \begin{array}{lll}\cos\left(5.0º\right)& =& \frac{ T_{\text{L}x}}{ T_{\text{L}}}\\ {T}_{\text{L}x}& =& {T}_{\text{L}}\cos\left(5.0º\right)\\ \cos\left(5.0º\right)& =& \frac{ T_{\text{R}x}}{ T_{\text{R}}}\\ {T}_{\text{R}x}& =& {T}_{\text{R}}\cos\left(5.0º\right).\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id2382116">
 $$ {T}_{\text{L}}\cos\left(5.0º\right)={T}_{\text{R}}\cos\left(5.0º\right). $$ 
</div>
Thus,
...
$$ F_{y}=0 $$. Thus, as illustrated in the free-body diagram
in [\[link\]](#import-auto-id1561864),

<div data-type="equation" id="eip-id1851063">
$$ F_{\text{net}y}={T}_{\text{L}y}+{T}_{\text{R}y}-w=0. $$ 
</div>
...
<div data-type="equation" id="eip-id3367015">
 $$ \begin{array}{lll}\sin\left(5.0º\right)& =& \frac{ T_{\text{L}y}}{ T_{\text{L}}}\\ {T}_{\text{L}y}={T}_{\text{L}}\sin\left(5.0º\right)& =& T\sin\left(5.0º\right)\\ \sin\left(5.0º\right)& =& \frac{ T_{\text{R}y}}{ T_{\text{R}}}\\ {T}_{\text{R}y}={T}_{\text{R}}\sin\left(5.0º\right)& =& T\sin\left(5.0º\right).\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id2085200">
 $$ \begin{array}{lll}{F}_{\text{net}y}& =& {T}_{\text{L}y}+{T}_{\text{R}y}-w=0\\ {F}_{\text{net}y}& =& T\sin\left(5.0º\right)+T\sin\left(5.0º\right)-w=0\\ 2T\sin\left(5.0º\right)-w& =& 0\\ 2T\sin\left(5.0º\right)& =& w\end{array} $$ 
</div>
and

<div data-type="equation" id="eip-id2089830">
 $$ T=\frac{w}{2\sin\left(5.0º\right)}=\frac{\text{mg}}{2\sin\left(5.0º\right)}, $$ 
</div>
so that

<div data-type="equation" id="eip-id2121189">
 $$ T=\frac{\left(70.\text{0 kg}\right)\left(9.80 \text{m/s}^2\right)}{2\left(0.0872\right)}, $$ 
</div>
and the tension is
...
* When objects rest on an inclined plane that makes an angle $$ \theta $$
  ...
  <div data-type="equation" id="eip-id2419526">
   $$ {w}_{\parallel }=w\text{sin}\left(\theta \right)=\text{mg}\text{sin}\left(\theta \right) $$ 
  </div>
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
What force does a trampoline have to apply to a 45.0-kg gymnast to accelerate her straight up at  $$ 7.50 \text{m/s}^2 $$ 
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the tension in a vertical strand of spider web if a spider of mass  $$ 8.00 \times 10^{-5}\text{kg} $$ 
...
<div data-type="solution" markdown="1">
(a)  $$ 7.84 \times 10^{-4}\text{N} $$ 

(b)  $$ 1.89 \times  10^{–3}\text{N}
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
Suppose a 60.0-kg gymnast climbs a rope. (a) What is the tension in the rope if he climbs at a constant speed? (b) What is the tension in the rope if he accelerates upward at a rate of  $$ 1.50 \text{m/s}^2 $$ 
...
tension of magnitude $$ T=\frac{ F_{\perp
}}{2\text{sin}\left(
\theta \right)} $$.
