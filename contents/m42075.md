...
$$
that the floor exerts on a chair might be $$ \vb{N}=100 \text{N} $$. One important difference is that normal force is a vector, while the newton is
