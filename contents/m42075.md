...
$$ \mathbf{\text{w}} $$ and the two tensions 
$$ {\mathbf{\text{T}}}_{\text{L}} $$
(left tension) and $$ {\mathbf{\text{T}}}_{\text{R}} $$
...
<div data-type="equation" id="eip-id2130931">
 $$ \begin{array}{lll}
\cos\left(5.0^\circ \right)& =& 
\frac{ T_{\text{L}x}}{ T_{\text{L}}}\\
...
\frac{ T_{\text{R}y}}{ T_{\text{R}}}\\
T_{\text{R}y}=T_{\text{R}}\sin\left(5.0^\circ \right)& =& 
T\sin\left(5.0^\circ \right).
\end{array} $$ 
</div>
...
mass  $$ 8.00 \times 10^{-5}\text{kg} $$ hangs motionless on it. 
...
(b) What is the tension in the rope if he accelerates upward at a rate of  $$ 1.50 \text{m/s}^2 $$?
