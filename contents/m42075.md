...
{\perp } $$, and a force acting parallel to the plane, $$ {\mathbf{\text{w}}}_
...
<div data-type="equation" id="eip-id2489897">
 $$ T=mg =\left(5.00 \text{kg}\right)
\left(9.80 \text{m/s}^2\right)=49.0 \text{N}. $$ 
</div>
...
to determine the magnitude of  $$ {T}_{\text{L}} $$ 
...
to determine the relationship between  $$ {T}_{\text{L}y} $$,
