...
<div data-type="equation" id="eip-id1172560">
 $$ {a}_{\parallel }=\frac{ {F}_{\text{net}\parallel }}{m}=\frac{\text{mg}\sin\left(\text{25º}\right)}{m}=g\sin\left(\text{25º}\right) $$ 
</div>
...
<div data-type="equation" id="eip-id1527388">
 $$ {a}_{\parallel }=\frac{ {F}_{\text{net}\mid \mid }}{m}=\frac{ {w}_{\parallel }-f}{m}=\frac{\text{mg}\sin\left(\text{25º}\right)-f}{m}. $$ 
</div>
...
<div data-type="equation" id="eip-id2503179">
 $$ \begin{array}{lll}\cos\left(\theta \right)& =& \frac{ {w}_{\perp }}{w}\\ {w}_{\perp }& =& w\cos\left(\theta \right)=\text{mg}\cos\left(\theta \right)\end{array} $$ 
</div>
<div data-type="equation" id="eip-id1900825">
 $$ \begin{array}{lll}\sin\left(\theta \right)& =& \frac{ {w}_{\parallel }}{w}\\ {w}_{\parallel }& =& w\sin\left(\theta \right)=\text{mg}\sin\left(\theta \right)\end{array} $$ 
</div>
</div>
...
<div data-type="equation" id="eip-id2130931">
 $$ \begin{array}{lll}\cos\left(5.0º\right)& =& \frac{ {T}_{\text{L}x}}{ {T}_{\text{L}}}\\ {T}_{\text{L}x}& =& {T}_{\text{L}}\cos\left(5.0º\right)\\ \cos\left(5.0º\right)& =& \frac{ {T}_{\text{R}x}}{ {T}_{\text{R}}}\\ {T}_{\text{R}x}& =& {T}_{\text{R}}\cos\left(5.0º\right).\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id3367015">
 $$ \begin{array}{lll}\sin\left(5.0º\right)& =& \frac{ {T}_{\text{L}y}}{ {T}_{\text{L}}}\\ {T}_{\text{L}y}={T}_{\text{L}}\sin\left(5.0º\right)& =& T\sin\left(5.0º\right)\\ \sin\left(5.0º\right)& =& \frac{ {T}_{\text{R}y}}{ {T}_{\text{R}}}\\ {T}_{\text{R}y}={T}_{\text{R}}\sin\left(5.0º\right)& =& T\sin\left(5.0º\right).\end{array} $$ 
</div>
...
<div data-type="exercise" data-element-type="problem-exercises">
<div data-type="problem" markdown="1">
(a) Calculate the tension in a vertical strand of spider web if a spider of mass  $$ 8\text{.}\text{00}×{\text{10}}^{-5}\text{kg} $$ 
...
<div data-type="solution" markdown="1">
(a)  $$ 7\text{.}\text{84}×{\text{10}}^{-4}\text{N} $$ 

(b)  $$ 1\text{.}\text{89}×{\text{10}}^{–3}\text{N}
