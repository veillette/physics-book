...
$$
to be the component of weight parallel to the slope and $$ w_{\perp } $$
...
where $$ F_{\text{net}\parallel }=w_{\parallel }=\text{mg}\sin\left(\text{25º}\right) $$ 
...
<div data-type="equation" id="eip-id1967372">
 $$ a_{\parallel }=\frac{\left(60.0 \text{kg}\right)\left(9.80 \text{m/s}^2\right)\left(0.4226\right)-45.0 \text{N}}{60.0 \text{kg}}, $$ 
</div>
which yields
...
<div data-type="equation" id="eip-id2265769">
 $$ w_{\parallel }=w\sin\left(\theta \right)=\text{mg}\sin\left(\theta \right) $$ 
</div>
and

<div data-type="equation" id="eip-id1553388">
 $$ w_{\perp }=w\cos\left(\theta \right)=\text{mg}\cos\left(\theta \right). $$ 
</div>
...
<div data-type="equation" id="eip-id2503179">
 $$ \begin{array}{lll}\cos\left(\theta \right)& =& \frac{ w_{\perp }}{w}\\ w_{\perp }& =& w\cos\left(\theta \right)=\text{mg}\cos\left(\theta \right)\end{array} $$ 
</div>
<div data-type="equation" id="eip-id1900825">
 $$ \begin{array}{lll}\sin\left(\theta \right)& =& \frac{ w_{\parallel }}{w}\\ w_{\parallel }& =& w\sin\left(\theta \right)=\text{mg}\sin\left(\theta \right)\end{array} $$ 
</div>
</div>
...
<div data-type="equation" id="eip-id2489897">
 $$ T=\text{mg}=\left(5.00 \text{kg}\right)\left(9.80 \text{m/s}^2\right)=49.0 \text{N}. $$ 
</div>
...
<div data-type="equation" id="eip-id2123898">
 $$ \begin{array}{lll}{F}_{\text{net}x}=0& =& {T}_{\text{L}x}-T_{\text{R}x}\\ {T}_{\text{L}x}& =& {T}_{\text{R}x}.\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id2382116">
 $$ {T}_{\text{L}}\cos\left(5.0º\right)=T_{\text{R}}\cos\left(5.0º\right). $$ 
</div>
Thus,

<div data-type="equation" id="eip-id2350456">
 $$ {T}_{\text{L}}=T_{\text{R}}=T, $$ 
</div>
...
<div data-type="equation" id="eip-id3367015">
 $$ \begin{array}{lll}\sin\left(5.0º\right)& =& \frac{ T_{\text{L}y}}{ T_{\text{L}}}\\ {T}_{\text{L}y}=T_{\text{L}}\sin\left(5.0º\right)& =& T\sin\left(5.0º\right)\\ \sin\left(5.0º\right)& =& \frac{ T_{\text{R}y}}{ T_{\text{R}}}\\ {T}_{\text{R}y}=T_{\text{R}}\sin\left(5.0º\right)& =& T\sin\left(5.0º\right).\end{array} $$ 
</div>
...
<div data-type="equation" id="eip-id2085200">
 $$ \begin{array}{lll}{F}_{\text{net}y}& =& {T}_{\text{L}y}+T_{\text{R}y}-w=0\\ {F}_{\text{net}y}& =& T\sin\left(5.0º\right)+T\sin\left(5.0º\right)-w=0\\ 2T\sin\left(5.0º\right)-w& =& 0\\ 2T\sin\left(5.0º\right)& =& w\end{array} $$ 
</div>
and
...
<div data-type="equation" id="eip-id2121189">
 $$ T=\frac{\left(70.0 \text{kg}\right)\left(9.80 \text{m/s}^2\right)}{2\left(0.0872\right)}, $$ 
</div>
and the tension is
...
* When objects rest on an inclined plane that makes an angle $$ \theta $$
  ...
  <div data-type="equation" id="eip-id2419526">
   $$ w_{\parallel }=w\text{sin}\left(\theta \right)=\text{mg}\text{sin}\left(\theta \right) $$ 
  </div>
