...
A **potentiometer** is a null measurement device for measuring potentials (voltages). (See [\[link\]](#Figure2).) A voltage source is connected to a resistor  $$R, $$
...
[\[link\]](#Figure2)(b) shows an unknown  $${\text{emf}}_{x} $$
