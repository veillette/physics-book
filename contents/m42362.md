...
Resistors  $${R}_{1} $$  and  $${R}_{2} $$
 ...
 drop along ad must equal the  $$IR $$  drop along ab. Thus,
...
Again, since b and d are at the same potential, the  $$IR $$
 drop along dc must equal the  $$IR $$  drop along bc. Thus,
