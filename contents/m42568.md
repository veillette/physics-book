...
Converting this to eV by multiplying by $$\left(\text{1 eV}\right)/\left(1\text{.}\text{602}×{\text{10}}^{\text{–19}}\phantom{\rule{0.25em}{0ex}}J\right)$$
 yields
...
Note that the forms of the constants $$h=\text{4}\text{.}\text{14}×{\text{10}}^{\text{–15}}\phantom{\rule{0.25em}{0ex}}\text{eV}\cdot \text{s}$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the wavelength of a photon that has a momentum of $$5\text{.}\text{00}×{\text{10}}^{-\text{29}}\phantom{\rule{0.25em}{0ex}}\text{kg}\cdot \text{m/s}$$
...
<div data-type="problem" markdown="1">
(a) A $$\gamma $$
-ray photon has a momentum of $$8\text{.}\text{00}×{\text{10}}^{-\text{21}}\phantom{\rule{0.25em}{0ex}}\text{kg}\cdot \text{m/s}$$
...
(c) electron $$3\text{.}\text{86}×{\text{10}}^{-\text{26}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
, photon $$7\text{.}\text{96}×{\text{10}}^{-\text{20}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
...
A car feels a small force due to the light it sends out from its headlights, equal to the momentum of the light divided by the time in which it is emitted. (a) Calculate the power of each headlight, if they exert a total force of $$2\text{.}\text{00}×{\text{10}}^{-2}\phantom{\rule{0.25em}{0ex}}\text{N}$$
