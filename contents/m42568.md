...
Converting this to eV by multiplying by  $$\left(1 \text{eV}\right)/\left( 1.602 \times 10^{-19} J\right) $$
 yields
...
<div class="equation" id="eip-474">
 $$p=\frac{E}{c}=\frac{\left(2.48 eV\right)\left( 1.60 \times 10^{-19} \text{J/eV}\right)}{ 3.00 \times 10^{8}  \text{m/s}}= 1.33  \times 10^{-27} \text{kg}\cdot \text{m/s}. $$
</div>
**Discussion**
