...
<div data-type="equation" id="eip-488">
 $$ {m}_{1}{v}_{1}={m}_{1}{v\prime }_{1}\cos{\theta }_{1}+{m}_{2}{v\prime }_{2}\cos{\theta }_{2}, $$ 
</div>
...
<div data-type="equation" id="eip-545">
 $$ 0={m}_{1}{v\prime }_{1}\sin{\theta }_{1}+{m}_{2}{v\prime }_{2}\sin{\theta }_{2}. $$ 
</div>
...
<div data-type="equation" id="eip-329">
 $$ \tan{\theta }_{2}=\frac{ {v\prime }_{1}\sin{\theta }_{1}}{ {v\prime }_{1}\cos{\theta }_{1}-{v}_{1}}. $$ 
</div>
Entering known values into the previous equation gives

<div data-type="equation" id="eip-45">
 $$ \tan{\theta }_{2}=\frac{\left(1\text{.}\text{50}\text{m/s}\right)\left(0\text{.}\text{7071}\right)}{\left(1\text{.}\text{50}\text{m/s}\right)\left(0\text{.}\text{7071}\right)-2\text{.}\text{00}\text{m/s}}=-1\text{.}\text{129}. $$ 
</div>
Thus,
...
<div data-type="equation" id="eip-497">
 $$ {v\prime }_{2}=-\left(\frac{0\text{.}\text{250}\text{kg}}{0\text{.}\text{400}\text{kg}}\right)\left(1\text{.}\text{50}\text{m/s}\right)\left(\frac{0\text{.}\text{7071}}{-0\text{.}\text{7485}}\right)\text{.} $$ 
</div>
Thus,

<div data-type="equation" id="eip-721">
 $$ {v\prime }_{2}=0\text{.}\text{886}\text{m/s}. $$ 
</div>
**Discussion**
...
8.00×{\text{10}}^{-\text{13}}\text{J} $$, and the masses of the helium and gold nuclei were $$
6.68×{\text{10}}^{-\text{27}}\text{kg} $$
and $$ 3.29×{\text{10}}^{-\text{25}}\text{kg} $$, respectively (note that their mass ratio is 4 to 197). (a) If a helium nucleus
...
<div data-type="solution" markdown="1">
(a)  $$ 5\text{.}\text{36}×{\text{10}}^{5}\text{m/s} $$ 

at $$ -\text{29.5º} $$
(b)  $$
7\text{.}\text{52}×{\text{10}}^{-\text{13}}\text{J}
$$
</div>
</div>
