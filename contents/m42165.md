...
We start by assuming that $$ {\mathbf{F}}_{\text{net}}=0 $$, so that momentum $$
\mathbf{p} $$ is conserved. The simplest collision is one in which one of the
...
- and $$ y $$ -axes $$ \left( p_{x}\text{and} p_{y}\right) $$ will also be
  ...
  Even with the simplifying assumptions of point masses, one particle initially
...
*-axis and $$ y $$ -axis are very useful in analyzing two-dimensional collisions
...
v^{\prime}_{2} $$ and $$\theta_{2}\right) $$ of the 0.400-kg object after the
collision.
...
that conservation of momentum along the $$ x $$
...
in which θ<sub>2</sub> is the only unknown quantity. Applying the identity $$
...
to the reader) of conservation of momentum in the $$ x $$
...
and assume that the cube is much more massive than the small object. (b) Answer
...
\text{m/s} $$ Verify that ratio of initial to final KE equals one:  $$
\begin{array}{l}\text{KE}=\frac{1}{2} m v_{1}^{2}=18 \text{mJ}\\
\text{KE}=\frac{1}{2} {mv^{\prime}_{1}}^{2}+\frac{1}{2}{mv^{\prime}_
{2}}^{2}=18\text{mJ}\end{array}}\frac{\text{KE}}{\text{KE′}}=1.00 $$
</div>
</div>
...
the bowling ball and with a speed of 15.0 m/s. (a)
...
$$ 8.00\times 10^{-13}\text{J} $$, and the masses of the helium and gold nuclei
were $$ 6.68\times 10^{-27}\text{kg} $$ and $$ 3.29\times 10^{-25}\text{kg} $$,
respectively (note that their mass ratio is 4 to 197). (a) If a helium nucleus
scatters to an angle of $$ 120^\circ $$ during an elastic collision with a gold
...
car has a mass of 1200 kg and is approaching at $$ 8.00\text{m/s} $$ due south.
The second car has a mass of 850 kg and is approaching at $$ 17.0\text{m/s} $$
