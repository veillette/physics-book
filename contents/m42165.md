...
- and $$ y $$
-axes $$ \left( p_{x}\text{and} p_{y}\right) $$
...
Suppose the following experiment is performed. A 0.250-kg object  $$ \left( m_{1}\right) $$ is slid on a frictionless surface into a dark room, where it strikes an
initially stationary object with mass of 0.400 kg $$ \left( m_{2}\right) $$. The 0.250-kg object emerges from the room at an angle of $$ 45.0^\circ $$
...
Solving $$  m_{1} v_{1}= m_{1}{v^{\prime} }_{1}\cos{\theta
}_{1}+ m_{2}{v^{\prime} }_{2}\cos{\theta
}_{2} $$
for $$  v_{2}^{\prime
}\cos{\theta }_{2}
$$
and $$ 0= m_{1}{v^{\prime} }_{1}\sin{\theta
}_{1}+ m_{2}{v^{\prime} }_{2}\sin{\theta
}_{2} $$
for $$ {v^{\prime} }_{2}\sin{\theta
}_{2} $$
...
<div data-type="equation" id="eip-532">
 $$ {\theta }_{2}={\tan}^{-1}\left(-1.129\right)=311.5º\approx 312^\circ. $$ 
</div>
...
<div data-type="equation" id="eip-213">
 $$ \frac{1}{2}m v_{1}^{2}=\frac{1}{2}{ {mv^{\prime} }_{1}}^{2}+\frac{1}{2}{ {mv^{\prime} }_{2}}^{2}. $$ 
</div>
...
<div data-type="equation" id="eip-717">
 $$ \frac{1}{2} m v_{1}^{2}=\frac{1}{2}{ {mv^{\prime} }_{1}}^{2}+\frac{1}{2}{ {mv^{\prime} }_{2}}^{2}+{mv^{\prime} }_{1}{v^{\prime} }_{2}\cos\left({\theta }_{1}-{\theta }_{2}\right). $$ 
</div>
...
that the angle between the balls is very close to $$ 90^\circ $$
...
* Two-dimensional collisions of point masses where mass 2 is initially at rest
  ...
  -axis), stated by $$ m_{1}v_{1}=m_{1}{v^{\prime} }_  {1}\cos{\theta
  }_{1}+m_{2}{v^{\prime} }_  {2}\cos{\theta
  }_{2} $$
...
<div data-type="problem" markdown="1">
Two identical pucks collide on an air hockey table. One puck was originally at rest. (a) If the incoming puck has a speed of 6.00 m/s and scatters to an angle of  $$ 30.0^\circ $$ 
...
v^{\prime}_{1}=v^{\prime}_{2}\frac{\sin{ 60^\circ}}{\sin{ 30^\circ }}= 5.196 \text{m/s} $$
Verify that ratio of initial to final KE equals one:  $$
\begin{array}{l}\text{KE}=\frac{1}{2} m v_{1}^{2}=18 \text{mJ}\\ 
\text{KE}=\frac{1}{2} {mv^{\prime}_{1}}^{2}+\frac{1}{2}{mv^{\prime}_{2}}^{2}=18\text{mJ}\end{array}}\frac{\text{KE}}{\text{KE′}}=1.00
$$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A 3000-kg cannon is mounted so that it can recoil only in the horizontal direction. (a) Calculate its recoil velocity when it fires a 15.0-kg shell at 480 m/s at an angle of  $$ 20.0^\circ $$ 
...
which is scattered at an angle of $$ 85.0^\circ $$
...
scatters to an angle of $$ 120^\circ $$
...
and $$ 0=m_{1}{v^{\prime} }_{1}\sin{\theta}_{1}+m_{2}{v^{\prime} }_{2}\sin{\theta}_{2} $$
for conservation of momentum in the $$ x $$ - and $$ y $$
...
<div data-type="equation" id="eip-id2367723">
 $$ \frac{1}{2}{ mv_{1}^{2}=\frac{1}{2}m{ {v^{\prime} }_{1}}^{2}+\frac{1}{2}m{ {v^{\prime} }_{2}}^{2}+m{v^{\prime} }_{1}{v^{\prime} }_{2}\cos\left({\theta }_{1}-{\theta }_{2}\right) $$ 
</div>
</div>
</div>
