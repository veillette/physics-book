...
<div data-type="equation" id="eip-717">
 $$ \frac{1}{2}{ {\text{mv}}_{1}}^{2}=\frac{1}{2}{ {\text{mv}\prime }_{1}}^{2}+\frac{1}{2}{ {\text{mv}\prime }_{2}}^{2}+{\text{mv}\prime }_{1}{v^{\prime} }_{2}\cos\left({\theta }_{1}-{\theta }_{2}\right). $$ 
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Starting with equations  $$ {m}_{1}{v}_{1}={m}_{1}{v^{\prime} }_{1}\cos{\theta }_{1}+{m}_{2}{v^{\prime} }_{2}\cos{\theta }_{2} $$ 
...
<div data-type="equation" id="eip-id1899177">
 $$ {v}_{1}={v}_{1}\cos{\theta }_{1}+{v}_{2}\cos{\theta }_{2} $$ 
</div>
and
