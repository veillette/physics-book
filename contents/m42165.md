...
\left(\text{tan}\phantom{\rule{0.25em}{0ex}}\theta
=\frac{\sin\phantom{\rule{0.25em}{0ex}}\theta
}{\cos\phantom{\rule{0.25em}{0ex}}\theta }\right) $$, we obtain:

<div data-type="equation" id="eip-329">
 $$ \text{tan}\phantom{\rule{0.25em}{0ex}}{\theta }_{2}=\frac{ {v\prime }_{1}^{}\phantom{\rule{0.25em}{0ex}}\sin\phantom{\rule{0.25em}{0ex}}{\theta }_{1}}{ {v\prime }_{1}^{}\phantom{\rule{0.25em}{0ex}}\cos\phantom{\rule{0.25em}{0ex}}{\theta }_{1}-{v}_{1}}. $$ 
</div>
