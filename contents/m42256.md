...
In a given medium under fixed conditions,  $${v}_{\text{w}} $$
 ...
 and  $$\lambda  $$ ; the higher the frequency, the smaller the wavelength. See [\[link\]](#import-auto-id1593942) and consider the following example.
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
Suppose a bat uses sound echoes to locate its insect prey, 3.00 m away. (See [[link]](#import-auto-id1578485).) (a) Calculate the echo times for temperatures of  $$5.00 \text{ºC} $$
 and  $$35.0 \text{ºC} $$ .
