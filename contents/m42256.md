...
<table id="import-auto-id3177545" summary="Two-column table listing various media for sound in the first column and their speeds of sound in the second column. The list of media is divided into three groups: gases, liquids, and solids."><caption><span data-type="title">Speed of Sound in Various Media</span></caption><thead><tr>
            ...
            <td colspan="2"><strong><em>Gases at  $$\text{0ºC} $$</em></strong></td>
             </tr><tr>
            <td>Air</td>
            <td>331</td>
          </tr><tr>
            ...
            <td colspan="2"><strong><em>Liquids at  $$\text{20ºC} $$</em></strong></td>
             </tr><tr>
            <td>Ethanol</td>
            <td>1160</td>
          </tr><tr>
...
<div data-type="equation" id="eip-330">
 $${v}_{\text{w}}=\left(\text{331} \text{m/s}\right)\sqrt{\frac{T}{\text{273} \text{K}}}, $$
</div>
...
<div data-type="equation" id="eip-97">
 $${v}_{\text{rms}}=\sqrt{\frac{\text{3}\mathrm{kT}}{m}}, $$
</div>

where  $$k $$
 is the Boltzmann constant ( $$1.38×{\text{10}}^{\text{−23}} \text{J/K} $$
) and  $$m $$
 is the mass of each (identical) particle in the gas. So, it is reasonable that the speed of sound in air and other gases should depend on the square root of temperature. While not negligible, this is not a strong dependence. At  $$\text{0ºC} $$
, the speed of sound is 331 m/s, whereas at  $$\text{20.0ºC} $$
...
Calculate the wavelengths of sounds at the extremes of the audible range, 20 and 20,000 Hz, in  $$\text{30.0ºC} $$
...
2.  {: #import-auto-id1815176} Convert the temperature into kelvin and then enter the temperature into the equation
    <div data-type="equation" id="eip-575">
     $${v}_{\text{w}}=\left(\text{331} \text{m/s}\right)\sqrt{\frac{\text{303 K}}{\text{273} \text{K}}}=\text{348}\text{.}7 \text{m/s}. $$
    </div>

3.  {: #import-auto-id2682073} Solve the relationship between speed and wavelength for * $$\lambda  $$
...
4.  {: #import-auto-id963388} Enter the speed and the minimum frequency to give the maximum wavelength:
    <div data-type="equation" id="eip-618">
     $${\lambda }_{\text{max}}=\frac{\text{348}\text{.}7 \text{m/s}}{\text{20 Hz}}=\text{17} \text{m}. $$
    </div>
...
5.  {: #import-auto-id1816494} Enter the speed and the maximum frequency to give the minimum wavelength:
    <div data-type="equation" id="eip-862">
     $${\lambda }_{\text{min}}=\frac{\text{348}\text{.}7 \text{m/s}}{\text{20}\text{,}\text{000 Hz}}=0\text{.}\text{017} \text{m}=1\text{.}\text{7 cm}. $$
    </div>
{: type="1"}
...
* equals a constant, the smaller  $$f $$
 is, the larger * $$\lambda  $$
...
The speed of sound can change when sound travels from one medium to another. However, the frequency usually remains the same because it is like a driven oscillation and has the frequency of the original source. If  $${v}_{\text{w}} $$
 ...
 must change. That is, because  $${v}_{\text{w}}=\mathrm{f\lambda } $$
...
In air, the speed of sound is related to air temperature * $$T $$
* by
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Show that the speed of sound in  $$\text{20.0ºC} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Air temperature in the Sahara Desert can reach  $$\text{56.0ºC} $$
 (about  $$\text{134ºF} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A physicist at a fireworks display times the lag between seeing an explosion and hearing its sound, and finds it to be 0.400 s. (a) How far away is the explosion if air temperature is  $$\text{24.0ºC} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Suppose a bat uses sound echoes to locate its insect prey, 3.00 m away. (See [[link]](#import-auto-id1578485).) (a) Calculate the echo times for temperatures of  $$\text{5.00ºC} $$
 and  $$\text{35.0ºC} $$
