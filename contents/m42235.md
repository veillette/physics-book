...
The hot and cold reservoir temperatures are given as  $$\text{300}\text{º}\text{C} $$
 and  $$ 27.0\text{º}\text{C} $$
, respectively. In kelvins, then,  $${T}_{\text{h}}=573 \text{K} $$
 and  $${T}_{\text{c}}=300 \text{K} $$
...
<div data-type="problem" markdown="1">
A certain gasoline engine has an efficiency of 30.0%. What would the hot reservoir temperature be for a Carnot engine having that efficiency, if it operates with a cold reservoir temperature of  $$200\text{º}\text{C} $$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the hot reservoir temperature of a Carnot engine that has an efficiency of 42.0% and a cold reservoir temperature of  $$ 27.0\text{º}\text{C} $$
? (b) What must the hot reservoir temperature be for a real heat engine that achieves 0.700 of the maximum efficiency, but still has an efficiency of 42.0% (and a cold reservoir at  $$ 27.0\text{º}\text{C} $$
...
(a)  $${\mathit{\text{Eff}}}_{\text{1}}=1-\frac{ {T}_{\text{c,1}}}{ {T}_{\text{h,1}}}=1-\frac{543 \text{K}}{723 \text{K}}= 0.249 \text{or}  24.9%  $$
(b)  $${\mathit{\text{Eff}}}_{2}=1-\frac{423 \text{K}}{543 \text{K}}= 0.221 \text{or}  22.1%  $$
(c)  $$\begin{array}{l}{\mathit{\text{Eff}}}_{1}=1-\frac{ {T}_{\text{c,1}}}{ {T}_{\text{h,1}}}⇒{T}_{\text{c,1}}={T}_{\text{h,1}}\left(1,-,{\mathit{\text{eff}}}_{1}\right)\end{array} $$
  ...
  $$\begin{array}{l}{T}_{\text{c,2}}={T}_{\text{h,1}}\left(1-{\mathit{\text{Eff}}}_{1}\right)\left(1-{\mathit{\text{Eff}}}_{2}\right)\equiv {T}_{\text{h,1}}\left(1-{\mathrm{Eff}}_{\text{overall}}\right)\\ \therefore \left(1-{\mathrm{Eff}}_{\text{overall}}\right)=\left(1-{\mathit{\text{Eff}}}_{1}\right)\left(1-{\mathit{\text{Eff}}}_{2}\right)\\ {\mathrm{Eff}}_{\text{overall}}=1-\left(1 -0.249\right)\left(1 -0.221\right)= 41.5% \end{array} $$
...
, so the efficiency is  $$\mathit{Eff}=1-\frac{ {Q}_{\text{c}}}{ {Q}_{\text{h}}}=1-\frac{13 \text{kJ}}{25 \text{kJ}}= 0.48 $$
. The Carnot efficiency is  $${\mathit{\text{Eff}}}_{\text{C}}=1-\frac{ {T}_{\text{c}}}{ {T}_{\text{h}}}=1-\frac{300 \text{K}}{600 \text{K}}= 0.50 $$
