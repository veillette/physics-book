...
where  $$\tau  $$
 ...
 the final value is very nearly achieved, as the graph in [[Figure 1]](#Figure1)(b) illustrates.
...
(See [[Figure 1]](#Figure1)(c).) In the first period of time  $$\tau =L/R $$
 ...
 the current becomes very close to zero, as seen in the graph in [[Figure 1]](#Figure1)(c).
