...
where  $$\tau  $$
 has units of seconds, since  $$\text{1} \text{H}=\text{1} \text{Ω}\text{·}\text{s} $$
. In the first period of time  $$\tau  $$
, the current rises from zero to  $$ 0.632{I}_{0} $$
, since  $$I={I}_{0}\left(1-{e}^{-1}\right)={I}_{0}\left(1 -0.368\right)= 0.632{I}_{0} $$
...
(See [\[link\]](#import-auto-id1169737969272)(c).) In the first period of time  $$\tau =L/R $$
 after the switch is closed, the current falls to 0.368 of its initial value, since  $$I={I}_{0}{e}^{-1}= 0.368{I}_{0} $$
...
<div data-type="equation" id="eip-316">
 $$\begin{array}{lll}I& =&  0.368{I}_{0}=\left( 0.368\right)\left(\text{10.0 A}\right)\\ & =& 3.68 \text{A at }t= 2.50\text{ ms.}\end{array} $$
</div>
...
<div data-type="equation" id="eip-822">
 $$\begin{array}{lll}I\prime & =&  0.368I=\left( 0.368\right)\left(\text{3.68 A}\right)\\ & =&  1.35\text{ A at }t= 5.00\text{ ms.}\end{array} $$
</div>
**Discussion for (b)**
