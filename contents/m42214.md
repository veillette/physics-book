...
The relationships between the three common temperature scales is shown in [[Figure 4]](#Figure4). Temperatures on these scales can be converted using the equations in [\[link\]](#Table1).
