...
<div data-type="solution" markdown="1">
(a)  $$ 22.2\text{ºC} $$
(b)  $$\begin{array}{lll}\text{Δ}T\left(\text{º}\text{F}\right)& =& {T}_{2}\left(\text{º}\text{F}\right)-{T}_{1}\left(\text{º}\text{F}\right)\\ & =& \frac{9}{5}{T}_{2}\left(\text{ºC}\right)+ 32.0\text{º}-\left(\frac{9}{5}{T}_{1}\left(\text{ºC}\right)+ 32.0\text{º}\right)\\ & =& \frac{9}{5}\left({T}_{2}\left(\text{ºC}\right)-{T}_{1}\left(\text{ºC}\right)\right) =\frac{9}{5}\text{Δ}T\left(\text{ºC}\right)\end{array} $$
</div>
</div>
