...
The **Celsius**{: data-type="term" #import-auto-id1821755} scale (which replaced the slightly different <em> <em>centigrade</em></em> scale) has the freezing point of water at  $$0\text{º}\text{C} $$
 and the boiling point at  $$\text{100}\text{º}\text{C} $$
. Its unit is the **degree Celsius**{: data-type="term" #import-auto-id1782946} $$\left(\text{º}\text{C}\right) $$
. On the **Fahrenheit**{: data-type="term" #import-auto-id1565340} scale (still the most frequently used in the United States), the freezing point of water is at  $$\text{32}\text{º}\text{F} $$
 and the boiling point is at  $$\text{212}\text{º}\text{F} $$
. The unit of temperature on this scale is the **degree Fahrenheit**{: data-type="term" #import-auto-id1349314} $$\left(\text{º}\text{F}\right) $$
...
<table id="import-auto-id1782978" summary="This table, with three columns, shows the equations to use when converting temperature values between the Celsius, Fahrenheit, and Kelvin scales. Each cell in the left column gives a pair of temperature scales, and the other two columns give the equation to be used for a temperature conversion between those scales. On any given row in the second and third columns, the same equation is written, but using different symbols for the temperature."><caption><span data-type="title">Temperature Conversions</span></caption><thead>
          ...
          <tr>
            ...
            <td>
               $$T\left(\text{º}\text{F}\right)=\frac{9}{5}T\left(\text{º}\text{C}\right)+\text{32} $$
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
               $$T\left(\text{K}\right)=T\left(\text{º}\text{C}\right)+\text{273}\text{.}\text{15} $$
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
               $$T\left(\text{º}\text{C}\right)=T\left(\text{K}\right)-\text{273}\text{.}\text{15} $$
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
               $$T\left(\text{K}\right)=\frac{5}{9}\left(T\left(\text{º}\text{F}\right)-\text{32}\right)+\text{273}\text{.}\text{15} $$
            </td>
            <td>
               $${T}_{\text{K}}=\frac{5}{9}\left({T}_{\text{º}\text{F}}-\text{32}\right)+\text{273}\text{.}\text{15} $$
            </td>
          </tr>
          <tr>
            <td>Kelvin to Fahrenheit</td>
            <td>
               $$T\left(\text{º}\text{F}\right)=\frac{9}{5}\left(T\left(\text{K}\right)-\text{273}\text{.}\text{15}\right)+\text{32} $$
            </td>
            <td>
               $${T}_{\text{º}\text{F}}=\frac{9}{5}\left({T}_{\text{K}}-\text{273}\text{.}\text{15}\right)+\text{32} $$
            </td>
          </tr>
        </tbody></table>
...
<div data-type="equation" id="eip-912">
 $${T}_{\text{K}}=\text{25}\text{º}\text{C}+\text{273}\text{.}\text{15}=\text{298} \text{K}\text{.} $$
</div>
</div>
...
<div data-type="equation" id="eip-393">
 $${T}_{\text{º}\text{R}}=\frac{0\text{.}8\text{º}\text{R}}{\text{º}\text{C}} × {T}_{\text{º}\text{C}}\text{.} $$
</div>
2\. Plug the known value into the equation and solve:

<div data-type="equation" id="eip-73">
 $${T}_{\text{º}\text{R}}=\frac{0\text{.}8\text{º}\text{R}}{\text{º}\text{C}} × \text{25}\text{º}\text{C}=\text{20}\text{º}\text{R}\text{.} $$
</div>
</div>
...
). The average normal body temperature is usually given as  $$\text{37}\text{.}0\text{º}\text{C} $$
 ( $$\text{98}\text{.}6\text{º}\text{F} $$
...
The lowest temperatures ever recorded have been measured during laboratory experiments:  $$4\text{.}5×{\text{10}}^{–\text{10}} \text{K} $$
 at the Massachusetts Institute of Technology (USA), and  $$1\text{.}0×{\text{10}}^{–\text{10}} \text{K} $$
...
What is absolute zero? Absolute zero is the temperature at which all molecular motion has ceased. The concept of absolute zero arises from the behavior of gases. [\[link\]](#import-auto-id1961524) shows how the pressure of gases at a constant volume decreases as temperature decreases. Various scientists have noted that the pressures of gases extrapolate to zero at the same temperature,  $$–\text{273}\text{.}\text{15}\text{º}\text{C} $$
. This extrapolation implies that there is a lowest temperature. This temperature is called *absolute zero*. Today we know that most gases first liquefy and then freeze, and it is not actually possible to reach absolute zero. The numerical value of absolute zero temperature is  $$–\text{273}\text{.}\text{15}\text{º}\text{C} $$
 or 0 K.
...
<div data-type="problem" markdown="1">
What is the Fahrenheit temperature of a person with a  $$\text{39}\text{.}0\text{º}\text{C} $$
 fever?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Frost damage to most plants occurs at temperatures of  $$\text{28}\text{.}0\text{º}\text{F} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
To conserve energy, room temperatures are kept at  $$\text{68}\text{.}0\text{º}\text{F} $$
 in the winter and  $$\text{78}\text{.}0\text{º}\text{F} $$
 in the summer. What are these temperatures on the Celsius scale?

</div>
<div data-type="solution" markdown="1">
 $$\text{20}\text{.}0\text{º}\text{C} $$
 and  $$\text{25}\text{.}6\text{º}\text{C} $$
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) Suppose a cold front blows into your locale and drops the temperature by 40.0 Fahrenheit degrees. How many degrees Celsius does the temperature decrease when there is a  $$\text{40}\text{.}0\text{º}\text{F} $$
