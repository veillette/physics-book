...
<div data-type="equation" id="eip-611">
 $$ \frac{2\text{mu}}{2\text{mu}\text{cos 30º}}=\frac{2}{\sqrt{3}}=1.155. $$ 
</div>
**Discussion**
...
momentum between times $$ t_{1} $$
and $$ t_{2} $$. That area is equal to the area inside the rectangle bounded by $$  F_
{\text{eff}} $$, $$ t_{1} $$, and $$ t_{2} $$. Thus the impulses and their effects are the same for both the actual and
effective forces.
...
spacecraft window at a relative speed of $$ 4.00\times 10^{3}\text{m/s} $$, given the collision lasts $$ 6.00\times 10^{–8} \text{s} $$.
...
<div data-type="solution" markdown="1">
(a)  $$ 1.50\times 10^{6} \text{N} $$ 

away from the dashboard

(b)  $$ 1.00\times 10^{5} \text{N} $$
away from the dashboard
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A cruise ship with a mass of  $$ 1.00\times 10^{7}\text{kg} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Calculate the final speed of a 110-kg rugby player who is initially running at 8.00 m/s but collides head-on with a padded goalpost and experiences a backward force of  $$ 1.76\times 10^{4}\text{N} $$ 

for $$ 5.50\times 10^{–2}\text{s}
$$.
