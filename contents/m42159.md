...
<div data-type="equation" id="eip-263">
 $$ {p}_{\text{xi}}=\text{mu}\text{;}{p}_{\text{yi}}=0 $$ 
</div>
<div data-type="equation" id="eip-640">
 $$ {p}_{\text{xf}}=-\text{mu}\text{;}{p}_{\text{yf}}=0 $$ 
</div>
...
<div data-type="equation" id="eip-123">
 $$ {p}_{\text{xi}}=\text{mu}\text{cos 30º}\text{;}{p}_{\text{yi}}=\text{–mu}\text{sin 30º} $$ 
</div>
<div data-type="equation" id="eip-344">
 $$ {p}_{\text{xf}}=–\text{mu}\text{cos 30º}\text{;}{p}_{\text{yf}}=-\text{mu}\text{sin 30º} $$ 
</div>
...
<div data-type="equation" id="eip-611">
 $$ \frac{2\text{mu}}{2\text{mu}\text{cos 30º}}=\frac{2}{\sqrt{3}}=1\text{.}\text{155}. $$ 
</div>
**Discussion**
...
4\text{.}\text{00}×{\text{10}}^{3}\text{m/s} $$, given the collision lasts $$
6\text{.}\text{00}×{\text{10}}^{–8}s $$.
...
<div data-type="solution" markdown="1">
(a)  $$ 1\text{.}\text{50}×{\text{10}}^{6}N $$ 

away from the dashboard

(b)  $$ 1\text{.}\text{00}×{\text{10}}^{5}N $$
away from the dashboard
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A cruise ship with a mass of  $$ 1\text{.}\text{00}×{\text{10}}^{7}\text{kg} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Calculate the final speed of a 110-kg rugby player who is initially running at 8.00 m/s but collides head-on with a padded goalpost and experiences a backward force of  $$ 1\text{.}\text{76}×{\text{10}}^{4}\text{N} $$ 

for $$
5\text{.}\text{50}×{\text{10}}^{\text{–2}}\text{s}
$$.
