...
multiplied by the time this force acts. The quantity $$ {\mathbf{F}}_{\text{net}}\Delta t $$
...
The quantity  $$ {\mathbf{F}}_{\text{net}}\Delta t $$ is given the name impulse.
...
Two identical billiard balls strike a rigid wall with the same speed, and are reflected without any change of speed. The first ball strikes perpendicular to the wall. The second ball strikes the wall at an angle of  $$ 30^\circ $$ from the perpendicular, and bounces off at an angle of $$ 30^\circ $$
...
<div data-type="equation" id="eip-123">
 $$ p_{\text{xi}}=\text{mu} \cos{30^\circ} \text{;}
p_{\text{yi}}=\text{–mu}\sin{30^\circ } $$ 
</div>
<div data-type="equation" id="eip-344">
 $$ p_{\text{xf}}=–\text{mu}\cos{30^\circ }\text{;}
p_{\text{yf}}=-\text{mu}\sin{30^\circ } $$ 
</div>
It should be noted here that while  $$ p_{x} $$ changes sign after the collision, $$ p_{y} $$
does not. Therefore the $$ x $$
-component of impulse is equal to $$ -2\text{mu}\cos{30^\circ } $$
and the $$ y $$
-component of impulse is equal to zero.
...
<div data-type="equation" id="eip-611">
 $$ \frac{2\text{mu}}{2\text{mu}\cos{30^\circ }}=\frac{2}{\sqrt{3}}=1.155. $$ 
</div>
**Discussion**
...
and $$ t_{2} $$. That area is equal to the area inside the rectangle bounded by $$ F_{\text{eff}} $$, $$ t_{1} $$, and $$ t_{2} $$. Thus the impulses and their effects are the same for both the actual and
effective forces.
...
<div data-type="equation" id="eip-id4088327">
 $$ \begin{array}{}\mathbf{p}=m\mathbf{v}⇒{p}^{2}={m}^{2}{v}^{2}⇒
\frac{ p^{2}}{m}=mv^{2}\\ ⇒\frac{ p^{2}}{2m}=\frac{1}{2}m v^{2}=\text{KE}\\ 
\text{KE}=\frac{ p^{2}}{2m}\end{array} $$ 
</div>
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A punter drops a ball from rest vertically 1 meter down onto his foot. The ball leaves the foot with a speed of 18 m/s at an angle  $$ 55^\circ $$ 
