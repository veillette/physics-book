...
. *Forces are usually not constant*. Forces vary considerably even during the
...
. That area is equal to the area inside the rectangle bounded by \\( {F}_
{\text{eff}} \\)
...
. Thus the impulses and their effects are the same for both the actual and
effective forces.
...
4\text{.}\text{00}×{\text{10}}^{3}\phantom{\rule{0.25em}{0ex}}\text{m/s} \\)
