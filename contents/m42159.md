...
<div data-type="equation" id="eip-263">
 $$ p_{\text{xi}}=\text{mu}\text{;}p_{\text{yi}}=0 $$ 
</div>
<div data-type="equation" id="eip-640">
 $$ p_{\text{xf}}=-\text{mu}\text{;}p_{\text{yf}}=0 $$ 
</div>
...
<div data-type="equation" id="eip-123">
 $$ p_{\text{xi}}=\text{mu}\text{cos 30º}\text{;}p_{\text{yi}}=\text{–mu}\text{sin 30º} $$ 
</div>
<div data-type="equation" id="eip-344">
 $$ p_{\text{xf}}=–\text{mu}\text{cos 30º}\text{;}p_{\text{yf}}=-\text{mu}\text{sin 30º} $$ 
</div>
It should be noted here that while  $$ p_{x} $$ 

changes sign after the collision, $$ p_{y} $$
