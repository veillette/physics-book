...
and $$ m $$ the mass of each ball. Choose the * $$ x $$
*-axis and * $$ y $$
...
-component of impulse is equal to $$ -2\text{mu} $$ and the $$ y $$ -component
...
to each ball is normal to the wall along the positive * $$ x $$
...
b)  $$ 1.20 \text{m/s} $$ away from the wall
...
spacecraft window at a relative speed of $$ 4.00\times 10^{3}\text{m/s} $$,
given the collision lasts $$ 6.00\times 10^{–8} \text{s} $$.
...
(b)  $$ 1.00\times 10^{5} \text{N} $$ away from the dashboard
