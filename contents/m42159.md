...
<div data-type="solution" markdown="1">
a)  $$ 2.40\times 10^{3}\text{N} $$ toward the leg
...
<div data-type="solution" markdown="1">
a)  $$ 800 \text{kg}\cdot \text{m/s} $$ away from the wall
...
<div data-type="solution" markdown="1">
(a)  $$ 1.50\times 10^{6} \text{N} $$ away from the dashboard
...
<div data-type="solution" id="eip-id2108527" markdown="1">
 $$ 2.10\times 10^{3} \text{N} $$ away from the wall
