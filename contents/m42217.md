...
(a) What is the average kinetic energy of a gas molecule at  $$ 20.0\text{º}\text{C} $$
...
<div data-type="equation" id="import-auto-id1168465431659">
 $$\overline{\text{KE}}=\frac{3}{2}\text{kT}=\frac{3}{2}\left( 1.38 \times 10^{-23}  \text{J/K}\right)\left(293 \text{K}\right)= 6.07 \times 10^{-21}  \text{J}\text{.} $$
</div>
**Strategy for (b)**
...
<div data-type="equation" id="import-auto-id3108905">
 $${v}_{\text{rms}}=\sqrt{\frac{3\text{kT}}{m}}=\sqrt{\frac{3\left( 1.38 \times 10^{-23} \text{J/K}\right)\left(293 \text{K}\right)}{ 4.65 \times 10^{-26} \text{kg}}}=511 \text{m/s}\text{.} $$
</div>
**Discussion**
