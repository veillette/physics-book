...
This temperature is much higher than atmospheric temperature, which is approximately 250 K  $$\left(–25\text{º}\text{C} $$
 or  $$–10\text{º}\text{F}\right) $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) What is the average kinetic energy in joules of hydrogen atoms on the  $$5500\text{º}\text{C} $$
...
There are two important isotopes of uranium—  $${}^{235}\text{U} $$
 and  $${}^{238}\text{U} $$
; these isotopes are nearly identical chemically but have different atomic masses. Only  $${}^{235}\text{U} $$
