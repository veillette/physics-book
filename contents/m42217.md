...
Equating the right-hand side of this equation with the right-hand side of  $$PV=\frac{1}{3}N m\overline{ {v}^{2}} $$
 gives
...
The average translational kinetic energy of a molecule,  $$\overline{\text{KE}} $$ ,
 is called **thermal energy** . The equation  $$\overline{\text{KE}}=\frac{1}{2}m\overline{ {v}^{2}}=\frac{3}{2}k_{B}T $$
...
It is sometimes useful to rearrange  $$\overline{\text{KE}}=\frac{1}{2}m\overline{ {v}^{2}}=\frac{3}{2}k_{B}T $$
...
The motion of molecules in a gas is random in magnitude and direction for individual molecules, but a gas of many molecules has a predictable distribution of molecular speeds. This distribution is called the *Maxwell-Boltzmann distribution*, after its originators, who calculated it based on kinetic theory, and has since been confirmed experimentally. (See [[Figure 4]](#Figure4).) The distribution has a long tail, because a few molecules may go several times the rms speed. The most probable speed  $${v}_{\text{p}} $$
 is less than the rms speed  $${v}_{\text{rms}} $$ .
 [[Figure 5]](#Figure5) shows that the curve is shifted to higher speeds at higher temperatures, with a broader range of speeds.
...
2. Identify the unknowns: We need to solve for temperature,  $$T $$ .
 We also need to solve for the mass  $$m $$  of the helium atom.
