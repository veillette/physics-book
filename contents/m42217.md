...
<div data-type="equation" id="import-auto-id1168465431659">
 $$\overline{\text{KE}}=\frac{3}{2}\text{kT}=\frac{3}{2}\left( 1.38 \times 10^{-23}  \text{J/K}\right)\left(\text{293} \text{K}\right)= 6.07 \times 10^{-21}  \text{J}\text{.} $$
</div>
**Strategy for (b)**
...
<div data-type="equation" id="import-auto-id1168465431776">
 $$m=\frac{2\left(\text{14}\text{.}\text{0067}\right)×{\text{10}}^{-3} \text{kg/mol}}{ 6.02 \times 10^{23}  {\text{mol}}^{-1}}= 4.65 \times 10^{-26}  \text{kg}\text{.} $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="import-auto-id3423579">
 $$T=\frac{\left( 6.65 \times 10^{-27}  \text{kg}\right){\left(\text{11}\text{.}1×{\text{10}}^{3} \text{m/s}\right)}^{2}}{3\left( 1.38 \times 10^{-23}  \text{J/K}\right)}= 1.98 \times 10^{4}  \text{K} $$
</div>
**Discussion**
