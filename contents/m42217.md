...
<div data-type="equation" id="import-auto-id1168465439144">
 $$m=\frac{\text{molar mass}}{\text{number of atoms per mole}}=\frac{ 4.0026 \times 10^{-3}  \text{kg/mol}}{6\text{.}\text{02}×{\text{10}}^{\text{23}} \text{mol}}=6\text{.}\text{65}×{\text{10}}^{-\text{27}} \text{kg} $$
</div>
<div data-type="equation" id="import-auto-id3423579">
 $$T=\frac{\left(6\text{.}\text{65}×{\text{10}}^{-\text{27}} \text{kg}\right){\left(\text{11}\text{.}1×{\text{10}}^{3} \text{m/s}\right)}^{2}}{3\left(1\text{.}\text{38}×{\text{10}}^{-\text{23}} \text{J/K}\right)}= 1.98 \times 10^{4}  \text{K} $$
</div>
**Discussion**
