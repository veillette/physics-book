...
, then the transmitted part of the wave has an amplitude $$E \text{cos} \theta $$
...
. Using this information, the equation $$I={I}_{0} {\text{cos}}^{2} \theta $$
 can be used to solve for the needed angle.

**Solution**

Solving the equation $$I={I}_{0} {\text{cos}}^{2} \theta $$
 for $$\text{cos} \theta $$
...
$$\text{cos} \theta =\sqrt{\frac{I}{ {I}_{0}}}=\sqrt{\frac{0\text{.}\text{100}{I}_{0}}{ {I}_{0}}}=0\text{.}\text{3162.}$$
</div>
Solving for $$\theta $$
 yields

<div data-type="equation" id="eip-344">
$$\theta ={\text{cos}}^{-1 }0\text{.}\text{3162}=\text{71}\text{.}6º.$$
</div>
**Discussion**
...
$$\text{tan} {\theta }_{\text{b}}=\frac{ {n}_{2}}{ {n}_{1}}\text{,}$$
</div>
...
. The equation $$\text{tan} {\theta }_{\text{b}}=\frac{ {n}_{2}}{ {n}_{1}}$$
...
$$\text{tan} {\theta }_{\text{b}}=\frac{ {n}_{2}}{ {n}_{1}}$$
</div>
gives

<div data-type="equation" id="eip-435">
$$\text{tan} {\theta }_{\text{b}}=\frac{ {n}_{2}}{ {n}_{1}}=\frac{1.333}{1.00}=1\text{.}\text{333.}$$
</div>
Solving for the angle $${\theta }_{\text{b}}$$
 yields

<div data-type="equation" id="eip-998">
$${\theta }_{\text{b}}={\text{tan}}^{-1} 1\text{.}\text{333}=\text{53}\text{.}1º.$$
</div>
**Solution for (b)**
...
$${\text{tan} \theta \prime }_{\text{b}}=\frac{ {n\prime }_{2}}{ {n}_{1}}=\frac{1.520}{1.00}=1\text{.}\text{52.}$$
</div>
Thus,

<div data-type="equation" id="eip-938">
$${\theta \prime }_{\text{b}}={\text{tan}}^{-1 }1\text{.}\text{52}=\text{56.7º.}$$
</div>
**Discussion**
...
<div data-type="solution" markdown="1">
$$\text{45}\text{.}7 {\text{mW/m}}^{2}$$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What angle would the axis of a polarizing filter need to make with the direction of polarized light of intensity $$1\text{.}\text{00} {\text{kW/m}}^{2}$$
 to reduce the intensity to $$10\text{.}0 {\text{W/m}}^{2}$$
?
...
Prove that, if $$I$$
 ...
 the original intensity. (Hint: Use the trigonometric identities $$\text{cos} \left(90.0º-\theta \right)=\text{sin} \theta $$
 and $${\text{cos}}^{2} \theta +{\text{sin}}^{2} \theta =1.$$
)
...
(a) On a day when the intensity of sunlight is $$1\text{.}\text{00} \text{kW}/{\text{m}}^{2}$$
