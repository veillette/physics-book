...
<div data-type="equation" id="eip-61">
 $$\cos \theta =\sqrt{\frac{I}{ {I}_{0}}}=\sqrt{\frac{ 0.100{I}_{0}}{ {I}_{0}}}=0\text{.}\text{3162.} $$
</div>
Solving for  $$\theta  $$
 yields
...
<div data-type="equation" id="eip-435">
 $$\tan {\theta }_{\text{b}}=\frac{ {n}_{2}}{ {n}_{1}}=\frac{1.333}{1.00}=1\text{.}\text{333.} $$
</div>
...
<div data-type="equation" id="eip-897">
 $${\tan \theta \prime }_{\text{b}}=\frac{ {n\prime }_{2}}{ {n}_{1}}=\frac{1.520}{1.00}=1\text{.}\text{52.} $$
</div>
Thus,

<div data-type="equation" id="eip-938">
 $${\theta \prime }_{\text{b}}={\tan}^{-1 } 1.52=\text{56.7º.} $$
</div>
**Discussion**
