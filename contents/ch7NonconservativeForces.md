...
nonconservative force. As illustrated in [Figure](#fig1),
work done against
...
energy. [Figure](#fig2) compares the effects of conservative
and nonconservative forces. We often choose to understand simpler systems such
as that described in [Figure](#fig2)(a) first before studying
more complicated systems as in [Figure](#fig2)(b).
...
Consider [Figure](#fig3), in which a person pushes a crate up
...
forces. In [Figure](#fig3), this is the work done by the
...
ramp in [Figure](#fig3). If $$ W_{\text{nc}} $$ is negative,
then mechanical energy is decreased, such as when the rock hits the ground
in [Figure](#fig2)(b). If $$ W_{\text{nc}} $$ is zero, then
...
Consider the situation shown in [Figure](#fig4), where a baseball player slides to a stop on level ground. Using energy considerations, calculate the distance the 65.0-kg baseball player slides, given that his initial speed is 6.00 m/s and the force of friction against him is a constant 450 N.
...
A 60.0-kg skier with an initial speed of 12.0 m/s coasts up a 2.50-m-high rise as shown in [Figure](#fig6). Find her final speed at the top, given that the coefficient of friction between her skis and the snow is 0.0800. (Hint: Find the distance traveled up the incline assuming a straight-line path as shown in the figure.)
