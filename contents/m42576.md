...
<div data-type="equation" id="eip-948">
 $$\begin{array}{lll}\text{KE}& =& \frac{1}{2}{\text{mv}}^{2}\\ & =& \frac{1}{2}\left(9.11 \times 10^{-31} \text{kg}\right)\left( 4.36 \times 10^{6}  \text{m/s}{\right)}^{2}\\ & =& \text{(86.4} \times 10^{-18} \text{J)}\left(\frac{1 \text{eV}}{1.602 \times 10^{-19} \text{J}}\right)\\ & =& 54.0 \text{eV}\end{array} $$
</div>
**Discussion**
...
. Because  $$\text{AB}=\text{BC}=d \sin \theta \text{,} $$
 we have constructive interference when  $$\mathrm{n\lambda }=\text{2}d \sin \mathrm{\theta .} $$
