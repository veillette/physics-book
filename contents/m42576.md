...
<div data-type="equation" id="eip-948">
 $$\begin{array}{lll}\text{KE}& =& \frac{1}{2}{\text{mv}}^{2}\\ & =& \frac{1}{2}\left(9.11 \times 10^{-31} \text{kg}\right)\left( 4.36 \times 10^{6}  \text{m/s}{\right)}^{2}\\ & =& \text{(86.4} \times 10^{-18} \text{J)}\left(\frac{1 \text{eV}}{1.602 \times 10^{-19} \text{J}}\right)\\ & =& \text{54.0 eV}\end{array} $$
</div>
**Discussion**
