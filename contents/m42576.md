...
<div data-type="equation" id="eip-177">
 $$v=\frac{6\text{.}\text{63}×{\text{10}}^{\text{–34}} \text{J}\cdot \text{s}}{\left(\text{9.11}×{\text{10}}^{\text{–31}} \text{kg}\right)\left(0\text{.}\text{167}×{\text{10}}^{\text{–9}} \text{m}\right)}=4.36 \times 10^{6}  \text{m/s}. $$
</div>
**Solution for (b)**
...
<div data-type="equation" id="eip-948">
 $$\begin{array}{lll}\text{KE}& =& \frac{1}{2}{\text{mv}}^{2}\\ & =& \frac{1}{2}\left(9.11×{\text{10}}^{\text{–31}} \text{kg}\right)\left( 4.36 \times 10^{6}  \text{m/s}{\right)}^{2}\\ & =& \text{(86.4}×{\text{10}}^{\text{–18}} \text{J)}\left(\frac{\text{1 eV}}{1.602×{\text{10}}^{\text{–19}} \text{J}}\right)\\ & =& \text{54.0 eV}\end{array} $$
</div>
**Discussion**
