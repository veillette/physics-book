...
Energy stored in a capacitor is electrical potential energy, and it is thus related to the charge **$$Q$$
** and voltage $$V$$
 on the capacitor. We must be careful when applying the equation for electrical potential energy $$\text{Δ}\text{PE}=q\text{Δ}V\phantom{\rule{0.25em}{0ex}}$$
 to a capacitor. Remember that $$\text{Δ}\text{PE}$$
 is the potential energy of a charge *$$q$$
* going through a voltage $$\text{Δ}V$$
. But the capacitor starts with zero voltage and gradually comes up to its full voltage as it is charged. The first charge placed on a capacitor experiences a change in voltage $$\text{Δ}V=0$$
, since the capacitor has zero voltage when uncharged. The final charge placed on a capacitor experiences $$\text{Δ}V=V$$
...
, and so the average voltage experienced by the full charge *$$q$$
* is $$V/2$$
. Thus the energy stored in a capacitor, $${E}_{\text{cap}}$$
, is
...
where **$$Q$$
** is the charge on a capacitor with a voltage $$V$$
 applied. (Note that the energy is not $$\text{QV}$$
, but $$\text{QV}/2$$
.) Charge and voltage are related to the capacitance $$C$$
 of a capacitor by $$Q=\text{CV}$$
...
A heart defibrillator delivers $$4.00×{\text{10}}^{\text{2}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
 of energy by discharging a capacitor initially at $$1.00×{\text{10}}^{\text{4}}\phantom{\rule{0.25em}{0ex}}\text{V}$$
...
$${E}_{\text{cap}}=\frac{ {\text{CV}}^{2}}{2}.$$
</div>
**Solution**

Solving this expression for $$C$$
 and entering the given values yields

<div data-type="equation" id="eip-448">
$$\begin{array}{lll}C& =& \frac{2{E}_{\text{cap}}}{ {V}^{2}}=\frac{2\left(4\text{.}\text{00}×{\text{10}}^{2}\phantom{\rule{0.25em}{0ex}}\text{J}\right)}{\left(1\text{.}\text{00}×{\text{10}}^{4}\phantom{\rule{0.25em}{0ex}}\text{V}{\right)}^{2}}=8\text{.}\text{00}×{\text{10}}^{–6}\phantom{\rule{0.25em}{0ex}}\text{F}\\ & =& \text{8}\text{.}\text{00 µF}\text{.}\end{array}$$
</div>
**Discussion**

This is a fairly large, but manageable, capacitance at $$1.00×{\text{10}}^{\text{4}}\phantom{\rule{0.25em}{0ex}}\text{V}$$
.
...
(a) What is the energy stored in the $$\text{10.0 μF}$$
 capacitor of a heart defibrillator charged to $$9.00×{\text{10}}^{\text{3}}\phantom{\rule{0.25em}{0ex}}\text{V}$$
...
<div data-type="problem" markdown="1">
In open heart surgery, a much smaller amount of energy will defibrillate the heart. (a) What voltage is applied to the $$\text{8.00 μF}$$
...
Suppose you have a 9.00 V battery, a $$\text{2.00 μF}$$
 capacitor, and a $$\text{7.40 μF}$$
...
(a) $$1.42×{\text{10}}^{\text{−5}}\phantom{\rule{0.25em}{0ex}}\text{C}$$
, $$6.38×{\text{10}}^{\text{−5}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
(b) $$8.46×{\text{10}}^{\text{−5}}\phantom{\rule{0.25em}{0ex}}\text{C}$$
, $$3.81×{\text{10}}^{\text{−4}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A nervous physicist worries that the two metal shelves of his wood frame bookcase might obtain a high voltage if charged by static electricity, perhaps produced by friction. (a) What is the capacitance of the empty shelves if they have area $$1.00×{\text{10}}^{\text{2}}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{\text{2}}$$
...
<div data-type="solution" markdown="1">
(a) $$4\text{.}\text{43}×{\text{10}}^{–\text{12}}\phantom{\rule{0.25em}{0ex}}\text{F}$$
(b) $$\text{452}\phantom{\rule{0.25em}{0ex}}\text{V}$$
(c) $$4\text{.}\text{52}×{\text{10}}^{–7}\phantom{\rule{0.25em}{0ex}}\text{J}$$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Show that for a given dielectric material the maximum energy a parallel plate capacitor can store is directly proportional to the volume of dielectric ($$\text{Volume =}\phantom{\rule{0.25em}{0ex}}A·d$$
...
(a) On a particular day, it takes $$9.60×{\text{10}}^{\text{3}}\phantom{\rule{0.25em}{0ex}}\text{J}$$
