...
** and voltage  $$V $$
 on the capacitor. We must be careful when applying the equation for electrical potential energy  $$\text{Δ}\text{PE}=q\text{Δ}V  $$
...
A heart defibrillator delivers  $$4.00×{\text{10}}^{\text{2}} \text{J} $$
 of energy by discharging a capacitor initially at  $$1.00×{\text{10}}^{\text{4}} \text{V} $$
...
<div data-type="equation" id="eip-448">
 $$\begin{array}{lll}C& =& \frac{2{E}_{\text{cap}}}{ {V}^{2}}=\frac{2\left(4\text{.}\text{00}×{\text{10}}^{2} \text{J}\right)}{\left(1\text{.}\text{00}×{\text{10}}^{4} \text{V}{\right)}^{2}}=8\text{.}\text{00}×{\text{10}}^{–6} \text{F}\\ & =& \text{8}\text{.}\text{00 µF}\text{.}\end{array} $$
</div>
**Discussion**

This is a fairly large, but manageable, capacitance at  $$1.00×{\text{10}}^{\text{4}} \text{V} $$
.
...
(a) What is the energy stored in the  $$\text{10.0 μF} $$
 capacitor of a heart defibrillator charged to  $$9.00×{\text{10}}^{\text{3}} \text{V} $$
...
(a)  $$1.42×{\text{10}}^{\text{−5}} \text{C} $$
,  $$6.38×{\text{10}}^{\text{−5}} \text{J} $$
(b)  $$8.46×{\text{10}}^{\text{−5}} \text{C} $$
,  $$3.81×{\text{10}}^{\text{−4}} \text{J} $$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A nervous physicist worries that the two metal shelves of his wood frame bookcase might obtain a high voltage if charged by static electricity, perhaps produced by friction. (a) What is the capacitance of the empty shelves if they have area  $$1.00×{\text{10}}^{\text{2}} {\text{m}}^{\text{2}} $$
...
<div data-type="solution" markdown="1">
(a)  $$4\text{.}\text{43}×{\text{10}}^{–\text{12}} \text{F} $$
(b)  $$\text{452} \text{V} $$
(c)  $$4\text{.}\text{52}×{\text{10}}^{–7} \text{J} $$
</div>
</div>
...
(a) On a particular day, it takes  $$9.60×{\text{10}}^{\text{3}} \text{J} $$
