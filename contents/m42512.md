...
<div data-type="equation" id="eip-127">
 $$d \sin \theta =\mathrm{m\lambda }, \text{for} m=0 \text{,} 1 \text{,} \text{–1,} 2 \text{,} \text{–2,}\dots \text{(constructive),} $$
</div>
...
The spacing  $$d $$
 of the grooves in a CD or DVD can be well determined by using a laser and the equation  $$d \sin \theta =\mathrm{m\lambda }, \text{for} m=0 \text{,} 1 \text{,} \text{–1,} 2 \text{,} \text{–2,}\dots  $$
...
<div data-type="equation" id="eip-777">
 $$d \sin \theta =\mathrm{m\lambda } \text{(for} m=0 \text{,} 1 \text{,} \text{–1,} 2 \text{,} \text{–2,} \dots \right) $$
</div>
