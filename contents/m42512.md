...
<div data-type="equation" id="eip-127">
 $$d \sin \theta =\mathrm{m\lambda }, \text{for} m=\text{0,} \text{1,} \text{–1,} \text{2,} \text{–2,}\dots \text{(constructive),} $$
</div>
...
The spacing  $$d $$
 of the grooves in a CD or DVD can be well determined by using a laser and the equation  $$d \sin \theta =\mathrm{m\lambda }, \text{for} m=\text{0,} \text{1,} \text{–1,} \text{2,} \text{–2,}\dots  $$
...
<div data-type="equation" id="eip-777">
 $$d \sin \theta =\mathrm{m\lambda } \text{(for} m=\text{0,} \text{1,} \text{–1,} \text{2,} \text{–2,} \dots \right) $$
</div>
...
<div data-type="equation" id="eip-455">
 $$\sin {\theta }_{\text{V}}=\frac{ {\mathrm{m\lambda }}_{\text{V}}}{d}\text{,} $$
</div>
where  $$m=1 $$
...
<div data-type="equation" id="eip-218">
 $$\sin {\theta }_{\text{V}}=\frac{ 3.80 \times 10^{-7}  \text{m}}{ 1.00 \times 10^{-6}  \text{m}}=0\text{.}\text{380.} $$
</div>
...
<div data-type="equation" id="eip-738">
 $${\theta }_{\text{R}}={\sin}^{-1}  0.760=\text{49.46º.} $$
</div>
...
<div data-type="equation" id="eip-69">
 $${y}_{\text{V}}=x \tan {\theta }_{\text{V}}=\left(2.00 m\right)\left(\text{tan 22.33º}\right)=0.815 m $$
</div>
and

<div data-type="equation" id="eip-834">
 $${y}_{\text{R}}=x \tan {\theta }_{\text{R}}=\left(\text{2.00 m}\right)\left(\text{tan 49.46º}\right)=\text{2.338 m.} $$
</div>
