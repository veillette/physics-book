...
The distance between slits is  $$d=\left(1 cm\right)/\text{10},\text{000}= 1.00 \times 10^{-4}  \text{cm} $$
...
where  $$m=1 $$
 for first order and  $${\lambda }_{\text{V}}=\text{380} \text{nm}= 3.80 \times 10^{-7}  \text{m} $$
. Substituting these values gives

<div data-type="equation" id="eip-218">
 $$\text{sin} {\theta }_{\text{V}}=\frac{ 3.80 \times 10^{-7}  \text{m}}{ 1.00 \times 10^{-6}  \text{m}}=0\text{.}\text{380.} $$
</div>
...
<div data-type="equation" id="eip-621">
 $$\text{sin} {\theta }_{\text{R}}=\frac{ 7.60 \times 10^{-7}  \text{m}}{ 1.00 \times 10^{-6}  \text{m}}. $$
</div>
