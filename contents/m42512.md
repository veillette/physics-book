...
<div data-type="equation" id="eip-127">
 $$d \text{sin} \theta =\mathrm{m\lambda }, \text{for} m=\text{0,} \text{1,} \text{–1,} \text{2,} \text{–2,}\dots \text{(constructive),} $$
</div>
...
The spacing  $$d $$
 of the grooves in a CD or DVD can be well determined by using a laser and the equation  $$d \text{sin} \theta =\mathrm{m\lambda }, \text{for} m=\text{0,} \text{1,} \text{–1,} \text{2,} \text{–2,}\dots  $$
...
<div data-type="equation" id="eip-777">
 $$d \text{sin} \theta =\mathrm{m\lambda } \text{(for} m=\text{0,} \text{1,} \text{–1,} \text{2,} \text{–2,} \dots \right) $$
</div>
...
The distance between slits is  $$d=\left(1 cm\right)/\text{10},\text{000}=1\text{.}\text{00}×{\text{10}}^{-4} \text{cm} $$
 or  $$1\text{.}\text{00}×{\text{10}}^{-6} \text{m} $$
. Let us call the two angles  $${\theta }_{\text{V}} $$
 for violet (380 nm) and  $${\theta }_{\text{R}} $$
 for red (760 nm). Solving the equation  $$d\text{sin} {\theta }_{\text{V}}=\mathrm{m\lambda } $$
 for  $$\text{sin} {\theta }_{\text{V}} $$
,

<div data-type="equation" id="eip-455">
 $$\text{sin} {\theta }_{\text{V}}=\frac{ {\mathrm{m\lambda }}_{\text{V}}}{d}\text{,} $$
</div>
where  $$m=1 $$
 for first order and  $${\lambda }_{\text{V}}=\text{380} \text{nm}=3\text{.}\text{80}×{\text{10}}^{-7} \text{m} $$
. Substituting these values gives

<div data-type="equation" id="eip-218">
 $$\text{sin} {\theta }_{\text{V}}=\frac{3\text{.}\text{80}×{\text{10}}^{-7} \text{m}}{1\text{.}\text{00}×{\text{10}}^{-6} \text{m}}=0\text{.}\text{380.} $$
</div>
Thus the angle  $${\theta }_{\text{V}} $$
 is

<div data-type="equation" id="eip-478">
 $${\theta }_{\text{V}}={\text{sin}}^{-1} 0\text{.}\text{380}=\text{22}\text{.}33º. $$
</div>
Similarly,

<div data-type="equation" id="eip-621">
 $$\text{sin} {\theta }_{\text{R}}=\frac{7\text{.}\text{60}×{\text{10}}^{-7} \text{m}}{1.00×{\text{10}}^{-6} \text{m}}. $$
</div>
Thus the angle  $${\theta }_{\text{R}} $$
 is

<div data-type="equation" id="eip-738">
 $${\theta }_{\text{R}}={\text{sin}}^{-1} 0\text{.}\text{760}=\text{49.46º.} $$
</div>
...
The distances on the screen are labeled  $${y}_{\text{V}} $$
 and  $${y}_{\text{R}} $$
 in [\[link\]](#import-auto-id1169738107871). Noting that  $$\text{tan} \theta =y/x $$
, we can solve for  $${y}_{\text{V}} $$
 and  $${y}_{\text{R}} $$
. That is,

<div data-type="equation" id="eip-69">
 $${y}_{\text{V}}=x \text{tan} {\theta }_{\text{V}}=\left(2.00 m\right)\left(\text{tan 22.33º}\right)=0.815 m $$
</div>
and

<div data-type="equation" id="eip-834">
 $${y}_{\text{R}}=x \text{tan} {\theta }_{\text{R}}=\left(\text{2.00 m}\right)\left(\text{tan 49.46º}\right)=\text{2.338 m.} $$
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
How many lines per centimeter are there on a diffraction grating that gives a first-order maximum for 470-nm blue light at an angle of  $$\text{25}\text{.}0º $$
?

</div>
<div data-type="solution" markdown="1">
 $$8\text{.}\text{99}×{\text{10}}^{3} $$
</div>
</div>

<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the distance between lines on a diffraction grating that produces a second-order maximum for 760-nm red light at an angle of  $$\text{60}\text{.}0º $$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Calculate the wavelength of light that has its second-order maximum at  $$\text{45}\text{.}0º $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
An electric current through hydrogen gas produces several distinct wavelengths of visible light. What are the wavelengths of the hydrogen spectrum, if they form first-order maxima at angles of  $$\text{24}\text{.}2º $$
,  $$\text{25}\text{.}7º $$
,  $$\text{29}\text{.}1º $$
, and  $$\text{41}\text{.}0º $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The yellow light from a sodium vapor lamp *seems* to be of pure wavelength, but it produces two first-order maxima at  $$\text{36}\text{.}\text{093}\text{º} $$
 and  $$\text{36}\text{.}\text{129}\text{º} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the spacing between structures in a feather that acts as a reflection grating, given that they produce a first-order maximum for 525-nm light at a  $$\text{30}\text{.}0º $$
 angle?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
At what angle does a diffraction grating produces a second-order maximum for light having a first-order maximum at  $$\text{20}\text{.}0º $$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Show that a diffraction grating cannot produce a second-order maximum for a given wavelength of light unless the first-order maximum is at an angle less than  $$\text{30}\text{.}0º $$
.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
If a diffraction grating produces a first-order maximum for the shortest wavelength of visible light at  $$\text{30}\text{.}0º $$
...
(c)  $$6\text{.}\text{58}×{\text{10}}^{3} \text{cm} $$
</div>
</div>
...
(a) What visible wavelength has its fourth-order maximum at an angle of  $$\text{25.0º} $$
