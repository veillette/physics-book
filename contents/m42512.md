...
The distances on the screen are labeled  $${y}_{\text{V}} $$
 and  $${y}_{\text{R}} $$
 in [\[link\]](#Figure5). Noting that  $$\tan \theta =y/x $$ ,
...
*  There is constructive interference for a diffraction grating when
   $$d \sin \theta =\mathrm{m\lambda } \text{(for} m=0 \text{,} 1 \text{,} -1 \text{,} 2 \text{,} -2 \text{,} \dots \right) $$ ,  where
...
<div class="exercise" data-element-type="problems-exercises">
<div class="problem" markdown="1">
An opal such as that shown in [[link]](#Figure2) acts like a reflection grating with rows separated by about  $$8 \text{μm} $$ .
