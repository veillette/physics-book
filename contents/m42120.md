...
A high school track coach has just purchased a new stopwatch. The stopwatch manual states that the stopwatch has an uncertainty of  $$ ±0.05\mathrm{s} $$ . Runners on the track coach’s team regularly clock 100-m sprints of $$ 11.49 \text{s} $$
...
circle can be calculated from its radius using $$ A=\pi r^{2} $$. Let us see how many significant figures the area has if the radius has only
two—say, $$
r=1.2\text{m} $$. Then,

<div data-type="equation" id="eip-722">
 $$ A=\pi r^{2}=\left(3.1415927 \dots}\right)×{\left(1.2\text{m}
\right)}^{2}=4.5238934\text{m}^{2} $$ 
</div>
...
? (b) Convert this range to miles per hour. $$ \left(1 \text{km}=\text{0.6214
mi}\right) $$
</div>
<div data-type="solution" markdown="1">
1.   $$ 85.5\text{to } 94.5 \text{km/h} $$ 

2. $$ 53.1\text{to } 58.7 \text{mi/h} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) A person’s blood pressure is measured to be  $$ 120}±2\text{mm Hg} $$ . What is its percent uncertainty? (b) Assuming the same percent uncertainty,
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A person measures his or her heart rate by counting the number of beats in  $$30 \text{s} $$ . If $$ 40}±1 $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
When non-metric units were used in the United Kingdom, a unit of mass called the **pound-mass** (lbm) was employed, where  $$ 1\text{lbm}=0.4539\text{kg} $$ . (a) If there is an uncertainty of $$ 0.0001\text{kg} $$
