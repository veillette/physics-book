...
* (“delta $$ A $$
”), so the measurement result would be recorded as $$ A±\mathrm{\delta A} $$. In our paper example, the length of the paper could be expressed as $$ 11\text{ in.}±0.2\text{.} $$
...
Uncertainty is a critical piece of information, both in physics and in many other real-world applications. Imagine you are caring for a sick child. You suspect the child has a fever, so you check his or her temperature with a thermometer. What if the uncertainty of the thermometer were  $$ 3.0º\text{C} $$ 

? If the child’s temperature reading was $$ 37.0º\text{C} $$
(which is normal body temperature), the “true” temperature could be anywhere
from a hypothermic $$ 34.0º\text{C} $$
to a dangerously high $$ 40.0º\text{C} $$. A thermometer with an uncertainty of $$ 3.0º\text{C} $$
would be useless.
...
bag has an uncertainty of $$ ±0.4\text{lb}
...
<div data-type="equation" id="eip-191">
 $$ \text{}\text{\% unc =}\frac{0.4\text{ lb}}{5\text{ lb}}×\text{100\%}\text{}=8\text{\%}\text{.} $$ 
</div>
<strong>Discussion </strong>

We can conclude that the weight of the apple bag is $$ 5\text{lb}±8\text{\%} $$. Consider how this percent uncertainty would change if the bag of apples were
...
floor has a length of $$ 4.00\text{m}
$$
and a width of $$ 3.00\text{m} $$, with uncertainties of $$ 2\%\text{} $$
and $$ 1\%\text{} $$, respectively, then the area of the floor is $$ 12.0{\text{m}}^{2} $$
and has an uncertainty of $$ 3\%\text{} $$. (Expressed as an area this is $$ 0.36{\text{m}}^{2} $$, which we round to $$ 0.4{\text{m}}^{2} $$
...
A high school track coach has just purchased a new stopwatch. The stopwatch manual states that the stopwatch has an uncertainty of  $$ ±0.05\mathrm{s} $$ 

. Runners on the track coach’s team regularly clock 100-m sprints of $$ 11.49 \text{s} $$
to $$ 15.01 \text{s} $$. At the school’s last track meet, the first-place sprinter came in at $$ 12.04 \text{s} $$
and the second-place sprinter came in at $$ 12.07 \text{s} $$. Will the coach’s new stopwatch be helpful in timing the sprint team? Why or
why not?
...
measure the length of a stick, you may measure it to be $$ 36.7\text{cm} $$. You could not express this value as $$ 36.71\text{cm} $$
...
length seems to be somewhere in between $$ 36.6\text{cm} $$
and $$ 36.7\text{cm} $$, and he or she must estimate the value of the last digit. Using the method
...
right. For example, the measured value $$ 36.7\text{cm} $$
...
<div data-type="equation" id="eip-722">
 $$ A={\mathrm{\pi r}}^{2}=\left(3.1415927.\text{.}\text{.}\right)×{\left(1.2\text{m}\right)}^{2}=4.5238934{\text{m}}^{2} $$ 
</div>
...
uncertainty. What is the range of possible speeds when it reads $$ 90\text{km/h} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
State how many significant figures are proper in the results of the following calculations: (a)  $$ \left(106.7\right)\left(98.2\right)/\left(46.210\right)\left(1.01\right) $$ 

(b)  $$ {\left(18.7\right)}^{2} $$
(c)  $$ \left(1.60 \times  10^{ -19 }\right)\left(
3712}\right) $$.
...
at a speed of $$ 90\text{km/h} $$, what is the percent uncertainty? (b) If it has the same percent uncertainty
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) A person’s blood pressure is measured to be  $$ 120}±2\text{mm Hg} $$ 

. What is its percent uncertainty? (b) Assuming the same percent uncertainty,
what is the uncertainty in a blood pressure measurement of $$ 80}\text{mm Hg} $$
?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A person measures his or her heart rate by counting the number of beats in  $$ 30}\text{s} $$ 

. If $$ 40}±1 $$
beats are counted in $$ 30.0±0.5\text{s} $$, what is the heart rate and its uncertainty in beats per minute?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the area of a circle  $$ 3.102\text{cm} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A marathon runner completes a  $$ 42.188\text{-km} $$ 

course in $$ 2\text{h} $$, 30 min, and $$ 12}\text{s} $$. There is an uncertainty of $$ 25}\text{m}
$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The sides of a small rectangular box are measured to be  $$ 1.80±0.01\text{cm} $$ 

, $$  $$
$$ 2.05±0.02\text{cm,
and 3}.1±0\text{.}\text{1 cm} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
When non-metric units were used in the United Kingdom, a unit of mass called the **pound-mass** (lbm) was employed, where  $$ 1\text{lbm}=0.4539\text{kg} $$ 

. (a) If there is an uncertainty of $$ 0.0001\text{kg} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The length and width of a rectangular room are measured to be  $$ 3.955±0.005\text{m} $$ 

and $$ 3.050±0.005\text{m} $$. Calculate the area of the room and its uncertainty in square meters.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A car engine moves a piston with a circular cross section of  $$ 7.500±0.002\text{cm} $$ 

diameter a distance of $$ 3.250±0.001\text{cm} $$
