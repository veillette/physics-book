...
bag has an uncertainty of $$ ±0\text{.}4\text{lb}
...
5\text{lb}±8\text{\%} $$. Consider how this percent uncertainty would change if the bag of apples were
...
floor has a length of $$ 4\text{.}\text{00}\text{m}
$$
and a width of $$ 3\text{.}\text{00}\text{m} $$, with uncertainties of $$ 2\%\text{} $$
and $$ 1\%\text{} $$, respectively, then the area of the floor is $$
\text{12}\text{.}0{\text{m}}^{2} $$
and has an uncertainty of $$ 3\%\text{} $$. (Expressed as an area this is $$
0\text{.}\text{36}{\text{m}}^{2} $$, which we round to $$ 0\text{.}4{\text{m}}^{2} $$
...
A high school track coach has just purchased a new stopwatch. The stopwatch manual states that the stopwatch has an uncertainty of  $$ ±0\text{.}\text{05}\mathrm{s} $$ 
...
\text{36}\text{.}7\text{cm} $$. You could not express this value as $$
\text{36}\text{.}\text{71}\text{cm} $$
...
\text{36}\text{.}6\text{cm} $$
and $$ \text{36}\text{.}7\text{cm} $$, and he or she must estimate the value of the last digit. Using the method
...
two—say, $$
r=1\text{.}2\text{m} $$. Then,

<div data-type="equation" id="eip-722">
 $$ A={\mathrm{\pi r}}^{2}=\left(3\text{.}\text{1415927}\text{.}\text{.}\text{.}\right)×{\left(1\text{.}2\text{m}\right)}^{2}=4\text{.}\text{5238934}{\text{m}}^{2} $$ 
</div>
...
<div data-type="solution" markdown="1">
1.   $$ \text{85}\text{.}5\text{to 94}\text{.}\text{5 km/h} $$ 

2. $$ \text{53}\text{.}1\text{to 58}\text{.}\text{7
   mi/h} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) If your speedometer has an uncertainty of  $$ 2\text{.}0\text{km/h} $$ 

at a speed of $$ \text{90}\text{km/h} $$, what is the percent uncertainty? (b) If it has the same percent uncertainty
when it reads $$
\text{60}\text{km/h} $$, what is the range of speeds you could be going?
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) A person’s blood pressure is measured to be  $$ \text{120}±2\text{mm Hg} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A person measures his or her heart rate by counting the number of beats in  $$ \text{30}\text{s} $$ 

. If $$ \text{40}±1 $$
beats are counted in $$
\text{30}\text{.}0±0\text{.}5\text{s} $$, what is the heart rate and its uncertainty in beats per minute?

</div>
<div data-type="solution" markdown="1">
 $$ \text{80}±3\text{beats/min} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
What is the area of a circle  $$ 3\text{.}\text{102}\text{cm} $$ 
...
course in $$ 2\text{h} $$, 30 min, and $$ \text{12}\text{s} $$. There is an uncertainty of $$ \text{25}\text{m}
$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The sides of a small rectangular box are measured to be  $$ 1\text{.}\text{80}±0\text{.}\text{01}\text{cm} $$ 

, $$  $$
$$ 2\text{.}\text{05}±0\text{.}\text{02}\text{cm,
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
When non-metric units were used in the United Kingdom, a unit of mass called the **pound-mass** (lbm) was employed, where  $$ 1\text{lbm}=0\text{.}\text{4539}\text{kg} $$ 

. (a) If there is an uncertainty of $$
0\text{.}\text{0001}\text{kg} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
The length and width of a rectangular room are measured to be  $$ 3\text{.}\text{955}±0\text{.}\text{005}\text{m} $$ 

and $$
3\text{.}\text{050}±0\text{.}\text{005}\text{m} $$. Calculate the area of the room and its uncertainty in square meters.

</div>
<div data-type="solution" markdown="1">
 $$ \text{12}\text{.}\text{06}±0\text{.}\text{04}{\text{m}}^{2} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
A car engine moves a piston with a circular cross section of  $$ 7\text{.}\text{500}±0\text{.}\text{002}\text{cm} $$ 

diameter a distance of $$
3\text{.}\text{250}±0\text{.}\text{001}\text{cm} $$
