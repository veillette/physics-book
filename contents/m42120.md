...
* (“delta $$ A $$ ”), so the measurement result would be recorded as $$ A \pm
  \delta A $$. In our paper example, the length of the paper could be expressed
  as $$ 11\text{ in.} \pm 0.2\text{.} $$ The factors contributing to uncertainty
...
* Week 3 weight:
  $$ 4.9 \text{lb} $$
* Week 4 weight:
  $$ 5.4 \text{lb} $$ {: data-bullet-style="none"}
...
says that **the percent uncertainty in a
...
floor has a length of $$ 4.00\text{m} $$ and a width of $$ 3.00\text{m} $$, with
uncertainties of $$ 2 \% $$ and $$ 1 \% $$, respectively, then the area of the
floor is $$ 12.0\text{m}^{2} $$ and has an uncertainty of $$ 3 \% $$. (Expressed
as an area this is $$ 0.36\text{m}^{2} $$, which we round to $$ 0.4\text{m}^{2}
...
somewhere in between $$ 36.6\text{cm} $$ and $$ 36.7\text{cm} $$, and he or she
...
0.0255\text{m/s}^{2} $$, what is the force on the wagon? (The unit of force is
