...
Accuracy**{: data-type="term"

# import-auto-id2543264} is how close a measurement is to the correct value for that measurement. For example, let us say
...
uncertainty**{: data-type="term"

# import-auto-id1745835} in the measurements. Uncertainty is a quantitative measure of how much your measured values
...
uncertainty in a measurement, \\( A \\)

, is often denoted as * \\( \mathrm{\delta A} \\)

* (“delta \\( A \\)

”), so the measurement result would be recorded as \\( A±\mathrm{\delta A} \\)
...
to a dangerously high \\( \text{40}\text{.}0º\text{C} \\)

. A thermometer with an uncertainty of \\( 3\text{.}0º\text{C} \\)
...
is expressed with uncertainty, \\( \mathrm{\delta A} \\)

, the **percent uncertainty**{: data-type="term" #import-auto-id3102818} (%unc)
is defined to be
...
First, observe that the expected value of the bag’s weight, \\( A \\)

, is 5 lb. The uncertainty in this value, \\( \mathrm{\delta A} \\)

, is 0.4 lb. We can use the following equation to determine the percent
...
5\phantom{\rule{0.25em}{0ex}}\text{lb}±8\text{\%} \\)
...
# import-auto-id1516086} can be used for multiplication or division. This method says that **the percent uncertainty in a
...
and a width of \\( 3\text{.}\text{00}\phantom{\rule{0.25em}{0ex}}\text{m} \\)

, with uncertainties of \\( 2\%\text{} \\)
...
and has an uncertainty of \\( 3\%\text{} \\)

. (Expressed as an area this is \\(
0\text{.}\text{36}\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2} \\)

, which we round to \\( 0\text{.}4\phantom{\rule{0.25em}{0ex}}{\text{m}}^{2} \\)
...
and the second-place sprinter came in at \\( \text{12}\text{.}\text{07 s} \\)

. Will the coach’s new stopwatch be helpful in timing the sprint team? Why or
why not?
...
. You could not express this value as \\(
...
and \\( \text{36}\text{.}7\phantom{\rule{0.25em}{0ex}}\text{cm} \\)

, and he or she must estimate the value of the last digit. Using the method
...
circle can be calculated from its radius using \\( A={\mathrm{\pi r}}^{2} \\)

. Let us see how many significant figures the area has if the radius has only
two—say, \\(
r=1\text{.}2\phantom{\rule{0.25em}{0ex}}\text{m} \\)
...
. If a wagon with mass 55 kg accelerates at a rate of \\( 0\text{.}\text{0255
}{\text{m/s}}^{2} \\)

, what is the force on the wagon? (The unit of force is called the newton, and
...
at a speed of \\( \text{90}\phantom{\rule{0.25em}{0ex}}\text{km/h} \\)

, what is the percent uncertainty? (b) If it has the same percent uncertainty
when it reads \\(
\text{60}\phantom{\rule{0.25em}{0ex}}\text{km/h} \\)
...
\text{30}\text{.}0±0\text{.}5\phantom{\rule{0.25em}{0ex}}\text{s} \\)
...
course in \\( 2\phantom{\rule{0.25em}{0ex}}\text{h} \\)

, 30 min, and \\( \text{12}\phantom{\rule{0.25em}{0ex}}\text{s} \\)

. There is an uncertainty of \\( \text{25}\phantom{\rule{0.25em}{0ex}}\text{m}
\\)
...
and \\(
3\text{.}\text{050}±0\text{.}\text{005}\phantom{\rule{0.25em}{0ex}}\text{m} \\)
