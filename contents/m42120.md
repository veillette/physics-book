...
<div data-type="equation" id="eip-718">
 $$ \% \text{unc} = =\frac{\delta A}{A} \times 100 \% \text{.} $$ 
</div>
...
<div data-type="equation" id="eip-191">
 $$ \% \text{unc} =\frac{0.4\text{ lb}}{5\text{ lb}} \times 100  \% = 8 \% \text{.} $$ 
</div>
<strong>Discussion </strong>

We can conclude that the weight of the apple bag is $$ 5\text{lb} \pm  8 \% $$. Consider how this percent uncertainty would change if the bag of apples were
...
floor has a length of 
$$ 4.00\text{m} $$ and a width of $$ 3.00\text{m} $$, with uncertainties of $$ 2 \% $$
and $$ 1 \%  $$, respectively, then the area of the floor is $$ 12.0\text{m}^{2} $$
and has an uncertainty of $$ 3 \% $$. (Expressed as an area this is $$ 0.36\text{m}^{2} $$, which we round to $$ 0.4\text{m}^{2} $$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
(a) A car speedometer has a  $$ 5.0 \% $$ uncertainty. What is the range of possible speeds when it reads $$ 90\text{km/h} $$
