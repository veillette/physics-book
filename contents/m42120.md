...
0.36{\text{m}}^{2} $$, which we round to $$ 0.4{\text{m}}^{2} $$
...
36.7\text{cm} $$. You could not express this value as $$
36.71\text{cm} $$
...
when it reads $$
60}\text{km/h} $$, what is the range of speeds you could be going?
...
30.0±0.5\text{s} $$, what is the heart rate and its uncertainty in beats per minute?
...
and $$
3.050±0.005\text{m} $$. Calculate the area of the room and its uncertainty in square meters.
