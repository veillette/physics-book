...
the slope in the graph above is average velocity $$ \stackrel{-}{v} $$
and the intercept is position at time zero—that is, $$ {x}_{0} $$. Substituting these symbols into $$ y=\text{mx}+b $$
gives

<div data-type="equation" id="import-auto-id4019047">
 $$ x=\stackrel{-}{v}t+{x}_{0} $$ 
</div>
...
<div data-type="equation" id="import-auto-id1850584">
 $$ \text{slope}=\frac{\Delta x}{\Delta t}=\stackrel{-}{v}. $$ 
</div>
...
<div data-type="equation" id="import-auto-id4181834">
 $$ \stackrel{-}{v}=\frac{\Delta x}{\Delta t}=\frac{2000 \text{m}-525 \text{m}}{6.4 \text{s}-0.50 \text{s}}, $$ 
</div>
yielding

<div data-type="equation" id="import-auto-id2024433">
 $$ \stackrel{-}{v}=250 \text{m/s}. $$ 
</div>
**Discussion**
...
<div data-type="equation" id="import-auto-id3627758">
 $$ \text{slope}={v}_{Q}=\frac{ {\Delta x}_{Q}}{ {\Delta t}_{Q}}=\frac{\left(3120 \text{m}-1300 \text{m}\right)}{\left(32 \text{s}-19 \text{s}\right)} $$ 
</div>
Thus,

<div data-type="equation" id="import-auto-id1657105">
 $$ {v}_{Q}=\frac{1820 \text{m}}{13 \text{s}}=\text{140 m/s.} $$ 
</div>
**Discussion**

This is the value given in this figure’s table for $$ v $$
at $$ t=25 \text{s} $$. The value of 140 m/s for $$ {v}_{Q} $$
...
<div data-type="problem" markdown="1">
(a) Explain how you can use the graph of position versus time in [[link]](#import-auto-id4064025) to describe the change in velocity over time. Identify (b) the time ( $$ {t}_{a} $$ 

, $$ {t}_{b} $$, $$ {t}_{c} $$, $$ {t}_{d} $$, or $$ {t}_{e} $$
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
(a) Sketch a graph of velocity versus time corresponding to the graph of position versus time given in [[link]](#import-auto-id2562897). (b) Identify the time or times ( $$ {t}_{a} $$ 

, $$ {t}_{b} $$, $$ {t}_{c} $$, etc.) at which the instantaneous velocity is greatest. (c) At which times is
...
<div data-type="exercise" data-element-type="conceptual-questions">
<div data-type="problem" markdown="1">
(a) Sketch a graph of acceleration versus time corresponding to the graph of velocity versus time given in [[link]](#import-auto-id1447833). (b) Identify the time or times ( $$ {t}_{a} $$ 

, $$ {t}_{b} $$, $$ {t}_{c} $$, etc.) at which the acceleration is greatest. (c) At which times is it zero? (
...
<div data-type="problem" markdown="1">
(a) By taking the slope of the curve in [[link]](#import-auto-id1798398), verify that the velocity of the jet car is 115 m/s at  $$ t=20 \text{s} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Using approximate values, calculate the slope of the curve in [[link]](#import-auto-id4122996) to verify that the velocity at  $$ t=\text{10.0 s} $$ 
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Using approximate values, calculate the slope of the curve in [[link]](#import-auto-id4122996) to verify that the velocity at  $$ t=\text{30.0 s} $$ 
...
<div data-type="equation" id="eip-id2453534">
 $$ v=\frac{\left(11.7-6.95\right)×10^{3}\text{m}}{\left(40.\text{0 – 20}.0\right)\text{s}}=238 \text{m/s} $$ 
</div>
</div>
</div>
