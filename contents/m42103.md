...
acceleration. 
(c) Acceleration has the constant value of \(5.0 \text{m/s}^2\) 
...
"The slope of an x size 12{x} {} vs. t size 12{t} {} graph is velocity.
...
This is the value given in this figure’s table for $$ v $$ at $$ t=25 \text{s}
...
decreases from $$ 5.{0 \text{m/s}}^{2} $$ to zero when the car hits 250 m/s. The
slope of the $$ x $$ vs. $$ t $$ graph increases until $$ t=55 \text{s} $$,
...
Calculate the acceleration of the jet car at a time of 25 s by finding the slope of the  $$ v $$ vs. 
$$ t $$
graph in [\[link\]](#import-auto-id1534076)(b).

**Strategy**

The slope of the curve at $$ t=25 \text{s} $$ is equal to the slope of the line
...
in [\[link\]](#import-auto-id1534076)(c) at $$ t=25 \text{s} $$.
...
(a) The ship moves at constant velocity and then begins to decelerate at a constant rate. 
At some point, its deceleration rate decreases. 
It maintains this lower deceleration rate until it stops moving.
...
(b) Identify the time or times ( $$ t_{a} $$ 

, $$ t_{b} $$, $$ t_{c} $$, etc.) at which the instantaneous velocity is
greatest. (c) At which times is it zero? (d) At which times is it negative?
...
, $$ t_{b} $$, $$ t_{c} $$, etc.) at which the acceleration is greatest. (c) At
which times is it zero? (
...
[Motion Equations for Constant Acceleration in One Dimension](/contents/m42099) for the complete trip.
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Construct the position graph for the subway shuttle train as shown in [[link]](/contents/m42100#import-auto-id2590556)(a). Your graph should show the position of the train, in kilometers, from t = 0 to 20 s. 
...
first 4 s? (b) What is his instantaneous velocity at $$ t=5 s $$ ? (c) What is
his average acceleration between 0 and 4 s? (d) What is his time for the race?
