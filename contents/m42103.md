...
The slope of the graph of position  $$ x $$ vs. time $$ t $$
** is velocity $$ v $$.
...
<div data-type="equation" id="import-auto-id1657105">
 $$ v_{Q}=\frac{1820 \text{m}}{13 \text{s}}=140  \text{m/s.} $$ 
</div>
**Discussion**
...
Calculate the acceleration of the jet car at a time of 25 s by finding the slope of the  $$ v $$ vs. $$ t $$
...
<div data-type="equation" id="import-auto-id2028886">
 $$ a=\frac{50 \text{m/s}}{50 \text{s}}=1.0 \text{m/s}^{2}. $$ 
</div>
**Discussion**
...
<div data-type="equation" id="eip-id2453534">
 $$ v=\frac{\left(11.7-6.95\right)\times 10^{3}\text{m}}{\left(40.0 – 20.0\right)\text{s}}=238 \text{m/s} $$ 
</div>
</div>
</div>
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
By taking the slope of the curve in [[link]](#import-auto-id3552017), verify that the acceleration is  $$ 3.2 \text{m/s}^{2} $$ 
