...
Noting that the number of microstates is labeled  $$W $$
 in [\[link\]](#import-auto-id1169738223876) for the 100-coin toss, we can use  $$\Delta S={S}_{\text{f}}-{S}_{\text{i}}=k\ln {W}_{\text{f}}-k\ln {W}_{\text{i}} $$
...
<div class="equation" id="eip-822">
 $$\Delta S={S}_{\text{f}}–{S}_{\text{i}}=k\ln {W}_{\text{f}}–k\ln {W}_{\text{i},} $$
</div>
...
* The entropy of a system in a given state (a macrostate) can be written as
  ...
  where
   $$k=1.38 \times 10^{-23}  \text{J/K} $$ is Boltzmann’s constant, and
   $$lnW $$ is the natural logarithm of the number of microstates
