...
where  $$k= 1.38 \times 10^{-23}  \text{J/K} $$
...
<div data-type="equation" id="eip-827">
 $$\begin{array}{lll}\Delta S& =& \left(1\text{.}\text{38}×{\text{10}}^{–\text{23}} \text{J/K}\right)\left[\text{ln}\left( 1.0 \times 10^{29} \right)–\text{ln}\left( 1.4 \times 10^{28} \right)\right]\\ & =& \text{2.7}×{\text{10}}^{–\text{23}} \text{J/K}\end{array} $$
</div>
**Discussion**
...
It should happen twice in every  $$ 1.27 \times 10^{30}  \text{s} $$
 or once in every  $$ 6.35 \times 10^{29}  \text{s} $$
  $$\begin{array}{ll}\left( 6.35 \times 10^{29}  \text{s}\right)\left(\frac{\text{1 h}}{\text{3600 s}}\right)& \left(\frac{\text{1 d}}{\text{24 h}}\right)\left(\frac{\text{1 y}}{\text{365.25 d}}\right)\\ =&  2.0 \times 10^{22}  \text{y}\end{array} $$
</div>
</div>
