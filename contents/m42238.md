...
<div data-type="equation" id="eip-827">
 $$\begin{array}{lll}\Delta S& =& \left( 1.38 \times 10^{-23} \text{J/K}\right)\left[\text{ln}\left( 1.0 \times 10^{29} \right)–\text{ln}\left( 1.4 \times 10^{28} \right)\right]\\ & =& 2.7 \times 10^{-23} \text{J/K}\end{array} $$
</div>
**Discussion**
...
. There is about a  $$1\text{ in } 10^{30} $$
...
. Given that a  $$\Delta S{\text{ of 10}}^{-\text{21}} \text{J/K} $$
 corresponds to about a  $$1\text{ in } 10^{30} $$
...
It should happen twice in every  $$ 1.27 \times 10^{30}  \text{s} $$
 or once in every  $$ 6.35 \times 10^{29}  \text{s} $$
  $$\begin{array}{ll}\left( 6.35 \times 10^{29}  \text{s}\right)\left(\frac{1 \text{h}}{3600 \text{s}}\right)& \left(\frac{1 \text{d}}{24 \text{h}}\right)\left(\frac{1 \text{y}}{\text{365.25 d}}\right)\\ =&  2.0 \times 10^{22}  \text{y}\end{array} $$
</div>
</div>
