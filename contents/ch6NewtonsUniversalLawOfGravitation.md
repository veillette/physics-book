...
motions. See [\[link\]](#import-auto-id2409649). But Newton was not the first to
...
mass of the object and Earth). See [\[link\]](#import-auto-id2448812). The mass
...
see [\[link\]](#import-auto-id1955361)). We do not sense the Moon’s effect on
...
Earth. [\[link\]](#import-auto-id2404894) is a simplified drawing of the Moon’s
...
see [\[link\]](#import-auto-id3051120)). A few likely candidates for black holes
...
in [\[link\]](#import-auto-id2055450). Remarkably, his value for $$ G $$ differs
...
where $$ m $$ is the mass of the object, $$ M $$ is the mass of Earth, and $$ r
$$ is the distance to the center of Earth (the distance between the centers of
mass of the object and Earth). See [\[link\]](#import-auto-id2406145). The mass
$$ m $$ of the object cancels, leaving an equation for $$ g $$:
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
Solve part (b) of [[link]](#fs-id3174863) using $$ \ac ={v}^{2}/r $$.
