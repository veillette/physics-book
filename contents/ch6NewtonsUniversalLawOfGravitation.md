...
motions. See [Figure](#fig1). But Newton was not the first to
...
mass of the object and Earth). See [Figure](#fig3). The mass
...
see [Figure](#fig4)). We do not sense the Moon’s effect on
...
Earth. [Figure](#fig5) is a simplified drawing of the Moon’s
...
see [Figure](#fig7)). A few likely candidates for black holes
...
in [Figure](#fig9). Remarkably, his value for $$ G $$ differs
...
where $$ m $$ is the mass of the object, $$ M $$ is the mass of Earth, and $$ r
$$ is the distance to the center of Earth (the distance between the centers of
mass of the object and Earth). See [Figure](#fig2). The mass
$$ m $$ of the object cancels, leaving an equation for $$ g $$:
