...
<div data-type="equation" id="eip-256">
 $$\begin{array}{lll}R& =& {R}_{0}\left(1+\alpha \Delta T\right)\\ & =& \left(0.350 \text{Ω}\right)\left[\text{1}+\left(4.5 \times 10^{-3}/\text{ºC}\right)\left(\text{2830º}\text{C}\right)\right]\\ & =& 4.8 \text{Ω.}\end{array} $$
</div>
**Discussion**
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
An electronic device designed to operate at any temperature in the range from  $$-10.0º\text{C to 55}\text{.}0º\text{C} $$
