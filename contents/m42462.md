...
*can be is * $$\text{90º} $$
*, as shown in [\[link\]](#import-auto-id1435341)(b).The **critical angle*** $${\theta }_{c} $$
...
*. If the incident angle  $${\theta }_{1} $$
 is greater than the critical angle, as shown in [\[link\]](#import-auto-id1435341)(c), then all of the light is reflected back into medium 1, a condition called **total internal reflection**.
...
<div data-type="equation" id="eip-76">
 $${n}_{1} \text{sin} {\theta }_{1}={n}_{2} \text{sin} {\theta }_{2}\text{.} $$
</div>
...
<div data-type="equation" id="eip-342">
 $${n}_{1} \text{sin} {\theta }_{1}={n}_{2}\text{.} $$
</div>
...
<div data-type="equation" id="eip-458">
 $${\theta }_{c}={\text{sin}}^{-1}\left({n}_{2}/{n}_{1}\right) \text{for} {n}_{1}>{n}_{2}\text{.} $$
</div>
