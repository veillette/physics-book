...
Consider what happens when a ray of light strikes the surface between two materials, such as is shown in [\[link\]](#import-auto-id1435341)(a). Part of the light crosses the boundary and is refracted; the rest is reflected. If, as shown in the figure, the index of refraction for the second medium is less than for the first, the ray bends away from the perpendicular. (Since  $${n}_{1}>{n}_{2} $$ , the angle of refraction is greater than the angle of incidence—that is,  $${\theta }_{2}>{\theta }_{1} $$ .) Now imagine what happens as the incident angle is increased. This causes  $${\theta }_{2} $$  to increase also. The largest the angle of refraction  $${\theta }_{2} $$ can be is  $$90 \text{º} $$ , as shown in [\[link\]](#import-auto-id1435341)(b).The **critical angle** $${\theta }_{c} $$  for a combination of materials is defined to be the incident angle  $${\theta }_{1} $$
