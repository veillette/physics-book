...
absorbing the rest. But it would be useful to have a mirror that reflects all of
the light that falls on it. Interestingly, we can produce **total reflection**
...
the angle of refraction $${\theta }_{2} $$ can be is $$90 \text{º} $$ , as shown
...
** that produces an angle of refraction of $$90 \text{º} $$ . That is, $${\theta
}_{c} $$ is the incident angle for which $${\theta }_{2}=90 \text{º} $$ . If the
...
{c} $$ ), the angle of refraction is $$90 \text{º} $$  ( $${\theta }_{2}=90
...
an angle greater than $$42.2 \text{º} $$ will be totally reflected. This will
...
illustrated in [[Figure 3]](#Figure3). The output of a device called an **
endoscope**{: class="term"} is shown in [[Figure 3]](#Figure3)(b). Endoscopes
...
angle that is less than $$45 \text{º} $$ . One use of these perfect mirrors is
...
* The incident angle that produces an angle of refraction of $$90 \text{º} $$ is
...
critical angle
: incident angle that produces an angle of refraction of $$90 \text{º} $$
