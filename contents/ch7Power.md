...
What is the power output for a 60.0-kg woman who runs up a 3.00 m high flight of stairs in 3.50 s, starting from rest but having a final speed of 2.00 m/s? (See [Figure](#fig2).)
...
a rate of 1500 MW. (See [Figure](#fig3).)
...
<div class="problem" markdown="1">
The Crab Nebula (see [Figure](#fig4)) pulsar is the remnant of a supernova that occurred in A.D. 1054. Using data from [Figure](#import-auto-id2195139), calculate the approximate factor by which the power output of this astronomical object has declined since its explosion.
