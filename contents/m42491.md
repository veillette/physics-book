...
Normal optical microscopes can magnify up to $$1500×$$
 ...
 with a theoretical resolution of $$–0.2\phantom{\rule{0.25em}{0ex}}\text{μm}$$
...
**{: data-type="term" #import-auto-id3110009}, the magnification $$\left(m\right)$$
...
<div data-type="exercise" data-element-type="problems-exercises">
<div data-type="problem" markdown="1">
You switch from a $$1.40\text{NA}\phantom{\rule{0.25em}{0ex}}\text{60}×$$

 oil immersion objective to a $$1.40\text{NA}\phantom{\rule{0.25em}{0ex}}\text{60}×$$
...
You are using a standard microscope with a $$0.10\text{NA}\phantom{\rule{0.25em}{0ex}}\text{4}×$$

 objective and switch to a $$0.65\text{NA}\phantom{\rule{0.25em}{0ex}}\text{40}×$$
