...
<div class="note" id="eip-992" markdown="1">
<div class="title">
...
This situation is similar to that shown in [\[link\]](#Figure2). To find the overall magnification, we must find the magnification of the objective, then the magnification of the eyepiece. This involves using the thin lens equation.

**Solution**

The magnification of the objective lens is given as

<div class="equation" id="eip-289">
 $${m}_{\text{o}}= -\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}\text{,} $$
</div>
where  $${d}_{\text{o}} $$
 and  $${d}_{\text{i}} $$
 are the object and image distances, respectively, for the objective lens as labeled in [\[link\]](#Figure2). The object distance is given to be  $${d}_{\text{o}}=6.20 \text{mm} $$ ,
...
Both the objective and the eyepiece contribute to the overall magnification, which is large and negative, consistent with [\[link\]](#Figure2), where the image is seen to be large and inverted. In this case, the image is virtual and inverted, which cannot happen for a single element (case 2 and case 3 images for single elements are virtual and upright). The final image is 367 mm (0.367 m) to the left of the eyepiece. Had the eyepiece been placed farther from the objective, it could have formed a case 1 image to the right. Such an image could be projected on a screen, but it would be behind the head of the person in the figure and not appropriate for direct viewing. The procedure used to solve this example is applicable in any multiple-element system. Each element is treated in turn, with each forming an image that becomes the object for the next element. The process is not more difficult than for single lenses or mirrors, only lengthier.
...
**, the magnification  $$\left(m\right) $$ ,
 ...
 formed by the maximum cone of rays focusing on the specimen (see [\[link\]](#Figure3)(a)) and is given by
...
where  $$n $$
 ...
 As the angle of acceptance given by  $$\theta  $$  increases,  $$\text{NA} $$
...
The term  $$f/\# $$
 in general is called the  $$f $$ -number and is used to denote the light per unit area reaching the image plane. In photography, an image of an object at infinity is formed at the focal point and the  $$f $$
-number is given by the ratio of the focal length  $$f $$
 of the lens and the diameter  $$D $$  of the aperture controlling the light into the lens (see [\[link\]](#Figure3)(b)). If the acceptance angle is small the  $$\text{NA} $$  of the lens can also be used as given below.
...
*  The overall magnification of a multiple-element system is the product of the magnifications of its individual elements. For a two-element system with an objective and an eyepiece, this is
  <div class="equation" id="eip-id1417167">
...
*  The eyepiece and objective contribute to the magnification. The numerical aperture
   $$\left(\text{NA}\right) $$ of an objective is given by
...
<div class="exercise" data-element-type="conceptual-questions">
<div class="problem" markdown="1">
The image produced by the microscope in [[link]](#Figure2) cannot be projected. Could extra lenses or mirrors project it? Explain.
...
<div class="exercise" id="eip-49" data-element-type="problems-exercises">
<div class="problem" id="eip-57" markdown="1">
...
<div class="solution" id="eip-207" markdown="1">
...
<div class="exercise" id="eip-999" data-element-type="problems-exercises">
<div class="problem" id="eip-413" markdown="1">
You are using a standard microscope with a  $$0.10\text{NA} 4× $$
 objective and switch to a  $$0.65\text{NA} 40× $$
 objective. What are the acceptance angles for each? Compare and comment on the values. Which would you use first to locate the target area on of your specimen? (See [[link]](#Figure3).)
