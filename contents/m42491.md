...
<div data-type="equation" id="eip-960">
 $$\frac{1}{ {d}_{\text{i}}}=\frac{1}{6\text{.}00 \text{mm}}-\frac{1}{6\text{.}20 \text{mm}}=\frac{0.00538}{\text{mm}}\text{.} $$
</div>
...
<div data-type="equation" id="eip-171">
 $${m}_{\text{o}}=-\frac{ {d}_{\text{i}}}{ {d}_{\text{o}}}=-\frac{186 \text{mm}}{6.20 \text{mm}}=-\text{30.0.} $$
</div>
...
<div data-type="equation" id="eip-248">
 $${m}_{\text{e}}=-\frac{ {d}_{\text{i}}\prime }{ {d}_{\text{o}}\prime }=-\frac{-367 \text{mm}}{\text{44}\text{.}0 \text{mm}}=8.33. $$
</div>
