...
<div data-type="equation" id="eip-960">
 $$\frac{1}{ {d}_{\text{i}}}=\frac{1}{6\text{.}\text{00 mm}}-\frac{1}{6\text{.}\text{20 mm}}=\frac{0.00538}{\text{mm}}\text{.} $$
</div>
...
<div data-type="equation" id="eip-589">
 $${d}_{\text{i}}\prime =-\frac{\text{mm}}{0.00273}=-\text{367 mm}. $$
</div>
The eyepiece’s magnification is thus

<div data-type="equation" id="eip-248">
 $${m}_{\text{e}}=-\frac{ {d}_{\text{i}}\prime }{ {d}_{\text{o}}\prime }=-\frac{-\text{367 mm}}{\text{44}\text{.}\text{0 mm}}=8.33. $$
</div>
So the overall magnification is

<div data-type="equation" id="eip-472">
 $$m={m}_{\text{o}}{m}_{\text{e}}=\left(-\text{30.0}\right)\left(8.33\right)=-\text{250}. $$
</div>
**Discussion**
