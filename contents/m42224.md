...
4.  {: #import-auto-id2973422} Calculate the heat transferred to the aluminum. Use the specific heat for aluminum in [\[link\]](#import-auto-id1921148)\:
    <div class="equation" id="eip-168">
     $${Q}_{\text{Al}}={m}_{\text{Al}}{c}_{\text{Al}}\Delta T=\left(0.500 \text{kg}\right)\left(900 \text{J/kgºC}\right)\left(60.0 \text{ºC}\right)=  27.0 \times 10^{4}\text{J = 27.0 kJ.} $$
    </div>
...
3.  {: #import-auto-id2382813} Note that
    ...
    <div class="equation" id="eip-582">
     $$\begin{array}{lll}\hfill {Q}_{\text{cold}}\text{+}{Q}_{\text{hot}}& =& 0 \text{,}\\ \hfill {Q}_{\text{cold}}& =& {\text{–Q}}_{\text{hot}},\\ {m}_{W}{c}_{W}\left({T}_{\text{f}}-20.0 \text{ºC}\right)& =& -m_{\text{Al}}{c}_{\text{Al}}\left({T}_{\text{f}}-150 \text{ºC.}\right)\end{array} $$
    </div>
...
* {: #import-auto-id1823260} The transfer of heat
   ...
   $$\Delta T $$ in the temperature of a body with mass
   $$m $$ is
   $$Q=\text{mc}\Delta T $$
    , where
...
* {: class="footnote-ref" #footnote1} [1](#footnote-ref1){: class="footnote-ref-link"} <span class="footnote-ref-content">The values for solids and liquids are at constant volume and at  $$25 \text{ºC} $$
  , except as noted.</span>
* {: class="footnote-ref" #footnote2} [2](#footnote-ref2){: class="footnote-ref-link"} <span class="footnote-ref-content">These values are identical in units of  $$\text{cal/g}\cdot ºC $$
  .</span>
