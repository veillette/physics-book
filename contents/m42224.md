...
3.  {: #import-auto-id1848706} Calculate the heat transferred to the water. Use the specific heat of water in [\[link\]](#import-auto-id1921148)\:
    ...
    $${Q}_{w}={m}_{w}{c}_{w}\text{Δ}T=\left(0\text{.}\text{250} \text{kg}\right)\left(\text{4186} \text{J/kg}\text{ºC}\right)\left(\text{60.0}\text{ºC}\right)=\text{62}.8 kJ.$$
    </div>
...
5.  {: #import-auto-id1514408} Compare the percentage of heat going into the pan versus that going into the water. First, find the total transferred heat:
    ...
    $${Q}_{\text{Total}}={Q}_{\text{W}}+{Q}_{\text{Al}}=\text{62}\text{.}8 \text{kJ}+\text{27}\text{.}0  \text{kJ = 89}\text{.}8 \text{kJ.}$$
    </div>
{: type="1"}
...
$$\frac{\text{27}\text{.}0 \text{kJ}}{\text{89}\text{.}8 \text{kJ}}×\text{100%}\text{}=\text{30.1%,}\text{}$$
</div>
and the amount going into heating the water is

<div data-type="equation" id="eip-686">
$$\frac{\text{62}\text{.}8 \text{kJ}}{\text{89}\text{.}8 \text{kJ}}×\text{100%}\text{}=\text{69.9%}\text{}\text{.}$$
</div>
**Discussion**
...
1.  {: #import-auto-id3130222} Calculate the change in gravitational potential energy as the truck goes downhill
    ...
    $$\text{Mgh}=\left(\text{10,000 kg}\right)\left(9\text{.}\text{80 m}{\text{/s}}^{2}\right)\left(\text{75.0 m}\right)=\text{7.}\text{35}×{\text{10}}^{6} \text{J.}$$
    </div>
...
2.  {: #import-auto-id3036480} Calculate the temperature from the heat transferred using
    ...
    $$\text{Δ}T=\frac{\left(7\text{.35}×{\text{10}}^{5} \text{J}\right)}{\left(\text{100 kg}\right)\left(\text{800 J/kgºC}\right)}=\text{9.2ºC.}$$
    </div>
{: type="1"}
...
. At what rate in watts must the person transfer thermal energy to reduce the the body temperature to $$\text{37}\text{.}0º\text{C}$$
 in 30.0 min, assuming the body continues to produce energy at the rate of 150 W? $$\left(\text{1 watt = 1 joule/second or 1 W = 1 J/s} \right)$$
.
...
. (a) Calculate the rate of temperature increase in degrees Celsius per second $$\left(\text{ºC/s}\right)$$
 if the mass of the reactor core is $$1\text{.}\text{60}×{\text{10}}^{5} \text{kg}$$
