...
1.  {: #import-auto-id862880} Calculate the temperature difference:
    <div data-type="equation" id="eip-461">
     $$\text{Δ}T={T}_{\text{f}}-{T}_{\text{i}}=60.0 \text{ºC.} $$
    </div>
...
4.  {: #import-auto-id2973422} Calculate the heat transferred to the aluminum. Use the specific heat for aluminum in [\[link\]](#import-auto-id1921148)\:
    <div data-type="equation" id="eip-168">
     $${Q}_{\text{Al}}={m}_{\text{Al}}{c}_{\text{Al}}\text{Δ}T=\left(0.500 \text{kg}\right)\left(900 \text{J/kgºC}\right)\left(60.0 \text{ºC}\right)=  27.0 \times 10^{4}\text{J = 27.0 kJ.} $$
    </div>
...
<div data-type="equation" id="eip-508">
 $$\frac{ 27.0 \text{kJ}}{ 89.8 \text{kJ}}×100 \text{%} =30.1 \text{%,}  $$
</div>
and the amount going into heating the water is

<div data-type="equation" id="eip-686">
 $$\frac{ 62.8 \text{kJ}}{ 89.8 \text{kJ}}×100 \text{%} =69.9 \text{%} \text{.} $$
</div>
**Discussion**
...
2.  {: #import-auto-id3036480} Calculate the temperature from the heat transferred using
    ...
    <div data-type="equation" id="eip-456">
     $$\text{Δ}T=\frac{\left( 7.35 \times 10^{5}  \text{J}\right)}{\left(100 \text{ kg}\right)\left(800 \text{ J/kgºC}\right)}=9.2 \text{ºC.} $$
    </div>
{: type="1"}
...
Suppose you pour 0.250 kg of  $$20\text{.0ºC} $$
...
3.  {: #import-auto-id2382813} Note that
    ...
    <div data-type="equation" id="eip-582">
     $$\begin{array}{lll}\hfill {Q}_{\text{cold}}\text{+}{Q}_{\text{hot}}& =& 0 \text{,}\\ \hfill {Q}_{\text{cold}}& =& {\text{–Q}}_{\text{hot}},\\ {m}_{W}{c}_{W}\left({T}_{\text{f}}-20.0 \text{ºC}\right)& =& {\mathrm{-m}}_{\mathrm{Al}}{c}_{\mathrm{Al}}\left({T}_{\text{f}}-150 \text{ºC.}\right)\end{array} $$
    </div>
...
5.  {: #import-auto-id1570030} Bring all terms involving
    ...
    <div data-type="equation" id="eip-499">
     $${T}_{\text{f}}=\frac{ {m}_{\text{Al}}{c}_{\text{Al}}\left(150 \text{ºC}\right)+{m}_{W}{c}_{W}\left(20\text{.0ºC}\right)}{ {m}_{\text{Al}}{c}_{\text{Al}}+{m}_{W}{c}_{W}}\text{,} $$
    </div>
    
    and insert the numerical values:
    
    <div data-type="equation" id="eip-274">
     $$\begin{array}{lll}{T}_{\text{f}}& =& \frac{\left(0.500 \text{kg}\right)\left(900 \text{J/kgºC}\right)\left(150 \text{ºC}\right)\text{+}\left(0.250 \text{kg}\right)\left(4186 \text{J/kgºC}\right)\left(20.0 \text{ºC}\right)}{\left(0.500 \text{kg}\right)\left(900 \text{J/kgºC}\right)+\left(0.250 \text{kg}\right)\left(4186 \text{J/kgºC}\right)}\\ & =& \frac{88430 \text{J}}{1496.5 \text{J/ºC}}\\ & =& 59\text{.1ºC.}\end{array} $$
    </div>
{: type="1"}

**Discussion**

This is a typical *calorimetry* problem—two bodies at different temperatures are brought in contact with each other and exchange heat until a common temperature is reached. Why is the final temperature so much closer to  $$20.0 \text{ºC} $$
 than  $$150 \text{ºC} $$
...
. (b) How long would it take to obtain a temperature increase of  $$2000 \text{º}\text{C} $$
...
* {: data-type="footnote-ref" #footnote1} [1](#footnote-ref1){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">The values for solids and liquids are at constant volume and at  $$25 \text{ºC} $$
