...
( function() {
  var BOOK_TEMPLATE, BookConfig, doHopscotch, fa, _base, _base1, _base2;
  ...
  $( function() {
    var $body, $book, $bookBody, $bookPage, $bookProgressBar, $bookSearchInput, $bookSummary, $bookTitle, $originalPage,
      $startHopscotch, $toggleSearch, $toggleSummary, TocHelper, addTrailingSlash, changePage, mdToHtmlFix,
